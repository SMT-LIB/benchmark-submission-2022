...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_976 us_t) (temp___is_init_972 Bool) (temp___skip_constant_973 Bool) (temp___do_toplevel_974 Bool) (temp___do_typ_inv_975 Bool) (Ada___ada___ada__strings__fixed__Omultiply__2__left___left___ Int)) Bool
  (=>
    ...
    (and
      ...
      (= (last temp___expr_976) (* Ada___ada___ada__strings__fixed__Omultiply__2__left___left___ 
      (length
        right))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_978 us_t) (temp___skip_top_level_979 Bool) (Ada___ada___ada__strings__fixed__Omultiply__2__left___left___ Int)) Bool
  (and
    (= (first temp___expr_978) 1)
    (= (last temp___expr_978) (* Ada___ada___ada__strings__fixed__Omultiply__2__left___left___ 
    (length
      right)))))
...
;; H
(assert
  (forall ((temp___2809 Int))
    (ite (and
           (<= (+ ptr 1) temp___2809)
           (<= temp___2809 (+ ptr (length right))))
      (= (select (to_array1 usf) temp___2809) (select (to_array1
                                                        (of_array1
                                                          (convert1
                                                            (slide
                                                              (to_array
...
(assert
  (let ((temp___2839 (of_array1
                       ...
                       1
                       ptr2)))
    (forall ((temp___2840 Int))
      (=>
        (and
          (<= (first1 temp___2839) temp___2840)
          (<= temp___2840 (last1 temp___2839)))
        (= (us_attr__init (select (to_array1 temp___2839) temp___2840)) true)))))
...
(assert
  (forall ((temp___2809 Int))
    (ite (and
           (<= (+ ptr2 1) temp___2809)
           (<= temp___2809 (+ ptr2 (length right))))
      (= (select (to_array1 usf1) temp___2809) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
