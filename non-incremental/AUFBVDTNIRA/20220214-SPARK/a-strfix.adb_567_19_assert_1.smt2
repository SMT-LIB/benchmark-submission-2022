...
(declare-datatypes ((t138b__init_wrapper__ref 0))
  (((t138b__init_wrapper__refqtmk (t138b__init_wrapper__content us_t1)))))

;; t138b__init_wrapper__ref_t138b__init_wrapper__content__projection
(define-fun t138b__init_wrapper__ref_t138b__init_wrapper__content__projection 
  ((a t138b__init_wrapper__ref)) us_t1
  (t138b__init_wrapper__content a))

(declare-datatypes ((t140b__ref 0))
  (((t140b__refqtmk (t140b__content us_t)))))

;; t140b__ref_t140b__content__projection
(define-fun t140b__ref_t140b__content__projection ((a t140b__ref)) us_t
  (t140b__content a))

(declare-datatypes ((t142b__init_wrapper__ref 0))
  (((t142b__init_wrapper__refqtmk (t142b__init_wrapper__content us_t1)))))

;; t142b__init_wrapper__ref_t142b__init_wrapper__content__projection
(define-fun t142b__init_wrapper__ref_t142b__init_wrapper__content__projection 
  ((a t142b__init_wrapper__ref)) us_t1
  (t142b__init_wrapper__content a))

(declare-datatypes ((t144b__ref 0))
  (((t144b__refqtmk (t144b__content us_t)))))

;; t144b__ref_t144b__content__projection
(define-fun t144b__ref_t144b__content__projection ((a t144b__ref)) us_t
  (t144b__content a))

(declare-datatypes ((t146b__init_wrapper__ref 0))
  (((t146b__init_wrapper__refqtmk (t146b__init_wrapper__content us_t1)))))

;; t146b__init_wrapper__ref_t146b__init_wrapper__content__projection
(define-fun t146b__init_wrapper__ref_t146b__init_wrapper__content__projection 
  ((a t146b__init_wrapper__ref)) us_t1
  (t146b__init_wrapper__content a))
...
(declare-datatypes ((t150b__init_wrapper__ref 0))
  (((t150b__init_wrapper__refqtmk (t150b__init_wrapper__content us_t1)))))

;; t150b__init_wrapper__ref_t150b__init_wrapper__content__projection
(define-fun t150b__init_wrapper__ref_t150b__init_wrapper__content__projection 
  ((a t150b__init_wrapper__ref)) us_t1
  (t150b__init_wrapper__content a))

(declare-datatypes ((t152b__ref 0))
  (((t152b__refqtmk (t152b__content us_t)))))

;; t152b__ref_t152b__content__projection
(define-fun t152b__ref_t152b__content__projection ((a t152b__ref)) us_t
  (t152b__content a))
...
(declare-datatypes ((t158b__init_wrapper__ref 0))
  (((t158b__init_wrapper__refqtmk (t158b__init_wrapper__content us_t1)))))

;; t158b__init_wrapper__ref_t158b__init_wrapper__content__projection
(define-fun t158b__init_wrapper__ref_t158b__init_wrapper__content__projection 
  ((a t158b__init_wrapper__ref)) us_t1
  (t158b__init_wrapper__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_1144 us_t) (temp___is_init_1140 Bool) (temp___skip_constant_1141 Bool) (temp___do_toplevel_1142 Bool) (temp___do_typ_inv_1143 Bool) (Ada___ada___ada__strings__fixed__overwrite__B_13__result_length___result_length___ Int)) Bool
  (=>
    (not (= temp___skip_constant_1141 true))
    (and
      (and
        (dynamic_property
          1
          Ada___ada___ada__strings__fixed__overwrite__B_13__result_length___result_length___
          (first temp___expr_1144)
          (last temp___expr_1144))
        (= (first temp___expr_1144) 1))
      (= (last temp___expr_1144) Ada___ada___ada__strings__fixed__overwrite__B_13__result_length___result_length___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1146 us_t) (temp___skip_top_level_1147 Bool) (Ada___ada___ada__strings__fixed__overwrite__B_13__result_length___result_length___ Int)) Bool
  (and
    (= (first temp___expr_1146) 1)
    (= (last temp___expr_1146) Ada___ada___ada__strings__fixed__overwrite__B_13__result_length___result_length___)))
...
(assert
  (and
    (let ((temp___2324 (- position 1)))
      (and
        (<= (- (first source) 1) temp___2324)
        (<= temp___2324 (last source))))
    (=>
...
(assert
  (forall ((temp___2179 Int))
    (ite (and (<= 1 temp___2179) (<= temp___2179 front))
      (= (select (to_array1 usf) temp___2179) (select (to_array1
                                                        (of_array1
                                                          (convert1
                                                            (slide
                                                              (to_array
...
;; Assert
(assert
  (= (let ((temp___2202 (of_array
                          (to_array source)
                          (first source)
                          (- position 1))))
       (let ((temp___2200 (of_array1
                            (to_array1
                              (of_array1
                                result__1
                                (to_rep1 result____first)
         ...
         (bool_eq5
           (convert (to_array1 temp___2200))
           (first1 temp___2200)
           (last1 temp___2200)
           (to_array temp___2202)
           (first temp___2202)
           (last temp___2202)))) true))
...
;; H
(assert
  (forall ((temp___2213 Int))
    (ite (and
           (<= (+ front 1) temp___2213)
           (<= temp___2213 (+ front (length new_item))))
      (= (select (to_array1 usf1) temp___2213) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
...
;; Assert
(assert
  (= (let ((temp___2230 (of_array1
                          (to_array1
                            (of_array1
                              result__2
                              (to_rep1 result____first)
                              (to_rep1 result____last)))
                          (+ (- position (first source)) 1)
                          (+ (- position (first source)) (length new_item)))))
       (bool_eq5
         (convert (to_array1 temp___2230))
         (first1 temp___2230)
         (last1 temp___2230)
         (to_array new_item)
         (first new_item)
...
;; Ensures
(assert (in_range1 (+ position (length new_item))))

;; Assert
(assert
  (=>
    (<= (+ position (length new_item)) (last source))
    (and
      (and
        (<= (first source) (+ position (length new_item)))
        (<= (+ position (length new_item)) (last source)))
      (and
        (<= (first source) (last source))
             ...
             (of_array
               ...
               (last source))) (last
                                 (of_array
                                   ...
                                   (last source))))
    (and
      (<= (+ (+ front (length new_item)) 1) (to_rep1 result____last))
      (= (- (last
              (of_array
                (to_array source)
                (+ position (length new_item))
...
;; Ensures
(assert (in_range1 (+ (+ front (length new_item)) 1)))
      ...
      (and
        (<= (first1
              (of_array1
                result__2
                (to_rep1 result____first)
                (to_rep1 result____last))) (to_rep1 result____last))
        (<= (to_rep1 result____last) (last1
                                       (of_array1
                                         result__2
                                         (to_rep1 result____first)
                                         (to_rep1 result____last))))))))
...
;; H
(assert (= (to_rep1 result____last) o))

(declare-const o1 Int)

;; H
(assert (= (to_rep1 result____first) o1))

(declare-const temp___2251 Int)

;; H
(assert (= (to_rep1 result____last) temp___2251))
...
(assert
  (= (first1
       (of_array1
         result__2
         (to_rep1 result____first)
         (to_rep1 result____last))) (first1 usf2)))
...
(assert
  (= (last1
       (of_array1
         result__2
         (to_rep1 result____first)
         (to_rep1 result____last))) (last1 usf2)))

;; H
(assert
  (forall ((temp___2247 Int))
    (ite (and
           (<= (+ (+ front (length new_item)) 1) temp___2247)
           (<= temp___2247 (to_rep1 result____last)))
      (= (select (to_array1 usf2) temp___2247) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
...
;; H
(assert (= result__3 (to_array1 usf2)))

;; Goal def'vc
;; File "a-strfix.ads", line 986, characters 0-0
(assert
  (not
  (= (let ((temp___2276 (of_array
                          (to_array source)
                          (+ position (length new_item))
                          (last source))))
       (let ((temp___2274 (of_array1
                            (to_array1
                              (of_array1
                                result__3
                                (to_rep1 result____first)
                            ...
                            (to_rep1 result____last))))
         (bool_eq5
           (convert (to_array1 temp___2274))
           (first1 temp___2274)
           (last1 temp___2274)
           (to_array temp___2276)
           (first temp___2276)
           (last temp___2276)))) true)))
