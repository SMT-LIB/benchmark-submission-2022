...
;; t172b__ref_t172b__content__projection
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_1226 us_t) (temp___is_init_1222 Bool) (temp___skip_constant_1223 Bool) (temp___do_toplevel_1224 Bool) (temp___do_typ_inv_1225 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1223 true))
    (and
      (and
        (dynamic_property
          1
          (length source)
          (first temp___expr_1226)
          (last temp___expr_1226))
        (= (first temp___expr_1226) 1))
      (= (last temp___expr_1226) (length source)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1228 us_t) (temp___skip_top_level_1229 Bool)) Bool
  (and
    (= (first temp___expr_1228) 1)
    (= (last temp___expr_1228) (length source))))
