...
(declare-datatypes ((t227b__ref 0))
  (((t227b__refqtmk (t227b__content integer)))))

;; t227b__ref_t227b__content__projection
(define-fun t227b__ref_t227b__content__projection ((a t227b__ref)) integer
  (t227b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_1318 us_t) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool) (temp___do_typ_inv_1317 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1315 true))
    (and
      (and
        (dynamic_property
          1
          (length source)
          (first temp___expr_1318)
          (last temp___expr_1318))
        (= (first temp___expr_1318) 1))
      (= (last temp___expr_1318) (length source)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_1320 us_t) (temp___skip_top_level_1321 Bool)) Bool
  (and
    (= (first temp___expr_1320) 1)
    (= (last temp___expr_1320) (length source))))
