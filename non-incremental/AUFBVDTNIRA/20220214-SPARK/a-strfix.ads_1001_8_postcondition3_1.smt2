  ...
  (ite (= spark__branch1 true)
    (and
      ...
      (and
        ...
        (let ((temp___2244 (of_array1 result__2 o1 o)))
          (let ((temp___2233 (last source)))
                      ...
                      (=>
                        ...
                        (and
                          (and
                            ...
                            (<= o10 (last source)))
                          (and
                            (<= (first source) temp___2233)
                            (<= temp___2233 (last source)))))
                      (let ((temp___2234 (of_array
                                           (to_array source)
                                           o10
                                           temp___2233)))
                        (and
                          (ite (<= (first temp___2234) (last temp___2234))
                            (and
                              (<= (+ (+ front (length new_item)) 1) (to_rep1
                                                                    result____last))
                              (= (- (last temp___2234) (first temp___2234)) (- 
                              (to_rep1
                          ...
                          (and
                            ...
                            (let ((temp___2238 (of_array1
                                                 (convert1
                                                   (slide
                                                     (to_array temp___2234)
                                                     (first temp___2234)
                                                     (+ (+ front (length
                                                                   new_item)) 1)))
                                                 (+ (+ front (length
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (and
                                    (= (to_rep1 result____last) temp___2242)
                                    (let ((o11 (length new_item)))
                                      (and
                                        (in_range1 o11)
                                        (let ((o12 (+ front o11)))
                                          (and
                                                              ...
                                                              (and
                                                                (and
                                                                  ...
                                                                  (forall 
                                                                    ...
                                                                    front 
                                                                    (length
                                                                    new_item)) 1) temp___2247)
                                                                    (<= temp___2247 
                                                                    (to_rep1
                                                                    result____last)))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf2) temp___2247) (select 
                                                                    (to_array1
                                                                    temp___2238) temp___2247))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf2) temp___2247) (select 
                                                                    (to_array1
                                                                    temp___2244) temp___2247)))))
                                                                (and
                                                                  (= 
                                                                  result__3 
                                                                  (to_array1
...
(assert
  (=>
    ...
    (= (let ((temp___2299 (of_array
                            (to_array source)
                            (+ position (length new_item))
                            (last source))))
         (let ((temp___2297 (of_array1
                              (to_array1
                                (of_array1
                                  result__3
                                  (to_rep1 result____first)
                              ...
                              (to_rep1 result____last))))
           (bool_eq5
             (convert (to_array1 temp___2297))
             (first1 temp___2297)
             (last1 temp___2297)
             (to_array temp___2299)
             (first temp___2299)
             (last temp___2299)))) true)))
...
(assert
  (not
  (= (let ((temp___2332 (of_array
                          (to_array source)
                          (first source)
                          (- position 1))))
       (let ((temp___2330 (of_array
                            (to_array
                              ada___ada___ada__strings__fixed__overwrite__result)
                            1
                            (- position (first source)))))
         (bool_eq5
           (to_array temp___2330)
           (first temp___2330)
           (last temp___2330)
           (to_array temp___2332)
           (first temp___2332)
           (last temp___2332)))) true)))
