...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_996 us_t) (temp___is_init_992 Bool) (temp___skip_constant_993 Bool) (temp___do_toplevel_994 Bool) (temp___do_typ_inv_995 Bool)) Bool
  (=>
    (not (= temp___skip_constant_993 true))
    (and
      (and
        (dynamic_property
          1
          (length source)
          (first temp___expr_996)
          (last temp___expr_996))
        (= (first temp___expr_996) 1))
      (= (last temp___expr_996) (length source)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_998 us_t) (temp___skip_top_level_999 Bool)) Bool
  (and
    (= (first temp___expr_998) 1)
    (= (last temp___expr_998) (length source))))

;; front__def_axiom
(assert (= front (- from (first source))))

;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_1006 us_t) (temp___is_init_1002 Bool) (temp___skip_constant_1003 Bool) (temp___do_toplevel_1004 Bool) (temp___do_typ_inv_1005 Bool) (Ada___ada___ada__strings__fixed__delete__from___from___ Int) (Ada___ada___ada__strings__fixed__delete__through___through___ Int)) Bool
  (=>
    (not (= temp___skip_constant_1003 true))
    (and
      (and
        (dynamic_property
          1
          ...
          (first temp___expr_1006)
          (last temp___expr_1006))
        (= (first temp___expr_1006) 1))
      (= (last temp___expr_1006) (- (length source) (+ (- Ada___ada___ada__strings__fixed__delete__through___through___ Ada___ada___ada__strings__fixed__delete__from___from___) 1))))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_1008 us_t) (temp___skip_top_level_1009 Bool) (Ada___ada___ada__strings__fixed__delete__from___from___ Int) (Ada___ada___ada__strings__fixed__delete__through___through___ Int)) Bool
  (and
    (= (first temp___expr_1008) 1)
    (= (last temp___expr_1008) (- (length source) (+ (- Ada___ada___ada__strings__fixed__delete__through___through___ Ada___ada___ada__strings__fixed__delete__from___from___) 1)))))
  ...
  (ite (= spark__branch true)
    ...
    (and
      (= spark__branch1 (ite (not
                          ...
                          true
                          (let ((o16 (last source)))
                            (let ((lastqtresultqtunusedqtunused o16))
                              (ite (< o16 through) true false)))))
      (ite (= spark__branch1 true)
        (and
          (let ((o16 (+ (last source) 1)))
            (and
              (in_range1 o16)
              (ite (= from o16)
                (= o15 (ite (= from through) true false))
                (= o15 false))))
          (and
            (= spark__branch3 o15)
            (and
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (let ((temp___2390 (of_array1 result__ o1 o)))
                          (let ((temp___2383 (- from 1)))
                            (let ((temp___2382 (first source)))
                              (and
                                (=>
                                  (<= temp___2382 temp___2383)
                                  (and
                                    (and
                                      (<= (first source) temp___2382)
                                      (<= temp___2382 (last source)))
                                    (and
                                      (<= (first source) temp___2383)
                                      (<= temp___2383 (last source)))))
                                (let ((temp___2384 (of_array
                                                     (to_array source)
                                                     temp___2382
                                                     temp___2383)))
                                  (and
                                    (ite (<= (first temp___2384) (last
                                                                   temp___2384))
                                      (and
                                        (<= 1 front)
                                        (= (- (last temp___2384) (first
                                                                   temp___2384)) (- 
                                        front 1)))
                                      (< front 1))
                                    (let ((temp___2386 (of_array1
                                                         (convert1
                                                           (slide
                                                             (to_array
                                                               temp___2384)
                                                    ...
                                                    (and
                                                      ...
                                                      (forall ((temp___2393 Int))
                                                        (ite (and
                                                          ...
                                                          (= (select 
                                                          (to_array1
                                                            usf) temp___2393) (select 
                                                          (to_array1
                                                            temp___2386) temp___2393))
                                                          (= (select 
                                                          (to_array1
                                                            usf) temp___2393) (select 
                                                          (to_array1
                                                            temp___2390) temp___2393)))))
                                                    (and
                                                      (= result__1 (to_array1
                                                                    usf))
                                                      (and
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___2409 
                                                                  ...
                                                                  (let ((temp___2398 
                                                                    ...
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf1) temp___2412) (select 
                                                                    (to_array1
                                                                    temp___2403) temp___2412))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf1) temp___2412) (select 
                                                                    (to_array1
                                                                    temp___2409) temp___2412)))))
                                                                    (= 
                                                                    result__2 
                                                                    (to_array1
                                                                    usf1))))))))))))))))))))))))))
...
(assert
  ...
  (=>
    ...
    (=>
      (< through (last source))
      (= (let ((temp___2451 (of_array
                              (to_array source)
                              (+ through 1)
                              (last source))))
           (let ((temp___2449 (of_array
                                (to_array
                                  ada___ada___ada__strings__fixed__delete__result)
                                (+ (- from (first source)) 1)
                                (last
                                  ada___ada___ada__strings__fixed__delete__result))))
             (bool_eq5
               (to_array temp___2449)
               (first temp___2449)
               (last temp___2449)
               (to_array temp___2451)
               (first temp___2451)
               (last temp___2451)))) true)))))
