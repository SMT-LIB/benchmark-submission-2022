...
(declare-datatypes ((t95b__init_wrapper__ref 0))
  (((t95b__init_wrapper__refqtmk (t95b__init_wrapper__content us_t1)))))

;; t95b__init_wrapper__ref_t95b__init_wrapper__content__projection
(define-fun t95b__init_wrapper__ref_t95b__init_wrapper__content__projection 
  ((a t95b__init_wrapper__ref)) us_t1
  (t95b__init_wrapper__content a))

(declare-datatypes ((t97b__init_wrapper__ref 0))
  (((t97b__init_wrapper__refqtmk (t97b__init_wrapper__content us_t1)))))

;; t97b__init_wrapper__ref_t97b__init_wrapper__content__projection
(define-fun t97b__init_wrapper__ref_t97b__init_wrapper__content__projection 
  ((a t97b__init_wrapper__ref)) us_t1
  (t97b__init_wrapper__content a))

(declare-datatypes ((t99b__ref 0))
  (((t99b__refqtmk (t99b__content us_t)))))

;; t99b__ref_t99b__content__projection
(define-fun t99b__ref_t99b__content__projection ((a t99b__ref)) us_t
  (t99b__content a))

(declare-datatypes ((t101b__init_wrapper__ref 0))
  (((t101b__init_wrapper__refqtmk (t101b__init_wrapper__content us_t1)))))

;; t101b__init_wrapper__ref_t101b__init_wrapper__content__projection
(define-fun t101b__init_wrapper__ref_t101b__init_wrapper__content__projection 
  ((a t101b__init_wrapper__ref)) us_t1
  (t101b__init_wrapper__content a))

(declare-datatypes ((t103b__ref 0))
  (((t103b__refqtmk (t103b__content us_t)))))

;; t103b__ref_t103b__content__projection
(define-fun t103b__ref_t103b__content__projection ((a t103b__ref)) us_t
  (t103b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_1088 us_t) (temp___is_init_1084 Bool) (temp___skip_constant_1085 Bool) (temp___do_toplevel_1086 Bool) (temp___do_typ_inv_1087 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1085 true))
    (and
      (and
        (dynamic_property
          1
          (+ (length source) (length new_item))
          (first temp___expr_1088)
          (last temp___expr_1088))
        (= (first temp___expr_1088) 1))
      (= (last temp___expr_1088) (+ (length source) (length new_item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1090 us_t) (temp___skip_top_level_1091 Bool)) Bool
  (and
    (= (first temp___expr_1090) 1)
    (= (last temp___expr_1090) (+ (length source) (length new_item)))))
...
(assert
  (and
    (let ((temp___2119 (- before 1)))
      (and
        (<= (- (first source) 1) temp___2119)
        (<= temp___2119 (last source))))
...
;; H
(assert
  (forall ((temp___2001 Int))
    (ite (and (<= 1 temp___2001) (<= temp___2001 front))
      (= (select (to_array1 usf) temp___2001) (select (to_array1
                                                        (of_array1
                                                          (convert1
                                                            (slide
                                                              (to_array
...
(assert
  (forall ((temp___2014 Int))
    (ite (and
           (<= (+ front 1) temp___2014)
           (<= temp___2014 (+ front (length new_item))))
      (= (select (to_array1 usf1) temp___2014) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
...
;; Assert
(assert
  (= (let ((temp___2039 (of_array
                          (to_array source)
                          (first source)
                          (- before 1))))
       (let ((temp___2037 (of_array1
                            (to_array1
                              (of_array1
                                result__2
                                (to_rep1 result____first)
                            ...
                            (- before (first source)))))
         (bool_eq4
           (convert (to_array1 temp___2037))
           (first1 temp___2037)
           (last1 temp___2037)
           (to_array temp___2039)
           (first temp___2039)
           (last temp___2039)))) true))

;; Assert
(assert
  (= (let ((temp___2052 (of_array1
                          (to_array1
                            (of_array1
                              result__2
                              (to_rep1 result____first)
                              (to_rep1 result____last)))
                          (+ (- before (first source)) 1)
                          (+ (- before (first source)) (length new_item)))))
       (bool_eq4
         (convert (to_array1 temp___2052))
         (first1 temp___2052)
         (last1 temp___2052)
         (to_array new_item)
         (first new_item)
  ...
  (ite (= spark__branch1 true)
    (and
      ...
      (and
        ...
        (let ((temp___2065 (of_array1 result__2 o1 o)))
          (let ((temp___2054 (last source)))
            (and
              (=>
                (<= before temp___2054)
                (and
                  ...
                  (and
                    (<= (first source) temp___2054)
                    (<= temp___2054 (last source)))))
              (let ((temp___2055 (of_array
                                   (to_array source)
                                   before
                                   temp___2054)))
                (and
                  (ite (<= (first temp___2055) (last temp___2055))
                    (and
                      (<= (+ (+ front (length new_item)) 1) (to_rep1
                                                              result____last))
                      (= (- (last temp___2055) (first temp___2055)) (- 
                      (to_rep1
                        result____last) (+ (+ front (length new_item)) 1))))
                    (< (to_rep1 result____last) (+ (+ front (length new_item)) 1)))
                  (and
                    (= (to_rep1 result____last) o2)
                    (let ((temp___2059 (of_array1
                                         (convert1
                                           (slide
                                             (to_array temp___2055)
                                             (first temp___2055)
                      ...
                      (and
                        ...
                        (and
                          ...
                          (and
                            (= (to_rep1 result____last) temp___2063)
                                                        ...
                                                        (and
                                                          ...
                                                          (forall ((temp___2068 Int))
                                                            (ite (and
                                                                   ...
                                                                   front 
                                                                   (length
                                                                    new_item)) 1) temp___2068)
                                                                   (<= temp___2068 
                                                                   (to_rep1
                                                                    result____last)))
                                                              (= (select 
                                                              (to_array1
                                                                usf2) temp___2068) (select 
                                                              (to_array1
                                                                temp___2059) temp___2068))
                                                              (= (select 
                                                              (to_array1
                                                                usf2) temp___2068) (select 
                                                              (to_array1
                                                                temp___2065) temp___2068)))))
                                                        (= result__3 
                                                        (to_array1
                                                          usf2))))))))))))))))))))))))))))
    (= result__3 result__2)))
...
;; Assert
(assert
  (= (let ((temp___2095 (of_array
                          (to_array source)
                          (first source)
                          (- before 1))))
       (let ((temp___2093 (of_array1
                            (to_array1
                              (of_array1
                                result__3
                                (to_rep1 result____first)
                            ...
                            (- before (first source)))))
         (bool_eq4
           (convert (to_array1 temp___2093))
           (first1 temp___2093)
           (last1 temp___2093)
           (to_array temp___2095)
           (first temp___2095)
           (last temp___2095)))) true))
