...
(assert
  ...
  (=>
    (<= before (last source))
    (= (let ((temp___1851 (of_array (to_array source) before (last source))))
         (let ((temp___1849 (of_array
                              (to_array
                                ada___ada___ada__strings__fixed__insert__result)
                              (+ (+ (- before (first source)) (length
                                                                new_item)) 1)
                              (last
                                ada___ada___ada__strings__fixed__insert__result))))
           (bool_eq4
             (to_array temp___1849)
             (first temp___1849)
             (last temp___1849)
             (to_array temp___1851)
             (first temp___1851)
             (last temp___1851)))) true))))
