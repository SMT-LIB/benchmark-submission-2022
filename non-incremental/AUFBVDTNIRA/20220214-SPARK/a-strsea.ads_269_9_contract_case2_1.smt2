                                  ...
                                  (=>
                                    ...
                                    (and
                                      (and
                                        ...
                                        (<= from (last source)))
                                      (and
                                        (<= (first source) temp___662)
                                        (<= temp___662 (last source)))))
                                  (let ((temp___663 (of_array
                                                      (to_array source)
                                                      from
                                                      temp___662)))
                                    (let ((o4 (of_array
                    ...
                    (exists ((spark__branch2 Bool))
                      (and
                        ...
                        (and
                          ...
                          (let ((o2 mapping))
                            (let ((o3 pattern))
                              (let ((temp___658 (first source)))
                                (and
                                  (=>
                                    (<= temp___658 from)
                                    (and
                                      (and
                                        (<= (first source) temp___658)
                                        (<= temp___658 (last source)))
                                      (and
                                        (<= (first source) from)
                                        (<= from (last source)))))
                                  (let ((temp___659 (of_array
                                                      (to_array source)
                                                      temp___658
                                                      from)))
                                    (let ((o4 (of_array
        ...
        (=>
          (forall ((k1 Int))
            (value__function_guard
              (value
                mapping
                (to_rep
                  (select (to_array source) (+ ada___ada___ada__strings__search__index__4__result (- k1 
                  (first
                    pattern))))))
              mapping
              (to_rep
          ...
          (= (to_rep (select (to_array pattern) k)) (value
                                                      ...
                                                      (to_rep
                                                        (select (to_array
                                                                  source) (+ 
                                                        ada___ada___ada__strings__search__index__4__result (- k 
                                                        (first
                                                          pattern)))))))))))))
