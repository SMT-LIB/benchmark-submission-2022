...
;; Assume
(assert (dynamic_invariant2 r710b true false true true))

;; Ensures
(assert (in_range1 (+ indx ilen)))

;; Assume
(assert (= (+ indx ilen) r711b))

;; Assume
(assert (dynamic_invariant2 r711b true false true true))
...
;; H
(assert
  (= (and (ite (<= r710b k) true false) (ite (<= k r711b) true false)) true))
...
;; H
(assert
  (= (and (ite (dynamic_property3 r710b r711b k1) true false) (ite (and
                                                                    (<= 
                                                                    r710b 
                                                                    k1)
                                                                    (<= 
