...
;; Ensures
(assert (in_range1 (* count ilen)))

(declare-const spark__branch1 Bool)

;; H
(assert (= spark__branch1 (ite (< 0 (* count ilen)) true false)))
...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j count) true false)) true))
...
(assert
  (forall ((temp___13391 Int))
    (ite (and (<= (+ indx1 1) temp___13391) (<= temp___13391 (+ indx1 ilen)))
      (= (select (to_array1 usf) temp___13391) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
                                                               ...
                                                               (+ indx1 1)))
                                                           (+ indx1 1)
                                                           (+ indx1 ilen))) temp___13391))
      (= (select (to_array1 usf) temp___13391) (select (to_array1
                                                         (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                           result____split_fields)) temp___13391)))))
                                  ...
                                  (us_repqtmk1
                                    ...
                                    (us_split_fieldsqtmk1
                                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                        result____split_fields)
                                      usf)))))))))
      (forall ((temp___13404 Int))
        (=>
          (and
            (<= (first1 temp___13403) temp___13404)
            (<= temp___13404 (last1 temp___13403)))
          (= (us_attr__init (select (to_array1 temp___13403) temp___13404)) true))))))
    ...
    (=>
      ...
      (= (to_rep2
           (rec__value
             (select (to_array1
                       (rec__ada___ada___ada__strings__superbounded__super_string__data1
                         result____split_fields1)) (+ indx1 k)))) (to_rep2
                                                                    (select 
                                                                    (to_array
                                                                    item) (+ (- 
                                                                    (first
...
;; Assert
(assert
  (= (let ((temp___13430 (let ((temp___13427 (of_array1
                                               (to_array1
                                                 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                               ...
                                               (+ indx1 ilen))))
                           (of_array1
                             (to_array1 temp___13427)
                             (first1 temp___13427)
                             (last1 temp___13427)))))
       (bool_eq5
         (convert (to_array1 temp___13430))
         (first1 temp___13430)
         (last1 temp___13430)
         (to_array item)
         (first item)
...
(assert
  (forall ((j1 Int))
    (=>
      (and (<= (+ indx1 1) j1) (<= j1 (+ indx1 ilen)))
      (= (to_rep2
           (rec__value
             (select (to_array1
                       (rec__ada___ada___ada__strings__superbounded__super_string__data1
                         result____split_fields1)) j1))) (to_rep2
                                                           (select (to_array
                                                                    item) (+ 
                                                           (first
                                                             item) (mod2
...
;; Ensures
(assert (in_range1 (* j ilen)))

;; (=)'result'unused'unused
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= indx2 (* j ilen)) true false))
...
;; LoopInvariant
(assert (= indx3 (* j1 ilen)))

;; LoopInvariant
(assert
  (let ((temp___13450 (of_array1
                        (to_array1
                          (rec__ada___ada___ada__strings__superbounded__super_string__data1
                            result____split_fields2))
                        1
                        indx3)))
    (forall ((temp___13451 Int))
      (=>
        (and
          (<= (first1 temp___13450) temp___13451)
          (<= temp___13451 (last1 temp___13450)))
        (= (us_attr__init (select (to_array1 temp___13450) temp___13451)) true)))))
...
(assert
  (= (and (ite (and
                 ...
                 (dynamic_property2 1 count j1))
            true
            false) (ite (and (<= 1 j1) (<= j1 count)) true false)) true))

;; (=)'result'unused'unused
(define-fun lpeqrpqtresultqtunusedqtunused3 () Bool
  (ite (= j1 count) true false))
...
(assert
  (forall ((temp___13391 Int))
    (ite (and (<= (+ indx3 1) temp___13391) (<= temp___13391 (+ indx3 ilen)))
      (= (select (to_array1 usf1) temp___13391) (select (to_array1
                                                          (of_array1
                                                            (convert1
                                                              (slide
                                                                (to_array
      ...
      (= (select (to_array1 usf1) temp___13391) (select (to_array1
                                                          (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                            result____split_fields2)) temp___13391)))))
    ...
    (=>
      ...
      (= (to_rep2
           (rec__value
             (select (to_array1
                       (rec__ada___ada___ada__strings__superbounded__super_string__data1
                         result____split_fields3)) (+ indx3 k)))) (to_rep2
                                                                    (select 
                                                                    (to_array
                                                                    item) (+ (- 
                                                                    (first
