        ...
        (let ((temp___13469 (of_array
          ...
          (and
            (ite (<= (first temp___13469) (last temp___13469))
              (and
                (<= (+ indx1 1) (+ indx1 ilen))
                (= (- (last temp___13469) (first temp___13469)) (- (+ 
                indx1 ilen) (+ indx1 1))))
              (< (+ indx1 ilen) (+ indx1 1)))
                      ...
                      (let ((temp___13472 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                        ...
                        (and
                          (=>
                            ...
                            (and
                              (and
                                (<= (first1 temp___13472) o1)
                                (<= o1 (last1 temp___13472)))
                              (and
                                (<= (first1 temp___13472) o)
                                (<= o (last1 temp___13472)))))
                          (let ((temp___13475 (of_array1
                                                (to_array1 temp___13472)
                                                o1
                                                o)))
                            (and
                              (ite (<= (first1 temp___13471) (last1
                                                               temp___13471))
                                (and
                                  (<= (first1 temp___13475) (last1
                                                              temp___13475))
                                  (= (- (last1 temp___13471) (first1
                                                               temp___13471)) (- 
                                  (last1
                                    temp___13475) (first1 temp___13475))))
                                (< (last1 temp___13475) (first1 temp___13475)))
                              (and
                                (and
                                  (in_range1 (+ indx1 1))
                                  (in_range1 (+ indx1 ilen)))
                                (exists ((usf us_t1))
                                  (and
                                    (and
                                      (and
                                        (= (first1 temp___13476) (first1 usf))
                                        (= (last1 temp___13476) (last1 usf)))
                                      (forall ((temp___13479 Int))
                                        (ite (and
                                               (<= (+ indx1 1) temp___13479)
                                               (<= temp___13479 (+ indx1 
                                               ilen)))
                                          (= (select (to_array1 usf) temp___13479) (select 
                                          (to_array1
                                            temp___13471) temp___13479))
                                          (= (select (to_array1 usf) temp___13479) (select 
                                          (to_array1
                                            temp___13476) temp___13479)))))
                                    (let ((temp___13486 (us_repqtmk1
                                      ...
                                      (and
                                        (and
                                          (<= (to_rep
                                                (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                  (us_split_fields1
                                                    (to_base temp___13486)))) 
                                          (to_rep1
                                            (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                              (us_split_discrs1
                                                (to_base temp___13486)))))
                                          (let ((temp___13491 (of_array1
                                                                (to_array1
                                                                  (rec__ada___ada___ada__strings__superbounded__super_string__data
                                                                    (us_split_fields1
                                                                    (to_base
                                            ...
                                            (forall ((temp___13492 Int))
                                              (=>
                                                (and
                                                  (<= (first1 temp___13491) temp___13492)
                                                  (<= temp___13492 (last1
                                                                    temp___13491)))
                                                (= (us_attr__init
                                                     (select (to_array1
                                                               temp___13491) temp___13492)) true)))))
                                        (exists ((result____split_fields2 us_split_fields2))
                                          (and
                                                              ...
                                                              (let ((o3 (- 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (not
                                                                    (< 
                                                                    indx2 o3)))))))))))))))))))))))))))))))))
    (and (= result____split_fields1 result____split_fields) (= indx2 indx1))))

;; Ensures
(assert (in_range1 (- max_length indx2)))

;; Ensures
(assert (in_range1 (+ (first item) (- (- max_length indx2) 1))))

;; Assert
(assert
  (=>
    (<= (first item) (+ (first item) (- (- max_length indx2) 1)))
    (and
      (and (<= (first item) (first item)) (<= (first item) (last item)))
      (and
        (<= (first item) (+ (first item) (- (- max_length indx2) 1)))
        (<= (+ (first item) (- (- max_length indx2) 1)) (last item))))))
             ...
             (of_array
               ...
               (last
                 (of_array
                   (to_array item)
                   (first item)
                   (+ (first item) (- (- max_length indx2) 1)))))) (last
                                                                    (of_array
                                                                    (to_array
                                                                    (of_array
                                                                    (to_array
              ...
              (of_array
                ...
                (last
                  (of_array
                    (to_array item)
                    (first item)
                    (+ (first item) (- (- max_length indx2) 1)))))) (first
                                                                    (of_array
                                                                    (to_array
                                                                    (of_array
                                                                    (to_array
  ...
  (=>
    ...
    (and
      (and
        (<= (first1
              (rec__ada___ada___ada__strings__superbounded__super_string__data1
                result____split_fields1)) (+ indx2 1))
        (<= (+ indx2 1) (last1
                          (rec__ada___ada___ada__strings__superbounded__super_string__data1
                            result____split_fields1))))
      (and
        (<= (first1
              (rec__ada___ada___ada__strings__superbounded__super_string__data1
                result____split_fields1)) max_length)
        (<= max_length (last1
                         (rec__ada___ada___ada__strings__superbounded__super_string__data1
                           result____split_fields1)))))))
...
(assert
  (= (first1
       (rec__ada___ada___ada__strings__superbounded__super_string__data1
         result____split_fields1)) (first1 usf)))

;; H
(assert
  (= (last1
       (rec__ada___ada___ada__strings__superbounded__super_string__data1
         result____split_fields1)) (last1 usf)))

;; H
(assert
  (forall ((temp___13557 Int))
    (ite (and (<= (+ indx2 1) temp___13557) (<= temp___13557 max_length))
      (= (select (to_array1 usf) temp___13557) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
                                                               ...
                                                               (+ indx2 1)))
                                                           (+ indx2 1)
                                                           max_length)) temp___13557))
      (= (select (to_array1 usf) temp___13557) (select (to_array1
                                                         (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                           result____split_fields1)) temp___13557)))))
                                  ...
                                  (us_repqtmk1
                                    ...
                                    (us_split_fieldsqtmk1
                                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                        result____split_fields1)
                                      usf)))))))))
      (forall ((temp___13568 Int))
        (=>
          (and
            (<= (first1 temp___13567) temp___13568)
            (<= temp___13568 (last1 temp___13567)))
          (= (us_attr__init (select (to_array1 temp___13567) temp___13568)) true))))))
...
(assert
  (forall ((j Int))
    (=>
      (and (<= (+ indx2 1) j) (<= j max_length))
      (= (to_rep2
           (rec__value
             (select (to_array1
                       (rec__ada___ada___ada__strings__superbounded__super_string__data1
                         result____split_fields2)) j))) (to_rep2
                                                          (select (to_array
                                                                    item) (+ (- (- 
                                                          (first
                                                            item) 1) 
...
;; Assume
(assert (= (+ indx2 1) r758b))

;; Assume
(assert (dynamic_invariant2 r758b true false true true))
...
;; H
(assert
  (= (and (ite (<= r758b j) true false) (ite (<= j max_length) true false)) true))

;; Ensures
(assert (in_range1 (- j 1)))

;; Ensures
(assert (in_range2 (- j 1)))

;; Ensures
(assert (= (mod2 (- j 1) ilen) (- (- j 1) indx2)))
...
;; H
(assert
  (= (and (ite (dynamic_property3 r758b max_length j1) true false) (ite 
                                                                    (and
                                                                    (<= 
                                                                    r758b 
                                                                    j1)
...
(define-fun lpeqrpqtresultqtunusedqtunused3 () Bool
  (ite (= j1 max_length) true false))

;; H
(assert (not (= j1 max_length)))
...
;; Ensures
(assert (in_range1 (- j2 1)))

;; Ensures
(assert (in_range2 (- j2 1)))

;; Ensures
(assert (= (mod2 (- j2 1) ilen) (- (- j2 1) indx2)))
