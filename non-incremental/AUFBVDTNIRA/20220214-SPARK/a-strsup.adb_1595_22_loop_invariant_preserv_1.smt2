              ...
              (let ((temp___13597 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                ...
                (and
                  ...
                  (let ((temp___13590 (of_array
                                        ...
                                        (last item))))
                    (and
                      (ite (<= (first temp___13590) (last temp___13590))
                        (and
                          (<= (+ indx3 1) (+ indx3 ilen))
                          (= (- (last temp___13590) (first temp___13590)) (- (+ indx3 
                          ilen) (+ indx3 1))))
                        (< (+ indx3 ilen) (+ indx3 1)))
                      (let ((temp___13592 (of_array1
                                            (convert1
                                              (slide
                                                (to_array temp___13590)
                                                (first temp___13590)
                                                (+ indx3 1)))
                                            (+ indx3 1)
                                            (+ indx3 ilen))))
                                ...
                                (let ((temp___13593 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                  ...
                                  (and
                                    (=>
                                      ...
                                      (and
                                        (and
                                          (<= (first1 temp___13593) o2)
                                          (<= o2 (last1 temp___13593)))
                                        (and
                                          (<= (first1 temp___13593) o1)
                                          (<= o1 (last1 temp___13593)))))
                                    (let ((temp___13596 (of_array1
                                                          (to_array1
                                                            temp___13593)
                                                          o2
                                                          o1)))
                                      (and
                                        (ite (<= (first1 temp___13592) 
                                          (last1
                                            temp___13592))
                                          (and
                                            (<= (first1 temp___13596) 
                                            ...
                                            (and
                                              (and
                                                ...
                                                (forall ((temp___13600 Int))
                                                  (ite (and
                                                         (<= (+ indx3 1) temp___13600)
                                                         (<= temp___13600 (+ indx3 
                                                         ilen)))
                                                    (= (select (to_array1
                                                                 usf) temp___13600) (select 
                                                    (to_array1
                                                          ...
                                                          (=>
                                                            ...
                                                            (= (to_rep2
                                                                 (rec__value
                                                                   ...
                                                                   (to_array1
                                                                    (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                                    result____split_fields2)) (+ indx3 k)))) 
                                                            (to_rep2
                                                              (select 
                                                              (to_array
                                                                item) (+ (- 
...
;; Ensures
(assert (in_range1 (- (last item) indx2)))

;; Ensures
(assert (in_range1 (+ (- (last item) indx2) 1)))

;; Assert
(assert
  (=>
    (<= (+ (- (last item) indx2) 1) (last item))
    (and
      (and
        (<= (first item) (+ (- (last item) indx2) 1))
        (<= (+ (- (last item) indx2) 1) (last item)))
      (and (<= (first item) (last item)) (<= (last item) (last item))))))
...
(assert
  (dynamic_property
    ...
    2147483647
    (first
      (of_array (to_array item) (+ (- (last item) indx2) 1) (last item)))
    (last (of_array (to_array item) (+ (- (last item) indx2) 1) (last item)))))
...
(assert
  (forall ((temp___13677 Int))
    (ite (and (<= 1 temp___13677) (<= temp___13677 indx2))
      (= (select (to_array1 usf) temp___13677) (select (to_array1
                                                         (of_array1
                                                           (convert1
                                                             (slide
                                                               (to_array
      ...
      (= (select (to_array1 usf) temp___13677) (select (to_array1
                                                         (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                           result____split_fields1)) temp___13677)))))
  ...
  (and
    ...
    (let ((temp___13687 (of_array1
      ...
      (forall ((temp___13688 Int))
        (=>
          (and
            (<= (first1 temp___13687) temp___13688)
            (<= temp___13688 (last1 temp___13687)))
          (= (us_attr__init (select (to_array1 temp___13687) temp___13688)) true))))))
...
;; Assume
(assert (dynamic_invariant r784b true false true true))
...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j r784b) true false)) true))

;; Ensures
(assert (in_range1 (- max_length indx2)))

;; Ensures
(assert (in_range2 (- max_length indx2)))

;; Ensures
(assert (in_range2 (- max_length j)))

;; Ensures
(assert
  (= (mod2 (- max_length j) ilen) (- (- max_length j) (- max_length indx2))))

;; _f'unused'unused
(define-fun usfqtunusedqtunused () Bool
  (ite (forall ((k Int))
         (=>
           (and (<= j k) (<= k max_length))
           (= (to_rep2
                (rec__value
                  (select (to_array1
                            (rec__ada___ada___ada__strings__superbounded__super_string__data1
...
;; H
(assert
  (= (and (ite (dynamic_property4 1 r784b j1) true false) (ite (and
                                                                 (<= 1 
                                                                 j1)
                                                                 (<= 
                                                                 j1 r784b))
...
;; Ensures
(assert (in_range2 (- max_length j2)))

;; Ensures
(assert
  (= (mod2 (- max_length j2) ilen) (- (- max_length j2) (- max_length 
  indx2))))
