...
(declare-datatypes ((t1045b__ref 0))
  (((t1045b__refqtmk (t1045b__content us_t)))))

;; t1045b__ref_t1045b__content__projection
(define-fun t1045b__ref_t1045b__content__projection ((a t1045b__ref)) us_t
  (t1045b__content a))

(declare-datatypes ((t1045b__init_wrapper__ref 0))
  (((t1045b__init_wrapper__refqtmk (t1045b__init_wrapper__content us_t1)))))

;; t1045b__init_wrapper__ref_t1045b__init_wrapper__content__projection
(define-fun t1045b__init_wrapper__ref_t1045b__init_wrapper__content__projection 
  ((a t1045b__init_wrapper__ref)) us_t1
  (t1045b__init_wrapper__content a))
...
(declare-datatypes ((t1046b__ref 0))
  (((t1046b__refqtmk (t1046b__content integer)))))

;; t1046b__ref_t1046b__content__projection
(define-fun t1046b__ref_t1046b__content__projection ((a t1046b__ref)) integer
  (t1046b__content a))

(declare-datatypes ((t1049b__init_wrapper__ref 0))
  (((t1049b__init_wrapper__refqtmk (t1049b__init_wrapper__content us_t1)))))

;; t1049b__init_wrapper__ref_t1049b__init_wrapper__content__projection
(define-fun t1049b__init_wrapper__ref_t1049b__init_wrapper__content__projection 
  ((a t1049b__init_wrapper__ref)) us_t1
  (t1049b__init_wrapper__content a))

(declare-datatypes ((t1051b__init_wrapper__ref 0))
  (((t1051b__init_wrapper__refqtmk (t1051b__init_wrapper__content us_t1)))))

;; t1051b__init_wrapper__ref_t1051b__init_wrapper__content__projection
(define-fun t1051b__init_wrapper__ref_t1051b__init_wrapper__content__projection 
  ((a t1051b__init_wrapper__ref)) us_t1
  (t1051b__init_wrapper__content a))

(declare-datatypes ((t1055b__init_wrapper__ref 0))
  (((t1055b__init_wrapper__refqtmk (t1055b__init_wrapper__content us_t1)))))

;; t1055b__init_wrapper__ref_t1055b__init_wrapper__content__projection
(define-fun t1055b__init_wrapper__ref_t1055b__init_wrapper__content__projection 
  ((a t1055b__init_wrapper__ref)) us_t1
  (t1055b__init_wrapper__content a))
...
;; H
(assert
  (forall ((temp___13192 Int))
    (ite (and (<= (+ pos 1) temp___13192) (<= temp___13192 (+ pos rlen)))
      (= (select (to_array1 usf) temp___13192) (select (to_array1
                                                         (of_array1
                                                           (slide
                                                             (to_array1
                                                               (of_array1
                                                             ...
                                                             (+ pos 1))
                                                           (+ pos 1)
                                                           (+ pos rlen))) temp___13192))
      (= (select (to_array1 usf) temp___13192) (select (to_array1
                                                         (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                           result____split_fields)) temp___13192)))))
                                  ...
                                  (us_repqtmk1
                                    ...
                                    (us_split_fieldsqtmk1
                                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                        result____split_fields)
                                      usf)))))))))
      (forall ((temp___13205 Int))
        (=>
          (and
            (<= (first1 temp___13204) temp___13205)
            (<= temp___13205 (last1 temp___13204)))
          (= (us_attr__init (select (to_array1 temp___13204) temp___13205)) true))))))
...
;; LoopInvariant
(assert
  (let ((temp___13232 (of_array1
                        (to_array1
                          (rec__ada___ada___ada__strings__superbounded__super_string__data1
                            result____split_fields2))
                        1
                        pos2)))
    (forall ((temp___13233 Int))
      (=>
        (and
          (<= (first1 temp___13232) temp___13233)
          (<= temp___13233 (last1 temp___13232)))
        (= (us_attr__init (select (to_array1 temp___13232) temp___13233)) true)))))
...
(assert
  (forall ((temp___13192 Int))
    (ite (and (<= (+ pos2 1) temp___13192) (<= temp___13192 (+ pos2 rlen)))
      (= (select (to_array1 usf1) temp___13192) (select (to_array1
                                                          (of_array1
                                                            (slide
                                                              (to_array1
                                                                (of_array1
                                                              ...
                                                              (+ pos2 1))
                                                            (+ pos2 1)
                                                            (+ pos2 rlen))) temp___13192))
      (= (select (to_array1 usf1) temp___13192) (select (to_array1
                                                          (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                            result____split_fields2)) temp___13192)))))
