...
(declare-const temp___7709 Bool)
...
(assert
  (ite (< (- o (length right)) (super_length left))
    (= temp___7709 (ite (= drop 0) true false))
    (= temp___7709 false)))
...
(assert
  (ite (= spark__branch true)
    (let ((temp___7732 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                         result____split_fields)))
      (let ((temp___7724 (rec__ada___ada___ada__strings__superbounded__super_string__data
                           (us_split_fields1 left))))
        (and
          (=>
            (<= 1 llen)
            (and
              (and (<= (first1 temp___7724) 1) (<= 1 (last1 temp___7724)))
              (and
                (<= (first1 temp___7724) llen)
                (<= llen (last1 temp___7724)))))
          (let ((temp___7726 (of_array1 (to_array1 temp___7724) 1 llen)))
            (and
              (ite (<= (first1 temp___7726) (last1 temp___7726))
                (and
                  (<= 1 llen)
                  (= (- (last1 temp___7726) (first1 temp___7726)) (- 
                  llen 1)))
                (< llen 1))
              (let ((temp___7728 (of_array1
                                   (to_array1 temp___7726)
                                   (first1 temp___7726)
                                   (last1 temp___7726))))
                (let ((temp___7729 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                     result____split_fields)))
                  (and
                    (=>
                      (<= 1 llen)
                      (and
                        (and
                          (<= (first1 temp___7729) 1)
                          (<= 1 (last1 temp___7729)))
                        (and
                          (<= (first1 temp___7729) llen)
                          (<= llen (last1 temp___7729)))))
                    (let ((temp___7731 (of_array1
                                         (to_array1 temp___7729)
                                         1
                                         llen)))
                      (and
                        (ite (<= (first1 temp___7728) (last1 temp___7728))
                          (and
                            (<= (first1 temp___7731) (last1 temp___7731))
                            (= (- (last1 temp___7728) (first1 temp___7728)) (- 
                            (last1
                              temp___7731) (first1 temp___7731))))
                          (< (last1 temp___7731) (first1 temp___7731)))
                        (and
                          (and
                            (and
                              (= (first1 temp___7732) (first1 usf5))
                              (= (last1 temp___7732) (last1 usf5)))
                            (forall ((temp___7735 Int))
                              (ite (and
                                     (<= 1 temp___7735)
                                     (<= temp___7735 llen))
                                (= (select (to_array1 usf5) temp___7735) (select 
                                (to_array1
                                  temp___7728) temp___7735))
                                (= (select (to_array1 usf5) temp___7735) (select 
                                (to_array1
                                  temp___7732) temp___7735)))))
                          (let ((temp___7740 (us_repqtmk1
                            ...
                            (and
                              (and
                                (<= (to_rep
                                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                        (us_split_fields1
                                          (to_base temp___7740)))) (to_rep1
                                                                    (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                                    (us_split_discrs1
                                                                    (to_base
                                                                    temp___7740)))))
                                (let ((temp___7745 (of_array1
                                                     (to_array1
                                                       (rec__ada___ada___ada__strings__superbounded__super_string__data
                                                         (us_split_fields1
                                                           (to_base
                                                     ...
                                                     (to_rep
                                                       (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                         (us_split_fields1
                                                           (to_base
                                                             temp___7740)))))))
                                  (forall ((temp___7746 Int))
                                    (=>
                                      (and
                                        (<= (first1 temp___7745) temp___7746)
                                        (<= temp___7746 (last1 temp___7745)))
                                      (= (us_attr__init
                                           (select (to_array1 temp___7745) temp___7746)) true)))))
                              (and
                                ...
                                (and
                                  (and
                                    ...
                                    (ite (= spark__branch5 true)
                                      (let ((temp___7758 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                        ...
                                        (and
                                          (dynamic_property
                                            ...
                                            (first right)
                                            (last right))
                                          (let ((temp___7751 (of_array
                                                               (to_array
                                                                 right)
                                                               (first right)
                                                               (last right))))
                                            (and
                                              (ite (<= (first temp___7751) 
                                                (last
                                                  temp___7751))
                                                (and
                                                  (<= (+ llen 1) (+ llen 
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf6) temp___7761) (select 
                                                                    (to_array1
                                                                    temp___7753) temp___7761))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf6) temp___7761) (select 
                                                                    (to_array1
                                                                    temp___7758) temp___7761)))))
                                                                    (let ((temp___7768 
                                                                    (us_repqtmk1
                                                                    result____split_discrs
                                                                    (us_split_fieldsqtmk1
                                            ...
                                            (and
                                              ...
                                              (let ((temp___7785 (of_array1
                                                                   ...
                                                                   (to_rep
                                                                    ...
                                                                    (to_base
                                                                    temp___7780)))))))
                                                (forall ((temp___7786 Int))
                                                  (=>
                                                    (and
                                                      (<= (first1
                                                            temp___7785) temp___7786)
                                                      (<= temp___7786 
                                                      (last1
                                                        temp___7785)))
                                                    (= (us_attr__init
                                                         (select (to_array1
                                                                   temp___7785) temp___7786)) true)))))
        ...
        (ite (= spark__branch1 true)
          (and
            ...
            (ite (= spark__branch4 true)
              (let ((temp___7790 (rec__ada___ada___ada__strings__superbounded__super_string__data
                                   (us_split_fields1 left))))
                (and
                  (ite (<= (first1 temp___7790) (last1 temp___7790))
                    (and
                      (<= 1 max_length)
                      (= (- (last1 temp___7790) (first1 temp___7790)) (- 
                      max_length 1)))
                    (< max_length 1))
                  (let ((temp___7792 (of_array1
                                       (to_array1 temp___7790)
                                       (first1 temp___7790)
                                       (last1 temp___7790))))
                    (let ((temp___7793 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                         result____split_fields)))
                      (and
                        (ite (<= (first1 temp___7792) (last1 temp___7792))
                          (and
                            (<= (first1 temp___7793) (last1 temp___7793))
                            (= (- (last1 temp___7792) (first1 temp___7792)) (- 
                            (last1
                              temp___7793) (first1 temp___7793))))
                          (< (last1 temp___7793) (first1 temp___7793)))
                        (let ((temp___7796 (us_repqtmk1
                                             result____split_discrs
                                             (us_split_fieldsqtmk1
                                               (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                                 result____split_fields)
                          ...
                          (and
                            (and
                              (<= (to_rep
                                    (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                      (us_split_fields1
                                        (to_base temp___7796)))) (to_rep1
                                                                   (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                                    (us_split_discrs1
                                                                    (to_base
                                                                    temp___7796)))))
                              (let ((temp___7801 (of_array1
                                                   (to_array1
                                                     (rec__ada___ada___ada__strings__superbounded__super_string__data
                                                       (us_split_fields1
                                                         (to_base
                                                   ...
                                                   (to_rep
                                                     (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                       (us_split_fields1
                                                         (to_base
                                                           temp___7796)))))))
                                (forall ((temp___7802 Int))
                                  (=>
                                    (and
                                      (<= (first1 temp___7801) temp___7802)
                                      (<= temp___7802 (last1 temp___7801)))
                                    (= (us_attr__init
                                         (select (to_array1 temp___7801) temp___7802)) true)))))
                            (= result____split_fields2 (us_split_fieldsqtmk1
                                                         (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                                           result____split_fields)
                                                         temp___7792)))))))))
              (let ((temp___7814 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                   result____split_fields)))
                (let ((temp___7806 (rec__ada___ada___ada__strings__superbounded__super_string__data
                                     (us_split_fields1 left))))
                  (and
                    (=>
                      (<= 1 llen)
                      (and
                        (and
                          (<= (first1 temp___7806) 1)
                          (<= 1 (last1 temp___7806)))
                        (and
                          (<= (first1 temp___7806) llen)
                          (<= llen (last1 temp___7806)))))
                    (let ((temp___7808 (of_array1
                                         (to_array1 temp___7806)
                                         1
                                         llen)))
                      (and
                        (ite (<= (first1 temp___7808) (last1 temp___7808))
                          (and
                            (<= 1 llen)
                            (= (- (last1 temp___7808) (first1 temp___7808)) (- 
                            llen 1)))
                          (< llen 1))
                        (let ((temp___7810 (of_array1
                                             (to_array1 temp___7808)
                                             (first1 temp___7808)
                                             (last1 temp___7808))))
                          (let ((temp___7811 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                               result____split_fields)))
                            (and
                              (=>
                                (<= 1 llen)
                                (and
                                  (and
                                    (<= (first1 temp___7811) 1)
                                    (<= 1 (last1 temp___7811)))
                                  (and
                                    (<= (first1 temp___7811) llen)
                                    (<= llen (last1 temp___7811)))))
                              (let ((temp___7813 (of_array1
                                                   (to_array1 temp___7811)
                                                   1
                                                   llen)))
                                (and
                                  (ite (<= (first1 temp___7810) (last1
                                                                  temp___7810))
                                    (and
                                      (<= (first1 temp___7813) (last1
                                                                 temp___7813))
                                      (= (- (last1 temp___7810) (first1
                                                                  temp___7810)) (- 
                                      (last1
                                        temp___7813) (first1 temp___7813))))
                                    (< (last1 temp___7813) (first1
                                                             temp___7813)))
                                  (and
                                    (and
                                      (and
                                        (= (first1 temp___7814) (first1 usf3))
                                        (= (last1 temp___7814) (last1 usf3)))
                                      (forall ((temp___7817 Int))
                                        (ite (and
                                               (<= 1 temp___7817)
                                               (<= temp___7817 llen))
                                          (= (select (to_array1 usf3) temp___7817) (select 
                                          (to_array1
                                            temp___7810) temp___7817))
                                          (= (select (to_array1 usf3) temp___7817) (select 
                                          (to_array1
                                            temp___7814) temp___7817)))))
                                    (let ((temp___7822 (us_repqtmk1
                                                         result____split_discrs
                                                         (us_split_fieldsqtmk1
                                                           (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                                             result____split_fields)
                                                               ...
                                                               (to_rep
                                                                 (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                                   (us_split_fields1
                                                                    (to_base
                                                                    temp___7822)))))))
                                            (forall ((temp___7828 Int))
                                              (=>
                                                (and
                                                  (<= (first1 temp___7827) temp___7828)
                                                  (<= temp___7828 (last1
                                                                    temp___7827)))
                                                (= (us_attr__init
                                                     (select (to_array1
                                                               temp___7827) temp___7828)) true)))))
                                        (and
                                          ...
                                          (us_split_fieldsqtmk1
                                            (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                              result____split_fields)
                                            usf3))
                                          (let ((temp___7842 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                               result____split_fields4)))
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___7836 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf4) temp___7845) (select 
                                                                    (to_array1
                                                                    temp___7838) temp___7845))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf4) temp___7845) (select 
                                                                    (to_array1
                                                                    temp___7842) temp___7845)))))
                                                                    (let ((temp___7850 
                                                                    (us_repqtmk1
                                                                    result____split_discrs
                                                                    (us_split_fieldsqtmk1
            ...
            (and
              ...
              (and
                ...
                (ite (= spark__branch3 true)
                  (let ((temp___7870 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                       result____split_fields)))
                    (let ((temp___7861 (last right)))
                            ...
                            (=>
                              ...
                              (and
                                (and
                                  ...
                                  (<= o3 (last right)))
                                (and
                                  (<= (first right) temp___7861)
                                  (<= temp___7861 (last right)))))
                            (let ((temp___7862 (of_array
                                                 (to_array right)
                                                 o3
                                                 temp___7861)))
                              (and
                                (dynamic_property
                                  ...
                                  (first temp___7862)
                                  (last temp___7862))
                                (let ((temp___7864 (of_array
                                                     (to_array temp___7862)
                                                     (first temp___7862)
                                                     (last temp___7862))))
                                  (and
                                    (ite (<= (first temp___7864) (last
                                                                   temp___7864))
                                      (and
                                        (<= 1 max_length)
                                        (= (- (last temp___7864) (first
                                                                   temp___7864)) (- 
                                        max_length 1)))
                                      (< max_length 1))
                                    (let ((temp___7866 (of_array1
                                                         (convert
                                                           (slide
                                                             (to_array
                                                               temp___7864)
                                                         ...
                                                         1
                                                         max_length)))
                                      (let ((temp___7867 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                           result____split_fields)))
                                        (and
                                          (=>
                                            (<= 1 max_length)
                                            (and
                                              ...
                                              (and
                                                ...
                                                (<= max_length (last1
                                                                 temp___7867)))))
                                          (let ((temp___7869 (of_array1
                                                               (to_array1
                                                                 temp___7867)
                                                               1
                                                               max_length)))
                                            (and
                                              (ite (<= (first1 temp___7866) 
                                                (last1
                                                  temp___7866))
                                                (and
                                                  (<= (first1 temp___7869) 
                                              ...
                                              (and
                                                (and
                                                  (and
                                                    ...
                                                    (last1
                                                      usf2)))
                                                  (forall ((temp___7873 Int))
                                                    (ite (and
                                                           (<= 1 temp___7873)
                                                           (<= temp___7873 
                                                           max_length))
                                                      (= (select (to_array1
                                                                   usf2) temp___7873) (select 
                                                      (to_array1
                                                        temp___7866) temp___7873))
                                                      (= (select (to_array1
                                                                   usf2) temp___7873) (select 
                                                      (to_array1
                                                        temp___7870) temp___7873)))))
                                                (let ((temp___7878 (us_repqtmk1
                                                                    result____split_discrs
                                                                    (us_split_fieldsqtmk1
                                                                    (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                                                    result____split_fields)
                                                          ...
                                                          (to_rep
                                                            (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                              (us_split_fields1
                                                                (to_base
                                                                  temp___7878)))))))
                                                        (forall ((temp___7884 Int))
                                                          (=>
                                                            (and
                                                              (<= (first1
                                                                    temp___7883) temp___7884)
                                                              (<= temp___7884 
                                                              (last1
                                                                temp___7883)))
                                                            (= (us_attr__init
                                                                 (select 
                                                                 (to_array1
                                                                   temp___7883) temp___7884)) true)))))
                                                    (= result____split_fields2 
                                                    (us_split_fieldsqtmk1
                                                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length1
                                                        result____split_fields)
                                                      usf2)))))))))))))))))))
                  (let ((temp___7897 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                       result____split_fields)))
                    (let ((o3 (- max_length rlen)))
                      (and
                        ...
                        (let ((o4 (- llen (- o3 1))))
                          (and
                            (in_range1 o4)
                            (let ((temp___7888 (rec__ada___ada___ada__strings__superbounded__super_string__data
                                                 (us_split_fields1 left))))
                              (and
                                (=>
                                  (<= o4 llen)
                                  (and
                                    (and
                                      (<= (first1 temp___7888) o4)
                                      (<= o4 (last1 temp___7888)))
                                    (and
                                      (<= (first1 temp___7888) llen)
                                      (<= llen (last1 temp___7888)))))
                                (let ((temp___7890 (of_array1
                                                     (to_array1 temp___7888)
                                                     o4
                                                     llen)))
                                  (and
                                    (ite (<= (first1 temp___7890) (last1
                                                                    temp___7890))
                                      (and
                                        (<= 1 (- max_length rlen))
                                        (= (- (last1 temp___7890) (first1
                                                                    temp___7890)) (- (- 
                                        max_length rlen) 1)))
                                      (< (- max_length rlen) 1))
                                    (let ((temp___7892 (of_array1
                                                         (slide1
                                                           (to_array1
                                                             temp___7890)
                                                           (first1
                                      ...
                                      (let ((o5 (- max_length rlen)))
                                        (and
                                          (in_range1 o5)
                                          (let ((temp___7893 (rec__ada___ada___ada__strings__superbounded__super_string__data1
                                                               result____split_fields)))
                                            (and
                                              (=>
                                                (<= 1 o5)
                                                (and
                                                  (and
                                                    (<= (first1 temp___7893) 1)
                                                    (<= 1 (last1 temp___7893)))
                                                  (and
                                                    (<= (first1 temp___7893) o5)
                                                    (<= o5 (last1
                                                             temp___7893)))))
                                              (let ((temp___7896 (of_array1
                                                                   (to_array1
                                                                    temp___7893)
                                                                   1
                                                                   o5)))
                                                      ...
                                                      (and
                                                        ...
                                                        (forall ((temp___7900 Int))
                                                          (ite (and
                                                            ...
                                                            (= (select 
                                                            (to_array1
                                                              usf) temp___7900) (select 
                                                            (to_array1
                                                              temp___7892) temp___7900))
                                                            (= (select 
                                                            (to_array1
                                                              usf) temp___7900) (select 
                                                            (to_array1
                                                              temp___7897) temp___7900)))))
                                                      (let ((temp___7907 
                                                        (us_repqtmk1
                                                          result____split_discrs
                                                          (us_split_fieldsqtmk1
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___7918 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf1) temp___7927) (select 
                                                                    (to_array1
                                                                    temp___7920) temp___7927))
                                                                    (= (select 
                                                                    (to_array1
                                                                    usf1) temp___7927) (select 
                                                                    (to_array1
                                                                    temp___7924) temp___7927)))))
                                                                    (let ((temp___7932 
                                                                    (us_repqtmk1
                                                                    result____split_discrs
                                                                    (us_split_fieldsqtmk1
        ...
        (let ((temp___7944 (us_repqtmk1
          ...
          (and
            (and
              (<= (to_rep
                    (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                      (us_split_fields1 (to_base temp___7944)))) (to_rep1
                                                                   (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                                    (us_split_discrs1
                                                                    (to_base
                                                                    temp___7944)))))
              (let ((temp___7949 (of_array1
                                   (to_array1
                                     (rec__ada___ada___ada__strings__superbounded__super_string__data
                                       (us_split_fields1
                                         (to_base temp___7944))))
                                   ...
                                   (to_rep
                                     (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                       (us_split_fields1
                                         (to_base temp___7944)))))))
                (forall ((temp___7950 Int))
                  (=>
                    (and
                      (<= (first1 temp___7949) temp___7950)
                      (<= temp___7950 (last1 temp___7949)))
                    (= (us_attr__init
                         (select (to_array1 temp___7949) temp___7950)) true)))))
  ...
  (=>
    ...
    (and
      (and
        ...
        (super_length
          left) (length right)))
        (= (let ((temp___7964 (super_to_string left)))
      ...
      (=>
        (< 0 (length right))
        (= (let ((temp___7966 (super_slice
                                ada___ada___ada__strings__superbounded__super_append__2__result
                                (+ (super_length left) 1)
                                (super_length
                                  ada___ada___ada__strings__superbounded__super_append__2__result))))
             (bool_eq5
               (to_array temp___7966)
               (first temp___7966)
               (last temp___7966)
               (to_array right)
               (first right)
          ...
          (= (let ((temp___7982 (super_slice
               ...
               (let ((temp___7980 (super_slice
                                    ...
                                    (length
                                      right)))))
                 (bool_eq5
                   (to_array temp___7980)
                   (first temp___7980)
                   (last temp___7980)
                   (to_array temp___7982)
                   (first temp___7982)
                   (last temp___7982)))) true)
          (= (let ((temp___7984 (super_slice
                                  ada___ada___ada__strings__superbounded__super_append__2__result
                                  (+ (- (to_rep1
                                          (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                            (us_split_discrs1 left))) 
                                  ...
                                  (to_rep1
                                    (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                      (us_split_discrs1 left))))))
               (bool_eq5
                 (to_array temp___7984)
                 (first temp___7984)
                 (last temp___7984)
                 (to_array right)
                 (first right)
                 (last right))) true))
        (= (let ((temp___7990 (of_array
                                (to_array right)
                                (+ (- (last right) (to_rep1
                                                     (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                       (us_split_discrs1
                                                         left)))) 1)
                                (last right))))
             (let ((temp___7988 (super_to_string
                                  ada___ada___ada__strings__superbounded__super_append__2__result)))
               (bool_eq5
                 (to_array temp___7988)
                 (first temp___7988)
                 (last temp___7988)
                 (to_array temp___7990)
                 (first temp___7990)
                 (last temp___7990)))) true)))))
    ...
    (not
      (= (or (ite (<= (super_length left) (- (to_rep1
               ...
               (length
                 right)))
               true
               false) temp___7709) true))
    (=>
      (< (super_length left) (to_rep1
                               (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                 (us_split_discrs1 left))))
      (= (let ((temp___8010 (of_array
                              (to_array right)
                              (first right)
                              (+ (- (- (to_rep1
                                         (rec__ada___ada___ada__strings__superbounded__super_string__max_length
           ...
           (let ((temp___8008 (super_slice
                                ...
                                (to_rep1
                                  (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                    (us_split_discrs1 left))))))
             (bool_eq5
               (to_array temp___8008)
               (first temp___8008)
               (last temp___8008)
               (to_array temp___8010)
               (first temp___8010)
               (last temp___8010)))) true)))))
