...
(assert
  (ite (not (= count 0))
    (and
      (= (to_rep
           (rec__ada___ada___ada__strings__superbounded__super_string__max_length
             (us_split_discrs1 item))) o)
      (let ((o1 item))
        (let ((o2 (super_length o1)))
          (and
            (and
              ...
              (= o2 (to_rep3
                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                        (us_split_fields1 o1)))))
            (= temp___13724 (ite (<= o2 (div1 o count)) true false))))))
    (= temp___13724 (of_int 1))))

(declare-const temp___13725 Bool)
          ...
          (and
            (and
              ...
              (= o4 (to_rep3
                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                        (us_split_fields1 o3)))))
            (= o1 (ite (< (div1 o2 count) o4) true false))))))
    (= o1 false)))

;; H
(assert
  (ite (= o1 true)
    (= temp___13725 (ite (= drop 1) true false))
    (= temp___13725 false)))
