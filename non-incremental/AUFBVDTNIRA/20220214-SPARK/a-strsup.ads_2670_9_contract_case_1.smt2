...
(declare-const dummy5 character__init_wrapper)

;; dummy__def
(assert (= (us_attr__init dummy5) false))
...
(define-fun super_to_string ((source us_rep)) us_t
  (let ((temp___183 (let ((temp___181 (let ((temp___180 (to_rep3
                                                          (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                            (us_split_fields1
                                                              source)))))
                                        (let ((temp___179 1))
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_1285 us_rep) (temp___is_init_1281 Bool) (temp___skip_constant_1282 Bool) (temp___do_toplevel_1283 Bool) (temp___do_typ_inv_1284 Bool)) Bool
  (and
    (=>
      ...
      (and
        (<= (to_rep3
              (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                (us_split_fields1 temp___expr_1285))) (to_rep
                                                        (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                          (us_split_discrs1
                                                            temp___expr_1285))))
        (= (let ((temp___1290 (let ((temp___1289 (to_rep3
                                                   (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                                                     (us_split_fields1
                                                       temp___expr_1285)))))
                                (let ((temp___1288 1))
    ...
    (let ((temp___1293 (rec__ada___ada___ada__strings__superbounded__super_string__max_length
      ...
      (=>
        ...
        (and
          ...
          (= (last1
               (rec__ada___ada___ada__strings__superbounded__super_string__data
                 (us_split_fields1 temp___expr_1285))) (to_rep temp___1293)))))))
...
;; length
(define-fun length2 ((x Int) (y Int)) Int
  (ite (<= x y) (+ (- y x) 1) 0))

;; super_replicate
(declare-fun super_replicate (Int
  us_t
  Int
  Int) us_rep)

;; super_replicate__function_guard
(declare-fun super_replicate__function_guard (us_rep
  Int
  us_t
  Int
  Int) Bool)
...
(assert
  (forall ((left us_rep) (right us_rep))
    (! (=>
         (and
           (and
             (dynamic_invariant2 left true true true true)
             (dynamic_invariant2 right true true true true))
           (= (to_rep
                (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                  (us_split_discrs1 left))) (to_rep
                                              (rec__ada___ada___ada__strings__superbounded__super_string__max_length
  ...
  (=>
    (and
      ...
      (< (div1
           (to_rep
             (rec__ada___ada___ada__strings__superbounded__super_string__max_length
               (us_split_discrs1 item)))
           count) (super_length item)))
    (not (= drop 2))))

(declare-const temp___13332 Bool)
...
(assert
  (ite (not (= count 0))
    (and
      (= (to_rep
           (rec__ada___ada___ada__strings__superbounded__super_string__max_length
             (us_split_discrs1 item))) o1)
      (let ((o2 item))
        (let ((o3 (super_length o2)))
          (and
            (and
              (dynamic_invariant o3 true false true true)
              (= o3 (to_rep3
                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                        (us_split_fields1 o2)))))
            (= o (ite (< (div1 o1 count) o3) true false))))))
    (= o false)))

;; H
(assert
  (ite (= o true)
    (= temp___13332 (ite (= drop 1) true false))
    (= temp___13332 false)))

(declare-const temp___13331 Bool)
...
(assert
  (ite (not (= count 0))
    (and
      (= (to_rep
           (rec__ada___ada___ada__strings__superbounded__super_string__max_length
             (us_split_discrs1 item))) o2)
      (let ((o3 item))
        (let ((o4 (super_length o3)))
          (and
            (and
              ...
              (= o4 (to_rep3
                      (rec__ada___ada___ada__strings__superbounded__super_string__current_length
                        (us_split_fields1 o3)))))
            (= temp___13331 (ite (<= o4 (div1 o2 count)) true false))))))
    (= temp___13331 (of_int 1))))

;; H
(assert (dynamic_invariant1 (super_to_string item) true false true true))

;; H
(assert
  (= (super_to_string item) (let ((temp___1326 (let ((temp___1324 (of_array1
                                                                    (to_array1
                                                                    (rec__ada___ada___ada__strings__superbounded__super_string__data
                                                                    (us_split_fields1
                                                                    item)))
                                                                    ...
                                                                    item))))))
                                                 (of_array1
                                                   (to_array1 temp___1324)
                                                   (first1 temp___1324)
                                                   (last1 temp___1324)))))
                              (of_array
                                (convert (to_array1 temp___1326))
                                (first1 temp___1326)
                                (last1 temp___1326)))))
       ...
       (rec__ada___ada___ada__strings__superbounded__super_string__max_length
         (us_split_discrs1
           (super_replicate
             ...
             (to_rep
               (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                 (us_split_discrs1 item))))))) (to_rep
                                                 (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                   (us_split_discrs1 item)))))

;; H
(assert
  (ite (= (or (bool_eq9 count 0) (bool_le
                                   (length (super_to_string item))
                                   (div1
                                     (to_rep
                                       (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                         (us_split_discrs1 item)))
    ...
    (and
      (= (super_length
           (super_replicate
             ...
             (to_rep
               (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                 (us_split_discrs1 item))))) (* count (length
                                                        (super_to_string
                                                          item))))
      (=>
        (< 0 (length (super_to_string item)))
        (forall ((k Int))
          (=>
            (and (<= 1 k) (<= k (* count (length (super_to_string item)))))
            (= (super_element
                 (super_replicate
                   count
                   (super_to_string item)
                   ...
                   (to_rep
                     (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                       (us_split_discrs1 item))))
                 k) (to_rep1
                      (select (to_array (super_to_string item)) (+ (first
                                                                    (super_to_string
                                                                    item)) 
                      (mod2
                        (- k 1)
                        (length (super_to_string item)))))))))))
    (ite (= (and (and (bool_ne count 0) (bool_gt
                                          (length (super_to_string item))
                                          (div1
                                            (to_rep
                                              (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                                                (us_split_discrs1 item)))
                                            count))) (bool_eq9 drop 1)) true)
      (and
        (= (super_length
             (super_replicate
               count
                 ...
                 (super_replicate
                   ...
                   (to_rep
                     (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                       (us_split_discrs1 item))))
                 k) (to_rep1
                      (select (to_array (super_to_string item)) (- (last
                                                                    (super_to_string
                                                                    item)) 
                      (mod2
                        (- (to_rep
                             (rec__ada___ada___ada__strings__superbounded__super_string__max_length
                               (us_split_discrs1 item))) k)
                        (length (super_to_string item)))))))))))))

(declare-const ada___ada___ada__strings__superbounded__super_replicate__3__result us_rep)

;; H
(assert
  (= ada___ada___ada__strings__superbounded__super_replicate__3__result 
  (super_replicate
    count
    (super_to_string item)
    drop
...
;; Goal def'vc
;; File "a-strsup.ads", line 2658, characters 0-0
(assert
  (not
  (=>
    (= temp___13331 true)
    (=>
      ...
      (forall ((k Int))
        (=>
          (and (<= 1 k) (<= k (* count (super_length item))))
          (= (super_element
               ada___ada___ada__strings__superbounded__super_replicate__3__result
               k) (super_element
                    item
                    (+ 1 (mod2 (- k 1) (super_length item)))))))))))
