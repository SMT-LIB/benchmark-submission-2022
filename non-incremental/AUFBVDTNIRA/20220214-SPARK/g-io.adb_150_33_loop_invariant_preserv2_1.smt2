...
(declare-datatypes ((t16b__init_wrapper__ref 0))
  (((t16b__init_wrapper__refqtmk (t16b__init_wrapper__content us_t1)))))

;; t16b__init_wrapper__ref_t16b__init_wrapper__content__projection
(define-fun t16b__init_wrapper__ref_t16b__init_wrapper__content__projection 
  ((a t16b__init_wrapper__ref)) us_t1
  (t16b__init_wrapper__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_205 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool) (temp___do_typ_inv_204 Bool)) Bool
  (=>
    (= temp___do_toplevel_203 true)
    (=> (= temp___is_init_201 true) (< 0 temp___expr_205))))

;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool
  (=>
...
;; Ensures
(assert (= (div1 (big int__1) (big 10)) (big (div1 int__1 10))))

;; Assert
(assert (< 0 big_10))

;; Ensures
(assert (in_range2 (- 12 first2)))

;; Assert
(assert true)

;; Assert
(assert (< 0 (power big_10 (- 12 first2))))

;; H
(assert true)

;; H
(assert (= (big int_init1) int_init1))

;; Assert
(assert true)

;; Assert
(assert (<= 0 (- (big int_init1))))

;; Ensures
(assert
  (= (div1 (div1 (- (big int_init1)) (power big_10 (- 12 first2))) big_10) 
  (div1
    (- (big int_init1))
    (* (power big_10 (- 12 first2)) big_10))))
...
;; LoopInvariant
(assert
  (let ((temp___285 (of_array1 s2 first4 11)))
    (forall ((temp___286 Int))
      (=>
        (and
          (<= (first1 temp___285) temp___286)
          (<= temp___286 (last1 temp___285)))
        (= (us_attr__init (select (to_array1 temp___285) temp___286)) true)))))
...
;; Ensures
(assert (= (div1 (big int__3) (big 10)) (big (div1 int__3 10))))

;; Assert
(assert (< 0 big_10))

;; Ensures
(assert (in_range2 (- 12 first4)))

;; Assert
(assert true)

;; Assert
(assert (< 0 (power big_10 (- 12 first4))))
...
;; Ensures
(assert
  (= (div1 (div1 (- (big int_init1)) (power big_10 (- 12 first4))) big_10) 
  (div1
    (- (big int_init1))
    (* (power big_10 (- 12 first4)) big_10))))
