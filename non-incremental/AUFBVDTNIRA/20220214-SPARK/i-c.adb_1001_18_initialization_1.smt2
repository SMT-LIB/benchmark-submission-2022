      ...
      (and
        (forall ((k Int))
          (to_c__function_guard
            (to_c (to_rep (select (to_array item) k)))
            (to_rep (select (to_array item) k))))
        (ite (= (and (ite (<= (first item) j) true false) (ite (<= j temp___2013)
                                                            true
                                                            false)) true)
                  ...
                  (exists ((o2 (_ BitVec 64)))
                    (and
                      ...
                      (exists ((o3 (_ BitVec 64)))
                        (and
                          (= (to_rep2 r__first) o3)
                          (let ((temp___2015 (of_array2 r o3 o2)))
                            (exists ((o4 Int))
                              (and
                                (= (to_rep (select (to_array item) j)) o4)
                                (let ((o5 (to_c o4)))
                                  (and
                                    (and
                                      (to_c__function_guard o5 o4)
                                      (and
                                        (dynamic_invariant2
                                          o5
                                          true
                                              ...
                                              (let ((temp___2017 (of_int o7)))
                                                (and
                                                  (and
                                                    ...
                                                    (last2
                                                      temp___2015)))
                                                  (exists ((r3 (Array (_ BitVec 64) char16_t__init_wrapper)))
                                                    (and
                                                      (= r3 (to_array2
                                                              (us_tqtmk2
                                                                (store 
...
(assert
  (and
    (bvule (first2 (of_array2 r2 (to_rep2 r__first) (to_rep2 r__last))) 
    (to_rep2
      r__last))
    (bvule (to_rep2 r__last) (last2
                               (of_array2
                                 r2
                                 (to_rep2 r__first)
                                 (to_rep2 r__last))))))
...
(assert
  (= r3 (to_array2
          (us_tqtmk2
            (store (to_array2
                     (of_array2 r2 (to_rep2 r__first) (to_rep2 r__last))) 
            (to_rep2
              r__last) (char16_t__init_wrapperqtmk o true))
            (rt2 (of_array2 r2 (to_rep2 r__first) (to_rep2 r__last)))))))
...
(assert
  (and
    ...
    (of_int
      (- usf (first item))))
    (bvule (of_int (- usf (first item))) (last2
                                           (of_array2
                                             r3
                                             (to_rep2 r__first)
                                             (to_rep2 r__last))))))
