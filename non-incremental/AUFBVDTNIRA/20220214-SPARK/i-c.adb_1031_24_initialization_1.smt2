...
(define-fun length2 ((a us_t2)) Int
  (ite (bvule (first2 a) (last2 a))
    (+ (- (bv2nat64 (last2 a)) (bv2nat64 (first2 a))) 1)
    0))
...
(declare-datatypes ((t321b__ref 0))
  (((t321b__refqtmk (t321b__content integer)))))

;; t321b__ref_t321b__content__projection
(define-fun t321b__ref_t321b__content__projection ((a t321b__ref)) integer
  (t321b__content a))
...
(declare-datatypes ((t333b__ref 0))
  (((t333b__refqtmk (t333b__content integer)))))

;; t333b__ref_t333b__content__projection
(define-fun t333b__ref_t333b__content__projection ((a t333b__ref)) integer
  (t333b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_519 us_t1) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool) (temp___do_typ_inv_518 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1056 us_t1) (temp___is_init_1052 Bool) (temp___skip_constant_1053 Bool) (temp___do_toplevel_1054 Bool) (temp___do_typ_inv_1055 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (of_int (length item))
          (first1 temp___expr_1056)
          (last1 temp___expr_1056))
        (= (first1 temp___expr_1056) #x0000000000000000))
      (= (last1 temp___expr_1056) (of_int (length item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1058 us_t1) (temp___skip_top_level_1059 Bool)) Bool
  (and
    (= (first1 temp___expr_1058) #x0000000000000000)
    (= (last1 temp___expr_1058) (of_int (length item)))))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_1066 us_t1) (temp___is_init_1062 Bool) (temp___skip_constant_1063 Bool) (temp___do_toplevel_1064 Bool) (temp___do_typ_inv_1065 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1063 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (bvsub (of_int (length item)) #x0000000000000001)
          (first1 temp___expr_1066)
          (last1 temp___expr_1066))
        (= (first1 temp___expr_1066) #x0000000000000000))
      (= (last1 temp___expr_1066) (bvsub (of_int (length item)) #x0000000000000001)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_1068 us_t1) (temp___skip_top_level_1069 Bool)) Bool
  (and
    (= (first1 temp___expr_1068) #x0000000000000000)
    (= (last1 temp___expr_1068) (bvsub (of_int (length item)) #x0000000000000001))))
...
(assert
  (and
    ...
    (= (last2 (of_array2 r1 (to_rep2 r__first1) (to_rep2 r__last1))) (bvsub 
    (of_int
      (length item)) #x0000000000000001))))
...
(assert
  (and
    (bvule (first2 (of_array2 r1 (to_rep2 r__first1) (to_rep2 r__last1))) 
    (of_int
      (- j (first item))))
    (bvule (of_int (- j (first item))) (last2
                                         (of_array2
                                           r1
                                           (to_rep2 r__first1)
                                           (to_rep2 r__last1))))))
...
(assert
  (= r2 (to_array2
          (us_tqtmk2
            (store (to_array2
                     (of_array2 r1 (to_rep2 r__first1) (to_rep2 r__last1))) 
            (of_int
             ...
             (rec__value
               (select (to_array2
                         (of_array2
                           r3
                           (to_rep2 r__first1)
                           (to_rep2 r__last1))) (of_int (- k (first item)))))) 
        (to_c
...
(assert
  (and
    (bvule (first2 (of_array2 r3 (to_rep2 r__first1) (to_rep2 r__last1))) 
    (of_int
      (- j2 (first item))))
    (bvule (of_int (- j2 (first item))) (last2
                                          (of_array2
                                            r3
                                            (to_rep2 r__first1)
                                            (to_rep2 r__last1))))))
...
(assert
  (= r4 (to_array2
          (us_tqtmk2
            (store (to_array2
                     (of_array2 r3 (to_rep2 r__first1) (to_rep2 r__last1))) 
            (of_int
...
(assert
  (and
    (bvule (first2 (of_array2 r4 (to_rep2 r__first1) (to_rep2 r__last1))) 
    (of_int
      (- usf2 (first item))))
    (bvule (of_int (- usf2 (first item))) (last2
                                            (of_array2
                                              r4
                                              (to_rep2 r__first1)
                                              (to_rep2 r__last1))))))
...
(assert
  ...
  (= (us_attr__init
       (select (to_array2
                 (of_array2 r4 (to_rep2 r__first1) (to_rep2 r__last1))) 
       (of_int
