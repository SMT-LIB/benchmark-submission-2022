...
(assert
  (let ((temp___1918 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___1919 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___1918) temp___1919)
          (bvule temp___1919 (last2 temp___1918)))
        (= (us_attr__init (select (to_array2 temp___1918) temp___1919)) true)))))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= (bvsub to__3 (to_rep2 target__first)) ((_ int2bv 64) (- from2 
    (first
      item))))
    true
    false))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___1914 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
...
(assert
  (and
    ...
    usf1 (first item)))))
    (bvule (bvadd (to_rep2 target__first) ((_ int2bv 64) (- usf1 (first item)))) 
    (last2
