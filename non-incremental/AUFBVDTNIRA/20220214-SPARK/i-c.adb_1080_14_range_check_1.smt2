...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= (length1 item) 0) true false))

;; H
(assert (not (= (length1 item) 0)))

;; Ensures
(assert (uint_in_range (length1 item)))

;; H
(assert
  (bvule (to_rep2 target__first) (bvadd (to_rep2 target__first) (bvsub 
  (of_int
    (length1 item)) #x0000000000000001))))

;; Goal def'vc
;; File "i-c.ads", line 432, characters 0-0
(assert
  (not
  (bvule (bvadd (to_rep2 target__first) (bvsub (of_int (length1 item)) #x0000000000000001)) 
  (last2
