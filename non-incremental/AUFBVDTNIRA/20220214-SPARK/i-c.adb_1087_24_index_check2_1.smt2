      ...
      (and
        ...
        (ite (= (and (ite (<= (first item) from) true false) (ite (<= 
          ...
          (exists ((o (_ BitVec 64)))
            (and
              (= (to_rep2 target__last) o)
              (exists ((o1 (_ BitVec 64)))
                (and
                  (= (to_rep2 target__first) o1)
                  (exists ((o2 (_ BitVec 64)))
                    (and
                      (= (to_rep2 target__last) o2)
                      (exists ((o3 (_ BitVec 64)))
                        (and
                          (= (to_rep2 target__first) o3)
                          (let ((temp___2185 (of_array2 target o3 o2)))
                            (exists ((o4 Int))
                              (and
                                (= (to_rep (select (to_array item) from)) o4)
                                (let ((o5 (to_c o4)))
                                  (and
                                    (and
                                    ...
                                    (exists ((o6 char16_t))
                                      (and
                                        ...
                                        (and
                                          ...
                                          (exists ((target2 (Array (_ BitVec 64) char16_t__init_wrapper)))
                                            (and
                                              (= target2 (to_array2
                                                           (us_tqtmk2
                                                             (store (to_array2
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    (= from1 temp___2183)))))))))))))))))))))))))))))))))))
          (and (= target1 target) (= to__2 to__1)))))))
...
;; H
(assert
  (= spark__branch2 (ite (bvugt to__2 (to_rep2 target__last)) true false)))
