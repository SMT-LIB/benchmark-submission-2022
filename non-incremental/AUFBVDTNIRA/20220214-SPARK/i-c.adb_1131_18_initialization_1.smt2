      ...
      (and
        (forall ((k Int))
          (to_c__function_guard
            (to_c (to_rep (select (to_array item) k)))
            (to_rep (select (to_array item) k))))
        (ite (= (and (ite (<= (first item) j) true false) (ite (<= j temp___2449)
                                                            true
                                                            false)) true)
                  ...
                  (exists ((o2 (_ BitVec 64)))
                    (and
                      ...
                      (exists ((o3 (_ BitVec 64)))
                        (and
                          (= (to_rep2 r__first) o3)
                          (let ((temp___2451 (of_array2 r o3 o2)))
                            (exists ((o4 Int))
                              (and
                                              ...
                                              (let ((temp___2453 (of_int o7)))
                                                (and
                                                  (and
                                                    ...
                                                    (last2
                                                      temp___2451)))
                                                  (exists ((r3 (Array (_ BitVec 64) char32_t__init_wrapper)))
                                                    (and
                                                      (= r3 (to_array2
                                                              (us_tqtmk2
                                                                (store 
...
(assert
  (= r3 (to_array2
          (us_tqtmk2
            ...
            (to_rep2
              r__last) (char32_t__init_wrapperqtmk o true))
