...
(declare-datatypes ((t364b__ref 0))
  (((t364b__refqtmk (t364b__content integer)))))

;; t364b__ref_t364b__content__projection
(define-fun t364b__ref_t364b__content__projection ((a t364b__ref)) integer
  (t364b__content a))
...
(declare-datatypes ((t376b__ref 0))
  (((t376b__refqtmk (t376b__content integer)))))

;; t376b__ref_t376b__content__projection
(define-fun t376b__ref_t376b__content__projection ((a t376b__ref)) integer
  (t376b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_598 us_t1) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool) (temp___do_typ_inv_597 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1112 us_t1) (temp___is_init_1108 Bool) (temp___skip_constant_1109 Bool) (temp___do_toplevel_1110 Bool) (temp___do_typ_inv_1111 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1109 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (of_int (length item))
          (first1 temp___expr_1112)
          (last1 temp___expr_1112))
        (= (first1 temp___expr_1112) #x0000000000000000))
      (= (last1 temp___expr_1112) (of_int (length item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1114 us_t1) (temp___skip_top_level_1115 Bool)) Bool
  (and
    (= (first1 temp___expr_1114) #x0000000000000000)
    (= (last1 temp___expr_1114) (of_int (length item)))))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_1122 us_t1) (temp___is_init_1118 Bool) (temp___skip_constant_1119 Bool) (temp___do_toplevel_1120 Bool) (temp___do_typ_inv_1121 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1119 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (bvsub (of_int (length item)) #x0000000000000001)
          (first1 temp___expr_1122)
          (last1 temp___expr_1122))
        (= (first1 temp___expr_1122) #x0000000000000000))
      (= (last1 temp___expr_1122) (bvsub (of_int (length item)) #x0000000000000001)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_1124 us_t1) (temp___skip_top_level_1125 Bool)) Bool
  (and
    (= (first1 temp___expr_1124) #x0000000000000000)
    (= (last1 temp___expr_1124) (bvsub (of_int (length item)) #x0000000000000001))))
