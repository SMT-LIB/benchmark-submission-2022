...
(declare-datatypes ((t30b__ref 0))
  (((t30b__refqtmk (t30b__content size_t)))))

;; t30b__ref_t30b__content__projection
(define-fun t30b__ref_t30b__content__projection ((a t30b__ref)) size_t
  (t30b__content a))
...
(declare-const ada___interfaces__c__is_nul_terminated__result Bool)
...
;; Goal def'vc
;; File "i-c.ads", line 121, characters 0-0
(assert
