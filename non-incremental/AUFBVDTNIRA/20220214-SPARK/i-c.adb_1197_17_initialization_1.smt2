               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target
                            (to_rep2 target__first)
                            (to_rep2 target__last))) to__1 (char32_t__init_wrapperqtmk
                                                             o
                                                             true))
                 (rt2
                   (of_array2
...
(assert
  (let ((temp___2653 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___2654 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___2653) temp___2654)
          (bvule temp___2654 (last2 temp___2653)))
        (= (us_attr__init (select (to_array2 temp___2653) temp___2654)) true)))))
...
(declare-const target3 (Array (_ BitVec 64) char32_t__init_wrapper))
               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target2
                            (to_rep2 target__first)
                            (to_rep2 target__last))) to__3 (char32_t__init_wrapperqtmk
                                                             o1
                                                             true))
                 (rt2
                   (of_array2
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___2648 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
