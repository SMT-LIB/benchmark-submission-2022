...
(assert
  (let ((temp___2249 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___2250 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___2249) temp___2250)
          (bvule temp___2250 (last2 temp___2249)))
        (= (us_attr__init (select (to_array2 temp___2249) temp___2250)) true)))))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___2245 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
