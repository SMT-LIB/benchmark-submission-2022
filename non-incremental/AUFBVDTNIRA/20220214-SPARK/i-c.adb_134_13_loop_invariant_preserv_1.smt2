...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_440 us_t) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool
  (=>
    (not (= temp___skip_constant_437 true))
    (dynamic_property
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first temp___expr_440)
      (last temp___expr_440))))
...
(declare-datatypes ((t38b__ref 0))
  (((t38b__refqtmk (t38b__content size_t)))))

;; t38b__ref_t38b__content__projection
(define-fun t38b__ref_t38b__content__projection ((a t38b__ref)) size_t
  (t38b__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool
  (=>
    ...
    (in_range1 temp___expr_433)))

(declare-const ada___interfaces__c__is_nul_terminated__2__result Bool)
...
;; Goal def'vc
;; File "i-c.ads", line 257, characters 0-0
(assert
