...
;; bool_eq
(define-fun bool_eq10 ((a (Array (_ BitVec 64) char1)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) char1)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool
  (ite (and
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_361 us_t1) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool) (temp___do_typ_inv_360 Bool)) Bool
  (=>
...
;; trS__ref_trS__content__projection
(define-fun trS__ref_trS__content__projection ((a trS__ref)) us_t
  (trS__content a))
...
;; trS__init_wrapper__ref_trS__init_wrapper__content__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__projection 
...
;; t71b__ref_t71b__content__projection
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_114 us_t) (temp___is_init_110 Bool) (temp___skip_constant_111 Bool) (temp___do_toplevel_112 Bool) (temp___do_typ_inv_113 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_712 us_t) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool) (Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___ Int)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          1
          Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___
          (first temp___expr_712)
          (last temp___expr_712))
        (= (first temp___expr_712) 1))
      (= (last temp___expr_712) Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_714 us_t) (temp___skip_top_level_715 Bool) (Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___ Int)) Bool
  (and
    (= (first temp___expr_714) 1)
    (= (last temp___expr_714) Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___)))

(declare-const count Int)

(declare-const from (_ BitVec 64))

(declare-const r (Array Int character__init_wrapper))
...
(declare-const r1 (Array Int character__init_wrapper))
...
(assert
  (= r1 (to_array2
          (us_tqtmk2
            ...
            j (character__init_wrapperqtmk o true))
...
(declare-const r2 (Array Int character__init_wrapper))
                 ...
                 (forall ((temp___1186 Int))
                   (=>
                     ...
                     (=>
                       (or
                         (< (to_rep1 r__last) temp___1186)
                         (or (< temp___1186 1) (< j1 temp___1186)))
                       (= (select (to_array2
                                    (of_array2
                                      r2
                                      (to_rep1 r__first)
                                      (to_rep1 r__last))) temp___1186) (select 
                       (to_array2
                         (of_array2 r (to_rep1 r__first) (to_rep1 r__last))) temp___1186)))))
...
(declare-const r3 (Array Int character__init_wrapper))
...
(assert
  (= r3 (to_array2
          (us_tqtmk2
            ...
            j2 (character__init_wrapperqtmk o1 true))
...
;; Goal def'vc
;; File "i-c.ads", line 157, characters 0-0
(assert
  (not
