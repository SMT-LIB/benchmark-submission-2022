...
(assert
  (let ((temp___1345 (of_array2
    ...
    (forall ((temp___1346 Int))
      (=>
        (and
          (<= (first2 temp___1345) temp___1346)
          (<= temp___1346 (last2 temp___1345)))
        (= (us_attr__init (select (to_array2 temp___1345) temp___1346)) true)))))
