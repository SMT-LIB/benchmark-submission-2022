...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_770 us_t) (temp___is_init_766 Bool) (temp___skip_constant_767 Bool) (temp___do_toplevel_768 Bool) (temp___do_typ_inv_769 Bool)) Bool
  (=>
    (not (= temp___skip_constant_767 true))
    (and
      (and
        (dynamic_property
          (to_rep1 target__first)
          (to_rep1 target__last)
          (first temp___expr_770)
          (last temp___expr_770))
        (= (first temp___expr_770) (to_rep1 target__first)))
      (= (last temp___expr_770) (to_rep1 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_776 us_t) (temp___skip_top_level_777 Bool)) Bool
  (and
    (= (first temp___expr_776) (to_rep1 target__first))
    (= (last temp___expr_776) (to_rep1 target__last))))
...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j r91b) true false)) true))
...
;; Ensures
(assert (= (to_rep o) (to_rep3 (select (to_array1 item) from3))))
               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target
                            (to_rep1 target__first)
                            (to_rep1 target__last))) to__1 (character__init_wrapperqtmk
                                                             o
                                                             true))
                 (rt2
                   (of_array2
...
(declare-const target2 (Array Int character__init_wrapper))
...
(assert
  (let ((temp___1492 (of_array2
                       ...
                       (to_rep1 target__first)
                       to__2)))
    (forall ((temp___1493 Int))
      (=>
        (and
          (<= (first2 temp___1492) temp___1493)
          (<= temp___1493 (last2 temp___1492)))
        (= (us_attr__init (select (to_array2 temp___1492) temp___1493)) true)))))
...
(assert
  (= (and (ite (and
                 ...
                 (dynamic_property3 1 r91b j1))
            true
            false) (ite (and (<= 1 j1) (<= j1 r91b)) true false)) true))
...
;; Ensures
(assert (= (to_rep o1) (to_rep3 (select (to_array1 item) from5))))
...
(declare-const target3 (Array Int character__init_wrapper))
               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target2
                            (to_rep1 target__first)
                            (to_rep1 target__last))) to__3 (character__init_wrapperqtmk
                                                             o1
                                                             true))
                 (rt2
                   (of_array2
