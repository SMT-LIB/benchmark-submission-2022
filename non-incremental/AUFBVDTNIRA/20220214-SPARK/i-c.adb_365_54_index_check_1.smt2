...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool
  (=>
...
;; bool_eq
(define-fun bool_eq10 ((a (Array (_ BitVec 64) wchar_t)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) wchar_t)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool
  (ite (and
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_440 us_t1) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool
  (=>
...
;; trS__ref_trS__content__2__projection
...
;; trS__init_wrapper__ref_trS__init_wrapper__content__2__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__2__projection 
...
(declare-datatypes ((t115b__ref 0))
  (((t115b__refqtmk (t115b__content integer)))))

;; t115b__ref_t115b__content__projection
(define-fun t115b__ref_t115b__content__projection ((a t115b__ref)) integer
  (t115b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_806 us_t) (temp___is_init_802 Bool) (temp___skip_constant_803 Bool) (temp___do_toplevel_804 Bool) (temp___do_typ_inv_805 Bool) (Ada___interfaces__c__to_ada__5__B_15__count_cst___count_cst___ Int)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          1
          Ada___interfaces__c__to_ada__5__B_15__count_cst___count_cst___
          (first temp___expr_806)
          (last temp___expr_806))
        (= (first temp___expr_806) 1))
      (= (last temp___expr_806) Ada___interfaces__c__to_ada__5__B_15__count_cst___count_cst___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_808 us_t) (temp___skip_top_level_809 Bool) (Ada___interfaces__c__to_ada__5__B_15__count_cst___count_cst___ Int)) Bool
  (and
    (= (first temp___expr_808) 1)
    (= (last temp___expr_808) Ada___interfaces__c__to_ada__5__B_15__count_cst___count_cst___)))
                 ...
                 (forall ((temp___1701 Int))
                   (=>
                     ...
                     (=>
                       (or
                         (< (to_rep1 r__last) temp___1701)
                         (or (< temp___1701 1) (< j1 temp___1701)))
                       (= (select (to_array2
                                    (of_array2
                                      r2
                                      (to_rep1 r__first)
                                      (to_rep1 r__last))) temp___1701) (select 
                       (to_array2
                         (of_array2 r (to_rep1 r__first) (to_rep1 r__last))) temp___1701)))))
...
;; Goal def'vc
;; File "i-c.ads", line 292, characters 0-0
(assert
  (not
