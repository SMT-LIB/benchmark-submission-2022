...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool
  (=>
    (or (= temp___is_init_429 true) (<= 0 65535))
    (in_range5 temp___expr_433)))
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_440 us_t1) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool
  (=>
    (not (= temp___skip_constant_437 true))
    (dynamic_property1
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first1 temp___expr_440)
      (last1 temp___expr_440))))
    ...
    (! (=>
         ...
         (let ((result (is_nul_terminated item)))
           (=>
             ...
             (=
               (= result true)
               (exists ((temp___444 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first1 item) temp___444)
                     (bvule temp___444 (last1 item)))
                   (= (to_rep3 (select (to_array1 item) temp___444)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_816 us_t) (temp___is_init_812 Bool) (temp___skip_constant_813 Bool) (temp___do_toplevel_814 Bool) (temp___do_typ_inv_815 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          ...
          (first temp___expr_816)
          (last temp___expr_816))
        (= (first temp___expr_816) (to_rep1 target__first)))
      (= (last temp___expr_816) (to_rep1 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_822 us_t) (temp___skip_top_level_823 Bool)) Bool
  (and
    (= (first temp___expr_822) (to_rep1 target__first))
    (= (last temp___expr_822) (to_rep1 target__last))))
...
(assert
  (let ((temp___1928 (of_array2
                       ...
                       (to_rep1 target__first)
                       to__2)))
    (forall ((temp___1929 Int))
      (=>
        (and
          (<= (first2 temp___1928) temp___1929)
          (<= temp___1929 (last2 temp___1928)))
        (= (us_attr__init (select (to_array2 temp___1928) temp___1929)) true)))))
