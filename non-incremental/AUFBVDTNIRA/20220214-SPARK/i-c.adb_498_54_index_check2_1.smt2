...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_512 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool) (temp___do_typ_inv_511 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_519 us_t1) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool) (temp___do_typ_inv_518 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_852 us_t) (temp___is_init_848 Bool) (temp___skip_constant_849 Bool) (temp___do_toplevel_850 Bool) (temp___do_typ_inv_851 Bool) (Ada___interfaces__c__to_ada__8__B_20__count_cst___count_cst___ Int)) Bool
  (=>
    (not (= temp___skip_constant_849 true))
    (and
      (and
        (dynamic_property
          1
          Ada___interfaces__c__to_ada__8__B_20__count_cst___count_cst___
          (first temp___expr_852)
          (last temp___expr_852))
        (= (first temp___expr_852) 1))
      (= (last temp___expr_852) Ada___interfaces__c__to_ada__8__B_20__count_cst___count_cst___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_854 us_t) (temp___skip_top_level_855 Bool) (Ada___interfaces__c__to_ada__8__B_20__count_cst___count_cst___ Int)) Bool
  (and
    (= (first temp___expr_854) 1)
    (= (last temp___expr_854) Ada___interfaces__c__to_ada__8__B_20__count_cst___count_cst___)))
    ...
    (ite (= spark__branch true)
      (and
        ...
        (and
          ...
          (and
            (= from2 (bvadd (first1 item) (c_length_ghost item)))
            (let ((o (bv2nat64 (bvsub from2 (first1 item)))))
              (and (in_range2 o) (= count1 o))))))
      (let ((o (length1 item))) (and (in_range2 o) (= count1 o))))))
...
(assert
  (and
    (bvule (first1 item) (bvadd (bvsub (of_int j) #x0000000000000001) 
    (first1
      item)))
    (bvule (bvadd (bvsub (of_int j) #x0000000000000001) (first1 item)) 
    (last1
      item))))
...
(assert
  (to_ada__function_guard
    (to_ada
      (to_rep3
        (select (to_array1 item) (bvadd (bvsub (of_int j) #x0000000000000001) 
        (first1
          item)))))
    (to_rep3
      (select (to_array1 item) (bvadd (bvsub (of_int j) #x0000000000000001) 
      ...
      (and
        (forall ((k1 Int))
          (to_ada__function_guard
            (to_ada
              (to_rep3
                (select (to_array1 item) (bvadd (bvsub (of_int k1) #x0000000000000001) 
                (first1
                  item)))))
            (to_rep3
              (select (to_array1 item) (bvadd (bvsub (of_int k1) #x0000000000000001) 
        ...
        (to_ada
          (to_rep3
            (select (to_array1 item) (bvadd (bvsub (of_int k) #x0000000000000001) 
            (first1
              item))))))))))
                 ...
                 (forall ((temp___2137 Int))
                   (=>
                     ...
                     (=>
                       (or
                         (< (to_rep1 r__last) temp___2137)
                         (or (< temp___2137 1) (< j1 temp___2137)))
                       (= (select (to_array2
                                    (of_array2
                                      r2
                                      (to_rep1 r__first)
                                      (to_rep1 r__last))) temp___2137) (select 
                       (to_array2
                         (of_array2 r (to_rep1 r__first) (to_rep1 r__last))) temp___2137)))))
...
(assert
  (and
    (bvule (first1 item) (bvadd (bvsub (of_int j2) #x0000000000000001) 
    (first1
      item)))
    (bvule (bvadd (bvsub (of_int j2) #x0000000000000001) (first1 item)) 
    (last1
      item))))
...
(assert
  (to_ada__function_guard
    (to_ada
      (to_rep3
        (select (to_array1 item) (bvadd (bvsub (of_int j2) #x0000000000000001) 
        (first1
          item)))))
    (to_rep3
      (select (to_array1 item) (bvadd (bvsub (of_int j2) #x0000000000000001) 
...
(assert
  (not
  (bvule (first1 item) (bvadd (bvsub (of_int usf) #x0000000000000001) 
  (first1
    item)))))
