...
(define-fun uc_to_int ((x (_ BitVec 64))) Int
  (ite (= (bool_lt1 x (of_int two_power_size_minus_one)) true)
    (bv2nat64 x)
    (- (bv2nat64 (bvneg x)))))
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_512 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool) (temp___do_typ_inv_511 Bool)) Bool
  (=>
    (or (= temp___is_init_508 true) (<= 0 65535))
    (in_range5 temp___expr_512)))
...
(define-fun length2 ((a us_t1)) Int
  (ite (bvule (first1 a) (last1 a))
    (+ (- (bv2nat64 (last1 a)) (bv2nat64 (first1 a))) 1)
    0))
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_519 us_t1) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool) (temp___do_typ_inv_518 Bool)) Bool
  (=>
    (not (= temp___skip_constant_516 true))
    (dynamic_property1
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first1 temp___expr_519)
      (last1 temp___expr_519))))
    ...
    (! (=>
         ...
         (let ((result (is_nul_terminated item)))
           (=>
             ...
             (=
               (= result true)
               (exists ((temp___523 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first1 item) temp___523)
                     (bvule temp___523 (last1 item)))
                   (= (to_rep3 (select (to_array1 item) temp___523)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_862 us_t) (temp___is_init_858 Bool) (temp___skip_constant_859 Bool) (temp___do_toplevel_860 Bool) (temp___do_typ_inv_861 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          ...
          (first temp___expr_862)
          (last temp___expr_862))
        (= (first temp___expr_862) (to_rep1 target__first)))
      (= (last temp___expr_862) (to_rep1 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_868 us_t) (temp___skip_top_level_869 Bool)) Bool
  (and
    (= (first temp___expr_868) (to_rep1 target__first))
    (= (last temp___expr_868) (to_rep1 target__last))))
  ...
  (and
    ...
    (and
      ...
      (ite (= trim_nul true)
        (and
          (= (is_nul_terminated item) true)
          (bvule (c_length_ghost item) (of_int
                                         (length
                                           (to_rep1 target__first)
                                           (to_rep1 target__last)))))
        (bvult (bvsub (last1 item) (first1 item)) (of_int
                                                    (length
                                                      (to_rep1 target__first)
                                                      (to_rep1 target__last))))))))
  ...
  (ite (= spark__branch1 true)
    (and
      ...
      (and
        ...
        (let ((o (bv2nat64 (bvsub from1 (first1 item)))))
...
;; LoopInvariant
(assert (= from4 (bvadd (first1 item) (of_int (- j1 1)))))
...
(assert
  (let ((temp___2364 (of_array2
                       ...
                       (to_rep1 target__first)
                       to__2)))
    (forall ((temp___2365 Int))
      (=>
        (and
          (<= (first2 temp___2364) temp___2365)
          (<= temp___2365 (last2 temp___2364)))
        (= (us_attr__init (select (to_array2 temp___2364) temp___2365)) true)))))
      ...
      (and
        (forall ((k1 Int))
          (to_ada__function_guard
            (to_ada
              (to_rep3
                (select (to_array1 item) (bvadd (of_int
                                                  (- k1 (to_rep1
                                                          target__first))) 
                (first1
                  item)))))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= from5 (bvadd (first1 item) (of_int (- j2 1)))) true false))
...
;; H
(assert (= (to_rep1 target__last) o2))

(declare-const o3 Int)

;; H
(assert (= (to_rep1 target__first) o3))

(declare-const o4 Int)

;; H
(assert (= (to_rep1 target__first) o4))
...
(assert
  (not
  (bvule (bvadd (of_int (- usf1 (to_rep1 target__first))) (first1 item)) 
  (last1
    item))))
