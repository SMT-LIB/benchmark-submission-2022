...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_598 us_t1) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool) (temp___do_typ_inv_597 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_898 us_t) (temp___is_init_894 Bool) (temp___skip_constant_895 Bool) (temp___do_toplevel_896 Bool) (temp___do_typ_inv_897 Bool) (Ada___interfaces__c__to_ada__11__B_25__count_cst___count_cst___ Int)) Bool
  (=>
    (not (= temp___skip_constant_895 true))
    (and
      (and
        (dynamic_property
          1
          Ada___interfaces__c__to_ada__11__B_25__count_cst___count_cst___
          (first temp___expr_898)
          (last temp___expr_898))
        (= (first temp___expr_898) 1))
      (= (last temp___expr_898) Ada___interfaces__c__to_ada__11__B_25__count_cst___count_cst___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_900 us_t) (temp___skip_top_level_901 Bool) (Ada___interfaces__c__to_ada__11__B_25__count_cst___count_cst___ Int)) Bool
  (and
    (= (first temp___expr_900) 1)
    (= (last temp___expr_900) Ada___interfaces__c__to_ada__11__B_25__count_cst___count_cst___)))
                 ...
                 (forall ((temp___2573 Int))
                   (=>
                     ...
                     (=>
                       (or
                         (< (to_rep1 r__last) temp___2573)
                         (or (< temp___2573 1) (< j1 temp___2573)))
                       (= (select (to_array2
                                    (of_array2
                                      r2
                                      (to_rep1 r__first)
                                      (to_rep1 r__last))) temp___2573) (select 
                       (to_array2
                         (of_array2 r (to_rep1 r__first) (to_rep1 r__last))) temp___2573)))))
