...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_591 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool) (temp___do_typ_inv_590 Bool)) Bool
  (=>
    (or (= temp___is_init_587 true) (<= 0 2147483647))
    (in_range5 temp___expr_591)))
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_598 us_t1) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool) (temp___do_typ_inv_597 Bool)) Bool
  (=>
    (not (= temp___skip_constant_595 true))
    (dynamic_property1
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first1 temp___expr_598)
      (last1 temp___expr_598))))
           ...
           (=>
             ...
             (=
               ...
               (exists ((temp___602 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first1 item) temp___602)
                     (bvule temp___602 (last1 item)))
                   (= (to_rep3 (select (to_array1 item) temp___602)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_908 us_t) (temp___is_init_904 Bool) (temp___skip_constant_905 Bool) (temp___do_toplevel_906 Bool) (temp___do_typ_inv_907 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          ...
          (first temp___expr_908)
          (last temp___expr_908))
        (= (first temp___expr_908) (to_rep1 target__first)))
      (= (last temp___expr_908) (to_rep1 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_914 us_t) (temp___skip_top_level_915 Bool)) Bool
  (and
    (= (first temp___expr_914) (to_rep1 target__first))
    (= (last temp___expr_914) (to_rep1 target__last))))
...
(assert
  (let ((temp___2800 (of_array2
                       ...
                       (to_rep1 target__first)
                       to__2)))
    (forall ((temp___2801 Int))
      (=>
        (and
          (<= (first2 temp___2800) temp___2801)
          (<= temp___2801 (last2 temp___2800)))
        (= (us_attr__init (select (to_array2 temp___2800) temp___2801)) true)))))
