      ...
      (and
        (forall ((k Int))
          (to_c__function_guard
            (to_c (to_rep (select (to_array item) k)))
            (to_rep (select (to_array item) k))))
        (ite (= (and (ite (<= (first item) j) true false) (ite (<= j temp___1072)
                                                            true
                                                            false)) true)
                  ...
                  (exists ((o2 (_ BitVec 64)))
                    (and
                      ...
                      (exists ((o3 (_ BitVec 64)))
                        (and
                          (= (to_rep2 r__first) o3)
                          (let ((temp___1074 (of_array2 r o3 o2)))
                            (exists ((o4 Int))
                              (and
                                      ...
                                      (and
                                        ...
                                        (let ((o7 (- j (first item))))
                                          (and
                                            ...
                                            (and
                                              (uint_in_range o7)
                                              (let ((temp___1076 ((_ int2bv 64) o7)))
                                                (and
                                                  (and
                                                    (bvule (first2
...
(declare-const temp___1106 (_ BitVec 64))
