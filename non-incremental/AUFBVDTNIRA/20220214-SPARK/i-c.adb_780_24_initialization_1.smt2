...
;; convert
(declare-fun convert ((Array (_ BitVec 64) char__init_wrapper)) (Array (_ BitVec 64) char1))

;; convert__def
(assert
  (forall ((a (Array (_ BitVec 64) char__init_wrapper)))
    (forall ((temp___183 (_ BitVec 64)))
      (= (to_rep3 (of_rep3 (to_rep3 (rec__value (select a temp___183))))) 
      (to_rep3
        (select (convert a) temp___183))))))

(declare-datatypes ((trS__ref 0))
  (((trS__refqtmk (trS__content us_t1)))))

;; trS__ref_trS__content__5__projection
(define-fun trS__ref_trS__content__5__projection ((a trS__ref)) us_t1
  (trS__content a))
...
;; trS__init_wrapper__ref_trS__init_wrapper__content__5__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__5__projection 
...
(declare-datatypes ((t239b__ref 0))
  (((t239b__refqtmk (t239b__content integer)))))

;; t239b__ref_t239b__content__projection
(define-fun t239b__ref_t239b__content__projection ((a t239b__ref)) integer
  (t239b__content a))

(declare-datatypes ((trS__ref1 0))
  (((trS__refqtmk1 (trS__content1 us_t1)))))

;; trS__ref_trS__content__6__projection
(define-fun trS__ref_trS__content__6__projection ((a trS__ref1)) us_t1
  (trS__content1 a))

(declare-datatypes ((trS__init_wrapper__ref1 0))
  (((trS__init_wrapper__refqtmk1 (trS__init_wrapper__content1 us_t2)))))

;; trS__init_wrapper__ref_trS__init_wrapper__content__6__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__6__projection 
...
(declare-datatypes ((t251b__ref 0))
  (((t251b__refqtmk (t251b__content integer)))))

;; t251b__ref_t251b__content__projection
(define-fun t251b__ref_t251b__content__projection ((a t251b__ref)) integer
  (t251b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_944 us_t1) (temp___is_init_940 Bool) (temp___skip_constant_941 Bool) (temp___do_toplevel_942 Bool) (temp___do_typ_inv_943 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (of_int (length item))
          (first1 temp___expr_944)
          (last1 temp___expr_944))
        (= (first1 temp___expr_944) #x0000000000000000))
      (= (last1 temp___expr_944) (of_int (length item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_946 us_t1) (temp___skip_top_level_947 Bool)) Bool
  (and
    (= (first1 temp___expr_946) #x0000000000000000)
    (= (last1 temp___expr_946) (of_int (length item)))))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_954 us_t1) (temp___is_init_950 Bool) (temp___skip_constant_951 Bool) (temp___do_toplevel_952 Bool) (temp___do_typ_inv_953 Bool)) Bool
  (=>
    (not (= temp___skip_constant_951 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (bvsub (of_int (length item)) #x0000000000000001)
          (first1 temp___expr_954)
          (last1 temp___expr_954))
        (= (first1 temp___expr_954) #x0000000000000000))
      (= (last1 temp___expr_954) (bvsub (of_int (length item)) #x0000000000000001)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_956 us_t1) (temp___skip_top_level_957 Bool)) Bool
  (and
    (= (first1 temp___expr_956) #x0000000000000000)
    (= (last1 temp___expr_956) (bvsub (of_int (length item)) #x0000000000000001))))

(declare-const r (Array (_ BitVec 64) char__init_wrapper))

(declare-const r1 (Array (_ BitVec 64) char__init_wrapper))
...
(declare-const r2 (Array (_ BitVec 64) char__init_wrapper))
...
(assert
  (= r2 (to_array2
          (us_tqtmk2
            ...
            (of_int
              (- j (first item))) (char__init_wrapperqtmk o true))
...
(declare-const r3 (Array (_ BitVec 64) char__init_wrapper))
...
(declare-const r4 (Array (_ BitVec 64) char__init_wrapper))
...
(assert
  (= r4 (to_array2
          (us_tqtmk2
            ...
            (of_int
              (- j2 (first item))) (char__init_wrapperqtmk o1 true))
...
;; Goal def'vc
;; File "i-c.ads", line 139, characters 0-0
(assert
  (not
  (= (us_attr__init
       (select (to_array2
