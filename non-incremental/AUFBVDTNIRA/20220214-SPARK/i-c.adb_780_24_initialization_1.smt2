...
(declare-datatypes ((t249b__ref 0))
  (((t249b__refqtmk (t249b__content integer)))))

;; t249b__ref_t249b__content__projection
(define-fun t249b__ref_t249b__content__projection ((a t249b__ref)) integer
  (t249b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_872 us_t1) (temp___is_init_868 Bool) (temp___skip_constant_869 Bool) (temp___do_toplevel_870 Bool) (temp___do_typ_inv_871 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property1
          ...
          (first1 temp___expr_872)
          (last1 temp___expr_872))
        (= (first1 temp___expr_872) #x0000000000000000))
      (= (last1 temp___expr_872) ((_ int2bv 64) (length item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_874 us_t1) (temp___skip_top_level_875 Bool)) Bool
  (and
    (= (first1 temp___expr_874) #x0000000000000000)
    (= (last1 temp___expr_874) ((_ int2bv 64) (length item)))))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_882 us_t1) (temp___is_init_878 Bool) (temp___skip_constant_879 Bool) (temp___do_toplevel_880 Bool) (temp___do_typ_inv_881 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property1
          ...
          (first1 temp___expr_882)
          (last1 temp___expr_882))
        (= (first1 temp___expr_882) #x0000000000000000))
      (= (last1 temp___expr_882) (bvsub ((_ int2bv 64) (length item)) #x0000000000000001)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_884 us_t1) (temp___skip_top_level_885 Bool)) Bool
  (and
    (= (first1 temp___expr_884) #x0000000000000000)
    (= (last1 temp___expr_884) (bvsub ((_ int2bv 64) (length item)) #x0000000000000001))))
