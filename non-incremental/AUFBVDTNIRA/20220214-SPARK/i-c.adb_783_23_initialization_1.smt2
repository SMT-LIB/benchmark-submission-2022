      ...
      (and
        (forall ((k Int))
          (to_c__function_guard
            (to_c (to_rep (select (to_array item) k)))
            (to_rep (select (to_array item) k))))
        (ite (= (and (ite (<= (first item) j) true false) (ite (<= j temp___1224)
                                                            true
                                                            false)) true)
                    ...
                    (and
                      ...
                      (exists ((o3 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___1226 (of_array2 r1 o3 o2)))
                            (exists ((o4 Int))
                              (and
...
(declare-const temp___1254 (_ BitVec 64))
