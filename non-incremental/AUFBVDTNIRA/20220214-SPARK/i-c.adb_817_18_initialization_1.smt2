...
(assert
  (let ((temp___1372 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___1373 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___1372) temp___1373)
          (bvule temp___1373 (last2 temp___1372)))
        (= (us_attr__init (select (to_array2 temp___1372) temp___1373)) true)))))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___1367 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
