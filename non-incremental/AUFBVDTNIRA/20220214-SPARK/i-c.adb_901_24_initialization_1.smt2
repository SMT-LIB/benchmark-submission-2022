...
(declare-datatypes ((map__ref1 0))
  (((map__refqtmk1 (map__content1 (Array (_ BitVec 64) wchar_t))))))

;; slide
(declare-fun slide1 ((Array (_ BitVec 64) wchar_t)
  (_ BitVec 64)
...
;; const
(declare-fun const2 (wchar_t) (Array (_ BitVec 64) wchar_t))
...
(declare-datatypes ((wchar_t__init_wrapper 0))
  (((wchar_t__init_wrapperqtmk (rec__value wchar_t)(us_attr__init Bool)))))

;; wchar_t__init_wrapper_rec__value__projection
(define-fun wchar_t__init_wrapper_rec__value__projection ((a wchar_t__init_wrapper)) wchar_t
  (rec__value a))

;; wchar_t__init_wrapper___attr__init__projection
(define-fun wchar_t__init_wrapper___attr__init__projection ((a wchar_t__init_wrapper)) Bool
  (us_attr__init a))

(declare-const dummy8 wchar_t__init_wrapper)

;; dummy__def
(assert (= (us_attr__init dummy8) false))

(declare-datatypes ((wchar_t__init_wrapper__ref 0))
  (((wchar_t__init_wrapper__refqtmk
    (wchar_t__init_wrapper__content wchar_t__init_wrapper)))))

;; wchar_t__init_wrapper__ref_wchar_t__init_wrapper__content__projection
(define-fun wchar_t__init_wrapper__ref_wchar_t__init_wrapper__content__projection 
  ((a wchar_t__init_wrapper__ref)) wchar_t__init_wrapper
  (wchar_t__init_wrapper__content a))

(declare-datatypes ((map__ref2 0))
  (((map__refqtmk2
    (map__content2 (Array (_ BitVec 64) wchar_t__init_wrapper))))))

;; slide
(declare-fun slide2 ((Array (_ BitVec 64) wchar_t__init_wrapper)
  (_ BitVec 64)
  (_ BitVec 64)) (Array (_ BitVec 64) wchar_t__init_wrapper))

;; slide_eq
(assert
  (forall ((a (Array (_ BitVec 64) wchar_t__init_wrapper)))
...
;; const
(declare-fun const3 (wchar_t__init_wrapper) (Array (_ BitVec 64) wchar_t__init_wrapper))

;; const_def
(assert
  (forall ((v wchar_t__init_wrapper))
    (forall ((i (_ BitVec 64)))
...
;; convert
(declare-fun convert ((Array (_ BitVec 64) wchar_t__init_wrapper)) (Array (_ BitVec 64) wchar_t))

;; convert__def
(assert
  (forall ((a (Array (_ BitVec 64) wchar_t__init_wrapper)))
    (forall ((temp___194 (_ BitVec 64)))
      (= (to_rep3 (of_rep3 (to_rep3 (rec__value (select a temp___194))))) 
      (to_rep3
        (select (convert a) temp___194))))))

(declare-datatypes ((trS__ref 0))
  (((trS__refqtmk (trS__content us_t1)))))

;; trS__ref_trS__content__7__projection
(define-fun trS__ref_trS__content__7__projection ((a trS__ref)) us_t1
  (trS__content a))

;; array_bool_eq
(declare-fun array_bool_eq ((Array (_ BitVec 64) wchar_t__init_wrapper)
  (_ BitVec 64)
  (_ BitVec 64)
  (Array (_ BitVec 64) wchar_t__init_wrapper)
  (_ BitVec 64)
  (_ BitVec 64)) Bool)
...
(declare-datatypes ((us_t2 0))
  (((us_tqtmk2 (elts2 (Array (_ BitVec 64) wchar_t__init_wrapper))(rt2 t2)))))

;; to_array
(define-fun to_array2 ((a us_t2)) (Array (_ BitVec 64) wchar_t__init_wrapper)
  (elts2 a))

;; of_array
(define-fun of_array2 ((a (Array (_ BitVec 64) wchar_t__init_wrapper)) (f (_ BitVec 64)) (l (_ BitVec 64))) us_t2
  (us_tqtmk2 a (mk2 f l)))
...
(declare-datatypes ((wchar_array__init_wrapper__ref 0))
  (((wchar_array__init_wrapper__refqtmk
    (wchar_array__init_wrapper__content us_t2)))))

;; wchar_array__init_wrapper__ref_wchar_array__init_wrapper__content__projection
(define-fun wchar_array__init_wrapper__ref_wchar_array__init_wrapper__content__projection 
  ((a wchar_array__init_wrapper__ref)) us_t2
  (wchar_array__init_wrapper__content a))

(declare-datatypes ((trS__init_wrapper__ref 0))
  (((trS__init_wrapper__refqtmk (trS__init_wrapper__content us_t2)))))

;; trS__init_wrapper__ref_trS__init_wrapper__content__7__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__7__projection 
...
(declare-datatypes ((t278b__ref 0))
  (((t278b__refqtmk (t278b__content integer)))))

;; t278b__ref_t278b__content__projection
(define-fun t278b__ref_t278b__content__projection ((a t278b__ref)) integer
  (t278b__content a))

(declare-datatypes ((trS__ref1 0))
  (((trS__refqtmk1 (trS__content1 us_t1)))))

;; trS__ref_trS__content__8__projection
(define-fun trS__ref_trS__content__8__projection ((a trS__ref1)) us_t1
  (trS__content1 a))

(declare-datatypes ((trS__init_wrapper__ref1 0))
  (((trS__init_wrapper__refqtmk1 (trS__init_wrapper__content1 us_t2)))))

;; trS__init_wrapper__ref_trS__init_wrapper__content__8__projection
(define-fun trS__init_wrapper__ref_trS__init_wrapper__content__8__projection 
...
(declare-datatypes ((t290b__ref 0))
  (((t290b__refqtmk (t290b__content integer)))))

;; t290b__ref_t290b__content__projection
(define-fun t290b__ref_t290b__content__projection ((a t290b__ref)) integer
  (t290b__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_440 us_t1) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1000 us_t1) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool) (temp___do_typ_inv_999 Bool)) Bool
  (=>
    (not (= temp___skip_constant_997 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (of_int (length item))
          (first1 temp___expr_1000)
          (last1 temp___expr_1000))
        (= (first1 temp___expr_1000) #x0000000000000000))
      (= (last1 temp___expr_1000) (of_int (length item))))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1002 us_t1) (temp___skip_top_level_1003 Bool)) Bool
  (and
    (= (first1 temp___expr_1002) #x0000000000000000)
    (= (last1 temp___expr_1002) (of_int (length item)))))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_1010 us_t1) (temp___is_init_1006 Bool) (temp___skip_constant_1007 Bool) (temp___do_toplevel_1008 Bool) (temp___do_typ_inv_1009 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1007 true))
    (and
      (and
        (dynamic_property1
          #x0000000000000000
          (bvsub (of_int (length item)) #x0000000000000001)
          (first1 temp___expr_1010)
          (last1 temp___expr_1010))
        (= (first1 temp___expr_1010) #x0000000000000000))
      (= (last1 temp___expr_1010) (bvsub (of_int (length item)) #x0000000000000001)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_1012 us_t1) (temp___skip_top_level_1013 Bool)) Bool
  (and
    (= (first1 temp___expr_1012) #x0000000000000000)
    (= (last1 temp___expr_1012) (bvsub (of_int (length item)) #x0000000000000001))))

(declare-const r (Array (_ BitVec 64) wchar_t__init_wrapper))

(declare-const r1 (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(declare-const r2 (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(assert
  (= r2 (to_array2
          (us_tqtmk2
            ...
            (of_int
              (- j (first item))) (wchar_t__init_wrapperqtmk o true))
...
(declare-const r3 (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(declare-const r4 (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(assert
  (= r4 (to_array2
          (us_tqtmk2
            ...
            (of_int
              (- j2 (first item))) (wchar_t__init_wrapperqtmk o1 true))
...
;; Goal def'vc
;; File "i-c.ads", line 280, characters 0-0
(assert
  (not
  (= (us_attr__init
       (select (to_array2
