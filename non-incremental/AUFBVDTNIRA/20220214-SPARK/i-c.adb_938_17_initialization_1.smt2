               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target
                            (to_rep2 target__first)
                            (to_rep2 target__last))) to__1 (wchar_t__init_wrapperqtmk
                                                             o
                                                             true))
                 (rt2
                   (of_array2
...
(assert
  (let ((temp___1781 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___1782 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___1781) temp___1782)
          (bvule temp___1782 (last2 temp___1781)))
        (= (us_attr__init (select (to_array2 temp___1781) temp___1782)) true)))))
...
(declare-const target3 (Array (_ BitVec 64) wchar_t__init_wrapper))
               ...
               (us_tqtmk2
                 (store (to_array2
                          (of_array2
                            target2
                            (to_rep2 target__first)
                            (to_rep2 target__last))) to__3 (wchar_t__init_wrapperqtmk
                                                             o1
                                                             true))
                 (rt2
                   (of_array2
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___1776 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
