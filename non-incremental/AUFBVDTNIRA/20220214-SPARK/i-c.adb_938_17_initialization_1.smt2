...
(assert
  (let ((temp___1587 (of_array2
                       ...
                       (to_rep2 target__first)
                       to__2)))
    (forall ((temp___1588 (_ BitVec 64)))
      (=>
        (and
          (bvule (first2 temp___1587) temp___1588)
          (bvule temp___1588 (last2 temp___1587)))
        (= (us_attr__init (select (to_array2 temp___1587) temp___1588)) true)))))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((temp___1583 (_ BitVec 64)))
         (=>
           (and
             (bvule (first2
                      (of_array2
