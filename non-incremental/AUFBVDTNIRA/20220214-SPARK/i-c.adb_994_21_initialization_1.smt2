...
(assert
  (and
    ...
    (= (last2 (of_array2 r (to_rep2 r__first) (to_rep2 r__last))) (of_int
                                                                    (length
                                                                    item)))))
...
(assert
  (and
    (bvule (first2 (of_array2 r (to_rep2 r__first) (to_rep2 r__last))) 
    (of_int
      (- j (first item))))
    ...
    (=>
      ...
      (and
        ...
        (= (to_rep3
             (rec__value
               (select (to_array2
                         (of_array2 r3 (to_rep2 r__first) (to_rep2 r__last))) 
               (of_int
                 (- k (first item)))))) (to_c
...
(assert
  (and
    (bvule (first2 (of_array2 r3 (to_rep2 r__first) (to_rep2 r__last))) 
    (of_int
      (- j2 (first item))))
...
(assert
  (and
    (bvule (first2 (of_array2 r4 (to_rep2 r__first) (to_rep2 r__last))) 
    (of_int
      (- usf2 (first item))))
...
(assert
  ...
  (= (us_attr__init
       (select (to_array2
                 (of_array2 r4 (to_rep2 r__first) (to_rep2 r__last))) 
       (of_int
