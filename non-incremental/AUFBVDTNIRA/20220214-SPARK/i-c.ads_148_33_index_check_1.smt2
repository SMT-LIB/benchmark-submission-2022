...
(declare-const temp___1200 (_ BitVec 64))
                ...
                (and
                  (and
                    ...
                    (of_int
                      (length item))))
                  (and
                    (let ((temp___1167 (first item)))
                      (let ((temp___1168 (last item)))
                        (and
                          (= j1 temp___1167)
                          (ite (= (and (ite (<= temp___1167 j1) true false) 
                            (ite (<= j1 temp___1168)
                              true
                              false)) true)
                    ...
                    (and
                      ...
                      (and
                        (= (to_rep2 r__first) o3)
                        (let ((temp___1197 (of_array2 r3 o3 o2)))
                          (and
                            (= (to_rep3 o4) 0)
                            (and
                              (= (to_rep2 r__last) o5)
                              (and
                                (= (to_rep2 r__first) o6)
                                (and
                                  (= (to_rep2 r__last) temp___1200)
                                  (and
                                    (and
                                      (bvule (first2 temp___1197) temp___1200)
                                      (bvule temp___1200 (last2 temp___1197)))
                                    (and
                                      (= r4 (to_array2
                                              (us_tqtmk2
                                                (store (to_array2
                                                         temp___1197) 
                                                temp___1200 (char__init_wrapperqtmk
                                                              o4
                                                              true))
                                                (rt2 temp___1197))))
                                      (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            (= (to_rep2 r__first) o8)
                                            (let ((temp___1209 (of_array2
                                                                 r4
                                                                 o8
                                                                 o7)))
                                              (and
                                                (forall ((temp___1211 (_ BitVec 64)))
                                                  (=>
                                                    (and
                                                      (bvule (first2
                                                               temp___1209) temp___1211)
                                                      (bvule temp___1211 
                                                      (last2
                                                        temp___1209)))
                                                    (= (us_attr__init
                                                         (select (to_array2
                                                                   temp___1209) temp___1211)) true)))
                                                (and
                                                  (dynamic_property1
                                                    #x0000000000000000
                                                    #xFFFFFFFFFFFFFFFF
                        ...
                        (= (last2
                             (of_array2
                               ...
                               (to_rep2 r__last1))) (bvsub (of_int
                                                             (length item)) #x0000000000000001)))
                      (and
                        (let ((temp___1223 (first item)))
                          (let ((temp___1224 (last item)))
                            (and
                              (= j temp___1223)
                              (ite (= (and (ite (<= temp___1223 j)
                                             true
                                             false) (ite (<= j temp___1224)
                                                      true
                                                      false)) true)
                                (exists ((o9 (_ BitVec 64)))
                                  (and
                        ...
                        (and
                          ...
                          (and
                            ...
                            (let ((temp___1252 (of_array2 r2 o1 o)))
                              (and
                                (forall ((temp___1254 (_ BitVec 64)))
                                  (=>
                                    (and
                                      (bvule (first2 temp___1252) temp___1254)
                                      (bvule temp___1254 (last2 temp___1252)))
                                    (= (us_attr__init
                                         (select (to_array2 temp___1252) temp___1254)) true)))
                                (and
                                  (dynamic_property1
                                    #x0000000000000000
                                    #xFFFFFFFFFFFFFFFF
  ...
  (ite (= (first1 ada___interfaces__c__to_c__2__result) #x0000000000000000)
    (and
      (ite (= append_nul true)
        (= o9 (+ (length item) 1))
        (= o9 (length item)))
      (let ((o10 (length1 ada___interfaces__c__to_c__2__result)))
