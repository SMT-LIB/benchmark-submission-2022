                ...
                (exists ((o2 Int))
                  (and
                    ...
                    (exists ((o3 Int))
                      (and
                        (= (to_rep1 r__first) o3)
                        (let ((temp___1178 (of_array2 r o3 o2)))
                          (let ((temp___1177 (bvadd (bvsub ((_ int2bv 64) 
                            j) #x0000000000000001) (first1 item))))
                            (and
                              (and
                                (bvule (first1 item) temp___1177)
                                (bvule temp___1177 (last1 item)))
                              (exists ((o4 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) temp___1177)) o4)
                                  (let ((o5 (to_ada o4)))
                                    (and
                                      (and
...
;; Assert
(assert
  (forall ((temp___1205 Int))
    (=>
      (and
        (<= (first2 (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1205)
        (<= temp___1205 (last2
                          (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last)))))
      (= (us_attr__init
           (select (to_array2
                     (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1205)) true))))
...
(assert
  (ite (= (first ada___interfaces__c__to_ada__2__result) 1)
    (and
      ...
      (let ((o1 (length ada___interfaces__c__to_ada__2__result)))
        (and
          (uint_in_range o1)
