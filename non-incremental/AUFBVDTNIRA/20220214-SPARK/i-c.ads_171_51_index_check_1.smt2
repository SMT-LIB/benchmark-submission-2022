...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_760 us_t) (temp___is_init_756 Bool) (temp___skip_constant_757 Bool) (temp___do_toplevel_758 Bool) (temp___do_typ_inv_759 Bool) (Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___ Int)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          ...
          (first temp___expr_760)
          (last temp___expr_760))
        (= (first temp___expr_760) 1))
      (= (last temp___expr_760) Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_762 us_t) (temp___skip_top_level_763 Bool) (Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___ Int)) Bool
  (and
    (= (first temp___expr_762) 1)
    (= (last temp___expr_762) Ada___interfaces__c__to_ada__2__B_10__count_cst___count_cst___)))
...
;; H
(assert (= (to_rep1 r__last) temp___1281))
      ...
      (forall ((k Int))
        (to_ada__function_guard
          ...
          (to_rep3
            ...
            (first1
              item))))))
      (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1281)
                                               true
                                               false)) true)
        (exists ((o1 Int))
          (and
                ...
                (exists ((o3 Int))
                  (and
                    ...
                    (exists ((o4 Int))
                      (and
                        (= (to_rep1 r__first) o4)
                        (let ((temp___1284 (of_array2 r o4 o3)))
                          (let ((temp___1283 (bvadd (bvsub (of_int j) #x0000000000000001) 
                            (first1
                              item))))
                            (and
                              (and
                                (bvule (first1 item) temp___1283)
                                (bvule temp___1283 (last1 item)))
                              (exists ((o5 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) temp___1283)) o5)
                                  (let ((o6 (to_ada o5)))
                                    (and
                                      (and
                                      ...
                                      (exists ((o7 character))
                                        (and
                                          (= (to_rep o7) o6)
                                          (exists ((r2 (Array Int character__init_wrapper)))
                                            (and
                                              (= r2 (to_array2
                                                      (us_tqtmk2
                                                        (store (to_array2
                                                                 temp___1284) 
                                                        j (character__init_wrapperqtmk
                                                            o7
                                                            true))
                                                        (rt2 temp___1284))))
                                              (exists ((j1 Int))
...
(assert
  (forall ((temp___1315 Int))
    (=>
      (and
        (<= (first2 (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1315)
        (<= temp___1315 (last2
                          (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last)))))
      (= (us_attr__init
           (select (to_array2
                     (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1315)) true))))
...
(declare-const ada___interfaces__c__to_ada__2__result us_t)

;; H
(assert
  (= ada___interfaces__c__to_ada__2__result (of_array
                                              (convert
                                                (to_array2
                                                  (of_array2
                                                    r1
...
;; H
(assert
  (ite (= (first ada___interfaces__c__to_ada__2__result) 1)
    (and
      (ite (= trim_nul true)
        (let ((o2 item))
          (and
      ...
      (let ((o2 (length ada___interfaces__c__to_ada__2__result)))
...
;; H
(assert
  (= (and (ite (<= (first ada___interfaces__c__to_ada__2__result) usf)
            true
            false) (ite (<= usf (last ada___interfaces__c__to_ada__2__result))
                     true
                     false)) true))
