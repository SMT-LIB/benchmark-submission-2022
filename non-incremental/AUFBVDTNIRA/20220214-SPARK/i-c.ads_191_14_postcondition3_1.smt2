...
(assert
  ...
  (=>
    ...
    (let ((temp___1299 (of_array2
      ...
      (forall ((temp___1300 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___1299) temp___1300)
            (bvule temp___1300 (last2 temp___1299)))
          (= (us_attr__init (select (to_array2 temp___1299) temp___1300)) true)))))))
