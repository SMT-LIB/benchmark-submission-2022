...
(assert
  ...
  (=>
    ...
    (let ((temp___1435 (of_array2
      ...
      (forall ((temp___1436 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___1435) temp___1436)
            (bvule temp___1436 (last2 temp___1435)))
          (= (us_attr__init (select (to_array2 temp___1435) temp___1436)) true)))))))
