...
(declare-datatypes ((s262b__init_wrapper__ref 0))
  (((s262b__init_wrapper__refqtmk (s262b__init_wrapper__content us_t2)))))

;; s262b__init_wrapper__ref_s262b__init_wrapper__content__projection
(define-fun s262b__init_wrapper__ref_s262b__init_wrapper__content__projection 
  ((a s262b__init_wrapper__ref)) us_t2
  (s262b__init_wrapper__content a))
...
(declare-datatypes ((t263b__ref 0))
  (((t263b__refqtmk (t263b__content integer)))))

;; t263b__ref_t263b__content__projection
(define-fun t263b__ref_t263b__content__projection ((a t263b__ref)) integer
  (t263b__content a))

(declare-datatypes ((t271b__init_wrapper__ref 0))
  (((t271b__init_wrapper__refqtmk (t271b__init_wrapper__content us_t2)))))

;; t271b__init_wrapper__ref_t271b__init_wrapper__content__projection
(define-fun t271b__init_wrapper__ref_t271b__init_wrapper__content__projection 
  ((a t271b__init_wrapper__ref)) us_t2
  (t271b__init_wrapper__content a))
...
(declare-datatypes ((s262b__ref 0))
  (((s262b__refqtmk (s262b__content us_t1)))))

;; s262b__ref_s262b__content__projection
(define-fun s262b__ref_s262b__content__projection ((a s262b__ref)) us_t1
  (s262b__content a))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_964 us_t1) (temp___is_init_960 Bool) (temp___skip_constant_961 Bool) (temp___do_toplevel_962 Bool) (temp___do_typ_inv_963 Bool)) Bool
  (=>
    (not (= temp___skip_constant_961 true))
    (and
      (and
        (dynamic_property1
          (to_rep2 target__first)
          (to_rep2 target__last)
          (first1 temp___expr_964)
          (last1 temp___expr_964))
        (= (first1 temp___expr_964) (to_rep2 target__first)))
      (= (last1 temp___expr_964) (to_rep2 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_970 us_t1) (temp___skip_top_level_971 Bool)) Bool
  (and
    (= (first1 temp___expr_970) (to_rep2 target__first))
    (= (last1 temp___expr_970) (to_rep2 target__last))))
                    ...
                    (and
                      ...
                      (exists ((o10 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___1340 (of_array2 target o10 o9)))
                            (exists ((o11 Int))
                              (and
                                ...
                                (exists ((o12 char1))
                                  (and
                                    ...
                                    (and
                                      (and
                                        (bvule (first2 temp___1340) to__1)
                                        (bvule to__1 (last2 temp___1340)))
                                      (exists ((target3 (Array (_ BitVec 64) char__init_wrapper)))
                                        (and
                                          (= target3 (to_array2
                                                       (us_tqtmk2
                                                         (store (to_array2
                                                                  temp___1340) 
                                                         to__1 (char__init_wrapperqtmk
                                                                 o12
                                                                 true))
                                                         (rt2 temp___1340))))
                                          (exists ((o13 (_ BitVec 64)))
                                            (and
                                              (= (to_rep2 target__last) o13)
                                              (exists ((o14 (_ BitVec 64)))
                                                (and
                                                  (= (to_rep2 target__first) o14)
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    to__3)))
                                                                    (forall 
                                                                    ((temp___1373 (_ BitVec 64)))
                                                                    (=>
                                                                    (and
                                                                    (bvule 
                                                                    (first2
                                                                    temp___1372) temp___1373)
                                                                    (bvule temp___1373 
                                                                    (last2
                                                                    temp___1372)))
                                                                    (= 
            ...
            (and
              ...
              (and
                ...
                (and
                  ...
                  (let ((temp___1394 (of_array2 target2 o11 o10)))
                    (and
                      (= (to_rep3 o12) 0)
                      (and
                        (and
                          (bvule (first2 temp___1394) to__2)
                          (bvule to__2 (last2 temp___1394)))
                        (and
                          (= target1 (to_array2
                                       (us_tqtmk2
                                         (store (to_array2 temp___1394) 
                                         to__2 (char__init_wrapperqtmk
                                                 o12
                                                 true))
                                         (rt2 temp___1394))))
...
(declare-const temp___1403 (_ BitVec 64))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (let ((temp___1405 (bvadd o16 (bvsub count1 #x0000000000000001))))
              (and
                (= (to_rep2 target__last) o17)
                (and
                  (= (to_rep2 target__first) o18)
                  (and
                    (= (to_rep2 target__first) temp___1403)
                    (and
                      (= (to_rep2 target__last) o19)
                      (and
                        (= (to_rep2 target__first) o20)
                        (let ((temp___1401 (of_array2 target1 o20 o19)))
                          (and
                            (=>
                              (bvule temp___1403 temp___1405)
                              (and
                                (and
                                  (bvule (first2 temp___1401) temp___1403)
                                  (bvule temp___1403 (last2 temp___1401)))
                                (and
                                  (bvule (first2 temp___1401) temp___1405)
                                  (bvule temp___1405 (last2 temp___1401)))))
                            (let ((temp___1406 (of_array2
                                                 (to_array2 temp___1401)
                                                 temp___1403
                                                 temp___1405)))
                              (= true (ite (forall ((temp___1407 (_ BitVec 64)))
                                             (=>
                                               (and
                                                 (bvule (first2 temp___1406) temp___1407)
                                                 (bvule temp___1407 (last2
                                                                    temp___1406)))
                                               (= (us_attr__init
                                                    (select (to_array2
                                                              temp___1406) temp___1407)) true)))
                                        true
                                        false))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
