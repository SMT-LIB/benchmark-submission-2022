                    ...
                    (and
                      ...
                      (exists ((o6 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___1229 (of_array2 target o6 o5)))
                            (exists ((o7 Int))
                              (and
                                ...
                                (exists ((o8 char1))
                                  (and
                                    ...
                                    (and
                                      (and
                                        (bvule (first2 temp___1229) to__1)
                                        (bvule to__1 (last2 temp___1229)))
                                                            ...
                                                            (and
                                                              (let ((temp___1256 
                                                                (of_array2
                                                                  ...
                                                                  to__3)))
                                                                (forall 
                                                                  ((temp___1257 (_ BitVec 64)))
                                                                  (=>
                                                                    (and
                                                                    (bvule 
                                                                    (first2
                                                                    temp___1256) temp___1257)
                                                                    (bvule temp___1257 
                                                                    (last2
                                                                    temp___1256)))
                                                                    (= 
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (let ((temp___1269 (of_array2 target2 o5 o4)))
                (and
                  (= (to_rep3 o6) 0)
                  (and
                    (and
                      (bvule (first2 temp___1269) to__2)
                      (bvule to__2 (last2 temp___1269)))
                    (and
                      (= target1 (to_array2
                                   (us_tqtmk2
                                     (store (to_array2 temp___1269) to__2 
...
(declare-const temp___1275 (_ BitVec 64))
  ...
  (ite (= count1 o7)
    (ite (not (= count1 #x0000000000000000))
      (and
        ...
        (let ((temp___1276 (bvadd o8 (bvsub count1 #x0000000000000001))))
          (and
            (= (to_rep2 target__first) temp___1275)
            (and
              (= (to_rep2 target__last) o9)
              (and
                (= (to_rep2 target__first) o10)
                (let ((temp___1274 (of_array2 target1 o10 o9)))
                  (and
                    (=>
                      (bvule temp___1275 temp___1276)
                      (and
                        (and
                          (bvule (first2 temp___1274) temp___1275)
                          (bvule temp___1275 (last2 temp___1274)))
                        (and
                          (bvule (first2 temp___1274) temp___1276)
                          (bvule temp___1276 (last2 temp___1274)))))
                    (let ((temp___1277 (of_array2
                                         (to_array2 temp___1274)
                                         temp___1275
                                         temp___1276)))
                      (= true (ite (forall ((temp___1278 (_ BitVec 64)))
                                     (=>
                                       (and
                                         (bvule (first2 temp___1277) temp___1278)
                                         (bvule temp___1278 (last2
                                                              temp___1277)))
                                       (= (us_attr__init
                                            (select (to_array2 temp___1277) temp___1278)) true)))
                                true
                                false))))))))))
      (= true (of_int 1)))
    (= true false)))
