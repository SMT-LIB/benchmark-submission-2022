  ...
  (ite (= count1 o7)
    (ite (not (= count1 #x0000000000000000))
      (and
        ...
        (let ((temp___1276 (bvadd o9 (bvsub count1 #x0000000000000001))))
          (and
            ...
            (and
              ...
              (and
                ...
                (let ((temp___1274 (of_array2 target1 o11 o10)))
                  (and
                    (=>
                    ...
                    (let ((temp___1277 (of_array2
                                         ...
                                         temp___1275
                                         temp___1276)))
                      (= o8 (ite (forall ((temp___1278 (_ BitVec 64)))
                                   (=>
                                     (and
                                       (bvule (first2 temp___1277) temp___1278)
                                       (bvule temp___1278 (last2 temp___1277)))
                                     (= (us_attr__init
