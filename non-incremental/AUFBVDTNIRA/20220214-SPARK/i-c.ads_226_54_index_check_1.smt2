      ...
      (and
        ...
        (let ((o6 (+ o3 (- count1 1))))
          (and
            (in_range1 o6)
            (and
              (= (to_rep1 target__first) temp___1361)
              (and
                (= (to_rep1 target__last) o4)
                (and
                  (= (to_rep1 target__first) o5)
                  (let ((temp___1360 (of_array2 target1 o5 o4)))
                    (and
                      (=>
                        (<= temp___1361 o6)
                        (and
                          (and
                            (<= (first2 temp___1360) temp___1361)
                            (<= temp___1361 (last2 temp___1360)))
                          (and
                            (<= (first2 temp___1360) o6)
                            (<= o6 (last2 temp___1360)))))
                      (let ((temp___1363 (of_array2
                                           (to_array2 temp___1360)
                                           temp___1361
                                           o6)))
                        (= true (ite (forall ((temp___1364 Int))
                                       (=>
                                         (and
                                           (<= (first2 temp___1363) temp___1364)
                                           (<= temp___1364 (last2
                                                             temp___1363)))
                                         (= (us_attr__init
                                              (select (to_array2 temp___1363) temp___1364)) true)))
                                  true
                                  false)))))))))))
      (= true (of_int 1)))
    (= true false)))
