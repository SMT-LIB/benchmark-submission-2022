        ...
        (forall ((k Int))
          (to_ada__function_guard
            ...
            (to_rep3
              ...
              (first1
                item))))))
        (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1454)
                                                 true
                                                 false)) true)
          (exists ((o6 Int))
            (and
                    ...
                    (and
                      ...
                      (exists ((o9 Int))
                        (and
                          ...
                          (let ((temp___1456 (of_array2 target o9 o8)))
                            (and
                              (and
                                (bvule (first1 item) from3)
                                (bvule from3 (last1 item)))
                              (exists ((o10 Int))
                                (and
                                  ...
                                  (exists ((o11 character))
                                    (and
                                      (= (to_rep o11) o10)
                                      (and
                                        (and
                                          (<= (first2 temp___1456) to__1)
                                          (<= to__1 (last2 temp___1456)))
              ...
              (and
                ...
                (and
                  ...
                  (and
                    ...
                    (and
                      (= (to_rep1 target__first) temp___1519)
                      (and
                        (= (to_rep1 target__last) o12)
                        (and
                          (= (to_rep1 target__first) o13)
                          (let ((temp___1517 (of_array2 target1 o13 o12)))
                            (and
                              (=>
                                (<= temp___1519 o14)
                                (and
                                  (and
                                    (<= (first2 temp___1517) temp___1519)
                                    (<= temp___1519 (last2 temp___1517)))
                                  (and
                                    (<= (first2 temp___1517) o14)
                                    (<= o14 (last2 temp___1517)))))
                              (let ((temp___1522 (of_array2
                                                   (to_array2 temp___1517)
                                                   temp___1519
                                                   o14)))
                                (= true (ite (forall ((temp___1523 Int))
                                               (=>
                                                 (and
                                                   (<= (first2 temp___1522) temp___1523)
                                                   (<= temp___1523 (last2
                                                                    temp___1522)))
                                                 (= (us_attr__init
                                                      (select (to_array2
                                                                temp___1522) temp___1523)) true)))
                                          true
                                          false)))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
