           ...
           (=>
             ...
             (=
               ...
               (exists ((temp___444 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first item) temp___444)
                     (bvule temp___444 (last item)))
                   (= (to_rep1 (select (to_array item) temp___444)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
...
(declare-const ada___interfaces__c__c_length_ghost__2__result (_ BitVec 64))
...
(assert
  (ite (= spark__branch true)
    (= ada___interfaces__c__c_length_ghost__2__result (bvsub j (first item)))
    (and
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= spark__branch1 true)
                  (= ada___interfaces__c__c_length_ghost__2__result (bvsub 
                  j2 (first item))))))))))))
...
(assert
  ...
  (forall ((j3 (_ BitVec 64)))
    (=>
      (and
        (bvule (first item) j3)
        (bvule j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__2__result)))
      (=>
        (not
          (= j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__2__result)))
