...
;; H
(assert (= (to_rep1 r__last) temp___1690))
      ...
      (forall ((k Int))
        (to_ada__function_guard
          ...
          (to_rep3
            ...
            (first1
              item))))))
      (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1690)
                                               true
                                               false)) true)
        (exists ((o1 Int))
          (and
                ...
                (exists ((o3 Int))
                  (and
                    ...
                    (exists ((o4 Int))
                      (and
                        (= (to_rep1 r__first) o4)
                        (let ((temp___1693 (of_array2 r o4 o3)))
                          (let ((temp___1692 (bvadd (bvsub (of_int j) #x0000000000000001) 
                            (first1
                              item))))
                            (and
                              (and
                                (bvule (first1 item) temp___1692)
                                (bvule temp___1692 (last1 item)))
                              (exists ((o5 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) temp___1692)) o5)
                                  (let ((o6 (to_ada o5)))
                                    (and
                                      (and
...
(assert
  (forall ((temp___1724 Int))
    (=>
      (and
        (<= (first2 (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1724)
        (<= temp___1724 (last2
                          (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last)))))
      (= (us_attr__init
           (select (to_array2
                     (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___1724)) true))))
...
(declare-const ada___interfaces__c__to_ada__5__result us_t)

;; H
(assert
  (= ada___interfaces__c__to_ada__5__result (of_array
                                              (convert
                                                (to_array2
                                                  (of_array2
                                                    r1
...
;; H
(assert
  (ite (= (first ada___interfaces__c__to_ada__5__result) 1)
    (and
      (ite (= trim_nul true)
        (let ((o2 item))
          (and
      ...
      (let ((o2 (length ada___interfaces__c__to_ada__5__result)))
...
;; H
(assert
  (= (and (ite (<= (first ada___interfaces__c__to_ada__5__result) usf)
            true
            false) (ite (<= usf (last ada___interfaces__c__to_ada__5__result))
                     true
                     false)) true))
