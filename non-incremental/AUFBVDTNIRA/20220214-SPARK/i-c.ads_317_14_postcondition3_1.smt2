...
(assert
  ...
  (=>
    ...
    (let ((temp___1630 (of_array2
      ...
      (forall ((temp___1631 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___1630) temp___1631)
            (bvule temp___1631 (last2 temp___1630)))
          (= (us_attr__init (select (to_array2 temp___1630) temp___1631)) true)))))))
