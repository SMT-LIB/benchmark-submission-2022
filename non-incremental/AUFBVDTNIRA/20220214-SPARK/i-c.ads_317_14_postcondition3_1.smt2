...
(assert
  ...
  (=>
    ...
    (let ((temp___1871 (of_array2
      ...
      (forall ((temp___1872 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___1871) temp___1872)
            (bvule temp___1872 (last2 temp___1871)))
          (= (us_attr__init (select (to_array2 temp___1871) temp___1872)) true)))))))
