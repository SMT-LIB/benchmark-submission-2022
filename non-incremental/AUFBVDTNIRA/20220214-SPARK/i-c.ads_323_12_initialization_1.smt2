...
(declare-datatypes ((t86s__init_wrapper__ref 0))
  (((t86s__init_wrapper__refqtmk (t86s__init_wrapper__content us_t2)))))

;; t86s__init_wrapper__ref_t86s__init_wrapper__content__projection
(define-fun t86s__init_wrapper__ref_t86s__init_wrapper__content__projection 
  ((a t86s__init_wrapper__ref)) us_t2
  (t86s__init_wrapper__content a))

(declare-datatypes ((s301b__init_wrapper__ref 0))
  (((s301b__init_wrapper__refqtmk (s301b__init_wrapper__content us_t2)))))

;; s301b__init_wrapper__ref_s301b__init_wrapper__content__projection
(define-fun s301b__init_wrapper__ref_s301b__init_wrapper__content__projection 
  ((a s301b__init_wrapper__ref)) us_t2
  (s301b__init_wrapper__content a))
...
(declare-datatypes ((t302b__ref 0))
  (((t302b__refqtmk (t302b__content integer)))))

;; t302b__ref_t302b__content__projection
(define-fun t302b__ref_t302b__content__projection ((a t302b__ref)) integer
  (t302b__content a))

(declare-datatypes ((t310b__init_wrapper__ref 0))
  (((t310b__init_wrapper__refqtmk (t310b__init_wrapper__content us_t2)))))
...
(define-fun t310b__init_wrapper__ref_t310b__init_wrapper__content__projection 
  ((a t310b__init_wrapper__ref)) us_t2
  (t310b__init_wrapper__content a))

(declare-datatypes ((t318b__init_wrapper__ref 0))
  (((t318b__init_wrapper__refqtmk (t318b__init_wrapper__content us_t2)))))

;; t318b__init_wrapper__ref_t318b__init_wrapper__content__projection
(define-fun t318b__init_wrapper__ref_t318b__init_wrapper__content__projection 
  ((a t318b__init_wrapper__ref)) us_t2
  (t318b__init_wrapper__content a))
...
(declare-datatypes ((s301b__ref 0))
  (((s301b__refqtmk (s301b__content us_t1)))))

;; s301b__ref_s301b__content__projection
(define-fun s301b__ref_s301b__content__projection ((a s301b__ref)) us_t1
  (s301b__content a))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1020 us_t1) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool) (temp___do_typ_inv_1019 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1017 true))
    (and
      (and
        (dynamic_property1
          (to_rep2 target__first)
          (to_rep2 target__last)
          (first1 temp___expr_1020)
          (last1 temp___expr_1020))
        (= (first1 temp___expr_1020) (to_rep2 target__first)))
      (= (last1 temp___expr_1020) (to_rep2 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1026 us_t1) (temp___skip_top_level_1027 Bool)) Bool
  (and
    (= (first1 temp___expr_1026) (to_rep2 target__first))
    (= (last1 temp___expr_1026) (to_rep2 target__last))))

(declare-const target (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(declare-const target1 (Array (_ BitVec 64) wchar_t__init_wrapper))
...
(declare-const target2 (Array (_ BitVec 64) wchar_t__init_wrapper))
                    ...
                    (and
                      ...
                      (exists ((o10 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___1749 (of_array2 target o10 o9)))
                            (exists ((o11 Int))
                              (and
                                  ...
                                  (and
                                    ...
                                    (exists ((o13 wchar_t))
                                      (and
                                        ...
                                        (and
                                          (and
                                            (bvule (first2 temp___1749) 
                                            to__1)
                                            (bvule to__1 (last2 temp___1749)))
                                          (exists ((target3 (Array (_ BitVec 64) wchar_t__init_wrapper)))
                                            (and
                                              (= target3 (to_array2
                                                           (us_tqtmk2
                                                             (store (to_array2
                                                                    temp___1749) 
                                                             to__1 (wchar_t__init_wrapperqtmk
                                                                    o13
                                                                    true))
                                                             (rt2
                                                               temp___1749))))
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    to__3)))
                                                                    (forall 
                                                                    ((temp___1782 (_ BitVec 64)))
                                                                    (=>
                                                                    (and
                                                                    (bvule 
                                                                    (first2
                                                                    temp___1781) temp___1782)
                                                                    (bvule temp___1782 
                                                                    (last2
                                                                    temp___1781)))
                                                                    (= 
...
(assert
  (=>
    ...
    (let ((temp___1826 (of_array2
      ...
      (forall ((temp___1827 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___1826) temp___1827)
            (bvule temp___1827 (last2 temp___1826)))
          (= (us_attr__init (select (to_array2 temp___1826) temp___1827)) true))))))
            ...
            (and
              ...
              (and
                ...
                (and
                  ...
                  (let ((temp___1830 (of_array2 target2 o11 o10)))
                    (and
                      (= (to_rep3 o12) 0)
                      (and
                        (and
                          (bvule (first2 temp___1830) to__2)
                          (bvule to__2 (last2 temp___1830)))
                        (and
                          (= target1 (to_array2
                                       (us_tqtmk2
                                         (store (to_array2 temp___1830) 
                                         to__2 (wchar_t__init_wrapperqtmk
                                                 o12
                                                 true))
                                         (rt2 temp___1830))))
...
(declare-const temp___1839 (_ BitVec 64))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (let ((temp___1841 (bvadd o16 (bvsub count1 #x0000000000000001))))
              (and
                (= (to_rep2 target__last) o17)
                (and
                  (= (to_rep2 target__first) o18)
                  (and
                    (= (to_rep2 target__first) temp___1839)
                    (and
                      (= (to_rep2 target__last) o19)
                      (and
                        (= (to_rep2 target__first) o20)
                        (let ((temp___1837 (of_array2 target1 o20 o19)))
                          (and
                            (=>
                              (bvule temp___1839 temp___1841)
                              (and
                                (and
                                  (bvule (first2 temp___1837) temp___1839)
                                  (bvule temp___1839 (last2 temp___1837)))
                                (and
                                  (bvule (first2 temp___1837) temp___1841)
                                  (bvule temp___1841 (last2 temp___1837)))))
                            (let ((temp___1842 (of_array2
                                                 (to_array2 temp___1837)
                                                 temp___1839
                                                 temp___1841)))
                              (= true (ite (forall ((temp___1843 (_ BitVec 64)))
                                             (=>
                                               (and
                                                 (bvule (first2 temp___1842) temp___1843)
                                                 (bvule temp___1843 (last2
                                                                    temp___1842)))
                                               (= (us_attr__init
                                                    (select (to_array2
                                                              temp___1842) temp___1843)) true)))
                                        true
                                        false))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
...
;; Goal def'vc
;; File "i-c.ads", line 308, characters 0-0
(assert
  (not
  (= (us_attr__init
       (select (to_array2
