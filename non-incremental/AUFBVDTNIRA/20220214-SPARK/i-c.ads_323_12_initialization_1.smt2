...
(declare-datatypes ((s297b__init_wrapper__ref 0))
  (((s297b__init_wrapper__refqtmk (s297b__init_wrapper__content us_t2)))))

;; s297b__init_wrapper__ref_s297b__init_wrapper__content__projection
(define-fun s297b__init_wrapper__ref_s297b__init_wrapper__content__projection 
  ((a s297b__init_wrapper__ref)) us_t2
  (s297b__init_wrapper__content a))
...
(declare-datatypes ((t298b__ref 0))
  (((t298b__refqtmk (t298b__content integer)))))

;; t298b__ref_t298b__content__projection
(define-fun t298b__ref_t298b__content__projection ((a t298b__ref)) integer
  (t298b__content a))

(declare-datatypes ((t306b__init_wrapper__ref 0))
  (((t306b__init_wrapper__refqtmk (t306b__init_wrapper__content us_t2)))))

;; t306b__init_wrapper__ref_t306b__init_wrapper__content__projection
(define-fun t306b__init_wrapper__ref_t306b__init_wrapper__content__projection 
  ((a t306b__init_wrapper__ref)) us_t2
  (t306b__init_wrapper__content a))
...
(declare-datatypes ((s297b__ref 0))
  (((s297b__refqtmk (s297b__content us_t1)))))

;; s297b__ref_s297b__content__projection
(define-fun s297b__ref_s297b__content__projection ((a s297b__ref)) us_t1
  (s297b__content a))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_942 us_t1) (temp___is_init_938 Bool) (temp___skip_constant_939 Bool) (temp___do_toplevel_940 Bool) (temp___do_typ_inv_941 Bool)) Bool
  (=>
    (not (= temp___skip_constant_939 true))
    (and
      (and
        (dynamic_property1
          (to_rep2 target__first)
          (to_rep2 target__last)
          (first1 temp___expr_942)
          (last1 temp___expr_942))
        (= (first1 temp___expr_942) (to_rep2 target__first)))
      (= (last1 temp___expr_942) (to_rep2 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_944 us_t1) (temp___skip_top_level_945 Bool)) Bool
  (and
    (= (first1 temp___expr_944) (to_rep2 target__first))
    (= (last1 temp___expr_944) (to_rep2 target__last))))
                    ...
                    (and
                      ...
                      (exists ((o6 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___1560 (of_array2 target o6 o5)))
                            (exists ((o7 Int))
                              (and
                                  ...
                                  (and
                                    ...
                                    (exists ((o9 wchar_t))
                                      (and
                                        ...
                                        (and
                                          (and
                                            (bvule (first2 temp___1560) 
                                            to__1)
                                            (bvule to__1 (last2 temp___1560)))
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  (let ((temp___1587 
                                                                    ...
                                                                    to__3)))
                                                                    (forall 
                                                                    ((temp___1588 (_ BitVec 64)))
                                                                    (=>
                                                                    (and
                                                                    (bvule 
                                                                    (first2
                                                                    temp___1587) temp___1588)
                                                                    (bvule temp___1588 
                                                                    (last2
                                                                    temp___1587)))
                                                                    (= 
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (let ((temp___1600 (of_array2 target2 o5 o4)))
                (and
                  (= (to_rep3 o6) 0)
                  (and
                    (and
                      (bvule (first2 temp___1600) to__2)
                      (bvule to__2 (last2 temp___1600)))
                    (and
                      (= target1 (to_array2
                                   (us_tqtmk2
                                     (store (to_array2 temp___1600) to__2 
...
(declare-const temp___1606 (_ BitVec 64))
  ...
  (ite (= count1 o7)
    (ite (not (= count1 #x0000000000000000))
      (and
        ...
        (let ((temp___1607 (bvadd o8 (bvsub count1 #x0000000000000001))))
          (and
            (= (to_rep2 target__first) temp___1606)
            (and
              (= (to_rep2 target__last) o9)
              (and
                (= (to_rep2 target__first) o10)
                (let ((temp___1605 (of_array2 target1 o10 o9)))
                  (and
                    (=>
                      (bvule temp___1606 temp___1607)
                      (and
                        (and
                          (bvule (first2 temp___1605) temp___1606)
                          (bvule temp___1606 (last2 temp___1605)))
                        (and
                          (bvule (first2 temp___1605) temp___1607)
                          (bvule temp___1607 (last2 temp___1605)))))
                    (let ((temp___1608 (of_array2
                                         (to_array2 temp___1605)
                                         temp___1606
                                         temp___1607)))
                      (= true (ite (forall ((temp___1609 (_ BitVec 64)))
                                     (=>
                                       (and
                                         (bvule (first2 temp___1608) temp___1609)
                                         (bvule temp___1609 (last2
                                                              temp___1608)))
                                       (= (us_attr__init
                                            (select (to_array2 temp___1608) temp___1609)) true)))
                                true
                                false))))))))))
      (= true (of_int 1)))
    (= true false)))
