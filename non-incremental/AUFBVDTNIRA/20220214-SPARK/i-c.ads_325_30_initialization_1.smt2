  ...
  (ite (= count1 o7)
    (ite (not (= count1 #x0000000000000000))
      (and
        ...
        (let ((temp___1607 (bvadd o9 (bvsub count1 #x0000000000000001))))
          (and
            ...
            (and
              ...
              (and
                ...
                (let ((temp___1605 (of_array2 target1 o11 o10)))
                  (and
                    (=>
                    ...
                    (let ((temp___1608 (of_array2
                                         ...
                                         temp___1606
                                         temp___1607)))
                      (= o8 (ite (forall ((temp___1609 (_ BitVec 64)))
                                   (=>
                                     (and
                                       (bvule (first2 temp___1608) temp___1609)
                                       (bvule temp___1609 (last2 temp___1608)))
                                     (= (us_attr__init
