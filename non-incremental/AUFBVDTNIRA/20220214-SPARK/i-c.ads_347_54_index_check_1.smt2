        ...
        (forall ((k Int))
          (to_ada__function_guard
            ...
            (to_rep3
              ...
              (first1
                item))))))
        (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1890)
                                                 true
                                                 false)) true)
          (exists ((o6 Int))
            (and
                    ...
                    (and
                      ...
                      (exists ((o9 Int))
                        (and
                          ...
                          (let ((temp___1892 (of_array2 target o9 o8)))
                            (and
                              (and
                                (bvule (first1 item) from3)
                                (bvule from3 (last1 item)))
              ...
              (and
                ...
                (and
                  ...
                  (and
                    ...
                    (and
                      (= (to_rep1 target__first) temp___1955)
                      (and
                        (= (to_rep1 target__last) o12)
                        (and
                          (= (to_rep1 target__first) o13)
                          (let ((temp___1953 (of_array2 target1 o13 o12)))
                            (and
                              (=>
                                (<= temp___1955 o14)
                                (and
                                  (and
                                    (<= (first2 temp___1953) temp___1955)
                                    (<= temp___1955 (last2 temp___1953)))
                                  (and
                                    (<= (first2 temp___1953) o14)
                                    (<= o14 (last2 temp___1953)))))
                              (let ((temp___1958 (of_array2
                                                   (to_array2 temp___1953)
                                                   temp___1955
                                                   o14)))
                                (= true (ite (forall ((temp___1959 Int))
                                               (=>
                                                 (and
                                                   (<= (first2 temp___1958) temp___1959)
                                                   (<= temp___1959 (last2
                                                                    temp___1958)))
                                                 (= (us_attr__init
                                                      (select (to_array2
                                                                temp___1958) temp___1959)) true)))
                                          true
                                          false)))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
