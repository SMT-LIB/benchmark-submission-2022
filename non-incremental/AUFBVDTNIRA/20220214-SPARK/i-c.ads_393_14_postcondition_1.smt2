...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_519 us_t) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool) (temp___do_typ_inv_518 Bool)) Bool
  (=>
    (not (= temp___skip_constant_516 true))
    (dynamic_property
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first temp___expr_519)
      (last temp___expr_519))))
           ...
           (=>
             ...
             (=
               ...
               (exists ((temp___523 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first item) temp___523)
                     (bvule temp___523 (last item)))
                   (= (to_rep1 (select (to_array item) temp___523)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
