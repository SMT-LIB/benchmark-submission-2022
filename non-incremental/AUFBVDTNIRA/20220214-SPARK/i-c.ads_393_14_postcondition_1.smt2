...
;; user_eq
(declare-fun user_eq1 (char16_t
  char16_t) Bool)

(declare-const dummy1 char16_t)
...
;; to_rep
(declare-fun to_rep1 (char16_t) Int)

;; of_rep
(declare-fun of_rep1 (Int) char16_t)
...
;; range_axiom
(assert
  (forall ((x char16_t)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-datatypes ((map__ref 0))
  (((map__refqtmk (map__content (Array (_ BitVec 64) char16_t))))))

;; slide
(declare-fun slide ((Array (_ BitVec 64) char16_t)
  (_ BitVec 64)
...
;; const
(declare-fun const1 (char16_t) (Array (_ BitVec 64) char16_t))
...
;; bool_eq
(define-fun bool_eq4 ((a (Array (_ BitVec 64) char16_t)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) char16_t)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool
  (ite (and
         ...
         (forall ((temp___idx_204 (_ BitVec 64)))
           (=>
             ...
             (= (to_rep1 (select a temp___idx_204)) (to_rep1
...
(declare-datatypes ((us_t 0))
  (((us_tqtmk (elts (Array (_ BitVec 64) char16_t))(rt t)))))

;; to_array
(define-fun to_array ((a us_t)) (Array (_ BitVec 64) char16_t)
  (elts a))

;; of_array
(define-fun of_array ((a (Array (_ BitVec 64) char16_t)) (f (_ BitVec 64)) (l (_ BitVec 64))) us_t
  (us_tqtmk a (mk f l)))
...
(declare-datatypes ((char16_array__ref 0))
  (((char16_array__refqtmk (char16_array__content us_t)))))

;; char16_array__ref_char16_array__content__projection
(define-fun char16_array__ref_char16_array__content__projection ((a char16_array__ref)) us_t
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_495 us_t) (temp___is_init_491 Bool) (temp___skip_constant_492 Bool) (temp___do_toplevel_493 Bool) (temp___do_typ_inv_494 Bool)) Bool
  (=>
    (not (= temp___skip_constant_492 true))
    (dynamic_property
      #x0000000000000000
      #xFFFFFFFFFFFFFFFF
      (first temp___expr_495)
      (last temp___expr_495))))
           ...
           (=>
             ...
             (=
               ...
               (exists ((temp___499 (_ BitVec 64)))
                 (and
                   (and
                     (bvule (first item) temp___499)
                     (bvule temp___499 (last item)))
                   (= (to_rep1 (select (to_array item) temp___499)) 0))))))) :pattern (
    (is_nul_terminated
      item)) )))
...
(declare-datatypes ((t16b__ref 0))
  (((t16b__refqtmk (t16b__content size_t)))))

;; t16b__ref_t16b__content__projection
(define-fun t16b__ref_t16b__content__projection ((a t16b__ref)) size_t
  (t16b__content a))
...
(declare-const ada___interfaces__c__c_length_ghost__3__result (_ BitVec 64))
...
(assert
  (ite (= spark__branch true)
    (= ada___interfaces__c__c_length_ghost__3__result (bvsub j (first item)))
    (and
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= spark__branch1 true)
                  (= ada___interfaces__c__c_length_ghost__3__result (bvsub 
                  j2 (first item))))))))))))

;; Goal def'vc
;; File "i-c.ads", line 389, characters 0-0
(assert
  (not
  (forall ((j3 (_ BitVec 64)))
    (=>
      (and
        (bvule (first item) j3)
        (bvule j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__3__result)))
      (=>
        (not
          (= j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__3__result)))
