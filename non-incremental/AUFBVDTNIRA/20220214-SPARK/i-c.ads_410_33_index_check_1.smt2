...
(declare-const temp___2045 (_ BitVec 64))
                ...
                (and
                  (and
                    ...
                    (of_int
                      (length item))))
                  (and
                    (let ((temp___2012 (first item)))
                      (let ((temp___2013 (last item)))
                        (and
                          (= j1 temp___2012)
                          (ite (= (and (ite (<= temp___2012 j1) true false) 
                            (ite (<= j1 temp___2013)
                              true
                              false)) true)
                                ...
                                (exists ((o10 (_ BitVec 64)))
                                  (and
                                    ...
                                    (exists ((o11 (_ BitVec 64)))
                                      (and
                                        (= (to_rep2 r__last) o11)
                                        (exists ((o12 (_ BitVec 64)))
                                          (and
                                            (= (to_rep2 r__first) o12)
                                            (let ((temp___2015 (of_array2
                                                                 r
                                                                 o12
                                                                 o11)))
                                              (exists ((o13 Int))
                    ...
                    (and
                      ...
                      (and
                        (= (to_rep2 r__first) o3)
                        (let ((temp___2042 (of_array2 r3 o3 o2)))
                          (and
                            (= (to_rep3 o4) 0)
                            (and
                              (= (to_rep2 r__last) o5)
                              (and
                                (= (to_rep2 r__first) o6)
                                (and
                                  (= (to_rep2 r__last) temp___2045)
                                  (and
                                    (and
                                      (bvule (first2 temp___2042) temp___2045)
                                      (bvule temp___2045 (last2 temp___2042)))
                                    (and
                                      (= r4 (to_array2
                                              (us_tqtmk2
                                                (store (to_array2
                                                         temp___2042) 
                                                temp___2045 (char16_t__init_wrapperqtmk
                                                              o4
                                                              true))
                                                (rt2 temp___2042))))
                                      (and
                                        (forall ((j2 Int))
                                          (=>
                                            ...
                                            (to_c
                                              (to_rep
                                                (select (to_array item) j2))))))
                                        (and
                                          (= (to_rep2 r__last) o7)
                                          (and
                                            (= (to_rep2 r__first) o8)
                                            (let ((temp___2054 (of_array2
                                                                 r4
                                                                 o8
                                                                 o7)))
                                              (and
                                                (forall ((temp___2056 (_ BitVec 64)))
                                                  (=>
                                                    (and
                                                      (bvule (first2
                                                               temp___2054) temp___2056)
                                                      (bvule temp___2056 
                                                      (last2
                                                        temp___2054)))
                                                    (= (us_attr__init
                                                         (select (to_array2
                                                                   temp___2054) temp___2056)) true)))
                                                (and
                                                  (dynamic_property1
                                                    #x0000000000000000
                                                    #xFFFFFFFFFFFFFFFF
                        ...
                        (= (last2
                             (of_array2
                               ...
                               (to_rep2 r__last1))) (bvsub (of_int
                                                             (length item)) #x0000000000000001)))
                      (and
                        (let ((temp___2068 (first item)))
                          (let ((temp___2069 (last item)))
                            (and
                              (= j temp___2068)
                              (ite (= (and (ite (<= temp___2068 j)
                                             true
                                             false) (ite (<= j temp___2069)
                                                      true
                                                      false)) true)
                                (exists ((o9 (_ BitVec 64)))
                                  (and
                                    ...
                                    (exists ((o10 (_ BitVec 64)))
                                      (and
                                        ...
                                        (exists ((o11 (_ BitVec 64)))
                                          (and
                                            (= (to_rep2 r__last1) o11)
                                            (exists ((o12 (_ BitVec 64)))
                                              (and
                                                (= (to_rep2 r__first1) o12)
                                                (let ((temp___2071 (of_array2
                                                                    r1
                                                                    o12
                                                                    o11)))
                                                  (exists ((o13 Int))
                        ...
                        (and
                          ...
                          (and
                            ...
                            (let ((temp___2097 (of_array2 r2 o1 o)))
                              (and
                                (forall ((temp___2099 (_ BitVec 64)))
                                  (=>
                                    (and
                                      (bvule (first2 temp___2097) temp___2099)
                                      (bvule temp___2099 (last2 temp___2097)))
                                    (= (us_attr__init
                                         (select (to_array2 temp___2097) temp___2099)) true)))
                                (and
                                  (dynamic_property1
                                    #x0000000000000000
                                    #xFFFFFFFFFFFFFFFF
  ...
  (ite (= (first1 ada___interfaces__c__to_c__8__result) #x0000000000000000)
    (and
      (ite (= append_nul true)
        (= o9 (+ (length item) 1))
        (= o9 (length item)))
      (let ((o10 (length1 ada___interfaces__c__to_c__8__result)))
        (and (in_range4 o10) (= true (ite (= o10 o9) true false)))))
    (= true false)))
...
(assert
  (not
  (bvule (of_int (- usf (first item))) (last1
                                         ada___interfaces__c__to_c__8__result))))
