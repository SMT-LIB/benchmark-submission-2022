...
;; H
(assert (= (to_rep1 r__last) temp___2126))
      ...
      (forall ((k Int))
        (to_ada__function_guard
          ...
          (to_rep3
            ...
            (first1
              item))))))
      (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___2126)
                                               true
                                               false)) true)
        (exists ((o1 Int))
          (and
                ...
                (exists ((o3 Int))
                  (and
                    ...
                    (exists ((o4 Int))
                      (and
                        (= (to_rep1 r__first) o4)
                        (let ((temp___2129 (of_array2 r o4 o3)))
                          (let ((temp___2128 (bvadd (bvsub (of_int j) #x0000000000000001) 
                            (first1
                              item))))
                            (and
                              (and
                                (bvule (first1 item) temp___2128)
                                (bvule temp___2128 (last1 item)))
                              (exists ((o5 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) temp___2128)) o5)
                                  (let ((o6 (to_ada o5)))
                                    (and
                                      (and
                                        (to_ada__function_guard o6 o5)
                                        (and
                                          (dynamic_invariant1
                                            o6
                                            true
                                            ...
                                            true)
                                          (= o6 o5)))
                                      (exists ((o7 wide_character))
                                        (and
                                          (= (to_rep o7) o6)
                                          (exists ((r2 (Array Int wide_character__init_wrapper)))
                                            (and
                                              (= r2 (to_array2
                                                      (us_tqtmk2
                                                        (store (to_array2
                                                                 temp___2129) 
                                                        j (wide_character__init_wrapperqtmk
                                                            o7
                                                            true))
                                                        (rt2 temp___2129))))
                                              (exists ((j1 Int))
...
(assert
  (forall ((temp___2160 Int))
    (=>
      (and
        (<= (first2 (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___2160)
        (<= temp___2160 (last2
                          (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last)))))
      (= (us_attr__init
           (select (to_array2
                     (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___2160)) true))))
...
(declare-const ada___interfaces__c__to_ada__8__result us_t)

;; H
(assert
  (= ada___interfaces__c__to_ada__8__result (of_array
                                              (convert
                                                (to_array2
                                                  (of_array2
                                                    r1
...
;; H
(assert
  (ite (= (first ada___interfaces__c__to_ada__8__result) 1)
    (and
      (ite (= trim_nul true)
        (let ((o2 item))
          (and
            (= o1 (c_length_ghost o2))
            (and
              (c_length_ghost__function_guard o1 o2)
              (and
                (dynamic_invariant4 o1 true false true true)
                (and
                  (and
                    (bvule o1 (bvsub (last1 o2) (first1 o2)))
                    (= (to_rep3
                         (select (to_array1 o2) (bvadd (first1 o2) o1))) 0))
                  (forall ((j1 (_ BitVec 64)))
                    (=>
                      (and
                        (bvule (first1 o2) j1)
                        (bvule j1 (bvadd (first1 o2) o1)))
                      (=>
                        (not (= j1 (bvadd (first1 o2) o1)))
                        (not (= (to_rep3 (select (to_array1 o2) j1)) 0))))))))))
        (let ((o2 (length1 item)))
          (and (uint_in_range o2) (= o1 (of_int o2)))))
      (let ((o2 (length ada___interfaces__c__to_ada__8__result)))
        (and (uint_in_range o2) (= true (ite (= (of_int o2) o1) true false)))))
    (= true false)))
...
;; H
(assert
  (= (and (ite (<= (first ada___interfaces__c__to_ada__8__result) usf)
            true
            false) (ite (<= usf (last ada___interfaces__c__to_ada__8__result))
                     true
                     false)) true))

;; Ensures
(assert (uint_in_range usf))
