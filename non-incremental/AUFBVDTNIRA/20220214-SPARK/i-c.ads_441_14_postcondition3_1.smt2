...
(assert
  (not
  (=>
    (not (= count1 #x0000000000000000))
    (let ((temp___2307 (of_array2
                         (to_array2
                           (of_array2
                             target1
                             (to_rep2 target__first)
                             (to_rep2 target__last)))
                         (to_rep2 target__first)
                         (bvadd (to_rep2 target__first) (bvsub count1 #x0000000000000001)))))
      (forall ((temp___2308 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___2307) temp___2308)
            (bvule temp___2308 (last2 temp___2307)))
          (= (us_attr__init (select (to_array2 temp___2307) temp___2308)) true)))))))
