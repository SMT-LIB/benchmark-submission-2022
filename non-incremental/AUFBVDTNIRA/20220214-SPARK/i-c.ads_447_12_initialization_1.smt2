...
;; bool_eq
(define-fun bool_eq5 ((a (Array Int wide_character)) (a__first Int) (a__last Int) (b (Array Int wide_character)) (b__first Int) (b__last Int)) Bool
  (ite (and
...
(declare-datatypes ((t101s__init_wrapper__ref 0))
  (((t101s__init_wrapper__refqtmk (t101s__init_wrapper__content us_t2)))))

;; t101s__init_wrapper__ref_t101s__init_wrapper__content__projection
(define-fun t101s__init_wrapper__ref_t101s__init_wrapper__content__projection 
  ((a t101s__init_wrapper__ref)) us_t2
  (t101s__init_wrapper__content a))

(declare-datatypes ((s344b__init_wrapper__ref 0))
  (((s344b__init_wrapper__refqtmk (s344b__init_wrapper__content us_t2)))))

;; s344b__init_wrapper__ref_s344b__init_wrapper__content__projection
(define-fun s344b__init_wrapper__ref_s344b__init_wrapper__content__projection 
  ((a s344b__init_wrapper__ref)) us_t2
  (s344b__init_wrapper__content a))
...
(declare-datatypes ((t345b__ref 0))
  (((t345b__refqtmk (t345b__content integer)))))

;; t345b__ref_t345b__content__projection
(define-fun t345b__ref_t345b__content__projection ((a t345b__ref)) integer
  (t345b__content a))

(declare-datatypes ((t353b__init_wrapper__ref 0))
  (((t353b__init_wrapper__refqtmk (t353b__init_wrapper__content us_t2)))))

;; t353b__init_wrapper__ref_t353b__init_wrapper__content__projection
(define-fun t353b__init_wrapper__ref_t353b__init_wrapper__content__projection 
  ((a t353b__init_wrapper__ref)) us_t2
  (t353b__init_wrapper__content a))

(declare-datatypes ((t361b__init_wrapper__ref 0))
  (((t361b__init_wrapper__refqtmk (t361b__init_wrapper__content us_t2)))))

;; t361b__init_wrapper__ref_t361b__init_wrapper__content__projection
(define-fun t361b__init_wrapper__ref_t361b__init_wrapper__content__projection 
  ((a t361b__init_wrapper__ref)) us_t2
  (t361b__init_wrapper__content a))
...
(declare-datatypes ((s344b__ref 0))
  (((s344b__refqtmk (s344b__content us_t1)))))

;; s344b__ref_s344b__content__projection
(define-fun s344b__ref_s344b__content__projection ((a s344b__ref)) us_t1
  (s344b__content a))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1076 us_t1) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool) (temp___do_typ_inv_1075 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1073 true))
    (and
      (and
        (dynamic_property1
          (to_rep2 target__first)
          (to_rep2 target__last)
          (first1 temp___expr_1076)
          (last1 temp___expr_1076))
        (= (first1 temp___expr_1076) (to_rep2 target__first)))
      (= (last1 temp___expr_1076) (to_rep2 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1082 us_t1) (temp___skip_top_level_1083 Bool)) Bool
  (and
    (= (first1 temp___expr_1082) (to_rep2 target__first))
    (= (last1 temp___expr_1082) (to_rep2 target__last))))

(declare-const target (Array (_ BitVec 64) char16_t__init_wrapper))
...
(declare-const target1 (Array (_ BitVec 64) char16_t__init_wrapper))
...
;; H
(assert (= (to_rep2 target__last) o2))

(declare-const o3 (_ BitVec 64))

;; H
(assert (= (to_rep2 target__first) o3))

;; H
(assert (in_range4 (length (bv2nat64 o3) (bv2nat64 o2))))

(declare-const spark__branch Bool)

;; H
(assert
  (= spark__branch (ite (< (length (bv2nat64 o3) (bv2nat64 o2)) (length1
                                                                  item))
                     true
                     false)))
...
;; H
(assert (= (to_rep2 target__last) o4))

(declare-const o5 (_ BitVec 64))

;; H
(assert (= (to_rep2 target__first) o5))

(declare-const o6 (_ BitVec 64))

;; H
(assert (= (to_rep2 target__first) o6))
...
(declare-const target2 (Array (_ BitVec 64) char16_t__init_wrapper))
                    ...
                    (and
                      ...
                      (exists ((o10 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___2185 (of_array2 target o10 o9)))
                            (exists ((o11 Int))
                              (and
                                (= (to_rep (select (to_array item) from)) o11)
                                (let ((o12 (to_c o11)))
                                  (and
                                    (and
                                      (to_c__function_guard o12 o11)
                                      (and
                                        (dynamic_invariant2
                                          o12
                                          true
                                    ...
                                    (exists ((o13 char16_t))
                                      (and
                                        ...
                                        (and
                                          (and
                                            (bvule (first2 temp___2185) 
                                            to__1)
                                            (bvule to__1 (last2 temp___2185)))
                                          (exists ((target3 (Array (_ BitVec 64) char16_t__init_wrapper)))
                                            (and
                                              (= target3 (to_array2
                                                           (us_tqtmk2
                                                             (store (to_array2
                                                                    temp___2185) 
                                                             to__1 (char16_t__init_wrapperqtmk
                                                                    o13
                                                                    true))
                                                             (rt2
                                                               temp___2185))))
                                              (exists ((o14 (_ BitVec 64)))
                                                (and
                                                  (= (to_rep2 target__last) o14)
                                                  (exists ((o15 (_ BitVec 64)))
                                                    (and
                                                      (= (to_rep2
                                                           target__first) o15)
                                                      (exists ((o16 (_ BitVec 64)))
                                                        (and
                                                          (= (to_rep2
                                                               target__last) o16)
                                                          (exists ((o17 (_ BitVec 64)))
                                                            (and
                                                              (= (to_rep2
                                                                   target__last) o17)
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    to__3)))
                                                                    (forall 
                                                                    ((temp___2218 (_ BitVec 64)))
                                                                    (=>
                                                                    (and
                                                                    (bvule 
                                                                    (first2
                                                                    temp___2217) temp___2218)
                                                                    (bvule temp___2218 
                                                                    (last2
                                                                    temp___2217)))
                                                                    (= 
        ...
        (= (to_rep3
             (rec__value
               ...
               (of_int
                 (- j (first item))))))) (to_c
                                           (to_rep
                                             (select (to_array item) j))))))))

;; H
(assert
  (=>
    (not (= (length1 item) 0))
    (let ((temp___2262 (of_array2
                         (to_array2
                           (of_array2
                             target2
                             (to_rep2 target__first)
                             (to_rep2 target__last)))
                         (to_rep2 target__first)
                         (bvadd (to_rep2 target__first) (bvsub (of_int
                                                                 (length1
                                                                   item)) #x0000000000000001)))))
      (forall ((temp___2263 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___2262) temp___2263)
            (bvule temp___2263 (last2 temp___2262)))
          (= (us_attr__init (select (to_array2 temp___2262) temp___2263)) true))))))
    ...
    (and
      ...
      (and
        ...
        (and
          (= (to_rep2 target__last) o9)
          (and
            (= spark__branch2 (ite (bvugt to__2 o9) true false))
            (and
              (not (= spark__branch2 true))
              (and
                (= (to_rep2 target__last) o10)
                (and
                  (= (to_rep2 target__first) o11)
                  (let ((temp___2266 (of_array2 target2 o11 o10)))
                    (and
                      (= (to_rep3 o12) 0)
                      (and
                        (and
                          (bvule (first2 temp___2266) to__2)
                          (bvule to__2 (last2 temp___2266)))
                        (and
                          (= target1 (to_array2
                                       (us_tqtmk2
                                         (store (to_array2 temp___2266) 
                                         to__2 (char16_t__init_wrapperqtmk
                                                 o12
                                                 true))
                                         (rt2 temp___2266))))
                          (let ((o13 (length1 item)))
                            (and
                              (uint_in_range o13)
                              (= count1 (bvadd (of_int o13) #x0000000000000001)))))))))))))))
    (and
      (let ((o13 (length1 item)))
        (and (uint_in_range o13) (= count1 (of_int o13))))
      (= target1 target2))))
...
(assert
  (ite (= append_nul true)
    (let ((o14 (length1 item)))
      (and
        (uint_in_range o14)
        (= o13 (bvadd (of_int o14) #x0000000000000001))))
    (let ((o14 (length1 item)))
      (and (uint_in_range o14) (= o13 (of_int o14))))))
...
(declare-const temp___2275 (_ BitVec 64))
  ...
  (ite (= count1 o13)
    (ite (not (= count1 #x0000000000000000))
      (and
        (= (to_rep2 target__last) o14)
        (and
          (= (to_rep2 target__first) o15)
          (and
            (= (to_rep2 target__first) o16)
            (let ((temp___2277 (bvadd o16 (bvsub count1 #x0000000000000001))))
              (and
                (= (to_rep2 target__last) o17)
                (and
                  (= (to_rep2 target__first) o18)
                  (and
                    (= (to_rep2 target__first) temp___2275)
                    (and
                      (= (to_rep2 target__last) o19)
                      (and
                        (= (to_rep2 target__first) o20)
                        (let ((temp___2273 (of_array2 target1 o20 o19)))
                          (and
                            (=>
                              (bvule temp___2275 temp___2277)
                              (and
                                (and
                                  (bvule (first2 temp___2273) temp___2275)
                                  (bvule temp___2275 (last2 temp___2273)))
                                (and
                                  (bvule (first2 temp___2273) temp___2277)
                                  (bvule temp___2277 (last2 temp___2273)))))
                            (let ((temp___2278 (of_array2
                                                 (to_array2 temp___2273)
                                                 temp___2275
                                                 temp___2277)))
                              (= true (ite (forall ((temp___2279 (_ BitVec 64)))
                                             (=>
                                               (and
                                                 (bvule (first2 temp___2278) temp___2279)
                                                 (bvule temp___2279 (last2
                                                                    temp___2278)))
                                               (= (us_attr__init
                                                    (select (to_array2
                                                              temp___2278) temp___2279)) true)))
                                        true
                                        false))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
  ...
  (and
    (bvule (first2
             (of_array2
               target1
               (to_rep2 target__first)
               (to_rep2 target__last))) (bvadd (to_rep2 target__first) 
    (of_int
      (- usf (first item)))))
    (bvule (bvadd (to_rep2 target__first) (of_int (- usf (first item)))) 
    (last2
      (of_array2 target1 (to_rep2 target__first) (to_rep2 target__last))))))

;; Goal def'vc
;; File "i-c.ads", line 432, characters 0-0
(assert
  (not
  (= (us_attr__init
       (select (to_array2
