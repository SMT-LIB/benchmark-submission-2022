...
(assert
  (ite (= count1 o13)
    (ite (not (= count1 #x0000000000000000))
      (and
        (= (to_rep2 target__last) o15)
        (and
          (= (to_rep2 target__first) o16)
          (and
            (= (to_rep2 target__first) o17)
            (let ((temp___2277 (bvadd o17 (bvsub count1 #x0000000000000001))))
              (and
                (= (to_rep2 target__last) o18)
                (and
                  (= (to_rep2 target__first) o19)
                  (and
                    (= (to_rep2 target__first) temp___2275)
                    (and
                      (= (to_rep2 target__last) o20)
                      (and
                        (= (to_rep2 target__first) o21)
                        (let ((temp___2273 (of_array2 target1 o21 o20)))
                          (and
                            (=>
                            ...
                            (let ((temp___2278 (of_array2
                                                 ...
                                                 temp___2275
                                                 temp___2277)))
                              (= o14 (ite (forall ((temp___2279 (_ BitVec 64)))
                                            (=>
                                              (and
                            ...
                            (rec__value
                              (select (to_array2
                                        (of_array2
                                          target1
                                          (to_rep2 target__first)
                                          (to_rep2 target__last))) (bvadd 
                              (to_rep2
                                target__first) (of_int (- j (first item))))))) 
                       (to_c
                         (to_rep (select (to_array item) j))))))
                true
                false))
  ...
  (and
    (bvule (first2
             (of_array2
               target1
               (to_rep2 target__first)
               (to_rep2 target__last))) (bvadd (to_rep2 target__first) (bvsub 
    count1 #x0000000000000001)))
    (bvule (bvadd (to_rep2 target__first) (bvsub count1 #x0000000000000001)) 
    (last2
