...
;; H
(assert (= (to_rep1 target__last) o1))
...
;; H
(assert (in_range1 (length o2 o1)))

(declare-const spark__branch2 Bool)

;; H
(assert (= spark__branch2 (ite (< (length o2 o1) count1) true false)))
...
;; H
(assert (= (to_rep1 target__last) o3))
...
;; H
(assert (= (to_rep1 target__first) o5))
        ...
        (forall ((k Int))
          (to_ada__function_guard
            ...
            (to_rep3
              ...
              (first1
                item))))))
        (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___2326)
                                                 true
                                                 false)) true)
          (exists ((o6 Int))
            (and
              (= (to_rep1 target__last) o6)
              (exists ((o7 Int))
                (and
                  (= (to_rep1 target__first) o7)
                  (exists ((o8 Int))
                    (and
                      (= (to_rep1 target__last) o8)
                      (exists ((o9 Int))
                        (and
                          (= (to_rep1 target__first) o9)
                          (let ((temp___2328 (of_array2 target o9 o8)))
                            (and
                              (and
                                (bvule (first1 item) from3)
                                (bvule from3 (last1 item)))
                              (exists ((o10 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) from3)) o10)
                                  (let ((o11 (to_ada o10)))
                                    (and
                                      (and
                                        (to_ada__function_guard o11 o10)
                                        (and
                                          (dynamic_invariant2
                                            o11
                                            true
                                        ...
                                        (and
                                          ...
                                          (and
                                            (and
                                              (<= (first2 temp___2328) 
                                              to__1)
                                              (<= to__1 (last2 temp___2328)))
                                            (exists ((target2 (Array Int wide_character__init_wrapper)))
                                              (and
                                                (= target2 (to_array2
                                                             (us_tqtmk2
                                                               (store 
...
(assert
  (ite (= trim_nul true)
    (let ((o7 item))
      (let ((o8 (c_length_ghost o7)))
        (and
          (and
            (c_length_ghost__function_guard o8 o7)
            (and
              (dynamic_invariant5 o8 true false true true)
              (and
                (and
                  (bvule o8 (bvsub (last1 o7) (first1 o7)))
                  (= (to_rep3 (select (to_array1 o7) (bvadd (first1 o7) o8))) 0))
                (forall ((j1 (_ BitVec 64)))
                  (=>
                    (and
                      (bvule (first1 o7) j1)
                      (bvule j1 (bvadd (first1 o7) o8)))
                    (=>
                      (not (= j1 (bvadd (first1 o7) o8)))
                      (not (= (to_rep3 (select (to_array1 o7) j1)) 0))))))))
          (let ((o9 (bv2nat64 o8))) (and (= o6 o9) (in_range2 o9))))))
    (let ((o7 (length2 item))) (and (= o6 o7) (in_range1 o7)))))
...
(assert
  (ite (= count1 o6)
    (ite (not (= count1 0))
      (and
        (= (to_rep1 target__last) o7)
        (and
          (= (to_rep1 target__first) o8)
          (and
            (= (to_rep1 target__first) o9)
            (let ((o14 (+ o9 (- count1 1))))
              (and
                (in_range1 o14)
                (and
                  (= (to_rep1 target__last) o10)
                  (and
                    (= (to_rep1 target__first) o11)
                    (and
                      (= (to_rep1 target__first) temp___2391)
                      (and
                        (= (to_rep1 target__last) o12)
                        (and
                          (= (to_rep1 target__first) o13)
                          (let ((temp___2389 (of_array2 target1 o13 o12)))
                            (and
                              (=>
                                (<= temp___2391 o14)
                                (and
                                  (and
                                    (<= (first2 temp___2389) temp___2391)
                                    (<= temp___2391 (last2 temp___2389)))
                                  (and
                                    (<= (first2 temp___2389) o14)
                                    (<= o14 (last2 temp___2389)))))
                              (let ((temp___2394 (of_array2
                                                   (to_array2 temp___2389)
                                                   temp___2391
                                                   o14)))
                                (= true (ite (forall ((temp___2395 Int))
                                               (=>
                                                 (and
                                                   (<= (first2 temp___2394) temp___2395)
                                                   (<= temp___2395 (last2
                                                                    temp___2394)))
                                                 (= (us_attr__init
                                                      (select (to_array2
                                                                temp___2394) temp___2395)) true)))
                                          true
                                          false)))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
...
;; Ensures
(assert (in_range1 (+ (to_rep1 target__first) (- count1 1))))

;; H
(assert
  (= (and (ite (<= (to_rep1 target__first) usf) true false) (ite (<= 
                                                              usf (+ 
                                                              (to_rep1
                                                                target__first) (- 
                                                              count1 1)))
...
;; Ensures
(assert (in_range1 (- usf (to_rep1 target__first))))

;; Ensures
(assert (uint_in_range (- usf (to_rep1 target__first))))

;; Goal def'vc
;; File "i-c.ads", line 452, characters 0-0
(assert
  (not
  (bvule (first1 item) (bvadd (of_int (- usf (to_rep1 target__first))) 
  (first1
    item)))))
