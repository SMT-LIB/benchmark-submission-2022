...
(declare-const ada___interfaces__c__c_length_ghost__4__result (_ BitVec 64))
...
(assert
  (ite (= spark__branch true)
    (= ada___interfaces__c__c_length_ghost__4__result (bvsub j (first item)))
    (and
          ...
          (and
            ...
            (and
              ...
              (and
                ...
                (and
                  (= spark__branch1 true)
                  (= ada___interfaces__c__c_length_ghost__4__result (bvsub 
                  j2 (first item))))))))))))
...
(assert
  ...
  (forall ((j3 (_ BitVec 64)))
    (=>
      (and
        (bvule (first item) j3)
        (bvule j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__4__result)))
      (=>
        (not
          (= j3 (bvadd (first item) ada___interfaces__c__c_length_ghost__4__result)))
