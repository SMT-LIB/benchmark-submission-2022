...
(declare-const temp___2481 (_ BitVec 64))
                ...
                (and
                  (and
                    ...
                    (of_int
                      (length item))))
                  (and
                    (let ((temp___2448 (first item)))
                      (let ((temp___2449 (last item)))
                        (and
                          (= j1 temp___2448)
                          (ite (= (and (ite (<= temp___2448 j1) true false) 
                            (ite (<= j1 temp___2449)
                              true
                              false)) true)
                    ...
                    (and
                      ...
                      (and
                        (= (to_rep2 r__first) o3)
                        (let ((temp___2478 (of_array2 r3 o3 o2)))
                          (and
                            (= (to_rep3 o4) 0)
                            (and
                              (= (to_rep2 r__last) o5)
                              (and
                                (= (to_rep2 r__first) o6)
                                (and
                                  (= (to_rep2 r__last) temp___2481)
                                  (and
                                    (and
                                      (bvule (first2 temp___2478) temp___2481)
                                      (bvule temp___2481 (last2 temp___2478)))
                                    (and
                                      (= r4 (to_array2
                                              (us_tqtmk2
                                                (store (to_array2
                                                         temp___2478) 
                                                temp___2481 (char32_t__init_wrapperqtmk
                                                              o4
                                                              true))
                                                (rt2 temp___2478))))
                                      (and
                                        ...
                                        (and
                                          ...
                                          (and
                                            (= (to_rep2 r__first) o8)
                                            (let ((temp___2490 (of_array2
                                                                 r4
                                                                 o8
                                                                 o7)))
                                              (and
                                                (forall ((temp___2492 (_ BitVec 64)))
                                                  (=>
                                                    (and
                                                      (bvule (first2
                                                               temp___2490) temp___2492)
                                                      (bvule temp___2492 
                                                      (last2
                                                        temp___2490)))
                                                    (= (us_attr__init
                                                         (select (to_array2
                                                                   temp___2490) temp___2492)) true)))
                                                (and
                                                  (dynamic_property1
                                                    #x0000000000000000
                                                    #xFFFFFFFFFFFFFFFF
                        ...
                        (= (last2
                             (of_array2
                               ...
                               (to_rep2 r__last1))) (bvsub (of_int
                                                             (length item)) #x0000000000000001)))
                      (and
                        (let ((temp___2504 (first item)))
                          (let ((temp___2505 (last item)))
                            (and
                              (= j temp___2504)
                              (ite (= (and (ite (<= temp___2504 j)
                                             true
                                             false) (ite (<= j temp___2505)
                                                      true
                                                      false)) true)
                                (exists ((o9 (_ BitVec 64)))
                                  (and
                        ...
                        (and
                          ...
                          (and
                            ...
                            (let ((temp___2533 (of_array2 r2 o1 o)))
                              (and
                                (forall ((temp___2535 (_ BitVec 64)))
                                  (=>
                                    (and
                                      (bvule (first2 temp___2533) temp___2535)
                                      (bvule temp___2535 (last2 temp___2533)))
                                    (= (us_attr__init
                                         (select (to_array2 temp___2533) temp___2535)) true)))
                                (and
                                  (dynamic_property1
                                    #x0000000000000000
                                    #xFFFFFFFFFFFFFFFF
  ...
  (ite (= (first1 ada___interfaces__c__to_c__11__result) #x0000000000000000)
    (and
      (ite (= append_nul true)
        (= o9 (+ (length item) 1))
        (= o9 (length item)))
      (let ((o10 (length1 ada___interfaces__c__to_c__11__result)))
