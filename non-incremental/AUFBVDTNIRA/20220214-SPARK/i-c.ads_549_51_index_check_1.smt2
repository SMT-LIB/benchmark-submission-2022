...
(declare-const temp___2562 Int)

;; H
(assert (= (to_rep1 r__last) temp___2562))
      ...
      (forall ((k Int))
        (to_ada__function_guard
          ...
          (to_rep3
            ...
            (first1
              item))))))
      (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___2562)
                                               true
                                               false)) true)
        (exists ((o1 Int))
          (and
                ...
                (exists ((o3 Int))
                  (and
                    ...
                    (exists ((o4 Int))
                      (and
                        (= (to_rep1 r__first) o4)
                        (let ((temp___2565 (of_array2 r o4 o3)))
                          (let ((temp___2564 (bvadd (bvsub (of_int j) #x0000000000000001) 
                            (first1
                              item))))
                            (and
                              (and
                                (bvule (first1 item) temp___2564)
                                (bvule temp___2564 (last1 item)))
                              (exists ((o5 Int))
                                (and
                                  (= (to_rep3
                                       (select (to_array1 item) temp___2564)) o5)
                                  (let ((o6 (to_ada o5)))
                                    (and
                                      (and
...
;; Assert
(assert
  (forall ((temp___2596 Int))
    (=>
      (and
        (<= (first2 (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___2596)
        (<= temp___2596 (last2
                          (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last)))))
      (= (us_attr__init
           (select (to_array2
                     (of_array2 r1 (to_rep1 r__first) (to_rep1 r__last))) temp___2596)) true))))
...
(assert
  (ite (= (first ada___interfaces__c__to_ada__11__result) 1)
    (and
      ...
      (let ((o2 (length ada___interfaces__c__to_ada__11__result)))
