...
(assert
  ...
  (=>
    ...
    (let ((temp___2292 (of_array2
      ...
      (forall ((temp___2293 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___2292) temp___2293)
            (bvule temp___2293 (last2 temp___2292)))
          (= (us_attr__init (select (to_array2 temp___2292) temp___2293)) true)))))))
