...
(assert
  ...
  (=>
    ...
    (let ((temp___2743 (of_array2
      ...
      (forall ((temp___2744 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___2743) temp___2744)
            (bvule temp___2744 (last2 temp___2743)))
          (= (us_attr__init (select (to_array2 temp___2743) temp___2744)) true)))))))
