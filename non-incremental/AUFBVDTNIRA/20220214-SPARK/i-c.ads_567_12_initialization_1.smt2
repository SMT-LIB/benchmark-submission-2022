...
(declare-datatypes ((s387b__init_wrapper__ref 0))
  (((s387b__init_wrapper__refqtmk (s387b__init_wrapper__content us_t2)))))

;; s387b__init_wrapper__ref_s387b__init_wrapper__content__projection
(define-fun s387b__init_wrapper__ref_s387b__init_wrapper__content__projection 
  ((a s387b__init_wrapper__ref)) us_t2
  (s387b__init_wrapper__content a))
...
(declare-datatypes ((t388b__ref 0))
  (((t388b__refqtmk (t388b__content integer)))))

;; t388b__ref_t388b__content__projection
(define-fun t388b__ref_t388b__content__projection ((a t388b__ref)) integer
  (t388b__content a))

(declare-datatypes ((t396b__init_wrapper__ref 0))
  (((t396b__init_wrapper__refqtmk (t396b__init_wrapper__content us_t2)))))

;; t396b__init_wrapper__ref_t396b__init_wrapper__content__projection
(define-fun t396b__init_wrapper__ref_t396b__init_wrapper__content__projection 
  ((a t396b__init_wrapper__ref)) us_t2
  (t396b__init_wrapper__content a))

(declare-datatypes ((t404b__init_wrapper__ref 0))
  (((t404b__init_wrapper__refqtmk (t404b__init_wrapper__content us_t2)))))
...
(define-fun t404b__init_wrapper__ref_t404b__init_wrapper__content__projection 
  ((a t404b__init_wrapper__ref)) us_t2
...
(declare-datatypes ((s387b__ref 0))
  (((s387b__refqtmk (s387b__content us_t1)))))

;; s387b__ref_s387b__content__projection
(define-fun s387b__ref_s387b__content__projection ((a s387b__ref)) us_t1
  (s387b__content a))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_1132 us_t1) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool) (temp___do_typ_inv_1131 Bool)) Bool
  (=>
    (not (= temp___skip_constant_1129 true))
    (and
      (and
        (dynamic_property1
          (to_rep2 target__first)
          (to_rep2 target__last)
          (first1 temp___expr_1132)
          (last1 temp___expr_1132))
        (= (first1 temp___expr_1132) (to_rep2 target__first)))
      (= (last1 temp___expr_1132) (to_rep2 target__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_1138 us_t1) (temp___skip_top_level_1139 Bool)) Bool
  (and
    (= (first1 temp___expr_1138) (to_rep2 target__first))
    (= (last1 temp___expr_1138) (to_rep2 target__last))))
                    ...
                    (and
                      ...
                      (exists ((o10 (_ BitVec 64)))
                        (and
                          ...
                          (let ((temp___2621 (of_array2 target o10 o9)))
                            (exists ((o11 Int))
                              (and
                                  ...
                                  (and
                                    ...
                                    (exists ((o13 char32_t))
                                      (and
                                        ...
                                        (and
                                          (and
                                            (bvule (first2 temp___2621) 
                                            to__1)
                                            (bvule to__1 (last2 temp___2621)))
...
(assert
  (=>
    ...
    (let ((temp___2698 (of_array2
      ...
      (forall ((temp___2699 (_ BitVec 64)))
        (=>
          (and
            (bvule (first2 temp___2698) temp___2699)
            (bvule temp___2699 (last2 temp___2698)))
          (= (us_attr__init (select (to_array2 temp___2698) temp___2699)) true))))))
            ...
            (and
              ...
              (and
                ...
                (and
                  ...
                  (let ((temp___2702 (of_array2 target2 o11 o10)))
                    (and
                      (= (to_rep3 o12) 0)
                      (and
                        (and
                          (bvule (first2 temp___2702) to__2)
                          (bvule to__2 (last2 temp___2702)))
                        (and
                          (= target1 (to_array2
                                       (us_tqtmk2
                                         (store (to_array2 temp___2702) 
                                         to__2 (char32_t__init_wrapperqtmk
                                                 o12
                                                 true))
                                         (rt2 temp___2702))))
...
(declare-const temp___2711 (_ BitVec 64))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (let ((temp___2713 (bvadd o16 (bvsub count1 #x0000000000000001))))
              (and
                (= (to_rep2 target__last) o17)
                (and
                  (= (to_rep2 target__first) o18)
                  (and
                    (= (to_rep2 target__first) temp___2711)
                    (and
                      (= (to_rep2 target__last) o19)
                      (and
                        (= (to_rep2 target__first) o20)
                        (let ((temp___2709 (of_array2 target1 o20 o19)))
                          (and
                            (=>
                              (bvule temp___2711 temp___2713)
                              (and
                                (and
                                  (bvule (first2 temp___2709) temp___2711)
                                  (bvule temp___2711 (last2 temp___2709)))
                                (and
                                  (bvule (first2 temp___2709) temp___2713)
                                  (bvule temp___2713 (last2 temp___2709)))))
                            (let ((temp___2714 (of_array2
                                                 (to_array2 temp___2709)
                                                 temp___2711
                                                 temp___2713)))
                              (= true (ite (forall ((temp___2715 (_ BitVec 64)))
                                             (=>
                                               (and
                                                 (bvule (first2 temp___2714) temp___2715)
                                                 (bvule temp___2715 (last2
                                                                    temp___2714)))
                                               (= (us_attr__init
                                                    (select (to_array2
                                                              temp___2714) temp___2715)) true)))
                                        true
                                        false))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
