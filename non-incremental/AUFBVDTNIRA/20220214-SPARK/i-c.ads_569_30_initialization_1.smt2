  ...
  (ite (= count1 o7)
    (ite (not (= count1 #x0000000000000000))
      (and
        ...
        (let ((temp___2269 (bvadd o9 (bvsub count1 #x0000000000000001))))
          (and
            ...
            (and
              ...
              (and
                ...
                (let ((temp___2267 (of_array2 target1 o11 o10)))
                  (and
                    (=>
                    ...
                    (let ((temp___2270 (of_array2
                                         ...
                                         temp___2268
                                         temp___2269)))
                      (= o8 (ite (forall ((temp___2271 (_ BitVec 64)))
                                   (=>
                                     (and
                                       (bvule (first2 temp___2270) temp___2271)
                                       (bvule temp___2271 (last2 temp___2270)))
                                     (= (us_attr__init
