        ...
        (forall ((k Int))
          (to_ada__function_guard
            ...
            (to_rep3
              ...
              (first1
                item))))))
        (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___2762)
                                                 true
                                                 false)) true)
          (exists ((o6 Int))
            (and
                    ...
                    (and
                      ...
                      (exists ((o9 Int))
                        (and
                          ...
                          (let ((temp___2764 (of_array2 target o9 o8)))
                            (and
                              (and
                                (bvule (first1 item) from3)
                                (bvule from3 (last1 item)))
                                      ...
                                      (and
                                        ...
                                        (and
                                          (dynamic_invariant2
                                            ...
                                            true)
                                          (= o11 o10)))
                                      (exists ((o12 wide_wide_character))
                                        (and
                                          (= (to_rep o12) o11)
                                          (and
                                            (and
                                              (<= (first2 temp___2764) 
                                              to__1)
                                              (<= to__1 (last2 temp___2764)))
                                            (exists ((target2 (Array Int wide_wide_character__init_wrapper)))
                                              (and
                                                (= target2 (to_array2
                                                             (us_tqtmk2
                                                               (store 
              ...
              (and
                ...
                (and
                  ...
                  (and
                    ...
                    (and
                      (= (to_rep1 target__first) temp___2827)
                      (and
                        (= (to_rep1 target__last) o12)
                        (and
                          (= (to_rep1 target__first) o13)
                          (let ((temp___2825 (of_array2 target1 o13 o12)))
                            (and
                              (=>
                                (<= temp___2827 o14)
                                (and
                                  (and
                                    (<= (first2 temp___2825) temp___2827)
                                    (<= temp___2827 (last2 temp___2825)))
                                  (and
                                    (<= (first2 temp___2825) o14)
                                    (<= o14 (last2 temp___2825)))))
                              (let ((temp___2830 (of_array2
                                                   (to_array2 temp___2825)
                                                   temp___2827
                                                   o14)))
                                (= true (ite (forall ((temp___2831 Int))
                                               (=>
                                                 (and
                                                   (<= (first2 temp___2830) temp___2831)
                                                   (<= temp___2831 (last2
                                                                    temp___2830)))
                                                 (= (us_attr__init
                                                      (select (to_array2
                                                                temp___2830) temp___2831)) true)))
                                          true
                                          false)))))))))))))))
      (= true (of_int1 1)))
    (= true false)))
