...
;; H
(assert
  (ite (= (hi t22) #x0000000000000001)
    (let ((o2 (lo t22)))
      (and
        (and
          (dynamic_invariant2 o2 true false true true)
          (= o2 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
        (= o1 (ite (= o2 #x0000000000000000) true false))))
    (= o1 false)))
    ...
    (let ((o3 (lo t11)))
      (and
        (and
          ...
          (= o3 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
        (= o2 (ite (= o3 #x0000000000000000) true false))))
    (= o2 false)))

;; H
(assert
  (ite (= o2 true)
    (= o (ite (= x (- 170141183460469231731687303715884105728)) true false))
    (= o false)))

(declare-const spark__branch5 Bool)

;; H
(assert (= spark__branch5 (ite (= o true) round false)))
...
(assert
  (and
    (hi__function_guard (hi t22) t22)
    (<= 1 (big1 ((_ zero_extend 64) (hi t22))))))

;; Assert
(assert (<= 0 (big1 ((_ zero_extend 64) (lo t22)))))

;; Assert
(assert (<= 0 (big1 ((_ zero_extend 64) (lo t11)))))

;; Assert
(assert (<= big_2xxdouble mult))
...
;; H
(assert
  (= spark__branch6 (ite (bvugt (hi t22) #x0000000000000001) true false)))
    ...
    (ite (= spark__branch6 true)
      ...
      (let ((o3 (lo t22)))
        (and
          (and
            (dynamic_invariant2 o3 true false true true)
            (= o3 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
          (and
            (= spark__branch7 (ite (bvugt o3 #x0000000000000000) true false))
            (ite (= spark__branch7 true)
              (< 0 (big1 ((_ zero_extend 64) (lo t22))))
              (let ((o4 (lo t11)))
                (and
                  (and
                    (dynamic_invariant2 o4 true false true true)
                    (= o4 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                  (and
                    (= spark__branch8 (ite (bvugt o4 #x0000000000000000)
                                        true
                                        false))
                    (or
                      (not (= spark__branch8 true))
                      (and
                        (bvugt ((_ zero_extend 64) (lo t11)) #x00000000000000000000000000000000)
                        (let ((o5 (lo t11)))
                          (and
                            (and
                              (dynamic_invariant2 o5 true false true true)
                              (= o5 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (< (big1 #x00000000000000000000000000000000) 
                              (big1
                                ((_ zero_extend 64) o5)))
                              (< 0 (big1 ((_ zero_extend 64) (lo t11)))))))))))))))))))
