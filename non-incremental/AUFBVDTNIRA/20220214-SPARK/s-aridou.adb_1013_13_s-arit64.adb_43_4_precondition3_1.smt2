...
;; H
(assert
  (ite (= (hi t22) #x00000001)
    (let ((o2 (lo t22)))
      (and
        (and
          (dynamic_invariant2 o2 true false true true)
          (= o2 ((_ extract 31 0) (bvand t22 #x00000000FFFFFFFF))))
        (= o1 (ite (= o2 #x00000000) true false))))
    (= o1 false)))
    ...
    (let ((o3 (lo t11)))
      (and
        (and
          ...
          (= o3 ((_ extract 31 0) (bvand t11 #x00000000FFFFFFFF))))
        (= o2 (ite (= o3 #x00000000) true false))))
    (= o2 false)))

;; H
(assert
  (ite (= o2 true)
    (= o (ite (= x (- 9223372036854775808)) true false))
    (= o false)))
...
(assert
  (and
    (hi__function_guard (hi t22) t22)
    (<= 1 (big1 ((_ zero_extend 32) (hi t22))))))

;; Assert
(assert (<= 0 (big1 ((_ zero_extend 32) (lo t22)))))

;; Assert
(assert (<= 0 (big1 ((_ zero_extend 32) (lo t11)))))
...
;; H
(assert (= spark__branch6 (ite (bvugt (hi t22) #x00000001) true false)))
    ...
    (ite (= spark__branch6 true)
      ...
      (let ((o3 (lo t22)))
        (and
          (and
            (dynamic_invariant2 o3 true false true true)
            (= o3 ((_ extract 31 0) (bvand t22 #x00000000FFFFFFFF))))
          (and
            (= spark__branch7 (ite (bvugt o3 #x00000000) true false))
            (ite (= spark__branch7 true)
              (< 0 (big1 ((_ zero_extend 32) (lo t22))))
              (let ((o4 (lo t11)))
                (and
                  (and
                    (dynamic_invariant2 o4 true false true true)
                    (= o4 ((_ extract 31 0) (bvand t11 #x00000000FFFFFFFF))))
                  (and
                    (= spark__branch8 (ite (bvugt o4 #x00000000) true false))
                    (or
                      (not (= spark__branch8 true))
                      (and
                        (bvugt ((_ zero_extend 32) (lo t11)) #x0000000000000000)
                        (let ((o5 (lo t11)))
                          (and
                            (and
                              (dynamic_invariant2 o5 true false true true)
                              (= o5 ((_ extract 31 0) (bvand t11 #x00000000FFFFFFFF))))
                            (and
                              (< (big1 #x0000000000000000) (big1
                                                             ((_ zero_extend 32) o5)))
                              (< 0 (big1 ((_ zero_extend 32) (lo t11)))))))))))))))))))
...
(assert
  ...
  (not
    (and
      (and (= mult big_2xxdouble) (= x (- 9223372036854775808)))
      (= round true)))))
