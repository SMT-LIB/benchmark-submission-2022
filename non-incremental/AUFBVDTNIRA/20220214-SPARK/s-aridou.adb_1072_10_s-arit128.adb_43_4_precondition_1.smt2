...
;; H
(assert
  (= spark__branch7 (ite (bvugt ru1 (bvudiv (bvsub du1 #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                      true
                      false)))
...
(assert
  (not
  (= (big1 qu2) (ite (bvugt ru1 (bvudiv (bvsub du1 #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                  (+ (abs1 quot1) 1)
                  (abs1 quot1)))))
