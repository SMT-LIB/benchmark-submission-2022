...
;; H
(assert
  (= spark__branch7 (ite (bvugt ru1 (bvudiv (bvsub du1 #x0000000000000001) #x0000000000000002))
                      true
                      false)))
...
(assert
  (ite (= spark__branch7 true)
    (and
      (= (+ (big1 qu1) (big1 ((_ zero_extend 32) #x00000001))) (big1
                                                                 (bvadd 
                                                                 qu1 ((_ zero_extend 32) #x00000001))))
...
(assert
  (not
  (= (big1 qu2) (ite (bvugt ru1 (bvudiv (bvsub du1 #x0000000000000001) #x0000000000000002))
                  (+ (abs1 quot1) 1)
                  (abs1 quot1)))))
