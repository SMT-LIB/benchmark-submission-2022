...
;; bool_eq
(define-fun bool_eq5 ((x1 (_ BitVec 128)) (y1 (_ BitVec 128))) Bool
...
;; H
(assert (= (hi t22) ((_ extract 63 0) (bvlshr t22 ((_ int2bv 128) 64)))))
...
;; H
(assert
  (= (oconcat (lo t22) (lo t11)) (bvor (bvshl ((_ zero_extend 64) (lo t22)) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
  (lo
    t11)))))
