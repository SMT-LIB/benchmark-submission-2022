...
;; H
(assert (dynamic_invariant2 (lo t22) true false true true))
...
;; H
(assert (dynamic_invariant2 (hi t22) true false true true))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (lo t22))) (bv2nat128 ((_ zero_extend 64) 
  (lo
    t22)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (hi t22))) (bv2nat128 ((_ zero_extend 64) 
  (hi
    t22)))))

;; Ensures
(assert
  (= (* big_2xxsingle (+ (big1 ((_ zero_extend 64) (hi t22))) (big1
                                                                ((_ zero_extend 64) 
                                                                (lo
                                                                  t22))))) (+ (* 
  big_2xxsingle (big1 ((_ zero_extend 64) (hi t22)))) (* big_2xxsingle 
  (big1
    ((_ zero_extend 64) (lo t22)))))))
...
(assert
  (and
    ...
    (= mult (+ (+ (* big_2xxdouble (big1 ((_ zero_extend 64) (hi t22)))) (* 
    big_2xxsingle (big1 ((_ zero_extend 64) (lo t22))))) (big1
                                                           ((_ zero_extend 64) 
                                                           (lo
                                                             t11)))))))
...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= (hi t22) #x0000000000000000)) true false))

(declare-const spark__branch4 Bool)

;; H
(assert
  (= spark__branch4 (ite (not (= (hi t22) #x0000000000000000)) true false)))
...
;; H
(assert
  (oconcat__function_guard (oconcat (lo t22) (lo t11)) (lo t22) (lo t11)))

;; H
(assert
  (dynamic_invariant1 (oconcat (lo t22) (lo t11)) true false true true))

;; H
(assert
  (= (oconcat (lo t22) (lo t11)) (bvor (bvshl ((_ zero_extend 64) (lo t22)) 
  (of_int1
    64)) ((_ zero_extend 64) (lo t11)))))

(declare-const du1 (_ BitVec 128))

;; H
(assert (= du1 (oconcat (lo t22) (lo t11))))
...
;; Ensures
(assert
  (= (big1 du1) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (lo t22)))) 
  (big1
    ((_ zero_extend 64) (lo t11))))))

;; Assert
(assert (= mult (big1 du1)))

;; Assert
(assert (not (= du1 #x00000000000000000000000000000000)))
...
;; H
(assert
  (ite (= x (- 170141183460469231731687303715884105728))
    (= o (ite (= du1 #x00000000000000000000000000000001) true false))
    (= o false)))

;; H
(assert
  (ite (= o true)
    (= spark__branch5 (ite (= den_pos true) false true))
...
;; H
(assert (= qu1 (bvudiv xu du1)))

(declare-const ru1 (_ BitVec 128))

;; H
(assert (= ru1 (bvurem xu du1)))

;; Ensures
(assert (= (div1 (big1 xu) (big1 du1)) (big1 (bvudiv xu du1))))
...
;; Ensures
(assert (= (mod1 (big1 xu) (big1 du1)) (big1 (bvurem xu du1))))
...
;; Ensures
(assert
  (= (abs1 (mod1 (big x) (* (big y) (big z)))) (mod1
                                                 (abs1 (big x))
                                                 (abs1 (* (big y) (big z))))))

;; Assert
(assert (= (abs1 big_r1) (big1 ru1)))
...
(assert
  (ite (= spark__branch7 true)
    (and
      (and
        (= spark__branch6 (ite (bvugt ru1 (bvudiv (bvsub du1 #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                            true
                            false))
        (ite (= spark__branch6 true)
          (and
            (= (+ (big1 qu1) (big1 ((_ zero_extend 64) #x0000000000000001))) 
            (big1
              (bvadd qu1 ((_ zero_extend 64) #x0000000000000001))))
            (= qu2 (bvadd qu1 #x00000000000000000000000000000001)))
          (= qu2 qu1)))
      (= (abs1 big_q1) (big1 qu2)))
    (and (= spark__branch6 spark__branch7) (= qu2 qu1))))

;; Assert
(assert (= (abs1 big_q1) (big1 qu2)))
...
;; H
(assert (= spark__branch8 (ite (<= 0 x) true false)))
...
(assert
  (ite (= spark__branch8 true)
    (let ((o3 (uc_to_int1 ru1)))
      (and
        (and
          (to_int__function_guard o3 ru1)
          ...
          (and
            (ite (= den_pos true)
              (and
                (= o2 (uc_to_int1 qu2))
                (and
                  (to_int__function_guard o2 qu2)
                  (dynamic_invariant o2 true false true true)))
              (let ((o4 (bvneg qu2)))
                (and
                  (= o2 (uc_to_int1 o4))
                  (and
                    (to_int__function_guard o2 o4)
                    (dynamic_invariant o2 true false true true)))))
            (= q1 o2)))))
    (let ((o3 (bvneg ru1)))
      (let ((o4 (uc_to_int1 o3)))
        (and
          (and
            (to_int__function_guard o4 o3)
              ...
              (ite (= den_pos true)
                (let ((o5 (bvneg qu2)))
                  (and
                    (= o1 (uc_to_int1 o5))
                    (and
                      (to_int__function_guard o1 o5)
                      (dynamic_invariant o1 true false true true))))
                (and
                  (= o1 (uc_to_int1 qu2))
                  (and
                    (to_int__function_guard o1 qu2)
                    (dynamic_invariant o1 true false true true))))
              (= q1 o1))))))))
...
(assert
  (not
  (=>
    (to_int__function_guard (uc_to_int1 ru1) ru1)
    (=>
      (to_int__function_guard (uc_to_int1 (bvneg ru1)) (bvneg ru1))
      (= r1 (ite (<= 0 x) (uc_to_int1 ru1) (uc_to_int1 (bvneg ru1))))))))
