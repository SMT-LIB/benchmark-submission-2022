...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_291 (_ BitVec 64)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_305 (_ BitVec 32)) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool
  true)
...
;; ada___system__arith_64__impl__double_divide__den_pos__assume
(define-fun ada___system__arith_64__impl__double_divide__den_pos__assume 
  () Bool
...
;; Assume
(assert
  (= ada___system__arith_64__impl__double_divide__den_pos__assume den_pos))
...
(assert
  (ite (= yu #x0000000000000000)
    (= spark__branch true)
    (= spark__branch (ite (= zu #x0000000000000000) true false))))
            ...
            (let ((o2 (omultiply o1 o)))
              (and
                (and
                  ...
                  (= o2 (bvmul ((_ zero_extend 32) o1) ((_ zero_extend 32) o))))
...
;; H
(assert
  (= (omultiply ylo zlo) (bvmul ((_ zero_extend 32) ylo) ((_ zero_extend 32) 
  zlo))))
...
;; H
(assert
  (= (omultiply ylo zhi) (bvmul ((_ zero_extend 32) ylo) ((_ zero_extend 32) 
  zhi))))
...
;; H
(assert (= (big1 (omultiply ylo zhi)) (bv2nat64 (omultiply ylo zhi))))
...
;; H
(assert
  (= (omultiply yhi zlo) (bvmul ((_ zero_extend 32) yhi) ((_ zero_extend 32) 
  zlo))))
...
;; H
(assert (= (big1 (omultiply yhi zlo)) (bv2nat64 (omultiply yhi zlo))))
...
;; Ensures
(assert
  (= (big1 t11) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t11)))) 
  (big1
    ((_ zero_extend 32) (lo t11))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (hi t11))) (bv2nat64 ((_ zero_extend 32) 
  (hi
    t11)))))
...
;; H
(assert (= (big1 t21) (bv2nat64 t21)))

;; Ensures
(assert
  (= (* big_2xxsingle (+ (big1 t21) (big1 ((_ zero_extend 32) (hi t11))))) (+ (* 
  big_2xxsingle (big1 t21)) (* big_2xxsingle (big1
                                               ((_ zero_extend 32) (hi t11)))))))
...
;; Ensures
(assert
  (= (+ (big1 t21) (big1 ((_ zero_extend 32) (hi t11)))) (big1
                                                           (bvadd t21 ((_ zero_extend 32) 
                                                           (hi
                                                             t11))))))
...
;; H
(assert (= (oadd t21 (hi t11)) (bvadd t21 ((_ zero_extend 32) (hi t11)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (lo t22))) (bv2nat64 ((_ zero_extend 32) 
  (lo
    t22)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (hi t22))) (bv2nat64 ((_ zero_extend 32) 
  (hi
    t22)))))

;; Ensures
(assert
  (= (* big_2xxsingle (+ (big1 ((_ zero_extend 32) (hi t22))) (big1
                                                                ((_ zero_extend 32) 
                                                                (lo
                                                                  t22))))) (+ (* 
  big_2xxsingle (big1 ((_ zero_extend 32) (hi t22)))) (* big_2xxsingle 
  (big1
    ((_ zero_extend 32) (lo t22)))))))
...
(assert
  (and
    ...
    (= mult (+ (+ (* big_2xxdouble (big1 ((_ zero_extend 32) (hi t22)))) (* 
    big_2xxsingle (big1 ((_ zero_extend 32) (lo t22))))) (big1
                                                           ((_ zero_extend 32) 
                                                           (lo
                                                             t11)))))))
...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= (hi t22) #x00000000)) true false))

(declare-const spark__branch4 Bool)

;; H
(assert (= spark__branch4 (ite (not (= (hi t22) #x00000000)) true false)))
...
;; H
(assert
  (= (oconcat (lo t22) (lo t11)) (bvor (bvshl ((_ zero_extend 32) (lo t22)) 
  (of_int1
    32)) ((_ zero_extend 32) (lo t11)))))

(declare-const du1 (_ BitVec 64))
...
;; Ensures
(assert
  (= (big1 du1) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (lo t22)))) 
  (big1
    ((_ zero_extend 32) (lo t11))))))
...
;; Assert
(assert (not (= du1 #x0000000000000000)))
...
(assert
  (ite (= x (- 9223372036854775808))
    (= o (ite (= du1 #x0000000000000001) true false))
    (= o false)))
...
(assert
  (ite (= spark__branch7 true)
    (and
      (and
        (= spark__branch6 (ite (bvugt ru1 (bvudiv (bvsub du1 #x0000000000000001) #x0000000000000002))
                            true
                            false))
        (ite (= spark__branch6 true)
          (and
            (= (+ (big1 qu1) (big1 ((_ zero_extend 32) #x00000001))) 
            (big1
              (bvadd qu1 ((_ zero_extend 32) #x00000001))))
