...
;; Assume
(assert (dynamic_invariant xu true false true true))

;; Assume
(assert (dynamic_invariant yu true false true true))

;; Assume
(assert (dynamic_invariant1 xhi true false true true))

;; Assume
(assert (dynamic_invariant1 xlo true false true true))

;; Assume
(assert (dynamic_invariant1 yhi true false true true))

;; Assume
(assert (dynamic_invariant1 ylo true false true true))
...
(assert
  (and
    (and
      (and
        (and
          (= mult (* (big1 xu) (big1 yu)))
          (and (hi__function_guard (hi xu) xu) (= xhi (hi xu))))
        (= xlo (lo xu)))
      (and (hi__function_guard (hi yu) yu) (= yhi (hi yu))))
    (= ylo (lo yu))))

;; Ensures
(assert
  (= (big1 xu) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) xhi))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    xlo)))))

;; Ensures
(assert
  (= (big1 yu) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) yhi))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    ylo)))))

;; Goal def'vc
;; File "s-aridou.adb", line 400, characters 0-0
(assert
  (not
  (= mult (* (+ (* big_2xxsingle (big1 ((_ zero_extend 64) xhi))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    xlo))) (+ (* 
  big_2xxsingle (big1 ((_ zero_extend 64) yhi))) (big1
                                                   ((_ zero_extend 64) 
                                                   ylo)))))))
