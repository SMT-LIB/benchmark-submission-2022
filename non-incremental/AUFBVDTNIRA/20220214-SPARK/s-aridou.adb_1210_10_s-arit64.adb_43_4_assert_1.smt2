...
;; Ensures
(assert
  (= (big1 xu) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) xhi))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    xlo)))))

;; Ensures
(assert
  (= (big1 yu) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) yhi))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    ylo)))))
...
(assert
  (not
  (= mult (* (+ (* big_2xxsingle (big1 ((_ zero_extend 32) xhi))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    xlo))) (+ (* 
  big_2xxsingle (big1 ((_ zero_extend 32) yhi))) (big1
                                                   ((_ zero_extend 32) 
                                                   ylo)))))))
