...
;; Ensures
(assert
  (< (power (big #x00000000000000000000000000000002) (+ m n)) (power
                                                                (big
                                                                  #x00000000000000000000000000000002)
                                                                128)))
...
(assert
  (let ((o1 (+ m n)))
    (ite (< o1 340282366920938463463374607431768211456)
      (= o (bvshl #x00000000000000000000000000000001 (of_int o1)))
...
(assert
  (ite (< m 340282366920938463463374607431768211456)
    (= o2 (bvshl #x00000000000000000000000000000001 (of_int m)))
    (= o2 #x00000000000000000000000000000000)))

;; Goal def'vc
;; File "s-aridou.adb", line 439, characters 0-0
(assert
  (not (< (* (big o2) (big o1)) big_2xxdouble)))
