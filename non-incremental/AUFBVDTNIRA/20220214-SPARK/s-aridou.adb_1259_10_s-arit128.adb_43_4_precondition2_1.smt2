...
(assert
  (forall ((x Int) (n1 Int))
    (=> (<= 0 n1) (= (power1 x (+ n1 1)) (* x (power1 x n1))))))

;; Power_s_alt
(assert
  (forall ((x Int) (n1 Int))
    (=> (< 0 n1) (= (power1 x n1) (* x (power1 x (- n1 1)))))))
...
;; Power_sum
(assert
  (forall ((x Int) (n1 Int) (m1 Int))
    (=>
      (<= 0 n1)
      (=> (<= 0 m1) (= (power1 x (+ n1 m1)) (* (power1 x n1) (power1 x m1)))))))
...
(assert
  (forall ((x Int) (n1 Int) (m1 Int))
    (=>
      (<= 0 n1)
      (=> (<= 0 m1) (= (power1 x (* n1 m1)) (power1 (power1 x n1) m1))))))
...
(assert
  (forall ((x Int) (y Int))
    (=>
      (= (* x y) (* y x))
      (forall ((n1 Int))
        (=> (<= 0 n1) (= (* (power1 x n1) y) (* y (power1 x n1))))))))
  ...
  (forall ((x Int) (y Int))
    (=>
      ...
      (forall ((n1 Int))
        (=>
          (<= 0 n1)
          (= (power1 (* x y) n1) (* (power1 x n1) (power1 y n1))))))))
...
(assert
  (forall ((x Int) (n1 Int) (m1 Int))
    (=>
      (and (< 0 x) (and (<= 0 n1) (<= n1 m1)))
      (<= (power1 x n1) (power1 x m1)))))
...
(assert
  (and
    ...
    (= (power1 (big #x00000000000000000000000000000002) m) (ite (< m 128)
                                                             (big_2xx m)
                                                             big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power1 (big #x00000000000000000000000000000002) n) (ite (< n 128)
                                                             (big_2xx n)
                                                             big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power1 (big #x00000000000000000000000000000002) (+ m n)) (ite (< (+ 
                                                                   m 
                                                                   n) 128)
                                                                   (big_2xx
                                                                    (+ 
...
;; Ensures
(assert
  (< (power1 (big #x00000000000000000000000000000002) (+ m n)) (power1
                                                                 (big
...
(assert
  (let ((o1 (+ m n)))
    (ite (< o1 340282366920938463463374607431768211456)
      (= o (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) o1)))
...
(assert
  (ite (< n 340282366920938463463374607431768211456)
    (= o1 (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) n)))
...
(assert
  (ite (< m 340282366920938463463374607431768211456)
    (= o2 (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) m)))
