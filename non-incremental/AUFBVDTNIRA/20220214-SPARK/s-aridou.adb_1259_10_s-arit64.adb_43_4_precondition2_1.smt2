...
;; Assume
(assert (and (and (< m 64) (< n 64)) (<= (+ m n) 64)))
...
;; H
(assert (= spark__branch (ite (< (+ m n) 64) true false)))

;; H
(assert
  (or
    (not (= spark__branch true))
    (= (bvmul (ite (< m 18446744073709551616)
                (bvshl #x0000000000000001 (of_int m))
                #x0000000000000000) (ite (< n 18446744073709551616)
                                      (bvshl #x0000000000000001 (of_int n))
                                      #x0000000000000000)) (let ((temp___2835 (+ 
                                                             m n)))
                                                             (ite (< temp___2835 18446744073709551616)
...
(assert
  (and
    ...
    (= (power (big #x0000000000000002) m) (ite (< m 64)
                                            (big_2xx m)
                                            big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power (big #x0000000000000002) n) (ite (< n 64)
                                            (big_2xx n)
                                            big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power (big #x0000000000000002) (+ m n)) (ite (< (+ m n) 64)
                                                  (big_2xx (+ m n))
                                                  big_2xxdouble))))
...
;; H
(assert (= spark__branch1 (ite (< (+ m n) 64) true false)))
...
;; Assert
(assert
  (= (* (power (big #x0000000000000002) m) (power (big #x0000000000000002) n)) 
  (power
...
;; Ensures
(assert
  (< (power (big #x0000000000000002) (+ m n)) (power
                                                (big #x0000000000000002)
                                                64)))
...
(assert
  (let ((o1 (+ m n)))
    (ite (< o1 18446744073709551616)
      (= o (bvshl #x0000000000000001 (of_int o1)))
      (= o #x0000000000000000))))
...
(assert
  (ite (< n 18446744073709551616)
    (= o1 (bvshl #x0000000000000001 (of_int n)))
...
(assert
  (ite (< m 18446744073709551616)
    (= o2 (bvshl #x0000000000000001 (of_int m)))
