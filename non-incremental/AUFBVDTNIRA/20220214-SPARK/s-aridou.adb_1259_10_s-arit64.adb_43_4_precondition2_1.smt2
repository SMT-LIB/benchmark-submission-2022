...
;; Ensures
(assert
  (< (power1 (big #x0000000000000002) (+ m n)) (power1
...
(assert
  (let ((o1 (+ m n)))
    (ite (< o1 18446744073709551616)
      (= o (bvshl #x0000000000000001 ((_ int2bv 64) o1)))
      (= o #x0000000000000000))))
...
(assert
  (ite (< n 18446744073709551616)
    (= o1 (bvshl #x0000000000000001 ((_ int2bv 64) n)))
...
(assert
  (ite (< m 18446744073709551616)
    (= o2 (bvshl #x0000000000000001 ((_ int2bv 64) m)))
