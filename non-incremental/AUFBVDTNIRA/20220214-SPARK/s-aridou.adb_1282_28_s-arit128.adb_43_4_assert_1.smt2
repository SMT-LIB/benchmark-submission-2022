...
;; H
(assert (= spark__branch (ite (< 0 m) true false)))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
    (= (power (big #x00000000000000000000000000000002) (- m 1)) (ite (< (- 
                                                                  m 1) 128)
                                                                  (big_2xx
                                                                    (- 
                                                                    m 1))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
    (= (power (big #x00000000000000000000000000000002) (- m 1)) (big_2xx
                                                                  (- 
                                                                  m 1)))))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
    (= (power (big #x00000000000000000000000000000002) m) (* (big_2xx
                                                               (- m 1)) 2))))

(declare-const spark__branch1 Bool)

;; H
(assert (= spark__branch1 (ite (< m 128) true false)))
...
;; Ensures
(assert
  (< (power (big #x00000000000000000000000000000002) (- m 1)) (power
                                                                (big
...
;; Ensures
(assert
  (bvult (ite (< (- m 1) 340282366920938463463374607431768211456)
           (bvshl #x00000000000000000000000000000001 (of_int (- m 1)))
           #x00000000000000000000000000000000) (ite (< 127 340282366920938463463374607431768211456)
                                                 (bvshl #x00000000000000000000000000000001 
                                                 (of_int
                                                   127))
...
;; Assert
(assert
  (= (bvmul (let ((temp___2882 (- m 1)))
              (ite (< temp___2882 340282366920938463463374607431768211456)
                (bvshl #x00000000000000000000000000000001 (of_int
                                                            temp___2882))
                #x00000000000000000000000000000000)) #x00000000000000000000000000000002) 
...
(assert
  (ite (< m 340282366920938463463374607431768211456)
    (= o (bvshl #x00000000000000000000000000000001 (of_int m)))
...
(assert
  (let ((o2 (- m 1)))
    (ite (< o2 340282366920938463463374607431768211456)
      (= o1 (bvshl #x00000000000000000000000000000001 (of_int o2)))
      (= o1 #x00000000000000000000000000000000))))

;; Ensures
(assert (= (* (big o1) (big #x00000000000000000000000000000002)) (big o)))

;; Goal def'vc
;; File "s-aridou.adb", line 449, characters 0-0
(assert
  (not
  (=>
    (big_2xx__function_guard (big_2xx m) m)
    (= (power (big #x00000000000000000000000000000002) m) (big_2xx m)))))
