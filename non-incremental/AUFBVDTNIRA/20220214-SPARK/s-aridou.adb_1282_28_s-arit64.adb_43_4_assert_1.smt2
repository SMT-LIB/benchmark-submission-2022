...
;; Assume
(assert (= (+ (big #xFFFFFFFFFFFFFFFF) 1) big_2xxdouble))
...
(assert
  (and
    ...
    (= (power (big #x0000000000000002) (- m 1)) (ite (< (- m 1) 64)
                                                  (big_2xx (- m 1))
                                                  big_2xxdouble))))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
    (= (power (big #x0000000000000002) (- m 1)) (big_2xx (- m 1)))))

;; Assert
(assert
  (and
    (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
    (= (power (big #x0000000000000002) m) (* (big_2xx (- m 1)) 2))))

(declare-const spark__branch1 Bool)

;; H
(assert (= spark__branch1 (ite (< m 64) true false)))
...
;; Ensures
(assert
  (< (power (big #x0000000000000002) (- m 1)) (power
                                                (big #x0000000000000002)
                                                63)))
...
;; Ensures
(assert
  (bvult (ite (< (- m 1) 18446744073709551616)
           (bvshl #x0000000000000001 (of_int (- m 1)))
           #x0000000000000000) (ite (< 63 18446744073709551616)
                                 (bvshl #x0000000000000001 (of_int 63))
                                 #x0000000000000000)))

;; Assert
(assert
  (= (bvmul (let ((temp___2882 (- m 1)))
              (ite (< temp___2882 18446744073709551616)
                (bvshl #x0000000000000001 (of_int temp___2882))
                #x0000000000000000)) #x0000000000000002) (ite (< m 18446744073709551616)
...
;; H
(assert
  (ite (< m 18446744073709551616)
    (= o (bvshl #x0000000000000001 (of_int m)))
    (= o #x0000000000000000)))
...
(assert
  (let ((o2 (- m 1)))
    (ite (< o2 18446744073709551616)
      (= o1 (bvshl #x0000000000000001 (of_int o2)))
      (= o1 #x0000000000000000))))

;; Ensures
(assert (= (* (big o1) (big #x0000000000000002)) (big o)))
...
(assert
  ...
  (=>
    ...
    (= (power (big #x0000000000000002) m) (big_2xx m)))))
