    ...
    (! (=>
         ...
         (= (big_2xx n) (big
                          (ite (< n 18446744073709551616)
                            (bvshl #x0000000000000001 (of_int n))
...
;; LoopInvariant
(assert
  (= xx2 (bvudiv x (ite (< j1 18446744073709551616)
                     (bvshl #x0000000000000001 (of_int j1))
                     #x0000000000000000))))
...
(assert
  (not
  (= xx3 (bvudiv x (ite (< j2 18446744073709551616)
                     (bvshl #x0000000000000001 (of_int j2))
                     #x0000000000000000)))))
