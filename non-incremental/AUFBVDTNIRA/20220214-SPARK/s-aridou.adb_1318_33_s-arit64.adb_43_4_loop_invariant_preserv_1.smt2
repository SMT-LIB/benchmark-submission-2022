...
;; H
(assert (= xx1 (bvlshr xx ((_ int2bv 64) 1))))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= xx1 (bvlshr x ((_ int2bv 64) j))) true false))
...
;; LoopInvariant
(assert (= xx2 (bvlshr x ((_ int2bv 64) j1))))
...
;; H
(assert (= xx3 (bvlshr xx2 ((_ int2bv 64) 1))))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= xx3 (bvlshr x ((_ int2bv 64) j2))) true false))

;; LoopInvariant
(assert (= xx3 (bvlshr x ((_ int2bv 64) j2))))
...
(assert
  ...
  (= xx3 (bvudiv x (ite (< j2 18446744073709551616)
                     (bvshl #x0000000000000001 ((_ int2bv 64) j2))
                     #x0000000000000000)))))
