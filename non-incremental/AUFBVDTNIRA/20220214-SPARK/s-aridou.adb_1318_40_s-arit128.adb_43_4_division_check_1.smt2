...
(declare-datatypes ((t237b__ref 0))
  (((t237b__refqtmk (t237b__content integer)))))

;; t237b__ref_t237b__content__projection
(define-fun t237b__ref_t237b__content__projection ((a t237b__ref)) integer
  (t237b__content a))
...
;; H
(assert (= xx1 (bvlshr xx (of_int 1))))

;; Ensures
(assert
  (= (bvlshr (bvlshr x (of_int (- j 1))) (of_int 1)) (bvlshr x (of_int
                                                                 (+ (- 
                                                                 j 1) 1)))))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= xx1 (bvlshr x (of_int j))) true false))
...
;; LoopInvariant
(assert (= xx2 (bvlshr x (of_int j1))))

;; LoopInvariant
(assert
  (= xx2 (bvudiv x (ite (< j1 340282366920938463463374607431768211456)
                     (bvshl #x00000000000000000000000000000001 (of_int j1))
...
;; H
(assert (= xx3 (bvlshr xx2 (of_int 1))))

;; Ensures
(assert
  (= (bvlshr (bvlshr x (of_int (- j2 1))) (of_int 1)) (bvlshr x (of_int
                                                                  (+ (- 
                                                                  j2 1) 1)))))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= xx3 (bvlshr x (of_int j2))) true false))

(declare-const o (_ BitVec 128))

;; H
(assert
  (ite (< j2 340282366920938463463374607431768211456)
    (= o (bvshl #x00000000000000000000000000000001 (of_int j2)))
    (= o #x00000000000000000000000000000000)))

;; Goal def'vc
;; File "s-aridou.adb", line 497, characters 0-0
(assert
  (not (not (= o #x00000000000000000000000000000000))))
