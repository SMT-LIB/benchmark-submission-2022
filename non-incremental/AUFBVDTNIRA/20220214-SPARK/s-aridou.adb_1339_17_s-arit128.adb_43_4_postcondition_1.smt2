...
(assert
  (and
    (<= shift 64)
    (bvule x (oadd
               (bvmul #x00000000000000010000000000000000 (bvsub (let ((temp___3394 (- 64 
                                                                  shift)))
                                                                  (ite (< temp___3394 340282366920938463463374607431768211456)
...
;; Goal def'vc
;; File "s-aridou.adb", line 1333, characters 0-0
(assert
  (not
  (bvule x (bvsub (let ((temp___3395 (- 128 shift)))
                    (ite (< temp___3395 340282366920938463463374607431768211456)
