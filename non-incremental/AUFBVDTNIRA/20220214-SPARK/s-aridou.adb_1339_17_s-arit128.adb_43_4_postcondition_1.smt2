...
(assert
  (and
    (<= shift 64)
    (bvule x (oadd
               (bvmul #x00000000000000010000000000000000 (bvsub (let ((temp___1966 (- 64 
                                                                  shift)))
                                                                  (ite (< temp___1966 340282366920938463463374607431768211456)
                                                                    (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) temp___1966))
...
(assert
  (not
  (bvule x (bvsub (let ((temp___1967 (- 128 shift)))
                    (ite (< temp___1967 340282366920938463463374607431768211456)
                      (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) temp___1967))
                      #x00000000000000000000000000000000)) #x00000000000000000000000000000001))))
