...
(assert
  (and
    (<= shift 32)
    (bvule x (oadd
               (bvmul #x0000000100000000 (bvsub (let ((temp___3394 (- 32 
                                                  shift)))
                                                  (ite (< temp___3394 18446744073709551616)
...
(assert
  (not
  (bvule x (bvsub (let ((temp___3395 (- 64 shift)))
                    (ite (< temp___3395 18446744073709551616)
                      (bvshl #x0000000000000001 (of_int1 temp___3395))
                      #x0000000000000000)) #x0000000000000001))))
