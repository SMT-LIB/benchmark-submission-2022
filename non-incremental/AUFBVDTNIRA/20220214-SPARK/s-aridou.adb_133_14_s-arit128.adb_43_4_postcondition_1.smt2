...
(assert
  (ite (< n 340282366920938463463374607431768211456)
    (= o (bvshl #x00000000000000000000000000000001 (of_int n)))
...
;; H
(assert (= (big o) (bv2nat128 o)))

(declare-const ada___system__arith_128__impl__big_2xx__result Int)

;; H
(assert (= ada___system__arith_128__impl__big_2xx__result (big o)))

;; Goal def'vc
;; File "s-aridou.adb", line 128, characters 0-0
(assert
  (not (< 0 ada___system__arith_128__impl__big_2xx__result)))
