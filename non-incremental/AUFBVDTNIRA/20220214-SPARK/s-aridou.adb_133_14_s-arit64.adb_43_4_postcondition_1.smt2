...
(assert
  (ite (< n 18446744073709551616)
    (= o (bvshl #x0000000000000001 (of_int n)))
    (= o #x0000000000000000)))
...
;; H
(assert (= (big o) (bv2nat64 o)))

(declare-const ada___system__arith_64__impl__big_2xx__result Int)

;; H
(assert (= ada___system__arith_64__impl__big_2xx__result (big o)))

;; Goal def'vc
;; File "s-aridou.adb", line 128, characters 0-0
(assert
  (not (< 0 ada___system__arith_64__impl__big_2xx__result)))
