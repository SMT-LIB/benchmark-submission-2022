...
;; Assume
(assert (and (<= 0 n) (<= n 127)))

;; Goal def'vc
;; File "s-aridou.adb", line 1341, characters 0-0
(assert
  (not
  (bvugt (ite (< n 340282366920938463463374607431768211456)
           (bvshl #x00000000000000000000000000000001 (of_int n))
