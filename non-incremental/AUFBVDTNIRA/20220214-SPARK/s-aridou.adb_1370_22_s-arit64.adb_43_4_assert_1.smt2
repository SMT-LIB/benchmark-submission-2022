...
(assert (= big_2xxdouble (+ (big #xFFFFFFFFFFFFFFFF) 1)))
    ...
    (and
      (and
        (and
          ...
          (= (bvand (hi x) mask) #x00000000))
        (<= shift 32))
      (= mask (bvshl #xFFFFFFFF (of_int (- 32 shift)))))
...
;; Ensures
(assert
  (bvule x (bvsub (let ((temp___400 (- 64 shift)))
                    (ite (< temp___400 18446744073709551616)
                      (bvshl #x0000000000000001 (of_int1 temp___400))
                      #x0000000000000000)) #x0000000000000001)))

;; Ensures
(assert
  (bvugt (ite (< (- 64 shift) 18446744073709551616)
           (bvshl #x0000000000000001 (of_int1 (- 64 shift)))
           #x0000000000000000) #x0000000000000000))

;; Assert
(assert
  (bvult x (let ((temp___2993 (- 64 shift)))
             (ite (< temp___2993 18446744073709551616)
               (bvshl #x0000000000000001 (of_int1 temp___2993))
               #x0000000000000000))))

;; Assert
(assert
  (and
    (big_2xx__function_guard (big_2xx (- 64 shift)) (- 64 shift))
    (< (big x) (big_2xx (- 64 shift)))))

;; Assert
(assert
  (= y (bvmul (ite (< shift 18446744073709551616)
                (bvshl #x0000000000000001 (of_int1 shift))
                #x0000000000000000) x)))
...
(assert
  (and
    ...
    (and
      ...
      (and
        (big_2xx__function_guard
          (big_2xx (+ shift (- 64 shift)))
          (+ shift (- 64 shift)))
        (= (* (big_2xx shift) (big_2xx (- 64 shift))) (ite (= (+ shift (- 64 
                                                        shift)) 64)
                                                        big_2xxdouble
                                                        (big_2xx
                                                          (+ shift (- 64 
...
;; H
(assert
  (ite (< shift 18446744073709551616)
    (= o (bvshl #x0000000000000001 (of_int1 shift)))
    (= o #x0000000000000000)))
