...
;; Assert
(assert
  (<= (* (* big_2xxsingle big_2xxsingle) (big1 (omultiply xhi yhi))) 
  mult))

;; Assert
(assert
  (bvuge (bvmul ((_ zero_extend 64) xhi) ((_ zero_extend 64) yhi)) #x00000000000000000000000000000001))

;; Goal def'vc
;; File "s-aridou.adb", line 1394, characters 0-0
(assert
  (not (<= (* big_2xxsingle big_2xxsingle) mult)))
