...
;; of_int
(declare-fun of_int2 (Int) (_ BitVec 128))

;; to_int
(define-fun to_int3 ((x (_ BitVec 128))) Int
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_305 (_ BitVec 64)) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool
  true)
  ...
  (forall ((x1 (_ BitVec 64)) (x2 (_ BitVec 64)) (x3 (_ BitVec 64)))
    (! (=>
         (and
           ...
           (dynamic_invariant x3 true true true true))
...
(assert
  (forall ((arg Int))
    (! (=> (dynamic_invariant2 arg true true true true) (= (big1 arg) arg)) :pattern (
    (big1
      arg)) )))
...
;; Assume
(assert (dynamic_invariant y2 true false true true))

;; Assume
(assert (dynamic_invariant y3 true false true true))

(declare-const ada___system__arith_128__impl__le3__result Bool)

(declare-const spark__branch Bool)

;; H
(assert (= spark__branch (ite (bvult x1 y1) true false)))
...
(assert
  (ite (= spark__branch true)
    (= ada___system__arith_128__impl__le3__result (of_int1 1))
    (and
      (= spark__branch1 (ite (bvugt x1 y1) true false))
      (ite (= spark__branch1 true)
        (= ada___system__arith_128__impl__le3__result (of_int1 0))
        (and
          (= spark__branch2 (ite (bvult x2 y2) true false))
          (ite (= spark__branch2 true)
            (= ada___system__arith_128__impl__le3__result (of_int1 1))
            (and
              (= spark__branch3 (ite (bvugt x2 y2) true false))
              (ite (= spark__branch3 true)
                (= ada___system__arith_128__impl__le3__result (of_int1 0))
                (= ada___system__arith_128__impl__le3__result (ite (bvule 
                                                                x3 y3)
                                                                true
                                                                false))))))))))

;; Goal def'vc
;; File "s-aridou.adb", line 143, characters 0-0
(assert
  (not
  (=>
    (<= (big3 x1 x2 x3) (big3 y1 y2 y3))
    (= ada___system__arith_128__impl__le3__result true))))
