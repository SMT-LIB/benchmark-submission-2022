...
;; user_eq
(declare-fun user_eq1 (uns32
  uns32) Bool)

(declare-const dummy1 uns32)
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_305 (_ BitVec 32)) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool
  true)
...
(assert
  (forall ((x1 (_ BitVec 32)) (x2 (_ BitVec 32)) (x3 (_ BitVec 32)))
    (! (=>
         ...
         (big
           ((_ zero_extend 32) x1))) (* big_2xxsingle (big
                                                        ((_ zero_extend 32) x2)))) 
         (big
...
(assert (= big_2xxsingle (big1 4294967296)))
...
(declare-const ada___system__arith_64__impl__le3__result Bool)
...
(assert
  (ite (= spark__branch true)
    (= ada___system__arith_64__impl__le3__result (of_int1 1))
    (and
      (= spark__branch1 (ite (bvugt x1 y1) true false))
      (ite (= spark__branch1 true)
        (= ada___system__arith_64__impl__le3__result (of_int1 0))
        (and
          ...
          (ite (= spark__branch2 true)
            ...
            (and
              ...
              (ite (= spark__branch3 true)
                (= ada___system__arith_64__impl__le3__result (of_int1 0))
                (= ada___system__arith_64__impl__le3__result (ite (bvule 
                                                               x3 y3)
                                                               true
                                                               false))))))))))
...
(assert
  (not
  (=>
    (= ada___system__arith_64__impl__le3__result true)
