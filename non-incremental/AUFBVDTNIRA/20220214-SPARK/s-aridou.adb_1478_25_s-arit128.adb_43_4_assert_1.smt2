...
(declare-const big_2xxdouble_minus_1 Int)
...
;; big_2xxdouble_minus_1__def_axiom
(assert (= big_2xxdouble_minus_1 (big1 #x80000000000000000000000000000000)))
...
;; Assume
(assert (= (big1 #x80000000000000000000000000000000) big_2xxdouble_minus_1))
...
(assert
  (and
    (and
      ...
      (= mult (+ (* big_2xxsingle (big1 t2)) (big1
                                               ((_ zero_extend 64) (lo t1))))))
    (and (hi__function_guard (hi t2) t2) (= (hi t2) #x0000000000000000))))
...
;; Assert
(assert
  (= mult (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (lo t2)))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    (lo
                                                                    t1))))))

;; Assert
(assert (<= mult big_2xxdouble_minus_1))

;; Ensures
(assert (= (* (big x) (big y)) (big (* x y))))

;; Assert
(assert (= mult (abs1 (big (* x y)))))
...
;; Ensures
(assert
  (= (* big_2xxsingle (big1 ((_ zero_extend 64) (lo t2)))) (big1
                                                             (bvmul #x00000000000000010000000000000000 ((_ zero_extend 64) 
                                                             (lo
                                                               t2))))))
...
(assert
  (= mult (+ (big1
               (bvmul #x00000000000000010000000000000000 ((_ zero_extend 64) 
               (lo
                 t2)))) (big1 ((_ zero_extend 64) (lo t1))))))
...
(assert
  (= (+ (big1
          (bvmul #x00000000000000010000000000000000 ((_ zero_extend 64) 
          (lo
            t2)))) (big1 ((_ zero_extend 64) (lo t1)))) (big1
                                                          (bvadd (bvmul #x00000000000000010000000000000000 ((_ zero_extend 64) 
                                                          (lo
                                                            t2))) ((_ zero_extend 64) 
                                                          (lo
                                                            t1))))))
...
;; Goal def'vc
;; File "s-aridou.adb", line 1406, characters 0-0
(assert
  (not
  (=>
    (oconcat__function_guard (oconcat (lo t2) (lo t1)) (lo t2) (lo t1))
    (= (oconcat (lo t2) (lo t1)) (oadd
                                   (bvmul #x00000000000000010000000000000000 ((_ zero_extend 64) 
                                   (lo
                                     t2)))
                                   (lo t1))))))
