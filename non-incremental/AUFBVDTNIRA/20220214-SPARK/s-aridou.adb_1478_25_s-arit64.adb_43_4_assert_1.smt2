...
(assert (= big_2xxdouble_minus_1 (big1 #x8000000000000000)))
...
;; Assume
(assert (= (big1 #x8000000000000000) big_2xxdouble_minus_1))
...
(assert
  (and
    ...
    (and (hi__function_guard (hi t2) t2) (= (hi t2) #x00000000))))
...
;; Assert
(assert
  (= mult (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (lo t2)))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    (lo
                                                                    t1))))))
...
;; Ensures
(assert
  (= (* big_2xxsingle (big1 ((_ zero_extend 32) (lo t2)))) (big1
                                                             (bvmul #x0000000100000000 ((_ zero_extend 32) 
                                                             (lo
                                                               t2))))))

;; Assert
(assert
  (= mult (+ (big1 (bvmul #x0000000100000000 ((_ zero_extend 32) (lo t2)))) 
  (big1
    ((_ zero_extend 32) (lo t1))))))
...
;; Ensures
(assert
  (= (+ (big1 (bvmul #x0000000100000000 ((_ zero_extend 32) (lo t2)))) 
  (big1
    ((_ zero_extend 32) (lo t1)))) (big1
                                     (bvadd (bvmul #x0000000100000000 ((_ zero_extend 32) 
                                     (lo
                                       t2))) ((_ zero_extend 32) (lo t1))))))

;; Assert
(assert
  (= mult (big1
            (oadd
              (bvmul #x0000000100000000 ((_ zero_extend 32) (lo t2)))
              (lo t1)))))
