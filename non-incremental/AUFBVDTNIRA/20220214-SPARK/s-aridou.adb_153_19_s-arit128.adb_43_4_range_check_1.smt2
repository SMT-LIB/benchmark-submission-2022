...
;; user_eq
(declare-fun user_eq (uns128
  uns128) Bool)

(declare-const dummy uns128)

(declare-datatypes ((uns128__ref 0))
  (((uns128__refqtmk (uns128__content uns128)))))

;; uns128__ref_uns128__content__projection
(define-fun uns128__ref_uns128__content__projection ((a1 uns128__ref)) uns128
  (uns128__content a1))
...
;; Goal def'vc
;; File "s-aridou.adb", line 152, characters 0-0
(assert
  (not
  (bvule (bvlshr a (of_int1 64)) ((_ zero_extend 64) #xFFFFFFFFFFFFFFFF))))
