...
;; H
(assert (= (big1 (omultiply xlo yhi)) (bv2nat128 (omultiply xlo yhi))))
...
;; H
(assert (= (big1 (omultiply xhi ylo)) (bv2nat128 (omultiply xhi ylo))))

;; Ensures
(assert
  (= (* big_2xxsingle (+ (big1 (omultiply xhi ylo)) (big1
                                                      (omultiply xlo yhi)))) (+ (* 
  big_2xxsingle (big1 (omultiply xhi ylo))) (* big_2xxsingle (big1
                                                               (omultiply
                                                                 xlo
...
;; H
(assert (= spark__branch4 (ite (< y 0) true false)))
...
(assert
  (not (= (in_double_int_range (- (big1 t23))) true)))
