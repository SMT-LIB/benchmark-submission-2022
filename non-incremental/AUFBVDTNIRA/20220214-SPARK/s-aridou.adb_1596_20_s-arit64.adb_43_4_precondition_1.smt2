...
;; bool_eq
(define-fun bool_eq4 ((x1 (_ BitVec 64)) (y1 (_ BitVec 64))) Bool
...
;; user_eq
(declare-fun user_eq4 (tinteger_64B
  tinteger_64B) Bool)

(declare-const dummy4 tinteger_64B)
...
;; H
(assert (= spark__branch1 (ite (not (= xhi #x00000000)) true false)))

;; H
(assert
  (ite (= spark__branch1 true)
    (and
      (= spark__branch (ite (not (= yhi #x00000000)) true false))
      (and
...
;; H
(assert (= (big1 (omultiply xlo yhi)) (bv2nat64 (omultiply xlo yhi))))
...
;; H
(assert (= (big1 (omultiply xhi ylo)) (bv2nat64 (omultiply xhi ylo))))
...
;; H
(assert (= spark__branch2 (ite (not (= (hi t22) #x00000000)) true false)))
