...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_296 (_ BitVec 32)) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool
  true)
...
(declare-const xx1 (_ BitVec 32))

(declare-const xx2 (_ BitVec 32))

(declare-const xx3 (_ BitVec 32))
...
(assert
  (= (big3 x1 x2 x3) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big
                                                                ((_ zero_extend 32) 
                                                                x1))) (* 
  big_2xxsingle (big ((_ zero_extend 32) x2)))) (big ((_ zero_extend 32) x3)))))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (and
        (= spark__branch (ite (= x2 #x00000000) true false))
        (ite (= spark__branch true) (= x11 (bvsub x1 #x00000001)) (= x11 x1)))
      (= x21 (bvsub x2 #x00000001)))
...
;; H
(assert
  (ite (= spark__branch2 true) (= x12 (bvsub x11 #x00000001)) (= x12 x11)))
