    ...
    (and
      (and
        ...
        (and
          ...
          (= t1 (bvshl (oconcat
                         (to_rep (rec__value (select d 1)))
                         (to_rep (rec__value (select d 2)))) ((_ int2bv 128) 
          scale)))))
      (= t2 (bvshl ((_ zero_extend 64) (to_rep (rec__value (select d 3)))) ((_ int2bv 128) 
      scale))))
    (= t3 (bvshl ((_ zero_extend 64) (to_rep (rec__value (select d 4)))) ((_ int2bv 128) 
    scale)))))
