...
(declare-const big_d12 Int)

(declare-const big_t1 Int)

(declare-const big_d3 Int)

(declare-const big_t2 Int)

(declare-const big_d4 Int)

(declare-const big_t3 Int)
...
;; user_eq
(declare-fun user_eq4 (int128
  int128) Bool)

(declare-const dummy5 int128)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool
  (=>
    (or
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool
  true)
    ...
    (and
      (and
        (and
          (and
            (and
              (forall ((temp___3787 Int))
                (=>
                  (and (<= 1 temp___3787) (<= temp___3787 4))
                  (= (us_attr__init (select d temp___3787)) true)))
              (<= scale 64))
            (= mult (+ (+ (+ (* (* (* big_2xxsingle big_2xxsingle) big_2xxsingle) 
            (big1
              ((_ zero_extend 64) (to_rep (rec__value (select d 1)))))) (* (* 
        ...
        (and
          ...
          (= t1 (bvshl (oconcat
                         (to_rep (rec__value (select d 1)))
                         (to_rep (rec__value (select d 2)))) (of_int1 scale)))))
      (= t2 (bvshl ((_ zero_extend 64) (to_rep (rec__value (select d 3)))) 
      (of_int1
        scale))))
    (= t3 (bvshl ((_ zero_extend 64) (to_rep (rec__value (select d 4)))) 
    (of_int1
      scale)))))

;; Assert
(assert (= (us_attr__init (select d 2)) true))

;; Assert
(assert (= (us_attr__init (select d 1)) true))
...
(assert
  (= (oconcat
       (to_rep (rec__value (select d 1)))
       (to_rep (rec__value (select d 2)))) (bvor (bvshl ((_ zero_extend 64) 
  (to_rep
    (rec__value (select d 1)))) (of_int1 64)) ((_ zero_extend 64) (to_rep
                                                                    (rec__value
                                                                    (select 
                                                                    d 2)))))))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d 1)))
         (to_rep (rec__value (select d 2))))) (+ (* big_2xxsingle (big1
                                                                    ((_ zero_extend 64) 
                                                                    (to_rep
                                                                    (rec__value
                                                                    (select 
                                                                    d 1)))))) 
  (big1
    ((_ zero_extend 64) (to_rep (rec__value (select d 2))))))))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            big_2xxsingle) (big_2xx scale)) (big1
                                              (oconcat
                                                (to_rep
                                                  (rec__value (select d 1)))
                                                (to_rep
                                                  (rec__value (select d 2)))))) (* (* 
            big_2xxsingle (big_2xx scale)) (big1
                                             ((_ zero_extend 64) (to_rep
                                                                   (rec__value
                                                                    (select 
...
;; Assert
(assert
  (and (big_2xx__function_guard (big_2xx scale) scale) (< 0 (big_2xx scale))))

;; H
(assert (big_2xx__function_guard (big_2xx scale) scale))
...
(assert
  (= (big_2xx scale) (big1
                       (ite (< scale 340282366920938463463374607431768211456)
                         (bvshl #x00000000000000000000000000000001 (of_int1
                                                                    scale))
                         #x00000000000000000000000000000000))))

;; H
(assert (< 0 (big_2xx scale)))

;; Assert
(assert (= (us_attr__init (select d 3)) true))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 3))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep
    (rec__value (select d 3)))))))

;; Ensures
(assert
  (< (* (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 3))))) 
  (big_2xx
    scale)) big_2xxdouble))
...
;; Assert
(assert (= (us_attr__init (select d 4)) true))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 4))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep
    (rec__value (select d 4)))))))

;; Ensures
(assert
  (< (* (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 4))))) 
  (big_2xx
    scale)) big_2xxdouble))
...
(declare-const o (_ BitVec 128))

;; H
(assert
  (ite (< scale 340282366920938463463374607431768211456)
    (= o (bvshl #x00000000000000000000000000000001 (of_int1 scale)))
    (= o #x00000000000000000000000000000000)))
...
(assert
  (= (* (big1 o) (big1
                   (oconcat
                     (to_rep (rec__value (select d 1)))
                     (to_rep (rec__value (select d 2)))))) (big1 t1)))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d 1)))
         (to_rep (rec__value (select d 2))))) (bv2nat128 (oconcat
                                                           (to_rep
                                                             (rec__value
                                                               (select 
                                                               d 1)))
...
(assert
  (= (* (big_2xx scale) (big1
                          (oconcat
                            (to_rep (rec__value (select d 1)))
                            (to_rep (rec__value (select d 2)))))) big_d12))
...
;; H
(assert (= (big1 t1) (bv2nat128 t1)))

;; Assume
(assert (= (big1 t1) big_t1))

;; Assume
(assert true)

;; Assert
(assert (= big_d12 big_t1))

;; Assert
(assert
  (= (* (* big_2xxsingle big_2xxsingle) big_d12) (* (* big_2xxsingle 
  big_2xxsingle) big_t1)))

;; Assert
(assert (= (us_attr__init (select d 3)) true))

(declare-const o1 (_ BitVec 128))

;; H
(assert
  (ite (< scale 340282366920938463463374607431768211456)
    (= o1 (bvshl #x00000000000000000000000000000001 (of_int1 scale)))
    (= o1 #x00000000000000000000000000000000)))

;; Ensures
(assert
  (= (* (big1 o1) (big1
                    ((_ zero_extend 64) (to_rep (rec__value (select d 3)))))) 
  (big1
    t2)))
...
;; H
(assert (= (big1 t2) (bv2nat128 t2)))

;; Assume
(assert (= (big1 t2) big_t2))

;; Assume
(assert true)

;; Assert
(assert (= big_d3 big_t2))

;; Assert
(assert (= (* big_2xxsingle big_d3) (* big_2xxsingle big_t2)))

;; Assert
(assert (= (us_attr__init (select d 4)) true))

(declare-const o2 (_ BitVec 128))

;; H
(assert
  (ite (< scale 340282366920938463463374607431768211456)
    (= o2 (bvshl #x00000000000000000000000000000001 (of_int1 scale)))
    (= o2 #x00000000000000000000000000000000)))
...
;; H
(assert (= (big1 t3) (bv2nat128 t3)))

;; Assume
(assert (= (big1 t3) big_t3))

;; Assume
(assert true)

;; Assert
(assert (= big_d4 big_t3))
...
(assert
  (and
    ...
    (big1
      t1)) (* big_2xxsingle (big1 t2))) (big1 t3)))))

;; H
(assert (dynamic_invariant2 (lo t1) true false true true))

;; H
(assert
  (= (lo t1) ((_ extract 63 0) (bvand t1 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t1) t1))

;; H
(assert (dynamic_invariant2 (hi t1) true false true true))

;; H
(assert (= (hi t1) ((_ extract 63 0) (bvlshr t1 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t1) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t1)))) 
  (big1
    ((_ zero_extend 64) (lo t1))))))

;; H
(assert (dynamic_invariant2 (lo t2) true false true true))

;; H
(assert
  (= (lo t2) ((_ extract 63 0) (bvand t2 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t2) t2))

;; H
(assert (dynamic_invariant2 (hi t2) true false true true))

;; H
(assert (= (hi t2) ((_ extract 63 0) (bvlshr t2 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t2) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t2)))) 
  (big1
    ((_ zero_extend 64) (lo t2))))))

;; H
(assert (dynamic_invariant2 (lo t3) true false true true))

;; H
(assert
  (= (lo t3) ((_ extract 63 0) (bvand t3 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t3) t3))

;; H
(assert (dynamic_invariant2 (hi t3) true false true true))

;; H
(assert (= (hi t3) ((_ extract 63 0) (bvlshr t3 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t3) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t3)))) 
  (big1
    ((_ zero_extend 64) (lo t3))))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t2) t2)
      (= ((_ zero_extend 64) (bvor (lo t1) (hi t2))) (bvadd ((_ zero_extend 64) 
      (lo
        t1)) ((_ zero_extend 64) (hi t2)))))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t3) t3)
      (= ((_ zero_extend 64) (bvor (lo t2) (hi t3))) (bvadd ((_ zero_extend 64) 
      (lo
        t2)) ((_ zero_extend 64) (hi t3)))))))
    ...
    (=>
      ...
      (=>
        ...
        (=>
          (hi__function_guard (hi t3) t3)
          (= (* mult (big_2xx scale)) (+ (+ (+ (* (* (* big_2xxsingle 
          big_2xxsingle) big_2xxsingle) (big1 ((_ zero_extend 64) (hi t1)))) (* (* 
          big_2xxsingle big_2xxsingle) (big1
                                         ((_ zero_extend 64) (bvor (lo t1) 
                                         (hi
                                           t2)))))) (* big_2xxsingle 
          (big1
            ((_ zero_extend 64) (bvor (lo t2) (hi t3)))))) (big1
                                                             ((_ zero_extend 64) 
                                                             (lo
                                                               t3)))))))))))
