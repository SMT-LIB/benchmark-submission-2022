...
(assert
  (and
    (and
      ...
      (= t2 (bvshl ((_ zero_extend 32) (to_rep (rec__value (select d 3)))) 
      (of_int1
        scale))))
    (= t3 (bvshl ((_ zero_extend 32) (to_rep (rec__value (select d 4)))) 
    (of_int1
      scale)))))
...
(assert
  (= (oconcat
       (to_rep (rec__value (select d 1)))
       (to_rep (rec__value (select d 2)))) (bvor (bvshl ((_ zero_extend 32) 
  (to_rep
    (rec__value (select d 1)))) (of_int1 32)) ((_ zero_extend 32) (to_rep
                                                                    (rec__value
                                                                    (select 
                                                                    d 2)))))))
  ...
  (= (big1
       (oconcat
         ...
         (to_rep (rec__value (select d 2))))) (+ (* big_2xxsingle (big1
                                                                    ...
                                                                    d 1)))))) 
  (big1
    ((_ zero_extend 32) (to_rep (rec__value (select d 2))))))))
...
(assert
  (= (big_2xx scale) (big1
                       (ite (< scale 18446744073709551616)
                         (bvshl #x0000000000000001 (of_int1 scale))
                         #x0000000000000000))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep (rec__value (select d 3))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep
    (rec__value (select d 3)))))))

;; Ensures
(assert
  (< (* (big1 ((_ zero_extend 32) (to_rep (rec__value (select d 3))))) 
  (big_2xx
    scale)) big_2xxdouble))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep (rec__value (select d 4))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep
    (rec__value (select d 4)))))))

;; Ensures
(assert
  (< (* (big1 ((_ zero_extend 32) (to_rep (rec__value (select d 4))))) 
  (big_2xx
    scale)) big_2xxdouble))
...
(assert
  (ite (< scale 18446744073709551616)
    (= o (bvshl #x0000000000000001 (of_int1 scale)))
    (= o #x0000000000000000)))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d 1)))
         (to_rep (rec__value (select d 2))))) (bv2nat64 (oconcat
                                                          (to_rep
                                                            (rec__value
                                                              (select 
                                                              d 1)))
...
(assert
  (ite (< scale 18446744073709551616)
    (= o1 (bvshl #x0000000000000001 (of_int1 scale)))
    (= o1 #x0000000000000000)))

;; Ensures
(assert
  (= (* (big1 o1) (big1
                    ((_ zero_extend 32) (to_rep (rec__value (select d 3)))))) 
  (big1
    t2)))
...
(assert
  (ite (< scale 18446744073709551616)
    (= o2 (bvshl #x0000000000000001 (of_int1 scale)))
...
;; H
(assert (= (lo t1) ((_ extract 31 0) (bvand t1 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t1) ((_ extract 31 0) (bvlshr t1 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t1) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t1)))) 
  (big1
    ((_ zero_extend 32) (lo t1))))))

;; H
(assert (dynamic_invariant2 (lo t2) true false true true))

;; H
(assert (= (lo t2) ((_ extract 31 0) (bvand t2 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t2) ((_ extract 31 0) (bvlshr t2 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t2) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t2)))) 
  (big1
    ((_ zero_extend 32) (lo t2))))))

;; H
(assert (dynamic_invariant2 (lo t3) true false true true))

;; H
(assert (= (lo t3) ((_ extract 31 0) (bvand t3 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t3) ((_ extract 31 0) (bvlshr t3 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t3) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t3)))) 
  (big1
    ((_ zero_extend 32) (lo t3))))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t2) t2)
      (= ((_ zero_extend 32) (bvor (lo t1) (hi t2))) (bvadd ((_ zero_extend 32) 
      (lo
        t1)) ((_ zero_extend 32) (hi t2)))))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t3) t3)
      (= ((_ zero_extend 32) (bvor (lo t2) (hi t3))) (bvadd ((_ zero_extend 32) 
      (lo
        t2)) ((_ zero_extend 32) (hi t3)))))))
