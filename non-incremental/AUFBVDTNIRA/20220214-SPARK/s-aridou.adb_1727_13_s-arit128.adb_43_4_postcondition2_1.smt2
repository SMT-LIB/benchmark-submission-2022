...
;; Assume
(assert (= (big1 #x00000000000000000000000000000000) big_0))
  ...
  (and
    (and
      (and
        (and
          (and
            (and (not (= z 0)) (= (big1 qu) (abs1 big_q)))
...
;; Ensures
(assert (<= (* (big x) (big y)) big_0))

;; Goal def'vc
;; File "s-aridou.adb", line 1712, characters 0-0
(assert
  (not (=> (not (< 0 z)) (= (in_double_int_range (big1 qu)) true))))
