...
;; r__def_axiom
(assert (and (to_int__function_guard (uc_to_int a) a) (= r (uc_to_int a))))
...
(declare-const ada___system__arith_128__impl__to_pos_int__result Int)

;; H
(assert (let ((o a)) (to_int__function_guard (uc_to_int o) o)))

;; H
(assert (dynamic_invariant (uc_to_int a) true false true true))

;; H
(assert (= (uc_to_int a) r))
...
;; H
(assert (= spark__branch (ite (<= 0 r) true false)))

;; H
(assert (= spark__branch true))

;; H
(assert (= ada___system__arith_128__impl__to_pos_int__result r))

;; Goal def'vc
;; File "s-aridou.adb", line 172, characters 0-0
(assert
  (not (= (big ada___system__arith_128__impl__to_pos_int__result) (big1 a))))
