              ...
              (and
                ...
                (let ((o5 x))
                  (let ((o6 (big o5)))
                    (and
                      (= o6 o5)
                      (= o (ite (= quot (div1 (* o6 o4) o2)) true false)))))))))))
    (= o false)))
              ...
              (and
                ...
                (let ((o6 x))
                  (let ((o7 (big o6)))
                    (and
                      (= o7 o6)
                      (= o1 (ite (= big_r (mod1 (* o7 o5) o3)) true false)))))))))))
    (= o1 false)))
                    ...
                    (let ((o8 x))
                      (let ((o9 (big o8)))
                        (and
                          (= o9 o8)
                          (let ((o10 (* o9 o7)))
                            (let ((o11 (round_quotient o10 o5 quot big_r)))
                              (and
                                (= o11 (ite (< (div1
                                                 (- (abs1 o5) (big 1))
                                                 (big 2)) (abs1 big_r))
                                         (ite (= (same_sign o10 o5) true)
                                           (+ quot (big 1))
                                           (- quot (big 1)))
                                         quot))
                                (= o3 o11)))))))))))))
        (= o3 quot))
      (= o2 (ite (= big_q o3) true false)))
    (= o2 false)))
...
(assert
  (ite (= o2 true)
    (let ((o5 (big1 ru)))
      (and (= o5 (bv2nat128 ru)) (= o4 (ite (= o5 (abs1 big_r)) true false))))
    (= o4 false)))
...
(assert
  (ite (= o4 true)
    (let ((o6 (big1 qu)))
      (and (= o6 (bv2nat128 qu)) (= o5 (ite (= o6 (abs1 big_q)) true false))))
    (= o5 false)))
...
(assert
  (ite (= o5 true)
    (and
      (= o6 (in_double_int_range big_q))
      (=
        (= o6 true)
        (= (in_range2
             big_q
             (big (- 170141183460469231731687303715884105728))
             (big 170141183460469231731687303715884105727)) true)))
    (= o6 false)))
...
(assert
  (ite (= o7 true)
    (and
      (ite (= (to_int2 (ite (<= 0 x) true false)) (to_int2
                                                    (ite (<= 0 y) true false)))
        (and
          (= o8 (to_pos_int ru))
          (and
            (to_pos_int__function_guard o8 ru)
            (and
              (dynamic_invariant o8 true false true true)
              (= (big o8) (big1 ru)))))
        (and
          (= o8 (to_neg_int ru))
          (and
            (to_neg_int__function_guard o8 ru)
            (and
              (dynamic_invariant o8 true false true true)
              (= (big o8) (- (big1 ru)))))))
      (= true (ite (= r o8) true false)))
    (= true false)))
  ...
  (ite (= (to_int2
            (ite (= (to_int2 (ite (<= 0 x) true false)) (to_int2
                                                          (ite (<= 0 
                                                            ...
                                                            false)))
              true
              false)) (to_int2 (ite (<= 0 z) true false)))
    true
    false))
...
;; Goal def'vc
;; File "s-aridou.adb", line 1829, characters 0-0
(assert
  (not (= (in_double_int_range (big1 qu)) true)))
