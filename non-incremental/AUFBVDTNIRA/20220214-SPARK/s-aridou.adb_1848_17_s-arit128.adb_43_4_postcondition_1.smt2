        ...
        (and
          (and
            (and
              ...
              (= (big1 ru) (abs1 big_r)))
            (= (big1 qu) (abs1 big_q)))
          (= (in_double_int_range big_q) true))
        (= (in_double_int_range big_r) true))
      (and
        (to_pos_int__function_guard (to_pos_int ru) ru)
        (and
          (to_neg_int__function_guard (to_neg_int ru) ru)
          (= r (ite (= (<= 0 x) (<= 0 y)) (to_pos_int ru) (to_neg_int ru))))))
    (and
      (to_pos_int__function_guard (to_pos_int qu) qu)
      (and
        (to_neg_int__function_guard (to_neg_int qu) qu)
        (= q (ite (= (= (<= 0 x) (<= 0 y)) (<= 0 z))
               (to_pos_int qu)
               (to_neg_int qu)))))))
