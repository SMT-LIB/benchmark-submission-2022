...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_335 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool
  (=>
                ...
                (and
                  (and
                    (and
                      (and
                        (not (= z 0))
                        (forall ((temp___4514 Int))
                          (=>
                            (and (<= 1 temp___4514) (<= temp___4514 4))
                            (= (us_attr__init (select d temp___4514)) true))))
                      (and
...
;; Ensures
(assert
  (= (+ (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 2))))) 
  (big1
    ((_ zero_extend 64) #x0000000000000001))) (big1
                                                (bvadd ((_ zero_extend 64) 
                                                (to_rep
                                                  (rec__value (select d 2)))) ((_ zero_extend 64) #x0000000000000001)))))

;; Assert
(assert
  (<= (+ (big1 ((_ zero_extend 64) (to_rep (rec__value (select d 2))))) 1) 
  (big1
    ((_ zero_extend 64) zlo))))

;; H
(assert (dynamic_invariant1 (orem t1 zlo) true false true true))

;; H
(assert (= (orem t1 zlo) (bvurem t1 ((_ zero_extend 64) zlo))))

;; H
(assert (dynamic_invariant1 (odivide t1 zlo) true false true true))

;; H
(assert (= (odivide t1 zlo) (bvudiv t1 ((_ zero_extend 64) zlo))))

;; Ensures
(assert
  (= (big1 t1) (+ (* (big1 ((_ zero_extend 64) zlo)) (big1 (odivide t1 zlo))) 
  (big1
    (orem t1 zlo)))))

;; Assert
(assert (= ((_ zero_extend 64) (lo (orem t1 zlo))) (orem t1 zlo)))
...
;; H
(assert (dynamic_invariant2 (lo (orem t1 zlo)) true false true true))

;; H
(assert
  (= (lo (orem t1 zlo)) ((_ extract 63 0) (bvand (orem t1 zlo) #x0000000000000000FFFFFFFFFFFFFFFF))))

;; Ensures
(assert
  (= (big1 t2) (+ (* big_2xxsingle (big1
                                     ((_ zero_extend 64) (lo (orem t1 zlo))))) 
  (big1
    ((_ zero_extend 64) (to_rep (rec__value (select d 4))))))))

;; Assert
(assert
  (bvule (bvadd (orem t1 zlo) #x00000000000000000000000000000001) ((_ zero_extend 64) 
  zlo)))
...
;; Ensures
(assert
  (= (+ (big1 (orem t1 zlo)) (big1 ((_ zero_extend 64) #x0000000000000001))) 
  (big1
    (bvadd (orem t1 zlo) ((_ zero_extend 64) #x0000000000000001)))))

;; Assert
(assert (<= (+ (big1 (orem t1 zlo)) 1) (big1 ((_ zero_extend 64) zlo))))

;; H
(assert (dynamic_invariant1 (odivide t2 zlo) true false true true))

;; H
(assert (= (odivide t2 zlo) (bvudiv t2 ((_ zero_extend 64) zlo))))

;; Ensures
(assert
  (= (big1 t2) (+ (* (big1 ((_ zero_extend 64) zlo)) (big1 (odivide t2 zlo))) 
  (big1
    ru))))

;; Assert
(assert
  (= mult (+ (* (big1 ((_ zero_extend 64) zlo)) (+ (* big_2xxsingle (big1
                                                                    (odivide
                                                                    t1
                                                                    zlo))) 
  (big1
    (odivide t2 zlo)))) (big1 ru))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) zlo)) (bv2nat128 ((_ zero_extend 64) zlo))))

;; Assert
(assert (<= 0 (big1 ((_ zero_extend 64) zlo))))
...
;; Ensures
(assert (< (div1 (big1 t1) (big1 ((_ zero_extend 64) zlo))) big_2xxsingle))

;; Ensures
(assert
  (= (div1 (big1 t1) (big1 ((_ zero_extend 64) zlo))) (big1
                                                        (bvudiv t1 ((_ zero_extend 64) 
                                                        zlo)))))
...
;; Ensures
(assert (= ((_ zero_extend 64) (lo (odivide t1 zlo))) (odivide t1 zlo)))
...
;; Ensures
(assert (< (div1 (big1 t2) (big1 ((_ zero_extend 64) zlo))) big_2xxsingle))

;; Ensures
(assert
  (= (div1 (big1 t2) (big1 ((_ zero_extend 64) zlo))) (big1
                                                        (bvudiv t2 ((_ zero_extend 64) 
                                                        zlo)))))
...
;; Ensures
(assert (= ((_ zero_extend 64) (lo (odivide t2 zlo))) (odivide t2 zlo)))
...
;; H
(assert (dynamic_invariant2 (lo (odivide t2 zlo)) true false true true))

;; H
(assert
  (= (lo (odivide t2 zlo)) ((_ extract 63 0) (bvand (odivide t2 zlo) #x0000000000000000FFFFFFFFFFFFFFFF))))
...
;; H
(assert (dynamic_invariant2 (lo (odivide t1 zlo)) true false true true))

;; H
(assert
  (= (lo (odivide t1 zlo)) ((_ extract 63 0) (bvand (odivide t1 zlo) #x0000000000000000FFFFFFFFFFFFFFFF))))

;; Ensures
(assert
  (= (big1 qu) (+ (* big_2xxsingle (big1
                                     ((_ zero_extend 64) (lo
                                                           (odivide t1 zlo))))) 
  (big1
    ((_ zero_extend 64) (lo (odivide t2 zlo)))))))

;; H
(assert true)

;; H
(assert (= (big1 ru) (bv2nat128 ru)))

;; H
(assert true)

;; H
(assert (= (big1 qu) (bv2nat128 qu)))
...
;; H
(assert (= (big1 (odivide t2 zlo)) (bv2nat128 (odivide t2 zlo))))
...
;; H
(assert (= (big1 (odivide t1 zlo)) (bv2nat128 (odivide t1 zlo))))
...
;; Ensures
(assert (= mult (+ (* (big1 ((_ zero_extend 64) zlo)) (big1 qu)) (big1 ru))))

;; Ensures
(assert (< (big1 ru) (big1 ((_ zero_extend 64) zlo))))
...
;; H
(assert (= (big1 qu) (div1 mult (big1 ((_ zero_extend 64) zlo)))))

;; H
(assert (= (big1 ru) (mod1 mult (big1 ((_ zero_extend 64) zlo)))))

;; Assert
(assert (= ((_ zero_extend 64) zlo) (oabs z)))
