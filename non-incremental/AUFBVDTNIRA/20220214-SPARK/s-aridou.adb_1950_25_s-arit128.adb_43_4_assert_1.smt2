...
;; user_eq
(declare-fun user_eq1 (uns128
  uns128) Bool)

(declare-const dummy1 uns128)
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_291 (_ BitVec 128)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_305 (_ BitVec 64)) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool
  true)
  ...
  (forall ((x1 (_ BitVec 64)) (x2 (_ BitVec 64)) (x3 (_ BitVec 64)))
    (! (=>
         (and
           ...
           (dynamic_invariant1 x3 true true true true))
...
(assert
  (forall ((a (_ BitVec 128)))
    (! (=>
         (dynamic_invariant a true true true true)
         (let ((result (hi a)))
           (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool
  (=>
    (or
...
(assert
  (forall ((arg Int))
    (! (=> (dynamic_invariant2 arg true true true true) (= (big arg) arg)) :pattern (
    (big
      arg)) )))
...
;; Assume
(assert (dynamic_invariant zu true false true true))
...
;; Assume
(assert (dynamic_invariant1 s3 true false true true))
...
;; Assume
(assert (dynamic_invariant t3 true false true true))

;; Assume
(assert (dynamic_invariant1 q true false true true))
  ...
  (and
    (and
      (and
        (and
          (and
            (= t1 (omultiply q (lo zu)))
            (and
              (hi__function_guard (hi zu) zu)
              (= t2 (omultiply q (hi zu)))))
          (= s3 (lo t1)))
        (and (hi__function_guard (hi t1) t1) (= t3 (oadd (hi t1) (lo t2)))))
      (= s2 (lo t3)))
    (and
      (hi__function_guard (hi t3) t3)
      (and (hi__function_guard (hi t2) t2) (= s1 (bvadd (hi t3) (hi t2)))))))

;; H
(assert (dynamic_invariant1 (lo zu) true false true true))
...
;; H
(assert (dynamic_invariant1 (hi zu) true false true true))
...
;; Ensures
(assert
  (= (big1 zu) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi zu)))) 
  (big1
    ((_ zero_extend 64) (lo zu))))))

;; H
(assert (hi__function_guard (hi t1) t1))

;; H
(assert (dynamic_invariant1 (hi t1) true false true true))
...
;; H
(assert (dynamic_invariant1 (lo t2) true false true true))
...
;; H
(assert (dynamic_invariant1 (hi t2) true false true true))
...
;; H
(assert (dynamic_invariant1 (hi t3) true false true true))
...
;; Ensures
(assert
  (= (* (big1 ((_ zero_extend 64) q)) (big1 ((_ zero_extend 64) (lo zu)))) 
  (big1
    t1)))
...
;; Ensures
(assert
  (= (* (big1 ((_ zero_extend 64) q)) (big1 ((_ zero_extend 64) (hi zu)))) 
  (big1
    t2)))

;; Assert
(assert
  (= (* (big1 ((_ zero_extend 64) q)) (big1 zu)) (+ (* big_2xxsingle 
  (big1
    t2)) (big1 t1))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t3) t3)
      (= (* (big1 ((_ zero_extend 64) q)) (big1 zu)) (+ (+ (+ (* (* big_2xxsingle 
      big_2xxsingle) (big1 ((_ zero_extend 64) (hi t2)))) (* (* big_2xxsingle 
      big_2xxsingle) (big1 ((_ zero_extend 64) (hi t3))))) (* big_2xxsingle 
      (big1
        ((_ zero_extend 64) s2)))) (big1 ((_ zero_extend 64) s3)))))))

;; Goal def'vc
;; File "s-aridou.adb", line 1699, characters 0-0
(assert
  (not
  (=>
    (hi__function_guard (hi t3) t3)
    (=>
      (hi__function_guard (hi t2) t2)
      (= (oadd1 ((_ zero_extend 64) (hi t3)) (hi t2)) ((_ zero_extend 64) 
      s1))))))
