...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_291 (_ BitVec 64)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_305 (_ BitVec 32)) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool
  true)
...
;; Ensures
(assert
  (= (big1 zu) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi zu)))) 
  (big1
    ((_ zero_extend 32) (lo zu))))))
...
;; Ensures
(assert
  (= (* (big1 ((_ zero_extend 32) q)) (big1 ((_ zero_extend 32) (lo zu)))) 
  (big1
    t1)))
...
;; Ensures
(assert
  (= (* (big1 ((_ zero_extend 32) q)) (big1 ((_ zero_extend 32) (hi zu)))) 
  (big1
    t2)))

;; Assert
(assert
  (= (* (big1 ((_ zero_extend 32) q)) (big1 zu)) (+ (* big_2xxsingle 
  (big1
    t2)) (big1 t1))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t3) t3)
      (= (* (big1 ((_ zero_extend 32) q)) (big1 zu)) (+ (+ (+ (* (* big_2xxsingle 
      big_2xxsingle) (big1 ((_ zero_extend 32) (hi t2)))) (* (* big_2xxsingle 
      big_2xxsingle) (big1 ((_ zero_extend 32) (hi t3))))) (* big_2xxsingle 
      (big1
        ((_ zero_extend 32) s2)))) (big1 ((_ zero_extend 32) s3)))))))
...
(assert
  ...
  (=>
    ...
    (=>
      (hi__function_guard (hi t2) t2)
      (= (oadd1 ((_ zero_extend 32) (hi t3)) (hi t2)) ((_ zero_extend 32) 
      s1))))))
