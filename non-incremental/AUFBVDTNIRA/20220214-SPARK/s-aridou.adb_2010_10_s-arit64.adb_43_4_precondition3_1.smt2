...
;; inversion_axiom
(assert
  (forall ((x uns32)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))
...
;; to_int
(define-fun to_int4 ((x uns32)) Int
  (bv2nat32 (to_rep x)))
...
;; user_eq
(declare-fun user_eq6 (int64
  int64) Bool)

(declare-const dummy7 int64)
...
(assert
  (= (oconcat
       (to_rep (rec__value (select d j)))
       (to_rep (rec__value (select d (+ j 1))))) (bvor (bvshl ((_ zero_extend 32) 
  (to_rep
    (rec__value (select d j)))) (of_int1 32)) ((_ zero_extend 32) (to_rep
                                                                    (rec__value
                                                                    (select 
                                                                    d (+ 
                                                                    j 1))))))))
...
(assert
  ...
  (big1
    ((_ zero_extend 32) (to_rep (rec__value (select d j)))))) (big1
                                                                ((_ zero_extend 32) 
                                                                (to_rep
                                                                  (rec__value
                                                                    (select 
...
;; Ensures
(assert
  (< (big1 ((_ zero_extend 32) (to_rep (rec__value (select d j))))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    zhi))))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d j)))
         (to_rep (rec__value (select d (+ j 1)))))) (bv2nat64 (oconcat
                                                                (to_rep
                                                                  (rec__value
                                                                    (select 
                                                                    d 
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep (rec__value (select d j))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) zhi)) (bv2nat64 ((_ zero_extend 32) zhi))))
...
;; Assert
(assert (<= 0 (big1 ((_ zero_extend 32) zhi))))
  ...
  (< (div1
       (big1
         (oconcat
           (to_rep (rec__value (select d j)))
           (to_rep (rec__value (select d (+ j 1))))))
       (big1 ((_ zero_extend 32) zhi))) big_2xxsingle))
  ...
  (= (div1
       (big1
         (oconcat
           (to_rep (rec__value (select d j)))
           (to_rep (rec__value (select d (+ j 1))))))
       (big1 ((_ zero_extend 32) zhi))) (big1
                                          (bvudiv (oconcat
                                                    (to_rep
                                                      (rec__value
                                                        (select d j)))
...
(assert
  (= (odivide
       ...
       zhi) (bvudiv (oconcat
                      (to_rep (rec__value (select d j)))
                      (to_rep (rec__value (select d (+ j 1))))) ((_ zero_extend 32) 
  zhi))))
...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 32) (to_rep (rec__value (select d j)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 32) (to_rep
                                        (rec__value (select d (+ j 1)))))))) 
  (big1
    ((_ zero_extend 32) (to_rep (rec__value (select d (+ j 2)))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep (rec__value (select qd j))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep
       ...
       (to_rep (rec__value (select d (+ j 2))))) (* (* (+ (big1
                                                            ...
                                                            (to_rep
                                                              (rec__value
                                                                ...
                                                                qd j))))) 1) 
  (big1
    ((_ zero_extend 32) zhi))) big_2xxsingle)))
...
;; Ensures
(assert
  (= (big1 zu) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) zhi))) (big1
                                                                    ((_ zero_extend 32) 
                                                                    (lo
                                                                    zu))))))
...
;; H
(assert (= (big1 zu) (bv2nat64 zu)))

;; Goal def'vc
;; File "s-aridou.adb", line 1768, characters 0-0
(assert
  (not (<= (* big_2xxsingle (big1 ((_ zero_extend 32) zhi))) (big1 zu))))
