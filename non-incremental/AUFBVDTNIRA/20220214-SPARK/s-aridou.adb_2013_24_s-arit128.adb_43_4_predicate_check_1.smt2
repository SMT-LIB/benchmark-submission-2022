...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_335 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool
  (=>
    ...
    (and
      (and
        (and
          (and
            (and (<= 1 j) (<= j 2))
            (forall ((temp___4176 Int))
              (=>
                (and (<= 1 temp___4176) (<= temp___4176 4))
                (= (us_attr__init (select d temp___4176)) true))))
...
;; Assert
(assert (and (<= 1 (+ j 1)) (<= (+ j 1) 4)))

;; Assert
(assert (= (us_attr__init (select d (+ j 1))) true))

;; Assert
(assert (and (<= 1 j) (<= j 4)))

;; Assert
(assert (= (us_attr__init (select d j)) true))
...
(assert
  (= (oconcat
       (to_rep (rec__value (select d j)))
       (to_rep (rec__value (select d (+ j 1))))) (bvor (bvshl ((_ zero_extend 64) 
  (to_rep
    (rec__value (select d j)))) (of_int1 64)) ((_ zero_extend 64) (to_rep
                                                                    (rec__value
                                                                    (select 
                                                                    d (+ 
                                                                    j 1))))))))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d j)))
         (to_rep (rec__value (select d (+ j 1)))))) (+ (* big_2xxsingle 
  (big1
    ((_ zero_extend 64) (to_rep (rec__value (select d j)))))) (big1
                                                                ((_ zero_extend 64) 
                                                                (to_rep
                                                                  (rec__value
                                                                    (select 
...
;; Ensures
(assert
  (< (big1 ((_ zero_extend 64) (to_rep (rec__value (select d j))))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    zhi))))
...
(assert
  (= (big1
       (oconcat
         (to_rep (rec__value (select d j)))
         (to_rep (rec__value (select d (+ j 1)))))) (bv2nat128 (oconcat
                                                                 (to_rep
                                                                   (rec__value
                                                                    (select 
                                                                    d 
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep (rec__value (select d j))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep
    (rec__value (select d j)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) zhi)) (bv2nat128 ((_ zero_extend 64) zhi))))
...
(assert
  (< (big1
       (oconcat
         (to_rep (rec__value (select d j)))
         (to_rep (rec__value (select d (+ j 1)))))) (* (big1
                                                         ((_ zero_extend 64) 
                                                         zhi)) big_2xxsingle)))
...
;; Assert
(assert (<= 0 (big1 ((_ zero_extend 64) zhi))))
  ...
  (< (div1
       (big1
         (oconcat
           (to_rep (rec__value (select d j)))
           (to_rep (rec__value (select d (+ j 1))))))
       (big1 ((_ zero_extend 64) zhi))) big_2xxsingle))
  ...
  (= (div1
       (big1
         (oconcat
           (to_rep (rec__value (select d j)))
           (to_rep (rec__value (select d (+ j 1))))))
       (big1 ((_ zero_extend 64) zhi))) (big1
                                          (bvudiv (oconcat
                                                    (to_rep
                                                      (rec__value
                                                        (select d j)))
...
(assert
  (= (odivide
       ...
       zhi) (bvudiv (oconcat
                      (to_rep (rec__value (select d j)))
                      (to_rep (rec__value (select d (+ j 1))))) ((_ zero_extend 64) 
  zhi))))
...
;; Assert
(assert (= (us_attr__init (select qd j)) true))
  ...
  (< (big1
       (orem
         (oconcat
           (to_rep (rec__value (select d j)))
           (to_rep (rec__value (select d (+ j 1)))))
         zhi)) (big1 ((_ zero_extend 64) zhi))))

;; Ensures
(assert (in_range1 (+ j 2)))

;; Assert
(assert (and (<= 1 (+ j 2)) (<= (+ j 2) 4)))

;; Assert
(assert (= (us_attr__init (select d (+ j 2))) true))
...
(assert
  (= (big3
       (to_rep (rec__value (select d j)))
       (to_rep (rec__value (select d (+ j 1))))
       (to_rep (rec__value (select d (+ j 2))))) (+ (+ (* (* big_2xxsingle 
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep (rec__value (select d j)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep
                                        (rec__value (select d (+ j 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep (rec__value (select d (+ j 2)))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep (rec__value (select qd j))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep
    (rec__value (select qd j)))))))
...
(assert
  (< (big3
       (to_rep (rec__value (select d j)))
       (to_rep (rec__value (select d (+ j 1))))
       (to_rep (rec__value (select d (+ j 2))))) (* (* (+ (big1
                                                            ((_ zero_extend 64) 
                                                            (to_rep
                                                              (rec__value
                                                                (select 
                                                                qd j))))) 1) 
  (big1
    ((_ zero_extend 64) zhi))) big_2xxsingle)))
...
;; Ensures
(assert
  (= (big1 zu) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) zhi))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    (lo
                                                                    zu))))))
...
(assert
  (< (big3
       (to_rep (rec__value (select d j)))
       (to_rep (rec__value (select d (+ j 1))))
       (to_rep (rec__value (select d (+ j 2))))) (* (big1 zu) (+ (big1
                                                                   ((_ zero_extend 64) 
                                                                   (to_rep
                                                                    (rec__value
                                                                    (select 
...
;; Assert
(assert
  (<= 0 (+ (big1 ((_ zero_extend 64) (to_rep (rec__value (select qd j))))) 1)))
