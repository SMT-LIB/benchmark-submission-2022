...
;; user_eq
(declare-fun user_eq2 (int128
  int128) Bool)

(declare-const dummy2 int128)
...
;; Ensures
(assert (< (div1 (big1 ru) (big_2xx scale)) (big1 (oabs z))))
...
(assert
  (not
  (= (* mult (big_2xx scale)) (+ (* (* (big1 (oabs z)) (big1 qu)) (big_2xx
                                                                    scale)) 
  (big1
    ru)))))
