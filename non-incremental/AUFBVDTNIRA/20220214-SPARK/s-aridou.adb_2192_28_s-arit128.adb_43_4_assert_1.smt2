...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= yhi #x0000000000000000)) true false))

(declare-const spark__branch2 Bool)

;; H
(assert (= spark__branch2 (ite (not (= yhi #x0000000000000000)) true false)))

;; H
(assert (= spark__branch2 true))

;; H
(assert (dynamic_invariant2 (omultiply xlo yhi) true false true true))

;; H
(assert
  (= (omultiply xlo yhi) (bvmul ((_ zero_extend 64) xlo) ((_ zero_extend 64) 
  yhi))))

(declare-const t12 (_ BitVec 128))

;; H
(assert (= t12 (omultiply xlo yhi)))

;; H
(assert (dynamic_invariant3 (lo t12) true false true true))

;; H
(assert
  (= (lo t12) ((_ extract 63 0) (bvand t12 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t12) t12))

;; H
(assert (dynamic_invariant3 (hi t12) true false true true))

;; H
(assert (= (hi t12) ((_ extract 63 0) (bvlshr t12 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t12) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t12)))) 
  (big1
    ((_ zero_extend 64) (lo t12))))))
...
(assert
  (dynamic_invariant2
    (oadd (to_rep1 (rec__value (select d2 3))) (lo t12))
    true
    false
    true
    true))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d2 3))) (lo t12)) (bvadd ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d2 3)))) ((_ zero_extend 64) (lo t12)))))

(declare-const t21 (_ BitVec 128))

;; H
(assert (= t21 (oadd (to_rep1 (rec__value (select d2 3))) (lo t12))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (lo t12))) (bv2nat128 ((_ zero_extend 64) 
  (lo
    t12)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d2 3))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d2 3)))))))
...
(assert
  (= (* big_2xxsingle (+ (big1
                           ((_ zero_extend 64) (to_rep1
                                                 (rec__value (select d2 3))))) 
  (big1
    ((_ zero_extend 64) (lo t12))))) (+ (* big_2xxsingle (big1
                                                           ((_ zero_extend 64) 
                                                           (to_rep1
                                                             (rec__value
                                                               (select 
                                                               d2 3)))))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) (lo t12)))))))

;; H
(assert (dynamic_invariant3 (lo t21) true false true true))

;; H
(assert
  (= (lo t21) ((_ extract 63 0) (bvand t21 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t21) t21))

;; H
(assert (dynamic_invariant3 (hi t21) true false true true))

;; H
(assert (= (hi t21) ((_ extract 63 0) (bvlshr t21 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t21) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t21)))) 
  (big1
    ((_ zero_extend 64) (lo t21))))))
...
;; Ensures
(assert (= (to_rep1 o2) (lo t21)))

(declare-const d3 (Array Int uns64__init_wrapper))

;; H
(assert (= d3 (store d2 3 (uns64__init_wrapperqtmk o2 true))))
...
;; Ensures
(assert (= (to_rep1 o3) (bvadd (hi t12) (hi t21))))

(declare-const d4 (Array Int uns64__init_wrapper))

;; H
(assert (= d4 (store d3 2 (uns64__init_wrapperqtmk o3 true))))
...
(assert
  (and
    ...
    (and
      ...
      (= (oadd1 ((_ zero_extend 64) (hi t12)) (hi t21)) ((_ zero_extend 64) 
      (to_rep1
        (rec__value (select d4 2))))))))
...
;; Ensures
(assert
  (= (+ (big1 ((_ zero_extend 64) (hi t12))) (big1
                                               ((_ zero_extend 64) (hi t21)))) 
  (big1
    (bvadd ((_ zero_extend 64) (hi t12)) ((_ zero_extend 64) (hi t21))))))
...
;; neq'result'unused'unused
(define-fun neqqtresultqtunusedqtunused1 () Bool
  (ite (not (= xhi #x0000000000000000)) true false))

(declare-const spark__branch3 Bool)

;; H
(assert (= spark__branch3 (ite (not (= xhi #x0000000000000000)) true false)))

;; H
(assert (= spark__branch3 true))

;; H
(assert (dynamic_invariant2 (omultiply xhi ylo) true false true true))

;; H
(assert
  (= (omultiply xhi ylo) (bvmul ((_ zero_extend 64) xhi) ((_ zero_extend 64) 
  ylo))))

(declare-const t13 (_ BitVec 128))

;; H
(assert (= t13 (omultiply xhi ylo)))

;; H
(assert (dynamic_invariant3 (lo t13) true false true true))

;; H
(assert
  (= (lo t13) ((_ extract 63 0) (bvand t13 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t13) t13))

;; H
(assert (dynamic_invariant3 (hi t13) true false true true))

;; H
(assert (= (hi t13) ((_ extract 63 0) (bvlshr t13 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t13) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t13)))) 
  (big1
    ((_ zero_extend 64) (lo t13))))))
...
;; Assert
(assert (= (us_attr__init (select d4 3)) true))

;; H
(assert
  (dynamic_invariant2
    (oadd (to_rep1 (rec__value (select d4 3))) (lo t13))
    true
    false
    true
    true))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d4 3))) (lo t13)) (bvadd ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d4 3)))) ((_ zero_extend 64) (lo t13)))))

(declare-const t22 (_ BitVec 128))

;; H
(assert (= t22 (oadd (to_rep1 (rec__value (select d4 3))) (lo t13))))

;; H
(assert (dynamic_invariant3 (lo t22) true false true true))

;; H
(assert
  (= (lo t22) ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t22) t22))

;; H
(assert (dynamic_invariant3 (hi t22) true false true true))

;; H
(assert (= (hi t22) ((_ extract 63 0) (bvlshr t22 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t22) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t22)))) 
  (big1
    ((_ zero_extend 64) (lo t22))))))
...
(declare-const o4 uns64)

;; Ensures
(assert (= (to_rep1 o4) (lo t22)))

(declare-const d5 (Array Int uns64__init_wrapper))

;; H
(assert (= d5 (store d4 3 (uns64__init_wrapperqtmk o4 true))))
...
;; Assert
(assert (= (us_attr__init (select d5 2)) true))

;; H
(assert
  (dynamic_invariant2
    (oadd (to_rep1 (rec__value (select d5 2))) (hi t13))
    true
    false
    true
    true))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d5 2))) (hi t13)) (bvadd ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d5 2)))) ((_ zero_extend 64) (hi t13)))))

(declare-const t31 (_ BitVec 128))

;; H
(assert (= t31 (oadd (to_rep1 (rec__value (select d5 2))) (hi t13))))
...
;; Ensures
(assert
  (= (+ (big1 t31) (big1 ((_ zero_extend 64) (hi t22)))) (big1
                                                           (bvadd t31 ((_ zero_extend 64) 
                                                           (hi
                                                             t22))))))
...
;; H
(assert (dynamic_invariant2 (oadd1 t31 (hi t22)) true false true true))

;; H
(assert (= (oadd1 t31 (hi t22)) (bvadd t31 ((_ zero_extend 64) (hi t22)))))

(declare-const t32 (_ BitVec 128))

;; H
(assert (= t32 (oadd1 t31 (hi t22))))

;; H
(assert (dynamic_invariant2 (omultiply xhi yhi) true false true true))

;; H
(assert
  (= (omultiply xhi yhi) (bvmul ((_ zero_extend 64) xhi) ((_ zero_extend 64) 
  yhi))))

(declare-const t23 (_ BitVec 128))

;; H
(assert (= t23 (omultiply xhi yhi)))

;; H
(assert (dynamic_invariant3 (lo t23) true false true true))

;; H
(assert
  (= (lo t23) ((_ extract 63 0) (bvand t23 #x0000000000000000FFFFFFFFFFFFFFFF))))

;; H
(assert (hi__function_guard (hi t23) t23))

;; H
(assert (dynamic_invariant3 (hi t23) true false true true))

;; H
(assert (= (hi t23) ((_ extract 63 0) (bvlshr t23 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t23) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t23)))) 
  (big1
    ((_ zero_extend 64) (lo t23))))))
...
;; Ensures
(assert
  (= (+ (big1 t32) (big1 ((_ zero_extend 64) (lo t23)))) (big1
                                                           (bvadd t32 ((_ zero_extend 64) 
                                                           (lo
                                                             t23))))))
...
;; H
(assert (dynamic_invariant2 (oadd1 t32 (lo t23)) true false true true))

;; H
(assert (= (oadd1 t32 (lo t23)) (bvadd t32 ((_ zero_extend 64) (lo t23)))))

(declare-const t14 (_ BitVec 128))

;; H
(assert (= t14 (oadd1 t32 (lo t23))))

;; H
(assert (dynamic_invariant3 (lo t14) true false true true))

;; H
(assert
  (= (lo t14) ((_ extract 63 0) (bvand t14 #x0000000000000000FFFFFFFFFFFFFFFF))))

(declare-const o5 uns64)

;; Ensures
(assert (= (to_rep1 o5) (lo t14)))

(declare-const d6 (Array Int uns64__init_wrapper))

;; H
(assert (= d6 (store d5 2 (uns64__init_wrapperqtmk o5 true))))

;; Assert
(assert (= (us_attr__init (select d6 2)) true))

;; H
(assert (hi__function_guard (hi t14) t14))

;; H
(assert (dynamic_invariant3 (hi t14) true false true true))

;; H
(assert (= (hi t14) ((_ extract 63 0) (bvlshr t14 (of_int1 64)))))

;; Ensures
(assert
  (= (big1 t14) (+ (* big_2xxsingle (big1 ((_ zero_extend 64) (hi t14)))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d6 2))))))))
...
;; Ensures
(assert (= (to_rep1 o6) (bvadd (hi t23) (hi t14))))

(declare-const d7 (Array Int uns64__init_wrapper))

;; H
(assert (= d7 (store d6 1 (uns64__init_wrapperqtmk o6 true))))

;; Assert
(assert
  (and
    (hi__function_guard (hi t23) t23)
    (and
      (hi__function_guard (hi t14) t14)
      (= (oadd1 ((_ zero_extend 64) (hi t23)) (hi t14)) ((_ zero_extend 64) 
      (to_rep1
        (rec__value (select d7 1))))))))
...
;; Ensures
(assert
  (= (+ (big1 ((_ zero_extend 64) (hi t23))) (big1
                                               ((_ zero_extend 64) (hi t14)))) 
  (big1
    (bvadd ((_ zero_extend 64) (hi t23)) ((_ zero_extend 64) (hi t14))))))
...
(assert
  ...
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d7 1)))))) (* (* 
  big_2xxsingle big_2xxsingle) (big1
                                 ((_ zero_extend 64) (to_rep1
                                                       (rec__value
                                                         (select d7 2))))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1 (rec__value (select d7 3))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d7 4)))))))))
