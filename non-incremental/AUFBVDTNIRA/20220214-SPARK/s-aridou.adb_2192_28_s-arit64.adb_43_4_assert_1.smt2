...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= yhi #x00000000)) true false))

(declare-const spark__branch2 Bool)

;; H
(assert (= spark__branch2 (ite (not (= yhi #x00000000)) true false)))
...
;; H
(assert
  (= (omultiply xlo yhi) (bvmul ((_ zero_extend 32) xlo) ((_ zero_extend 32) 
  yhi))))
...
;; H
(assert (= (lo t12) ((_ extract 31 0) (bvand t12 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t12) ((_ extract 31 0) (bvlshr t12 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t12) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t12)))) 
  (big1
    ((_ zero_extend 32) (lo t12))))))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d2 3))) (lo t12)) (bvadd ((_ zero_extend 32) 
  (to_rep1
    (rec__value (select d2 3)))) ((_ zero_extend 32) (lo t12)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (lo t12))) (bv2nat64 ((_ zero_extend 32) 
  (lo
    t12)))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select d2 3))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep1
...
(assert
  (= (* big_2xxsingle (+ (big1
                           ((_ zero_extend 32) (to_rep1
                                                 (rec__value (select d2 3))))) 
  (big1
    ((_ zero_extend 32) (lo t12))))) (+ (* big_2xxsingle (big1
                                                           ((_ zero_extend 32) 
                                                           (to_rep1
                                                             (rec__value
                                                               (select 
                                                               d2 3)))))) (* 
  big_2xxsingle (big1 ((_ zero_extend 32) (lo t12)))))))

;; H
(assert (dynamic_invariant3 (lo t21) true false true true))

;; H
(assert (= (lo t21) ((_ extract 31 0) (bvand t21 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t21) ((_ extract 31 0) (bvlshr t21 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t21) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t21)))) 
  (big1
    ((_ zero_extend 32) (lo t21))))))
...
;; H
(assert (= d3 (store d2 3 (uns32__init_wrapperqtmk o2 true))))
...
;; H
(assert (= d4 (store d3 2 (uns32__init_wrapperqtmk o3 true))))
...
(assert
  (and
    ...
    (and
      ...
      (= (oadd1 ((_ zero_extend 32) (hi t12)) (hi t21)) ((_ zero_extend 32) 
      (to_rep1
...
;; Ensures
(assert
  (= (+ (big1 ((_ zero_extend 32) (hi t12))) (big1
                                               ((_ zero_extend 32) (hi t21)))) 
  (big1
    (bvadd ((_ zero_extend 32) (hi t12)) ((_ zero_extend 32) (hi t21))))))
...
(define-fun neqqtresultqtunusedqtunused1 () Bool
  (ite (not (= xhi #x00000000)) true false))

(declare-const spark__branch3 Bool)

;; H
(assert (= spark__branch3 (ite (not (= xhi #x00000000)) true false)))
...
;; H
(assert
  (= (omultiply xhi ylo) (bvmul ((_ zero_extend 32) xhi) ((_ zero_extend 32) 
  ylo))))
...
;; H
(assert (= (lo t13) ((_ extract 31 0) (bvand t13 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t13) ((_ extract 31 0) (bvlshr t13 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t13) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t13)))) 
  (big1
    ((_ zero_extend 32) (lo t13))))))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d4 3))) (lo t13)) (bvadd ((_ zero_extend 32) 
  (to_rep1
    (rec__value (select d4 3)))) ((_ zero_extend 32) (lo t13)))))
...
;; H
(assert (= (lo t22) ((_ extract 31 0) (bvand t22 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t22) ((_ extract 31 0) (bvlshr t22 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t22) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t22)))) 
  (big1
    ((_ zero_extend 32) (lo t22))))))
...
;; H
(assert (= d5 (store d4 3 (uns32__init_wrapperqtmk o4 true))))
...
;; H
(assert
  (= (oadd (to_rep1 (rec__value (select d5 2))) (hi t13)) (bvadd ((_ zero_extend 32) 
  (to_rep1
    (rec__value (select d5 2)))) ((_ zero_extend 32) (hi t13)))))
...
;; Ensures
(assert
  (= (+ (big1 t31) (big1 ((_ zero_extend 32) (hi t22)))) (big1
                                                           (bvadd t31 ((_ zero_extend 32) 
                                                           (hi
                                                             t22))))))
...
;; H
(assert (= (oadd1 t31 (hi t22)) (bvadd t31 ((_ zero_extend 32) (hi t22)))))
...
;; H
(assert
  (= (omultiply xhi yhi) (bvmul ((_ zero_extend 32) xhi) ((_ zero_extend 32) 
  yhi))))
...
;; H
(assert (= (lo t23) ((_ extract 31 0) (bvand t23 #x00000000FFFFFFFF))))
...
;; H
(assert (= (hi t23) ((_ extract 31 0) (bvlshr t23 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t23) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t23)))) 
  (big1
    ((_ zero_extend 32) (lo t23))))))
...
;; Ensures
(assert
  (= (+ (big1 t32) (big1 ((_ zero_extend 32) (lo t23)))) (big1
                                                           (bvadd t32 ((_ zero_extend 32) 
                                                           (lo
                                                             t23))))))
...
;; H
(assert (= (oadd1 t32 (lo t23)) (bvadd t32 ((_ zero_extend 32) (lo t23)))))
...
;; H
(assert (= (lo t14) ((_ extract 31 0) (bvand t14 #x00000000FFFFFFFF))))
...
;; H
(assert (= d6 (store d5 2 (uns32__init_wrapperqtmk o5 true))))
...
;; H
(assert (= (hi t14) ((_ extract 31 0) (bvlshr t14 (of_int1 32)))))

;; Ensures
(assert
  (= (big1 t14) (+ (* big_2xxsingle (big1 ((_ zero_extend 32) (hi t14)))) 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d6 2))))))))
...
;; H
(assert (= d7 (store d6 1 (uns32__init_wrapperqtmk o6 true))))
...
(assert
  (and
    ...
    (and
      ...
      (= (oadd1 ((_ zero_extend 32) (hi t23)) (hi t14)) ((_ zero_extend 32) 
      (to_rep1
...
;; Ensures
(assert
  (= (+ (big1 ((_ zero_extend 32) (hi t23))) (big1
                                               ((_ zero_extend 32) (hi t14)))) 
  (big1
    (bvadd ((_ zero_extend 32) (hi t23)) ((_ zero_extend 32) (hi t14))))))
...
(assert
  ...
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d7 1)))))) (* (* 
  big_2xxsingle big_2xxsingle) (big1
                                 ((_ zero_extend 32) (to_rep1
                                                       (rec__value
                                                         (select d7 2))))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 32) (to_rep1 (rec__value (select d7 3))))))) 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d7 4)))))))))
