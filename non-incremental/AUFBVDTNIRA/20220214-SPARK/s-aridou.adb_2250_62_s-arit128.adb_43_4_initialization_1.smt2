...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d3 4))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d3 4)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d3 3))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d3 3)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d3 2))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
...
(assert
  (not (= (us_attr__init (select d3 1)) true)))
