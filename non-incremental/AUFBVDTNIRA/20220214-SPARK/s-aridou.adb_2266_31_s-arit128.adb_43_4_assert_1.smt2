...
;; H
(assert
  (= spark__branch6 (ite (bvugt (to_rep1 (rec__value (select d3 1))) #x0000000000000000)
                      true
                      false)))
...
;; Assert
(assert (<= (* big_2xxdouble big_2xxsingle) mult))

;; Ensures
(assert (<= (big1 zu) (big1 #x00000000000000010000000000000000)))

;; Goal def'vc
;; File "s-aridou.ads", line 125, characters 0-0
(assert
  (not (<= (* big_2xxdouble (big1 zu)) mult)))
