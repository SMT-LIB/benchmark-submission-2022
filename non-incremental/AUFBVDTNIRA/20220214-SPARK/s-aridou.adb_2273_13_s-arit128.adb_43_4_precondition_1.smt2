...
;; H
(assert (= (to_rep1 (rec__value (select d3 1))) o21))

;; H
(assert (= spark__branch6 (ite (bvugt o21 #x0000000000000000) true false)))
...
(assert
  (ite (= spark__branch6 true)
    (and
      (<= (* (* (* big_2xxsingle big_2xxsingle) big_2xxsingle) (big1
                                                                 ((_ zero_extend 64) 
                                                                 (to_rep1
                                                                   (rec__value
                                                                    (select 
      ...
      mult)
      (and
        (<= (* big_2xxdouble big_2xxsingle) mult)
        (and
          (<= (big1 zu) (big1 #x00000000000000010000000000000000))
          (<= (* big_2xxdouble (big1 zu)) mult))))
    (let ((temp___1029 (select d3 2)))
      (and
        (= (us_attr__init temp___1029) true)
        (and
          (= (to_rep1 (rec__value temp___1029)) o22)
          (and
            (<= (big1 zu) (big1 ((_ zero_extend 64) o22)))
            (<= (* big_2xxdouble (big1 zu)) mult)))))))
