...
(assert
  (= (oconcat
       (to_rep1 (rec__value (select d3 2)))
       (to_rep1 (rec__value (select d3 3)))) (bvor (bvshl ((_ zero_extend 32) 
  (to_rep1
    (rec__value (select d3 2)))) (of_int1 32)) ((_ zero_extend 32) (to_rep1
                                                                    (rec__value
                                                                    (select 
                                                                    d3 3)))))))
...
;; H
(assert (= (orem t15 zlo) (bvurem t15 ((_ zero_extend 32) zlo))))
...
;; H
(assert
  (= (lo (orem t15 zlo)) ((_ extract 31 0) (bvand (orem t15 zlo) #x00000000FFFFFFFF))))
...
;; H
(assert
  (= (oconcat (lo (orem t15 zlo)) (to_rep1 (rec__value (select d3 4)))) (bvor (bvshl ((_ zero_extend 32) 
  (lo
    (orem t15 zlo))) (of_int1 32)) ((_ zero_extend 32) (to_rep1
                                                         (rec__value
                                                           (select d3 4)))))))
...
;; H
(assert (= (odivide t24 zlo) (bvudiv t24 ((_ zero_extend 32) zlo))))
...
;; H
(assert
  (= (lo (odivide t24 zlo)) ((_ extract 31 0) (bvand (odivide t24 zlo) #x00000000FFFFFFFF))))

;; H
(assert (dynamic_invariant2 (odivide t15 zlo) true false true true))

;; H
(assert (= (odivide t15 zlo) (bvudiv t15 ((_ zero_extend 32) zlo))))
...
;; H
(assert
  (= (lo (odivide t15 zlo)) ((_ extract 31 0) (bvand (odivide t15 zlo) #x00000000FFFFFFFF))))
...
;; H
(assert
  (= (oconcat (lo (odivide t15 zlo)) (lo (odivide t24 zlo))) (bvor (bvshl ((_ zero_extend 32) 
  (lo
    (odivide t15 zlo))) (of_int1 32)) ((_ zero_extend 32) (lo
                                                            (odivide t24 zlo))))))
...
;; H
(assert (= (orem t24 zlo) (bvurem t24 ((_ zero_extend 32) zlo))))
