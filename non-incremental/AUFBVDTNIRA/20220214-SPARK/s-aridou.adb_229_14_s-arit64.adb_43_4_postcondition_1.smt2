...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool
  true)
          ...
          (exists ((spark__branch1 Bool))
            (and
              ...
              (ite (= spark__branch1 true)
                (and
                  (= (mod1 x y) (- (mod1 (- x) (- y))))
                  (= (abs1 (mod1 x y)) (mod1 (abs1 x) (abs1 y))))
                (= (abs1 (mod1 x y)) (mod1 (abs1 x) (abs1 y)))))))))))

;; Goal def'vc
;; File "s-aridou.adb", line 225, characters 0-0
(assert
  (not (= (abs1 (mod1 x y)) (mod1 (abs1 x) (abs1 y)))))
