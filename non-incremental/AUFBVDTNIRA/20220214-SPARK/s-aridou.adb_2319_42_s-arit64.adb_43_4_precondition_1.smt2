                                  ...
                                  (and
                                    (and
                                      (dynamic_invariant2
                                        ...
                                        true
                                        true)
                                      (= o21 (ite (= o20 (- 9223372036854775808))
                                               #x8000000000000000
                                               (of_int1 (abs1 o20)))))
                                    (let ((o22 (big1 o21)))
                                      (and
...
;; H
(assert (= (hi zu2) ((_ extract 31 0) (bvlshr zu2 (of_int1 32)))))

;; neq'result'unused'unused
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= (bvand (hi zu2) mask3) #x00000000)) true false))

;; Ensures
(assert (in_range2 (- 32 shift3)))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= mask3 (bvshl #xFFFFFFFF (of_int (- 32 shift3)))) true false))
