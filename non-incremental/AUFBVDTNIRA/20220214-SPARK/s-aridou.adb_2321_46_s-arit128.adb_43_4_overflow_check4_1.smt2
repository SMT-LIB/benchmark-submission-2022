...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= (bvand (hi zu) mask1) #x0000000000000000)) true false))

;; Ensures
(assert (in_range2 (- 64 shift1)))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= mask1 (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 shift1))))
    true
    false))
...
(define-fun eqqtresultqtunusedqtunused2 () Bool
  (ite (= zu (bvshl (oabs z) (of_int1 scale1))) true false))

;; H
(assert (big_2xx__function_guard (big_2xx scale1) scale1))
...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= (big1 zu) (* (big1 (oabs z)) (big_2xx scale1))) true false))

;; Ensures
(assert (in_range1 (- log_single_size inter1)))

;; Ensures
(assert (in_range2 (- log_single_size inter1)))

;; Goal def'vc
;; File "s-aridou.ads", line 125, characters 0-0
(assert
  (not (<= (- 2147483648) (power 2 (- log_single_size inter1)))))
