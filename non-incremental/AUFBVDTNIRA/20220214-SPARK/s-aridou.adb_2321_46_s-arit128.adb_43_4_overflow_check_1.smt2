...
;; LoopInvariant
(assert (= mask2 (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 shift2)))))

;; LoopInvariant
(assert (= zu1 (bvshl (oabs z) (of_int1 scale2))))
...
;; H
(assert (= (div1 shift2 2) (power 2 (- log_single_size (+ inter2 1)))))

;; H
(assert (or (= shift2 2) (= (mod2 (div1 shift2 2) 2) 0)))
...
;; H
(assert (= mask3 (bvshl mask2 (of_int shift3))))

;; Ensures
(assert (in_range2 (- 64 shift_prev)))

;; Ensures
(assert
  (= (bvshl (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 shift_prev))) (of_int
                                                                    shift3)) (bvshl #xFFFFFFFFFFFFFFFF 
  (of_int
    (+ (- 64 shift_prev) shift3)))))

;; H
(assert
  (= mask_prev (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 (* 2 shift3))))))

;; H
(assert (= mask3 (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 shift3)))))
            ...
            (and
              ...
              (and
                ...
                (ite (= spark__branch6 true)
                  (and
                    (= zu2 (bvshl zu1 (of_int1 shift3)))
                    (and
                      (not (= (bvand (hi zu2) mask3) #x0000000000000000))
                      (and
                        (= (big1 zu_prev) (* (big1 (oabs z)) (big_2xx scale2)))
                        (and
                          (= (big1 zu2) (* (big_2xx shift3) (big1 zu_prev)))
                          (let ((o19 (big_2xx scale2)))
                            (and
                              (and
                                (big_2xx__function_guard o19 scale2)
                                (and
                                  (= o19 (big1
                                  ...
                                  (and
                                    (and
                                      (dynamic_invariant2
                                        ...
                                        true
                                        true)
                                      (= o21 (ite (= o20 (- 170141183460469231731687303715884105728))
                                               #x80000000000000000000000000000000
                                               (of_int1 (abs1 o20)))))
                                    (let ((o22 (big1 o21)))
                                      (and
                                        ...
                                        (let ((o23 zu_prev))
                                          (and
                                            (= (big1 o23) (bv2nat128 o23))
                                            (let ((o24 (big_2xx shift3)))
                                              (and
                                                (and
                                                  (big_2xx__function_guard
                                                    o24
                                                  ...
                                                  (and
                                                    (= o24 (big1
                                                             (ite (< 
                                                               shift3 340282366920938463463374607431768211456)
                                                               (bvshl #x00000000000000000000000000000001 
                                                               (of_int1
                                                                 shift3))
                                                               #x00000000000000000000000000000000)))
                                                              ...
                                                              (and
                                                                (and
                                                                  ...
                                                                  (and
                                                                    (= o27 
                                                                    (big1
                                                                    (ite (< o26 340282366920938463463374607431768211456)
                                                                    (bvshl #x00000000000000000000000000000001 
                                                                    (of_int1
                                                                    o26))
                                                                    #x00000000000000000000000000000000)))
                                                                ...
                                                                (let ((o28 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    true)
                                                                    (= o31 
                                                                    (ite (= o30 (- 170141183460469231731687303715884105728))
                                                                    #x80000000000000000000000000000000
                                                                    (of_int1
                                                                    (abs1
                                                                    o30)))))
                                                                    ...
                                                                    true)
                                                                    (= o35 
                                                                    (ite (= o34 (- 170141183460469231731687303715884105728))
                                                                    #x80000000000000000000000000000000
                                                                    (of_int1
                                                                    (abs1
                                                                    o34)))))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx scale3) scale3)
    (= (big1 zu2) (* (big1 (oabs z)) (big_2xx scale3)))))
...
;; H
(assert (= (hi zu2) ((_ extract 63 0) (bvlshr zu2 (of_int1 64)))))
...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= mask3 (bvshl #xFFFFFFFFFFFFFFFF (of_int (- 64 shift3))))
    true
    false))
...
(define-fun eqqtresultqtunusedqtunused2 () Bool
  (ite (= zu2 (bvshl (oabs z) (of_int1 scale3))) true false))
...
(assert
  (not (<= (power 2 (- log_single_size inter3)) 2147483647)))
