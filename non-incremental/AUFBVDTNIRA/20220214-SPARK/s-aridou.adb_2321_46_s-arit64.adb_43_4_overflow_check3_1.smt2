...
(define-fun neqqtresultqtunusedqtunused () Bool
  (ite (not (= (bvand (hi zu) mask1) #x00000000)) true false))

;; Ensures
(assert (in_range2 (- 32 shift1)))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= mask1 (bvshl #xFFFFFFFF ((_ int2bv 32) (- 32 shift1)))) true false))
...
(define-fun eqqtresultqtunusedqtunused2 () Bool
  (ite (= zu (bvshl (oabs z) ((_ int2bv 64) scale1))) true false))
...
(assert
  (= (big_2xx scale1) (big1
                        (ite (< scale1 18446744073709551616)
                          (bvshl #x0000000000000001 ((_ int2bv 64) scale1))
                          #x0000000000000000))))
