...
;; LoopInvariant
(assert (<= scale2 (- 32 shift2)))

;; LoopInvariant
(assert
  (and
    (hi__function_guard (hi zu1) zu1)
    (not (= (bvand (hi zu1) mask2) #x00000000))))

;; LoopInvariant
(assert (= mask2 (bvshl #xFFFFFFFF ((_ int2bv 32) (- 32 shift2)))))

;; LoopInvariant
(assert (= zu1 (bvshl (oabs z) ((_ int2bv 64) scale2))))
...
(declare-const mask3 (_ BitVec 32))

;; H
(assert (= mask3 (bvshl mask2 ((_ int2bv 32) shift3))))
...
;; H
(assert
  (= spark__branch6 (ite (= (bvand (hi zu1) mask3) #x00000000) true false)))
      ...
      (and
        ...
        (and
          ...
          (ite (= spark__branch6 true)
            (and
              (= zu2 (bvshl zu1 ((_ int2bv 64) shift3)))
              (and
...
;; LoopInvariant
(assert (<= scale3 (- 32 shift3)))

;; LoopInvariant
(assert
  (and
    (hi__function_guard (hi zu2) zu2)
    (not (= (bvand (hi zu2) mask3) #x00000000))))

;; LoopInvariant
(assert (= mask3 (bvshl #xFFFFFFFF ((_ int2bv 32) (- 32 shift3)))))

;; LoopInvariant
(assert (= zu2 (bvshl (oabs z) ((_ int2bv 64) scale3))))
...
;; LoopInvariant
(assert (and (<= 0 inter3) (<= inter3 (- log_single_size 1))))

;; LoopInvariant
(assert (= shift3 (power 2 (- log_single_size inter3))))
