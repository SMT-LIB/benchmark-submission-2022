...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_282 (_ BitVec 128)) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool
  true)
...
(assert
  (forall ((x1 (_ BitVec 64)) (y (_ BitVec 64)))
    (= (bv2nat (bv_min1 x1 y)) (min (bv2nat x1) (bv2nat y)))))

;; bv_max_to_uint
(assert
  (forall ((x1 (_ BitVec 64)) (y (_ BitVec 64)))
    (= (bv2nat (bv_max1 x1 y)) (max (bv2nat x1) (bv2nat y)))))

;; uc_of_int
(define-fun uc_of_int1 ((x1 Int)) (_ BitVec 64)
  (ite (<= 0 x1) ((_ int2bv 64) x1) (bvneg ((_ int2bv 64) (- x1)))))

;; uc_to_int
(define-fun uc_to_int1 ((x1 (_ BitVec 64))) Int
  (ite (= (bool_lt1 x1 ((_ int2bv 64) two_power_size_minus_one1)) true)
    (bv2nat x1)
    (- (bv2nat (bvneg x1)))))
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_296 (_ BitVec 64)) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool
  true)
