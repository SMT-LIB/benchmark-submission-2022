...
;; bool_eq
(define-fun bool_eq3 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (= x1 y) true false))

;; bool_ne
(define-fun bool_ne1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (not (= x1 y)) true false))

;; bool_lt
(define-fun bool_lt1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (bvult x1 y) true false))

;; bool_le
(define-fun bool_le1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (bvule x1 y) true false))

;; bool_gt
(define-fun bool_gt1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (bvugt x1 y) true false))

;; bool_ge
(define-fun bool_ge1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (bvuge x1 y) true false))
...
;; Power_0
(assert (forall ((x1 (_ BitVec 64))) (= (power1 x1 0) #x0000000000000001)))

;; Power_1
(assert (forall ((x1 (_ BitVec 64))) (= (power1 x1 1) x1)))

;; Power_s
(assert
  (forall ((x1 (_ BitVec 64)) (n Int))
    (=> (<= 0 n) (= (power1 x1 (+ n 1)) (bvmul x1 (power1 x1 n))))))

;; Power_s_alt
(assert
  (forall ((x1 (_ BitVec 64)) (n Int))
    (=> (< 0 n) (= (power1 x1 n) (bvmul x1 (power1 x1 (- n 1)))))))

;; Power_sum
(assert
  (forall ((x1 (_ BitVec 64)) (n Int) (m Int))
    (=>
      (<= 0 n)
      (=>
        (<= 0 m)
        (= (power1 x1 (+ n m)) (bvmul (power1 x1 n) (power1 x1 m)))))))
...
(assert
  (forall ((x1 (_ BitVec 64)) (n Int) (m Int))
    (=>
      (<= 0 n)
      (=> (<= 0 m) (= (power1 x1 (* n m)) (power1 (power1 x1 n) m))))))

;; Power_mult2
(assert
  (forall ((x1 (_ BitVec 64)) (y (_ BitVec 64)) (n Int))
    (=>
      (<= 0 n)
      (= (power1 (bvmul x1 y) n) (bvmul (power1 x1 n) (power1 y n))))))

;; bv_min
(define-fun bv_min1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) (_ BitVec 64)
  (ite (bvule x1 y) x1 y))

;; bv_max
(define-fun bv_max1 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) (_ BitVec 64)
  (ite (bvule x1 y) y x1))

;; bv_min_to_uint
(assert
  (forall ((x1 (_ BitVec 64)) (y (_ BitVec 64)))
    (= (bv2nat64 (bv_min1 x1 y)) (min (bv2nat64 x1) (bv2nat64 y)))))

;; bv_max_to_uint
(assert
  (forall ((x1 (_ BitVec 64)) (y (_ BitVec 64)))
    (= (bv2nat64 (bv_max1 x1 y)) (max (bv2nat64 x1) (bv2nat64 y)))))

;; uc_of_int
(define-fun uc_of_int1 ((x1 Int)) (_ BitVec 64)
  (ite (<= 0 x1) (of_int1 x1) (bvneg (of_int1 (- x1)))))

;; uc_to_int
(define-fun uc_to_int1 ((x1 (_ BitVec 64))) Int
  (ite (= (bool_lt1 x1 (of_int1 two_power_size_minus_one1)) true)
    (bv2nat64 x1)
    (- (bv2nat64 (bvneg x1)))))
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool
  true)
...
;; Assume
(assert (bvule x #xFFFFFFFFFFFFFFFF0000000000000000))

;; Goal def'vc
;; File "s-aridou.adb", line 231, characters 0-0
(assert
  (not
  (= (+ (big x) (big ((_ zero_extend 64) y))) (big
                                                (bvadd x ((_ zero_extend 64) 
                                                y))))))
