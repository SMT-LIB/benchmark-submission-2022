...
(assert
  (forall ((x (_ BitVec 32)) (n (_ BitVec 32)))
    (= (bvlshr x n) (lsr1 x (bv2nat32 n)))))

;; asr_bv_is_asr
(assert
  (forall ((x (_ BitVec 32)) (n (_ BitVec 32)))
    (= (bvashr x n) (asr1 x (bv2nat32 n)))))

;; lsl_bv_is_lsl
(assert
  (forall ((x (_ BitVec 32)) (n (_ BitVec 32)))
    (= (bvshl x n) (lsl1 x (bv2nat32 n)))))
...
(assert
  (forall ((a (_ BitVec 32)) (b (_ BitVec 32)) (i (_ BitVec 32)) (n (_ BitVec 32)))
    (= (eq_sub1 a b (bv2nat32 i) (bv2nat32 n)) (eq_sub_bv1 a b i n))))
...
(assert
  (forall ((arg (_ BitVec 64)))
    (! (=>
         ...
         (= (big arg) (bv2nat64 arg))) :pattern ((big arg)) )))
...
;; bool_eq
(define-fun bool_eq3 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (= x1 y) true false))

;; bool_ne
(define-fun bool_ne1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (not (= x1 y)) true false))

;; bool_lt
(define-fun bool_lt1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (bvult x1 y) true false))

;; bool_le
(define-fun bool_le1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (bvule x1 y) true false))

;; bool_gt
(define-fun bool_gt1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (bvugt x1 y) true false))

;; bool_ge
(define-fun bool_ge1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
...
;; Power_0
(assert (forall ((x1 (_ BitVec 32))) (= (power1 x1 0) #x00000001)))

;; Power_1
(assert (forall ((x1 (_ BitVec 32))) (= (power1 x1 1) x1)))

;; Power_s
(assert
  (forall ((x1 (_ BitVec 32)) (n Int))
...
;; Power_sum
(assert
  (forall ((x1 (_ BitVec 32)) (n Int) (m Int))
    (=>
      (<= 0 n)
      (=>
        (<= 0 m)
...
;; Power_mult2
(assert
  (forall ((x1 (_ BitVec 32)) (y (_ BitVec 32)) (n Int))
    (=>
      (<= 0 n)
      (= (power1 (bvmul x1 y) n) (bvmul (power1 x1 n) (power1 y n))))))

;; bv_min
(define-fun bv_min1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) (_ BitVec 32)
  (ite (bvule x1 y) x1 y))

;; bv_max
(define-fun bv_max1 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) (_ BitVec 32)
  (ite (bvule x1 y) y x1))

;; bv_min_to_uint
(assert
  (forall ((x1 (_ BitVec 32)) (y (_ BitVec 32)))
    (= (bv2nat32 (bv_min1 x1 y)) (min (bv2nat32 x1) (bv2nat32 y)))))

;; bv_max_to_uint
(assert
  (forall ((x1 (_ BitVec 32)) (y (_ BitVec 32)))
    (= (bv2nat32 (bv_max1 x1 y)) (max (bv2nat32 x1) (bv2nat32 y)))))

;; uc_of_int
(define-fun uc_of_int1 ((x1 Int)) (_ BitVec 32)
  (ite (<= 0 x1) (of_int1 x1) (bvneg (of_int1 (- x1)))))

;; uc_to_int
(define-fun uc_to_int1 ((x1 (_ BitVec 32))) Int
...
;; Assume
(assert (bvule x #xFFFFFFFF00000000))

;; Goal def'vc
;; File "s-aridou.adb", line 231, characters 0-0
(assert
  (not
  (= (+ (big x) (big ((_ zero_extend 32) y))) (big
                                                (bvadd x ((_ zero_extend 32) 
                                                y))))))
