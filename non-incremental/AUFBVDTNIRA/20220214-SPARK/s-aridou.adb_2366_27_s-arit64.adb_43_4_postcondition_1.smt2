...
(assert
  (and
    (and
      (and
        (and (<= shift 16) (= zu (bvshl zu_prev (of_int1 shift))))
        (= mask_prev (bvshl #xFFFFFFFF (of_int (- 32 (* 2 shift))))))
      (= mask (bvshl #xFFFFFFFF (of_int (- 32 shift)))))
    (and
      (hi__function_guard (hi zu_prev) zu_prev)
      (not
        (= (bvand (bvand (hi zu_prev) mask_prev) (bvnot mask)) #x00000000)))))
...
(assert
  ...
  (=>
    ...
    (not (= (bvand (hi zu) mask) #x00000000)))))
