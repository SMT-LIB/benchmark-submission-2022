...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (bvand (hi zu1) mask3) #x0000000000000000) true false))
...
;; H
(assert (= zu2 (bvshl zu1 (of_int1 shift3))))
...
;; H
(assert (= (big1 zu_prev) (bv2nat128 zu_prev)))

;; H
(assert (big_2xx__function_guard (big_2xx shift3) shift3))
...
(assert
  (= (big_2xx shift3) (big1
                        (ite (< shift3 340282366920938463463374607431768211456)
                          (bvshl #x00000000000000000000000000000001 (of_int1
                                                                    shift3))
                          #x00000000000000000000000000000000))))

;; H
(assert (< 0 (big_2xx shift3)))
...
;; Ensures
(assert
  (= (big1 zu2) (+ (* (big_2xx shift3) (* (big1 (oabs z)) (big_2xx scale2))) 0)))
    ...
    (and
      ...
      (and
        (big_2xx__function_guard
          ...
          (+ shift3 scale2))
        (= (* (big_2xx shift3) (big_2xx scale2)) (ite (= (+ shift3 scale2) 128)
                                                   big_2xxdouble
                                                   (big_2xx
                                                     (+ shift3 scale2))))))))

;; Ensures
(assert (in_range1 (+ shift3 scale2)))

;; H
(assert
  (big_2xx__function_guard (big_2xx (+ shift3 scale2)) (+ shift3 scale2)))
...
;; H
(assert
  (= (big_2xx (+ shift3 scale2)) (big1
                                   (ite (< (+ shift3 scale2) 340282366920938463463374607431768211456)
                                     (bvshl #x00000000000000000000000000000001 
                                     (of_int1
                                       (+ shift3 scale2)))
                                     #x00000000000000000000000000000000))))
...
;; H
(assert (< 0 (big_2xx (+ shift3 scale2))))
...
(assert
  (not
  (= (* (big_2xx shift3) (big_2xx scale2)) (big_2xx (+ shift3 scale2)))))
