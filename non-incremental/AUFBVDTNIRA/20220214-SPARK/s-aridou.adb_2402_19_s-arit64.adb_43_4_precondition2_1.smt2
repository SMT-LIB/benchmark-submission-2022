...
;; LoopInvariant
(assert (= mask2 (bvshl #xFFFFFFFF (of_int (- 32 shift2)))))
...
;; Ensures
(assert (in_range2 (- 32 shift_prev)))

;; Ensures
(assert
  (= (bvshl (bvshl #xFFFFFFFF (of_int (- 32 shift_prev))) (of_int shift3)) (bvshl #xFFFFFFFF 
  (of_int
    (+ (- 32 shift_prev) shift3)))))

;; H
(assert (= mask_prev (bvshl #xFFFFFFFF (of_int (- 32 (* 2 shift3))))))

;; H
(assert (= mask3 (bvshl #xFFFFFFFF (of_int (- 32 shift3)))))
...
;; H
(assert (= (big1 zu_prev) (bv2nat64 zu_prev)))
...
(assert
  (= (big_2xx shift3) (big1
                        (ite (< shift3 18446744073709551616)
                          (bvshl #x0000000000000001 (of_int1 shift3))
                          #x0000000000000000))))
    ...
    (and
      ...
      (and
        (big_2xx__function_guard
          ...
          (+ shift3 scale2))
        (= (* (big_2xx shift3) (big_2xx scale2)) (ite (= (+ shift3 scale2) 64)
                                                   big_2xxdouble
                                                   (big_2xx
                                                     (+ shift3 scale2))))))))
...
(assert
  (= (big_2xx (+ shift3 scale2)) (big1
                                   (ite (< (+ shift3 scale2) 18446744073709551616)
                                     (bvshl #x0000000000000001 (of_int1
                                                                 (+ shift3 
                                                                 scale2)))
                                     #x0000000000000000))))
