...
;; H
(assert
  (= spark__branch12 (ite (bvugt (to_rep1 (rec__value (select d16 j1))) 
                       zhi1)
                       true
                       false)))
...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select d16 j1))) zhi1) true false))

(declare-const spark__branch13 Bool)

;; H
(assert
  (= spark__branch13 (ite (= (to_rep1 (rec__value (select d16 j1))) zhi1)
                       true
                       false)))
...
(declare-const o55 uns64)

;; Ensures
(assert (= (to_rep1 o55) #xFFFFFFFFFFFFFFFF))

(declare-const qd4 (Array Int uns64__init_wrapper))

;; H
(assert (= qd4 (store qd3 j1 (uns64__init_wrapperqtmk o55 true))))
...
(assert
  (= (big1
       (oconcat
         (to_rep1 (rec__value (select d16 j1)))
         (to_rep1 (rec__value (select d16 (+ j1 1)))))) (bv2nat128 (oconcat
                                                                    (to_rep1
                                                                    (rec__value
                                                                    (select 
                                                                    d16 
...
(assert
  (< (big3
       (to_rep1 (rec__value (select d16 j1)))
       (to_rep1 (rec__value (select d16 (+ j1 1))))
       (to_rep1 (rec__value (select d16 (+ j1 2))))) (* (big1 zu1) big_2xxsingle)))
