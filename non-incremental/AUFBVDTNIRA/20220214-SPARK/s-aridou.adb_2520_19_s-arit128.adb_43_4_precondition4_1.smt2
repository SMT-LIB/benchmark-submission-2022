...
;; H
(assert
  (= spark__branch7 (ite (bvugt (to_rep1 (rec__value (select d13 j))) 
                      zhi1)
                      true
                      false)))
...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select d13 j))) zhi1) true false))

(declare-const spark__branch8 Bool)

;; H
(assert
  (= spark__branch8 (ite (= (to_rep1 (rec__value (select d13 j))) zhi1)
                      true
                      false)))
...
;; Ensures
(assert (= (to_rep1 o23) #xFFFFFFFFFFFFFFFF))

(declare-const qd2 (Array Int uns64__init_wrapper))

;; H
(assert (= qd2 (store qd j (uns64__init_wrapperqtmk o23 true))))
...
(assert
  (= (big1
       (oconcat
         (to_rep1 (rec__value (select d13 j)))
         (to_rep1 (rec__value (select d13 (+ j 1)))))) (bv2nat128 (oconcat
                                                                    (to_rep1
                                                                    (rec__value
                                                                    (select 
                                                                    d13 
...
(assert
  (< (big3
       (to_rep1 (rec__value (select d13 j)))
       (to_rep1 (rec__value (select d13 (+ j 1))))
       (to_rep1 (rec__value (select d13 (+ j 2))))) (* (big1 zu1) big_2xxsingle)))
