...
(assert
  (= (odivide
       ...
       zhi1) (bvudiv (oconcat
                       (to_rep1 (rec__value (select d16 j1)))
                       (to_rep1 (rec__value (select d16 (+ j1 1))))) ((_ zero_extend 64) 
  zhi1))))
  ...
  (= (lo
       (odivide
         (oconcat
           (to_rep1 (rec__value (select d16 j1)))
           (to_rep1 (rec__value (select d16 (+ j1 1)))))
         zhi1)) ((_ extract 63 0) (bvand (odivide
                                           (oconcat
                                             (to_rep1
                                             ...
                                             (to_rep1
                                               (rec__value
                                                 (select d16 (+ j1 1)))))
                                           zhi1) #x0000000000000000FFFFFFFFFFFFFFFF))))
...
(assert
  ...
  (forall ((temp___420 Int))
    (=>
      (and (<= 1 temp___420) (<= temp___420 4))
      (= (us_attr__init (select d16 temp___420)) true)))))
