...
(assert
  (= (odivide
       ...
       zhi1) (bvudiv (oconcat
                       (to_rep1 (rec__value (select d16 j1)))
                       (to_rep1 (rec__value (select d16 (+ j1 1))))) ((_ zero_extend 32) 
  zhi1))))
  ...
  (= (lo
       (odivide
         (oconcat
           (to_rep1 (rec__value (select d16 j1)))
           (to_rep1 (rec__value (select d16 (+ j1 1)))))
         zhi1)) ((_ extract 31 0) (bvand (odivide
                                           (oconcat
                                             (to_rep1
                                             ...
                                             (to_rep1
                                               (rec__value
                                                 (select d16 (+ j1 1)))))
                                           zhi1) #x00000000FFFFFFFF))))

(declare-const o55 uns32)
...
;; H
(assert (= qd4 (store qd3 j1 (uns32__init_wrapperqtmk o55 true))))
