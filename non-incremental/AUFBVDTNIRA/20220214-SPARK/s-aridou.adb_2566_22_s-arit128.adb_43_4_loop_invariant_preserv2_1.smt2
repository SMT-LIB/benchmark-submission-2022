                     ...
                     (and
                       (forall ((temp___861 Int))
                         (=>
                           ...
                           (=>
                             (not (= j temp___861))
                             (= (select qd3 temp___861) (select qd2 temp___861)))))
...
(declare-const o26 uns64)

;; Ensures
(assert
  (= (to_rep1 o26) (bvsub (to_rep1 (rec__value (select qd3 j))) #x0000000000000001)))

(declare-const qd4 (Array Int uns64__init_wrapper))

;; H
(assert (= qd4 (store qd3 j (uns64__init_wrapperqtmk o26 true))))
...
;; LoopInvariant
(assert (= (us_attr__init (select qd4 j)) true))
