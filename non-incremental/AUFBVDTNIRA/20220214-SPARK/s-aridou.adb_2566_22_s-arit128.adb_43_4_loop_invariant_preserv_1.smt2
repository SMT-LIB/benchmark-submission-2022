                     ...
                     (and
                       (forall ((temp___861 Int))
                         (=>
                           ...
                           (=>
                             (not (= j1 temp___861))
                             (= (select qd5 temp___861) (select qd4 temp___861)))))
...
(declare-const o38 uns64)

;; Ensures
(assert
  (= (to_rep1 o38) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x0000000000000001)))

(declare-const qd6 (Array Int uns64__init_wrapper))

;; H
(assert (= qd6 (store qd5 j1 (uns64__init_wrapperqtmk o38 true))))
...
;; LoopInvariant
(assert (= (us_attr__init (select qd6 j1)) true))
