...
;; H
(assert
  (= (big3 s13 s23 s33) (- (big3 s12 s22 s32) (big3 #x00000000 zhi1 zlo1))))
...
;; H
(assert (= prev1 (bvsub (to_rep1 (rec__value (select qd3 j))) #x00000001)))
...
(declare-const o26 uns32)

;; Ensures
(assert
  (= (to_rep1 o26) (bvsub (to_rep1 (rec__value (select qd3 j))) #x00000001)))

(declare-const qd4 (Array Int uns32__init_wrapper))

;; H
(assert (= qd4 (store qd3 j (uns32__init_wrapperqtmk o26 true))))
