...
(declare-const o24 uns32)

(declare-const o25 uns32)

;; H
(assert
  (ite (= spark__branch7 true)
    (and
      (= (to_rep1 o25) #xFFFFFFFF)
      (= qd2 (store qd j (uns32__init_wrapperqtmk o25 true))))
                  ...
                  (and
                    (and
                      ...
                      (and
                        ...
                        (= o26 (bvor (bvshl ((_ zero_extend 32) o23) ((_ int2bv 64) 32)) ((_ zero_extend 32) 
                        o22)))))
                    (let ((o27 (odivide o26 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o27 true false true true)
                          (= o27 (bvudiv o26 ((_ zero_extend 32) zhi1))))
                        (let ((o28 (lo o27)))
                          (and
                            (and
                              (dynamic_invariant3 o28 true false true true)
                              (= o28 ((_ extract 31 0) (bvand o27 #x00000000FFFFFFFF))))
                            (and
                              (= (to_rep1 o24) o28)
...
;; H
(assert (= d14 (store d13 j (uns32__init_wrapperqtmk o29 true))))
...
;; H
(assert (= d15 (store d14 (+ j 1) (uns32__init_wrapperqtmk o30 true))))
...
;; H
(assert (= d16 (store d15 (+ j 2) (uns32__init_wrapperqtmk o31 true))))
...
(declare-const o37 uns32)

;; H
(assert
  (ite (= spark__branch10 true)
    (and
      (= (to_rep1 o37) #xFFFFFFFF)
      (= qd4 (store qd3 j1 (uns32__init_wrapperqtmk o37 true))))
                  ...
                  (and
                    (and
                      ...
                      (and
                        ...
                        (= o38 (bvor (bvshl ((_ zero_extend 32) o35) ((_ int2bv 64) 32)) ((_ zero_extend 32) 
                        o34)))))
                    (let ((o39 (odivide o38 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o39 true false true true)
                          (= o39 (bvudiv o38 ((_ zero_extend 32) zhi1))))
                        (let ((o40 (lo o39)))
                          (and
                            (and
                              (dynamic_invariant3 o40 true false true true)
                              (= o40 ((_ extract 31 0) (bvand o39 #x00000000FFFFFFFF))))
                            (and
                              (= (to_rep1 o36) o40)
...
(declare-const s15 (_ BitVec 32))

(declare-const s25 (_ BitVec 32))

(declare-const s35 (_ BitVec 32))

;; H
(assert
  (= (big3 s15 s25 s35) (- (big3 s14 s24 s34) (big3 #x00000000 zhi1 zlo1))))
...
;; H
(assert (= prev2 (bvsub (to_rep1 (rec__value (select qd5 j1))) #x00000001)))
...
(declare-const o38 uns32)

;; Ensures
(assert
  (= (to_rep1 o38) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x00000001)))

(declare-const qd6 (Array Int uns32__init_wrapper))

;; H
(assert (= qd6 (store qd5 j1 (uns32__init_wrapperqtmk o38 true))))
