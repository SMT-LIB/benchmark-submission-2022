...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select qd5 j1))) #x00000000) true false))

(declare-const spark__branch14 Bool)

;; H
(assert
  (= spark__branch14 (ite (= (to_rep1 (rec__value (select qd5 j1))) #x00000000)
                       true
                       false)))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd5 j1))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep1
...
;; Ensures
(assert
  (= (- (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd5 j1))))) 
  (big1
    #x0000000000000001)) (big1
                           (bvsub ((_ zero_extend 32) (to_rep1
                                                        (rec__value
                                                          (select qd5 
                                                          j1)))) #x0000000000000001))))
...
(assert
  (= (big1
       ((_ zero_extend 32) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x00000001))) (bv2nat64 ((_ zero_extend 32) (bvsub 
  (to_rep1
    (rec__value (select qd5 j1))) #x00000001)))))
...
(assert
  (= (big3 s15 s25 s35) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 32) 
                                                                   s15))) (* 
  big_2xxsingle (big1 ((_ zero_extend 32) s25)))) (big1
                                                    ((_ zero_extend 32) 
                                                    s35)))))
...
(assert
  (not
  (= (- (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd5 j1))))) 1) 
  (big1
    ((_ zero_extend 32) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x00000001))))))
