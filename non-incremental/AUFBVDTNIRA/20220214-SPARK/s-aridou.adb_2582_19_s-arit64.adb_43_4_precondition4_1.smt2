...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select qd3 j))) #x00000000) true false))

(declare-const spark__branch9 Bool)

;; H
(assert
  (= spark__branch9 (ite (= (to_rep1 (rec__value (select qd3 j))) #x00000000)
                      true
                      false)))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd3 j))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep1
...
;; Ensures
(assert
  (= (- (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd3 j))))) 
  (big1
...
(assert
  (= (big1
       ((_ zero_extend 32) (bvsub (to_rep1 (rec__value (select qd3 j))) #x00000001))) (bv2nat64 ((_ zero_extend 32) (bvsub 
  (to_rep1
    (rec__value (select qd3 j))) #x00000001)))))
...
(assert
  (= (big3 s13 s23 s33) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 32) 
                                                                   s13))) (* 
  big_2xxsingle (big1 ((_ zero_extend 32) s23)))) (big1
                                                    ((_ zero_extend 32) 
                                                    s33)))))
...
(assert
  (not
  (= (- (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select qd3 j))))) 1) 
  (big1
    ((_ zero_extend 32) (bvsub (to_rep1 (rec__value (select qd3 j))) #x00000001))))))
