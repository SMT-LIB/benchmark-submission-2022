...
(assert
  (=
    (= (le3
         ...
         (to_rep1 (rec__value (select d13 j)))
         (to_rep1 (rec__value (select d13 (+ j 1))))
         (to_rep1 (rec__value (select d13 (+ j 2))))) true)
    (<= (big3 s11 s21 s31) (big3
                             (to_rep1 (rec__value (select d13 j)))
                             (to_rep1 (rec__value (select d13 (+ j 1))))
                             (to_rep1 (rec__value (select d13 (+ j 2))))))))
...
;; LoopInvariant
(assert (= (us_attr__init (select qd3 j)) true))
                     ...
                     (and
                       (forall ((temp___1425 Int))
                         (=>
                           ...
                           (=>
                             (not (= j temp___1425))
                             (= (select qd3 temp___1425) (select qd2 temp___1425)))))
                       (dynamic_invariant3 s12 false true true true))
                     (dynamic_invariant3 s22 false true true true))
                   (dynamic_invariant3 s32 false true true true))
              true
              false) (ite (not
                            (= (le3
                                 s12
...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select qd3 j))) #x0000000000000000)
    true
    false))
...
;; H
(assert
  (= spark__branch9 (ite (= (to_rep1 (rec__value (select qd3 j))) #x0000000000000000)
                      true
                      false)))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd3 j))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd3 j)))))))
...
;; H
(assert
  (= (big3 s13 s23 s33) (- (big3 s12 s22 s32) (big3
                                                #x0000000000000000
                                                zhi1
                                                zlo1))))

;; H
(assert (dynamic_invariant3 s13 true true true true))

;; H
(assert (dynamic_invariant3 s23 true true true true))

;; H
(assert (dynamic_invariant3 s33 true true true true))
...
;; Ensures
(assert
  (= (- (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd3 j))))) 
  (big1
    #x00000000000000000000000000000001)) (big1
                                           (bvsub ((_ zero_extend 64) 
                                           (to_rep1
                                             (rec__value (select qd3 j)))) #x00000000000000000000000000000001))))
...
(assert
  (= (big1
       ((_ zero_extend 64) (bvsub (to_rep1 (rec__value (select qd3 j))) #x0000000000000001))) (bv2nat128 ((_ zero_extend 64) (bvsub 
  (to_rep1
    (rec__value (select qd3 j))) #x0000000000000001)))))
...
;; H
(assert
  (= (big3 s13 s23 s33) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 64) 
                                                                   s13))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) s23)))) (big1
                                                    ((_ zero_extend 64) 
                                                    s33)))))

;; Ensures
(assert
  (= (big3 s13 s23 s33) (+ (* (big1 zu1) (big1
                                           ((_ zero_extend 64) (bvsub 
                                           (to_rep1
                                             (rec__value (select qd3 j))) #x0000000000000001)))) 0)))
...
;; H
(assert
  (= prev1 (bvsub (to_rep1 (rec__value (select qd3 j))) #x0000000000000001)))

;; Assume
(assert (dynamic_invariant3 prev1 true false true true))
...
;; Ensures
(assert
  (= (to_rep1 o37) (bvsub (to_rep1 (rec__value (select qd3 j))) #x0000000000000001)))

(declare-const qd4 (Array Int uns64__init_wrapper))

;; H
(assert (= qd4 (store qd3 j (uns64__init_wrapperqtmk o37 true))))

;; Assert
(assert (= (to_rep1 (rec__value (select qd4 j))) prev1))
