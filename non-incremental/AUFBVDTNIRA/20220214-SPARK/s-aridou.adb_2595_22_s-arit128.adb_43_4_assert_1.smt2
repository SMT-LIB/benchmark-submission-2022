...
(declare-const qd1 (_ BitVec 64))

;; H
(assert (= qd1 #x0000000000000000))
...
(assert
  (= (oconcat
       (to_rep1 (rec__value (select d13 j)))
       (to_rep1 (rec__value (select d13 (+ j 1))))) (bvor (bvshl ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d13 j)))) (of_int1 64)) ((_ zero_extend 64) (to_rep1
                                                                    (rec__value
                                                                    (select 
                                                                    d13 (+ 
                                                                    j 1))))))))
...
(assert
  ...
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d13 j)))))) (big1
                                                                   ((_ zero_extend 64) 
                                                                   (to_rep1
                                                                    (rec__value
                                                                    (select 
...
(declare-const o27 uns64)

(declare-const o28 uns64)
...
(assert
  (ite (= spark__branch7 true)
    (and
      (= (to_rep1 o28) #xFFFFFFFFFFFFFFFF)
      (and
        (= qd2 (store qd j (uns64__init_wrapperqtmk o28 true)))
                        ...
                        (and
                          ...
                          (let ((o37 (big3 o31 o30 o29)))
                            (and
                              ...
                              (big1
                                ((_ zero_extend 64) o31))) (* big_2xxsingle 
                              (big1
                                ((_ zero_extend 64) o30)))) (big1
                                                              ((_ zero_extend 64) 
                                                              o29))))
                                              ...
                                              (and
                                                ...
                                                (and
                                                  (dynamic_invariant2
                                                    ...
                                                    true
                                                    true)
                                                  (= o38 (bvor (bvshl ((_ zero_extend 64) 
                                                  o33) (of_int1 64)) ((_ zero_extend 64) 
                                                  o32)))))
                                              (and
                                                (= (big1 o38) (bv2nat128 o38))
                                                (let ((o39 (big1 zu1)))
                                                  (and
                                                    (= o39 (bv2nat128 
                                                    zu1))
                  ...
                  (and
                    (and
                      ...
                      (and
                        ...
                        (= o37 (bvor (bvshl ((_ zero_extend 64) o26) 
                        (of_int1
                          64)) ((_ zero_extend 64) o25)))))
                    (let ((o38 (odivide o37 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o38 true false true true)
                          (= o38 (bvudiv o37 ((_ zero_extend 64) zhi1))))
                        (let ((o39 (lo o38)))
                          (and
                            (and
                              (dynamic_invariant3 o39 true false true true)
                              (= o39 ((_ extract 63 0) (bvand o38 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o27) o39)
                              (and
...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d13 j)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1
                                        (rec__value (select d13 (+ j 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d13 (+ j 2)))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd2 j))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
...
(assert
  ...
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select qd2 j))))) (big1 zu1))))
...
;; H
(assert
  (= (omultiply (to_rep1 (rec__value (select qd2 j))) zlo1) (bvmul ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd2 j)))) ((_ zero_extend 64) zlo1))))
...
;; H
(assert
  (= (omultiply (to_rep1 (rec__value (select qd2 j))) zhi1) (bvmul ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd2 j)))) ((_ zero_extend 64) zhi1))))
...
;; H
(assert
  (= (oadd (hi t16) (lo t25)) (bvadd ((_ zero_extend 64) (hi t16)) ((_ zero_extend 64) 
  (lo
    t25)))))
            ...
            (and
              ...
              (let ((temp___1365 (select qd4 j)))
                (and
                  ...
                  (exists ((o40 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___1365)) o40)
                      (and
                        (= spark__branch9 (ite (= o40 #x0000000000000000)
                                            true
                                            false))
                        (and
                                          ...
                                          (and
                                            ...
                                            (let ((temp___1369 (select qd4 
                                              ...
                                              (and
                                                (= (us_attr__init
                                                     temp___1369) true)
                                                (exists ((o44 (_ BitVec 64)))
                                                  (and
                                                    (= (to_rep1
                                                         (rec__value
                                                           temp___1369)) o44)
                                                    (let ((o45 ((_ zero_extend 64) o44)))
                                                      (let ((o46 (big1 o45)))
                                                        (and
                                                          (= o46 (bv2nat128 o45))
                                                          (and
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___1389 (select qd4 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    #x00000000000000000000000000000001)) 
                                                                    (big1
                                                                    (bvsub o48 #x00000000000000000000000000000001)))
                                                                    ...
                                                                    (rec__value
                                                                    temp___1400)) o49)
                                                                    (let ((o50 ((_ zero_extend 64) (bvsub o49 #x0000000000000001))))
                                                                    (let ((o51 
                                                                    (big1
                                                                    o50)))
                                                                    (and
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    prev1 (bvsub o56 #x0000000000000001))
                                                                    (and
                                                                    (dynamic_invariant3
                                                                    prev1
                                                                    true
                                                                    ...
                                                                    (= 
                                                                    (to_rep1
                                                                    o58) (bvsub o57 #x0000000000000001))
                                                                    (and
                                                                    (= 
                                                                    qd3 (store qd4 
...
;; H
(assert (= d14 (store d13 j (uns64__init_wrapperqtmk o40 true))))
...
;; H
(assert (= d15 (store d14 (+ j 1) (uns64__init_wrapperqtmk o41 true))))
...
;; H
(assert (= d16 (store d15 (+ j 2) (uns64__init_wrapperqtmk o42 true))))
...
;; H
(assert
  (= spark__branch10 (ite (bvugt (to_rep1 (rec__value (select d16 j))) #x0000000000000000)
                       true
                       false)))
                  ...
                  zu1))) (* big_2xxsingle (big1
                                            ((_ zero_extend 64) (to_rep1
                                                                  (rec__value
                                                                    ...
                                                                    d16 3))))))) 
                (big1
                  ((_ zero_extend 64) (to_rep1 (rec__value (select d16 4))))))))))
          (= qd11 qd1))))))
...
(assert
  (= (oconcat
       (to_rep1 (rec__value (select d16 j1)))
       (to_rep1 (rec__value (select d16 (+ j1 1))))) (bvor (bvshl ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d16 j1)))) (of_int1 64)) ((_ zero_extend 64) 
  (to_rep1
...
(assert
  ...
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 j1)))))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    (to_rep1
                                                                    (rec__value
                                                                    (select 
...
(assert
  (ite (= spark__branch12 true)
    (and
      (= (to_rep1 o60) #xFFFFFFFFFFFFFFFF)
      (and
        (= qd4 (store qd3 j1 (uns64__init_wrapperqtmk o60 true)))
                        ...
                        (and
                          ...
                          (let ((o69 (big3 o63 o62 o61)))
                            (and
                              ...
                              (big1
                                ((_ zero_extend 64) o63))) (* big_2xxsingle 
                              (big1
                                ((_ zero_extend 64) o62)))) (big1
                                                              ((_ zero_extend 64) 
                                                              o61))))
                                            ...
                                            (and
                                              (and
                                                ...
                                                (and
                                                  ...
                                                  o65) (of_int1 64)) ((_ zero_extend 64) 
                                                  o64)))))
                                              (and
                                                (= (big1 o70) (bv2nat128 o70))
                                                (let ((o71 (big1 zu1)))
                                                  (and
                                                    (= o71 (bv2nat128 
                                                    zu1))
                  ...
                  (and
                    (and
                      ...
                      (and
                        ...
                        (= o69 (bvor (bvshl ((_ zero_extend 64) o58) 
                        (of_int1
                          64)) ((_ zero_extend 64) o57)))))
                    (let ((o70 (odivide o69 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o70 true false true true)
                          (= o70 (bvudiv o69 ((_ zero_extend 64) zhi1))))
                        (let ((o71 (lo o70)))
                          (and
                            (and
                              (dynamic_invariant3 o71 true false true true)
                              (= o71 ((_ extract 63 0) (bvand o70 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o59) o71)
                              (and
...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d16 j1)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1
                                        (rec__value (select d16 (+ j1 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 (+ j1 2)))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd4 j1))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
...
(assert
  ...
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select qd4 j1))))) (big1 zu1))))
...
;; H
(assert
  (= (omultiply (to_rep1 (rec__value (select qd4 j1))) zlo1) (bvmul ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd4 j1)))) ((_ zero_extend 64) zlo1))))
...
;; H
(assert
  (= (omultiply (to_rep1 (rec__value (select qd4 j1))) zhi1) (bvmul ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd4 j1)))) ((_ zero_extend 64) zhi1))))
...
;; H
(assert
  (= (oadd (hi t17) (lo t26)) (bvadd ((_ zero_extend 64) (hi t17)) ((_ zero_extend 64) 
  (lo
    t26)))))
...
(assert
  (=
    (= (le3
         ...
         (to_rep1 (rec__value (select d16 j1)))
         (to_rep1 (rec__value (select d16 (+ j1 1))))
         (to_rep1 (rec__value (select d16 (+ j1 2))))) true)
    (<= (big3 s13 s23 s33) (big3
                             (to_rep1 (rec__value (select d16 j1)))
                             (to_rep1 (rec__value (select d16 (+ j1 1))))
                             (to_rep1 (rec__value (select d16 (+ j1 2))))))))
...
(declare-const qd5 (Array Int uns64__init_wrapper))
...
;; LoopInvariant
(assert (= (us_attr__init (select qd5 j1)) true))
    ...
    (= (and (ite (and
                   (and
                     (and
                       (forall ((temp___1425 Int))
                         (=>
                           (and (<= 1 temp___1425) (<= temp___1425 2))
                           (=>
                             (not (= j1 temp___1425))
                             (= (select qd5 temp___1425) (select qd4 temp___1425)))))
                       (dynamic_invariant3 s14 false true true true))
                     (dynamic_invariant3 s24 false true true true))
                   (dynamic_invariant3 s34 false true true true))
              true
              false) (ite (not
                            (= (le3
                                 s14
...
(define-fun eqqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (rec__value (select qd5 j1))) #x0000000000000000)
    true
    false))
...
;; H
(assert
  (= spark__branch14 (ite (= (to_rep1 (rec__value (select qd5 j1))) #x0000000000000000)
                       true
                       false)))
...
;; Ensures
(assert
  (<= (big1 #x00000000000000000000000000000001) (big1
                                                  ((_ zero_extend 64) 
                                                  (to_rep1
                                                    (rec__value
                                                      (select qd5 j1)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd5 j1))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd5 j1)))))))
...
(declare-const s25 (_ BitVec 64))

(declare-const s35 (_ BitVec 64))

;; H
(assert
  (= (big3 s15 s25 s35) (- (big3 s14 s24 s34) (big3
                                                #x0000000000000000
                                                zhi1
                                                zlo1))))

;; H
(assert (dynamic_invariant3 s15 true true true true))

;; H
(assert (dynamic_invariant3 s25 true true true true))

;; H
(assert (dynamic_invariant3 s35 true true true true))
...
;; Ensures
(assert
  (= (- (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd5 j1))))) 
  (big1
    #x00000000000000000000000000000001)) (big1
                                           (bvsub ((_ zero_extend 64) 
                                           (to_rep1
                                             (rec__value (select qd5 j1)))) #x00000000000000000000000000000001))))
...
(assert
  (= (big1
       ((_ zero_extend 64) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x0000000000000001))) (bv2nat128 ((_ zero_extend 64) (bvsub 
  (to_rep1
    (rec__value (select qd5 j1))) #x0000000000000001)))))
...
;; H
(assert
  (= (big3 s15 s25 s35) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 64) 
                                                                   s15))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) s25)))) (big1
                                                    ((_ zero_extend 64) 
                                                    s35)))))

;; Ensures
(assert
  (= (big3 s15 s25 s35) (+ (* (big1 zu1) (big1
                                           ((_ zero_extend 64) (bvsub 
                                           (to_rep1
                                             (rec__value (select qd5 j1))) #x0000000000000001)))) 0)))
...
(declare-const prev2 (_ BitVec 64))

;; H
(assert
  (= prev2 (bvsub (to_rep1 (rec__value (select qd5 j1))) #x0000000000000001)))

;; Assume
(assert (dynamic_invariant3 prev2 true false true true))

;; Assert
(assert (= (us_attr__init (select qd5 j1)) true))

(declare-const o69 uns64)

;; Ensures
(assert
  (= (to_rep1 o69) (bvsub (to_rep1 (rec__value (select qd5 j1))) #x0000000000000001)))

(declare-const qd6 (Array Int uns64__init_wrapper))

;; H
(assert (= qd6 (store qd5 j1 (uns64__init_wrapperqtmk o69 true))))

;; Assert
(assert (= (to_rep1 (rec__value (select qd6 j1))) prev2))
