...
;; H
(assert (= (to_rep1 (rec__value (select d13 j))) o20))

(declare-const spark__branch8 Bool)

;; H
(assert (= spark__branch8 (ite (bvugt o20 zhi1) true false)))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 j))) o21))

;; H
(assert (= spark__branch7 (ite (= o21 zhi1) true false)))
...
(assert
  (ite (= spark__branch7 true)
    (and
      (= (to_rep1 o25) #xFFFFFFFFFFFFFFFF)
      (= qd2 (store qd j (uns64__init_wrapperqtmk o25 true))))
    (let ((temp___831 (select d13 (+ j 1))))
      (and
        (= (us_attr__init temp___831) true)
        (and
          (= (to_rep1 (rec__value temp___831)) o22)
          (let ((temp___829 (select d13 j)))
            (and
              (= (us_attr__init temp___829) true)
              (and
                (= (to_rep1 (rec__value temp___829)) o23)
                (let ((o26 (oconcat o23 o22)))
                  (and
                    (and
                      (oconcat__function_guard o26 o23 o22)
                      (and
                        (dynamic_invariant2 o26 true false true true)
                        (= o26 (bvor (bvshl ((_ zero_extend 64) o23) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
                        o22)))))
                    (let ((o27 (odivide o26 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o27 true false true true)
                          (= o27 (bvudiv o26 ((_ zero_extend 64) zhi1))))
                        (let ((o28 (lo o27)))
                          (and
                            (and
                              (dynamic_invariant3 o28 true false true true)
                              (= o28 ((_ extract 63 0) (bvand o27 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o24) o28)
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 2)))) o26))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 1)))) o27))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 j))) o28))

;; H
(assert
  (le3__function_guard (le3 s11 s21 s31 o28 o27 o26) s11 s21 s31 o28 o27 o26))

;; H
(assert
  (=
    (= (le3 s11 s21 s31 o28 o27 o26) true)
    (<= (big3 s11 s21 s31) (big3 o28 o27 o26))))
  ...
  (and
    (forall ((s13 (_ BitVec 64)) (s23 (_ BitVec 64)) (s33 (_ BitVec 64)))
      (le3__function_guard
        ...
        (to_rep1 (rec__value (select d13 (+ j 1))))
        (to_rep1 (rec__value (select d13 (+ j 2))))))
    (ite (not (= (le3 s11 s21 s31 o28 o27 o26) true))
            ...
            (and
              ...
              (let ((temp___851 (select qd4 j)))
                (and
                  ...
                  (exists ((o29 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___851)) o29)
                      (and
                        (= prev1 (bvsub o29 #x0000000000000001))
                        (and
                          (dynamic_invariant3 prev1 true false true true)
                          (let ((temp___854 (select qd4 j)))
                            (and
                              (= (us_attr__init temp___854) true)
                              (exists ((o30 (_ BitVec 64)))
                                (and
                                  (= (to_rep1 (rec__value temp___854)) o30)
                                  (exists ((o31 uns64))
                                    (and
                                      (= (to_rep1 o31) (bvsub o30 #x0000000000000001))
                                      (and
                                        ...
                                        (let ((temp___878 (select d13 (+ 
                                          ...
                                          (and
                                            ...
                                            (exists ((o32 (_ BitVec 64)))
                                              (and
                                                (= (to_rep1
                                                     (rec__value temp___878)) o32)
                                                (let ((temp___876 (select 
                                                  d13 (+ j 1))))
                                                  (and
                                                    (= (us_attr__init
                                                         temp___876) true)
                                                    (exists ((o33 (_ BitVec 64)))
                                                      (and
                                                        (= (to_rep1
                                                             (rec__value
                                                               temp___876)) o33)
...
;; Ensures
(assert (= (to_rep1 o29) x1))

(declare-const d14 (Array Int uns64__init_wrapper))

;; H
(assert (= d14 (store d13 j (uns64__init_wrapperqtmk o29 true))))

(declare-const o30 uns64)

;; Ensures
(assert (= (to_rep1 o30) x2))

(declare-const d15 (Array Int uns64__init_wrapper))

;; H
(assert (= d15 (store d14 (+ j 1) (uns64__init_wrapperqtmk o30 true))))

(declare-const o31 uns64)

;; Ensures
(assert (= (to_rep1 o31) x3))

(declare-const d16 (Array Int uns64__init_wrapper))

;; H
(assert (= d16 (store d15 (+ j 2) (uns64__init_wrapperqtmk o31 true))))

(declare-const spark__branch9 Bool)

;; H
(assert (= spark__branch9 (ite (= j 1) true false)))
  ...
  (or
    ...
    (let ((temp___891 (select qd3 1)))
      (and
        ...
        (exists ((o32 (_ BitVec 64)))
          (= (to_rep1 (rec__value temp___891)) o32))))))
...
;; H
(assert (= (to_rep1 (rec__value (select d16 j1))) o32))

(declare-const spark__branch11 Bool)

;; H
(assert (= spark__branch11 (ite (bvugt o32 zhi1) true false)))
...
;; H
(assert (= (to_rep1 (rec__value (select d16 j1))) o33))

;; H
(assert (= spark__branch10 (ite (= o33 zhi1) true false)))
...
(assert
  (ite (= spark__branch10 true)
    (and
      (= (to_rep1 o37) #xFFFFFFFFFFFFFFFF)
      (= qd4 (store qd3 j1 (uns64__init_wrapperqtmk o37 true))))
    (let ((temp___831 (select d16 (+ j1 1))))
      (and
        (= (us_attr__init temp___831) true)
        (and
          (= (to_rep1 (rec__value temp___831)) o34)
          (let ((temp___829 (select d16 j1)))
            (and
              (= (us_attr__init temp___829) true)
              (and
                (= (to_rep1 (rec__value temp___829)) o35)
                (let ((o38 (oconcat o35 o34)))
                  (and
                    (and
                      (oconcat__function_guard o38 o35 o34)
                      (and
                        (dynamic_invariant2 o38 true false true true)
                        (= o38 (bvor (bvshl ((_ zero_extend 64) o35) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
                        o34)))))
                    (let ((o39 (odivide o38 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o39 true false true true)
                          (= o39 (bvudiv o38 ((_ zero_extend 64) zhi1))))
                        (let ((o40 (lo o39)))
                          (and
                            (and
                              (dynamic_invariant3 o40 true false true true)
                              (= o40 ((_ extract 63 0) (bvand o39 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o36) o40)
...
;; H
(assert (= (to_rep1 (rec__value (select d16 (+ j1 2)))) o38))
...
;; H
(assert (= (to_rep1 (rec__value (select d16 (+ j1 1)))) o39))
...
;; H
(assert (= (to_rep1 (rec__value (select d16 j1))) o40))

;; H
(assert
  (le3__function_guard (le3 s13 s23 s33 o40 o39 o38) s13 s23 s33 o40 o39 o38))

;; H
(assert
  (=
    (= (le3 s13 s23 s33 o40 o39 o38) true)
    (<= (big3 s13 s23 s33) (big3 o40 o39 o38))))
  ...
  (and
    (forall ((s15 (_ BitVec 64)) (s25 (_ BitVec 64)) (s35 (_ BitVec 64)))
      (le3__function_guard
        ...
        (to_rep1 (rec__value (select d16 (+ j1 1))))
        (to_rep1 (rec__value (select d16 (+ j1 2))))))
    (ite (not (= (le3 s13 s23 s33 o40 o39 o38) true))
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (let ((temp___851 (select qd6 j1)))
                (and
                  (= (us_attr__init temp___851) true)
                  (exists ((o41 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___851)) o41)
                      (exists ((prev2 (_ BitVec 64)))
                        (and
                          (= prev2 (bvsub o41 #x0000000000000001))
                          (and
                            (dynamic_invariant3 prev2 true false true true)
                            (let ((temp___854 (select qd6 j1)))
                              (and
                                (= (us_attr__init temp___854) true)
                                (exists ((o42 (_ BitVec 64)))
                                  (and
                                    (= (to_rep1 (rec__value temp___854)) o42)
                                    (exists ((o43 uns64))
                                      (and
                                        (= (to_rep1 o43) (bvsub o42 #x0000000000000001))
                                        (and
                                          (= qd5 (store qd6 j1 (uns64__init_wrapperqtmk
                                                                 o43
                                                                 true)))
                                          (let ((temp___878 (select d16 (+ 
                                            j1 2))))
                                            (and
                                              (= (us_attr__init temp___878) true)
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (let ((o47 
                                                                    ...
                                                                    o44))))
                                                                    (= o47 true)))))))))))))))))))))))))))))))))
      (and (and (and (= qd5 qd4) (= s14 s13)) (= s24 s23)) (= s34 s33)))))
