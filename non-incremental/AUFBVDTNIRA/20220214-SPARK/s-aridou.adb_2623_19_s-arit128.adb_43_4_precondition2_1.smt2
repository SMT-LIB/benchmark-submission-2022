...
(assert
  (= (big3
       (to_rep1 (rec__value (select d16 j)))
       (to_rep1 (rec__value (select d16 (+ j 1))))
       (to_rep1 (rec__value (select d16 (+ j 2))))) (+ (+ (* (* big_2xxsingle 
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d16 j)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1
                                        (rec__value (select d16 (+ j 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 (+ j 2)))))))))
...
(assert
  (= (big3
       (to_rep1 (rec__value (select d16 j)))
       (to_rep1 (rec__value (select d16 (+ j 1))))
       (to_rep1 (rec__value (select d16 (+ j 2))))) (+ (+ (* big_2xxdouble 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 j)))))) (* big_2xxsingle 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 (+ j 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 (+ j 2)))))))))
...
(assert
  (<= (* big_2xxdouble (big1
                         ((_ zero_extend 64) (to_rep1
                                               (rec__value (select d16 j)))))) 
  (big3
    (to_rep1 (rec__value (select d16 j)))
    (to_rep1 (rec__value (select d16 (+ j 1))))
    (to_rep1 (rec__value (select d16 (+ j 2)))))))
...
(assert
  (not
  (bvuge ((_ zero_extend 64) (to_rep1 (rec__value (select d16 j)))) #x00000000000000000000000000000001)))
