...
;; Assert
(assert (= (* big_2xxsingle big_2xxsingle) big_2xxdouble))
...
(assert
  (= (big3
       (to_rep1 (rec__value (select d19 j1)))
       (to_rep1 (rec__value (select d19 (+ j1 1))))
       (to_rep1 (rec__value (select d19 (+ j1 2))))) (+ (+ (* (* big_2xxsingle 
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d19 j1)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1
                                        (rec__value (select d19 (+ j1 1)))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d19 (+ j1 2)))))))))
...
(assert
  (= (big3
       (to_rep1 (rec__value (select d19 j1)))
       (to_rep1 (rec__value (select d19 (+ j1 1))))
       (to_rep1 (rec__value (select d19 (+ j1 2))))) (+ (+ (* big_2xxdouble 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d19 j1)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1
...
(assert
  (<= (* big_2xxdouble (big1
                         ((_ zero_extend 64) (to_rep1
                                               (rec__value (select d19 j1)))))) 
  (big3
    (to_rep1 (rec__value (select d19 j1)))
    (to_rep1 (rec__value (select d19 (+ j1 1))))
    (to_rep1 (rec__value (select d19 (+ j1 2)))))))
...
(assert
  (not
  (bvuge ((_ zero_extend 64) (to_rep1 (rec__value (select d19 j1)))) #x00000000000000000000000000000001)))
