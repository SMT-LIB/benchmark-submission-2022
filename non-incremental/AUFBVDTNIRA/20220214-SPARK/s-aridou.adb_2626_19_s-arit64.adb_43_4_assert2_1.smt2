...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 32) (to_rep1 (rec__value (select d16 j)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 32) (to_rep1
                                        (rec__value (select d16 (+ j 1)))))))) 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d16 (+ j 2)))))))))
...
(assert
  ...
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d16 j)))))) (* big_2xxsingle 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d16 (+ j 1)))))))) 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d16 (+ j 2)))))))))
