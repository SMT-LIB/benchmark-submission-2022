...
;; Assert
(assert (= (us_attr__init (select qd3 1)) true))

(declare-const qd11 (_ BitVec 64))

;; H
(assert (= qd11 (to_rep1 (rec__value (select qd3 1)))))

;; Assert
(assert (= (us_attr__init (select d16 4)) true))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d16 4))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
...
;; H
(assert
  (= (big3 s12 s22 s32) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 64) 
                                                                   s12))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) s22)))) (big1
                                                    ((_ zero_extend 64) 
                                                    s32)))))
...
;; Assert
(assert (= (us_attr__init (select d16 3)) true))

;; Assert
(assert (= (us_attr__init (select d16 2)) true))

;; Assert
(assert (= (us_attr__init (select d16 1)) true))
...
(assert
  (= (big3
       (to_rep1 (rec__value (select d16 1)))
       (to_rep1 (rec__value (select d16 2)))
       (to_rep1 (rec__value (select d16 3)))) (+ (+ (* (* big_2xxsingle 
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d16 1)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1 (rec__value (select d16 2))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d16 3))))))))
...
(assert
  ...
  (big3
    s12
    s22
    s32))) (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d16 4))))))))
...
(assert
  (= (+ (* big_2xxsingle (big3
                           (to_rep1 (rec__value (select d16 1)))
                           (to_rep1 (rec__value (select d16 2)))
                           (to_rep1 (rec__value (select d16 3))))) (big1
                                                                    ((_ zero_extend 64) 
                                                                    (to_rep1
                                                                    (rec__value
                                                                    (select 
  ...
  (big3
    (to_rep1 (rec__value (select d16 2)))
    (to_rep1 (rec__value (select d16 3)))
    (to_rep1 (rec__value (select d16 4))))))
...
(assert
  (= (big3
       (to_rep1 (rec__value (select d16 2)))
       (to_rep1 (rec__value (select d16 3)))
       (to_rep1 (rec__value (select d16 4)))) (+ (+ (* (* big_2xxsingle 
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d16 2)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1 (rec__value (select d16 3))))))) 
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) qd11)) (bv2nat128 ((_ zero_extend 64) 
  qd11))))
...
(assert
  (not
  (= (* mult (big_2xx scale2)) (+ (* big_2xxsingle (big3 s12 s22 s32)) 
  (big3
    (to_rep1 (rec__value (select d16 2)))
    (to_rep1 (rec__value (select d16 3)))
    (to_rep1 (rec__value (select d16 4))))))))
