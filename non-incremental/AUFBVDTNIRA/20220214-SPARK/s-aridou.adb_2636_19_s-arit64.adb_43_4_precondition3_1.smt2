...
;; H
(assert
  (= (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select d16 4))))) (bv2nat64 ((_ zero_extend 32) 
  (to_rep1
...
(assert
  (= (big3 s12 s22 s32) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 32) 
                                                                   s12))) (* 
  big_2xxsingle (big1 ((_ zero_extend 32) s22)))) (big1
                                                    ((_ zero_extend 32) 
                                                    s32)))))
...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 32) (to_rep1 (rec__value (select d16 1)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 32) (to_rep1 (rec__value (select d16 2))))))) 
  (big1
    ((_ zero_extend 32) (to_rep1 (rec__value (select d16 3))))))))
...
(assert
  ...
  (big3
    s12
    s22
    s32))) (big1 ((_ zero_extend 32) (to_rep1 (rec__value (select d16 4))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 32) qd11)) (bv2nat64 ((_ zero_extend 32) qd11))))
