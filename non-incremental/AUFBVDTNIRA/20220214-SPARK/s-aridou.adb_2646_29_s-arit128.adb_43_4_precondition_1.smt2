...
(assert
  ...
  big_2xxsingle) (big1
                   ((_ zero_extend 64) (to_rep1 (rec__value (select d19 2)))))) (* 
  big_2xxsingle (big1
                  ((_ zero_extend 64) (to_rep1 (rec__value (select d19 3))))))) 
  (big1
    ((_ zero_extend 64) (to_rep1 (rec__value (select d19 4))))))))
...
(assert
  (= (big3 s14 s24 s34) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 64) 
                                                                   s14))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) s24)))) (big1
                                                    ((_ zero_extend 64) 
                                                    s34)))))
