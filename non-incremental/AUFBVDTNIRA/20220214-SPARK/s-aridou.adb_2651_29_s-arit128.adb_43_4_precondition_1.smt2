...
(assert
  (and
    ...
    (ite (not (= (le3 s13 s23 s33 o71 o70 o69) true))
      (exists ((qd6 (Array Int uns64__init_wrapper)) (s15 (_ BitVec 64)) (s25 (_ BitVec 64)) (s35 (_ BitVec 64)))
        (and
          (and
          ...
          (and
            ...
            (and
              ...
              (let ((temp___1365 (select qd6 j1)))
                (and
                  (= (us_attr__init temp___1365) true)
                  (exists ((o72 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___1365)) o72)
                      (and
                        (= spark__branch14 (ite (= o72 #x0000000000000000)
                                             true
                                             false))
                        (and
                                          ...
                                          (and
                                            ...
                                            (let ((temp___1369 (select qd6 
                                              ...
                                              (and
                                                (= (us_attr__init
                                                     temp___1369) true)
                                                (exists ((o76 (_ BitVec 64)))
                                                  (and
                                                    (= (to_rep1
                                                         (rec__value
                                                           temp___1369)) o76)
                                                    (let ((o77 ((_ zero_extend 64) o76)))
                                                      (let ((o78 (big1 o77)))
                                                        (and
                                                          (= o78 (bv2nat128 o77))
                                                          (and
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___1389 (select qd6 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    #x00000000000000000000000000000001)) 
                                                                    (big1
                                                                    (bvsub o80 #x00000000000000000000000000000001)))
                                                                    ...
                                                                    (rec__value
                                                                    temp___1400)) o81)
                                                                    (let ((o82 ((_ zero_extend 64) (bvsub o81 #x0000000000000001))))
                                                                    (let ((o83 
                                                                    (big1
                                                                    o82)))
                                                                    (and
                                                                    ...
                                                                    ((prev2 (_ BitVec 64)))
                                                                    (and
                                                                    (= prev2 (bvsub o88 #x0000000000000001))
                                                                    (and
                                                                    (dynamic_invariant3
                                                                    prev2
                                                                    true
                                                                    ...
                                                                    (= 
                                                                    (to_rep1
                                                                    o90) (bvsub o89 #x0000000000000001))
                                                                    (and
                                                                    (= 
                                                                    qd5 (store qd6 
                                                                    j1 
...
;; H
(assert (= d17 (store d16 j1 (uns64__init_wrapperqtmk o72 true))))

(declare-const o73 uns64)
...
;; H
(assert (= d18 (store d17 (+ j1 1) (uns64__init_wrapperqtmk o73 true))))

(declare-const o74 uns64)
...
;; H
(assert (= d19 (store d18 (+ j1 2) (uns64__init_wrapperqtmk o74 true))))
...
;; H
(assert
  (= spark__branch15 (ite (bvugt (to_rep1 (rec__value (select d19 j1))) #x0000000000000000)
                       true
                       false)))
  ...
  (and
    ...
    (big1
      zu1)) (big3 s14 s24 s34)) (big3
                                  ...
                                  (to_rep1 (rec__value (select d19 4))))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d19 4))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d19 4)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d19 3))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d19 3)))))))
...
;; Assert
(assert (= (us_attr__init (select qd5 2)) true))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd5 2))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select qd5 2)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select qd5 1))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
