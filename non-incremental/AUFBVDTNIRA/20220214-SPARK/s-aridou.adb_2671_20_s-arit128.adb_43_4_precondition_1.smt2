...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d14 4))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d14 4)))))))
...
;; H
(assert
  (= (big1 ((_ zero_extend 64) (to_rep1 (rec__value (select d14 3))))) (bv2nat128 ((_ zero_extend 64) 
  (to_rep1
    (rec__value (select d14 3)))))))
