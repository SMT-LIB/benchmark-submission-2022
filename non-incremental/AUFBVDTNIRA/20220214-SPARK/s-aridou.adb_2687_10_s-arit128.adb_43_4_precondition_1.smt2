                ...
                (and
                  (forall ((scale3 Int) (shift2 Int))
                    (big_2xx__function_guard
                      ...
                      (+ shift2 scale3)))
                  (ite (< 1 shift1)
                    (exists ((zu2 (_ BitVec 128)) (mask2 (_ BitVec 64)) (scale3 Int) (shift2 Int) (inter2 Int))
                      (and
                        (and
                          (<= scale3 (- 64 shift2))
                          (and
                            (not
                              (= (bvand (hi zu2) mask2) #x0000000000000000))
                            (and
                              (= mask2 (bvshl #xFFFFFFFFFFFFFFFF ((_ int2bv 64) (- 64 shift2))))
                              (and
                                (= zu2 (bvshl (oabs z) ((_ int2bv 128) scale3)))
                                (and
                                  (= (big1 zu2) (* (big1 (oabs z)) (big_2xx
                                                                    scale3)))
                                  (and
                                    (and
                                      (<= 0 inter2)
                                                    ...
                                                    (exists ((mask3 (_ BitVec 64)))
                                                      (and
                                                        ...
                                                        (and
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  (dynamic_invariant3
                                                                    ...
                                                                    true
                                                                    true)
                                                                  (= o17 ((_ extract 63 0) (bvlshr zu2 ((_ int2bv 128) 64))))))
                                                              (and
                                                                (= spark__branch6 
                                                                (ite (= (bvand o17 mask3) #x0000000000000000)
                                                                  true
                                                                  false))
                                                                (ite (= 
                                                                  spark__branch6 true)
                                                                  (and
                                                                    (= 
                                                                    zu1 (bvshl zu2 ((_ int2bv 128) shift3)))
                                                                    (and
                                                                    (= 
                                                                    (big1
                                                                    zu1) (* 
                                                          ...
                                                          (not (< 1 shift3)))))))))))))))))))))
                    (and
                      (and (= spark__branch6 spark__branch5) (= zu1 zu))
                      (= scale2 scale1))))))))))))
...
(assert
  (= t15 (bvshl (oconcat
                  (to_rep1 (rec__value (select d3 1)))
                  (to_rep1 (rec__value (select d3 2)))) ((_ int2bv 128) 
  scale2))))
...
;; H
(assert
  (= t24 (bvshl ((_ zero_extend 64) (to_rep1 (rec__value (select d3 3)))) ((_ int2bv 128) 
  scale2))))
...
;; H
(assert
  (= t33 (bvshl ((_ zero_extend 64) (to_rep1 (rec__value (select d3 4)))) ((_ int2bv 128) 
  scale2))))
...
;; H
(assert (= (hi t15) ((_ extract 63 0) (bvlshr t15 ((_ int2bv 128) 64)))))

(declare-const o16 uns64)

;; Ensures
(assert (= (to_rep1 o16) (hi t15)))

(declare-const d10 (Array Int uns64__init_wrapper))

;; H
(assert (= d10 (store d3 1 (uns64__init_wrapperqtmk o16 true))))
...
;; H
(assert (= (hi t24) ((_ extract 63 0) (bvlshr t24 ((_ int2bv 128) 64)))))
...
(declare-const o17 uns64)

;; Ensures
(assert (= (to_rep1 o17) (bvor (lo t15) (hi t24))))

(declare-const d11 (Array Int uns64__init_wrapper))

;; H
(assert (= d11 (store d10 2 (uns64__init_wrapperqtmk o17 true))))
...
;; H
(assert (= (hi t33) ((_ extract 63 0) (bvlshr t33 ((_ int2bv 128) 64)))))
...
;; Ensures
(assert (= (to_rep1 o18) (bvor (lo t24) (hi t33))))

(declare-const d12 (Array Int uns64__init_wrapper))

;; H
(assert (= d12 (store d11 3 (uns64__init_wrapperqtmk o18 true))))
...
;; Ensures
(assert (= (to_rep1 o19) (lo t33)))

(declare-const d13 (Array Int uns64__init_wrapper))

;; H
(assert (= d13 (store d12 4 (uns64__init_wrapperqtmk o19 true))))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 3))) o20))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 2))) o21))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 1))) o22))
...
;; H
(assert
  (= (big3 o22 o21 o20) (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                   ((_ zero_extend 64) 
                                                                   o22))) (* 
  big_2xxsingle (big1 ((_ zero_extend 64) o21)))) (big1
                                                    ((_ zero_extend 64) 
                                                    o20)))))

;; H
(assert (= (big3 o22 o21 o20) d123))
...
;; H
(assert (= spark__branch9 (ite (bvugt o23 zhi1) true false)))
...
;; H
(assert (= spark__branch8 (ite (= o24 zhi1) true false)))
...
(assert
  (ite (= spark__branch8 true)
    ...
    (let ((temp___831 (select d13 (+ j 1))))
      (and
        (= (us_attr__init temp___831) true)
        (and
          (= (to_rep1 (rec__value temp___831)) o25)
          (let ((temp___829 (select d13 j)))
            (and
              (= (us_attr__init temp___829) true)
              (and
                (= (to_rep1 (rec__value temp___829)) o26)
                (let ((o29 (oconcat o26 o25)))
                  (and
                    (and
                      (oconcat__function_guard o29 o26 o25)
                      (and
                        (dynamic_invariant2 o29 true false true true)
                        (= o29 (bvor (bvshl ((_ zero_extend 64) o26) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
                        o25)))))
                    (let ((o30 (odivide o29 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o30 true false true true)
                          (= o30 (bvudiv o29 ((_ zero_extend 64) zhi1))))
                        (let ((o31 (lo o30)))
                          (and
                            (and
                              (dynamic_invariant3 o31 true false true true)
                              (= o31 ((_ extract 63 0) (bvand o30 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o27) o31)
...
;; H
(assert (= (to_rep1 (rec__value (select qd2 j))) o29))

;; H
(assert (dynamic_invariant2 (omultiply o29 zlo1) true false true true))

;; H
(assert
  (= (omultiply o29 zlo1) (bvmul ((_ zero_extend 64) o29) ((_ zero_extend 64) 
  zlo1))))

(declare-const t16 (_ BitVec 128))

;; H
(assert (= t16 (omultiply o29 zlo1)))
...
;; H
(assert (= (to_rep1 (rec__value (select qd2 j))) o30))

;; H
(assert (dynamic_invariant2 (omultiply o30 zhi1) true false true true))

;; H
(assert
  (= (omultiply o30 zhi1) (bvmul ((_ zero_extend 64) o30) ((_ zero_extend 64) 
  zhi1))))

(declare-const t25 (_ BitVec 128))

;; H
(assert (= t25 (omultiply o30 zhi1)))
...
;; H
(assert (= (hi t16) ((_ extract 63 0) (bvlshr t16 ((_ int2bv 128) 64)))))
...
(assert
  (let ((o31 (lo t25)))
    (let ((o32 (hi t16)))
      (= (oadd o32 o31) (bvadd ((_ zero_extend 64) o32) ((_ zero_extend 64) o31))))))
...
;; H
(assert (= (hi t25) ((_ extract 63 0) (bvlshr t25 ((_ int2bv 128) 64)))))
...
;; H
(assert (= (hi t34) ((_ extract 63 0) (bvlshr t34 ((_ int2bv 128) 64)))))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 2)))) o31))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 1)))) o32))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 j))) o33))

;; H
(assert
  (le3__function_guard (le3 s11 s21 s31 o33 o32 o31) s11 s21 s31 o33 o32 o31))

;; H
(assert
  (=
    (= (le3 s11 s21 s31 o33 o32 o31) true)
    (<= (big3 s11 s21 s31) (big3 o33 o32 o31))))
  ...
  (and
    (forall ((s13 (_ BitVec 64)) (s23 (_ BitVec 64)) (s33 (_ BitVec 64)))
      (le3__function_guard
        ...
        (to_rep1 (rec__value (select d13 (+ j 1))))
        (to_rep1 (rec__value (select d13 (+ j 2))))))
    (ite (not (= (le3 s11 s21 s31 o33 o32 o31) true))
      (exists ((qd4 (Array Int uns64__init_wrapper)) (s13 (_ BitVec 64)) (s23 (_ BitVec 64)) (s33 (_ BitVec 64)))
        (and
          ...
          (and
                           ...
                           (and
                             (and
                               (forall ((temp___861 Int))
                                 (=>
                                   (and (<= 1 temp___861) (<= temp___861 2))
                                   (=>
                                     (not (= j temp___861))
                                     (= (select qd4 temp___861) (select 
                                     qd2 temp___861)))))
            ...
            (and
              (and
                (= (big3 s12 s22 s32) (- (big3 s13 s23 s33) (big3
                                                              #x0000000000000000
                                                              zhi1
                                                              zlo1)))
                (and
                  (and
                    (dynamic_invariant3 s12 true true true true)
                    (dynamic_invariant3 s22 true true true true))
                  (dynamic_invariant3 s32 true true true true)))
              (let ((temp___851 (select qd4 j)))
                (and
                  (= (us_attr__init temp___851) true)
                  (exists ((o34 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___851)) o34)
                      (and
                        (= prev1 (bvsub o34 #x0000000000000001))
                        (and
                          (dynamic_invariant3 prev1 true false true true)
                          (let ((temp___854 (select qd4 j)))
                            (and
                              (= (us_attr__init temp___854) true)
                              (exists ((o35 (_ BitVec 64)))
                                (and
                                  (= (to_rep1 (rec__value temp___854)) o35)
                                  (exists ((o36 uns64))
                                    (and
                                      (= (to_rep1 o36) (bvsub o35 #x0000000000000001))
                                      (and
                                        (= qd3 (store qd4 j (uns64__init_wrapperqtmk
                                                              o36
                                                              true)))
                                        (let ((temp___878 (select d13 (+ 
                                          j 2))))
                                          (and
                                            (= (us_attr__init temp___878) true)
                                            (exists ((o37 (_ BitVec 64)))
                                              (and
                                                (= (to_rep1
                                                     (rec__value temp___878)) o37)
                                                (let ((temp___876 (select 
                                                  d13 (+ j 1))))
                                                  (and
                                                    (= (us_attr__init
                                                         temp___876) true)
                                                    (exists ((o38 (_ BitVec 64)))
                                                      (and
                                                        (= (to_rep1
                                                             (rec__value
                                                               temp___876)) o38)
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((o40 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= o40 true))))))))))))))))))))))))))))))))
      (and
        (and (and (and (= qd3 qd2) (= s12 s11)) (= s22 s21)) (= s32 s31))
        (= prev1 prev)))))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 j))) temp___compl_883))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 1)))) temp___compl_886))
...
;; H
(assert (= (to_rep1 (rec__value (select d13 (+ j 2)))) temp___compl_889))
...
(assert
  (= (big3 x1 x2 x3) (- (big3
                          temp___compl_883
                          temp___compl_886
                          temp___compl_889) (big3 s12 s22 s32))))
...
;; H
(assert (= (to_rep1 o34) x1))

(declare-const d15 (Array Int uns64__init_wrapper))

;; H
(assert (= d15 (store d13 j (uns64__init_wrapperqtmk o34 true))))

(declare-const o35 uns64)

;; H
(assert (= (to_rep1 o35) x2))

(declare-const d16 (Array Int uns64__init_wrapper))

;; H
(assert (= d16 (store d15 (+ j 1) (uns64__init_wrapperqtmk o35 true))))

(declare-const o36 uns64)

;; H
(assert (= (to_rep1 o36) x3))

(declare-const d17 (Array Int uns64__init_wrapper))

;; H
(assert (= d17 (store d16 (+ j 2) (uns64__init_wrapperqtmk o36 true))))

(declare-const spark__branch10 Bool)

;; H
(assert (= spark__branch10 (ite (= j 1) true false)))

;; H
(assert
  (or
    (not (= spark__branch10 true))
    (let ((temp___891 (select qd3 1)))
      (and
        (= (us_attr__init temp___891) true)
        (exists ((o37 (_ BitVec 64)))
          (= (to_rep1 (rec__value temp___891)) o37))))))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 j1))) o37))

(declare-const spark__branch12 Bool)

;; H
(assert (= spark__branch12 (ite (bvugt o37 zhi1) true false)))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 j1))) o38))

;; H
(assert (= spark__branch11 (ite (= o38 zhi1) true false)))
...
(assert
  (ite (= spark__branch11 true)
    (and
      (= (to_rep1 o42) #xFFFFFFFFFFFFFFFF)
      (= qd4 (store qd3 j1 (uns64__init_wrapperqtmk o42 true))))
    (let ((temp___831 (select d17 (+ j1 1))))
      (and
        (= (us_attr__init temp___831) true)
        (and
          (= (to_rep1 (rec__value temp___831)) o39)
          (let ((temp___829 (select d17 j1)))
            (and
              (= (us_attr__init temp___829) true)
              (and
                (= (to_rep1 (rec__value temp___829)) o40)
                (let ((o43 (oconcat o40 o39)))
                  (and
                    (and
                      (oconcat__function_guard o43 o40 o39)
                      (and
                        (dynamic_invariant2 o43 true false true true)
                        (= o43 (bvor (bvshl ((_ zero_extend 64) o40) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
                        o39)))))
                    (let ((o44 (odivide o43 zhi1)))
                      (and
                        (and
                          (dynamic_invariant2 o44 true false true true)
                          (= o44 (bvudiv o43 ((_ zero_extend 64) zhi1))))
                        (let ((o45 (lo o44)))
                          (and
                            (and
                              (dynamic_invariant3 o45 true false true true)
                              (= o45 ((_ extract 63 0) (bvand o44 #x0000000000000000FFFFFFFFFFFFFFFF))))
                            (and
                              (= (to_rep1 o41) o45)
...
;; H
(assert (= (to_rep1 (rec__value (select qd4 j1))) o43))

;; H
(assert (dynamic_invariant2 (omultiply o43 zlo1) true false true true))

;; H
(assert
  (= (omultiply o43 zlo1) (bvmul ((_ zero_extend 64) o43) ((_ zero_extend 64) 
  zlo1))))

(declare-const t17 (_ BitVec 128))

;; H
(assert (= t17 (omultiply o43 zlo1)))
...
;; H
(assert (= (to_rep1 (rec__value (select qd4 j1))) o44))

;; H
(assert (dynamic_invariant2 (omultiply o44 zhi1) true false true true))

;; H
(assert
  (= (omultiply o44 zhi1) (bvmul ((_ zero_extend 64) o44) ((_ zero_extend 64) 
  zhi1))))

(declare-const t26 (_ BitVec 128))

;; H
(assert (= t26 (omultiply o44 zhi1)))
...
;; H
(assert (= (hi t17) ((_ extract 63 0) (bvlshr t17 ((_ int2bv 128) 64)))))
...
(assert
  (let ((o45 (lo t26)))
    (let ((o46 (hi t17)))
      (= (oadd o46 o45) (bvadd ((_ zero_extend 64) o46) ((_ zero_extend 64) o45))))))
...
;; H
(assert (= (hi t26) ((_ extract 63 0) (bvlshr t26 ((_ int2bv 128) 64)))))
...
;; H
(assert (= (hi t35) ((_ extract 63 0) (bvlshr t35 ((_ int2bv 128) 64)))))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 (+ j1 2)))) o45))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 (+ j1 1)))) o46))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 j1))) o47))

;; H
(assert
  (le3__function_guard (le3 s13 s23 s33 o47 o46 o45) s13 s23 s33 o47 o46 o45))

;; H
(assert
  (=
    (= (le3 s13 s23 s33 o47 o46 o45) true)
    (<= (big3 s13 s23 s33) (big3 o47 o46 o45))))
  ...
  (and
    (forall ((s15 (_ BitVec 64)) (s25 (_ BitVec 64)) (s35 (_ BitVec 64)))
      (le3__function_guard
        ...
        (to_rep1 (rec__value (select d17 (+ j1 1))))
        (to_rep1 (rec__value (select d17 (+ j1 2))))))
    (ite (not (= (le3 s13 s23 s33 o47 o46 o45) true))
      (exists ((qd5 (Array Int uns64__init_wrapper)) (s15 (_ BitVec 64)) (s25 (_ BitVec 64)) (s35 (_ BitVec 64)))
        (and
          ...
          (and
            ...
            (and
              (and
                (= (big3 s14 s24 s34) (- (big3 s15 s25 s35) (big3
                                                              #x0000000000000000
                                                              zhi1
                                                              zlo1)))
                (and
                  (and
                    (dynamic_invariant3 s14 true true true true)
                    (dynamic_invariant3 s24 true true true true))
                  (dynamic_invariant3 s34 true true true true)))
              (let ((temp___851 (select qd5 j1)))
                (and
                  (= (us_attr__init temp___851) true)
                  (exists ((o48 (_ BitVec 64)))
                    (and
                      (= (to_rep1 (rec__value temp___851)) o48)
                      (exists ((prev2 (_ BitVec 64)))
                        (and
                          (= prev2 (bvsub o48 #x0000000000000001))
                          (and
                            (dynamic_invariant3 prev2 true false true true)
                            (let ((temp___854 (select qd5 j1)))
                              (and
                                (= (us_attr__init temp___854) true)
                                (exists ((o49 (_ BitVec 64)))
                                  (and
                                    (= (to_rep1 (rec__value temp___854)) o49)
                                    (exists ((o50 uns64))
                                      (and
                                        (= (to_rep1 o50) (bvsub o49 #x0000000000000001))
                                        (and
                                          (= qd1 (store qd5 j1 (uns64__init_wrapperqtmk
                                                                 o50
                                                                 true)))
                                          (let ((temp___878 (select d17 (+ 
                                            j1 2))))
                                            (and
                                              (= (us_attr__init temp___878) true)
                                              (exists ((o51 (_ BitVec 64)))
                                                (and
                                                  (= (to_rep1
                                                       (rec__value
                                                         temp___878)) o51)
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (let ((o54 
                                                                    ...
                                                                    o51))))
                                                                    (= o54 true)))))))))))))))))))))))))))))))))
      (and (and (and (= qd1 qd4) (= s14 s13)) (= s24 s23)) (= s34 s33)))))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 j1))) temp___compl_8831))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 (+ j1 1)))) temp___compl_8861))
...
;; H
(assert (= (to_rep1 (rec__value (select d17 (+ j1 2)))) temp___compl_8891))
...
(assert
  (= (big3 x11 x21 x31) (- (big3
                             temp___compl_8831
                             temp___compl_8861
                             temp___compl_8891) (big3 s14 s24 s34))))
...
(declare-const o48 uns64)

;; H
(assert (= (to_rep1 o48) x11))

(declare-const d18 (Array Int uns64__init_wrapper))

;; H
(assert (= d18 (store d17 j1 (uns64__init_wrapperqtmk o48 true))))

(declare-const o49 uns64)

;; H
(assert (= (to_rep1 o49) x21))

(declare-const d19 (Array Int uns64__init_wrapper))

;; H
(assert (= d19 (store d18 (+ j1 1) (uns64__init_wrapperqtmk o49 true))))

(declare-const o50 uns64)

;; H
(assert (= (to_rep1 o50) x31))

;; H
(assert (= d14 (store d19 (+ j1 2) (uns64__init_wrapperqtmk o50 true))))
...
(assert
  (or
    ...
    (let ((temp___891 (select qd1 1)))
      (and
        (= (us_attr__init temp___891) true)
        (exists ((o51 (_ BitVec 64)))
          (= (to_rep1 (rec__value temp___891)) o51))))))
...
(assert
  ...
  (to_rep1
    (rec__value (select qd1 1)))) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
  (to_rep1
...
(assert
  ...
  (to_rep1
    (rec__value (select d14 3)))) ((_ int2bv 128) 64)) ((_ zero_extend 64) 
  (to_rep1
...
;; H
(assert (= ru2 (bvlshr ru1 ((_ int2bv 128) scale2))))
