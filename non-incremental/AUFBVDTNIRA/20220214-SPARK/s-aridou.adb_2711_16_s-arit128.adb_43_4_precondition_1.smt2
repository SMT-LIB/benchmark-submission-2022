...
;; H
(assert
  (= spark__branch14 (ite (bvugt ru1 (bvudiv (bvsub zu1 #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                       true
                       false)))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= qu1 #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF) true false))

(declare-const spark__branch15 Bool)

;; H
(assert
  (= spark__branch15 (ite (= qu1 #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)
                       true
                       false)))
