...
(define-fun uns64__ref_uns64__content__projection ((a1 uns64__ref)) uns64
  (uns64__content a1))
...
(assert
  (and
    (and (not (= b #x0000000000000000)) (= q (odivide a b)))
    (= r (orem a b))))

;; Goal def'vc
;; File "s-aridou.adb", line 264, characters 0-0
(assert
  (not (= (big a) (+ (* (big ((_ zero_extend 64) b)) (big q)) (big r)))))
