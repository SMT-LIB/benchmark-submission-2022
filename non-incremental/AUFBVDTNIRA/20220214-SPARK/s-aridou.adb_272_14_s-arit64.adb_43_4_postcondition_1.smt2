...
(define-fun uns32__ref_uns32__content__projection ((a1 uns32__ref)) uns32
  (uns32__content a1))
...
;; Assume
(assert
  (and (and (not (= b #x00000000)) (= q (odivide a b))) (= r (orem a b))))

;; Goal def'vc
;; File "s-aridou.adb", line 264, characters 0-0
(assert
  (not (= (big a) (+ (* (big ((_ zero_extend 32) b)) (big q)) (big r)))))
