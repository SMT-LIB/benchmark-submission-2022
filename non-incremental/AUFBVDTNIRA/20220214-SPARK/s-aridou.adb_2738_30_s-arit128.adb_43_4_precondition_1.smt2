...
;; H
(assert (to_neg_int__function_guard (to_neg_int ru1) ru1))

;; H
(assert (dynamic_invariant1 (to_neg_int ru1) true false true true))

;; H
(assert (= (big (to_neg_int ru1)) (- (big1 ru1))))

(declare-const r1 Int)

;; H
(assert (= r1 (to_neg_int ru1)))
