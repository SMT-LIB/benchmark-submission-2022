...
(assert
  (and
    (and
      (bvule x1 (bvsub #xFFFFFFFFFFFFFFFF y1))
      (bvule x2 (bvsub #xFFFFFFFFFFFFFFFF y2)))
    (bvule x3 (bvsub #xFFFFFFFFFFFFFFFF y3))))

;; Goal def'vc
;; File "s-aridou.adb", line 2759, characters 0-0
(assert
  (not
  (= (big3 (bvadd x1 y1) (bvadd x2 y2) (bvadd x3 y3)) (+ (big3 x1 x2 x3) 
  (big3
    y1
    y2
    y3)))))
