...
;; Assume
(assert (and (and (bvuge x1 y1) (bvuge x2 y2)) (bvuge x3 y3)))

;; Ensures
(assert
  (= (- (big ((_ zero_extend 64) x1)) (big ((_ zero_extend 64) y1))) 
  (big
    (bvsub ((_ zero_extend 64) x1) ((_ zero_extend 64) y1)))))

;; Ensures
(assert
  (= (- (big ((_ zero_extend 64) x2)) (big ((_ zero_extend 64) y2))) 
  (big
    (bvsub ((_ zero_extend 64) x2) ((_ zero_extend 64) y2)))))

;; Ensures
(assert
  (= (- (big ((_ zero_extend 64) x3)) (big ((_ zero_extend 64) y3))) 
  (big
    (bvsub ((_ zero_extend 64) x3) ((_ zero_extend 64) y3)))))

;; Goal def'vc
;; File "s-aridou.adb", line 2776, characters 0-0
(assert
  (not
  (= (big3 (bvsub x1 y1) (bvsub x2 y2) (bvsub x3 y3)) (- (big3 x1 x2 x3) 
  (big3
    y1
    y2
    y3)))))
