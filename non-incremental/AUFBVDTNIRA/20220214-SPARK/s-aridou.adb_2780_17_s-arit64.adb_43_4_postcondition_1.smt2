...
;; Ensures
(assert
  (= (- (big ((_ zero_extend 32) x1)) (big ((_ zero_extend 32) y1))) 
  (big
    (bvsub ((_ zero_extend 32) x1) ((_ zero_extend 32) y1)))))

;; Ensures
(assert
  (= (- (big ((_ zero_extend 32) x2)) (big ((_ zero_extend 32) y2))) 
  (big
    (bvsub ((_ zero_extend 32) x2) ((_ zero_extend 32) y2)))))

;; Ensures
(assert
  (= (- (big ((_ zero_extend 32) x3)) (big ((_ zero_extend 32) y3))) 
  (big
    (bvsub ((_ zero_extend 32) x3) ((_ zero_extend 32) y3)))))
