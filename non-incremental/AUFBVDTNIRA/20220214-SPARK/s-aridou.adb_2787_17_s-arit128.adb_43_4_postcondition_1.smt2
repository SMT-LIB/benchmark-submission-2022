...
(assert
  (= (+ (big
          (bvsub #x00000000000000010000000000000000 ((_ zero_extend 64) 
          y2))) (big ((_ zero_extend 64) x2))) (big
                                                 (bvadd (bvsub #x00000000000000010000000000000000 ((_ zero_extend 64) 
                                                 y2)) ((_ zero_extend 64) 
                                                 x2)))))

;; Ensures
(assert
  (= (- (big #x00000000000000010000000000000000) (big
                                                   ((_ zero_extend 64) 
                                                   y2))) (big
                                                           (bvsub #x00000000000000010000000000000000 ((_ zero_extend 64) 
                                                           y2)))))
...
;; Goal def'vc
;; File "s-aridou.adb", line 2783, characters 0-0
(assert
  (not
  (= (big3 x1 (bvsub x2 y2) x3) (- (+ (big3 x1 x2 x3) (big3
                                                        #x0000000000000001
                                                        #x0000000000000000
                                                        #x0000000000000000)) 
  (big3
