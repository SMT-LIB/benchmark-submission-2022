...
;; Ensures
(assert
  (= (+ (big (bvsub #x0000000100000000 ((_ zero_extend 32) y2))) (big
                                                                   ((_ zero_extend 32) 
                                                                   x2))) 
  (big
    (bvadd (bvsub #x0000000100000000 ((_ zero_extend 32) y2)) ((_ zero_extend 32) 
    x2)))))

;; Ensures
(assert
  (= (- (big #x0000000100000000) (big ((_ zero_extend 32) y2))) (big
                                                                  (bvsub #x0000000100000000 ((_ zero_extend 32) 
                                                                  y2)))))
