      ...
      (ite (= spark__branch true)
                ...
                (let ((o3 (uc_of_int o2)))
                  (and
                    ...
                    (and
                      (= (bvsub o3 o1) ru)
                      (and
                        (dynamic_invariant1 ru true false true true)
                        (and
                          (= ru (bvsub (of_int x) (of_int y)))
                          (and
                            (= spark__branch2 (ite (bvult ru #x80000000000000000000000000000000)
                                                true
                                                false))
                            (ite (= spark__branch2 true)
                              (let ((o4 x))
                                (let ((o5 y))
                                  (and
                                    (= (of_int (- o4 o5)) (bvsub (of_int o4) 
                                    (of_int
                                      o5)))
                                    (= ru (of_int (- x y))))))
                              (and
                                (= spark__branch3 (ite (= ru #x80000000000000000000000000000000)
                                                    true
                                                    false))
                                (and
                                  (not (= spark__branch3 true))
                                  (and
                                    (= r (- (bv2nat128 (bvneg (bvsub 
                                    (of_int
                                      x) (of_int y))))))
                                    (and
        ...
        (and
          ...
          (and
            ...
            (= (bvsub (uc_of_int x) (uc_of_int y)) (bvadd (of_int x) 
            (of_int
              (- y))))))))))
