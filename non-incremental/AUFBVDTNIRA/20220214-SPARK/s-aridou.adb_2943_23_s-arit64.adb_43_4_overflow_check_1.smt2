                    ...
                    (and
                      ...
                      (and
                        ...
                        (and
                          ...
                          (and
                            (= spark__branch2 (ite (bvult ru #x8000000000000000)
                                                true
                                                false))
                              ...
                              (let ((o4 x))
                                (let ((o5 y))
                                  (and
                                    ...
                                    (= ru (of_int (- x y))))))
                              (and
                                (= spark__branch3 (ite (= ru #x8000000000000000)
                                                    true
                                                    false))
                                (and
                                  (not (= spark__branch3 true))
                                  (and
                                    (= r (- (bv2nat64 (bvneg (bvsub (of_int
                                                                    x) 
                                    (of_int
                                      y))))))
                                    (and
                                      ...
                                      (of_int
                                        x)) (of_int y)))))
                                      (= r (- (bv2nat64 (bvsub (of_int y) 
                                      (of_int
                                        x))))))))))))))))))))
        (and
          (= spark__branch1 (ite (= y (- 9223372036854775808)) true false))
          (and
