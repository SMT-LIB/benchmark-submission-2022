...
;; Assume
(assert (ite (<= 0 x) (and (<= y 0) (< r 0)) (and (< 0 y) (<= 0 r))))
...
(assert
  (ite (<= 0 x)
    (= o (ite (= y (- 170141183460469231731687303715884105728)) false true))
    (= o false)))
            ...
            (and
              ...
              (and
                ...
                (or
                  ...
                  (= (bvsub (uc_of_int x) (uc_of_int y)) (bvsub (bvneg 
                  (of_int
                    (- x))) (of_int y))))))))))))

;; Goal def'vc
;; File "s-aridou.adb", line 2945, characters 0-0
(assert
