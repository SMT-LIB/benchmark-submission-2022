...
;; H
(assert (= spark__branch1 (ite (bvult ru #x8000000000000000) true false)))
...
;; H
(assert (= spark__branch2 (ite (= ru #x8000000000000000) true false)))
...
(assert
  (not (= r (- (bv2nat64 (bvneg (bvsub (of_int x) (of_int y))))))))
