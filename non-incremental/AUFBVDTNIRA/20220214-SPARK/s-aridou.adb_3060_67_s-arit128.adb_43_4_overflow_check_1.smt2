...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= a #x80000000000000000000000000000000) true false))

;; H
(assert (not (= a #x80000000000000000000000000000000)))

;; H
(assert (to_int__function_guard (uc_to_int a) a))

;; H
(assert (dynamic_invariant (uc_to_int a) true false true true))

;; Goal def'vc
;; File "s-aridou.adb", line 162, characters 0-0
(assert
  (not (<= (- (uc_to_int a)) 170141183460469231731687303715884105727)))
