...
(define-fun tinteger_64B__ref_tinteger_64B__content__projection ((a1 tinteger_64B__ref)) tinteger_64B
  (tinteger_64B__content a1))
...
(declare-const ada___system__arith_64__impl__to_neg_int__r__assume Int)

;; H
(assert
  (ite (= a #x8000000000000000)
    (= ada___system__arith_64__impl__to_neg_int__r__assume (- 9223372036854775808))
    (let ((o a))
      (let ((o1 (uc_to_int o)))
        (and
          (and
          ...
          (let ((o2 (- o1)))
            (and
              (= ada___system__arith_64__impl__to_neg_int__r__assume o2)
              (in_range2 o2))))))))

;; Assume
(assert (= ada___system__arith_64__impl__to_neg_int__r__assume r))
