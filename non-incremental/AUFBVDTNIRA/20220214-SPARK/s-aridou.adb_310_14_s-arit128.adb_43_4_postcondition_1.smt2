...
;; Ensures
(assert
  (= (bvshl (bvshl x (of_int (bv2nat128 (of_int s)))) (of_int
                                                        (bv2nat128 (of_int
                                                                    s1)))) (bvshl 
...
;; Assert
(assert
  (= (bvshl (bvshl x (of_int s)) (of_int s1)) (bvshl (bvshl x (of_int s)) 
  (of_int
    (bv2nat128 (of_int s1))))))

;; Assert
(assert
  (= (bvshl x (of_int (+ s s1))) (bvshl x (of_int
                                            (bv2nat128 (of_int (+ s s1)))))))

;; Goal def'vc
;; File "s-aridou.adb", line 306, characters 0-0
(assert
  (not
  (= (bvshl (bvshl x (of_int s)) (of_int s1)) (bvshl x (of_int (+ s s1))))))
