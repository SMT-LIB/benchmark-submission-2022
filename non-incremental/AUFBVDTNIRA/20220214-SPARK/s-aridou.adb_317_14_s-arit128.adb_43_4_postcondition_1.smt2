...
;; bool_eq
(define-fun bool_eq2 ((x1 (_ BitVec 128)) (y (_ BitVec 128))) Bool
  (ite (= x1 y) true false))
...
(assert
  (and
    (bvule s #x00000000000000000000000000000080)
    (bvule s1 #x00000000000000000000000000000080)))

;; Goal def'vc
;; File "s-aridou.adb", line 312, characters 0-0
(assert
  (not
  (= (bvlshr (bvlshr x (of_int (bv2nat128 s))) (of_int (bv2nat128 s1))) (bvlshr 
  x (of_int (bv2nat128 (bvadd s s1)))))))
