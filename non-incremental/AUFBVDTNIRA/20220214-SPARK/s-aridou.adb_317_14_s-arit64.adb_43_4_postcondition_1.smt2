...
;; bool_eq
(define-fun bool_eq2 ((x1 (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (= x1 y) true false))
...
;; Assume
(assert (and (bvule s #x0000000000000040) (bvule s1 #x0000000000000040)))

;; Goal def'vc
;; File "s-aridou.adb", line 312, characters 0-0
(assert
  (not
  (= (bvlshr (bvlshr x (of_int (bv2nat64 s))) (of_int (bv2nat64 s1))) (bvlshr 
  x (of_int (bv2nat64 (bvadd s s1)))))))
