...
;; bool_eq
(define-fun bool_eq3 ((x1 (_ BitVec 128)) (y (_ BitVec 128))) Bool
  (ite (= x1 y) true false))
...
;; Ensures
(assert
  (= (bvlshr (bvlshr x (of_int (bv2nat128 (of_int s)))) (of_int
                                                          (bv2nat128 
                                                          (of_int
                                                            s1)))) (bvlshr 
  x (of_int (bv2nat128 (bvadd (of_int s) (of_int s1)))))))

;; Assert
(assert
  (= (bvlshr (bvlshr x (of_int s)) (of_int s1)) (bvlshr (bvlshr x (of_int s)) 
  (of_int
    (bv2nat128 (of_int s1))))))

;; Assert
(assert
  (= (bvlshr x (of_int (+ s s1))) (bvlshr x (of_int
                                              (bv2nat128 (of_int (+ s s1)))))))

;; Goal def'vc
;; File "s-aridou.adb", line 320, characters 0-0
(assert
  (not
  (= (bvlshr (bvlshr x (of_int s)) (of_int s1)) (bvlshr x (of_int (+ s s1))))))
