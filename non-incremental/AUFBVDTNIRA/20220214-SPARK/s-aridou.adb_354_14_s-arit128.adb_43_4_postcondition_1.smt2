...
;; Assume
(assert
  (and (and (hi__function_guard (hi xu) xu) (= xhi (hi xu))) (= xlo (lo xu))))

;; Assert
(assert
  (= ((_ zero_extend 64) xhi) (bvudiv xu #x00000000000000010000000000000000)))

;; Assert
(assert
  (= ((_ zero_extend 64) xlo) (bvurem xu #x00000000000000010000000000000000)))

;; Goal def'vc
;; File "s-aridou.adb", line 350, characters 0-0
(assert
  (not
