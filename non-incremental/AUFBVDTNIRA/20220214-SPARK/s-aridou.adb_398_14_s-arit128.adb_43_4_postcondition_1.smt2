...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool
  true)
...
;; Assume
(assert (and (< (* (big x) (big y)) big_2xxdouble) (= z (bvmul x y))))

;; Goal def'vc
;; File "s-aridou.adb", line 394, characters 0-0
(assert
  (not (= (* (big x) (big y)) (big z))))
