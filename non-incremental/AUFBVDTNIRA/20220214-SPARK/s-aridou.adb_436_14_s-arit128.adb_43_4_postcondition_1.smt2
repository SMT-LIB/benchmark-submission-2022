...
(assert
  (forall ((arg Int))
    (forall ((low Int) (high Int))
      (! (=
           (= (in_range arg low high) true)
           (and (<= low arg) (<= arg high))) :pattern ((in_range
                                                         arg
                                                         low
                                                         high)) ))))
...
;; Goal def'vc
;; File "s-aridou.adb", line 434, characters 0-0
(assert
  (not (not (= (in_double_int_range (- big_2xxdouble)) true))))
