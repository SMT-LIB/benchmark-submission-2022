...
;; user_eq
(declare-fun user_eq3 (uns128
  uns128) Bool)

(declare-const dummy3 uns128)
...
;; Assume
(assert (= (+ (big #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF) 1) big_2xxdouble))
...
;; Assume
(assert (and (and (< m 128) (< n 128)) (<= (+ m n) 128)))
...
;; H
(assert (= spark__branch (ite (< (+ m n) 128) true false)))

;; H
(assert
  (or
    (not (= spark__branch true))
    (= (bvmul (ite (< m 340282366920938463463374607431768211456)
                (bvshl #x00000000000000000000000000000001 (of_int m))
                #x00000000000000000000000000000000) (ite (< n 340282366920938463463374607431768211456)
                                                      (bvshl #x00000000000000000000000000000001 
                                                      (of_int
                                                        n))
                                                      #x00000000000000000000000000000000)) 
    (let ((temp___2835 (+ m n)))
      (ite (< temp___2835 340282366920938463463374607431768211456)
        (bvshl #x00000000000000000000000000000001 (of_int temp___2835))
        #x00000000000000000000000000000000)))))

;; Ensures
(assert
  (and
    (big_2xx__function_guard (big_2xx m) m)
    (= (power (big #x00000000000000000000000000000002) m) (ite (< m 128)
                                                            (big_2xx m)
                                                            big_2xxdouble))))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx n) n)
    (= (power (big #x00000000000000000000000000000002) n) (ite (< n 128)
                                                            (big_2xx n)
                                                            big_2xxdouble))))
...
(assert
  (and
    (big_2xx__function_guard (big_2xx (+ m n)) (+ m n))
    (= (power (big #x00000000000000000000000000000002) (+ m n)) (ite (< (+ 
                                                                  m n) 128)
                                                                  (big_2xx
                                                                    (+ 
                                                                    m 
...
;; H
(assert (= spark__branch1 (ite (< (+ m n) 128) true false)))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (= (* (power (big #x00000000000000000000000000000002) m) (power
                                                                 (big
                                                                   #x00000000000000000000000000000002)
                                                                 n)) 
      (power
        (big #x00000000000000000000000000000002)
        (+ m n)))
      (let ((o3 (+ m n)))
        (and
          (in_range o3)
          (and
            (< (power (big #x00000000000000000000000000000002) o3) (power
                                                                    (big
                                                                    #x00000000000000000000000000000002)
                                                                    128))
            (and
              (let ((o4 (+ m n)))
                (and
                  (in_range o4)
                  (ite (< o4 340282366920938463463374607431768211456)
                    (= o (bvshl #x00000000000000000000000000000001 (of_int
                                                                    o4)))
                    (= o #x00000000000000000000000000000000))))
              (and
                (ite (< n 340282366920938463463374607431768211456)
                  (= o1 (bvshl #x00000000000000000000000000000001 (of_int n)))
                  (= o1 #x00000000000000000000000000000000))
                (and
                  (ite (< m 340282366920938463463374607431768211456)
                    (= o2 (bvshl #x00000000000000000000000000000001 (of_int
                                                                    m)))
...
;; Goal def'vc
;; File "s-aridou.adb", line 439, characters 0-0
(assert
  (not
  (=>
    (big_2xx__function_guard (big_2xx m) m)
    (=>
      ...
      (=>
        (big_2xx__function_guard (big_2xx (+ m n)) (+ m n))
        (= (* (big_2xx m) (big_2xx n)) (ite (= (+ m n) 128)
                                         big_2xxdouble
                                         (big_2xx (+ m n)))))))))
