  ...
  (or
    ...
    (let ((o (+ m n)))
      (and
        (in_range o)
        (and
          (< (power1 (big #x00000000000000000000000000000002) o) (power1
                                                                   (big
                                                                    #x00000000000000000000000000000002)
                                                                   128))
          (exists ((o1 (_ BitVec 128)))
            (and
              (let ((o2 (+ m n)))
                (and
                  (in_range o2)
                  (ite (< o2 340282366920938463463374607431768211456)
                    (= o1 (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) o2)))
                    (= o1 #x00000000000000000000000000000000))))
              (exists ((o2 (_ BitVec 128)))
                (and
                  (ite (< n 340282366920938463463374607431768211456)
                    (= o2 (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) 
                    n)))
                    (= o2 #x00000000000000000000000000000000))
                  (exists ((o3 (_ BitVec 128)))
                    (and
                      (ite (< m 340282366920938463463374607431768211456)
                        (= o3 (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) 
                        m)))
                        (= o3 #x00000000000000000000000000000000))
                      (= (* (big o3) (big o2)) (big o1)))))))))))))
