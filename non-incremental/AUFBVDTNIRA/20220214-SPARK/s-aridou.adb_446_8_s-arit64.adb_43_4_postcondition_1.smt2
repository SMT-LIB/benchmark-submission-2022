...
(assert
  (and
    ...
    (= (power1 (big #x0000000000000002) m) (ite (< m 64)
                                             (big_2xx m)
                                             big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power1 (big #x0000000000000002) n) (ite (< n 64)
                                             (big_2xx n)
                                             big_2xxdouble))))
...
(assert
  (and
    ...
    (= (power1 (big #x0000000000000002) (+ m n)) (ite (< (+ m n) 64)
                                                   (big_2xx (+ m n))
                                                   big_2xxdouble))))
  ...
  (or
    ...
    (let ((o (+ m n)))
      (and
        (in_range o)
        (and
          (< (power1 (big #x0000000000000002) o) (power1
              ...
              (let ((o2 (+ m n)))
                (and
                  ...
                  (ite (< o2 18446744073709551616)
                    (= o1 (bvshl #x0000000000000001 ((_ int2bv 64) o2)))
                    (= o1 #x0000000000000000))))
              (exists ((o2 (_ BitVec 64)))
                (and
                  (ite (< n 18446744073709551616)
                    (= o2 (bvshl #x0000000000000001 ((_ int2bv 64) n)))
                    (= o2 #x0000000000000000))
                  (exists ((o3 (_ BitVec 64)))
                    (and
                      (ite (< m 18446744073709551616)
                        (= o3 (bvshl #x0000000000000001 ((_ int2bv 64) 
                        m)))
