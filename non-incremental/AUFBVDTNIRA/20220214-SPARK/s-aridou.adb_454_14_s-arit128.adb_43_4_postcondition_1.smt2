  ...
  (or
    ...
    (let ((o (- m 1)))
      (and
        ...
        (and
          (and
            (forall ((o1 Int)) (big_2xx__function_guard (big_2xx o1) o1))
            (= (power (big #x00000000000000000000000000000002) o) (ite (< o 128)
                                                                    (big_2xx
                                                                    o)
                                                                    big_2xxdouble)))
          (and
            (and
              ...
              (= (power (big #x00000000000000000000000000000002) (- m 1)) 
              (big_2xx
                (- m 1))))
            (and
              (and
                (big_2xx__function_guard (big_2xx (- m 1)) (- m 1))
                (= (power (big #x00000000000000000000000000000002) m) (* 
                (big_2xx
                  (- m 1)) 2)))
              (and
                ...
                (exists ((spark__branch1 Bool))
                  (and
                    (= spark__branch1 (ite (< m 128) true false))
                    (or
                          ...
                          (and
                            ...
                            (let ((o2 (- m 1)))
                              (and
                                (in_range o2)
                                (and
                                  (bvult (ite (< o2 340282366920938463463374607431768211456)
                                           (bvshl #x00000000000000000000000000000001 
                                           (of_int
                                             o2))
                                           #x00000000000000000000000000000000) 
                                  (ite (< 127 340282366920938463463374607431768211456)
                                    (bvshl #x00000000000000000000000000000001 
                                    (of_int
                                      127))
                                    #x00000000000000000000000000000000))
                                  (and
                                    ...
                                    (ite (< m 340282366920938463463374607431768211456)
                                      ...
                                      (of_int
                                        m))
                                      #x00000000000000000000000000000000))
                                    (exists ((o3 (_ BitVec 128)))
                                      (and
                                        (ite (< m 340282366920938463463374607431768211456)
                                          (= o3 (bvshl #x00000000000000000000000000000001 
                                          (of_int
                                            m)))
                                          (= o3 #x00000000000000000000000000000000))
                                        (exists ((o4 (_ BitVec 128)))
                                          (and
                                            (let ((o5 (- m 1)))
                                              (and
                                                (in_range o5)
                                                (ite (< o5 340282366920938463463374607431768211456)
                                                  (= o4 (bvshl #x00000000000000000000000000000001 
                                                  (of_int
                                                    o5)))
                                                  (= o4 #x00000000000000000000000000000000))))
                                            (and
                                              (= (* (big o4) (big
                                                               #x00000000000000000000000000000002)) 
                                              (big
