              ...
              (or
                ...
                (let ((o1 (- m 1)))
                  (and
                    (in_range o1)
                    (and
                      (< (power (big #x00000000000000000000000000000002) o1) 
                      (power
                      ...
                      (let ((o2 (- m 1)))
                        (and
                          ...
                          (bvult (ite (< o2 340282366920938463463374607431768211456)
                                   (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) o2))
                                   #x00000000000000000000000000000000) 
                          (ite (< 127 340282366920938463463374607431768211456)
                            (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) 127))
                            #x00000000000000000000000000000000)))))))))))))))
