      ...
      (and
        ...
        (and
          (and
            ...
            (= (power (big #x0000000000000002) o) (ite (< o 64)
                                                    (big_2xx o)
                                                    big_2xxdouble)))
          (and
            (and
            ...
            (and
              ...
              (and
                ...
                (exists ((spark__branch1 Bool))
                  (and
                    (= spark__branch1 (ite (< m 64) true false))
                    (or
                      ...
                      (let ((o1 (- m 1)))
                        (and
                          (in_range o1)
                          (and
                            (< (power (big #x0000000000000002) o1) (power
                                                                    (big
                                                                    #x0000000000000002)
                                                                    63))
                            (let ((o2 (- m 1)))
                              (and
                                (in_range o2)
                                (and
                                  (bvult (ite (< o2 18446744073709551616)
                                  ...
                                  (and
                                    (= (bvmul (let ((temp___2882 (- m 1)))
                                                (ite (< temp___2882 18446744073709551616)
                                                  ...
                                                  (of_int
                                                    temp___2882))
                                                  #x0000000000000000)) #x0000000000000002) 
