...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool
  (=>
    (= temp___do_toplevel_324 true)
    (=> (= temp___is_init_322 true) (<= 0 temp___expr_326))))
...
;; Assume
(assert (and (= a (+ (* b q) r)) (< r b)))

;; Goal def'vc
;; File "s-aridou.adb", line 491, characters 0-0
(assert
  (not (= r (mod1 a b))))
