...
;; H
(assert
  (let ((temp___2974 shift))
    (or
      (not
        (= (and (ite (<= 1 j) true false) (ite (<= j temp___2974) true false)) true))
      (exists ((xx1 (_ BitVec 128)))
        (and
          (= xx1 (bvlshr xx (of_int 1)))
          (let ((o (- j 1)))
            (let ((o1 x))
              (and
                (= (bvlshr (bvlshr o1 (of_int o)) (of_int 1)) (bvlshr o1 
                (of_int
                  (+ o 1))))
                (exists ((xx2 (_ BitVec 128)) (j1 Int))
                  (and
                    (and
                      (= xx2 (bvlshr x (of_int j1)))
...
(assert
  ...
  (=>
    ...
    (= (big (bvlshr x (of_int shift))) (div1 (big x) (big_2xx shift))))))
