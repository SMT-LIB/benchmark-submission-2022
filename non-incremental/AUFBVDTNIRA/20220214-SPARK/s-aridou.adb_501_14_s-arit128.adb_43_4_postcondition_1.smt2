...
;; H
(assert
  (let ((temp___1649 shift))
    (or
      (not
        (= (and (ite (<= 1 j) true false) (ite (<= j temp___1649) true false)) true))
      (exists ((xx1 (_ BitVec 128)))
        (and
          (= xx1 (bvlshr xx ((_ int2bv 128) 1)))
          (exists ((xx2 (_ BitVec 128)) (j1 Int))
            (and
              (and
                (= xx2 (bvlshr x ((_ int2bv 128) j1)))
                (= xx2 (bvudiv x (ite (< j1 340282366920938463463374607431768211456)
                                   (bvshl #x00000000000000000000000000000001 ((_ int2bv 128) j1))
...
(assert
  ...
  (=>
    ...
    (= (big (bvlshr x ((_ int2bv 128) shift))) (div1 (big x) (big_2xx shift))))))
