  ...
  (and
    (and
      (and
        ...
        (<= shift 64))
      (= mask (bvshl #xFFFFFFFFFFFFFFFF ((_ int2bv 64) (- 64 shift)))))
    (= y (bvshl x ((_ int2bv 128) shift)))))
  ...
  (or
    ...
    (let ((o (- 128 shift)))
      (and
        ...
        (let ((o1 shift))
          (and
            (forall ((o2 Int)) (big_2xx__function_guard (big_2xx o2) o2))
            (and
              (forall ((o2 Int)) (big_2xx__function_guard (big_2xx o2) o2))
              (and
                (forall ((o2 Int) (o3 Int))
                  (big_2xx__function_guard (big_2xx (+ o3 o2)) (+ o3 o2)))
                (= (* (big_2xx o1) (big_2xx o)) (ite (= (+ o1 o) 128)
                                                  big_2xxdouble
                                                  (big_2xx (+ o1 o))))))))))))
