...
(assert
  (forall ((x (_ BitVec 32)) (y (_ BitVec 32)))
    (= (bv2nat32 (bv_min1 x y)) (min (bv2nat32 x) (bv2nat32 y)))))

;; bv_max_to_uint
(assert
  (forall ((x (_ BitVec 32)) (y (_ BitVec 32)))
    (= (bv2nat32 (bv_max1 x y)) (max (bv2nat32 x) (bv2nat32 y)))))
...
;; bool_eq
(define-fun bool_eq4 ((x1 (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (= x1 y) true false))
...
(assert
  (not
  (= (* big_2xxsingle (big1 ((_ zero_extend 32) x))) (big1
