              ...
              (ite (= spark__branch true)
                (and
                  ...
                  (or
                    (= spark__branch5 true)
                    (and
                      (= (bvadd (uc_of_int x) (uc_of_int y)) (bvsub #x80000000000000000000000000000000 
                      (of_int
                        (- y))))
                      (and
                        (bvuge (bvadd (uc_of_int x) (uc_of_int y)) #x80000000000000000000000000000000)
                        (= y 0)))))
                (and
                  ...
                  (and
                    ...
                    (and
                      (= spark__branch2 (ite (<= y 0) true false))
                      (ite (= spark__branch2 true)
                        (= (bvadd (uc_of_int x) (uc_of_int y)) (bvsub (bvneg 
                        (of_int
                          (- x))) (of_int (- y))))
                        (let ((o y))
                          (let ((o1 (uc_of_int o)))
                            (and
                              (and
                                (to_uns__function_guard o1 o)
                                (dynamic_invariant1 o1 true false true true))
                              (let ((o2 x))
                                (let ((o3 (uc_of_int o2)))
                                  (and
                                    (and
                                      (to_uns__function_guard o3 o2)
                                      (dynamic_invariant1
                                        o3
                                        true
                                        false
                                    ...
                                    (and
                                      ...
                                      (and
                                        (dynamic_invariant1
                                          ...
                                          true)
                                        (and
                                          (= ru (bvadd (bvneg (of_int (- x))) 
                                          (of_int
                                            y)))
                                          (and
                                            (= spark__branch3 (ite (bvult 
                                                                ru #x80000000000000000000000000000000)
                                                                true
                                                                false))
                                              ...
                                              (and
                                                ...
                                                (and
                                                  (not
                                                    (= spark__branch4 true))
                                                  (and
                                                    (= r (- (bv2nat128 (bvneg (bvadd (bvneg 
                                                    (of_int
                                                      (- x))) (of_int y))))))
                                                    (= r (- (bv2nat128 (bvadd (bvneg 
                                                    (of_int
                                                      y)) (of_int (- x))))))))))))))))))))))))))))))))
