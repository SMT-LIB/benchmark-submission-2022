              ...
              (ite (= spark__branch true)
                (and
                  ...
                  (or
                    (= spark__branch5 true)
                    (and
                      (= (bvadd (uc_of_int x) (uc_of_int y)) (bvsub #x8000000000000000 
                      (of_int
                        (- y))))
                      (and
                        (bvuge (bvadd (uc_of_int x) (uc_of_int y)) #x8000000000000000)
                        (= y 0)))))
                (and
                  (= spark__branch1 (ite (= y (- 9223372036854775808))
                                      true
                                      false))
                  (and
                                              ...
                                              (and
                                                ...
                                                (and
                                                  (not
                                                    (= spark__branch4 true))
                                                  (and
                                                    (= r (- (bv2nat64 (bvneg (bvadd (bvneg 
                                                    (of_int
                                                      (- x))) (of_int y))))))
                                                    (= r (- (bv2nat64 (bvadd (bvneg 
                                                    (of_int
                                                      y)) (of_int (- x))))))))))))))))))))))))))))))))
