...
(assert
  (ite (<= 0 y)
    (= o true)
    (= o (ite (= y (- 170141183460469231731687303715884105728)) true false))))
...
(assert
  (or
    ...
    (and
      ...
      (and
        (to_uns__function_guard (uc_of_int y) y)
        (= (bvadd (uc_of_int x) (uc_of_int y)) (bvsub (of_int x) (of_int
                                                                   (- 
                                                                   y))))))))

;; Goal def'vc
;; File "s-aridou.adb", line 613, characters 0-0
(assert
