...
;; user_eq
(declare-fun user_eq (int64
  int64) Bool)

(declare-const dummy int64)
...
;; bool_eq
(define-fun bool_eq2 ((x1 (_ BitVec 64)) (y1 (_ BitVec 64))) Bool
  (ite (= x1 y1) true false))
...
;; user_eq
(declare-fun user_eq2 (tinteger_64B
  tinteger_64B) Bool)

(declare-const dummy2 tinteger_64B)
...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= x (- 9223372036854775808)) true false))

(declare-const spark__branch Bool)

;; H
(assert (= spark__branch (ite (= x (- 9223372036854775808)) true false)))
...
(define-fun lpeqrpqtresultqtunusedqtunused1 () Bool
  (ite (= y (- 9223372036854775808)) true false))

(declare-const spark__branch1 Bool)

;; H
(assert (= spark__branch1 (ite (= y (- 9223372036854775808)) true false)))
...
;; H
(assert (= spark__branch3 (ite (bvult ru #x8000000000000000) true false)))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= ru #x8000000000000000) true false))

(declare-const spark__branch4 Bool)

;; H
(assert (= spark__branch4 (ite (= ru #x8000000000000000) true false)))

;; H
(assert (= spark__branch4 true))

;; Assert
(assert (bvult (of_int y) #x8000000000000000))

;; Goal def'vc
;; File "s-aridou.adb", line 607, characters 0-0
(assert
  (not (bvult (of_int (- x)) #x8000000000000000)))
