...
;; Assume
(assert (ite (<= 0 x) (and (<= 0 y) (< r 0)) (and (<= y 0) (<= 0 r))))
...
(assert
  (ite (< x 0)
    (= o (ite (= x (- 170141183460469231731687303715884105728)) false true))
    (= o false)))
...
(assert
  (ite (= o true)
    (= spark__branch (ite (= y (- 170141183460469231731687303715884105728))
                       false
                       true))
    (= spark__branch false)))
...
;; Goal def'vc
;; File "s-aridou.adb", line 619, characters 0-0
(assert
  (not
  (=>
    (to_uns__function_guard (uc_of_int x) x)
