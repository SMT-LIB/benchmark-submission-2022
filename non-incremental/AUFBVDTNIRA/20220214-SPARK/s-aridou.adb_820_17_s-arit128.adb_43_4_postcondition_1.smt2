...
;; Assume
(assert (dynamic_invariant1 du true false true true))
  ...
  (and
    (and
      (and
        ...
        (= (big1 ru) (abs1 big_r)))
      (= (big1 du) mult))
    (= (big1 qu) (ite (bvugt ru (bvudiv (bvsub du #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                   (+ (abs1 quot) 1)
                   (abs1 quot)))))
...
;; Goal def'vc
;; File "s-aridou.adb", line 806, characters 0-0
(assert
  (not (= (abs1 big_q) (big1 qu))))
