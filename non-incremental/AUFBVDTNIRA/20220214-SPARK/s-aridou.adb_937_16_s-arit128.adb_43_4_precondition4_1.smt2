...
(define-fun neqqtresultqtunusedqtunused1 () Bool
  (ite (not (= zhi #x0000000000000000)) true false))

(declare-const spark__branch3 Bool)

;; H
(assert (= spark__branch3 (ite (not (= zhi #x0000000000000000)) true false)))
...
(assert
  (ite (= yhi #x0000000000000001)
    (= o1 (ite (= zhi #x0000000000000001) true false))
    (= o1 false)))
...
(assert
  (ite (= o1 true)
    (= o2 (ite (= ylo #x0000000000000000) true false))
    (= o2 false)))
...
(assert
  (ite (= o2 true)
    (= o3 (ite (= zlo #x0000000000000000) true false))
    (= o3 false)))
...
;; H
(assert (= spark__branch4 (ite (= o true) round false)))
...
;; Assert
(assert (bvuge (omultiply yhi zhi) ((_ zero_extend 64) yhi)))

;; Assert
(assert (bvuge (omultiply yhi zhi) ((_ zero_extend 64) zhi)))

;; Assert
(assert (<= 1 (big1 (omultiply yhi zhi))))

(declare-const spark__branch5 Bool)

;; H
(assert
  (= spark__branch5 (ite (bvugt yhi #x0000000000000001)
                      true
                      (ite (bvugt zhi #x0000000000000001) true false))))
...
(assert
  (ite (= spark__branch5 true)
    ...
    (and
      (= spark__branch6 (ite (bvugt zlo #x0000000000000000) true false))
      (ite (= spark__branch6 true)
        (< 0 (big1 (omultiply yhi zlo)))
        (and
          (= spark__branch7 (ite (bvugt ylo #x0000000000000000) true false))
          (or (not (= spark__branch7 true)) (< 0 (big1 (omultiply ylo zhi)))))))))

;; Goal def'vc
;; File "s-aridou.ads", line 151, characters 0-0
(assert
  (not (<= big_2xxdouble mult)))
