...
(define-fun neqqtresultqtunusedqtunused1 () Bool
  (ite (not (= zhi #x00000000)) true false))

(declare-const spark__branch3 Bool)

;; H
(assert (= spark__branch3 (ite (not (= zhi #x00000000)) true false)))
...
(assert
  (ite (= yhi #x00000001)
    (= o1 (ite (= zhi #x00000001) true false))
    (= o1 false)))
...
;; H
(assert
  (ite (= o1 true) (= o2 (ite (= ylo #x00000000) true false)) (= o2 false)))

(declare-const o3 Bool)

;; H
(assert
  (ite (= o2 true) (= o3 (ite (= zlo #x00000000) true false)) (= o3 false)))
...
;; Assert
(assert (bvuge (omultiply yhi zhi) ((_ zero_extend 32) yhi)))

;; Assert
(assert (bvuge (omultiply yhi zhi) ((_ zero_extend 32) zhi)))
...
;; H
(assert
  (= spark__branch5 (ite (bvugt yhi #x00000001)
                      true
                      (ite (bvugt zhi #x00000001) true false))))
...
(assert
  (ite (= spark__branch5 true)
    ...
    (and
      (= spark__branch6 (ite (bvugt zlo #x00000000) true false))
      (ite (= spark__branch6 true)
        (< 0 (big1 (omultiply yhi zlo)))
        (and
          (= spark__branch7 (ite (bvugt ylo #x00000000) true false))
