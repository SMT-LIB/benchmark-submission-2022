...
;; H
(assert
  (let ((o xu)) (= (hi o) ((_ extract 63 0) (bvlshr o ((_ int2bv 128) 64))))))
...
;; H
(assert
  (let ((o yu)) (= (hi o) ((_ extract 63 0) (bvlshr o ((_ int2bv 128) 64))))))
...
(assert
  (let ((o (lo t11)))
    (let ((o1 (lo t22)))
      (= (oconcat o1 o) (bvor (bvshl ((_ zero_extend 64) o1) ((_ int2bv 128) 64)) ((_ zero_extend 64) o))))))
