...
;; user_eq
(declare-fun user_eq4 (tinteger_128B
  tinteger_128B) Bool)

(declare-const dummy4 tinteger_128B)
...
(declare-const ada___system__arith_128__impl__multiply_with_ovflo_check__result Int)
...
;; H
(assert (let ((o xu)) (hi__function_guard (hi o) o)))

;; H
(assert (dynamic_invariant2 (hi xu) true false true true))

;; H
(assert (let ((o xu)) (= (hi o) ((_ extract 63 0) (bvlshr o (of_int1 64))))))
...
;; H
(assert (dynamic_invariant2 (lo xu) true false true true))
        ...
        (let ((o3 xhi))
          (= mult (+ (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                (omultiply
                                                                  o3
                                                                  o1))) (* 
          big_2xxsingle (big1 (omultiply o3 o)))) (* big_2xxsingle (big1
                                                                    (omultiply
                                                                    o2
                                                                    o1)))) 
          (big1
...
;; H
(assert (= spark__branch1 (ite (not (= xhi #x0000000000000000)) true false)))

;; H
(assert
  (ite (= spark__branch1 true)
    (and
      (= spark__branch (ite (not (= yhi #x0000000000000000)) true false))
      (and
          ...
          (let ((o1 xhi))
            (let ((o2 (omultiply o1 o)))
              (and
                ...
                (and
                  (= t21 o2)
                  (= (big1 t21) (+ (big1 (omultiply xhi ylo)) (big1
                                                                (omultiply
                                                                  xlo
                                                                  yhi)))))))))))
    (and
                ...
                (and
                  ...
                  (= (big1 t21) (+ (big1 (omultiply xhi ylo)) (big1
                                                                (omultiply
                                                                  xlo
                                                                  yhi)))))))))
        (= t21 #x00000000000000000000000000000000)))))

;; H
(assert (dynamic_invariant1 (omultiply xlo ylo) true false true true))

;; H
(assert
  (let ((o ylo))
    (let ((o1 xlo))
      (= (omultiply o1 o) (bvmul ((_ zero_extend 64) o1) ((_ zero_extend 64) o))))))
...
;; H
(assert
  (= (big1 t21) (+ (big1 (omultiply xhi ylo)) (big1 (omultiply xlo yhi)))))

;; H
(assert (dynamic_invariant1 (omultiply xlo yhi) true false true true))
...
;; H
(assert (let ((o (omultiply xlo yhi))) (= (big1 o) (bv2nat128 o))))

;; H
(assert (dynamic_invariant1 (omultiply xhi ylo) true false true true))
...
;; H
(assert (let ((o (omultiply xhi ylo))) (= (big1 o) (bv2nat128 o))))

;; H
(assert
  (let ((o (big1 (omultiply xlo yhi))))
    (let ((o1 (big1 (omultiply xhi ylo))))
      (let ((o2 big_2xxsingle)) (= (* o2 (+ o1 o)) (+ (* o2 o1) (* o2 o)))))))
...
(assert
  (let ((o (hi t11)))
    (= (+ (big1 t21) (big1 ((_ zero_extend 64) o))) (big1
                                                      (bvadd t21 ((_ zero_extend 64) o))))))
...
(assert
  (and
    ...
    (and
      (hi__function_guard (hi t11) t11)
      (= (big1 (oadd t21 (hi t11))) (+ (big1 t21) (big1
                                                    ((_ zero_extend 64) 
                                                    (hi
                                                      t11))))))))
...
;; H
(assert
  (let ((o (hi t11))) (= (oadd t21 o) (bvadd t21 ((_ zero_extend 64) o)))))
...
;; H
(assert
  (= spark__branch2 (ite (not (= (hi t22) #x0000000000000000)) true false)))
...
(assert
  (and
    ...
    (= mult (big1 (oconcat (lo t22) (lo t11))))))
...
(assert
  (let ((o (lo t11)))
    (let ((o1 (lo t22))) (oconcat__function_guard (oconcat o1 o) o1 o))))
...
(assert
  (let ((o (lo t11)))
    (let ((o1 (lo t22)))
      (= (oconcat o1 o) (bvor (bvshl ((_ zero_extend 64) o1) (of_int1 64)) ((_ zero_extend 64) o))))))

(declare-const t23 (_ BitVec 128))

;; H
(assert (= t23 (oconcat (lo t22) (lo t11))))

;; H
(assert (= mult (big1 t23)))

(declare-const spark__branch3 Bool)

;; H
(assert (= spark__branch3 (ite (<= 0 x) true false)))
...
(assert
  (and
    (to_pos_int__function_guard (to_pos_int t23) t23)
    (and
      (to_neg_int__function_guard (to_neg_int t23) t23)
      (and
        (to_pos_int__function_guard (to_pos_int t23) t23)
        (and
          (to_neg_int__function_guard (to_neg_int t23) t23)
          (ite (= spark__branch3 true)
            (and
              (= spark__branch5 (ite (<= 0 y) true false))
              (ite (= spark__branch5 true)
                (and
                  (and
                    (= (in_double_int_range (big1 t23)) true)
                    (= (to_pos_int t23) (* x y)))
                  (let ((o (to_pos_int t23)))
                    (and
                      (and
                        (to_pos_int__function_guard o t23)
                        (and
                          (dynamic_invariant o true false true true)
                          (= (big o) (big1 t23))))
                      (= ada___system__arith_128__impl__multiply_with_ovflo_check__result o))))
                (and
                  (= (to_neg_int t23) (* x y))
                  (let ((o (to_neg_int t23)))
                    (and
                      (and
                        (to_neg_int__function_guard o t23)
                        (and
                          (dynamic_invariant o true false true true)
                          (= (big o) (- (big1 t23)))))
                      (= ada___system__arith_128__impl__multiply_with_ovflo_check__result o))))))
            (and
              (= spark__branch4 (ite (< y 0) true false))
...
;; Goal def'vc
;; File "s-aridou.ads", line 100, characters 0-0
(assert
  (not
  (= ada___system__arith_128__impl__multiply_with_ovflo_check__result (* 
  x y))))
