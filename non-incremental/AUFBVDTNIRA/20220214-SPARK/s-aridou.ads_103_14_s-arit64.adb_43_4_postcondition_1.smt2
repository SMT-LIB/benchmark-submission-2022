...
(declare-const ada___system__arith_64__impl__multiply_with_ovflo_check__result Int)
...
;; H
(assert
  (let ((o xu)) (= (hi o) ((_ extract 31 0) (bvlshr o ((_ int2bv 64) 32))))))
...
;; H
(assert
  (let ((o xu)) (= (lo o) ((_ extract 31 0) (bvand o #x00000000FFFFFFFF)))))
...
(assert
  (let ((o ylo))
    (let ((o1 xlo))
      (= (omultiply o1 o) (bvmul ((_ zero_extend 32) o1) ((_ zero_extend 32) o))))))
...
;; H
(assert
  (let ((o (hi t11))) (= (oadd t21 o) (bvadd t21 ((_ zero_extend 32) o)))))
...
(assert
  (let ((o (lo t11)))
    (let ((o1 (lo t22)))
      (= (oconcat o1 o) (bvor (bvshl ((_ zero_extend 32) o1) ((_ int2bv 64) 32)) ((_ zero_extend 32) o))))))
          ...
          (and
            (and
              ...
              (and
                ...
                (= (big o) (big1 t23))))
            (= ada___system__arith_64__impl__multiply_with_ovflo_check__result o)))
...
(assert
  (not
  (= ada___system__arith_64__impl__multiply_with_ovflo_check__result (* 
  x y))))
