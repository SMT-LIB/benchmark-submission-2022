...
(assert
  (ite (and (<= 0 x) (<= 0 y))
    (= o67 true)
    (= o67 (ite (< x 0) (ite (< y 0) true false) false))))

(declare-const spark__branch16 Bool)

;; H
(assert (= spark__branch16 o67))
...
(assert
  (ite (= spark__branch16 true)
    (let ((o70 (to_pos_int ru1)))
      (and
        (and
          (to_pos_int__function_guard o70 ru1)
          (and
            (dynamic_invariant1 o70 true false true true)
            (= (big o70) (big1 ru1))))
        (and
          (= r1 o70)
          (and
            (ite (< 0 z)
              (and
                (= o69 (to_pos_int qu2))
                (and
                  (to_pos_int__function_guard o69 qu2)
                  (and
                    (dynamic_invariant1 o69 true false true true)
                    (= (big o69) (big1 qu2)))))
              (and
                (= o69 (to_neg_int qu2))
                (and
                  (to_neg_int__function_guard o69 qu2)
                  (and
                    (dynamic_invariant1 o69 true false true true)
                    (= (big o69) (- (big1 qu2)))))))
            (= q1 o69)))))
    (let ((o70 (to_neg_int ru1)))
      (and
        (and
          (to_neg_int__function_guard o70 ru1)
          (and
            (dynamic_invariant1 o70 true false true true)
            (= (big o70) (- (big1 ru1)))))
        (and
          ...
          (and
            (ite (< 0 z)
              (and
                (= o68 (to_neg_int qu2))
                (and
                  (to_neg_int__function_guard o68 qu2)
                  (and
                    (dynamic_invariant1 o68 true false true true)
                    (= (big o68) (- (big1 qu2))))))
              (and
                (= o68 (to_pos_int qu2))
                (and
                  (to_pos_int__function_guard o68 qu2)
                  (and
                    (dynamic_invariant1 o68 true false true true)
                    (= (big o68) (big1 qu2))))))
            (= q1 o68)))))))
...
(assert
  (not
  (=> (not (= round true)) (= (big q1) (div1 (* (big x) (big y)) (big z))))))
