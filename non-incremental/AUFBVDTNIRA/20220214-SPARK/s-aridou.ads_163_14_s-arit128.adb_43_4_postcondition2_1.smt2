...
(assert
  (let ((o x))
    (= (oabs o) (ite (= o (- 170141183460469231731687303715884105728))
                  #x80000000000000000000000000000000
                  (of_int1 (abs1 o))))))
...
;; H
(assert (let ((o yu)) (= (hi o) ((_ extract 63 0) (bvlshr o (of_int1 64))))))
...
(assert
  (let ((o yu))
    (= (lo o) ((_ extract 63 0) (bvand o #x0000000000000000FFFFFFFFFFFFFFFF)))))
...
;; H
(assert (let ((o zu)) (= (hi o) ((_ extract 63 0) (bvlshr o (of_int1 64))))))
...
(assert
  (ite (= yu #x00000000000000000000000000000000)
    (= o true)
    (= o (ite (= zu #x00000000000000000000000000000000) true false))))
...
(assert
  (let ((o1 (big z)))
    (let ((o2 (big y))) (= (abs1 (* o2 o1)) (* (abs1 o2) (abs1 o1))))))
        ...
        (let ((o4 yhi))
          (= mult (+ (+ (+ (* (* big_2xxsingle big_2xxsingle) (big1
                                                                (omultiply
                                                                  o4
                                                                  o2))) (* 
          big_2xxsingle (big1 (omultiply o4 o1)))) (* big_2xxsingle (big1
                                                                    (omultiply
                                                                    o3
                                                                    o2)))) 
          (big1
...
(assert
  (or
    (exists ((spark__branch2 Bool))
      (and
        (= spark__branch2 (ite (not (= yhi #x0000000000000000)) true false))
        (and
          (= spark__branch2 true)
          (exists ((spark__branch3 Bool))
            (and
              (= spark__branch3 (ite (not (= zhi #x0000000000000000))
                                  true
                                  false))
              (and
                (= spark__branch3 true)
                        ...
                        (and
                          (exists ((o3 Bool))
                            (and
                              (exists ((o4 Bool))
                                (and
                                  (ite (= yhi #x0000000000000001)
                                    (= o4 (ite (= zhi #x0000000000000001)
                                            true
                                            false))
                                    (= o4 false))
                                  (ite (= o4 true)
                                    (= o3 (ite (= ylo #x0000000000000000)
                                            true
                                            false))
                                    (= o3 false))))
                              (ite (= o3 true)
                                (= o2 (ite (= zlo #x0000000000000000)
                                        true
                                        false))
                                (= o2 false))))
                          (ite (= o2 true)
                            (= o1 (ite (= x (- 170141183460469231731687303715884105728))
                                    true
                                    false))
                            (= o1 false))))
                        ...
                        (and
                          ...
                          (ite (= spark__branch4 true)
                            ...
                            (and
                              (= q1 0)
                              (and
                                (bvuge (omultiply yhi zhi) ((_ zero_extend 64) 
                                yhi))
                                (and
                                  (bvuge (omultiply yhi zhi) ((_ zero_extend 64) 
                                  zhi))
                                  (and
                                    (<= 1 (big1 (omultiply yhi zhi)))
                                    (and
                                      (exists ((spark__branch5 Bool))
                                        (and
                                          (= spark__branch5 (ite (bvugt 
                                                              yhi #x0000000000000001)
                                                              true
                                                              (ite (bvugt 
                                                                zhi #x0000000000000001)
                                                                true
                                                                false)))
                                          (ite (= spark__branch5 true)
                                            ...
                                            (exists ((spark__branch6 Bool))
                                              (and
                                                (= spark__branch6 (ite (bvugt 
                                                                    zlo #x0000000000000000)
                                                                    true
                                                                    false))
                                                (ite (= spark__branch6 true)
                                                  ...
                                                  (exists ((spark__branch7 Bool))
                                                    (and
                                                      (= spark__branch7 
                                                      (ite (bvugt ylo #x0000000000000000)
                                                        true
                                                        false))
                                                      (or
                                                        (not
                                      ...
                                      (and
                                        ...
                                        (ite (= round true)
                                          ...
                                          (= (big q1) (div1
                                                        ...
                                                        (* (big y) (big z)))))))))))))))))))))))
    (and
      (forall ((t11 (_ BitVec 128))) (hi__function_guard (hi t11) t11))
      (and
        (forall ((t21 (_ BitVec 128))) (hi__function_guard (hi t21) t21))
        (and
          (forall ((t21 (_ BitVec 128))) (hi__function_guard (hi t21) t21))
          (and
            (forall ((t21 (_ BitVec 128))) (hi__function_guard (hi t21) t21))
            (exists ((spark__branch2 Bool) (t21 (_ BitVec 128)))
              (and
                (exists ((spark__branch3 Bool))
                  (and
                    (= spark__branch3 (ite (not (= yhi #x0000000000000000))
                                        true
                                        false))
                    (ite (= spark__branch3 true)
                      (and
                        (= spark__branch2 (ite (not
                                                 (= zhi #x0000000000000000))
                                            true
                                            false))
                        (and
                                ...
                                (and
                                  (and
                                    (dynamic_invariant1
                                      ...
                                      true
                                      true)
                                    (= o3 (bvmul ((_ zero_extend 64) o2) ((_ zero_extend 64) o1))))
                                  (and
                                    (= t21 o3)
                                    (= (big1 t21) (big1 (omultiply yhi zlo))))))))))
                      (and
                        (let ((o1 zhi))
                          (let ((o2 ylo))
                            (let ((o3 (omultiply o2 o1)))
                              (and
                                ...
                                (and
                                  (= t21 o3)
                                  (= (big1 t21) (big1 (omultiply ylo zhi))))))))
                                    ...
                                    (and
                                      (and
                                        (dynamic_invariant1
                                          ...
                                          true
                                          true)
                                        (= o6 (bvmul ((_ zero_extend 64) o5) ((_ zero_extend 64) o4))))
                                      (let ((o7 (big1 o6)))
                                        (and
                                          (= o7 (bv2nat128 o6))
                                          (let ((o8 zlo))
                                            (let ((o9 yhi))
                                              (let ((o10 (omultiply o9 o8)))
                                                (and
                                                  (and
                                                    (dynamic_invariant1
                                                      o10
                                                      ...
                                                      true
                                                      true)
                                                    (= o10 (bvmul ((_ zero_extend 64) o9) ((_ zero_extend 64) o8))))
                                                  (let ((o11 (big1 o10)))
                                                    (and
                                                      (= o11 (bv2nat128 o10))
                                                      (let ((o12 big_2xxsingle))
                                                        (and
                                                          (= (* o12 (+ o11 o7)) (+ (* o12 o11) (* o12 o7)))
                                                          (and
                                                            (= mult (+ (* 
                                                            big_2xxsingle 
                                                            (big1
                                                              ...
                                                              (and
                                                                (and
                                                                  (dynamic_invariant2
                                                                    ...
                                                                    true
                                                                    true)
                                                                  (= o13 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                (let ((o14 
                                                                  (hi
                                                                    t11)))
                                                                  (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o15 ((_ extract 63 0) (bvlshr t11 
                                                                    (of_int1
                                                                    64))))))
                                                                    (let ((o16 ((_ zero_extend 64) o15)))
                                                                    (let ((o17 
                                                                    (big1
                                                                    o16)))
                                                                    (and
                                                                    ...
                                                                    t21) 
                                                                    (big1
                                                                    ((_ zero_extend 64) o20))) 
                                                                    (big1
                                                                    (bvadd t21 ((_ zero_extend 64) o20))))
                                                                    (let ((o21 
                                                                    (hi
                                                                    t11)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o22 (bvadd t21 ((_ zero_extend 64) o21))))
                                                                    (exists 
                                                                    ((t22 (_ BitVec 128)))
                                                                    (and
                                                                    (= t22 o22)
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o23 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (let ((o24 
                                                                    (hi
                                                                    t22)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o25 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (let ((o26 ((_ zero_extend 64) o25)))
                                                                    (let ((o27 
                                                                    (big1
                                                                    o26)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o28 ((_ extract 63 0) (bvlshr t22 
                                                                    (of_int1
                                                                    64))))))
                                                                    (let ((o29 ((_ zero_extend 64) o28)))
                                                                    (let ((o30 
                                                                    (big1
                                                                    o29)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o36 ((_ extract 63 0) (bvlshr t22 
                                                                    (of_int1
                                                                    64))))))
                                                                    (ite (= o36 #x0000000000000001)
                                                                    (let ((o37 
                                                                    (lo
                                                                    t22)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o37 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (= o35 
                                                                    (ite (= o37 #x0000000000000000)
                                                                    true
                                                                    false))))
                                                                    (= o35 false))))
                                                                    (ite (= o35 true)
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o36 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (= o34 
                                                                    (ite (= o36 #x0000000000000000)
                                                                    true
                                                                    false))))
                                                                    (= o34 false))))
                                                                    (ite (= o34 true)
                                                                    ...
                                                                    (and
                                                                    (= spark__branch5 
                                                                    (ite (bvugt o34 #x0000000000000001)
                                                                    true
                                                                    false))
                                                                    (ite (= spark__branch5 true)
                                                                    (< 1 
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o35 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (exists 
                                                                    ((spark__branch6 Bool))
                                                                    (and
                                                                    (= spark__branch6 
                                                                    (ite (bvugt o35 #x0000000000000000)
                                                                    true
                                                                    false))
                                                                    (ite (= spark__branch6 true)
                                                                    (< 0 
                                                                    ...
                                                                    (and
                                                                    (= spark__branch7 
                                                                    (ite (bvugt o36 #x0000000000000000)
                                                                    true
                                                                    false))
                                                                    (or
                                                                    (not
                                                                    (= spark__branch7 true))
                                                                    (and
                                                                    (bvugt ((_ zero_extend 64) 
                                                                    (lo
                                                                    t11)) #x00000000000000000000000000000000)
                                                                    (let ((o37 
                                                                    (lo
                                                                    t11)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o37 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (and
                                                                    (< 
                                                                    (big1
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o33 ((_ extract 63 0) (bvand t11 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (let ((o34 
                                                                    (lo
                                                                    t22)))
                                                                    (and
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o34 ((_ extract 63 0) (bvand t22 #x0000000000000000FFFFFFFFFFFFFFFF))))
                                                                    (let ((o35 
                                                                    (oconcat
                                                                    o34
                                                                    o33)))
                                                                    ...
                                                                    true
                                                                    true)
                                                                    (= o35 (bvor (bvshl ((_ zero_extend 64) o34) 
                                                                    (of_int1
                                                                    64)) ((_ zero_extend 64) o33)))))
                                                                    (exists 
                                                                    ((du1 (_ BitVec 128)))
                                                                    (and
                                                                    (= du1 o35)
                                                                    ...
                                                                    (and
                                                                    (not
                                                                    (= du1 #x00000000000000000000000000000000))
                                                                    (exists 
                                                                    ((spark__branch4 Bool))
                                                                    (and
                                                                    (exists 
                                                                    ...
                                                                    x (- 170141183460469231731687303715884105728))
                                                                    (= o39 
                                                                    (ite (= du1 #x00000000000000000000000000000001)
                                                                    true
                                                                    false))
                                                                    (= o39 false))
                                                                    (ite (= o39 true)
                                                                    ...
                                                                    ru1))
                                                                    (exists 
                                                                    ((spark__branch5 Bool) (qu2 (_ BitVec 128)))
                                                                    (and
                                                                    (exists 
                                                                    ((spark__branch6 Bool))
                                                                    (and
                                                                    ...
                                                                    (and
                                                                    (= spark__branch5 
                                                                    (ite (bvugt ru1 (bvudiv (bvsub du1 #x00000000000000000000000000000001) #x00000000000000000000000000000002))
                                                                    true
                                                                    false))
                                                                    (ite (= spark__branch5 true)
                                                                    (and
                                                                    ...
                                                                    qu1) 
                                                                    (big1
                                                                    ((_ zero_extend 64) #x0000000000000001))) 
                                                                    (big1
