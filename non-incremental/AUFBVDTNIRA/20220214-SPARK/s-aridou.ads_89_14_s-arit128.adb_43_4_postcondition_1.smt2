...
(declare-const ada___system__arith_128__impl__add_with_ovflo_check__result Int)
...
;; H
(assert
  (let ((o (bvadd (uc_of_int x) (uc_of_int y))))
...
(assert
  (ite (= spark__branch true)
    (and
      (= spark__branch2 (ite (< y 0) true (ite (<= 0 r) true false)))
      (and
        (= spark__branch2 true)
        (= ada___system__arith_128__impl__add_with_ovflo_check__result 
        r)))
    (and
      (= spark__branch1 (ite (< 0 y) true (ite (< r 0) true false)))
      (and
        (= spark__branch1 true)
        (= ada___system__arith_128__impl__add_with_ovflo_check__result 
        r)))))
...
;; Goal def'vc
;; File "s-aridou.ads", line 86, characters 0-0
(assert
  (not
  (= ada___system__arith_128__impl__add_with_ovflo_check__result (+ x 
  y))))
