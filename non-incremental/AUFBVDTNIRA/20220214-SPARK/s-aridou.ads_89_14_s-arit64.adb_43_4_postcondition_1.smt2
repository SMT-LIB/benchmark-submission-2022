...
(declare-const ada___system__arith_64__impl__add_with_ovflo_check__result Int)
...
(assert
  (ite (= spark__branch true)
    (and
      ...
      (and
        (= spark__branch2 true)
        (= ada___system__arith_64__impl__add_with_ovflo_check__result 
        r)))
    (and
...
(assert
  (not
  (= ada___system__arith_64__impl__add_with_ovflo_check__result (+ x 
  y))))
