...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_256 (_ BitVec 64)) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool
  true)
...
(assert (= big_2xx32 (+ (big #xFFFFFFFF) 1)))
...
;; Assume
(assert (= (+ (big #xFFFFFFFF) 1) big_2xx32))

;; Assume
(assert (dynamic_invariant1 xu true false true true))

;; Assume
(assert (dynamic_invariant xhi true false true true))

;; Assume
(assert (dynamic_invariant xlo true false true true))
...
;; Goal def'vc
;; File "s-arit32.adb", line 172, characters 0-0
(assert
  (not (= (big1 xu) (+ (* big_2xx32 (big xhi)) (big xlo)))))
