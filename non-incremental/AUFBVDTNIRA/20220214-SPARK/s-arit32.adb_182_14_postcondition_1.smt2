...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_256 (_ BitVec 64)) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool
  true)
...
(assert (= big_2xx64 (+ (big #xFFFFFFFFFFFFFFFF) 1)))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool
  true)
...
;; Assume
(assert (= (+ (big #xFFFFFFFFFFFFFFFF) 1) big_2xx64))
...
;; Assume
(assert (and (< (* (big x) (big y)) big_2xx64) (= z (bvmul x y))))

;; Goal def'vc
;; File "s-arit32.adb", line 178, characters 0-0
(assert
