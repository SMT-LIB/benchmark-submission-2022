...
(assert
  (forall ((arg Int))
    (! (=
         ...
         (= (in_range arg (big (- 2147483648)) (big 2147483647)) true)) :pattern (
    (in_int32_range
      arg)) )))
...
;; user_eq
(declare-fun user_eq2 (int32
  int32) Bool)

(declare-const dummy2 int32)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool
  (=>
...
;; Goal def'vc
;; File "s-arit32.adb", line 210, characters 0-0
(assert
  (not (not (= (in_int32_range (- big_2xx32)) true))))
