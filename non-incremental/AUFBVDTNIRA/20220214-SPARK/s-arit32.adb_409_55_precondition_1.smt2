...
(assert
  (ite (= o2 true)
    (let ((o5 (big1 ru)))
      (and (= o5 (bv2nat ru)) (= o4 (ite (= o5 (abs1 big_r)) true false))))
    (= o4 false)))
...
(assert
  (ite (= o4 true)
    (let ((o6 (big1 qu)))
      (and (= o6 (bv2nat qu)) (= o5 (ite (= o6 (abs1 big_q)) true false))))
    (= o5 false)))
...
(assert
  (ite (= o5 true)
    (and
      (= o6 (in_int32_range big_q))
      (=
        (= o6 true)
        (= (in_range2 big_q (big (- 2147483648)) (big 2147483647)) true)))
    (= o6 false)))
...
(assert
  (ite (= o6 true)
    (and
      (= o7 (in_int32_range big_r))
      (=
        (= o7 true)
        (= (in_range2 big_r (big (- 2147483648)) (big 2147483647)) true)))
    (= o7 false)))
...
;; Goal def'vc
;; File "s-arit32.adb", line 392, characters 0-0
(assert
  (not (= (in_int32_range (big1 qu)) true)))
