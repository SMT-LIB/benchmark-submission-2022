...
;; H
(assert
  (= spark__branch4 (ite (bvugt ru1 (bvudiv (bvsub zu #x00000001) #x00000002))
                      true
                      false)))
...
;; Assert
(assert (= (abs1 big_q1) (+ (big1 qu1) 1)))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= qu1 #xFFFFFFFF) true false))

(declare-const spark__branch5 Bool)

;; H
(assert (= spark__branch5 (ite (= qu1 #xFFFFFFFF) true false)))

;; H
(assert (= spark__branch5 true))

;; Assert
(assert (= (abs1 big_q1) big_2xx32))

;; H
(assert (not (= (in_int32_range big_2xx32) true)))
