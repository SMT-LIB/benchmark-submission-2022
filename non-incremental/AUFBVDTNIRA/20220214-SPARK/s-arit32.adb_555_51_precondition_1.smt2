...
(assert
  (ite (and (<= 0 x) (<= 0 y))
    (= spark__branch6 true)
    (= spark__branch6 (ite (< x 0) (ite (< y 0) true false) false))))

;; H
(assert (= spark__branch6 true))

;; Ensures
(assert (ite (< 0 z) (<= big_0 big_q1) (<= big_q1 big_0)))

;; H
(assert (to_pos_int__function_guard (to_pos_int ru1) ru1))

;; H
(assert (dynamic_invariant (to_pos_int ru1) true false true true))
...
(assert
  (not (= (in_int32_range (- (big1 qu2))) true)))
