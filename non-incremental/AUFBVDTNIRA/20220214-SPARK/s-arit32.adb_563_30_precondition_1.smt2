...
(assert
  (forall ((arg (_ BitVec 64)))
    (! (=>
         ...
         (= (big2 arg) (bv2nat arg))) :pattern ((big2 arg)) )))
...
;; H
(assert
  (= (oabs x) (ite (= x (- 2147483648)) #x80000000 ((_ int2bv 32) (abs1 x)))))
...
;; H
(assert
  (= (oabs y) (ite (= y (- 2147483648)) #x80000000 ((_ int2bv 32) (abs1 y)))))
...
;; H
(assert (= (hi d1) ((_ extract 31 0) (bvlshr d1 ((_ int2bv 64) 32)))))
