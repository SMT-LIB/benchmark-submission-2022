...
(assert
  (forall ((arg (_ BitVec 32)))
    (! (=>
         ...
         (= (big1 arg) (bv2nat32 arg))) :pattern ((big1 arg)) )))

;; big
(declare-fun big2 ((_ BitVec 64)) Int)

;; big__function_guard
(declare-fun big__function_guard2 (Int
  (_ BitVec 64)) Bool)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_256 (_ BitVec 64)) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool
  true)
...
(assert
  (forall ((arg (_ BitVec 64)))
    (! (=>
         ...
         (= (big2 arg) (bv2nat64 arg))) :pattern ((big2 arg)) )))

(declare-const big_2xx32 Int)

;; oabs
(define-fun oabs ((x1 Int)) (_ BitVec 32)
  (ite (= x1 (- 2147483648)) #x80000000 (of_int (abs1 x1))))
...
;; to_neg_int
(declare-fun to_neg_int ((_ BitVec 32)) Int)
...
;; to_pos_int
(declare-fun to_pos_int ((_ BitVec 32)) Int)
...
(declare-const big_2xx64 Int)

(declare-const xu (_ BitVec 32))

(declare-const yu (_ BitVec 32))
...
;; big_0__def_axiom
(assert (= big_0 (big1 #x00000000)))

;; big_2xx32__def_axiom
(assert (= big_2xx32 (+ (big1 #xFFFFFFFF) 1)))

;; big_2xx64__def_axiom
(assert (= big_2xx64 (+ (big2 #xFFFFFFFFFFFFFFFF) 1)))
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool
  true)
...
;; H
(assert (= (oabs x) (ite (= x (- 2147483648)) #x80000000 (of_int (abs1 x)))))
...
;; H
(assert (= (oabs y) (ite (= y (- 2147483648)) #x80000000 (of_int (abs1 y)))))
...
;; H
(assert (= (oabs z) (ite (= z (- 2147483648)) #x80000000 (of_int (abs1 z)))))
...
;; Assume
(assert (dynamic_invariant2 d false false true true))
...
(declare-const d1 (_ BitVec 64))

;; H
(assert (= d1 (bvmul ((_ zero_extend 32) xu) ((_ zero_extend 32) yu))))

;; Assert
(assert (= mult (big2 d1)))

;; H
(assert (dynamic_invariant1 (lo d1) true false true true))

;; H
(assert (= (lo d1) ((_ extract 31 0) (bvand d1 #x00000000FFFFFFFF))))

;; H
(assert (hi__function_guard (hi d1) d1))

;; H
(assert (dynamic_invariant1 (hi d1) true false true true))

;; H
(assert (= (hi d1) ((_ extract 31 0) (bvlshr d1 (of_int1 32)))))

;; Ensures
(assert (= (big2 d1) (+ (* big_2xx32 (big1 (hi d1))) (big1 (lo d1)))))

;; Assert
(assert
  (and
    (hi__function_guard (hi d1) d1)
    (= mult (+ (* big_2xx32 (big1 (hi d1))) (big1 (lo d1))))))
...
;; H
(assert (= spark__branch2 (ite (bvuge (hi d1) zu) true false)))

;; H
(assert (not (= spark__branch2 true)))

(declare-const qu1 (_ BitVec 32))

;; H
(assert (= qu1 ((_ extract 31 0) (bvudiv d1 ((_ zero_extend 32) zu)))))

(declare-const ru1 (_ BitVec 32))

;; H
(assert (= ru1 ((_ extract 31 0) (bvurem d1 ((_ zero_extend 32) zu)))))
...
;; Ensures
(assert
  (= (* (big2 ((_ zero_extend 32) xu)) (big2 ((_ zero_extend 32) yu))) 
  (big2
    d1)))

;; Ensures
(assert
  (= (div1 (big2 d1) (big2 ((_ zero_extend 32) zu))) (big2
                                                       (bvudiv d1 ((_ zero_extend 32) 
                                                       zu)))))

;; Ensures
(assert
  (= (mod1 (big2 d1) (big2 ((_ zero_extend 32) zu))) (big2
                                                       (bvurem d1 ((_ zero_extend 32) 
                                                       zu)))))
...
;; Assert
(assert (= (big1 zu) (big1 (oabs z))))

(declare-const spark__branch3 Bool)

(declare-const qu2 (_ BitVec 32))

(declare-const spark__branch4 Bool)

;; H
(assert (= spark__branch4 round))
...
(assert
  (ite (= spark__branch4 true)
    (and
      (= (abs1 big_q1) (ite (bvugt ru1 (bvudiv (bvsub zu #x00000001) #x00000002))
                         (+ (abs1 quot1) 1)
                         (abs1 quot1)))
      (and
        (= spark__branch5 (ite (bvugt ru1 (bvudiv (bvsub zu #x00000001) #x00000002))
                            true
                            false))
        (ite (= spark__branch5 true)
          (and
            ...
            (and
              (and
                (= spark__branch3 (ite (= qu1 #xFFFFFFFF) true false))
                (not (= spark__branch3 true)))
              (= qu2 (bvadd qu1 #x00000001))))
          (and (= spark__branch3 spark__branch5) (= qu2 qu1)))))
    (and (= spark__branch3 spark__branch4) (= qu2 qu1))))
...
(assert
  (ite (and (<= 0 x) (<= 0 y))
    (= o true)
    (= o (ite (< x 0) (ite (< y 0) true false) false))))

(declare-const spark__branch6 Bool)

;; H
(assert (= spark__branch6 o))
...
(assert
  (ite (= spark__branch6 true)
    (and
      (ite (< 0 z) (<= big_0 big_q1) (<= big_q1 big_0))
      (let ((o3 (to_pos_int ru1)))
        (and
          (and
            (to_pos_int__function_guard o3 ru1)
            (and
            ...
            (and
              (ite (< 0 z)
                (and
                  (= o2 (to_pos_int qu2))
                  (and
                    (to_pos_int__function_guard o2 qu2)
                    (and
                ...
                (and
                  (= o2 (to_neg_int qu2))
                  (and
                    (to_neg_int__function_guard o2 qu2)
                    (and
                      (dynamic_invariant o2 true false true true)
                      (= (big o2) (- (big1 qu2)))))))
              (= q1 o2))))))
    (and
      (ite (< 0 z) (<= big_q1 big_0) (<= big_0 big_q1))
      (let ((o3 (to_neg_int ru1)))
        (and
          (and
            (to_neg_int__function_guard o3 ru1)
            (and
              (dynamic_invariant o3 true false true true)
              (= (big o3) (- (big1 ru1)))))
          (and
            ...
            (and
              (ite (< 0 z)
                (and
                  (= o1 (to_neg_int qu2))
                  (and
                    (to_neg_int__function_guard o1 qu2)
                    (and
                ...
                (and
                  (= o1 (to_pos_int qu2))
                  (and
                    (to_pos_int__function_guard o1 qu2)
                    (and
                      (dynamic_invariant o1 true false true true)
                      (= (big o1) (big1 qu2))))))
              (= q1 o1))))))))
...
;; Ensures
(assert (= (in_int32_range big_r1) true))

;; Goal def'vc
;; File "s-arit32.ads", line 91, characters 0-0
(assert
  (not
  (=>
