...
;; source__ref_source__content__projection
(define-fun source__ref_source__content__projection ((a source__ref)) source
  (source__content a))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_263 (_ BitVec 32)) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool
  true)
...
;; target__ref_target__content__projection
(define-fun target__ref_target__content__projection ((a target__ref)) target
  (target__content a))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool
  (=>
    (or (= temp___is_init_266 true) (<= (- 2147483648) 2147483647))
    (in_range2 temp___expr_270)))
...
;; user_eq
(declare-fun user_eq4 (uns32
  uns32) Bool)

(declare-const dummy4 uns32)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)
...
(assert
  (forall ((arg (_ BitVec 32)))
    (! (=>
         (dynamic_invariant3 arg true true true true)
...
;; user_eq
(declare-fun user_eq5 (tinteger_32B
  tinteger_32B) Bool)

(declare-const dummy5 tinteger_32B)

(declare-datatypes ((tinteger_32B__ref 0))
  (((tinteger_32B__refqtmk (tinteger_32B__content tinteger_32B)))))

;; tinteger_32B__ref_tinteger_32B__content__projection
(define-fun tinteger_32B__ref_tinteger_32B__content__projection ((a1 tinteger_32B__ref)) tinteger_32B
  (tinteger_32B__content a1))

;; r__def_axiom
(assert
  (and
    (to_int__function_guard (uc_to_int a) a)
    (= r (ite (= a #x80000000) (- 2147483648) (- (uc_to_int a))))))

;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool
  true)
...
;; Assume
(assert (= (in_int32_range (- (big1 a))) true))

(declare-const ada___system__arith_32__to_neg_int__r__assume Int)

;; H
(assert
  (ite (= a #x80000000)
    (= ada___system__arith_32__to_neg_int__r__assume (- 2147483648))
    (let ((o a))
      (let ((o1 (uc_to_int o)))
        (and
          (and
          ...
          (let ((o2 (- o1)))
            (and
              (= ada___system__arith_32__to_neg_int__r__assume o2)
              (in_range3 o2))))))))

;; Assume
(assert (= ada___system__arith_32__to_neg_int__r__assume r))
...
;; Goal def'vc
;; File "s-arit32.adb", line 105, characters 0-0
(assert
  (not false))
