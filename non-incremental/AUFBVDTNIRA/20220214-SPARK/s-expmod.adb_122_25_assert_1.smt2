...
(declare-const xquot Int)

(declare-const yquot Int)

(declare-const aquot Int)

;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_226 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool
  (=>
    (= temp___do_toplevel_224 true)
    (=> (= temp___is_init_222 true) (<= 0 temp___expr_226))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_234 Int) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool) (temp___do_typ_inv_233 Bool)) Bool
  (=>
    (= temp___do_toplevel_232 true)
    (=> (= temp___is_init_230 true) (< 0 temp___expr_234))))

;; left__def_axiom
(assert (= left (mod2 (+ x y) b)))

;; right__def_axiom
(assert (= right (mod2 (+ (mod2 x b) (mod2 y b)) b)))

;; xquot__def_axiom
(assert (= xquot (div1 x b)))

;; yquot__def_axiom
(assert (= yquot (div1 y b)))

;; aquot__def_axiom
(assert (= aquot (div1 (+ (mod2 x b) (mod2 y b)) b)))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool
  true)
...
;; Assert
(assert (<= 0 (mod2 (+ (mod2 x b) (mod2 y b)) b)))

;; Assume
(assert (= (mod2 (+ (mod2 x b) (mod2 y b)) b) right))
...
;; Assume
(assert (= (div1 x b) xquot))

;; Assume
(assert (dynamic_invariant xquot true false true true))
...
;; Assume
(assert (= (div1 y b) yquot))

;; Assume
(assert (dynamic_invariant yquot true false true true))
...
;; Assert
(assert (<= 0 (div1 (+ (mod2 x b) (mod2 y b)) b)))

;; Assume
(assert (= (div1 (+ (mod2 x b) (mod2 y b)) b) aquot))

;; Assume
(assert (dynamic_invariant aquot true false true true))
...
;; H
(assert
  (= spark__branch (and (ite (= y 0) false true) (ite (< 1 b) true false))))

;; H
(assert (= spark__branch true))

;; Assert
(assert (= x (+ (* xquot b) (mod2 x b))))

;; Assert
(assert (= y (+ (* yquot b) (mod2 y b))))

;; Assert
(assert
  (= left (mod2 (+ (+ (* (+ xquot yquot) b) (mod2 x b)) (mod2 y b)) b)))

;; Assert
(assert (= (+ (mod2 x b) (mod2 y b)) (+ (* aquot b) right)))

;; Assert
(assert (= left (mod2 (+ (* (+ (+ xquot yquot) aquot) b) right) b)))

;; Goal def'vc
;; File "s-expmod.adb", line 53, characters 0-0
(assert
  (not (= left right)))
