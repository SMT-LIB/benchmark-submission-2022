...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= (mod1 exp1 2) 0) true false))

(declare-const spark__branch Bool)

;; H
(assert (= spark__branch (ite (= (mod1 exp1 2) 0) true false)))

;; H
(assert (not (= spark__branch true)))

;; Assert
(assert (= exp1 (+ (+ (div1 exp1 2) (div1 exp1 2)) 1)))

;; Assert
(assert
  (= (power a exp1) (* (power a (div1 exp1 2)) (power a (+ (div1 exp1 2) 1)))))

;; Assert
(assert (= (power a (+ (div1 exp1 2) 1)) (* (power a (div1 exp1 2)) a)))

;; Goal def'vc
;; File "s-expmod.adb", line 58, characters 0-0
(assert
  (not
  (= (power a exp1) (* (* (power a (div1 exp1 2)) (power a (div1 exp1 2))) 
  a))))
