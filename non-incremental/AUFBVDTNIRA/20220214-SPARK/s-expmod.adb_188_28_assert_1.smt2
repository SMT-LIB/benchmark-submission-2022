...
;; Ensures
(assert (= (mod2 (* x (- y 1)) b) (mod2 (* (mod2 x b) (mod2 (- y 1) b)) b)))

;; Ensures
(assert (= (mod2 (mod2 x b) b) (mod2 x b)))
...
;; Assert
(assert (<= 0 (* (mod2 x b) (mod2 (- y 1) b))))

;; Ensures
(assert
  (= (mod2 (+ (* (mod2 x b) (mod2 (- y 1) b)) (mod2 x b)) b) (mod2
                                                               (+ (mod2
                                                                    (* 
                                                                    (mod2
                                                                    x
...
;; Ensures
(assert (= (mod2 (+ (- y 1) 1) b) (mod2 (+ (mod2 (- y 1) b) (mod2 1 b)) b)))

;; Assert
(assert (= (mod2 (+ (mod2 (- y 1) b) 1) b) (mod2 y b)))
...
;; H
(assert (= spark__branch1 (ite (< (+ (mod2 (- y 1) b) 1) b) true false)))
...
;; Assert
(assert (= (mod2 (* x y) b) (- (* x y) (* (div1 (* x y) b) b))))

;; Assert
(assert
  (= (mod2 (* x y) b) (- (* x y) (* (div1 (* (* x (div1 y b)) b) b) b))))
...
;; Ensures
(assert (= (div1 (* (* x (div1 y b)) b) b) (* x (div1 y b))))

;; Goal def'vc
;; File "s-expmod.adb", line 89, characters 0-0
(assert
  (not (= left 0)))
