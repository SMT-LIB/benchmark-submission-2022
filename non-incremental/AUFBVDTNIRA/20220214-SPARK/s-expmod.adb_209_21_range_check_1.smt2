...
;; Assume
(assert (not (= modulus #x00000000)))

;; Goal def'vc
;; File "s-expmod.adb", line 207, characters 0-0
(assert
  (not
  (bvule (bvurem (bvmul ((_ zero_extend 32) x) ((_ zero_extend 32) y)) ((_ zero_extend 32) 
  modulus)) ((_ zero_extend 32) #xFFFFFFFF))))
