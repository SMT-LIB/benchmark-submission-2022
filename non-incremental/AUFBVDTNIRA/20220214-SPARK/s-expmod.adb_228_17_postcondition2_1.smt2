...
;; bool_eq
(define-fun bool_eq2 ((x (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (= x y) true false))
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_187 (_ BitVec 32)) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool
  true)
...
;; Assume
(assert (dynamic_invariant modulus true false true true))
...
;; Goal def'vc
;; File "s-expmod.adb", line 225, characters 0-0
(assert
  (not (= (big (mult x y)) (mod2 (* (big x) (big y)) m))))
