...
(assert
  (forall ((arg (_ BitVec 32)))
    (! (=>
         ...
         (= (big arg) (bv2nat32 arg))) :pattern ((big arg)) )))
...
(define-fun uc_of_int1 ((x Int)) (_ BitVec 64)
  (ite (<= 0 x) (of_int2 x) (bvneg (of_int2 (- x)))))

;; uc_to_int
(define-fun uc_to_int1 ((x (_ BitVec 64))) Int
  (ite (= (bool_lt1 x (of_int2 two_power_size_minus_one1)) true)
    (bv2nat64 x)
    (- (bv2nat64 (bvneg x)))))
...
(assert
  (and
    ...
    (= (not (and (ite true true false) (ite (let ((temp___391 modulus))
                                              (and
                                                (not
                                                  (= temp___391 #x00000000))
                                                (= (bvand temp___391 (bvsub temp___391 #x00000001)) #x00000000)))
                                         true
                                         false))) true)))
...
;; H
(assert (= (big modulus) (bv2nat32 modulus)))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (= (power (big factor1) exp2) (* (big factor1) (power
                                                       (big factor1)
                                                       (- exp2 1))))
      (and
        (= (equal_modulo
             (* (* (big result__1) (big factor1)) (power
                                                    (big factor1)
                                                    (- exp2 1)))
             (power (big left) right)) true)
        (let ((o modulus))
...
;; H
(assert (= (big factor1) (bv2nat32 factor1)))

;; Ensures
(assert
  (ite (= (mod1 exp2 2) 0)
    (= (power (big factor1) exp2) (* (power (big factor1) (div1 exp2 2)) 
    (power
      (big factor1)
      (div1 exp2 2))))
    (= (power (big factor1) exp2) (* (* (power (big factor1) (div1 exp2 2)) 
...
;; Assert
(assert (<= 0 (* (big factor1) (big factor1))))

;; Ensures
(assert
  (= (mod2
       (power (mod2 (* (big factor1) (big factor1)) (big modulus)) exp3)
       (big modulus)) (mod2
                        (power (* (big factor1) (big factor1)) exp3)
                        (big modulus))))

;; Assert
(assert (= (power (* (big factor1) (big factor1)) exp3) (* rest2 rest2)))
...
;; H
(assert
  (= (big (mult factor1 factor1)) (mod2 (* (big factor1) (big factor1)) m)))

;; H
(assert (< (big (mult factor1 factor1)) m))

;; H
(assert (dynamic_invariant1 (mult factor1 factor1) true false true true))

;; H
(assert
  (= (mult factor1 factor1) ((_ extract 31 0) (bvurem (bvmul ((_ zero_extend 32) 
  factor1) ((_ zero_extend 32) factor1)) ((_ zero_extend 32) modulus)))))

(declare-const factor2 (_ BitVec 32))

;; H
(assert (= factor2 (mult factor1 factor1)))
...
;; Ensures
(assert
  (= (mod2 (mod2 (* rest2 rest2) (big modulus)) (big modulus)) (mod2
                                                                 (* rest2 
                                                                 rest2)
                                                                 (big
                                                                   modulus))))
...
;; H
(assert (= (big result__2) (bv2nat32 result__2)))

;; Assert
(assert (<= 0 (big result__2)))

;; Ensures
(assert (= (mod2 (big result__2) (big modulus)) (big result__2)))
...
;; Ensures
(assert
  (= (mod2 (* (big result__2) (* rest2 rest2)) (big modulus)) (mod2
                                                                (* (mod2
                                                                    (big
                                                                    result__2)
                                                                    (big
...
;; H
(assert (= (big factor2) (bv2nat32 factor2)))

;; Assert
(assert true)

;; Assert
(assert (<= 0 (power (big factor2) exp3)))
...
;; Ensures
(assert
  (= (mod2 (* (big result__2) (power (big factor2) exp3)) (big modulus)) 
  (mod2
    (* (mod2 (big result__2) (big modulus)) (mod2
                                              (power (big factor2) exp3)
                                              (big modulus)))
    (big modulus))))
...
(assert
  (= (equal_modulo
       (* (big result__2) (power (big factor2) exp3))
       (power (big left) right)) true))
