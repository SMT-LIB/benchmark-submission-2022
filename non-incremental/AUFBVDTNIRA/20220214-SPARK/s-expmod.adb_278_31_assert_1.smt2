...
(assert
  (= (equal_modulo
       (* (* (big result__1) (big factor1)) (power (big factor1) (- exp2 1)))
       (power (big left) right)) true))
...
;; Assert
(assert (<= 0 (power (big factor1) (- exp2 1))))
...
;; H
(assert (= (big result__1) (bv2nat32 result__1)))

;; Assert
(assert true)

;; Assert
(assert (<= 0 (* (big result__1) (big factor1))))
...
;; H
(assert
  (= (big (mult result__1 factor1)) (mod2
                                      (* (big result__1) (big factor1))
                                      m)))

;; H
(assert (< (big (mult result__1 factor1)) m))

;; H
(assert (dynamic_invariant1 (mult result__1 factor1) true false true true))

;; H
(assert
  (= (mult result__1 factor1) ((_ extract 31 0) (bvurem (bvmul ((_ zero_extend 32) 
  result__1) ((_ zero_extend 32) factor1)) ((_ zero_extend 32) modulus)))))

(declare-const result__2 (_ BitVec 32))

;; H
(assert (= result__2 (mult result__1 factor1)))
...
(assert
  (= (mod2
       (mod2 (power (big factor1) (- exp2 1)) (big modulus))
       (big modulus)) (mod2 (power (big factor1) (- exp2 1)) (big modulus))))
...
(assert
  (= (mod2
       (* (big result__2) (power (big factor1) (- exp2 1)))
       (big modulus)) (mod2
...
(assert
  (ite (= (mod1 (- exp2 1) 2) 0)
    (= (power (big factor1) (- exp2 1)) (* (power
                                             (big factor1)
                                             (div1 (- exp2 1) 2)) (power
                                                                    (big
                                                                    factor1)
    ...
    (power
      (big factor1)
      (div1 (- exp2 1) 2))) (big factor1)))))

;; Goal def'vc
;; File "s-expmod.ads", line 76, characters 0-0
(assert
  (not (= (div1 exp2 2) (div1 (- exp2 1) 2))))
