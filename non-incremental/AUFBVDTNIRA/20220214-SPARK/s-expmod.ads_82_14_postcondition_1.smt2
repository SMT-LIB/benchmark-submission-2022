...
(assert
  (ite (= spark__branch true)
    (and
      (exists ((result__2 (_ BitVec 32)) (factor1 (_ BitVec 32)) (exp2 Int))
        (and
          (and
            (< 0 exp2)
            (and
              (bvult result__2 modulus)
              (= (equal_modulo
                   (* (big result__2) (power (big factor1) exp2))
                   (power (big left) right)) true)))
          (and
            (and
              (and
                (dynamic_invariant1 result__2 true true true true)
                (dynamic_invariant1 factor1 true true true true))
              (dynamic_invariant exp2 true true true true))
            (and
              (exists ((spark__branch1 Bool))
                (and
                  (= spark__branch1 (ite (= (mod1 exp2 2) 0) false true))
                  (ite (= spark__branch1 true)
                    (and
                      (= (power (big factor1) exp2) (* (big factor1) 
                      (power
                        (big factor1)
                        (- exp2 1))))
                      (and
                        (= (equal_modulo
                             (* (* (big result__2) (big factor1)) (power
                                                                    (big
                                                                    factor1)
                                                                    (- exp2 1)))
                             (power (big left) right)) true)
                                        ...
                                        (let ((o4 (power o3 o2)))
                                          (and
                                            ...
                                            (let ((o5 (big factor1)))
                                              (and
                                                (= o5 (bv2nat32 factor1))
                                                (let ((o6 (big result__2)))
                                                  (and
                                                    (= o6 (bv2nat32 result__2))
                                                    (let ((o7 (* o6 o5)))
                                                      (and
                                                        (<= 0 o7)
                                                        (and
                                                              ...
                                                              (and
                                                                (and
                                                                  (dynamic_invariant1
                                                                    ...
                                                                    true
                                                                    true)
                                                                  (= o8 ((_ extract 31 0) (bvurem (bvmul ((_ zero_extend 32) result__2) ((_ zero_extend 32) factor1)) ((_ zero_extend 32) 
                                                                  modulus)))))
                                                                (and
                                                                  (= 
                                                                  result__1 o8)
              ...
              (let ((o (big factor1)))
                (and
                  ...
                  (and
                    (ite (= (mod1 exp2 2) 0)
                      (= (power o exp2) (* (power o (div1 exp2 2)) (power
                                                                    o
                                                                    (div1
                                                                    exp2
                                                                    2))))
                      (= (power o exp2) (* (* (power o (div1 exp2 2)) 
                      (power
                        o
                        (div1 exp2 2))) o)))
                    (exists ((exp3 Int))
                      (and (= exp3 (div1 exp2 2)) (= exp3 0))))))))))
      (= (big result__1) (mod2 (power (big left) right) (big modulus))))
    (= result__1 result__)))

(declare-const ada___system__exp_mod__exp_modular__result (_ BitVec 32))

;; H
(assert (= ada___system__exp_mod__exp_modular__result result__1))

;; Goal def'vc
;; File "s-expmod.ads", line 76, characters 0-0
(assert
  (not
  (= (big ada___system__exp_mod__exp_modular__result) (mod2
                                                        (power
                                                          (big left)
                                                          right)
                                                        (big modulus)))))
