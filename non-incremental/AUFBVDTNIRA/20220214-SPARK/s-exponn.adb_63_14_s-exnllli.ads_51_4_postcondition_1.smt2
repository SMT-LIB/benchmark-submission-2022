...
;; user_eq
(declare-fun user_eq2 (long_long_long_integer
  long_long_long_integer) Bool)

(declare-const dummy2 long_long_long_integer)
...
(define-fun long_long_long_integer__ref_long_long_long_integer__content__projection 
  ((a1 long_long_long_integer__ref)) long_long_long_integer
  (long_long_long_integer__content a1))
