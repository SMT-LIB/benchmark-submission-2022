...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool
  true)
...
;; Assume
(assert (and (not (= a 0)) (= (mod1 exp1 2) 0)))

(declare-const spark__branch Bool)

;; H
(assert (= spark__branch (ite (= exp1 0) true false)))
  ...
  (ite (= spark__branch true)
    ...
    (and
      ...
      (and
        ...
        (and
          (= (power a exp1) (power (power a (div1 exp1 2)) 2))
          (not (= (power a (div1 exp1 2)) 0)))))))

;; Goal def'vc
;; File "s-exponn.adb", line 71, characters 0-0
(assert
  (not (< 0 (power a exp1))))
