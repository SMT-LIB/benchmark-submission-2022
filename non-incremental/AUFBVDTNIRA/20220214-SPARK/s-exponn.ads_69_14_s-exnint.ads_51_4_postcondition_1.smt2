...
(declare-const ada___system__exn_int__exponn_integer__expon__result Int)
...
(assert
  (ite (= spark__branch true)
    (= ada___system__exn_int__exponn_integer__expon__result 1)
    (and
      (= spark__branch1 (ite (= left 0) true false))
      (ite (= spark__branch1 true)
        (= ada___system__exn_int__exponn_integer__expon__result 0)
        (and
          ...
          (= ada___system__exn_int__exponn_integer__expon__result result__1))))))

;; Goal def'vc
;; File "s-exponn.ads", line 66, characters 0-0
(assert
  (not
  (= ada___system__exn_int__exponn_integer__expon__result (power left right))))
