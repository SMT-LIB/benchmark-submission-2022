...
(assert
  (forall ((arg Int))
    (forall ((low Int) (high Int))
      (! (=
           (= (in_range3 arg low high) true)
           (and (<= low arg) (<= arg high))) :pattern ((in_range3
                                                         arg
                                                         low
                                                         high)) ))))
                    ...
                    (and
                      ...
                      (and
                        ...
                        (let ((o3 (big factor1)))
                          (and
                            (= o3 factor1)
                            (let ((o4 (big result__1)))
                              (and
                                (= o4 result__1)
                                (and
                                  (= (in_int_range (* o4 o3)) true)
                                  (let ((o5 (* result__1 factor1)))
                                    (and (in_range o5) (= result__2 o5))))))))))))))))))
    (= result__2 result__1)))
...
;; Assert
(assert (= (* (big result__2) (* rest2 rest2)) (power (big left) right)))

;; H
(assert true)

;; H
(assert (= (big left) left))
...
;; H
(assert (= (big result__2) result__2))
...
;; Ensures
(assert (= (in_int_range (* rest2 rest2)) true))

;; Ensures
(assert (in_range2 exp3))
...
;; Ensures
(assert (= (in_int_range (* (big factor1) (big factor1))) true))
...
;; Assert
(assert (= (power (big factor2) exp3) (* rest2 rest2)))
...
;; LoopInvariant
(assert (not (= factor2 0)))

;; Goal def'vc
;; File "s-expont.ads", line 66, characters 0-0
(assert
  (not
  (= (* (big result__2) (power (big factor2) exp3)) (power (big left) right))))
