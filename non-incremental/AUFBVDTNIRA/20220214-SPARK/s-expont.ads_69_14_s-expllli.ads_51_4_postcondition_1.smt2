...
(declare-const ada___system__exp_llli__expont_integer__expon__result Int)
...
(assert
  (ite (= spark__branch true)
    (= ada___system__exp_llli__expont_integer__expon__result 1)
    (and
      (= spark__branch1 (ite (= left 0) true false))
      (ite (= spark__branch1 true)
        (= ada___system__exp_llli__expont_integer__expon__result 0)
        (and
          (exists ((result__2 Int) (factor1 Int) (exp2 Int))
            (and
              (and
                (< 0 exp2)
                (and
                  (not (= factor1 0))
                  (= (* (big result__2) (power (big factor1) exp2)) (power
                                                                    (big
                                                                    left)
                                                                    right))))
              (and
                ...
                (and
                  (exists ((spark__branch2 Bool))
                    (and
                      (= spark__branch2 (ite (= (mod1 exp2 2) 0) false true))
                      (ite (= spark__branch2 true)
                        (let ((o (* result__2 factor1)))
                          (and (in_range o) (= result__1 o)))
                        (= result__1 result__2))))
                  (exists ((exp3 Int))
                    (and (= exp3 (div1 exp2 2)) (= exp3 0)))))))
          (= ada___system__exp_llli__expont_integer__expon__result result__1))))))

;; Goal def'vc
;; File "s-expont.ads", line 66, characters 0-0
(assert
  (not
  (= ada___system__exp_llli__expont_integer__expon__result (power left right))))
