...
(assert
  (ite (= spark__branch true)
    (exists ((result__2 (_ BitVec 128)) (factor1 (_ BitVec 128)) (exp2 Int))
      (and
        (and
          (< 0 exp2)
...
(declare-const ada___system__exp_lllu__exp_long_long_long_unsigned__result (_ BitVec 128))

;; H
(assert
  (= ada___system__exp_lllu__exp_long_long_long_unsigned__result result__1))

;; Goal def'vc
;; File "s-explllu.ads", line 57, characters 0-0
(assert
  (not
  (= ada___system__exp_lllu__exp_long_long_long_unsigned__result (power
                                                                   left
                                                                   right))))
