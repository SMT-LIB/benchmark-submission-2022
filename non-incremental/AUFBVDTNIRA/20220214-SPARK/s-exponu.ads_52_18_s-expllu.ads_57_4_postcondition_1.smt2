...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_180 (_ BitVec 64)) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool
  true)
...
;; H
(assert (= result__ #x0000000000000001))
...
(assert
  (ite (= spark__branch true)
    (exists ((result__2 (_ BitVec 64)) (factor1 (_ BitVec 64)) (exp2 Int))
      (and
        (and
          (< 0 exp2)
...
(declare-const ada___system__exp_llu__exp_long_long_unsigned__result (_ BitVec 64))

;; H
(assert (= ada___system__exp_llu__exp_long_long_unsigned__result result__1))

;; Goal def'vc
;; File "s-expllu.ads", line 57, characters 0-0
(assert
  (not
  (= ada___system__exp_llu__exp_long_long_unsigned__result (power left right))))
