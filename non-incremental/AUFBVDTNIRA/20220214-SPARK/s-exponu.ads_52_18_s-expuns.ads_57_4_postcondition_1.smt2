...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_180 (_ BitVec 32)) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool
  true)
  ...
  (ite (= spark__branch true)
    (exists ((result__2 (_ BitVec 32)) (factor1 (_ BitVec 32)) (exp2 Int))
      (and
        (and
          (< 0 exp2)
          (= (bvmul result__2 (power factor1 exp2)) (power left right)))
        (and
          (and
            (and
            ...
            (exists ((spark__branch1 Bool))
              (and
                ...
                (ite (= spark__branch1 true)
                  (and
                    (= (bvmul result__2 (bvmul factor1 (power
                                                         factor1
                                                         (- exp2 1)))) 
                    (power
                      left
                      right))
                    (and
                      (= (bvmul (bvmul result__2 factor1) (power
                                                            factor1
                                                            (- exp2 1))) 
                      (power
                        left
                        right))
                      (= result__1 (bvmul result__2 factor1))))
                  (= result__1 result__2))))
            (exists ((exp3 Int)) (and (= exp3 (div1 exp2 2)) (= exp3 0)))))))
    (= result__1 result__)))

(declare-const ada___system__exp_uns__exp_unsigned__result (_ BitVec 32))

;; H
(assert (= ada___system__exp_uns__exp_unsigned__result result__1))

;; Goal def'vc
;; File "s-expuns.ads", line 57, characters 0-0
(assert
  (not (= ada___system__exp_uns__exp_unsigned__result (power left right))))
