...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_276 (_ BitVec 32)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool
  true)
...
(define-fun default_initial_assumption1 ((temp___expr_285 us_rep) (temp___skip_top_level_286 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_uns__impl__uns_option__value__pred temp___expr_285)
      (= (to_rep2
           (rec__ada___system__val_uns__impl__uns_option__value
             (us_split_fields1 temp___expr_285))) #x00000000))))
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    o19
                                                                    #x0000000A
                                                                    (bvadd (bvmul #x0000000A uns_value3) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    ((_ int2bv 32) (- value3)))))
                                                                    (exists 
                                                                    ((value4 Int) (pow5 Int) (uns_value4 (_ BitVec 32)) (prev_value2 (_ BitVec 32)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (= uns_value4 
                                                                    (uns_of_non_positive
