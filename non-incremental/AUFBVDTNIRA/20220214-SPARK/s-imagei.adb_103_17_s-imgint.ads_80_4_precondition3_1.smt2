...
(assert
  (and
    (forall ((o (_ BitVec 32)))
      (hexa_to_unsigned_ghost__function_guard
        (hexa_to_unsigned_ghost (bv2nat32 (bvadd #x00000030 o)))
        (bv2nat32 (bvadd #x00000030 o))))
    (and
      (forall ((o Int))
        (hexa_to_unsigned_ghost__function_guard
                                                      ...
                                                      (and
                                                        ...
                                                        (and
                                                          (= (div1
                                                               (bv2nat32 
                                                               uns_value2)
                                                               (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
                                                              ...
                                                              (let ((o4 (- 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (let ((o5 
                                                                    ...
                                                                    (and
                                                                    (and
                                                                    (let ((temp___899 (bv2nat32 (bvadd #x00000030 (bvurem 
                                                                    uns_value2 #x0000000A)))))
                                                                    (and
                                                                    (<= 48 temp___899)
                                                                    (<= temp___899 57)))
                                                                    ...
                                                                    (= 
                                                                    (hexa_to_unsigned_ghost
                                                                    (bv2nat32 (bvadd #x00000030 o8))) o8)
                                                                    (= 
                                                                    (hexa_to_unsigned_ghost
                                                                    (+ 48 o7)) 
                                                                    (of_int
                                                                    ...
                                                                    o24
                                                                    #x0000000A
                                                                    (bvadd (bvmul #x0000000A uns_value4) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    temp___1204))
                                                                    (and
                                                                    (= prev_value1 (bvadd (bvmul #x0000000A uns_value4) (bvurem prev_value1 #x0000000A)))
                                                                    (and
                                                                    (= (bvurem prev_value1 #x0000000A) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    p j)))))
                                                                    (and
                                                                    (= prev_value1 (bvadd (bvmul #x0000000A uns_value4) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    true)
                                                                    (= o29 
                                                                    (ite (= value3 (- 2147483648))
                                                                    #x80000000
                                                                    (of_int
                                                                    (- value3)))))
                                                                    (exists 
                                                                    ((value4 Int) (pow5 Int) (prev_value2 (_ BitVec 32)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (= 
                                                                    uns_value3 
...
;; Assert
(assert
  (= (bv2nat32 uns_value3) (div1 (bv2nat32 uns_t) (power big_10 nb_digits1))))

;; Assert
(assert (= uns_value3 #x00000000))
