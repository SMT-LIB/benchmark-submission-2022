...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_276 (_ BitVec 64)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool
  true)
...
(define-fun default_initial_assumption1 ((temp___expr_285 us_rep) (temp___skip_top_level_286 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_llu__impl__uns_option__value__pred temp___expr_285)
      (= (to_rep2
           (rec__ada___system__val_llu__impl__uns_option__value
             (us_split_fields1 temp___expr_285))) #x0000000000000000))))
                          ...
                          (let ((o2 (uns_of_non_positive value2)))
                            (and
                              (and
                                ...
                                (= o2 (ite (= value2 (- 9223372036854775808))
                                        #x8000000000000000
                                        ((_ int2bv 64) (- value2)))))
                              (and
                                (and
                  ...
                  (forall ((o Int) (o1 us_t))
                    (hexa_to_unsigned_ghost__function_guard
                      (hexa_to_unsigned_ghost
                        (to_rep (select (to_array o1) o)))
                      (to_rep (select (to_array o1) o))))
                  (ite (= (and (ite (<= 1 j) true false) (ite (<= j r62s)
                                                           true
                                                           false)) true)
                    (exists ((o Int))
                      (and
                                        ...
                                        (exists ((o4 Int))
                                          (and
                                            ...
                                            (exists ((o5 Int))
                                              (and
                                                (= (to_rep1 s__first) o5)
                                                (let ((temp___1045 (of_array
                                                                    s
                                                                    o5
                                                                    o4)))
                                                  (let ((temp___1047 
                                                    (of_array
                                                      (to_array temp___1045)
                                                      (first temp___1045)
                                                      (last temp___1045))))
                                                    (exists ((o6 Int))
                                                      (and
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    ((_ int2bv 64) (- value3)))))
                                                                    (exists 
                                                                    ((value4 Int) (pow5 Int) (uns_value4 (_ BitVec 64)) (prev_value2 (_ BitVec 64)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (= uns_value4 
                                                                    (uns_of_non_positive
                                                                    value4))
                                                                    (and
                                                                    (bvule uns_value4 #x1999999999999999)
                                                                    (and
                                                                    (forall 
                                                                    ((k Int))
                                                                    (=>
...
;; H
(assert (= (to_rep1 s__first) temp___1123))
...
;; H
(assert
  (let ((temp___1122 (of_array s1 o1 o)))
    (=>
      (<= temp___1123 p)
      (and
        (and
          (<= (first temp___1122) temp___1123)
          (<= temp___1123 (last temp___1122)))
        (and (<= (first temp___1122) p) (<= p (last temp___1122)))))))
...
;; H
(assert
  (let ((temp___1131 (of_array
                       (to_array
                         (of_array s (to_rep1 s__first) (to_rep1 s__last)))
                       (to_rep1 s__first)
                       p)))
    (let ((temp___1129 (of_array (to_array (of_array s1 o1 o)) temp___1123 p)))
      (ite (= (bool_eq6
                (to_array temp___1129)
                (first temp___1129)
                (last temp___1129)
                (to_array temp___1131)
                (first temp___1131)
                (last temp___1131)) true)
        (and
          (= (to_rep1 s__last) o3)
          (let ((o4 (+ p 1)))
            (and
    ...
    (let ((o6 (+ p 1)))
      (and
        ...
        (and
          ...
          (and
            (= (to_rep1 s__first) o5)
            (let ((temp___1133 (of_array s1 o5 o4)))
              (let ((o7 (of_array
                          (to_array temp___1133)
                          (first temp___1133)
                          (last temp___1133))))
                (and
                  ...
                  (forall ((j1 Int))
                    (=>
                      (and (<= o6 j1) (<= j1 p1))
                      (let ((temp___743 (to_rep (select (to_array o7) j1))))
