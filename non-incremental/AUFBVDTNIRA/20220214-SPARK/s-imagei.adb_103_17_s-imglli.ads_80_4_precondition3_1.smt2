...
(assert
  (and
    (forall ((o (_ BitVec 64)))
      (hexa_to_unsigned_ghost__function_guard
        (hexa_to_unsigned_ghost (bv2nat64 (bvadd #x0000000000000030 o)))
        (bv2nat64 (bvadd #x0000000000000030 o))))
    (and
      (forall ((o Int))
        (hexa_to_unsigned_ghost__function_guard
          (hexa_to_unsigned_ghost (+ 48 o))
          (+ 48 o)))
      (and
                                  ...
                                  (and
                                    ...
                                    (and
                                      ...
                                      (ite (= (and (ite (<= 1 j) true false) 
                                        ...
                                        (exists ((o Int))
                                          (and
                                            (= (to_rep1 prev_s__last) o)
                                            (exists ((o1 Int))
                                              (and
                                                (= (to_rep1 prev_s__first) o1)
                                                (exists ((o2 Int))
                                                  (and
                                                    (= (to_rep1 s__last) o2)
                                                    (exists ((o3 Int))
                                                      (and
                                                        ...
                                                        (and
                                                          (= (div1
                                                               (bv2nat64 
                                                               uns_value2)
                                                               (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
                                                              ...
                                                              (let ((o4 (- 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (let ((o5 
                                                                    ...
                                                                    (and
                                                                    (and
                                                                    (let ((temp___899 (bv2nat64 (bvadd #x0000000000000030 (bvurem 
                                                                    uns_value2 #x000000000000000A)))))
                                                                    (and
                                                                    (<= 48 temp___899)
                                                                    (<= temp___899 57)))
                                                                    ...
                                                                    (= 
                                                                    (hexa_to_unsigned_ghost
                                                                    (bv2nat64 (bvadd #x0000000000000030 o8))) o8)
                                                                    (= 
                                                                    (hexa_to_unsigned_ghost
                                                                    (+ 48 o7)) 
                                                                    (of_int
                                                                    ...
                                                                    prev__split_discrs))
                                                                    (exists 
                                                                    ((prev__split_fields1 long_long_unsigned))
                                                                    (and
                                                                    (= 
                                                                    (us_split_fieldsqtmk
                                                                    prev__split_fields1) 
                                                                    ...
                                                                    o24
                                                                    #x000000000000000A
                                                                    (bvadd (bvmul #x000000000000000A uns_value4) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    cur__split_discrs))
                                                                    (exists 
                                                                    ((cur__split_fields1 long_long_unsigned))
                                                                    (and
                                                                    (= 
                                                                    (us_split_fieldsqtmk
                                                                    cur__split_fields1) 
                                                                    ...
                                                                    temp___1204))
                                                                    (and
                                                                    (= prev_value1 (bvadd (bvmul #x000000000000000A uns_value4) (bvurem prev_value1 #x000000000000000A)))
                                                                    (and
                                                                    (= (bvurem prev_value1 #x000000000000000A) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    p j)))))
                                                                    (and
                                                                    (= prev_value1 (bvadd (bvmul #x000000000000000A uns_value4) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    true)
                                                                    (= o29 
                                                                    (ite (= value3 (- 9223372036854775808))
                                                                    #x8000000000000000
                                                                    (of_int
                                                                    (- value3)))))
                                                                    (exists 
                                                                    ((value4 Int) (pow5 Int) (prev_value2 (_ BitVec 64)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (= 
                                                                    uns_value3 
                                        ...
                                        (and
                                          (= s1 s)
                                          (= uns_value3 uns_value2))))))))))))))))))))))

;; Assert
(assert
  (= (bv2nat64 uns_value3) (div1 (bv2nat64 uns_t) (power big_10 nb_digits1))))

;; Assert
(assert (= uns_value3 #x0000000000000000))

;; Ensures
(assert
  (= (let ((temp___916 (of_array (to_array s_init) (to_rep1 s__first) p)))
       (let ((temp___914 (of_array
                           (to_array
                             (of_array
                               s1
                               (to_rep1 s__first)
         ...
         (bool_eq6
           ...
           (to_array temp___916)
           (first temp___916)
           (last temp___916)))) true))

;; Assert
(assert
  (= (bool_eq10
       (scan_based_number_ghost
         (let ((temp___1276 (of_array
                              s1
                              (to_rep1 s__first)
                              (to_rep1 s__last))))
           (of_array
             (to_array temp___1276)
             (first temp___1276)
             (last temp___1276)))
         (+ p 1)
         (+ p nb_digits1)
...
;; H
(assert (= (to_rep1 s__first) temp___1287))
...
;; H
(assert (= (to_rep1 s__first) temp___1283))
...
;; H
(assert
  (let ((temp___1281 (of_array s1 o4 o3)))
    (=>
      (<= temp___1283 p)
      (and
        (and
          (<= (first temp___1281) temp___1283)
          (<= temp___1283 (last temp___1281)))
        (and (<= (first temp___1281) p) (<= p (last temp___1281)))))))
...
;; H
(assert
  (let ((temp___1292 (of_array
                       (to_array
                         (of_array s (to_rep1 s__first) (to_rep1 s__last)))
                       temp___1287
                       p)))
    (let ((temp___1290 (of_array
                         (to_array (of_array s1 o4 o3))
                         temp___1283
                         p)))
      (ite (= (bool_eq6
                (to_array temp___1290)
                (first temp___1290)
                (last temp___1290)
                (to_array temp___1292)
                (first temp___1292)
                (last temp___1292)) true)
        (and
          (= (to_rep1 s__last) o6)
          (and
            (= (to_rep1 s__first) o7)
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (let ((temp___1295 (of_array s1 o10 o9)))
              (let ((o12 (of_array
                           (to_array temp___1295)
                           (first temp___1295)
                           (last temp___1295))))
                (and
                  ...
                  (forall ((j1 Int))
                    (=>
                      (and (<= o11 j1) (<= j1 p1))
                      (let ((temp___750 (to_rep (select (to_array o12) j1))))
...
;; H
(assert
  (= (wrap_option (uns_of_non_positive t1)) (us_repqtmk
                                              (us_split_discrsqtmk
                                                (of_int1 0))
                                              (us_split_fieldsqtmk
                                                (of_rep2
                                                  (uns_of_non_positive t1))))))
