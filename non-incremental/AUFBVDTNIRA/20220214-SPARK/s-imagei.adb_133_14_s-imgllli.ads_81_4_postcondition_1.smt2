...
;; user_eq
(declare-fun user_eq1 (uns
  uns) Bool)

(declare-const dummy1 uns)
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_278 (_ BitVec 128)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool
  true)
...
;; Goal def'vc
;; File "s-imagei.adb", line 129, characters 0-0
(assert
  (not (= (div1 (bv2nat128 x) (bv2nat128 y)) (bv2nat128 (bvudiv x y)))))
