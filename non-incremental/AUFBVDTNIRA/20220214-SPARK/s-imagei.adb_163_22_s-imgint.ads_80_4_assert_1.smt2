...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_793 Int) (temp___is_init_789 Bool) (temp___skip_constant_790 Bool) (temp___do_toplevel_791 Bool) (temp___do_typ_inv_792 Bool)) Bool
  (=>
    (= temp___do_toplevel_791 true)
    (=> (= temp___is_init_789 true) (<= 0 temp___expr_793))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_801 Int) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool) (temp___do_typ_inv_800 Bool)) Bool
  (=>
