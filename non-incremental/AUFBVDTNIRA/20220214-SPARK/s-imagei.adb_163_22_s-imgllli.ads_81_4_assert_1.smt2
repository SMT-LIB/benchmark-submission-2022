...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_817 Int) (temp___is_init_813 Bool) (temp___skip_constant_814 Bool) (temp___do_toplevel_815 Bool) (temp___do_typ_inv_816 Bool)) Bool
  (=>
    (= temp___do_toplevel_815 true)
    (=> (= temp___is_init_813 true) (<= 0 temp___expr_817))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_825 Int) (temp___is_init_821 Bool) (temp___skip_constant_822 Bool) (temp___do_toplevel_823 Bool) (temp___do_typ_inv_824 Bool)) Bool
  (=>
    (= temp___do_toplevel_823 true)
    (=> (= temp___is_init_821 true) (< 0 temp___expr_825))))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool
  true)
...
;; Goal def'vc
;; File "s-imagei.adb", line 135, characters 0-0
(assert
