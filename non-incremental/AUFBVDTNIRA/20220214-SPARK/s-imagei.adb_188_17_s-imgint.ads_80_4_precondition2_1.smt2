...
(assert
  (forall ((val__ Int))
    (! (=>
         (dynamic_invariant2 val__ true true true true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___554 (to_rep2
                                                                   (rec__ada___system__val_uns__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000002 temp___554)
                                                        true
                                                        false) (ite (bvule temp___554 #x00000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
           ...
           (and
             (forall ((str2 us_t) (fst_num Int))
               (scan_raw_unsigned_ghost__function_guard
                 ...
                 (last str2)))
             (and
               (forall ((str2 us_t) (val__1 Int) (non_blank Int) (uval (_ BitVec 32)))
                 (is_int_of_uns__function_guard
                   (is_int_of_uns
                     (bool_eq10
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_294 us_t) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_809 us_t) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool) (temp___do_typ_inv_808 Bool)) Bool
  (=>
