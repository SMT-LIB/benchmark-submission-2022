...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_623 (_ BitVec 32)) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool
  true)
...
(define-fun dynamic_invariant5 ((temp___expr_271 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool
  (=>
    (or (= temp___is_init_267 true) (<= (- 2147483648) 2147483647))
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___556 (to_rep2
                                                                   (rec__ada___system__val_uns__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000002 temp___556)
                                                        true
                                                        false) (ite (bvule temp___556 #x00000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_296 us_t) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_833 us_t) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool) (temp___do_typ_inv_832 Bool)) Bool
  (=>
