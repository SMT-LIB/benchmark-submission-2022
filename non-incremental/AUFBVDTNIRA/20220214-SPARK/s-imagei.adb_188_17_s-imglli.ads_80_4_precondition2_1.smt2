...
;; user_eq
(declare-fun user_eq9 (long_long_integer
  long_long_integer) Bool)

(declare-const dummy9 long_long_integer)
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_32 Int) (temp___is_init_28 Bool) (temp___skip_constant_29 Bool) (temp___do_toplevel_30 Bool) (temp___do_typ_inv_31 Bool)) Bool
  (=>
    (or
      (= temp___is_init_28 true)
      (<= (- 9223372036854775808) 9223372036854775807))
    (in_range6 temp___expr_32)))
...
;; user_eq
(declare-fun user_eq10 (long_long_unsigned1
  long_long_unsigned1) Bool)

(declare-const dummy10 long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_621 (_ BitVec 64)) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool
  true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___554 (to_rep2
                                                                   (rec__ada___system__val_llu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x0000000000000002 temp___554)
                                                        true
                                                        false) (ite (bvule temp___554 #x0000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
           ...
           (and
             (forall ((str2 us_t) (fst_num Int))
               (scan_raw_unsigned_ghost__function_guard
                 ...
                 (last str2)))
             (and
               (forall ((str2 us_t) (val__1 Int) (non_blank Int) (uval (_ BitVec 64)))
                 (is_int_of_uns__function_guard
                   (is_int_of_uns
                     (bool_eq10
