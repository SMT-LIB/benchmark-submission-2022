...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_623 (_ BitVec 128)) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_271 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool
  (=>
    (or
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___334 (to_rep (select (to_array str1) j))))
                 (or
             ...
             (not
               (= (let ((temp___345 (temp___String_Literal_336 Tuple0)))
                    (bool_eq6
                      ...
                      1
                      0)) true))
             (let ((temp___346 (to_rep (select (to_array str1) (first str1)))))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___434 (let ((temp___433 (last str1)))
                                      (of_array
                                        (to_array str1)
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 (scan_natural_ghost
                   (let ((temp___518 (let ((temp___517 (last str2)))
                                       (of_array
                                         (to_array str2)
                                         start
                                         temp___517))))
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___372 (to_rep (select (to_array str1) j))))
                 (or
             ...
             (not
               (= (let ((temp___390 (temp___String_Literal_376 Tuple0)))
                    (bool_eq6
                      ...
                      1
                      0)) true))
             (let ((temp___391 (to_rep (select (to_array str1) (first str1)))))
               (or
    ...
    (! (and
         ...
         (and
           (forall ((str2 us_t) (last_num_init Int))
             (last_hexa_ghost__function_guard
               (last_hexa_ghost
                 (let ((temp___468 (let ((temp___467 (last str2)))
                 ...
                 (let ((starts_as_based (and (and (bool_lt1
                   ...
                   (let ((last_num_based (ite (= starts_as_based true)
                     ...
                     (and
                       ...
                       (= (is_opt_exponent_format_ghost
                            (let ((temp___464 (let ((temp___463 (last str1)))
                                                (of_array
                                                  (to_array str1)
    ...
    (forall ((from Int) (to__ Int))
      (! (and
           (forall ((str2 us_t) (from1 Int) (to__1 Int))
             (last_number_ghost__function_guard
               (last_number_ghost
                 (let ((temp___574 (of_array (to_array str2) from1 to__1)))
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___556 (to_rep2
                                                                   (rec__ada___system__val_lllu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000000000000000000000000000002 temp___556)
                                                        true
                                                        false) (ite (bvule temp___556 #x00000000000000000000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___598 (to_rep (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___616 (of_array (to_array str2) from1 to__1)))
             ...
             (and
               (and
                 (and
                   ...
                   (and (<= (first str1) from) (<= from (last str1))))
                 (and (<= from to__) (<= to__ (last str1))))
               (let ((temp___653 (to_rep (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___677 (of_array (to_array str2) from1 to__1)))
...
(assert
  (forall ((str1 us_t))
    (! (=>
         (dynamic_invariant1 str1 true true true true)
         (= (slide_to_1 str1) (let ((res (let ((temp___311 (slide
                                                             (to_array str1)
                                                             (first str1)
                                                             1)))
                                           (of_array
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_296 us_t) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool
  (=>
...
(define-fun default_initial_assumption1 ((temp___expr_298 us_t) (temp___skip_top_level_299 Bool)) Bool
  (and
    (= (first temp___expr_298) 1)
    (= (last temp___expr_298) (length str1))))

;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_833 us_t) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool) (temp___do_typ_inv_832 Bool)) Bool
  (=>
...
(assert
  (and
    (and
      (and
        (and
          ...
          (let ((temp___1506 (to_rep
                               (select (to_array
                                         (of_array
                                           s
                                           (to_rep1 s__first)
                                           (to_rep1 s__last))) 1))))
            (or (= temp___1506 32) (= temp___1506 45))))
        (=
          (= (to_rep
               (select (to_array
          ...
          (< v 0)))
      (= (only_decimal_ghost
           (let ((temp___1508 (of_array
                                s
                                (to_rep1 s__first)
                                (to_rep1 s__last))))
             (of_array
               (to_array temp___1508)
               (first temp___1508)
               (last temp___1508)))
           2
           p) true))
    (and
      ...
      (= (bool_eq9
           (scan_based_number_ghost
             (let ((temp___1510 (of_array
                                  s
                                  (to_rep1 s__first)
                                  (to_rep1 s__last))))
               (of_array
                 (to_array temp___1510)
                 (first temp___1510)
                 (last temp___1510)))
             2
             p
