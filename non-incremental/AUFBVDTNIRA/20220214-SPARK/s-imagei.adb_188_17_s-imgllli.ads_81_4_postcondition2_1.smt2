...
;; user_eq
(declare-fun user_eq9 (long_long_long_integer
  long_long_long_integer) Bool)

(declare-const dummy9 long_long_long_integer)
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool
  (=>
    (or
      (= temp___is_init_35 true)
      (<= (- 170141183460469231731687303715884105728) 170141183460469231731687303715884105727))
    (in_range6 temp___expr_39)))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_621 (_ BitVec 128)) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool
  true)
...
(assert
  (forall ((val__ Int))
    (! (=>
         (dynamic_invariant4 val__ true true true true)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool
  (=>
    (or
...
(declare-datatypes ((t37s__ref 0))
  (((t37s__refqtmk (t37s__content us_t)))))

;; t37s__ref_t37s__content__projection
(define-fun t37s__ref_t37s__content__projection ((a t37s__ref)) us_t
  (t37s__content a))
             ...
             (not
               (= (let ((temp___343 (temp___String_Literal_334 Tuple0)))
                    (bool_eq5
                      ...
                      1
                      0)) true))
             (let ((temp___344 (to_rep (select (to_array str1) (first str1)))))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___432 (let ((temp___431 (last str1)))
                                      (of_array
                                        (to_array str1)
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 (scan_natural_ghost
                   (let ((temp___516 (let ((temp___515 (last str2)))
                                       (of_array
                                         (to_array str2)
                                         start
                                         temp___515))))
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___370 (to_rep (select (to_array str1) j))))
                 (or
             ...
             (not
               (= (let ((temp___388 (temp___String_Literal_374 Tuple0)))
                    (bool_eq5
                      ...
                      1
                      0)) true))
             (let ((temp___389 (to_rep (select (to_array str1) (first str1)))))
               (or
    ...
    (! (and
         ...
         (and
           (forall ((str2 us_t) (last_num_init Int))
             (last_hexa_ghost__function_guard
               (last_hexa_ghost
                 (let ((temp___466 (let ((temp___465 (last str2)))
                 ...
                 (let ((starts_as_based (and (and (bool_lt1
                   ...
                   (let ((last_num_based (ite (= starts_as_based true)
                     ...
                     (and
                       ...
                       (= (is_opt_exponent_format_ghost
                            (let ((temp___462 (let ((temp___461 (last str1)))
                                                (of_array
                                                  (to_array str1)
    ...
    (forall ((from Int) (to__ Int))
      (! (and
           (forall ((str2 us_t) (from1 Int) (to__1 Int))
             (last_number_ghost__function_guard
               (last_number_ghost
                 (let ((temp___572 (of_array (to_array str2) from1 to__1)))
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___596 (to_rep (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___614 (of_array (to_array str2) from1 to__1)))
             ...
             (and
               (and
                 (and
                   ...
                   (and (<= (first str1) from) (<= from (last str1))))
                 (and (<= from to__) (<= to__ (last str1))))
               (let ((temp___651 (to_rep (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___675 (of_array (to_array str2) from1 to__1)))
...
(assert
  (forall ((str1 us_t))
    (! (=>
         (dynamic_invariant1 str1 true true true true)
         (= (slide_to_1 str1) (let ((res (let ((temp___309 (slide
                                                             (to_array str1)
                                                             (first str1)
                                                             1)))
                                           (of_array
  ...
  (and
    (forall ((str1 us_t))
      (only_space_ghost__function_guard
        ...
        (last str1)))
    (forall ((str1 us_t))
      (is_integer_ghost__function_guard (is_integer_ghost str1) str1))))
           ...
           (and
             (forall ((str2 us_t) (fst_num Int))
               (scan_raw_unsigned_ghost__function_guard
                 ...
                 (last str2)))
             (and
               (forall ((str2 us_t) (val__1 Int) (non_blank Int) (uval (_ BitVec 128)))
                 (is_int_of_uns__function_guard
                   (is_int_of_uns
                     (bool_eq10
                       (to_rep (select (to_array str2) non_blank))
                       45)
                     uval
                     val__1)
                   (bool_eq10 (to_rep (select (to_array str2) non_blank)) 45)
                   uval
                   val__1))
               (=
                 (= (is_value_integer_ghost str1 val__) true)
                 (let ((non_blank (first_non_space_ghost
                                    str1
                                    (first str1)
                                    (last str1))))
                   (= (is_int_of_uns
                        ...
                        (scan_raw_unsigned_ghost
                          ...
                          (ite (let ((temp___722 (to_rep
                                                   (select (to_array str1) non_blank))))
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_294 us_t) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool
  (=>
    ...
    (and
      ...
      (= (last temp___expr_294) (length str1)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_296 us_t) (temp___skip_top_level_297 Bool)) Bool
  (and
    (= (first temp___expr_296) 1)
    (= (last temp___expr_296) (length str1))))

;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_809 us_t) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool) (temp___do_typ_inv_808 Bool)) Bool
  (=>
...
;; Assume
(assert (dynamic_invariant6 v true false true true))
...
(assert
  (and
    (and
      (and
        (and
          ...
          (let ((temp___1320 (to_rep
                               (select (to_array
                                         (of_array
                                           s
                                           (to_rep1 s__first)
                                           (to_rep1 s__last))) 1))))
            (or (= temp___1320 32) (= temp___1320 45))))
        (=
          (= (to_rep
               (select (to_array
                         (of_array s (to_rep1 s__first) (to_rep1 s__last))) 1)) 45)
          (< v 0)))
      (= (only_decimal_ghost
           (let ((temp___1322 (of_array
                                s
                                (to_rep1 s__first)
                                (to_rep1 s__last))))
             (of_array
               (to_array temp___1322)
               (first temp___1322)
               (last temp___1322)))
           2
           p) true))
    (and
      ...
      (= (bool_eq9
           (scan_based_number_ghost
             (let ((temp___1324 (of_array
                                  s
                                  (to_rep1 s__first)
                                  (to_rep1 s__last))))
               (of_array
                 (to_array temp___1324)
                 (first temp___1324)
                 (last temp___1324)))
             2
             p
...
(assert
  (and
    (value_integer__function_guard (value_integer str) str)
    (= (value_integer str) v)))

;; Goal def'vc
;; File "s-imagei.adb", line 177, characters 0-0
(assert
  (not
  (=>
    (is_integer_ghost__function_guard
      (is_integer_ghost
        (let ((temp___1331 (of_array
                             (to_array
                               (of_array
                                 s
                                 (to_rep1 s__first)
