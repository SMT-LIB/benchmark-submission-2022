...
;; user_eq
(declare-fun user_eq (long_long_integer
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_229 (_ BitVec 64)) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool
  true)

;; to_rep
(declare-fun to_rep (long_long_unsigned) (_ BitVec 64))

;; of_rep
(declare-fun of_rep ((_ BitVec 64)) long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_278 (_ BitVec 64)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
(assert
  (and
    (and (bvule #x0000000000000000 ru) (bvule ru #x0000000000000009))
    (and (<= 0 ri) (<= ri 9))))
...
(assert
  ...
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost (bv2nat64 (bvadd #x0000000000000030 ru)))
      (bv2nat64 (bvadd #x0000000000000030 ru)))
    (= (hexa_to_unsigned_ghost (bv2nat64 (bvadd #x0000000000000030 ru))) 
    ru))))
