...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool
  (=>
    (or
      (= temp___is_init_265 true)
      (<= (- 170141183460469231731687303715884105728) 170141183460469231731687303715884105727))
    (in_range3 temp___expr_269)))
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_276 (_ BitVec 128)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool
  true)
...
(assert
  ...
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat (bvadd #x00000000000000000000000000000030 ru)))
      (bv2nat (bvadd #x00000000000000000000000000000030 ru)))
    (= (hexa_to_unsigned_ghost
         (bv2nat (bvadd #x00000000000000000000000000000030 ru))) ru))))
