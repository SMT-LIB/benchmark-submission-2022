...
;; user_eq
(declare-fun user_eq (long_long_long_integer
  long_long_long_integer) Bool)

(declare-const dummy long_long_long_integer)
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_88 Int) (temp___is_init_84 Bool) (temp___skip_constant_85 Bool) (temp___do_toplevel_86 Bool) (temp___do_typ_inv_87 Bool)) Bool
...
;; user_eq
(declare-fun user_eq2 (long_long_long_unsigned
  long_long_long_unsigned) Bool)

(declare-const dummy2 long_long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_229 (_ BitVec 128)) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool
  true)

;; to_rep
(declare-fun to_rep (long_long_long_unsigned) (_ BitVec 128))

;; of_rep
(declare-fun of_rep ((_ BitVec 128)) long_long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_271 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool
  (=>
    (or
...
;; user_eq
(declare-fun user_eq4 (uns
  uns) Bool)

(declare-const dummy4 uns)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_278 (_ BitVec 128)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
;; Assume
(assert (dynamic_invariant3 ru true false true true))

;; Assume
(assert (dynamic_invariant2 ri true false true true))

;; Assume
(assert
  (and
    (and
      (bvule #x00000000000000000000000000000000 ru)
      (bvule ru #x00000000000000000000000000000009))
    (and (<= 0 ri) (<= ri 9))))

;; Goal def'vc
;; File "s-imagei.adb", line 267, characters 0-0
(assert
  (not
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat128 (bvadd #x00000000000000000000000000000030 ru)))
      (bv2nat128 (bvadd #x00000000000000000000000000000030 ru)))
    (= (hexa_to_unsigned_ghost
         (bv2nat128 (bvadd #x00000000000000000000000000000030 ru))) ru))))
