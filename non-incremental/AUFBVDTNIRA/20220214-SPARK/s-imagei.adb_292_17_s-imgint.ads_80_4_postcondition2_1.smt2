...
;; uns_of_non_positive
(define-fun uns_of_non_positive ((t Int)) (_ BitVec 32)
  (ite (= t (- 2147483648)) #x80000000 (of_int (- t))))
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_278 (_ BitVec 32)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
