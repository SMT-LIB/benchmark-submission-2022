...
;; uns_of_non_positive
(define-fun uns_of_non_positive ((t Int)) (_ BitVec 64)
  (ite (= t (- 9223372036854775808)) #x8000000000000000 (of_int (- t))))
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_278 (_ BitVec 64)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
