...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_787 Int) (temp___is_init_783 Bool) (temp___skip_constant_784 Bool) (temp___do_toplevel_785 Bool) (temp___do_typ_inv_786 Bool)) Bool
  (=>
    (or
      (= temp___is_init_783 true)
      (<= (- 170141183460469231731687303715884105728) 0))
    (in_range temp___expr_787)))
