...
;; Ensures
(assert
  (= (div1 (bv2nat32 (uns_of_non_positive value)) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  (uns_of_non_positive
    value) #x0000000A))))
...
;; Assert
(assert (<= 0 (bv2nat32 (uns_of_non_positive t1))))

;; Ensures
(assert
  (= (div1
       (div1 (bv2nat32 (uns_of_non_positive t1)) (power big_10 nb_digits))
       big_10) (div1
                 (bv2nat32 (uns_of_non_positive t1))
                 (* (power big_10 nb_digits) big_10))))

;; H
(assert
  (= (bvudiv uns_value #x0000000A) (uns_of_non_positive (div1 value 10))))

;; H
(assert
  (= (bvurem uns_value #x0000000A) (uns_of_non_positive (mod1 value 10))))
...
;; H
(assert (= uns_value1 (bvudiv uns_value #x0000000A)))
...
;; H
(assert
  (= (uns_of_non_positive value1) (ite (= value1 (- 2147483648))
                                    #x80000000
                                    (of_int (- value1)))))
...
;; LoopInvariant
(assert (= (bv2nat32 uns_value2) (div1 (bv2nat32 uns_t) pow3)))
...
;; Ensures
(assert (not (= (bv2nat32 uns_value2) 0)))

;; Assert
(assert (<= pow3 (bv2nat32 #xFFFFFFFF)))
...
;; H
(assert
  (= (uns_of_non_positive value2) (ite (= value2 (- 2147483648))
                                    #x80000000
                                    (of_int (- value2)))))

;; Ensures
(assert
  (= (div1 (bv2nat32 (uns_of_non_positive value2)) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  (uns_of_non_positive
    value2) #x0000000A))))
...
(assert
  (= (div1
       (div1 (bv2nat32 (uns_of_non_positive t1)) (power big_10 nb_digits2))
       big_10) (div1
                 (bv2nat32 (uns_of_non_positive t1))
...
(assert
  (not (= (bv2nat32 uns_value3) (div1 (bv2nat32 uns_t) pow4))))
