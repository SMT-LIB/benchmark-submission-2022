...
(assert
  (= (div1
       (bv2nat64 (uns_of_non_positive value))
       (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv (uns_of_non_positive
...
;; Assert
(assert (<= 0 (bv2nat64 (uns_of_non_positive t1))))

;; Ensures
(assert
  (= (div1
       (div1 (bv2nat64 (uns_of_non_positive t1)) (power big_10 nb_digits))
       big_10) (div1
                 (bv2nat64 (uns_of_non_positive t1))
                 (* (power big_10 nb_digits) big_10))))

;; H
(assert
  (= (bvudiv uns_value #x000000000000000A) (uns_of_non_positive
                                             (div1 value 10))))

;; H
(assert
  (= (bvurem uns_value #x000000000000000A) (uns_of_non_positive
                                             (mod1 value 10))))

(declare-const value1 Int)

;; H
(assert (= value1 (div1 value 10)))
...
;; H
(assert (= uns_value1 (bvudiv uns_value #x000000000000000A)))
...
;; H
(assert
  (dynamic_invariant5 (uns_of_non_positive value1) true false true true))

;; H
(assert
  (= (uns_of_non_positive value1) (ite (= value1 (- 9223372036854775808))
                                    #x8000000000000000
                                    (of_int (- value1)))))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= uns_value1 (uns_of_non_positive value1)) true false))
...
;; LoopInvariant
(assert (= uns_value2 (uns_of_non_positive value2)))

;; LoopInvariant
(assert (and (<= 1 nb_digits2) (<= nb_digits2 (- unsigned_width_ghost1 1))))

;; LoopInvariant
(assert (= pow3 (power big_10 nb_digits2)))

;; LoopInvariant
(assert (= (bv2nat64 uns_value2) (div1 (bv2nat64 uns_t) pow3)))
...
(assert
  (and
    (and
      (and
        (dynamic_invariant5 uns_value2 true true true true)
        (dynamic_invariant nb_digits2 true true true true))
      (dynamic_invariant6 value2 true true true true))
    (dynamic_invariant7 pow3 true true true true)))

;; (=)'result'unused'unused
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= value2 0) true false))

;; H
(assert (not (= value2 0)))

;; Ensures
(assert (not (= (bv2nat64 uns_value2) 0)))

;; Assert
(assert (<= pow3 (bv2nat64 #xFFFFFFFFFFFFFFFF)))

;; H
(assert
  (dynamic_invariant5 (uns_of_non_positive value2) true false true true))

;; H
(assert
  (= (uns_of_non_positive value2) (ite (= value2 (- 9223372036854775808))
                                    #x8000000000000000
                                    (of_int (- value2)))))
...
(assert
  (= (div1
       (bv2nat64 (uns_of_non_positive value2))
       (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv (uns_of_non_positive
...
(assert
  (= (div1
       (div1 (bv2nat64 (uns_of_non_positive t1)) (power big_10 nb_digits2))
       big_10) (div1
                 (bv2nat64 (uns_of_non_positive t1))
                 (* (power big_10 nb_digits2) big_10))))
...
;; LoopInvariant
(assert (and (<= 1 nb_digits3) (<= nb_digits3 (- unsigned_width_ghost1 1))))
...
(assert
  (not (= (bv2nat64 uns_value3) (div1 (bv2nat64 uns_t) pow4))))
