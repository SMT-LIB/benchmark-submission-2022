...
;; H
(assert
  (dynamic_invariant4 (uns_of_non_positive value1) true false true true))
...
;; LoopInvariant
(assert (= (bv2nat uns_value2) (div1 (bv2nat uns_t) pow3)))
...
(assert
  (and
    (and
      (and
        (dynamic_invariant4 uns_value2 true true true true)
...
(assert
  (not (= (bv2nat uns_value3) (div1 (bv2nat uns_t) pow4))))
