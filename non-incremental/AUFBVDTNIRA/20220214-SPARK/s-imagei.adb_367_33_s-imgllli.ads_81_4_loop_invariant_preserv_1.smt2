...
(assert
  (= (div1
       (bv2nat128 (uns_of_non_positive value))
...
;; Assert
(assert (<= 0 (bv2nat128 (uns_of_non_positive t1))))

;; Ensures
(assert
  (= (div1
       (div1 (bv2nat128 (uns_of_non_positive t1)) (power big_10 nb_digits))
       big_10) (div1
                 (bv2nat128 (uns_of_non_positive t1))
                 (* (power big_10 nb_digits) big_10))))

;; H
(assert
  (= (bvudiv uns_value #x0000000000000000000000000000000A) (uns_of_non_positive
                                                             (div1 value 10))))
...
;; H
(assert (= uns_value1 (bvudiv uns_value #x0000000000000000000000000000000A)))
...
;; H
(assert
  (= (uns_of_non_positive value1) (ite (= value1 (- 170141183460469231731687303715884105728))
                                    #x80000000000000000000000000000000
                                    (of_int (- value1)))))
...
;; LoopInvariant
(assert (= (bv2nat128 uns_value2) (div1 (bv2nat128 uns_t) pow3)))
...
;; Ensures
(assert (not (= (bv2nat128 uns_value2) 0)))
...
;; H
(assert
  (= (uns_of_non_positive value2) (ite (= value2 (- 170141183460469231731687303715884105728))
                                    #x80000000000000000000000000000000
                                    (of_int (- value2)))))
...
(assert
  (= (div1
       (bv2nat128 (uns_of_non_positive value2))
       (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
  (uns_of_non_positive
...
(assert
  (= (div1
       (div1 (bv2nat128 (uns_of_non_positive t1)) (power big_10 nb_digits2))
       big_10) (div1
                 (bv2nat128 (uns_of_non_positive t1))
...
(assert
  (not (= (bv2nat128 uns_value3) (div1 (bv2nat128 uns_t) pow4))))
