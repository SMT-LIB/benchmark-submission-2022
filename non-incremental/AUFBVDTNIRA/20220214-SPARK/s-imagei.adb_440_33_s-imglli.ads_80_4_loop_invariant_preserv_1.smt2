...
;; LoopInvariant
(assert (= uns_value5 (uns_of_non_positive value5)))

;; LoopInvariant
(assert (bvule uns_value5 #x1999999999999999))
...
(assert
  (= (ite (forall ((j3 Int))
            (=>
              ...
              (let ((temp___753 (to_rep
                                  (select (to_array
                                            (let ((temp___1259 (of_array
                                                                 s3
                                                                 (to_rep1
                                                                   s__first)
                                                                 (to_rep1
                                              ...
                                              (of_array
                                                ...
                                                (first temp___1259)
                                                (last temp___1259)))) j3))))
                (and (<= 48 temp___753) (<= temp___753 57)))))
       true
       false) true))
...
(assert
  (not (= (bv2nat64 uns_value5) (div1 (bv2nat64 uns_t) pow6))))
