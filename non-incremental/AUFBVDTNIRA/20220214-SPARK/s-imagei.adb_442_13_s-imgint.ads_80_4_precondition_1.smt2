...
;; user_eq
(declare-fun user_eq6 (unsigned
  unsigned) Bool)

(declare-const dummy6 unsigned)
...
(define-fun uns_of_non_positive ((t1 Int)) (_ BitVec 32)
  (ite (= t1 (- 2147483648)) #x80000000 (of_int (- t1))))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_278 (_ BitVec 32)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
(declare-const uns_t (_ BitVec 32))
...
(define-fun default_initial_assumption1 ((temp___expr_287 us_rep) (temp___skip_top_level_288 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_uns__impl__uns_option__value__pred temp___expr_287)
      (= (to_rep2
           (rec__ada___system__val_uns__impl__uns_option__value
             (us_split_fields1 temp___expr_287))) #x00000000))))
...
(define-fun dynamic_invariant6 ((temp___expr_787 Int) (temp___is_init_783 Bool) (temp___skip_constant_784 Bool) (temp___do_toplevel_785 Bool) (temp___do_typ_inv_786 Bool)) Bool
  (=>
    (or (= temp___is_init_783 true) (<= (- 2147483648) 0))
...
;; bool_eq
(define-fun bool_eq14 ((x (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (= x y) true false))
...
;; user_eq
(declare-fun user_eq14 (unsigned1
  unsigned1) Bool)

(declare-const dummy14 unsigned1)
...
(define-fun unsigned__ref_unsigned__content__4__projection ((a unsigned__ref1)) unsigned1
  (unsigned__content1 a))

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_245 (_ BitVec 32)) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool
  true)
...
;; big_10__def_axiom
(assert (= big_101 (bv2nat32 #x0000000A)))
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log10 us_void_param) (let ((temp___249 32))
                                      (ite (= temp___249 8)
                                        2
                                        (ite (= temp___249 16)
                                          4
                 ...
                 (ite (bvugt lo hi)
                   ...
                   (and
                     (and
                       ...
                       (< (bv2nat32 lo) (power big_101 (- result 1))))
                     (< (bv2nat32 hi) (power big_101 (- result 1)))))
                 (dynamic_invariant result true false true true)))))) :pattern (
    (width
      lo
      hi)) )))
...
;; big_10__def_axiom
(assert (= big_10 (bv2nat32 #x0000000A)))
...
(declare-const prev__split_fields unsigned)

(declare-const prev__split_discrs Bool)

(declare-const cur__split_fields unsigned)

(declare-const cur__split_discrs Bool)

(declare-const prev_value (_ BitVec 32))
...
;; H
(assert
  (= (uns_of_non_positive t1) (ite (= t1 (- 2147483648))
                                #x80000000
                                (of_int (- t1)))))
...
;; H
(assert
  (= (uns_of_non_positive value) (ite (= value (- 2147483648))
                                   #x80000000
                                   (of_int (- value)))))

(declare-const uns_value (_ BitVec 32))
...
(declare-const uns_value1 (_ BitVec 32))
  ...
  (let ((o (uns_of_non_positive value)))
    (and
      (and
        ...
        (= o (ite (= value (- 2147483648)) #x80000000 (of_int (- value)))))
      (and
        (= (div1 (bv2nat32 o) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv o #x0000000A)))
                      ...
                      (let ((o4 (bv2nat32 o3)))
                        (and
                          ...
                          (and
                            ...
                            (and
                              (and
                                (= (bvudiv uns_value #x0000000A) (uns_of_non_positive
                                                                   (div1
                                                                    value
                                                                    10)))
                                (= (bvurem uns_value #x0000000A) (uns_of_non_positive
                                                                   (mod1
                                                                    value
                                                                    10))))
                              (exists ((value2 Int))
                                  ...
                                  (let ((o5 (+ nb_digits 1)))
                                    (and
                                      ...
                                      (exists ((nb_digits2 Int))
                                        (and
                                          (= nb_digits2 o5)
                                          (exists ((uns_value2 (_ BitVec 32)))
                                            (and
                                              (= uns_value2 (bvudiv uns_value #x0000000A))
                                              (let ((o6 (* pow 10)))
                                                (and
                                                  (< 0 o6)
                                                  (exists ((pow3 Int))
...
(declare-const uns_value2 (_ BitVec 32))
...
;; Assert
(assert (= uns_value2 (of_int (div1 (bv2nat32 uns_t) (power big_10 0)))))
...
;; Ensures
(assert
  (= (div1 (bv2nat32 uns_value2) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  uns_value2 #x0000000A))))
...
;; Assert
(assert (<= 0 (bv2nat32 uns_t)))

;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 uns_t) (power big_10 (- nb_digits1 j))) big_10) 
  (div1
    (bv2nat32 uns_t)
...
;; H
(assert
  (let ((temp___899 (bv2nat32 (bvadd #x00000030 (bvurem uns_value2 #x0000000A)))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat32 (bvadd #x00000030 (bvurem uns_value2 #x0000000A))))
      (bv2nat32 (bvadd #x00000030 (bvurem uns_value2 #x0000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat32 (bvadd #x00000030 (bvurem uns_value2 #x0000000A)))) (bvurem 
    uns_value2 #x0000000A))))
...
;; H
(assert
  (= (bvudiv uns_value2 #x0000000A) (uns_of_non_positive (div1 value2 10))))

;; H
(assert
  (= (bvurem uns_value2 #x0000000A) (uns_of_non_positive (mod1 value2 10))))
...
;; Assert
(assert (= (bvurem uns_value2 #x0000000A) (of_int (- (mod1 value2 10)))))

(declare-const prev_value1 (_ BitVec 32))
...
(declare-const uns_value3 (_ BitVec 32))

;; H
(assert (= uns_value3 (bvudiv uns_value2 #x0000000A)))
    ...
    (= (hexa_to_unsigned_ghost
         (to_rep
           ...
           p j)))) (bvurem (of_int
                             (div1
                               (bv2nat32 uns_t)
                               (power big_10 (- nb_digits1 j)))) #x0000000A))))
                          ...
                          (ite (= (to_rep
                            ...
                            (ite (= (scan_overflows_ghost
                              ...
                              (scan_based_number_ghost
                                ...
                                (+ p nb_digits1)
                                #x0000000A
                                (bvadd (bvmul #x0000000A prev_value1) 
                                (hexa_to_unsigned_ghost
                                  (to_rep
                                    (select (to_array
                                              (of_array
...
(declare-const prev__split_fields1 unsigned)
                         ...
                         (ite (= (to_rep
                           ...
                           (ite (= (scan_overflows_ghost
                             ...
                             (scan_based_number_ghost
                               ...
                               (+ p nb_digits1)
                               #x0000000A
                               (bvadd (bvmul #x0000000A uns_value3) (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
(declare-const cur__split_fields1 unsigned)
...
;; Assert
(assert
  (= prev_value1 (bvadd (bvmul #x0000000A uns_value3) (bvurem prev_value1 #x0000000A))))
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j))))
    (= (bvurem prev_value1 #x0000000A) (hexa_to_unsigned_ghost
                                         (to_rep
                                           (select (to_array
                                                     (of_array
                                                       s1
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j))))
    (= prev_value1 (bvadd (bvmul #x0000000A uns_value3) (hexa_to_unsigned_ghost
                                                          (to_rep
                                                            (select (to_array
                                                                    (of_array
                                                                    s1
...
;; H
(assert
  (= (uns_of_non_positive value3) (ite (= value3 (- 2147483648))
                                    #x80000000
                                    (of_int (- value3)))))
...
(declare-const uns_value4 (_ BitVec 32))

(declare-const prev__split_fields2 unsigned)

(declare-const prev__split_discrs2 Bool)

(declare-const cur__split_fields2 unsigned)

(declare-const cur__split_discrs2 Bool)

(declare-const prev_value2 (_ BitVec 32))
...
;; LoopInvariant
(assert (bvule uns_value4 #x19999999))
...
;; LoopInvariant
(assert (= (bv2nat32 uns_value4) (div1 (bv2nat32 uns_t) pow5)))
...
;; Ensures
(assert
  (= (div1 (bv2nat32 uns_value4) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  uns_value4 #x0000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 uns_t) (power big_10 (- nb_digits1 j2))) big_10) 
  (div1
    (bv2nat32 uns_t)
...
;; H
(assert
  (let ((temp___899 (bv2nat32 (bvadd #x00000030 (bvurem uns_value4 #x0000000A)))))
    (and (<= 48 temp___899) (<= temp___899 57))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat32 (bvadd #x00000030 (bvurem uns_value4 #x0000000A))))
      (bv2nat32 (bvadd #x00000030 (bvurem uns_value4 #x0000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat32 (bvadd #x00000030 (bvurem uns_value4 #x0000000A)))) (bvurem 
    uns_value4 #x0000000A))))
...
;; H
(assert
  (= (bvudiv uns_value4 #x0000000A) (uns_of_non_positive (div1 value4 10))))

;; H
(assert
  (= (bvurem uns_value4 #x0000000A) (uns_of_non_positive (mod1 value4 10))))
...
;; Assert
(assert (= (bvurem uns_value4 #x0000000A) (of_int (- (mod1 value4 10)))))

(declare-const prev_value3 (_ BitVec 32))
...
(declare-const uns_value5 (_ BitVec 32))

;; H
(assert (= uns_value5 (bvudiv uns_value4 #x0000000A)))
    ...
    (= (hexa_to_unsigned_ghost
         (to_rep
           ...
           p j2)))) (bvurem (of_int
                              (div1
                                (bv2nat32 uns_t)
                                (power big_10 (- nb_digits1 j2)))) #x0000000A))))
                          ...
                          (ite (= (to_rep
                            ...
                            (ite (= (scan_overflows_ghost
                              ...
                              (scan_based_number_ghost
                                ...
                                (+ p nb_digits1)
                                #x0000000A
                                (bvadd (bvmul #x0000000A prev_value3) 
                                (hexa_to_unsigned_ghost
                                  (to_rep
                                    (select (to_array
                                              (of_array
...
(declare-const prev__split_fields3 unsigned)
                         ...
                         (ite (= (to_rep
                           ...
                           (ite (= (scan_overflows_ghost
                             ...
                             (scan_based_number_ghost
                               ...
                               (+ p nb_digits1)
                               #x0000000A
                               (bvadd (bvmul #x0000000A uns_value5) (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
(declare-const cur__split_fields3 unsigned)
...
;; Assert
(assert
  (= prev_value3 (bvadd (bvmul #x0000000A uns_value5) (bvurem prev_value3 #x0000000A))))
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j2))))
    (= (bvurem prev_value3 #x0000000A) (hexa_to_unsigned_ghost
                                         (to_rep
                                           (select (to_array
                                                     (of_array
                                                       s3
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j2))))
    (= prev_value3 (bvadd (bvmul #x0000000A uns_value5) (hexa_to_unsigned_ghost
                                                          (to_rep
                                                            (select (to_array
                                                                    (of_array
                                                                    s3
...
;; H
(assert
  (= (uns_of_non_positive value5) (ite (= value5 (- 2147483648))
                                    #x80000000
                                    (of_int (- value5)))))
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat32 uns_value5) (div1 (bv2nat32 uns_t) pow6)) true false))
