...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_229 (_ BitVec 64)) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool
  true)
...
;; uns_of_non_positive
(define-fun uns_of_non_positive ((t1 Int)) (_ BitVec 64)
  (ite (= t1 (- 9223372036854775808)) #x8000000000000000 (of_int (- t1))))

;; uns_of_non_positive__function_guard
(declare-fun uns_of_non_positive__function_guard ((_ BitVec 64)
  Int) Bool)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_278 (_ BitVec 64)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
(declare-const uns_t (_ BitVec 64))
...
(define-fun default_initial_assumption1 ((temp___expr_287 us_rep) (temp___skip_top_level_288 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_llu__impl__uns_option__value__pred temp___expr_287)
      (= (to_rep2
           (rec__ada___system__val_llu__impl__uns_option__value
             (us_split_fields1 temp___expr_287))) #x0000000000000000))))
...
(assert
  (forall ((i non_positive))
    (and
      (<= (- 9223372036854775808) (non_positiveqtint i))
      (<= (non_positiveqtint i) 0))))

;; in_range
(define-fun in_range6 ((x Int)) Bool
  (and (<= (- 9223372036854775808) x) (<= x 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_787 Int) (temp___is_init_783 Bool) (temp___skip_constant_784 Bool) (temp___do_toplevel_785 Bool) (temp___do_typ_inv_786 Bool)) Bool
  (=>
    (or (= temp___is_init_783 true) (<= (- 9223372036854775808) 0))
...
;; user_eq
(declare-fun user_eq14 (long_long_unsigned1
  long_long_unsigned1) Bool)

(declare-const dummy14 long_long_unsigned1)
...
;; H
(assert
  (= (uns_of_non_positive t1) (ite (= t1 (- 9223372036854775808))
                                #x8000000000000000
                                (of_int (- t1)))))
...
;; H
(assert
  (= (uns_of_non_positive value) (ite (= value (- 9223372036854775808))
                                   #x8000000000000000
                                   (of_int (- value)))))

(declare-const uns_value (_ BitVec 64))
...
(declare-const uns_value1 (_ BitVec 64))
  ...
  (let ((o (uns_of_non_positive value)))
    (and
      (and
        ...
        (= o (ite (= value (- 9223372036854775808))
               #x8000000000000000
               (of_int (- value)))))
      (and
        (= (div1 (bv2nat64 o) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv o #x000000000000000A)))
                      ...
                      (let ((o4 (bv2nat64 o3)))
                        (and
                          ...
                          (and
                            ...
                            (and
                              (and
                                (= (bvudiv uns_value #x000000000000000A) 
                                (uns_of_non_positive
                                  (div1 value 10)))
                                (= (bvurem uns_value #x000000000000000A) 
                                (uns_of_non_positive
                                  (mod1 value 10))))
                              (exists ((value2 Int))
                                (and
                                  ...
                                  (let ((o5 (+ nb_digits 1)))
                                    (and
                                      ...
                                      (exists ((nb_digits2 Int))
                                        (and
                                          (= nb_digits2 o5)
                                          (exists ((uns_value2 (_ BitVec 64)))
                                            (and
                                              (= uns_value2 (bvudiv uns_value #x000000000000000A))
                                              (let ((o6 (* pow 10)))
                                                (and
                                                  (< 0 o6)
                                                  (exists ((pow3 Int))
                                                        ...
                                                        (and
                                                          (and
                                                            (dynamic_invariant5
                                                              ...
                                                              true
                                                              true)
                                                            (= o7 (ite (= value2 (- 9223372036854775808))
                                                                    #x8000000000000000
                                                                    (of_int
                                                                    (- value2)))))
                                                          (and
...
(declare-const uns_value2 (_ BitVec 64))
...
;; Assert
(assert (= uns_value2 (of_int (div1 (bv2nat64 uns_t) (power big_10 0)))))
...
;; Ensures
(assert
  (= (div1 (bv2nat64 uns_value2) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  uns_value2 #x000000000000000A))))
...
;; Assert
(assert (<= 0 (bv2nat64 uns_t)))

;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 uns_t) (power big_10 (- nb_digits1 j))) big_10) 
  (div1
    (bv2nat64 uns_t)
...
;; H
(assert
  (let ((temp___899 (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value2 #x000000000000000A)))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value2 #x000000000000000A))))
      (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value2 #x000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value2 #x000000000000000A)))) (bvurem 
    uns_value2 #x000000000000000A))))
...
;; H
(assert
  (= (bvudiv uns_value2 #x000000000000000A) (uns_of_non_positive
                                              (div1 value2 10))))

;; H
(assert
  (= (bvurem uns_value2 #x000000000000000A) (uns_of_non_positive
                                              (mod1 value2 10))))
...
;; Assert
(assert
  (= (bvurem uns_value2 #x000000000000000A) (of_int (- (mod1 value2 10)))))
...
(declare-const uns_value3 (_ BitVec 64))

;; H
(assert (= uns_value3 (bvudiv uns_value2 #x000000000000000A)))
                         ...
                         (ite (= (to_rep
                           ...
                           (ite (= (scan_overflows_ghost
                             ...
                             (scan_based_number_ghost
                               ...
                               (+ p nb_digits1)
                               #x000000000000000A
                               (bvadd (bvmul #x000000000000000A uns_value3) 
                               (hexa_to_unsigned_ghost
                                 (to_rep
                                   (select (to_array
                                             (of_array
...
;; Assert
(assert
  (= prev_value1 (bvadd (bvmul #x000000000000000A uns_value3) (bvurem 
  prev_value1 #x000000000000000A))))
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j))))
    (= (bvurem prev_value1 #x000000000000000A) (hexa_to_unsigned_ghost
                                                 (to_rep
                                                   (select (to_array
                                                             (of_array
                                                               s1
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j))))
    (= prev_value1 (bvadd (bvmul #x000000000000000A uns_value3) (hexa_to_unsigned_ghost
                                                                  (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
;; H
(assert
  (= (uns_of_non_positive value3) (ite (= value3 (- 9223372036854775808))
                                    #x8000000000000000
                                    (of_int (- value3)))))
...
(declare-const uns_value4 (_ BitVec 64))
...
;; LoopInvariant
(assert (bvule uns_value4 #x1999999999999999))
...
;; LoopInvariant
(assert (= (bv2nat64 uns_value4) (div1 (bv2nat64 uns_t) pow5)))
...
;; Ensures
(assert
  (= (div1 (bv2nat64 uns_value4) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  uns_value4 #x000000000000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 uns_t) (power big_10 (- nb_digits1 j2))) big_10) 
  (div1
    (bv2nat64 uns_t)
...
;; H
(assert
  (let ((temp___899 (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value4 #x000000000000000A)))))
    (and (<= 48 temp___899) (<= temp___899 57))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value4 #x000000000000000A))))
      (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value4 #x000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat64 (bvadd #x0000000000000030 (bvurem uns_value4 #x000000000000000A)))) (bvurem 
    uns_value4 #x000000000000000A))))
...
;; H
(assert
  (= (bvudiv uns_value4 #x000000000000000A) (uns_of_non_positive
                                              (div1 value4 10))))

;; H
(assert
  (= (bvurem uns_value4 #x000000000000000A) (uns_of_non_positive
                                              (mod1 value4 10))))
...
;; Assert
(assert
  (= (bvurem uns_value4 #x000000000000000A) (of_int (- (mod1 value4 10)))))
...
(declare-const uns_value5 (_ BitVec 64))

;; H
(assert (= uns_value5 (bvudiv uns_value4 #x000000000000000A)))
                         ...
                         (ite (= (to_rep
                           ...
                           (ite (= (scan_overflows_ghost
                             ...
                             (scan_based_number_ghost
                               ...
                               (+ p nb_digits1)
                               #x000000000000000A
                               (bvadd (bvmul #x000000000000000A uns_value5) 
                               (hexa_to_unsigned_ghost
                                 (to_rep
                                   (select (to_array
                                             (of_array
...
;; Assert
(assert
  (= prev_value3 (bvadd (bvmul #x000000000000000A uns_value5) (bvurem 
  prev_value3 #x000000000000000A))))
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j2))))
    (= (bvurem prev_value3 #x000000000000000A) (hexa_to_unsigned_ghost
                                                 (to_rep
                                                   (select (to_array
                                                             (of_array
                                                               s3
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      ...
      (to_rep
        (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
        p j2))))
    (= prev_value3 (bvadd (bvmul #x000000000000000A uns_value5) (hexa_to_unsigned_ghost
                                                                  (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
;; H
(assert
  (= (uns_of_non_positive value5) (ite (= value5 (- 9223372036854775808))
                                    #x8000000000000000
                                    (of_int (- value5)))))
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat64 uns_value5) (div1 (bv2nat64 uns_t) pow6)) true false))
