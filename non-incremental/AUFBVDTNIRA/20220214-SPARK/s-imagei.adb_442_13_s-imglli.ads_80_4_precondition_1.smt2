...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((k Int))
         (=>
           ...
           (let ((temp___1107 (to_rep
                                (select (to_array
                                          (of_array
                                            s3
                                            (to_rep1 s__first)
                                            (to_rep1 s__last))) k))))
             (and (<= 48 temp___1107) (<= temp___1107 57)))))
    true
    false))
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat uns_value5) (div1 (bv2nat uns_t) pow6)) true false))
