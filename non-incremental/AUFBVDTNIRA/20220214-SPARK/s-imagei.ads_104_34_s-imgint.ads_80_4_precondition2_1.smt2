...
;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_278 (_ BitVec 32)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_787 Int) (temp___is_init_783 Bool) (temp___skip_constant_784 Bool) (temp___do_toplevel_785 Bool) (temp___do_typ_inv_786 Bool)) Bool
  (=>
    (or (= temp___is_init_783 true) (<= (- 2147483648) 0))
    (in_range7 temp___expr_787)))

;; dynamic_invariant
(define-fun dynamic_invariant12 ((temp___expr_944 us_t) (temp___is_init_940 Bool) (temp___skip_constant_941 Bool) (temp___do_toplevel_942 Bool) (temp___do_typ_inv_943 Bool)) Bool
  (=>
...
;; H
(assert (dynamic_invariant4 (abs_uns_of_int v) true false true true))

;; H
(assert
  (= (abs_uns_of_int v) (ite (= v (- 2147483648))
                          #x80000000
