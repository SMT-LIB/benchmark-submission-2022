...
;; bool_eq
(define-fun bool_eq16 ((x (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (= x y) true false))
...
;; user_eq
(declare-fun user_eq15 (long_long_unsigned2
  long_long_unsigned2) Bool)

(declare-const dummy15 long_long_unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_278 (_ BitVec 64)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
;; H
(assert
  (= (abs_uns_of_int v) (ite (= v (- 9223372036854775808))
                          #x8000000000000000
