...
;; user_eq
(declare-fun user_eq4 (character
  character) Bool)
...
;; range_axiom
(assert
  (forall ((x character)) (! (in_range5 (to_rep x)) :pattern ((to_rep x)) )))
...
;; bool_eq
(define-fun bool_eq8 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool
  (ite (and
...
;; bool_eq
(define-fun bool_eq9 ((x us_t) (y us_t)) Bool
  (bool_eq8
    (elts x)
...
;; user_eq
(declare-fun user_eq13 (uns
  uns) Bool)

(declare-const dummy13 uns)
...
;; bool_eq
(define-fun bool_eq15 ((x Int) (y Int)) Bool
  (ite (= x y) true false))
...
;; user_eq
(declare-fun user_eq14 (non_positive
  non_positive) Bool)

(declare-const dummy14 non_positive)
...
(declare-datatypes ((s75s__ref 0))
  (((s75s__refqtmk (s75s__content us_t)))))

;; s75s__ref_s75s__content__projection
(define-fun s75s__ref_s75s__content__projection ((a s75s__ref)) us_t
  (s75s__content a))
...
(define-fun dynamic_invariant8 ((temp___expr_88 Int) (temp___is_init_84 Bool) (temp___skip_constant_85 Bool) (temp___do_toplevel_86 Bool) (temp___do_typ_inv_87 Bool)) Bool
  (=> (or (= temp___is_init_84 true) (<= 0 255)) (in_range5 temp___expr_88)))

(declare-sort long_long_long_unsigned2 0)

(declare-const attr__ATTRIBUTE_MODULUS3 (_ BitVec 128))

;; bool_eq
(define-fun bool_eq16 ((x (_ BitVec 128)) (y (_ BitVec 128))) Bool
  (ite (= x y) true false))

;; attr__ATTRIBUTE_IMAGE
(declare-fun attr__ATTRIBUTE_IMAGE11 ((_ BitVec 128)) us_image)

;; attr__ATTRIBUTE_VALUE__pre_check
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)

;; attr__ATTRIBUTE_VALUE
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) (_ BitVec 128))

;; user_eq
(declare-fun user_eq15 (long_long_long_unsigned2
  long_long_long_unsigned2) Bool)

(declare-const dummy15 long_long_long_unsigned2)
...
;; user_eq
(declare-fun user_eq16 (Int
  Int) Bool)

(declare-const dummy16 Int)
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_278 (_ BitVec 128)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant12 ((temp___expr_787 Int) (temp___is_init_783 Bool) (temp___skip_constant_784 Bool) (temp___do_toplevel_785 Bool) (temp___do_typ_inv_786 Bool)) Bool
  (=>
    (or
      (= temp___is_init_783 true)
      (<= (- 170141183460469231731687303715884105728) 0))
    (in_range8 temp___expr_787)))

;; dynamic_invariant
(define-fun dynamic_invariant13 ((temp___expr_944 us_t) (temp___is_init_940 Bool) (temp___skip_constant_941 Bool) (temp___do_toplevel_942 Bool) (temp___do_typ_inv_943 Bool)) Bool
  (=>
    (not (= temp___skip_constant_941 true))
    (and
      (and
        (dynamic_property
          (to_rep1 s__first)
          (to_rep1 s__last)
          (first temp___expr_944)
          (last temp___expr_944))
        (= (first temp___expr_944) (to_rep1 s__first)))
      (= (last temp___expr_944) (to_rep1 s__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_950 us_t) (temp___skip_top_level_951 Bool)) Bool
  (and
    (= (first temp___expr_950) (to_rep1 s__first))
    (= (last temp___expr_950) (to_rep1 s__last))))
        ...
        (and
          ...
          (and
            ...
            (and
              ...
              (and
                (= (to_rep1 s__first) o1)
                (let ((temp___1012 (of_array s o1 o)))
                  (and
                    (= (to_rep o2) 45)
                    (and
                      (and
                        (<= (first temp___1012) p2)
                        (<= p2 (last temp___1012)))
                      (and
                        (= s2 (to_array
                                (us_tqtmk
                                  (store (to_array temp___1012) p2 o2)
                                  (rt temp___1012))))
                        (and
                          (= (to_rep1 s__last) o3)
                          (and
  ...
  (=>
    ...
    (and
      ...
      (and
        (<= (first (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) 
        p)
        (<= p (last (of_array s1 (to_rep1 s__first) (to_rep1 s__last))))))))
...
(assert
  (and
    (<= (first (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) (+ 
    p 1))
    (<= (+ p 1) (last (of_array s1 (to_rep1 s__first) (to_rep1 s__last))))))

;; minus
(define-fun minus () Bool
  (ite (= (to_rep
            (select (to_array
...
;; H
(assert (ite (<= 0 v) (= offset 1) (= offset 2)))

;; H
(assert (abs_uns_of_int__function_guard (abs_uns_of_int v) v))

;; H
(assert (dynamic_invariant5 (abs_uns_of_int v) true false true true))

;; H
(assert
  (= (abs_uns_of_int v) (ite (= v (- 170141183460469231731687303715884105728))
                          #x80000000000000000000000000000000
                          (ite (< v 0) (of_int (- v)) (of_int v)))))
...
;; H
(assert
  (ite (= (to_int2 minus) (to_int2 (ite (< v 0) true false)))
    (and
      (= (to_rep1 s__last) o8)
      (and
        (= (to_rep1 s__first) o9)
        (and
          ...
          (let ((o11 (+ p offset)))
            (and
              (in_range1 o11)
              (= o7 (and (ite (<= o11 p1) true false) (ite (<= p1 o10)
                                                        true
                                                        false))))))))
    (= o7 false)))
    ...
    (let ((o13 (+ p offset)))
      (and
        ...
        (and
          (= (to_rep1 s__last) o11)
          (and
            (= (to_rep1 s__first) o12)
            (let ((temp___1033 (of_array s1 o12 o11)))
              (let ((o14 (of_array
                           (to_array temp___1033)
                           (first temp___1033)
                           (last temp___1033))))
                (and
                  (= true (only_decimal_ghost o14 o13 p1))
                  (forall ((j Int))
                    (=>
                      (and (<= o13 j) (<= j p1))
                      (let ((temp___750 (to_rep (select (to_array o14) j))))
...
;; H
(assert
  (= (wrap_option (abs_uns_of_int v)) (us_repqtmk
                                        (us_split_discrsqtmk (of_int1 0))
                                        (us_split_fieldsqtmk
                                          (of_rep2 (abs_uns_of_int v))))))
