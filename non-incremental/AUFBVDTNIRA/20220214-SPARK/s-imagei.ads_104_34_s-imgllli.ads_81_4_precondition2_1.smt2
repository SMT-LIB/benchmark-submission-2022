    ...
    (! (= (max_log10 us_void_param) (ite (= 128 8)
                                      ...
                                      (ite (= 128 16)
                                        ...
                                        (ite (= 128 32)
                                          ...
                                          (ite (= 128 64)
                                            19
                                            (ite true 38 (to_rep3 dummy2))))))) :pattern (
    (max_log10
      us_void_param)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_276 (_ BitVec 128)) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant12 ((temp___expr_771 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool) (temp___do_typ_inv_770 Bool)) Bool
  (=>
    (or
      (= temp___is_init_767 true)
      (<= (- 170141183460469231731687303715884105728) 0))
    (in_range8 temp___expr_771)))

;; dynamic_invariant
(define-fun dynamic_invariant13 ((temp___expr_899 us_t) (temp___is_init_895 Bool) (temp___skip_constant_896 Bool) (temp___do_toplevel_897 Bool) (temp___do_typ_inv_898 Bool)) Bool
  (=>
  ...
  (ite (= (to_int2 minus) (to_int2 (ite (< v 0) true false)))
    (and
      ...
      (let ((o9 (+ p offset)))
        (and
          (in_range1 o9)
          (= o7 (and (ite (<= o9 p1) true false) (ite (<= p1 o8) true false))))))
    (= o7 false)))
      ...
      (and
        ...
        (and
          ...
          (and
            ...
            (let ((temp___959 (of_array s1 o10 o9)))
              (let ((o12 (of_array
                           (to_array temp___959)
                           (first temp___959)
                           (last temp___959))))
                (and
                  ...
                  (forall ((j Int))
                    (=>
                      (and (<= o11 j) (<= j p1))
                      (let ((temp___743 (to_rep (select (to_array o12) j))))
