...
;; user_eq
(declare-fun user_eq7 (int__
  int__) Bool)

(declare-const dummy7 int__)
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool
  (=>
           ...
           (and
             (forall ((str1 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 ...
                 start
                 0))
             (= (scan_exponent_ghost str real__) (let ((plus_sign (bool_eq8
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    str) (+ 
...
;; user_eq
(declare-fun user_eq8 (unsigned1
  unsigned1) Bool)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_621 (_ BitVec 32)) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_229 (_ BitVec 32)) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq9 (unsigned2
  unsigned2) Bool)

(declare-const dummy9 unsigned2)
...
;; user_eq
(declare-fun user_eq10 (Int
  Int) Bool)

(declare-const dummy10 Int)
...
;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_294 us_t) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_809 us_t) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool) (temp___do_typ_inv_808 Bool)) Bool
  (=>
...
(declare-const ada___system__img_int__impl__image_integer__B_1__offset__assume Int)

;; H
(assert
  (ite (<= 0 v)
    (= ada___system__img_int__impl__image_integer__B_1__offset__assume 1)
    (= ada___system__img_int__impl__image_integer__B_1__offset__assume 2)))

;; Assume
(assert
  (= ada___system__img_int__impl__image_integer__B_1__offset__assume 
  offset))
