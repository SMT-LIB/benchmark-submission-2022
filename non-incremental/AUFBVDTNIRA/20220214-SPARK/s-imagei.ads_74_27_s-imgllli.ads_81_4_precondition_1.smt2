  ...
  (and
    (is_integer_ghost__function_guard
      ...
      (let ((temp___828 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___828) (first temp___828) (last temp___828))))
    (= (is_integer_ghost
         (let ((temp___828 (of_array
                             (to_array
                               (of_array
  ...
  (and
    (value_integer__function_guard
      ...
      (let ((temp___833 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___833) (first temp___833) (last temp___833))))
    (= (value_integer
         (let ((temp___833 (of_array
                             (to_array
                               (of_array
...
;; H
(assert
  (= (and (ite (<= (to_rep1 s__first) p2) true false) (ite (<= p2 (to_rep1
                                                                    s__last))
                                                        true
                                                        false)) true))
...
(assert
  (=>
    ...
    (and
      (and
        (<= (first (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) 1)
        (<= 1 (last (of_array s2 (to_rep1 s__first) (to_rep1 s__last)))))
      (and
        (<= (first (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) 
        p2)
        (<= p2 (last (of_array s2 (to_rep1 s__first) (to_rep1 s__last))))))))
