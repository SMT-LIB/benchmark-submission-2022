...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_623 (_ BitVec 128)) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool
  true)
  ...
  (and
    (is_integer_ghost__function_guard
      ...
      (let ((temp___861 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___861) (first temp___861) (last temp___861))))
    (= (is_integer_ghost
         (let ((temp___861 (of_array
                             (to_array
                               (of_array
  ...
  (and
    (value_integer__function_guard
      ...
      (let ((temp___866 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___866) (first temp___866) (last temp___866))))
    (= (value_integer
         (let ((temp___866 (of_array
                             (to_array
                               (of_array
