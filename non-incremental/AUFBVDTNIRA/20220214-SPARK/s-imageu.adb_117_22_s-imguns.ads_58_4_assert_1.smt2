...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_740 Int) (temp___is_init_736 Bool) (temp___skip_constant_737 Bool) (temp___do_toplevel_738 Bool) (temp___do_typ_inv_739 Bool)) Bool
  (=>
    (= temp___do_toplevel_738 true)
    (=> (= temp___is_init_736 true) (<= 0 temp___expr_740))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_748 Int) (temp___is_init_744 Bool) (temp___skip_constant_745 Bool) (temp___do_toplevel_746 Bool) (temp___do_typ_inv_747 Bool)) Bool
  (=>
    (= temp___do_toplevel_746 true)
    (=> (= temp___is_init_744 true) (< 0 temp___expr_748))))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool
  true)
