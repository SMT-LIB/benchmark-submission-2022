    ...
    (ite (= temp___199 8)
      ...
      (ite (= temp___199 16)
        ...
        (ite (= temp___199 32)
          ...
          (ite (= temp___199 64)
            19
            (ite (= temp___199 128) 38 (to_rep dummy1))))))))
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_243 (_ BitVec 128)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool
  true)
...
(assert
  (not
  (< (power big_10 (max_log10 Tuple0)) (bv2nat128 #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF))))
