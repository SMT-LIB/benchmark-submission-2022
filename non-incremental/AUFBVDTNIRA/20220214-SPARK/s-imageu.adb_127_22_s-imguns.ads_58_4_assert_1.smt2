...
(define-fun unsigned__ref_unsigned__content__4__projection ((a unsigned__ref)) unsigned
  (unsigned__content a))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_243 (_ BitVec 32)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
...
(assert
  (not (< (power big_10 (max_log10 Tuple0)) (bv2nat32 #xFFFFFFFF))))
