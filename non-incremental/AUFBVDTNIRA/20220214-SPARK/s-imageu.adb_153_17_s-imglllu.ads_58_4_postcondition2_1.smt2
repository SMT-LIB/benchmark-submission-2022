...
(define-fun default_initial_assumption ((temp___expr_236 us_rep) (temp___skip_top_level_237 Bool)) Bool
  (and
    (= (rec__ada___system__val_lllu__impl__uns_option__overflow
         (us_split_discrs1 temp___expr_236)) (of_int1 0))
    (=>
      (ada___system__val_lllu__impl__uns_option__value__pred temp___expr_236)
      (= (to_rep2
           (rec__ada___system__val_lllu__impl__uns_option__value
             (us_split_fields1 temp___expr_236))) #x00000000000000000000000000000000))))

;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_227 (_ BitVec 128)) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool
  true)
        ...
        (! (=>
             ...
             (and
               ...
               (and
                 ...
                 (ite (< to__ from)
                   (let ((temp___overflow_461 (of_int1 0)))
                     (us_repqtmk
                       (us_split_discrsqtmk temp___overflow_461)
                   ...
                   (ite (= (to_rep (select (to_array str) from)) 95)
                     ...
                     (ite (= (scan_overflows_ghost
                               ...
                               base
                               acc) true)
                       (let ((temp___overflow_462 (of_int1 1)))
                         (us_repqtmk
                           (us_split_discrsqtmk temp___overflow_462)
    ...
    (! (and
         ...
         (and
           (forall ((str1 us_t) (fst_num Int))
             (is_raw_unsigned_format_ghost__function_guard
               (is_raw_unsigned_format_ghost
                 (let ((temp___619 (let ((temp___618 (last str1)))
                                     (of_array
                                       (to_array str1)
                                       fst_num
                                       temp___618))))
                   (let ((temp___620 (to_array temp___619)))
                     (of_array
                       temp___620
                       (first temp___619)
                       (last temp___619)))))
               (let ((temp___619 (let ((temp___618 (last str1)))
                                   (of_array
                                     ...
                                     temp___618))))
                 (let ((temp___620 (to_array temp___619)))
                   (of_array temp___620 (first temp___619) (last temp___619))))))
           (and
             (forall ((str1 us_t) (fst_num Int))
               (raw_unsigned_overflows_ghost__function_guard
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___705 (to_rep (select (to_array str) j))))
                 (and (<= 48 temp___705) (<= temp___705 57)))))) :pattern (
      (only_decimal_ghost
        str
        from
        to__)) ))))
...
(assert
  (forall ((value (_ BitVec 128)))
    (! (=>
         ...
         (= (wrap_option value) (let ((temp___overflow_709 (of_int1 0)))
                                  (us_repqtmk
                                    (us_split_discrsqtmk temp___overflow_709)
...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_220 (_ BitVec 128)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___309 (to_rep (select (to_array str1) j))))
                 (or
                   (and (<= 48 temp___309) (<= temp___309 57))
                   (= temp___309 95)))))) :pattern ((only_number_ghost
                                                      str1
                                                      from
                                                      to__)) ))))
  ...
  (forall ((str1 us_t))
    (! (=>
         (and
           ...
           (and
             (not
               (= (let ((temp___320 (temp___String_Literal_311 Tuple0)))
                    (bool_eq6
                      (to_array str1)
                      (first str1)
                      (last str1)
                      ...
                      1
                      0)) true))
             (let ((temp___321 (to_rep (select (to_array str1) (first str1)))))
               (and (<= 48 temp___321) (<= temp___321 57)))))
             ...
             (and
               (and
                 (and
                   ...
                   (=>
                     (< result (last str1))
                     (= (not (let ((temp___323 (to_rep
                                                 (select (to_array str1) (+ result 1)))))
                               (or (let ((temp___324 temp___323))
                                     (and (ite (<= 48 temp___324) true false) 
                                     (ite (<= temp___324 57)
                                       true
                                       false))) (ite (= temp___323 95)
                                                  true
                                                  false)))) true)))
    ...
    (! (and
         ...
         (=
           ...
           (and
             (and
               (not
                 (= (let ((temp___335 (temp___String_Literal_326 Tuple0)))
                      (bool_eq6
                        (to_array str1)
                        (first str1)
                        (last str1)
                        ...
                        1
                        0)) true))
               (let ((temp___336 (to_rep
                                   (select (to_array str1) (first str1)))))
                 (and (<= 48 temp___336) (<= temp___336 57))))
             (let ((l (last_number_ghost str1)))
               (and
                 (let ((temp___337 (to_rep (select (to_array str1) l))))
                   (and (<= 48 temp___337) (<= temp___337 57)))
                 (forall ((j Int))
                   (=>
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (and
             (and
               (< 1 (length str1))
               (let ((temp___399 (to_rep
                                   (select (to_array str1) (first str1)))))
                 (or (= temp___399 69) (= temp___399 101))))
             (let ((minus_sign (bool_eq11
               ...
               (let ((sign (or (bool_eq11
                 ...
                 (and
                   ...
                   (let ((temp___400 (to_rep
                                       (select (to_array str1) (ite (= sign true)
                                                                 (+ (first
                                                                    str1) 2)
                                                                 (+ (first
                                                                    str1) 1))))))
                     (and (<= 48 temp___400) (<= temp___400 57)))))))) :pattern (
      (starts_as_exponent_format_ghost
        str1
        real__)) ))))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___409 (let ((temp___408 (last str1)))
                                      (of_array
                                        (to_array str1)
                                        (ite (let ((temp___412 (to_rep
                                                                 (select 
                                                                 (to_array
                                                                   str1) (+ 
                                                                 (first
                                          ...
                                          (+ (first str1) 1))
                                        temp___408))))
                    (let ((temp___410 (to_array temp___409)))
                      (of_array
                        temp___410
                        (first temp___409)
                        (last temp___409))))) true))) :pattern ((is_opt_exponent_format_ghost
                                                                  str1
                                                                  real__)) ))))
...
;; temp___String_Literal_465
(declare-fun temp___String_Literal_465 (tuple0) (Array Int character))

;; temp___String_Literal_465__def_axiom
(assert true)
             ...
             (and
               ...
               (and
                 (and
                   (and
                     (not
                       (= (let ((temp___477 (temp___String_Literal_465
                                              Tuple0)))
                            (bool_eq6
                              (to_array str1)
                              (first str1)
                     ...
                     (let ((temp___478 (to_rep
                                         (select (to_array str1) (first str1)))))
                       (and (<= 48 temp___478) (<= temp___478 57))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 (scan_natural_ghost
                   (let ((temp___493 (let ((temp___492 (last str2)))
                                       (of_array
                                         (to_array str2)
                                         start
                                         temp___492))))
                     (let ((temp___494 (to_array temp___493)))
                       (of_array
                         temp___494
                         (first temp___493)
                         (last temp___493))))
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___347 (to_rep (select (to_array str1) j))))
                 (or
                   (and (<= 48 temp___347) (<= temp___347 57))
                   (or
                     (and (<= 97 temp___347) (<= temp___347 102))
                     (or
                       (and (<= 65 temp___347) (<= temp___347 70))
                       (= temp___347 95)))))))) :pattern ((only_hexa_ghost
                                                            str1
                                                            from
                                                            to__)) ))))
  ...
  (forall ((str1 us_t))
    (! (=>
         (and
           ...
           (and
             (not
               (= (let ((temp___365 (temp___String_Literal_351 Tuple0)))
                    (bool_eq6
                      (to_array str1)
                      (first str1)
                      (last str1)
                      ...
                      1
                      0)) true))
             (let ((temp___366 (to_rep (select (to_array str1) (first str1)))))
               (or
                 (and (<= 48 temp___366) (<= temp___366 57))
                 (or
                   (and (<= 97 temp___366) (<= temp___366 102))
                   (and (<= 65 temp___366) (<= temp___366 70)))))))
             ...
             (and
               (and
                 (and
                   ...
                   (=>
                     (< result (last str1))
                     (= (not (let ((temp___371 (to_rep
                                                 (select (to_array str1) (+ result 1)))))
                               (or (let ((temp___374 temp___371))
                                     (and (ite (<= 48 temp___374) true false) 
                                     (ite (<= temp___374 57)
                                       true
                                       false))) (or (let ((temp___373 temp___371))
                                                      (and (ite (<= 97 temp___373)
                                                             true
                                                             false) (ite (<= temp___373 102)
                                                                    true
                                                                    false))) (or 
                               (let ((temp___372 temp___371))
                                 (and (ite (<= 65 temp___372) true false) 
                                 (ite (<= temp___372 70)
                                   true
                                   false))) (ite (= temp___371 95)
                                              true
                                              false)))))) true)))
    ...
    (! (and
         ...
         (=
           ...
           (and
             (and
               (not
                 (= (let ((temp___387 (temp___String_Literal_376 Tuple0)))
                      (bool_eq6
                        (to_array str1)
                        (first str1)
                        (last str1)
                        ...
                        1
                        0)) true))
               (let ((temp___388 (to_rep
                                   (select (to_array str1) (first str1)))))
                 (or
                   (and (<= 48 temp___388) (<= temp___388 57))
                   (or
                     (and (<= 97 temp___388) (<= temp___388 102))
                     (and (<= 65 temp___388) (<= temp___388 70))))))
    ...
    (! (and
         ...
         (and
           (forall ((str2 us_t) (last_num_init Int))
             (last_hexa_ghost__function_guard
               (last_hexa_ghost
                 (let ((temp___443 (let ((temp___442 (last str2)))
                                     (let ((temp___441 (+ last_num_init 2)))
                                       (of_array
                                         (to_array str2)
                                         temp___441
                                         temp___442)))))
                   (let ((temp___444 (to_array temp___443)))
                     (of_array
                       temp___444
                       (first temp___443)
                       (last temp___443)))))
               (let ((temp___443 (let ((temp___442 (last str2)))
                                   (let ((temp___441 (+ last_num_init 2)))
                                     (of_array
                                       ...
                                       temp___442)))))
                 (let ((temp___444 (to_array temp___443)))
                   (of_array temp___444 (first temp___443) (last temp___443))))))
           (=
             ...
             (and
               ...
               (let ((last_num_init (last_number_ghost str1)))
                 (let ((starts_as_based (and (and (bool_lt1
                                                    last_num_init
                                                    (- (last str1) 1)) 
                   (let ((temp___447 (to_rep
                                       (select (to_array str1) (+ last_num_init 1)))))
                     (or (ite (= temp___447 35) true false) (ite (= temp___447 58)
                                                              true
                                                              false)))) 
                   (let ((temp___448 (to_rep
                                       (select (to_array str1) (+ last_num_init 2)))))
                     (or (let ((temp___451 temp___448))
                           (and (ite (<= 48 temp___451) true false) (ite (<= temp___451 57)
                                                                    true
                                                                    false))) (or 
                     (let ((temp___450 temp___448))
                       (and (ite (<= 97 temp___450) true false) (ite (<= temp___450 102)
                                                                  true
                                                                  false))) 
                     (let ((temp___449 temp___448))
                       (and (ite (<= 65 temp___449) true false) (ite (<= temp___449 70)
                                                                  true
                                                                  false)))))))))
                   (let ((last_num_based (ite (= starts_as_based true)
                                           (last_hexa_ghost
                                             (let ((temp___443 (let ((temp___442 
                                                                 (last
                                                                   str1)))
                                                                 (let ((temp___441 (+ last_num_init 2)))
                                                                   (of_array
                     ...
                     (and
                       (=>
                         ...
                         (and
                           (= (is_based_format_ghost
                                (let ((temp___436 (let ((temp___435 (last
                                                                    str1)))
                                                    (let ((temp___434 (+ last_num_init 2)))
                                                      (of_array
                                                        (to_array str1)
                                                        temp___434
                                                        temp___435)))))
                                  (let ((temp___437 (to_array temp___436)))
                                    (of_array
                                      temp___437
                                      (first temp___436)
                                      (last temp___436))))) true)
                           (< last_num_based (last str1))))
                       (= (is_opt_exponent_format_ghost
                            (let ((temp___439 (let ((temp___438 (last str1)))
                                                (of_array
                                                  (to_array str1)
                                                  (ite (= (and (and starts_as_based 
                                                    ...
                                                    (+ last_num_init 1))
                                                  temp___438))))
                              (let ((temp___440 (to_array temp___439)))
                                (of_array
                                  temp___440
                                  (first temp___439)
                                  (last temp___439))))
    ...
    (forall ((from Int) (to__ Int))
      (! (and
           (forall ((str2 us_t) (from1 Int) (to__1 Int))
             (last_number_ghost__function_guard
               (last_number_ghost
                 (let ((temp___549 (of_array (to_array str2) from1 to__1)))
                   (let ((temp___550 (to_array temp___549)))
                     (of_array
                       temp___550
                       (first temp___549)
                       (last temp___549)))))
               (let ((temp___549 (of_array (to_array str2) from1 to__1)))
                 (let ((temp___550 (to_array temp___549)))
                   (of_array temp___550 (first temp___549) (last temp___549))))))
           (and
             (forall ((str2 us_t) (to__1 Int) (last_num_init Int))
               (last_hexa_ghost__function_guard
                 (last_hexa_ghost
                   (let ((temp___540 (let ((temp___539 (+ last_num_init 2)))
                                       (of_array
                                         (to_array str2)
                                         temp___539
                                         to__1))))
                     (let ((temp___541 (to_array temp___540)))
                       (of_array
                         temp___541
                         (first temp___540)
                         (last temp___540)))))
             ...
             (and
               ...
               (=
                 ...
                 (let ((last_num_init (last_number_ghost
                                        (let ((temp___549 (of_array
                                                            (to_array str1)
                                                            from
                                                            to__)))
                                          (let ((temp___550 (to_array
                                                              temp___549)))
                                            (of_array
                                              temp___550
                                              (first temp___549)
                   ...
                   (let ((init_val (scan_based_number_ghost
                     ...
                     (let ((starts_as_based (and (and (bool_lt1
                                                        ...
                                                        (- to__ 1)) (let ((temp___544 
                                                                    ...
                                                                    true
                                                                    false)))) 
                       (let ((temp___545 (to_rep
                                           (select (to_array str1) (+ last_num_init 2)))))
                         (or (let ((temp___548 temp___545))
                               (and (ite (<= 48 temp___548) true false) 
                               (ite (<= temp___548 57)
                                 true
                                 false))) (or (let ((temp___547 temp___545))
                                                (and (ite (<= 97 temp___547)
                                                       true
                                                       false) (ite (<= temp___547 102)
                                                                true
                                                                false))) 
                         (let ((temp___546 temp___545))
                           (and (ite (<= 65 temp___546) true false) (ite (<= temp___546 70)
                                                                    true
                                                                    false)))))))))
                       (let ((last_num_based (ite (= starts_as_based true)
                                               (last_hexa_ghost
                           ...
                           (let ((based_val (ite (and
                             ...
                             (let ((first_exp (ite (= is_based true)
                               ...
                               (or
                                       ...
                                       (and
                                         ...
                                         (let ((temp___530 (to_rep
                                           ...
                                           (or
                                             (= temp___530 35)
                                             (= temp___530 58))))
                                       (= (not (let ((temp___531 (to_rep2
                                                                   (rec__ada___system__val_lllu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000000000000000000000000000002 temp___531)
                                                        true
                                                        false) (ite (bvule temp___531 #x00000000000000000000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
                                 ...
                                 (and
                                   (= (starts_as_exponent_format_ghost
                                        (let ((temp___532 (of_array
                                                            (to_array str1)
                                                            first_exp
                                                            to__)))
                                          (let ((temp___533 (to_array
                                                              temp___532)))
                                            (of_array
                                              temp___533
                                              (first temp___532)
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___647 (to_rep (select (to_array str1) from))))
                     (and (<= 48 temp___647) (<= temp___647 57))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___665 (of_array (to_array str2) from1 to__1)))
                     (let ((temp___666 (to_array temp___665)))
                       (of_array
                         temp___666
                         (first temp___665)
                         (last temp___665)))))
             ...
             (and
               (forall ((str2 us_t) (to__1 Int) (last_num_init Int))
                 (last_hexa_ghost__function_guard
                   (last_hexa_ghost
                     (let ((temp___656 (let ((temp___655 (+ last_num_init 2)))
                                         (of_array
                                           (to_array str2)
                                           temp___655
                                           to__1))))
               ...
               (and
                 (forall ((str2 us_t) (to__1 Int) (first_exp Int))
                   (scan_exponent_ghost__function_guard
                     (scan_exponent_ghost
                       (let ((temp___650 (of_array
                                           (to_array str2)
                                           first_exp
                                           to__1)))
                         (let ((temp___651 (to_array temp___650)))
                           (of_array
                             temp___651
                             (first temp___650)
                             (last temp___650))))
                                                               ...
                                                               (let ((init_val 
                                                                 ...
                                                                 (let ((starts_as_based (and (and 
                                                                   ...
                                                                   (let ((last_num_based 
                                                                    ...
                                                                    (last_hexa_ghost
                                                                    (let ((temp___656 
                                                                    (let ((temp___655 (+ last_num_init 2)))
                                                                    (of_array
                                                                    (to_array
                                                                    str1)
                                                                    temp___655
             ...
             (and
               (and
                 (and
                   ...
                   (and (<= (first str1) from) (<= from (last str1))))
                 (and (<= from to__) (<= to__ (last str1))))
               (let ((temp___579 (to_rep (select (to_array str1) from))))
                 (and (<= 48 temp___579) (<= temp___579 57)))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___603 (of_array (to_array str2) from1 to__1)))
                     (let ((temp___604 (to_array temp___603)))
                       (of_array
                         temp___604
                         (first temp___603)
                         (last temp___603)))))
             ...
             (and
               (forall ((str2 us_t) (to__1 Int) (last_num_init Int))
                 (last_hexa_ghost__function_guard
                   (last_hexa_ghost
                     (let ((temp___594 (let ((temp___593 (+ last_num_init 2)))
                                         (of_array
                                           (to_array str2)
                                           temp___593
                                           to__1))))
                       (let ((temp___595 (to_array temp___594)))
                         (of_array
                           temp___595
                           (first temp___594)
                           (last temp___594)))))
               ...
               (and
                 (forall ((str2 us_t) (to__1 Int) (first_exp Int))
                   (last_number_ghost__function_guard
                     (last_number_ghost
                       (let ((temp___582 (let ((temp___581 (+ first_exp 2)))
                                           (of_array
                                             (to_array str2)
                                             temp___581
                                             to__1))))
                         (let ((temp___583 (to_array temp___582)))
                           (of_array
                             temp___583
                             (first temp___582)
                             (last temp___582)))))
                 ...
                 (and
                   (forall ((str2 us_t) (to__1 Int) (first_exp Int))
                     (last_number_ghost__function_guard
                       (last_number_ghost
                         (let ((temp___586 (let ((temp___585 (+ first_exp 1)))
                                             (of_array
                                               (to_array str2)
                                               temp___585
                                               to__1))))
                           (let ((temp___587 (to_array temp___586)))
                             (of_array
                               temp___587
                               (first temp___586)
                               (last temp___586)))))
                   ...
                   (= (raw_unsigned_last_ghost str1 from to__) (let ((last_num_init 
                                                                 ...
                                                                 (let ((starts_as_based (and (and 
                                                                   ...
                                                                   (let ((last_num_based 
                                                                    ...
                                                                    (last_hexa_ghost
                                                                    (let ((temp___594 
                                                                    (let ((temp___593 (+ last_num_init 2)))
                                                                    (of_array
                                                                    (to_array
                                                                    str1)
                                                                    temp___593
...
(assert
  (forall ((str1 us_t))
    (! (=>
         (dynamic_invariant1 str1 true true true true)
         (= (slide_to_1 str1) (let ((res (let ((temp___286 (slide
                                                             (to_array str1)
                                                             (first str1)
                                                             1)))
                                           (of_array
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_271 us_t) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          1
          (length str1)
          (first temp___expr_271)
          (last temp___expr_271))
        (= (first temp___expr_271) 1))
      (= (last temp___expr_271) (length str1)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_273 us_t) (temp___skip_top_level_274 Bool)) Bool
  (and
    (= (first temp___expr_273) 1)
    (= (last temp___expr_273) (length str1))))

;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_756 us_t) (temp___is_init_752 Bool) (temp___skip_constant_753 Bool) (temp___do_toplevel_754 Bool) (temp___do_typ_inv_755 Bool)) Bool
  (=>
    ...
    (and
      (and
        (dynamic_property
          (to_rep1 s__first)
          (to_rep1 s__last)
          (first temp___expr_756)
          (last temp___expr_756))
        (= (first temp___expr_756) (to_rep1 s__first)))
      (= (last temp___expr_756) (to_rep1 s__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption2 ((temp___expr_762 us_t) (temp___skip_top_level_763 Bool)) Bool
  (and
    (= (first temp___expr_762) (to_rep1 s__first))
    (= (last temp___expr_762) (to_rep1 s__last))))
...
(assert
  (and
    (and
      ...
      (= (only_decimal_ghost
           (let ((temp___1329 (of_array
                                s
                                (to_rep1 s__first)
                                (to_rep1 s__last))))
             (of_array
               (to_array temp___1329)
               (first temp___1329)
               (last temp___1329)))
           2
           p) true))
...
;; Assert
(assert (= (only_decimal_ghost str 2 p) true))
