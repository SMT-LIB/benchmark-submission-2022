...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_220 (_ BitVec 64)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___531 (to_rep2
                                                                   (rec__ada___system__val_llu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x0000000000000002 temp___531)
                                                        true
                                                        false) (ite (bvule temp___531 #x0000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
