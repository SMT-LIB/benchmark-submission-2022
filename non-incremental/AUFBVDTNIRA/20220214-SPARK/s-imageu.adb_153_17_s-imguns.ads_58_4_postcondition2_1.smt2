...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_219 (_ BitVec 32)) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool
  true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___528 (to_rep2
                                                                   (rec__ada___system__val_uns__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000002 temp___528)
                                                        true
                                                        false) (ite (bvule temp___528 #x00000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
