...
(define-fun default_initial_assumption ((temp___expr_236 us_rep) (temp___skip_top_level_237 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_uns__impl__uns_option__value__pred temp___expr_236)
      (= (to_rep2
           (rec__ada___system__val_uns__impl__uns_option__value
             (us_split_fields1 temp___expr_236))) #x00000000))))

;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_227 (_ BitVec 32)) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq10 (unsigned1
  unsigned1) Bool)

(declare-const dummy10 unsigned1)
...
(define-fun unsigned__ref_unsigned__content__2__projection ((a unsigned__ref1)) unsigned1
  (unsigned__content1 a))

;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_220 (_ BitVec 32)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___531 (to_rep2
                                                                   (rec__ada___system__val_uns__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000002 temp___531)
                                                        true
                                                        false) (ite (bvule temp___531 #x00000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
...
(assert
  (= (bool_eq9
       (scan_based_number_ghost
         ...
         #x0000000A
         #x00000000)
       (scan_based_number_ghost str 2 p #x0000000A #x00000000)) true))

;; Assert
(assert
  (= (bool_eq9
       (scan_based_number_ghost str 2 p #x0000000A #x00000000)
       (wrap_option v)) true))
