...
(declare-const quot (_ BitVec 128))

(declare-const rest (_ BitVec 128))
...
;; user_eq
(declare-fun user_eq (long_long_long_unsigned
  long_long_long_unsigned) Bool)

(declare-const dummy long_long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_220 (_ BitVec 128)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; Assume
(assert (dynamic_invariant quot true false true true))

;; Assume
(assert (dynamic_invariant rest true false true true))

;; Assume
(assert
  (and
    (= quot (bvudiv val__ #x0000000000000000000000000000000A))
    (= rest (bvurem val__ #x0000000000000000000000000000000A))))

;; Goal def'vc
;; File "s-imageu.adb", line 213, characters 0-0
(assert
  (not
  (= val__ (bvadd (bvmul #x0000000000000000000000000000000A quot) rest))))
