...
(declare-const quot (_ BitVec 64))

(declare-const rest (_ BitVec 64))
...
;; user_eq
(declare-fun user_eq (long_long_unsigned
  long_long_unsigned) Bool)

(declare-const dummy long_long_unsigned)
...
(assert
  (and
    (= quot (bvudiv val__ #x000000000000000A))
    (= rest (bvurem val__ #x000000000000000A))))

;; Goal def'vc
;; File "s-imageu.adb", line 213, characters 0-0
(assert
  (not (= val__ (bvadd (bvmul #x000000000000000A quot) rest))))
