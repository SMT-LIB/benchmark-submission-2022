...
(declare-const quot (_ BitVec 32))

(declare-const rest (_ BitVec 32))
...
;; Assume
(assert
  (and (= quot (bvudiv val__ #x0000000A)) (= rest (bvurem val__ #x0000000A))))

;; Goal def'vc
;; File "s-imageu.adb", line 213, characters 0-0
(assert
  (not (= val__ (bvadd (bvmul #x0000000A quot) rest))))
