...
(define-fun dynamic_invariant ((temp___expr_88 Int) (temp___is_init_84 Bool) (temp___skip_constant_85 Bool) (temp___do_toplevel_86 Bool) (temp___do_typ_inv_87 Bool)) Bool
  (=> (or (= temp___is_init_84 true) (<= 0 255)) (in_range1 temp___expr_88)))
...
;; user_eq
(declare-fun user_eq2 (long_long_long_unsigned1
  long_long_long_unsigned1) Bool)

(declare-const dummy2 long_long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_220 (_ BitVec 128)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
(assert
  (and
    (bvule #x00000000000000000000000000000000 r)
    (bvule r #x00000000000000000000000000000009)))

;; Goal def'vc
;; File "s-imageu.adb", line 222, characters 0-0
(assert
  (not
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat128 (bvadd #x00000000000000000000000000000030 r)))
      (bv2nat128 (bvadd #x00000000000000000000000000000030 r)))
    (= (hexa_to_unsigned_ghost
         (bv2nat128 (bvadd #x00000000000000000000000000000030 r))) r))))
