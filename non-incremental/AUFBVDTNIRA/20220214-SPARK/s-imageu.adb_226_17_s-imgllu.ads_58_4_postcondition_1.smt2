...
;; user_eq
(declare-fun user_eq1 (long_long_unsigned
  long_long_unsigned) Bool)

(declare-const dummy1 long_long_unsigned)
...
;; user_eq
(declare-fun user_eq2 (long_long_unsigned1
  long_long_unsigned1) Bool)

(declare-const dummy2 long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_220 (_ BitVec 64)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; Assume
(assert (and (bvule #x0000000000000000 r) (bvule r #x0000000000000009)))
...
(assert
  ...
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost (bv2nat64 (bvadd #x0000000000000030 r)))
      (bv2nat64 (bvadd #x0000000000000030 r)))
    (= (hexa_to_unsigned_ghost (bv2nat64 (bvadd #x0000000000000030 r))) 
    r))))
