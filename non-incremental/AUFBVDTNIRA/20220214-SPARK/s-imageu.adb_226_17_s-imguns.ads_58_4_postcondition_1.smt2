...
;; user_eq
(declare-fun user_eq2 (unsigned1
  unsigned1) Bool)

(declare-const dummy2 unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_220 (_ BitVec 32)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; Assume
(assert (and (bvule #x00000000 r) (bvule r #x00000009)))
...
(assert
  ...
  (=>
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost (bv2nat32 (bvadd #x00000030 r)))
      (bv2nat32 (bvadd #x00000030 r)))
    (= (hexa_to_unsigned_ghost (bv2nat32 (bvadd #x00000030 r))) r))))
