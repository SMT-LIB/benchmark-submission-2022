...
;; Ensures
(assert
  (= (div1 (bv2nat128 value) (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
...
;; Assert
(assert (< 0 (power big_10 nb_digits)))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 v) (power big_10 nb_digits)) big_10) (div1
                                                                   (bv2nat128 
                                                                   v)
                                                                   (* 
                                                                   (power
...
;; H
(assert (= value1 (bvudiv value #x0000000000000000000000000000000A)))

;; Ensures
(assert (in_range1 (+ nb_digits 1)))

(declare-const nb_digits1 Int)

;; H
(assert (= nb_digits1 (+ nb_digits 1)))
...
;; LoopInvariant
(assert (and (<= 1 nb_digits2) (<= nb_digits2 (- unsigned_width_ghost 1))))

;; LoopInvariant
(assert (= pow3 (power big_10 nb_digits2)))

;; LoopInvariant
(assert (= (bv2nat128 value2) (div1 (bv2nat128 v) pow3)))

;; Assume
(assert
  (and
    (and
      (dynamic_invariant nb_digits2 true true true true)
      (dynamic_invariant5 value2 true true true true))
    (dynamic_invariant6 pow3 true true true true)))

;; eq'result'unused'unused
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= value2 #x00000000000000000000000000000000) true false))

;; H
(assert (not (= value2 #x00000000000000000000000000000000)))

;; Ensures
(assert (not (= (bv2nat128 value2) 0)))

;; Assert
(assert (<= pow3 (bv2nat128 #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)))
...
;; Assert
(assert (< 0 (power big_10 nb_digits2)))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 v) (power big_10 nb_digits2)) big_10) (div1
                                                                    (bv2nat128 
                                                                    v)
                                                                    (* 
                                                                    (power
...
;; Ensures
(assert (in_range1 (+ nb_digits2 1)))

(declare-const nb_digits3 Int)

;; H
(assert (= nb_digits3 (+ nb_digits2 1)))
...
;; H
(assert (bvult value3 value2))

;; LoopInvariant
(assert (and (<= 1 nb_digits3) (<= nb_digits3 (- unsigned_width_ghost 1))))

;; LoopInvariant
(assert (= pow4 (power big_10 nb_digits3)))

;; Goal def'vc
;; File "s-imageu.ads", line 96, characters 0-0
(assert
  (not (= (bv2nat128 value3) (div1 (bv2nat128 v) pow4))))
