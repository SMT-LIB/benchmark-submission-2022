...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 v) (power big_10 nb_digits)) big_10) (div1
                                                                  (bv2nat64 
                                                                  v)
                                                                  (* 
                                                                  (power
...
;; H
(assert (= value1 (bvudiv value #x000000000000000A)))
...
;; LoopInvariant
(assert (= (bv2nat64 value2) (div1 (bv2nat64 v) pow3)))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= value2 #x0000000000000000) true false))

;; H
(assert (not (= value2 #x0000000000000000)))

;; Ensures
(assert (not (= (bv2nat64 value2) 0)))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 v) (power big_10 nb_digits2)) big_10) (div1
                                                                   (bv2nat64 
                                                                   v)
                                                                   (* 
                                                                   (power
...
(assert
  (not (= (bv2nat64 value3) (div1 (bv2nat64 v) pow4))))
