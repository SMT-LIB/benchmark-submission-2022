...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 v) (power big_10 nb_digits)) big_10) (div1
                                                                  (bv2nat32 
                                                                  v)
                                                                  (* 
                                                                  (power
...
;; H
(assert (= value1 (bvudiv value #x0000000A)))
...
;; LoopInvariant
(assert (= (bv2nat32 value2) (div1 (bv2nat32 v) pow3)))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= value2 #x00000000) true false))

;; H
(assert (not (= value2 #x00000000)))

;; Ensures
(assert (not (= (bv2nat32 value2) 0)))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 v) (power big_10 nb_digits2)) big_10) (div1
                                                                   (bv2nat32 
                                                                   v)
                                                                   (* 
                                                                   (power
...
(assert
  (not (= (bv2nat32 value3) (div1 (bv2nat32 v) pow4))))
