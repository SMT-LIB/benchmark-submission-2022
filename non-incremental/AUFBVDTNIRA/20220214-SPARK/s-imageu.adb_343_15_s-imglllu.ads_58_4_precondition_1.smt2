...
;; H
(assert
  (= (and (ite (<= (+ (+ p j2) 1) usf) true false) (ite (<= usf (+ p 
                                                     nb_digits1))
                                                     true
                                                     false)) true))

;; Ensures
(assert (in_range1 (- usf p)))

;; Ensures
(assert (in_range1 (- nb_digits1 (- usf p))))

;; Ensures
(assert (in_range2 (- nb_digits1 (- usf p))))
...
(assert
  (and
    (<= (first (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) usf)
    (<= usf (last (of_array s3 (to_rep1 s__first) (to_rep1 s__last))))))
