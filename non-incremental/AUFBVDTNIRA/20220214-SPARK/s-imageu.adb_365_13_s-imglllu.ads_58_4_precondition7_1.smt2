...
(assert
  (and
    (<= (first (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
    p j2))
    (<= (+ p j2) (last (of_array s3 (to_rep1 s__first) (to_rep1 s__last))))))
                             ...
                             (to_rep
                               (select (to_array
                                         (of_array
                                           s3
                                           (to_rep1 s__first)
                                           (to_rep1 s__last))) (+ p j2)))) #x00000000000000000000000000000030)
                    (ite (and
                           (<= 97 (to_rep
                                    (select (to_array
                                              (of_array
                                      ...
                                      (to_rep
                                        (select (to_array
                                                  (of_array
                                                    ...
                                                    (to_rep1 s__first)
                                                    (to_rep1 s__last))) (+ 
                                        p j2)))) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                      (ite (and
                             (<= 65 (to_rep
                                      (select (to_array
                                                (of_array
                                        ...
                                        (to_rep
                                          (select (to_array
                                                    (of_array
                                                      ...
                                                      (to_rep1 s__first)
                                                      (to_rep1 s__last))) (+ 
                                          p j2)))) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                        (to_rep2 dummy6))))))

;; Ensures
(assert
  (= prev_value3 (bvadd (bvmul #x0000000000000000000000000000000A value5) 
  (hexa_to_unsigned_ghost
    (to_rep
      (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) (+ 
      p j2)))))))
...
(assert
  ...
  (not
    (= (last
         (of_array prev_s3 (to_rep1 prev_s__first) (to_rep1 prev_s__last))) 2147483647))))
