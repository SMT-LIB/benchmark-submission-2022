...
;; LoopInvariant
(assert (bvule value5 #x19999999999999999999999999999999))
...
(assert
  (= (ite (forall ((j3 Int))
            (=>
              ...
              (let ((temp___705 (to_rep
                                  (select (to_array
                                            (let ((temp___1076 (of_array
                                                                 s3
                                                                 (to_rep1
                                                                   s__first)
                                                                 (to_rep1
                                              ...
                                              (of_array
                                                ...
                                                (first temp___1076)
                                                (last temp___1076)))) j3))))
                (and (<= 48 temp___705) (<= temp___705 57)))))
       true
       false) true))
    ...
    (= (hexa_to_unsigned_ghost
         (to_rep
           ...
           k))) (bvurem (of_int
                          (div1
                            (bv2nat128 v)
                            (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A)))))
