...
;; H
(assert
  (= (and (ite (<= (+ p j) usf2) true false) (ite (<= usf2 (+ p nb_digits1))
                                               true
                                               false)) true))
...
(assert
  (and
    (<= (first (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) usf2)
    (<= usf2 (last (of_array s1 (to_rep1 s__first) (to_rep1 s__last))))))
