...
;; H
(assert
  (= (and (ite (<= (+ p j2) usf2) true false) (ite (<= usf2 (+ p nb_digits1))
                                                true
                                                false)) true))

;; Ensures
(assert (in_range1 (- usf2 p)))

;; Ensures
(assert (in_range1 (- nb_digits1 (- usf2 p))))

;; Ensures
(assert (in_range2 (- nb_digits1 (- usf2 p))))
...
(assert
  (and
    (<= (first (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) usf2)
    (<= usf2 (last (of_array s3 (to_rep1 s__first) (to_rep1 s__last))))))
