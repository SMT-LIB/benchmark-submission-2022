    ...
    (=>
      ...
      (and
        ...
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem ((_ int2bv 128) 
        (div1
          (bv2nat v)
...
;; LoopInvariant
(assert (= (bv2nat value3) (div1 (bv2nat v) pow4)))
...
(assert
  ...
  (= (bool_eq10
       (scan_based_number_ghost
         (let ((temp___934 (of_array s1 (to_rep1 s__first) (to_rep1 s__last))))
           (of_array
             (to_array temp___934)
             (first temp___934)
             (last temp___934)))
