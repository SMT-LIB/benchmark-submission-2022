...
(assert
  (= (ite (forall ((j3 Int))
            (=>
              ...
              (let ((temp___697 (to_rep
                                  (select (to_array
                                            (let ((temp___964 (of_array
                                                                s3
                                                                (to_rep1
                                                                  s__first)
                                                                (to_rep1
                                              ...
                                              (of_array
                                                ...
                                                (first temp___964)
                                                (last temp___964)))) j3))))
                (and (<= 48 temp___697) (<= temp___697 57)))))
       true
       false) true))
    ...
    (=>
      ...
      (and
        ...
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem ((_ int2bv 128) 
        (div1
          (bv2nat v)
          (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A))))))
...
;; LoopInvariant
(assert (= (bv2nat value5) (div1 (bv2nat v) pow6)))
...
(assert
  ...
  (= (bool_eq10
       (scan_based_number_ghost
         (let ((temp___934 (of_array s3 (to_rep1 s__first) (to_rep1 s__last))))
           (of_array
             (to_array temp___934)
             (first temp___934)
             (last temp___934)))
