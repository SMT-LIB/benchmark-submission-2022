    ...
    (ite (= temp___199 8)
      ...
      (ite (= temp___199 16)
        ...
        (ite (= temp___199 32)
          ...
          (ite (= temp___199 64)
            19
            (ite (= temp___199 128) 38 (to_rep3 dummy1))))))))
...
(declare-datatypes ((s32s__ref 0))
  (((s32s__refqtmk (s32s__content us_t)))))

;; s32s__ref_s32s__content__projection
(define-fun s32s__ref_s32s__content__projection ((a s32s__ref)) us_t
  (s32s__content a))

(declare-datatypes ((t49s__ref 0))
  (((t49s__refqtmk (t49s__content us_t)))))

;; t49s__ref_t49s__content__projection
...
;; user_eq
(declare-fun user_eq11 (long_long_long_unsigned1
  long_long_long_unsigned1) Bool)

(declare-const dummy11 long_long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_220 (_ BitVec 128)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_748 Int) (temp___is_init_744 Bool) (temp___skip_constant_745 Bool) (temp___do_toplevel_746 Bool) (temp___do_typ_inv_747 Bool)) Bool
  (=>
    (= temp___do_toplevel_746 true)
    (=> (= temp___is_init_744 true) (< 0 temp___expr_748))))
...
(declare-datatypes ((t57s__ref 0))
  (((t57s__refqtmk (t57s__content integer)))))

;; t57s__ref_t57s__content__projection
(define-fun t57s__ref_t57s__content__projection ((a t57s__ref)) integer
  (t57s__content a))
...
;; user_eq
(declare-fun user_eq13 (long_long_long_unsigned2
  long_long_long_unsigned2) Bool)

(declare-const dummy13 long_long_long_unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_243 (_ BitVec 128)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_740 Int) (temp___is_init_736 Bool) (temp___skip_constant_737 Bool) (temp___do_toplevel_738 Bool) (temp___do_typ_inv_739 Bool)) Bool
  (=>
    (= temp___do_toplevel_738 true)
    (=> (= temp___is_init_736 true) (<= 0 temp___expr_740))))
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log101 us_void_param) (let ((temp___247 128))
                                       (ite (= temp___247 8)
                                         2
                                         (ite (= temp___247 16)
                                           4
...
;; dynamic_invariant
(define-fun dynamic_invariant11 ((temp___expr_803 us_t) (temp___is_init_799 Bool) (temp___skip_constant_800 Bool) (temp___do_toplevel_801 Bool) (temp___do_typ_inv_802 Bool)) Bool
  (=>
    (not (= temp___skip_constant_800 true))
    (and
      (and
        (dynamic_property
          (to_rep1 s__first)
          (to_rep1 s__last)
          (first temp___expr_803)
          (last temp___expr_803))
        (= (first temp___expr_803) (to_rep1 s__first)))
      (= (last temp___expr_803) (to_rep1 s__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_809 us_t) (temp___skip_top_level_810 Bool)) Bool
  (and
...
(assert
  (and
    (and (<= (- (to_rep1 s__first) 1) p) (< p (to_rep1 s__last)))
    (< p 2147483647)))

;; Ensures
(assert (= unsigned_width_ghost (+ (max_log10 Tuple0) 2)))

(declare-const nb_digits1 Int)

(declare-const value1 (_ BitVec 128))
...
(assert
  (and
    ...
    value #x0000000000000000000000000000000A)))
    (let ((temp___916 big_10))
      (and
        (< 0 temp___916)
        (let ((o (power big_10 nb_digits)))
          (and
            (< 0 o)
            (let ((o1 (bv2nat128 v)))
              (and
                (<= 0 o1)
                (and
                  (= (div1 (div1 o1 o) temp___916) (div1 o1 (* o temp___916)))
                  (exists ((value2 (_ BitVec 128)))
                    (and
                      (= value2 (bvudiv value #x0000000000000000000000000000000A))
                      (let ((o2 (+ nb_digits 1)))
                        (and
                          (in_range1 o2)
                                    ...
                                    (and
                                      ...
                                      (and
                                        (and
                                          (and
                                            (<= 1 nb_digits1)
                                            (<= nb_digits1 (- unsigned_width_ghost 1)))
                                          (and
                                            (= pow1 (power big_10 nb_digits1))
                                            (= (bv2nat128 value1) (div1
                                                                    (bv2nat128 
                                                                    v)
                                                                    pow1))))
                                        (and
                                          (and
                                            ...
                                            (dynamic_invariant6
                                              ...
                                              true
                                              true))
                                          (= value1 #x00000000000000000000000000000000))))))))))))))))))))))

(declare-const value2 (_ BitVec 128))
...
;; Assert
(assert (= value2 (of_int (div1 (bv2nat128 v) (power big_10 0)))))

;; Assume
(assert (= nb_digits1 r56s))

;; Assume
(assert (dynamic_invariant r56s true false true true))
...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j r56s) true false)) true))

;; Ensures
(assert
  (= (div1 (bv2nat128 value2) (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
  value2 #x0000000000000000000000000000000A))))
...
;; Assert
(assert (<= 0 (bv2nat128 v)))

;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 v) (power big_10 (- nb_digits1 j))) big_10) 
  (div1
    (bv2nat128 v)
...
;; Ensures
(assert
  (let ((temp___815 (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
    value2 #x0000000000000000000000000000000A)))))
    (and (<= 48 temp___815) (<= temp___815 57))))
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        ...
        value2 #x0000000000000000000000000000000A))))
      (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem value2 #x0000000000000000000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
         value2 #x0000000000000000000000000000000A)))) (bvurem value2 #x0000000000000000000000000000000A))))

(declare-const prev_value1 (_ BitVec 128))

;; H
(assert (= prev_value1 value2))
...
;; Ensures
(assert
  (= (to_rep o) (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
  value2 #x0000000000000000000000000000000A)))))
...
(declare-const value3 (_ BitVec 128))

;; H
(assert (= value3 (bvudiv value2 #x0000000000000000000000000000000A)))

;; Assert
(assert
  (let ((temp___986 (to_rep
                      (select (to_array
                                (of_array
                                  s1
                                  (to_rep1 s__first)
                                  (to_rep1 s__last))) (+ p j)))))
    (and (<= 48 temp___986) (<= temp___986 57))))
...
(assert
  (forall ((k Int))
    (=>
      ...
      (let ((temp___998 (to_rep
                          (select (to_array
                                    (of_array
                                      s1
                                      (to_rep1 s__first)
                                      (to_rep1 s__last))) k))))
        (and (<= 48 temp___998) (<= temp___998 57))))))
        ...
        (forall ((k1 Int))
          (hexa_to_unsigned_ghost__function_guard
            (hexa_to_unsigned_ghost
              (to_rep
                (select (to_array
                          (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k1)))
            (to_rep
              (select (to_array
                        (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k1))))
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem 
        (of_int
          (div1 (bv2nat128 v) (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A))))))
  ...
  (and
    ...
    (and
      ...
      (= (scan_based_number_ghost
           ...
           (+ p nb_digits1)
           #x0000000000000000000000000000000A
           value3) (ite (< (+ p nb_digits1) (+ p j))
                     (us_repqtmk
                       (us_split_discrsqtmk (of_int1 0))
                       (us_split_fieldsqtmk (of_rep2 value3)))
                     (ite (= (to_rep
                               (select (to_array
                                         (of_array
                                           (to_array
      ...
      (exists ((o1 Int))
        (and
          ...
          (exists ((o2 Int))
            (and
              (= (to_rep1 s__first) o2)
              (let ((temp___1018 (of_array s1 o2 o1)))
                (let ((o3 (+ p j)))
                  (and
                    (in_range1 o3)
                    (and
                      (and
                        (<= (first temp___1018) o3)
                        (<= o3 (last temp___1018)))
                      (exists ((o4 Int))
                        (and
                          (= (to_rep (select (to_array temp___1018) o3)) o4)
                          (let ((o5 (hexa_to_unsigned_ghost o4)))
                            (and
                              (and
                                (hexa_to_unsigned_ghost__function_guard
                                  o5
                                ...
                                (and
                                  (dynamic_invariant3
                                    ...
                                    true
                                    true)
                                  (= o5 (ite (and (<= 48 o4) (<= o4 57))
                                          (bvsub (of_int o4) #x00000000000000000000000000000030)
                                          (ite (and (<= 97 o4) (<= o4 102))
                                            (bvadd (bvsub (of_int o4) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                                            (ite (and (<= 65 o4) (<= o4 70))
                                              (bvadd (bvsub (of_int o4) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value1 (bvadd (bvmul #x0000000000000000000000000000000A 
                                value3) o5))
                                (and
                                  (= prev_value1 (bvadd (bvmul #x0000000000000000000000000000000A 
                                  value3) (hexa_to_unsigned_ghost
...
(declare-const value4 (_ BitVec 128))
...
;; LoopInvariant
(assert (bvule value4 #x19999999999999999999999999999999))
...
(assert
  (= (only_decimal_ghost
       (let ((temp___1076 (of_array s2 (to_rep1 s__first) (to_rep1 s__last))))
         (of_array
...
(assert
  (forall ((k Int))
    (=>
      ...
      (let ((temp___1072 (to_rep
                           (select (to_array
                                     (of_array
                                       s2
                                       (to_rep1 s__first)
                                       (to_rep1 s__last))) k))))
        (and (<= 48 temp___1072) (<= temp___1072 57))))))
        ...
        (forall ((k1 Int))
          (hexa_to_unsigned_ghost__function_guard
            (hexa_to_unsigned_ghost
              (to_rep
                (select (to_array
                          (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) k1)))
            (to_rep
              (select (to_array
                        (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) k1))))
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem 
        (of_int
          (div1 (bv2nat128 v) (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A))))))
...
;; LoopInvariant
(assert (= (bv2nat128 value4) (div1 (bv2nat128 v) pow5)))

;; LoopInvariant
(assert
  (= (bool_eq10
       (scan_based_number_ghost
         (let ((temp___1046 (of_array
                              s2
                              (to_rep1 s__first)
                              (to_rep1 s__last))))
           (of_array
             (to_array temp___1046)
             (first temp___1046)
             (last temp___1046)))
         (+ p j1)
         (+ p nb_digits1)
...
(assert
  (= (and (ite (and
                 ...
                 (dynamic_property1 1 r56s j1))
            true
            false) (ite (and (<= 1 j1) (<= j1 r56s)) true false)) true))
...
;; Ensures
(assert
  (= (div1 (bv2nat128 value4) (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
  value4 #x0000000000000000000000000000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 v) (power big_10 (- nb_digits1 j2))) big_10) 
  (div1
    (bv2nat128 v)
  ...
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
        value4 #x0000000000000000000000000000000A))))
      (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem value4 #x0000000000000000000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
         value4 #x0000000000000000000000000000000A)))) (bvurem value4 #x0000000000000000000000000000000A))))

(declare-const prev_value3 (_ BitVec 128))

;; H
(assert (= prev_value3 value4))
...
;; Ensures
(assert
  (= (to_rep o1) (bv2nat128 (bvadd #x00000000000000000000000000000030 (bvurem 
  value4 #x0000000000000000000000000000000A)))))
...
(declare-const value5 (_ BitVec 128))

;; H
(assert (= value5 (bvudiv value4 #x0000000000000000000000000000000A)))
        ...
        (forall ((k1 Int))
          (hexa_to_unsigned_ghost__function_guard
            (hexa_to_unsigned_ghost
              (to_rep
                (select (to_array
                          (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k1)))
            (to_rep
              (select (to_array
                        (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k1))))
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem 
        (of_int
          (div1 (bv2nat128 v) (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A))))))
  ...
  (and
    ...
    (and
      ...
      (= (scan_based_number_ghost
           ...
           (+ p nb_digits1)
           #x0000000000000000000000000000000A
           value5) (ite (< (+ p nb_digits1) (+ p j2))
                     (us_repqtmk
                       (us_split_discrsqtmk (of_int1 0))
                       (us_split_fieldsqtmk (of_rep2 value5)))
                     (ite (= (to_rep
                               (select (to_array
                                         (of_array
                                           (to_array
      ...
      (exists ((o2 Int))
        (and
          ...
          (exists ((o3 Int))
            (and
              (= (to_rep1 s__first) o3)
              (let ((temp___1018 (of_array s3 o3 o2)))
                (let ((o4 (+ p j2)))
                  (and
                    (in_range1 o4)
                    (and
                      (and
                        (<= (first temp___1018) o4)
                        (<= o4 (last temp___1018)))
                      (exists ((o5 Int))
                        (and
                          (= (to_rep (select (to_array temp___1018) o4)) o5)
                          (let ((o6 (hexa_to_unsigned_ghost o5)))
                            (and
                              (and
                                (hexa_to_unsigned_ghost__function_guard
                                  o6
                                ...
                                (and
                                  (dynamic_invariant3
                                    ...
                                    true
                                    true)
                                  (= o6 (ite (and (<= 48 o5) (<= o5 57))
                                          (bvsub (of_int o5) #x00000000000000000000000000000030)
                                          (ite (and (<= 97 o5) (<= o5 102))
                                            (bvadd (bvsub (of_int o5) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                                            (ite (and (<= 65 o5) (<= o5 70))
                                              (bvadd (bvsub (of_int o5) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value3 (bvadd (bvmul #x0000000000000000000000000000000A 
                                value5) o6))
                                (and
                                  (= prev_value3 (bvadd (bvmul #x0000000000000000000000000000000A 
                                  value5) (hexa_to_unsigned_ghost
                                      ...
                                      (of_array
                                        ...
                                        (last
                                          (of_array
                                            ...
                                            (to_rep1 s__first)
                                            (to_rep1 s__last))))) j3))))
          (and (<= 48 temp___702) (<= temp___702 57)))))))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((k Int))
         (=>
           ...
           (let ((temp___1070 (to_rep
                                (select (to_array
                                          (of_array
                                            s3
                                            (to_rep1 s__first)
                                            (to_rep1 s__last))) k))))
             (and (<= 48 temp___1070) (<= temp___1070 57)))))
    true
    false))
      ...
      (hexa_to_unsigned_ghost
        (to_rep
          (select (to_array
                    (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k)))
      (to_rep
        (select (to_array (of_array s3 (to_rep1 s__first) (to_rep1 s__last))) k)))))
                ...
                (to_rep
                  (select (to_array
                            (of_array
                              s3
                              (to_rep1 s__first)
                              (to_rep1 s__last))) k))) (bvurem (of_int
                                                                 (div1
                                                                   (bv2nat128 
                                                                   v)
                                                                   (power
                                                                    ...
                                                                    (- 
                                                                    nb_digits1 (- k 
                                                                    p))))) #x0000000000000000000000000000000A))))
    true
    false))
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat128 value5) (div1 (bv2nat128 v) pow6)) true false))
...
;; H
(assert
  (= (wrap_option v) (us_repqtmk
                       (us_split_discrsqtmk (of_int1 0))
                       (us_split_fieldsqtmk (of_rep2 v)))))
...
;; Goal def'vc
;; File "s-imageu.ads", line 96, characters 0-0
(assert
  (not
  (not
    (= (last
