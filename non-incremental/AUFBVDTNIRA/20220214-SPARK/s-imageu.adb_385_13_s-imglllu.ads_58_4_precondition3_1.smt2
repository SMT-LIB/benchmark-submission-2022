...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_219 (_ BitVec 128)) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_731 Int) (temp___is_init_727 Bool) (temp___skip_constant_728 Bool) (temp___do_toplevel_729 Bool) (temp___do_typ_inv_730 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_242 (_ BitVec 128)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_777 us_t) (temp___is_init_773 Bool) (temp___skip_constant_774 Bool) (temp___do_toplevel_775 Bool) (temp___do_typ_inv_776 Bool)) Bool
  (=>
    (not (= temp___skip_constant_774 true))
    (and
      (and
        (dynamic_property
          (to_rep1 s__first)
          (to_rep1 s__last)
          (first temp___expr_777)
          (last temp___expr_777))
        (= (first temp___expr_777) (to_rep1 s__first)))
      (= (last temp___expr_777) (to_rep1 s__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_779 us_t) (temp___skip_top_level_780 Bool)) Bool
  (and
    (= (first temp___expr_779) (to_rep1 s__first))
    (= (last temp___expr_779) (to_rep1 s__last))))
                      ...
                      (and
                        (and
                          ...
                          (and
                            ...
                            (= (bv2nat value1) (div1 (bv2nat v) pow1))))
                        (and
                          (and
                            (and
                              (dynamic_invariant
                                ...
                                true
                                true)
                              (dynamic_invariant5 value1 true true true true))
                            (dynamic_invariant6 pow1 true true true true))
...
;; Ensures
(assert
  (= (to_rep o) (bv2nat (bvadd #x00000000000000000000000000000030 (bvurem 
                ...
                (exists ((o4 Int))
                  (and
                    ...
                    (exists ((o5 Int))
                      (and
                        (= (to_rep1 s__first) o5)
                        (let ((temp___920 (of_array s1 o5 o4)))
                          (exists ((o6 Int))
                            (and
...
(assert
  (= (only_decimal_ghost
       (let ((temp___964 (of_array s2 (to_rep1 s__first) (to_rep1 s__last))))
         (of_array
           (to_array temp___964)
           (first temp___964)
           (last temp___964)))
...
(assert
  (forall ((k Int))
    (=>
      ...
      (let ((temp___960 (to_rep
                          (select (to_array
                                    (of_array
                                      s2
                                      (to_rep1 s__first)
                                      (to_rep1 s__last))) k))))
        (and (<= 48 temp___960) (<= temp___960 57))))))
    ...
    (=>
      ...
      (and
        ...
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem ((_ int2bv 128) 
        (div1
          (bv2nat v)
...
;; LoopInvariant
(assert (= (bv2nat value4) (div1 (bv2nat v) pow5)))

;; LoopInvariant
(assert
  (= (bool_eq10
       (scan_based_number_ghost
         (let ((temp___934 (of_array s2 (to_rep1 s__first) (to_rep1 s__last))))
           (of_array
             (to_array temp___934)
             (first temp___934)
             (last temp___934)))
...
;; Ensures
(assert
  (= (to_rep o1) (bv2nat (bvadd #x00000000000000000000000000000030 (bvurem 
                ...
                (exists ((o5 Int))
                  (and
                    ...
                    (exists ((o6 Int))
                      (and
                        (= (to_rep1 s__first) o6)
                        (let ((temp___920 (of_array s3 o6 o5)))
                          (exists ((o7 Int))
                            (and
                                      ...
                                      (of_array
                                        ...
                                        (last
                                          (of_array
                                            ...
                                            (to_rep1 s__first)
                                            (to_rep1 s__last))))) j3))))
          (and (<= 48 temp___694) (<= temp___694 57)))))))
...
(define-fun usfqtunusedqtunused1 () Bool
  (ite (forall ((k Int))
         (=>
           ...
           (let ((temp___958 (to_rep
                               (select (to_array
                                         (of_array
                                           s3
                                           (to_rep1 s__first)
                                           (to_rep1 s__last))) k))))
             (and (<= 48 temp___958) (<= temp___958 57)))))
    true
    false))
                ...
                (to_rep
                  (select (to_array
                            (of_array
                              s3
                              (to_rep1 s__first)
                              (to_rep1 s__last))) k))) (bvurem ((_ int2bv 128) 
           (div1
             (bv2nat v)
             (power big_10 (- nb_digits1 (- k p))))) #x0000000000000000000000000000000A))))
    true
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat value5) (div1 (bv2nat v) pow6)) true false))
