...
(define-fun usfqtunusedqtunused () Bool
  (ite (forall ((k Int))
         (=>
           ...
           (= (to_rep
                (select (to_array
                          (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k)) 
           (to_rep
      ...
      (hexa_to_unsigned_ghost
        (to_rep
          (select (to_array
                    (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k)))
      (to_rep
        (select (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last))) k)))))
...
;; Ensures
(assert (in_range1 (+ (- nb_digits1 j) 1)))

;; Ensures
(assert (in_range2 (+ (- nb_digits1 j) 1)))
...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= pow4 (power big_10 (+ (- nb_digits1 j) 1))) true false))
...
(define-fun lpeqrpqtresultqtunusedqtunused1 () Bool
  (ite (= (bv2nat128 value3) (div1 (bv2nat128 v) pow4)) true false))
  ...
  (not
    (= (last
         (of_array
           (to_array (of_array s1 (to_rep1 s__first) (to_rep1 s__last)))
           (first (of_array s1 (to_rep1 s__first) (to_rep1 s__last)))
           (last (of_array s1 (to_rep1 s__first) (to_rep1 s__last))))) 2147483647))))
