...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_227 (_ BitVec 64)) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool
  true)
...
(define-fun default_initial_assumption ((temp___expr_236 us_rep) (temp___skip_top_level_237 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_llu__impl__uns_option__value__pred temp___expr_236)
      (= (to_rep2
           (rec__ada___system__val_llu__impl__uns_option__value
             (us_split_fields1 temp___expr_236))) #x0000000000000000))))
...
;; user_eq
(declare-fun user_eq11 (long_long_unsigned1
  long_long_unsigned1) Bool)

(declare-const dummy11 long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_220 (_ BitVec 64)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq13 (long_long_unsigned2
  long_long_unsigned2) Bool)

(declare-const dummy13 long_long_unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_243 (_ BitVec 64)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
...
;; big_10__def_axiom
(assert (= big_101 (bv2nat64 #x000000000000000A)))
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log101 us_void_param) (let ((temp___247 64))
                                       (ite (= temp___247 8)
                                         2
                                         (ite (= temp___247 16)
                                           4
                 ...
                 (ite (bvugt lo hi)
                   ...
                   (and
                     (and
                       ...
                       (< (bv2nat64 lo) (power big_101 (- result 1))))
                     (< (bv2nat64 hi) (power big_101 (- result 1)))))
                 (dynamic_invariant result true false true true)))))) :pattern (
    (width
      lo
      hi)) )))
...
(declare-const prev__split_fields long_long_unsigned)

(declare-const prev__split_discrs Bool)

(declare-const cur__split_fields long_long_unsigned)

(declare-const cur__split_discrs Bool)

(declare-const prev_value (_ BitVec 64))
...
(assert
  (and
    (= (div1 (bv2nat64 value) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
    value #x000000000000000A)))
            ...
            (let ((o1 (bv2nat64 v)))
              (and
                ...
                (and
                  ...
                  (exists ((value2 (_ BitVec 64)))
                    (and
                      (= value2 (bvudiv value #x000000000000000A))
                      (let ((o2 (+ nb_digits 1)))
                        (and
                          (in_range1 o2)
...
;; Assert
(assert (= value2 (of_int (div1 (bv2nat64 v) (power big_10 0)))))
...
;; Ensures
(assert
  (= (div1 (bv2nat64 value2) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  value2 #x000000000000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 v) (power big_10 (- nb_digits1 j))) big_10) 
  (div1
    (bv2nat64 v)
...
;; Ensures
(assert
  (let ((temp___815 (bv2nat64 (bvadd #x0000000000000030 (bvurem value2 #x000000000000000A)))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat64 (bvadd #x0000000000000030 (bvurem value2 #x000000000000000A))))
      (bv2nat64 (bvadd #x0000000000000030 (bvurem value2 #x000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat64 (bvadd #x0000000000000030 (bvurem value2 #x000000000000000A)))) (bvurem 
    value2 #x000000000000000A))))

(declare-const prev_value1 (_ BitVec 64))
...
;; Ensures
(assert
  (= (to_rep o) (bv2nat64 (bvadd #x0000000000000030 (bvurem value2 #x000000000000000A)))))
...
;; H
(assert (= value3 (bvudiv value2 #x000000000000000A)))
    ...
    (= (hexa_to_unsigned_ghost
         (to_rep
           ...
           p j)))) (bvurem (of_int
                             (div1
                               (bv2nat64 v)
                               (power big_10 (- nb_digits1 j)))) #x000000000000000A))))
  ...
  (forall ((k Int))
    (=>
      ...
      (and
        ...
        (of_int
          (div1 (bv2nat64 v) (power big_10 (- nb_digits1 (- k p))))) #x000000000000000A))))))
                          ...
                          (ite (= (to_rep
                            ...
                            (ite (= (scan_overflows_ghost
                              ...
                              (scan_based_number_ghost
                                ...
                                (+ p nb_digits1)
                                #x000000000000000A
                                (bvadd (bvmul #x000000000000000A prev_value1) 
                                (hexa_to_unsigned_ghost
                                  (to_rep
                                    (select (to_array
                                              (of_array
...
(declare-const prev__split_fields1 long_long_unsigned)
                     ...
                     (ite (= (to_rep
                       ...
                       (ite (= (scan_overflows_ghost
                         ...
                         (scan_based_number_ghost
                           ...
                           (+ p nb_digits1)
                           #x000000000000000A
                           (bvadd (bvmul #x000000000000000A value3) (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
(declare-const cur__split_fields1 long_long_unsigned)
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= o5 (ite (and (<= 48 o4) (<= o4 57))
                                          (bvsub (of_int o4) #x0000000000000030)
                                          (ite (and (<= 97 o4) (<= o4 102))
                                            (bvadd (bvsub (of_int o4) #x0000000000000061) #x000000000000000A)
                                            (ite (and (<= 65 o4) (<= o4 70))
                                              (bvadd (bvsub (of_int o4) #x0000000000000041) #x000000000000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value1 (bvadd (bvmul #x000000000000000A 
                                value3) o5))
                                (and
                                  (= prev_value1 (bvadd (bvmul #x000000000000000A 
...
(declare-const prev__split_fields2 long_long_unsigned)

(declare-const prev__split_discrs2 Bool)

(declare-const cur__split_fields2 long_long_unsigned)

(declare-const cur__split_discrs2 Bool)

(declare-const prev_value2 (_ BitVec 64))
...
;; LoopInvariant
(assert (bvule value4 #x1999999999999999))
...
;; LoopInvariant
(assert (= (bv2nat64 value4) (div1 (bv2nat64 v) pow5)))
...
;; Ensures
(assert
  (= (div1 (bv2nat64 value4) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  value4 #x000000000000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 v) (power big_10 (- nb_digits1 j2))) big_10) 
  (div1
    (bv2nat64 v)
...
;; Ensures
(assert
  (let ((temp___815 (bv2nat64 (bvadd #x0000000000000030 (bvurem value4 #x000000000000000A)))))
    (and (<= 48 temp___815) (<= temp___815 57))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat64 (bvadd #x0000000000000030 (bvurem value4 #x000000000000000A))))
      (bv2nat64 (bvadd #x0000000000000030 (bvurem value4 #x000000000000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat64 (bvadd #x0000000000000030 (bvurem value4 #x000000000000000A)))) (bvurem 
    value4 #x000000000000000A))))

(declare-const prev_value3 (_ BitVec 64))
...
;; Ensures
(assert
  (= (to_rep o1) (bv2nat64 (bvadd #x0000000000000030 (bvurem value4 #x000000000000000A)))))
...
;; H
(assert (= value5 (bvudiv value4 #x000000000000000A)))
    ...
    (= (hexa_to_unsigned_ghost
         (to_rep
           ...
           p j2)))) (bvurem (of_int
                              (div1
                                (bv2nat64 v)
                                (power big_10 (- nb_digits1 j2)))) #x000000000000000A))))
                          ...
                          (ite (= (to_rep
                            ...
                            (ite (= (scan_overflows_ghost
                              ...
                              (scan_based_number_ghost
                                ...
                                (+ p nb_digits1)
                                #x000000000000000A
                                (bvadd (bvmul #x000000000000000A prev_value3) 
                                (hexa_to_unsigned_ghost
                                  (to_rep
                                    (select (to_array
                                              (of_array
...
(declare-const prev__split_fields3 long_long_unsigned)
                     ...
                     (ite (= (to_rep
                       ...
                       (ite (= (scan_overflows_ghost
                         ...
                         (scan_based_number_ghost
                           ...
                           (+ p nb_digits1)
                           #x000000000000000A
                           (bvadd (bvmul #x000000000000000A value5) (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    (of_array
...
(declare-const cur__split_fields3 long_long_unsigned)
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= o6 (ite (and (<= 48 o5) (<= o5 57))
                                          (bvsub (of_int o5) #x0000000000000030)
                                          (ite (and (<= 97 o5) (<= o5 102))
                                            (bvadd (bvsub (of_int o5) #x0000000000000061) #x000000000000000A)
                                            (ite (and (<= 65 o5) (<= o5 70))
                                              (bvadd (bvsub (of_int o5) #x0000000000000041) #x000000000000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value3 (bvadd (bvmul #x000000000000000A 
                                value5) o6))
                                (and
                                  (= prev_value3 (bvadd (bvmul #x000000000000000A 
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat64 value5) (div1 (bv2nat64 v) pow6)) true false))
