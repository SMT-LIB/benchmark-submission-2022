...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_226 (_ BitVec 32)) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool
  true)
...
(define-fun default_initial_assumption ((temp___expr_235 us_rep) (temp___skip_top_level_236 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_uns__impl__uns_option__value__pred temp___expr_235)
      (= (to_rep2
           (rec__ada___system__val_uns__impl__uns_option__value
             (us_split_fields1 temp___expr_235))) #x00000000))))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_219 (_ BitVec 32)) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)
...
;; big_10__def_axiom
(assert (= big_101 (bv2nat #x0000000A)))
...
;; Ensures
(assert
  (= (to_rep o) (bv2nat (bvadd #x00000030 (bvurem value2 #x0000000A)))))
    ...
    (=>
      ...
      (and
        ...
        (= (hexa_to_unsigned_ghost
             (to_rep
               (select (to_array
                         (of_array s2 (to_rep1 s__first) (to_rep1 s__last))) k))) (bvurem ((_ int2bv 32) 
        (div1
          (bv2nat v)
...
;; Ensures
(assert
  (= (to_rep o1) (bv2nat (bvadd #x00000030 (bvurem value4 #x0000000A)))))
                ...
                (to_rep
                  (select (to_array
                            (of_array
                              s3
                              (to_rep1 s__first)
                              (to_rep1 s__last))) k))) (bvurem ((_ int2bv 32) 
           (div1
             (bv2nat v)
             (power big_10 (- nb_digits1 (- k p))))) #x0000000A))))
    true
