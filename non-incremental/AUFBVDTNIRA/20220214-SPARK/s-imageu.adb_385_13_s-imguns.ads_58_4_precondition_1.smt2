...
;; user_eq
(declare-fun user_eq11 (unsigned1
  unsigned1) Bool)

(declare-const dummy11 unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_220 (_ BitVec 32)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq13 (unsigned2
  unsigned2) Bool)

(declare-const dummy13 unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_243 (_ BitVec 32)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log101 us_void_param) (let ((temp___247 32))
                                       (ite (= temp___247 8)
                                         2
                                         (ite (= temp___247 16)
                                           4
...
(assert
  (and
    (= (div1 (bv2nat32 value) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
    value #x0000000A)))
            ...
            (let ((o1 (bv2nat32 v)))
              (and
                ...
                (and
                  ...
                  (exists ((value2 (_ BitVec 32)))
                    (and
                      (= value2 (bvudiv value #x0000000A))
                      (let ((o2 (+ nb_digits 1)))
                        (and
                          (in_range1 o2)
...
;; Assert
(assert (= value2 (of_int (div1 (bv2nat32 v) (power big_10 0)))))
...
;; Ensures
(assert
  (= (div1 (bv2nat32 value2) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  value2 #x0000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 v) (power big_10 (- nb_digits1 j))) big_10) 
  (div1
    (bv2nat32 v)
...
;; Ensures
(assert
  (let ((temp___815 (bv2nat32 (bvadd #x00000030 (bvurem value2 #x0000000A)))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat32 (bvadd #x00000030 (bvurem value2 #x0000000A))))
      (bv2nat32 (bvadd #x00000030 (bvurem value2 #x0000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat32 (bvadd #x00000030 (bvurem value2 #x0000000A)))) (bvurem 
    value2 #x0000000A))))
...
;; Ensures
(assert
  (= (to_rep o) (bv2nat32 (bvadd #x00000030 (bvurem value2 #x0000000A)))))
...
;; H
(assert (= value3 (bvudiv value2 #x0000000A)))
  ...
  (forall ((k Int))
    (=>
      ...
      (and
        ...
        (of_int
          (div1 (bv2nat32 v) (power big_10 (- nb_digits1 (- k p))))) #x0000000A))))))
                     ...
                     (ite (= (to_rep
                       ...
                       (ite (= (scan_overflows_ghost
                         ...
                         (scan_based_number_ghost
                           ...
                           (+ p nb_digits1)
                           #x0000000A
                           (bvadd (bvmul #x0000000A value3) (hexa_to_unsigned_ghost
                                                              (to_rep
                                                                (select 
                                                                (to_array
                                                                  (of_array
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= o5 (ite (and (<= 48 o4) (<= o4 57))
                                          (bvsub (of_int o4) #x00000030)
                                          (ite (and (<= 97 o4) (<= o4 102))
                                            (bvadd (bvsub (of_int o4) #x00000061) #x0000000A)
                                            (ite (and (<= 65 o4) (<= o4 70))
                                              (bvadd (bvsub (of_int o4) #x00000041) #x0000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value1 (bvadd (bvmul #x0000000A 
                                value3) o5))
                                (and
                                  (= prev_value1 (bvadd (bvmul #x0000000A 
...
(declare-const value4 (_ BitVec 32))
...
;; LoopInvariant
(assert (= (bv2nat32 value4) (div1 (bv2nat32 v) pow5)))
...
;; Ensures
(assert
  (= (div1 (bv2nat32 value4) (bv2nat32 #x0000000A)) (bv2nat32 (bvudiv 
  value4 #x0000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat32 v) (power big_10 (- nb_digits1 j2))) big_10) 
  (div1
    (bv2nat32 v)
...
;; Ensures
(assert
  (let ((temp___815 (bv2nat32 (bvadd #x00000030 (bvurem value4 #x0000000A)))))
    (and (<= 48 temp___815) (<= temp___815 57))))
...
(assert
  (and
    (hexa_to_unsigned_ghost__function_guard
      (hexa_to_unsigned_ghost
        (bv2nat32 (bvadd #x00000030 (bvurem value4 #x0000000A))))
      (bv2nat32 (bvadd #x00000030 (bvurem value4 #x0000000A))))
    (= (hexa_to_unsigned_ghost
         (bv2nat32 (bvadd #x00000030 (bvurem value4 #x0000000A)))) (bvurem 
    value4 #x0000000A))))
...
;; Ensures
(assert
  (= (to_rep o1) (bv2nat32 (bvadd #x00000030 (bvurem value4 #x0000000A)))))
...
;; H
(assert (= value5 (bvudiv value4 #x0000000A)))
                     ...
                     (ite (= (to_rep
                       ...
                       (ite (= (scan_overflows_ghost
                         ...
                         (scan_based_number_ghost
                           ...
                           (+ p nb_digits1)
                           #x0000000A
                           (bvadd (bvmul #x0000000A value5) (hexa_to_unsigned_ghost
                                                              (to_rep
                                                                (select 
                                                                (to_array
                                                                  (of_array
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= o6 (ite (and (<= 48 o5) (<= o5 57))
                                          (bvsub (of_int o5) #x00000030)
                                          (ite (and (<= 97 o5) (<= o5 102))
                                            (bvadd (bvsub (of_int o5) #x00000061) #x0000000A)
                                            (ite (and (<= 65 o5) (<= o5 70))
                                              (bvadd (bvsub (of_int o5) #x00000041) #x0000000A)
                                              (to_rep2 dummy6)))))))
                              (and
                                (= prev_value3 (bvadd (bvmul #x0000000A 
                                value5) o6))
                                (and
                                  (= prev_value3 (bvadd (bvmul #x0000000A 
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (bv2nat32 value5) (div1 (bv2nat32 v) pow6)) true false))
