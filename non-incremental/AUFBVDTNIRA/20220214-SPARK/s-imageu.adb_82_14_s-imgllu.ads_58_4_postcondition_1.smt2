...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_220 (_ BitVec 64)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
(assert
  (not (= (div1 (bv2nat64 x) (bv2nat64 y)) (bv2nat64 (bvudiv x y)))))
