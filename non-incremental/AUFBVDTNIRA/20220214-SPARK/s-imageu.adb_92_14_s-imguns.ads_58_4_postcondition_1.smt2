...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log101 us_void_param) (ite (= 32 8)
                                       2
                                       (ite (= 32 16)
                                         4
                                         (ite true
