                              ...
                              (and
                                ...
                                (exists ((o2 Int))
                                  (and
                                    ...
                                    (exists ((o3 Int))
                                      (and
                                        (= (to_rep1 prev_s__first) o3)
                                        (exists ((prev_value1 (_ BitVec 128)))
                                          (and
                                            (= prev_value1 value2)
                                            (exists ((o4 Int))
                                              (and
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___892 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= 
                                                                    (to_rep
                                                                    o11) (bv2nat (bvadd #x00000000000000000000000000000030 (bvurem 
                                                                    ...
                                                                    o19
                                                                    #x0000000000000000000000000000000A
                                                                    (bvadd (bvmul #x0000000000000000000000000000000A value3) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    prev_value1)) true))))))))))))))))))
                                                                    (exists 
                                                                    ((value4 (_ BitVec 128)) (pow5 Int) (prev_value2 (_ BitVec 128)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (bvule value4 #x19999999999999999999999999999999)
                                                                    (and
                                                                    (forall 
                                                                    ((k Int))
                                                                    (=>
...
;; H
(assert (= (to_rep1 s__first) temp___974))
...
;; H
(assert
  (let ((temp___973 (of_array s1 o1 o)))
    (=>
      (<= temp___974 p)
      (and
        (and
          (<= (first temp___973) temp___974)
          (<= temp___974 (last temp___973)))
        (and (<= (first temp___973) p) (<= p (last temp___973)))))))
...
(assert
  (let ((temp___982 (of_array
                      ...
                      (to_rep1 s__first)
                      p)))
    (let ((temp___980 (of_array (to_array (of_array s1 o1 o)) temp___974 p)))
      (ite (= (bool_eq6
                (to_array temp___980)
                (first temp___980)
                (last temp___980)
                (to_array temp___982)
                (first temp___982)
                (last temp___982)) true)
        (and
          (= (to_rep1 s__last) o3)
          (let ((o4 (+ p 1)))
            (and
              (in_range1 o4)
              (= o2 (and (ite (<= o4 p1) true false) (ite (<= p1 o3)
                                                       true
                                                       false))))))
        (= o2 false)))))
    ...
    (let ((o6 (+ p 1)))
      (and
        ...
        (and
          ...
          (and
            (= (to_rep1 s__first) o5)
            (let ((temp___984 (of_array s1 o5 o4)))
              (let ((o7 (of_array
                          (to_array temp___984)
                          (first temp___984)
                          (last temp___984))))
                (and
                  (= true (only_decimal_ghost o7 o6 p1))
                  (forall ((j1 Int))
                    (=>
                      (and (<= o6 j1) (<= j1 p1))
                      (let ((temp___694 (to_rep (select (to_array o7) j1))))
