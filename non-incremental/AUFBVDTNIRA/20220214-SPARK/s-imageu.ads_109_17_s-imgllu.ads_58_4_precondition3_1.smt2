                                  ...
                                  (and
                                    ...
                                    (exists ((o3 Int))
                                      (and
                                        ...
                                        (exists ((prev_value1 (_ BitVec 64)))
                                          (and
                                            (= prev_value1 value2)
                                            (exists ((o4 Int))
                                              (and
                                                              ...
                                                              (and
                                                                ...
                                                                (let ((temp___892 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= 
                                                                    (to_rep
                                                                    o11) (bv2nat (bvadd #x0000000000000030 (bvurem 
                                                                    ...
                                                                    o19
                                                                    #x000000000000000A
                                                                    (bvadd (bvmul #x000000000000000A value3) 
                                                                    (hexa_to_unsigned_ghost
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    ...
                                                                    prev_value1)) true))))))))))))))))))
                                                                    (exists 
                                                                    ((value4 (_ BitVec 64)) (pow5 Int) (prev_value2 (_ BitVec 64)) (prev_s2 (Array Int character)) (j1 Int))
                                                                    (and
                                                                    (and
                                                                    (bvule value4 #x1999999999999999)
                                                                    (and
                                                                    (forall 
                                                                    ((k Int))
                                                                    (=>
