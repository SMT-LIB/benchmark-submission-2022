...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_227 (_ BitVec 128)) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool
  true)
...
(declare-const dummy7 long_long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_220 (_ BitVec 128)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___309 (to_rep (select (to_array str) j))))
                 (or
             ...
             (not
               (= (let ((temp___320 (temp___String_Literal_311 Tuple0)))
                    (bool_eq6
                      ...
                      1
                      0)) true))
             (let ((temp___321 (to_rep (select (to_array str) (first str)))))
               ...
               (not
                 (= (let ((temp___335 (temp___String_Literal_326 Tuple0)))
                      (bool_eq6
                        ...
                        1
                        0)) true))
               (let ((temp___336 (to_rep (select (to_array str) (first str)))))
                 (and (<= 48 temp___336) (<= temp___336 57))))
             (let ((l (last_number_ghost str)))
               (and
                 (let ((temp___337 (to_rep (select (to_array str) l))))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (and
             (and
               (< 1 (length str))
               (let ((temp___399 (to_rep (select (to_array str) (first str)))))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___409 (let ((temp___408 (last str)))
                                      (of_array
                                        (to_array str)
      ...
      (! (=>
           ...
           (and
             (forall ((str1 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 (scan_natural_ghost
                   (let ((temp___493 (let ((temp___492 (last str1)))
                                       (of_array
                                         (to_array str1)
                                         start
                                         temp___492))))
...
;; user_eq
(declare-fun user_eq8 (long_long_long_unsigned2
  long_long_long_unsigned2) Bool)

(declare-const dummy8 long_long_long_unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_243 (_ BitVec 128)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool
  true)
    ...
    (forall ((from Int) (to__ Int))
      (! (=
           ...
           (forall ((j Int))
             (=>
               (and (<= from j) (<= j to__))
               (let ((temp___347 (to_rep (select (to_array str) j))))
                 (or
             ...
             (not
               (= (let ((temp___365 (temp___String_Literal_351 Tuple0)))
                    (bool_eq6
                      ...
                      1
                      0)) true))
             (let ((temp___366 (to_rep (select (to_array str) (first str)))))
               (or
               ...
               (not
                 (= (let ((temp___387 (temp___String_Literal_376 Tuple0)))
                      (bool_eq6
                        ...
                        1
                        0)) true))
               (let ((temp___388 (to_rep (select (to_array str) (first str)))))
                 (or
    ...
    (! (and
         ...
         (and
           (forall ((str1 us_t) (last_num_init Int))
             (last_hexa_ghost__function_guard
               (last_hexa_ghost
                 (let ((temp___443 (let ((temp___442 (last str1)))
                 ...
                 (let ((starts_as_based (and (and (bool_lt1
                   ...
                   (let ((last_num_based (ite (= starts_as_based true)
                     ...
                     (and
                       ...
                       (= (is_opt_exponent_format_ghost
                            (let ((temp___439 (let ((temp___438 (last str)))
                                                (of_array
                                                  (to_array str)
    ...
    (forall ((from Int) (to__ Int))
      (! (and
           (forall ((str1 us_t) (from1 Int) (to__1 Int))
             (last_number_ghost__function_guard
               (last_number_ghost
                 (let ((temp___549 (of_array (to_array str1) from1 to__1)))
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___647 (to_rep (select (to_array str) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str1 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___665 (of_array (to_array str1) from1 to__1)))
             ...
             (and
               (and
                 (and
                   ...
                   (and (<= (first str) from) (<= from (last str))))
                 (and (<= from to__) (<= to__ (last str))))
               (let ((temp___579 (to_rep (select (to_array str) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str1 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___603 (of_array (to_array str1) from1 to__1)))
...
(assert
  (forall ((str us_t))
    (! (=>
         (dynamic_invariant2 str true true true true)
         (= (slide_to_1 str) (let ((res (let ((temp___286 (slide
                                                            (to_array str)
                                                            (first str)
                                                            1)))
                                          (of_array
                               ...
                               (let ((temp___285 (to_array res)))
                                 (of_array temp___285 (first res) (last res)))))) :pattern (
    (slide_to_1
      str)) )))
                     ...
                     (and
                       (forall ((str1 us_t))
                         (slide_if_necessary__function_guard
                           ...
                           str1))
                       (and
                         (forall ((str1 us_t) (result1 (_ BitVec 128)))
                           (is_value_unsigned_ghost__function_guard
                             (is_value_unsigned_ghost
                               (slide_if_necessary str1)
                               result1)
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_271 us_t) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool
  (=>
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log10 us_void_param) (let ((temp___247 128))
                                      (ite (= temp___247 8)
                                        2
                                        (ite (= temp___247 16)
                                          4
                 ...
                 (ite (bvugt lo hi)
                   ...
                   (and
                     (and
                       ...
                       (< (bv2nat128 lo) (power1 big_10 (- result 1))))
                     (< (bv2nat128 hi) (power1 big_10 (- result 1)))))
                 (dynamic_invariant result true false true true)))))) :pattern (
    (width
      lo
      hi)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant10 ((temp___expr_756 us_t) (temp___is_init_752 Bool) (temp___skip_constant_753 Bool) (temp___do_toplevel_754 Bool) (temp___do_typ_inv_755 Bool)) Bool
  (=>
...
;; H
(assert
  (= (let ((temp___726 (of_array
                         (to_array
                           (of_array s1 (to_rep1 s__first) (to_rep1 s__last)))
                         (to_rep1 s__first)
                         p1)))
       (let ((temp___724 (of_array
                           (to_array
                             (of_array
                               s2
                               (to_rep1 s__first)
  ...
  (and
    (is_unsigned_ghost__function_guard
      ...
      (let ((temp___780 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___780) (first temp___780) (last temp___780))))
    (= (is_unsigned_ghost
         (let ((temp___780 (of_array
                             (to_array
                               (of_array
  ...
  (and
    (value_unsigned__function_guard
      ...
      (let ((temp___785 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___785) (first temp___785) (last temp___785))))
    (= (value_unsigned
         (let ((temp___785 (of_array
                             (to_array
                               (of_array
