...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_226 (_ BitVec 128)) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_219 (_ BitVec 128)) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_242 (_ BitVec 128)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool
  true)
    ...
    (! (= (max_log10 us_void_param) (ite (= 128 8)
                                      ...
                                      (ite (= 128 16)
                                        ...
                                        (ite (= 128 32)
                                          ...
                                          (ite (= 128 64)
                                            19
                                            (ite true 38 (to_rep3 dummy))))))) :pattern (
    (max_log10
      us_void_param)) )))
  ...
  (and
    (is_unsigned_ghost__function_guard
      ...
      (let ((temp___754 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___754) (first temp___754) (last temp___754))))
    (= (is_unsigned_ghost
         (let ((temp___754 (of_array
                             (to_array
                               (of_array
  ...
  (and
    (value_unsigned__function_guard
      ...
      (let ((temp___759 (of_array
                          ...
                          1
                          p2)))
        (of_array (to_array temp___759) (first temp___759) (last temp___759))))
    (= (value_unsigned
         (let ((temp___759 (of_array
                             (to_array
                               (of_array
