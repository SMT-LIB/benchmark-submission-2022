...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_227 (_ BitVec 32)) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq7 (unsigned1
  unsigned1) Bool)

(declare-const dummy7 unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_220 (_ BitVec 32)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool
  true)
...
;; bool_eq
(define-fun bool_eq12 ((x (_ BitVec 32)) (y (_ BitVec 32))) Bool
  (ite (= x y) true false))
...
;; user_eq
(declare-fun user_eq8 (unsigned2
  unsigned2) Bool)

(declare-const dummy8 unsigned2)
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_243 (_ BitVec 32)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool
  true)
                     ...
                     (and
                       (forall ((str1 us_t))
                         (slide_if_necessary__function_guard
                           ...
                           str1))
                       (and
                         (forall ((str1 us_t) (result1 (_ BitVec 32)))
                           (is_value_unsigned_ghost__function_guard
                             (is_value_unsigned_ghost
                               (slide_if_necessary str1)
                               result1)
...
(assert
  (forall ((us_void_param tuple0))
    (! (= (max_log10 us_void_param) (let ((temp___247 32))
                                      (ite (= temp___247 8)
                                        2
                                        (ite (= temp___247 16)
                                          4
                 ...
                 (ite (bvugt lo hi)
                   ...
                   (and
                     (and
                       ...
                       (< (bv2nat32 lo) (power1 big_10 (- result 1))))
                     (< (bv2nat32 hi) (power1 big_10 (- result 1)))))
                 (dynamic_invariant result true false true true)))))) :pattern (
    (width
      lo
      hi)) )))
