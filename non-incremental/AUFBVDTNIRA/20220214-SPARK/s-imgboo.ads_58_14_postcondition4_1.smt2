...
(assert
  (forall ((us_void_param tuple0))
    (! (and
         (and
           (= (to_rep (select (temp___String_Literal_267 us_void_param) 1)) 84)
           (= (to_rep (select (temp___String_Literal_267 us_void_param) 2)) 82))
         (and
           (= (to_rep (select (temp___String_Literal_267 us_void_param) 3)) 85)
           (= (to_rep (select (temp___String_Literal_267 us_void_param) 4)) 69))) :pattern (
    (temp___String_Literal_267
      us_void_param)) )))

;; temp___String_Literal_280
...
(assert
  (forall ((us_void_param tuple0))
    (! (and
         (and
           (= (to_rep (select (temp___String_Literal_280 us_void_param) 1)) 70)
           (= (to_rep (select (temp___String_Literal_280 us_void_param) 2)) 65))
         (and
           (and
             (= (to_rep (select (temp___String_Literal_280 us_void_param) 3)) 76)
             (= (to_rep (select (temp___String_Literal_280 us_void_param) 4)) 83))
           (= (to_rep (select (temp___String_Literal_280 us_void_param) 5)) 69))) :pattern (
    (temp___String_Literal_280
      us_void_param)) )))
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_252 us_t) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool) (temp___do_typ_inv_251 Bool)) Bool
  (=>
    ...
    (and
      (and
        ...
        (= (first temp___expr_252) (to_rep1 s__first)))
      (= (last temp___expr_252) (to_rep1 s__last)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_258 us_t) (temp___skip_top_level_259 Bool)) Bool
  (and
    (= (first temp___expr_258) (to_rep1 s__first))
    (= (last temp___expr_258) (to_rep1 s__last))))
...
(assert
  (ite (= spark__branch true)
    (and
      ...
      (and
        (= (to_rep1 s__first) o3)
        (let ((temp___270 (of_array s o3 o2)))
          (and
            (and
              (and
                (= (first temp___270) (first usf1))
                (= (last temp___270) (last usf1)))
              (forall ((temp___273 Int))
                (ite (and (<= 1 temp___273) (<= temp___273 4))
                  (= (select (to_array usf1) temp___273) (select (temp___String_Literal_267
                                                                   Tuple0) temp___273))
                  (= (select (to_array usf1) temp___273) (select (to_array
                                                                   temp___270) temp___273)))))
            (and (= s1 (to_array usf1)) (= p1 4))))))
    (and
      (= (to_rep1 s__last) o)
      (and
        (= (to_rep1 s__first) o1)
        (let ((temp___283 (of_array s o1 o)))
          (and
            (and
              (and
                (= (first temp___283) (first usf))
                (= (last temp___283) (last usf)))
              (forall ((temp___286 Int))
                (ite (and (<= 1 temp___286) (<= temp___286 5))
                  (= (select (to_array usf) temp___286) (select (temp___String_Literal_280
                                                                  Tuple0) temp___286))
                  (= (select (to_array usf) temp___286) (select (to_array
                                                                  temp___283) temp___286)))))
  ...
  (=>
    (only_space_ghost__function_guard
      ...
      (let ((temp___311 (of_array
                          ...
                          1
                          p1)))
        (of_array (to_array temp___311) (first temp___311) (last temp___311)))
      (first
        (let ((temp___311 (of_array
                            (to_array
                              (of_array
