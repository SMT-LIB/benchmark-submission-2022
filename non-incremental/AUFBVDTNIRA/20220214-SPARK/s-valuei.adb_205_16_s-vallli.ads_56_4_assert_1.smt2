...
(assert
  (ite (= o true)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_lli__impl__value_integer__B_2__fst_num__assume o1)
        (in_range o1)))
...
;; H
(assert
  (not (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer usf) true)))

;; H
(assert
  (= false (rec__ada___system__val_lli__impl__T5s__is_null_pointer usf)))
    ...
    (let ((non_blank1 (first_non_space_ghost
      ...
      (let ((fst_num1 (ite (let ((temp___605 (to_rep1
        ...
        (and
          ...
          (and
            (and
              (forall ((non_blank2 Int) (uval (_ BitVec 64)))
                (is_int_of_uns__function_guard
                  (is_int_of_uns
                    (bool_eq6
