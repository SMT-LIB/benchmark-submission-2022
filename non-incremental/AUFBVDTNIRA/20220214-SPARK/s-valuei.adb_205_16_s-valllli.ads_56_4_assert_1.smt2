...
;; Assume
(assert (dynamic_invariant2 non_blank true false true true))
...
;; H
(assert (= (to_rep1 (select (to_array str) non_blank)) temp___855))

(declare-const o Bool)

;; H
(assert
  (ite (= temp___855 43) (= o true) (= o (ite (= temp___855 45) true false))))
...
(assert
  (ite (= o true)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_llli__impl__value_integer__B_2__fst_num__assume o1)
        (in_range o1)))
...
;; Assume
(assert (dynamic_invariant2 fst_num true false true true))
      ...
      (is_raw_unsigned_format_ghost
        (let ((temp___846 (of_array (to_array str) fst_num (last str))))
          (of_array
            ...
            (last temp___846))))
      (let ((temp___846 (of_array (to_array str) fst_num (last str))))
        (of_array (to_array temp___846) (first temp___846) (last temp___846))))
    (= (is_raw_unsigned_format_ghost
         (let ((temp___846 (of_array (to_array str) fst_num (last str))))
           (of_array
             (to_array temp___846)
             (first temp___846)
             (last temp___846)))) true)))
...
(assert
  (not
    (= (rec__ada___system__val_llli__impl__T5s__is_null_pointer usf) true)))

;; H
(assert
  (= false (rec__ada___system__val_llli__impl__T5s__is_null_pointer usf)))
...
(assert
  (and
    ...
    (let ((non_blank1 (first_non_space_ghost
                        ...
                        (to_rep p_acc__pointer_value)
                        (last str))))
      (let ((fst_num1 (ite (let ((temp___605 (to_rep1
                                               (select (to_array str) non_blank1))))
                             (or (= temp___605 43) (= temp___605 45)))
                        (+ non_blank1 1)
                        non_blank1)))
        (and
          (forall ((fst_num2 Int))
          ...
          (and
            (and
              (forall ((non_blank2 Int) (uval (_ BitVec 128)))
                (is_int_of_uns__function_guard
                  (is_int_of_uns
                    (bool_eq6
                      (to_rep1 (select (to_array str) non_blank2))
                      45)
                    uval
                    v1)
                  (bool_eq6 (to_rep1 (select (to_array str) non_blank2)) 45)
                  uval
                  v1))
              (= (is_int_of_uns
                   (bool_eq6 (to_rep1 (select (to_array str) non_blank1)) 45)
...
;; H
(assert (dynamic_invariant1 v1 true true true true))
...
(assert
  (and
    (raw_unsigned_last_ghost__function_guard
      ...
      fst_num
      (last str))
    (= p1 (raw_unsigned_last_ghost str fst_num (last str)))))
...
(assert
  ...
  (=>
    ...
    (=>
      ...
      (=>
        (is_value_integer_ghost__function_guard
          (is_value_integer_ghost (slide_if_necessary str) v1)
          (slide_if_necessary str)
          v1)
        (= (is_value_integer_ghost (slide_if_necessary str) v1) true))))))
