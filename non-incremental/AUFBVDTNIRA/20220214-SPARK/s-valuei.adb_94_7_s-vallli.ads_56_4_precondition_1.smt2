...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_217 (_ BitVec 64)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; abs_uns_of_int
(define-fun abs_uns_of_int ((val__ Int)) (_ BitVec 64)
  (ite (= val__ (- 9223372036854775808))
    #x8000000000000000
...
;; ada___system__val_lli__impl__prove_scan_only_decimal_ghost__minus__assume
(define-fun ada___system__val_lli__impl__prove_scan_only_decimal_ghost__minus__assume 
  () Bool
...
(declare-const ada___system__val_lli__impl__prove_scan_only_decimal_ghost__fst_num__assume Int)
...
(assert
  (ite (= minus true)
    (let ((o (+ non_blank 1)))
      (and
        (= ada___system__val_lli__impl__prove_scan_only_decimal_ghost__fst_num__assume o)
        (in_range1 o)))
    (= ada___system__val_lli__impl__prove_scan_only_decimal_ghost__fst_num__assume 
    non_blank)))
