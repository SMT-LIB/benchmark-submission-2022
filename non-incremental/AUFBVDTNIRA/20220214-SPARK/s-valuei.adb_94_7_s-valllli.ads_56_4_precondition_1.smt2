...
(define-fun abs_uns_of_int ((val__ Int)) (_ BitVec 128)
  (ite (= val__ (- 170141183460469231731687303715884105728))
    ...
    (ite (< val__ 0) ((_ int2bv 128) (- val__)) ((_ int2bv 128) val__))))
...
(assert
  (ite (and (= minus true) (= uval #x80000000000000000000000000000000))
    (= val__ (- 170141183460469231731687303715884105728))
    (ite (= minus true) (= val__ (- (bv2nat uval))) (= val__ (bv2nat uval)))))
...
(assert
  (and
    (is_raw_unsigned_format_ghost__function_guard
      (is_raw_unsigned_format_ghost
        (let ((temp___858 (of_array (to_array str) fst_num (last str))))
          (of_array
            (to_array temp___858)
            (first temp___858)
            (last temp___858))))
      (let ((temp___858 (of_array (to_array str) fst_num (last str))))
        (of_array (to_array temp___858) (first temp___858) (last temp___858))))
    (= (is_raw_unsigned_format_ghost
         (let ((temp___858 (of_array (to_array str) fst_num (last str))))
           (of_array
             (to_array temp___858)
             (first temp___858)
             (last temp___858)))) true)))
