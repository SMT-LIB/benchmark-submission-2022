...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool
  (=>
    (or
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_217 (_ BitVec 128)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; abs_uns_of_int
(define-fun abs_uns_of_int ((val__ Int)) (_ BitVec 128)
  (ite (= val__ (- 170141183460469231731687303715884105728))
    #x80000000000000000000000000000000
    (ite (< val__ 0) (of_int (- val__)) (of_int val__))))
...
(assert
  (forall ((value (_ BitVec 128)))
    (! (=>
         ...
         (= (wrap_option value) (let ((temp___overflow_701 (of_int1 0)))
                                  (us_repqtmk
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 ...
                 start
                 0))
             (= (scan_exponent_ghost str1 real__) (let ((plus_sign (bool_eq9
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    str1) (+ 
...
;; minus__def_axiom
(assert (= minus (bool_eq9 (to_rep (select (to_array str) non_blank)) 45)))
    ...
    (and
      (and
        (and
          ...
          (let ((temp___885 (to_rep (select (to_array str) (first str)))))
            (or (= temp___885 32) (= temp___885 45))))
...
;; ada___system__val_llli__impl__prove_scan_only_decimal_ghost__minus__assume
(define-fun ada___system__val_llli__impl__prove_scan_only_decimal_ghost__minus__assume 
  () Bool
...
(declare-const ada___system__val_llli__impl__prove_scan_only_decimal_ghost__fst_num__assume Int)
...
(assert
  (ite (= minus true)
    (let ((o (+ non_blank 1)))
      (and
        (= ada___system__val_llli__impl__prove_scan_only_decimal_ghost__fst_num__assume o)
        (in_range1 o)))
    (= ada___system__val_llli__impl__prove_scan_only_decimal_ghost__fst_num__assume 
    non_blank)))
...
(assert
  (and
    (last_number_ghost__function_guard
      (last_number_ghost
        (let ((temp___512 (of_array (to_array str) fst_num (last str))))
          (of_array
            (to_array temp___512)
            (first temp___512)
            (last temp___512))))
      (let ((temp___512 (of_array (to_array str) fst_num (last str))))
        (of_array (to_array temp___512) (first temp___512) (last temp___512))))
    (and
      (forall ((last_num_init Int))
        (last_hexa_ghost__function_guard
          (last_hexa_ghost
            (let ((temp___503 (of_array
                                (to_array str)
                                (+ last_num_init 2)
                                (last str))))
              (of_array
            ...
            (scan_exponent_ghost
              (let ((temp___497 (of_array
                ...
                (of_array
                  ...
                  (last temp___497)))
              (of_int1 0))
            (let ((temp___497 (of_array (to_array str) first_exp (last str))))
              (of_array
                (to_array temp___497)
                (first temp___497)
                (last temp___497)))
            ...
            (scan_exponent_ghost__function_guard
              ...
              (let ((temp___497 (of_array
                ...
                (of_array
                  ...
                  (last temp___497)))
              (of_int1 0)))
          (= (scan_raw_unsigned_ghost str fst_num (last str)) (let ((last_num_init 
                                                                (last_number_ghost
                                                                  (let ((temp___512 
                                                                    (of_array
                                                                    (to_array
...
;; Assume
(assert (= (scan_raw_unsigned_ghost str fst_num (last str)) uval))

;; Assume
(assert (dynamic_invariant3 uval true false true true))

;; Assert
(assert (= (= minus true) (< val__ 0)))

;; Assert
(assert (= uval (abs_uns_of_int val__)))

;; Assert
(assert
  (ite (= minus true)
    (bvule uval #x80000000000000000000000000000000)
    (bvule uval #x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)))
...
;; Assert
(assert
  (ite (and (= minus true) (= uval #x80000000000000000000000000000000))
    (= val__ (- 170141183460469231731687303715884105728))
    (ite (= minus true)
      (= val__ (- (bv2nat128 uval)))
      (= val__ (bv2nat128 uval)))))
...
(assert
  (and
    (is_int_of_uns__function_guard
      (is_int_of_uns minus uval val__)
      minus
      uval
      val__)
    (= (is_int_of_uns minus uval val__) true)))
...
(assert
  (and
    (is_raw_unsigned_format_ghost__function_guard
      (is_raw_unsigned_format_ghost
        (let ((temp___869 (of_array (to_array str) fst_num (last str))))
          (of_array
            (to_array temp___869)
            (first temp___869)
            (last temp___869))))
...
(assert
  (and
    (is_value_integer_ghost__function_guard
      (is_value_integer_ghost str val__)
      str
      val__)
    (= (is_value_integer_ghost str val__) true)))

;; H
(assert (value_integer__function_guard (value_integer str) str))

;; H
(assert (dynamic_invariant (value_integer str) true false true true))
...
(assert
  ...
  (=>
    (is_int_of_uns__function_guard
      (is_int_of_uns minus uval (value_integer str))
      minus
      uval
      (value_integer str))
    (= (is_int_of_uns minus uval (value_integer str)) true))))
