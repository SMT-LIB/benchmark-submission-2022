...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_217 (_ BitVec 64)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq6 (long_long_unsigned1
  long_long_unsigned1) Bool)

(declare-const dummy6 long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_224 (_ BitVec 64)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool
  true)
...
(declare-const ada___system__val_lli__impl__scan_integer__fst_num__assume Int)
...
(assert
  (ite (= o true)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_lli__impl__scan_integer__fst_num__assume o1)
        (in_range1 o1)))
    (= ada___system__val_lli__impl__scan_integer__fst_num__assume non_blank)))

;; Assume
(assert
  (= ada___system__val_lli__impl__scan_integer__fst_num__assume fst_num))
...
;; H
(assert (= spark__branch1 (ite (bvugt uval1 #x7FFFFFFFFFFFFFFF) true false)))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (ite (= minus true)
        (= o2 (ite (= uval1 #x8000000000000000) true false))
        (= o2 false))
      (and
        (= spark__branch3 o2)
        (and (= spark__branch3 true) (= res2 (- 9223372036854775808)))))
    (and
      (= spark__branch2 minus)
      (ite (= spark__branch2 true)
        (let ((o3 (bv2nat64 uval1))) (and (in_range2 o3) (= res2 (- o3))))
        (let ((o3 (bv2nat64 uval1))) (and (in_range2 o3) (= res2 o3)))))))
