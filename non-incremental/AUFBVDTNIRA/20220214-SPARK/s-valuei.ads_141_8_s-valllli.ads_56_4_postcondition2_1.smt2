...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_217 (_ BitVec 128)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; user_eq
(declare-fun user_eq6 (long_long_long_unsigned1
  long_long_long_unsigned1) Bool)

(declare-const dummy6 long_long_long_unsigned1)
...
;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_224 (_ BitVec 128)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool
  true)
...
(declare-datatypes ((t8s__ref 0))
  (((t8s__refqtmk (t8s__content us_rep1)))))

;; t8s__ref_t8s__content__projection
(define-fun t8s__ref_t8s__content__projection ((a t8s__ref)) us_rep1
  (t8s__content a))
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool
  (=>
    (or (= temp___is_init_42 true) (<= 0 2147483647))
    (in_range6 temp___expr_46)))
      ...
      (! (=>
           (and
             (and
               (and
                 (dynamic_invariant3 str1 true true true true)
                 (dynamic_invariant6 p true true true true))
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 ...
                 start
                 0))
             (= (scan_exponent_ghost str1 real__) (let ((plus_sign (bool_eq
                                                                    (to_rep1
                                                                    (select 
                                                                    (to_array
                                                                    str1) (+ 
...
(define-fun default_initial_assumption ((temp___expr_233 us_rep) (temp___skip_top_level_234 Bool)) Bool
  (and
    (= (rec__ada___system__val_lllu__impl__uns_option__overflow
         (us_split_discrs1 temp___expr_233)) (of_int1 0))
    (=>
        ...
        (! (=>
               ...
               (and
                 (and
                   (and
                     ...
                     (dynamic_invariant from true true true true))
                   (dynamic_invariant to__ true true true true))
                 (dynamic_invariant5 base true true true true))
             ...
             (and
               ...
               (and
                 ...
                 (ite (< to__ from)
                   (let ((temp___overflow_404 (of_int1 0)))
                     (us_repqtmk
                   ...
                   (ite (= (to_rep1 (select (to_array str1) from)) 95)
                     ...
                     (ite (= (scan_overflows_ghost
                               ...
                               base
                               acc) true)
                       (let ((temp___overflow_405 (of_int1 1)))
                         (us_repqtmk
  ...
  (forall ((value (_ BitVec 128)) (base (_ BitVec 128)))
    (forall ((exp1 Int))
      (! (=>
           (and
             (and
               (dynamic_invariant5 value true true true true)
               (dynamic_invariant6 exp1 true true true true))
             (dynamic_invariant5 base true true true true))
...
;; fst_num__def_axiom
(assert
  (= fst_num (ite (let ((temp___202 (to_rep1
                                      (select (to_array str) non_blank))))
                    (or (= temp___202 43) (= temp___202 45)))
               (+ non_blank 1)
               non_blank)))
...
(declare-const unused_start Int)
  ...
  (and
    (and
      (and
        ...
        (or
          (< max1 (to_rep ptr__pointer_value))
          (and
            (<= (first str) (to_rep ptr__pointer_value))
            (<= max1 (last str)))))
      (and
        (only_space_ghost__function_guard
          (only_space_ghost str (to_rep ptr__pointer_value) max1)
          str
          (to_rep ptr__pointer_value)
          max1)
        (not
          (= (only_space_ghost str (to_rep ptr__pointer_value) max1) true))))
    (and
      (first_non_space_ghost__function_guard
        (first_non_space_ghost str (to_rep ptr__pointer_value) max1)
        str
        (to_rep ptr__pointer_value)
        max1)
      (let ((non_blank1 (first_non_space_ghost
                          ...
                          (to_rep ptr__pointer_value)
                          max1)))
        (let ((fst_num1 (ite (let ((temp___807 (to_rep1
                                                 (select (to_array str) non_blank1))))
                               (or (= temp___807 43) (= temp___807 45)))
                          (+ non_blank1 1)
                          non_blank1)))
          (and
            (and
                    ...
                    (is_raw_unsigned_format_ghost
                      (let ((temp___800 (of_array
                        ...
                        (of_array
                          ...
                          (first temp___800)
                          (last temp___800))))
                    (let ((temp___800 (of_array (to_array str) fst_num2 max1)))
                      (of_array
                        (to_array temp___800)
                        (first temp___800)
                        (last temp___800)))))
                (= (is_raw_unsigned_format_ghost
                     (let ((temp___800 (of_array
                       ...
                       (of_array
                         (to_array temp___800)
                         (first temp___800)
                         (last temp___800)))) true))
              (and
                (forall ((fst_num2 Int))
                  (raw_unsigned_overflows_ghost__function_guard
                    (raw_unsigned_overflows_ghost str fst_num2 max1)
                    str
                    fst_num2
                    max1))
                (not
                  (= (raw_unsigned_overflows_ghost str fst_num1 max1) true))))
            (and
              (forall ((fst_num2 Int))
                (scan_raw_unsigned_ghost__function_guard
                  (scan_raw_unsigned_ghost str fst_num2 max1)
                  str
                  fst_num2
                  max1))
              (and
                (forall ((fst_num2 Int))
                  (scan_raw_unsigned_ghost__function_guard
                    ...
                    max1))
                (and
                  (forall ((non_blank2 Int) (fst_num2 Int))
                    (uns_is_valid_int__function_guard
                      (uns_is_valid_int
                        (bool_eq
                  ...
                  (= (uns_is_valid_int
                       (bool_eq
                         (to_rep1 (select (to_array str) non_blank1))
                         45)
                       (scan_raw_unsigned_ghost str fst_num1 max1)) true))))))))))
...
;; Assume
(assert (dynamic_invariant2 unused_start false false true true))
...
;; H
(assert
  (<= (to_rep ptr__pointer_value) (first_non_space_ghost
                                    str
                                    (to_rep ptr__pointer_value)
                                    max1)))
...
;; H
(assert
  (<= (first_non_space_ghost str (to_rep ptr__pointer_value) max1) max1))
  ...
  (and
    (only_space_ghost__function_guard
      (only_space_ghost
        str
        (to_rep ptr__pointer_value)
        (- (first_non_space_ghost str (to_rep ptr__pointer_value) max1) 1))
      str
      (to_rep ptr__pointer_value)
      (- (first_non_space_ghost str (to_rep ptr__pointer_value) max1) 1))
    (= (only_space_ghost
         str
         (to_rep ptr__pointer_value)
         (- (first_non_space_ghost str (to_rep ptr__pointer_value) max1) 1)) true)))

;; Assume
(assert
  (= (first_non_space_ghost str (to_rep ptr__pointer_value) max1) non_blank))

;; Assume
(assert (dynamic_invariant2 non_blank true false true true))

(declare-const ada___system__val_llli__impl__scan_integer__fst_num__assume Int)
...
;; H
(assert (= (to_rep1 (select (to_array str) non_blank)) temp___775))

(declare-const o Bool)

;; H
(assert
  (ite (= temp___775 43) (= o true) (= o (ite (= temp___775 45) true false))))
...
(assert
  (ite (= o true)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_llli__impl__scan_integer__fst_num__assume o1)
        (in_range1 o1)))
    (= ada___system__val_llli__impl__scan_integer__fst_num__assume non_blank)))

;; Assume
(assert
  (= ada___system__val_llli__impl__scan_integer__fst_num__assume fst_num))
...
(declare-const unused_start1 Int)
...
(assert
  (and
    (first_non_space_ghost__function_guard
      ...
      (to_rep ptr__pointer_value)
      max1)
    (let ((f (first_non_space_ghost str (to_rep ptr__pointer_value) max1)))
      (and
        (and
          (= (= minus true) (= (to_rep1 (select (to_array str) f)) 45))
          (= (to_rep ptr__pointer_value1) (ite (let ((temp___738 (to_rep1
                                                                   (select 
                                                                   (to_array
                                                                    str) f))))
                                                 (or
...
;; H
(assert (dynamic_invariant2 unused_start1 true true true true))
...
;; H
(assert (= (to_rep ptr__pointer_value1) temp___783))

;; H
(assert (and (<= (first str) temp___783) (<= temp___783 (last str))))

(declare-const temp___784 Int)

;; H
(assert (= (to_rep1 (select (to_array str) temp___783)) temp___784))

;; H
(assert
  (= spark__branch (ite (= (and (ite (<= 48 temp___784) true false) (ite (<= 
                                                                    temp___784 57)
                                                                    true
                                                                    false)) true)
                     false
...
(assert
  (and
    (raw_unsigned_overflows_ghost__function_guard
      (raw_unsigned_overflows_ghost str (to_rep ptr__pointer_value2) max1)
      str
      (to_rep ptr__pointer_value2)
      max1)
    (not
      (= (raw_unsigned_overflows_ghost str (to_rep ptr__pointer_value2) max1) true))))

;; H
(assert
  (and
    (scan_raw_unsigned_ghost__function_guard
      (scan_raw_unsigned_ghost str (to_rep ptr__pointer_value2) max1)
      str
      (to_rep ptr__pointer_value2)
      max1)
    (= res1 (scan_raw_unsigned_ghost str (to_rep ptr__pointer_value2) max1))))

;; H
(assert
  (and
    (raw_unsigned_last_ghost__function_guard
      (raw_unsigned_last_ghost str (to_rep ptr__pointer_value2) max1)
      str
      (to_rep ptr__pointer_value2)
      max1)
    (= (to_rep ptr__pointer_value3) (raw_unsigned_last_ghost
                                      str
                                      (to_rep ptr__pointer_value2)
                                      max1))))
...
;; H
(assert (dynamic_invariant5 res1 true true true true))
...
(assert
  (and
    (scan_raw_unsigned_ghost__function_guard
      (scan_raw_unsigned_ghost str fst_num max1)
      str
      fst_num
      max1)
    (= uval1 (scan_raw_unsigned_ghost str fst_num max1))))
...
;; H
(assert
  (= spark__branch1 (ite (bvugt uval1 #x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)
                      true
                      false)))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (ite (= minus true)
        (= o2 (ite (= uval1 #x80000000000000000000000000000000) true false))
        (= o2 false))
      (and
        (= spark__branch3 o2)
        (and
          (= spark__branch3 true)
          (= res2 (- 170141183460469231731687303715884105728)))))
    (and
      (= spark__branch2 minus)
      (ite (= spark__branch2 true)
        (let ((o3 (bv2nat128 uval1))) (and (in_range2 o3) (= res2 (- o3))))
        (let ((o3 (bv2nat128 uval1))) (and (in_range2 o3) (= res2 o3)))))))

;; temp___result_814'def
(assert
  (first_non_space_ghost__function_guard
    (first_non_space_ghost str (to_rep ptr__pointer_value) max1)
    str
...
;; non_blank
(define-fun non_blank1 () Int
  (first_non_space_ghost str (to_rep ptr__pointer_value) max1))

;; fst_num
(define-fun fst_num1 () Int
  (ite (let ((temp___813 (to_rep1 (select (to_array str) non_blank1))))
         (or (= temp___813 43) (= temp___813 45)))
    (+ non_blank1 1)
    non_blank1))

;; temp___result_811'def
(assert
  (scan_raw_unsigned_ghost__function_guard
    (scan_raw_unsigned_ghost str fst_num1 max1)
    str
    fst_num1
    max1))

;; uval
(define-fun uval2 () (_ BitVec 128)
  (scan_raw_unsigned_ghost str fst_num1 max1))

;; Goal def'vc
;; File "s-valuei.ads", line 116, characters 0-0
(assert
  (not
  (=>
    (is_int_of_uns__function_guard
      (is_int_of_uns
        (bool_eq (to_rep1 (select (to_array str) non_blank1)) 45)
        uval2
        res2)
      (bool_eq (to_rep1 (select (to_array str) non_blank1)) 45)
      uval2
