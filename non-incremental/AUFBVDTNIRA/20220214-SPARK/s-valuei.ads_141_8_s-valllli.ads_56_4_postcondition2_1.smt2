  ...
  (and
    ...
    (and
      ...
      (let ((non_blank1 (first_non_space_ghost
                          ...
                          (to_rep ptr__pointer_value)
                          max1)))
        (let ((fst_num1 (ite (let ((temp___806 (to_rep1
                                                 (select (to_array str) non_blank1))))
                               (or (= temp___806 43) (= temp___806 45)))
                          (+ non_blank1 1)
                          non_blank1)))
          (and
            (and
                    ...
                    (is_raw_unsigned_format_ghost
                      (let ((temp___799 (of_array
                        ...
                        (of_array
                          ...
                          (first temp___799)
                          (last temp___799))))
                    (let ((temp___799 (of_array (to_array str) fst_num2 max1)))
                      (of_array
                        (to_array temp___799)
                        (first temp___799)
                        (last temp___799)))))
  ...
  (ite (= spark__branch1 true)
    ...
    (and
      ...
      (ite (= spark__branch2 true)
        (let ((o3 (bv2nat uval1))) (and (in_range2 o3) (= res2 (- o3))))
        (let ((o3 (bv2nat uval1))) (and (in_range2 o3) (= res2 o3)))))))

;; temp___result_813'def
(assert
  (first_non_space_ghost__function_guard
    (first_non_space_ghost str (to_rep ptr__pointer_value) max1)
    str
...
(define-fun fst_num1 () Int
  (ite (let ((temp___812 (to_rep1 (select (to_array str) non_blank1))))
         (or (= temp___812 43) (= temp___812 45)))
    (+ non_blank1 1)
    non_blank1))

;; temp___result_810'def
(assert
  (scan_raw_unsigned_ghost__function_guard
