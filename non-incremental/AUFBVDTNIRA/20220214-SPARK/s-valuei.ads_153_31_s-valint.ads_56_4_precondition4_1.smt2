...
;; Assume
(assert (dynamic_invariant3 uval false false true true))

;; Assume
(assert true)

;; Assume
(assert (dynamic_invariant1 unused_start false false true true))
...
(declare-const ada___system__val_int__impl__scan_integer__fst_num__assume Int)
...
(assert
  (ite (= o true)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_int__impl__scan_integer__fst_num__assume o1)
        (in_range1 o1)))
    (= ada___system__val_int__impl__scan_integer__fst_num__assume non_blank)))

;; Assume
(assert
  (= ada___system__val_int__impl__scan_integer__fst_num__assume fst_num))
...
;; H
(assert (dynamic_invariant1 unused_start1 true true true true))
...
;; H
(assert (dynamic_invariant4 res1 true true true true))
...
;; H
(assert (= spark__branch1 (ite (bvugt uval1 #x7FFFFFFF) true false)))
...
(assert
  (ite (= spark__branch1 true)
    (and
      (ite (= minus true)
        (= o2 (ite (= uval1 #x80000000) true false))
        (= o2 false))
      (and
        (= spark__branch3 o2)
        (and (= spark__branch3 true) (= res2 (- 2147483648)))))
    (and
      (= spark__branch2 minus)
      (ite (= spark__branch2 true)
        (let ((o3 (bv2nat32 uval1))) (and (in_range1 o3) (= res2 (- o3))))
        (let ((o3 (bv2nat32 uval1))) (and (in_range1 o3) (= res2 o3)))))))
...
(declare-const fst_num1 Int)

;; Assert
(assert
  (and
    (<= (first str) (first_non_space_ghost
                      str
                      (to_rep ptr__pointer_value)
                      max1))
    (<= (first_non_space_ghost str (to_rep ptr__pointer_value) max1) 
...
(assert
  (ite (= temp___792 43)
    (= o3 true)
    (= o3 (ite (= temp___792 45) true false))))

;; H
(assert
  (ite (= o3 true)
    (let ((o4 (+ (first_non_space_ghost str (to_rep ptr__pointer_value) max1) 1)))
      (and (= fst_num1 o4) (in_range1 o4)))
    (= fst_num1 (first_non_space_ghost str (to_rep ptr__pointer_value) max1))))
...
(assert
  (and
    (last_number_ghost__function_guard
      (last_number_ghost
        (let ((temp___512 (of_array (to_array str) fst_num1 max1)))
          (of_array
            (to_array temp___512)
            (first temp___512)
            (last temp___512))))
    ...
    (and
      ...
      (and
        (forall ((first_exp Int))
          (scan_exponent_ghost__function_guard
            (scan_exponent_ghost
              (let ((temp___497 (of_array (to_array str) first_exp max1)))
                (of_array
                  (to_array temp___497)
                  (first temp___497)
                  (last temp___497)))
            ...
            (scan_exponent_ghost__function_guard
              ...
              (let ((temp___497 (of_array (to_array str) first_exp max1)))
                (of_array
                  ...
                  (last temp___497)))
              (of_int1 0)))
          (= (scan_raw_unsigned_ghost str fst_num1 max1) (let ((last_num_init 
                                                           (last_number_ghost
                                                             (let ((temp___512 
                                                               (of_array
                                                                 (to_array
    ...
    (ite (and
           (= (to_rep1
                (select (to_array str) (first_non_space_ghost
                                         ...
                                         (to_rep ptr__pointer_value)
                                         max1))) 45)
           (= (scan_raw_unsigned_ghost str fst_num1 max1) #x80000000))
      (= res2 (- 2147483648))
      (ite (= (to_rep1
                (select (to_array str) (first_non_space_ghost
                                         str
                                         (to_rep ptr__pointer_value)
                                         max1))) 45)
        (= res2 (- (bv2nat32 (scan_raw_unsigned_ghost str fst_num1 max1))))
        (= res2 (bv2nat32 (scan_raw_unsigned_ghost str fst_num1 max1)))))))
