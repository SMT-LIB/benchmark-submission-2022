...
(declare-const ada___system__val_int__impl__slide_to_1__result us_t)

;; H
(assert
  (= ada___system__val_int__impl__slide_to_1__result (of_array
                                                       (to_array
                                                         (of_array
                                                           (slide
                                                             (to_array str)
  ...
  (=>
    (forall ((j Int))
      (=>
        ...
        (= (to_rep
             (select (to_array
                       ada___system__val_int__impl__slide_to_1__result) (+ (- j 
             (first
               str)) 1))) 32)))
    (=>
      (only_space_ghost__function_guard
