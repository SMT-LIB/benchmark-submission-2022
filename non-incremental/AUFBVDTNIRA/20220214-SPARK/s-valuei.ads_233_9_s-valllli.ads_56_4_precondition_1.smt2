...
;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_217 (_ BitVec 128)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
             ...
             (and
               (and
                 (and
                   ...
                   (dynamic_invariant3 from true true true true))
                 (dynamic_invariant3 to__ true true true true))
               (and
                 (and
        ...
        (! (=>
             ...
             (and
               (forall ((str2 us_t) (from1 Int))
                 (hexa_to_unsigned_ghost__function_guard
                   (hexa_to_unsigned_ghost
                     (to_rep (select (to_array str2) from1)))
                   (to_rep (select (to_array str2) from1))))
               (and
                 (forall ((str2 us_t) (from1 Int))
                   (hexa_to_unsigned_ghost__function_guard
      ...
      (! (=>
           (and
             ...
             (and
               ...
               (let ((temp___564 (to_rep (select (to_array str1) from))))
...
;; H
(assert
  (ite (= temp___833 43) (= o true) (= o (ite (= temp___833 45) true false))))
...
;; Goal def'vc
;; File "s-valuei.ads", line 224, characters 0-0
(assert
  (not
  (=>
    (uns_is_valid_int__function_guard
    ...
    (= (uns_is_valid_int
         (ite (= (to_rep
           ...
           true
           false)
         (scan_raw_unsigned_ghost str fst_num (last str))) true))))
