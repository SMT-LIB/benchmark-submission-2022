...
;; bool_eq
(define-fun bool_eq6 ((x Bool) (y Bool)) Bool
  (ite (= x y) true false))
...
;; of_int
(declare-fun of_int1 (Int) (_ BitVec 32))
...
(assert
  (forall ((x (_ BitVec 32)) (i Int))
    (=> (and (<= 0 i) (< i 4294967296)) (= (nth_bv x (of_int1 i)) (nth x i)))))
  ...
  (forall ((x Int))
    (! (=>
         ...
         (= (hexa_to_unsigned_ghost x) (ite (and (<= 48 x) (<= x 57))
                                         (bvsub (of_int1 x) #x00000030)
                                         (ite (and (<= 97 x) (<= x 102))
                                           (bvadd (bvsub (of_int1 x) #x00000061) #x0000000A)
                                           (ite (and (<= 65 x) (<= x 70))
                                             (bvadd (bvsub (of_int1 x) #x00000041) #x0000000A)
      ...
      (forall ((val__ Int))
        (! (=
             ...
             (ite (and (= minus true) (= uval #x80000000))
               ...
               (ite (= minus true)
                 (= val__ (- (bv2nat32 uval)))
                 (= val__ (bv2nat32 uval))))) :pattern ((is_int_of_uns
                                                          minus
                                                          uval
                                                          val__)) )))))
                                          ...
                                          (and
                                            ...
                                            (= (is_value_integer_ghost
                                                 (slide_if_necessary
                                                   temp___compl_840)
                                                 temp___841) true)))
                                        (= ada___system__val_int__impl__value_integer__result temp___841))))))
                              (and
                                                    ...
                                                    (and
                                                      ...
                                                      (not
                                                        (= (to_rep1
                                                             (select 
                                                             (to_array
                                                               o4) ada___system__val_int__impl__value_integer__B_2__non_blank__assume)) 32)))
                                                    (= (only_space_ghost
                                                         o4
                                                         o3
