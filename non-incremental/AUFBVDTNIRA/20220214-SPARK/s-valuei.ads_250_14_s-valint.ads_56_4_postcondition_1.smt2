...
(declare-const ada___system__val_int__impl__value_integer__result Int)
      ...
      (and
        (forall ((temp___compl_839 us_t) (temp___840 Int))
          (is_value_integer_ghost__function_guard
            ...
            temp___840))
        (and
          (forall ((o2 Int) (o3 us_t) (ada___system__val_int__impl__value_integer__B_2__non_blank__assume Int))
            (only_space_ghost__function_guard
              (only_space_ghost
                o3
                o2
                (- ada___system__val_int__impl__value_integer__B_2__non_blank__assume 1))
              o3
              o2
              (- ada___system__val_int__impl__value_integer__B_2__non_blank__assume 1)))
          (and
            ...
            (and
              (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                (scan_raw_unsigned_ghost__function_guard
                  ...
                  o2))
              (and
                (forall ((o2 us_t) (non_blank1 Int) (uval (_ BitVec 32)))
                  (is_int_of_uns__function_guard
                    (is_int_of_uns
                      (bool_eq5
                      ...
                      uval
                      v1)
                    (bool_eq5 (to_rep1 (select (to_array o2) non_blank1)) 45)
                    uval
                    v1))
                (and
                  (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= (is_value_integer_ghost
                                       (slide_if_necessary temp___compl_839)
                                       temp___840) true)))
                              (= ada___system__val_int__impl__value_integer__result temp___840))))))
                    (and
                      ...
                      (and
                        ...
                        (and
                          ...
                          (let ((o2 (last str)))
                            (let ((o3 (first str)))
                              (let ((o4 str))
                                (let ((ada___system__val_int__impl__value_integer__B_2__non_blank__assume 
                                  (first_non_space_ghost
                                    o4
                                    o3
                                    o2)))
                                  (and
                                    (and
                                      (first_non_space_ghost__function_guard
                                        ada___system__val_int__impl__value_integer__B_2__non_blank__assume
                                        o4
                                        o3
                                        o2)
                                      (and
                                        ...
                                        (and
                                          (and
                                            (and
                                              (<= o3 ada___system__val_int__impl__value_integer__B_2__non_blank__assume)
                                              (<= ada___system__val_int__impl__value_integer__B_2__non_blank__assume o2))
                                            (not
                                              (= (to_rep1
                                                   (select (to_array o4) ada___system__val_int__impl__value_integer__B_2__non_blank__assume)) 32)))
                                          (= (only_space_ghost
                                               o4
                                               o3
                                               (- ada___system__val_int__impl__value_integer__B_2__non_blank__assume 1)) true))))
                                    (and
                                      (= ada___system__val_int__impl__value_integer__B_2__non_blank__assume 
                                      non_blank)
                                      (and
                                        ...
                                        (and
                                          (and
                                            ...
                                            (ite (= o1 true)
                                              (let ((o5 (+ non_blank 1)))
                                                (and
                                                  (= ada___system__val_int__impl__value_integer__B_2__fst_num__assume o5)
                                                  (in_range o5)))
                                                      ...
                                                      (and
                                                        (and
                                                          (not
                                                            (= (rec__ada___system__val_int__impl__T5s__is_null_pointer
                                                                 usf) true))
                                                          (= false (rec__ada___system__val_int__impl__T5s__is_null_pointer
                                                                    usf)))
                                                        (and
                                                              ...
                                                              (let ((o5 
                                                                ...
                                                                (let ((o6 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    p1)
                                                                    (= 
                                                                    ada___system__val_int__impl__value_integer__result 
                                                                    v1))))))))))))))))))))))))))))))))))))))
  ...
  (=>
    ...
    (=>
      ...
      (=>
        ...
        (= (is_value_integer_ghost
             (slide_if_necessary str)
             ada___system__val_int__impl__value_integer__result) true))))))
