                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= (is_value_integer_ghost
                                       (slide_if_necessary temp___compl_839)
                                       temp___840) true)))
                              (= ada___system__val_lli__impl__value_integer__result temp___840))))))
                    (and
                                      ...
                                      (and
                                        ...
                                        (and
                                          (and
                                            ...
                                            (not
                                              (= (to_rep1
                                                   (select (to_array o4) ada___system__val_lli__impl__value_integer__B_2__non_blank__assume)) 32)))
                                          (= (only_space_ghost
                                               o4
                                               o3
                                                      ...
                                                      (and
                                                        (and
                                                          (not
                                                            (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer
                                                                 usf) true))
                                                          (= false (rec__ada___system__val_lli__impl__T5s__is_null_pointer
                                                                    usf)))
                                                        (and
  ...
  (=>
    ...
    (=>
      ...
      (=>
        ...
        (= (is_value_integer_ghost
             (slide_if_necessary str)
             ada___system__val_lli__impl__value_integer__result) true))))))
