...
(declare-datatypes ((us_rep 0))
  (((us_repqtmk
    (rec__ada___system__val_lli__impl__T5s__is_null_pointer Bool)(rec__ada___system__val_lli__impl__T5s__is_moved_pointer Bool)(rec__ada___system__val_lli__impl__T5s__pointer_value integer)))))

;; __rep_rec__ada___system__val_lli__impl__T5s__is_null_pointer__projection
(define-fun us_rep_rec__ada___system__val_lli__impl__T5s__is_null_pointer__projection 
  ((a us_rep)) Bool
  (rec__ada___system__val_lli__impl__T5s__is_null_pointer a))

;; __rep_rec__ada___system__val_lli__impl__T5s__is_moved_pointer__projection
(define-fun us_rep_rec__ada___system__val_lli__impl__T5s__is_moved_pointer__projection 
  ((a us_rep)) Bool
  (rec__ada___system__val_lli__impl__T5s__is_moved_pointer a))

;; __rep_rec__ada___system__val_lli__impl__T5s__pointer_value__projection
(define-fun us_rep_rec__ada___system__val_lli__impl__T5s__pointer_value__projection 
  ((a us_rep)) integer
  (rec__ada___system__val_lli__impl__T5s__pointer_value a))
...
(define-fun bool_eq9 ((a us_rep) (b us_rep)) Bool
  (ite (and
         (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer a) 
         (rec__ada___system__val_lli__impl__T5s__is_null_pointer
           b))
         (=>
           (not
             (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer a) true))
           (= (rec__ada___system__val_lli__impl__T5s__pointer_value a) 
           (rec__ada___system__val_lli__impl__T5s__pointer_value
             b))))
    true
    false))

;; rec__ada___system__val_lli__impl__T5s__pointer_value__pred
(define-fun rec__ada___system__val_lli__impl__T5s__pointer_value__pred 
  ((a us_rep)) Bool
  (not (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer a) true)))

(declare-const us_null_pointer us_rep)

;; __null_pointer__def_axiom
(assert
  (= (rec__ada___system__val_lli__impl__T5s__is_null_pointer us_null_pointer) true))
...
;; bool_eq
(define-fun bool_eq11 ((x (_ BitVec 64)) (y (_ BitVec 64))) Bool
  (ite (= x y) true false))
...
(declare-const dummy8 long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_217 (_ BitVec 64)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_224 (_ BitVec 64)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool
  true)
...
;; to_rep
(declare-fun to_rep2 (long_long_unsigned1) (_ BitVec 64))

;; of_rep
(declare-fun of_rep2 ((_ BitVec 64)) long_long_unsigned1)

;; inversion_axiom
(assert
  (forall ((x long_long_unsigned1))
...
;; to_int
(define-fun to_int3 ((x long_long_unsigned1)) Int
  (bv2nat64 (to_rep2 x)))
...
(declare-datatypes ((us_split_fields 0))
  (((us_split_fieldsqtmk
    (rec__ada___system__val_llu__impl__uns_option__value long_long_unsigned1)))))
...
(define-fun us_split_fields_rec__ada___system__val_llu__impl__uns_option__value__projection 
  ((a us_split_fields)) long_long_unsigned1
...
(define-fun default_initial_assumption ((temp___expr_233 us_rep1) (temp___skip_top_level_234 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_llu__impl__uns_option__value__pred temp___expr_233)
      (= (to_rep2
           (rec__ada___system__val_llu__impl__uns_option__value
             (us_split_fields1 temp___expr_233))) #x0000000000000000))))
  ...
  (forall ((x Int))
    (! (=>
         ...
         (= (hexa_to_unsigned_ghost x) (ite (and (<= 48 x) (<= x 57))
                                         (bvsub (of_int1 x) #x0000000000000030)
                                         (ite (and (<= 97 x) (<= x 102))
                                           (bvadd (bvsub (of_int1 x) #x0000000000000061) #x000000000000000A)
                                           (ite (and (<= 65 x) (<= x 70))
                                             (bvadd (bvsub (of_int1 x) #x0000000000000041) #x000000000000000A)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___474 (to_rep2
                                                                   (rec__ada___system__val_llu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x0000000000000002 temp___474)
                                                        true
                                                        false) (ite (bvule temp___474 #x0000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
...
(declare-const ada___system__val_lli__impl__value_integer__result Int)
...
(declare-const ada___system__val_lli__impl__value_integer__B_2__fst_num__assume Int)
      ...
      (and
        (forall ((temp___compl_840 us_t) (temp___841 Int))
          (is_value_integer_ghost__function_guard
            ...
            temp___841))
        (and
          (forall ((o2 Int) (o3 us_t) (ada___system__val_lli__impl__value_integer__B_2__non_blank__assume Int))
            (only_space_ghost__function_guard
              (only_space_ghost
                o3
                o2
                (- ada___system__val_lli__impl__value_integer__B_2__non_blank__assume 1))
              o3
              o2
              (- ada___system__val_lli__impl__value_integer__B_2__non_blank__assume 1)))
          (and
              ...
              (and
                (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                  (scan_raw_unsigned_ghost__function_guard
                    ...
                    o2))
                (and
                  (forall ((o2 us_t) (non_blank1 Int) (uval (_ BitVec 64)))
                    (is_int_of_uns__function_guard
                      (is_int_of_uns
                        (bool_eq6
                                          ...
                                          (and
                                            ...
                                            (= (is_value_integer_ghost
                                                 (slide_if_necessary
                                                   temp___compl_840)
                                                 temp___841) true)))
                                        (= ada___system__val_lli__impl__value_integer__result temp___841))))))
                              (and
                                ...
                                (and
                                  ...
                                  (and
                                    ...
                                    (let ((o2 (last str)))
                                      (let ((o3 (first str)))
                                        (let ((o4 str))
                                          (let ((ada___system__val_lli__impl__value_integer__B_2__non_blank__assume 
                                            (first_non_space_ghost
                                              o4
                                              o3
                                              o2)))
                                            (and
                                              (and
                                                (first_non_space_ghost__function_guard
                                                  ada___system__val_lli__impl__value_integer__B_2__non_blank__assume
                                                  o4
                                                  o3
                                                  o2)
                                                (and
                                                  ...
                                                  (and
                                                    (and
                                                      (and
                                                        (<= o3 ada___system__val_lli__impl__value_integer__B_2__non_blank__assume)
                                                        (<= ada___system__val_lli__impl__value_integer__B_2__non_blank__assume o2))
                                                      (not
                                                        (= (to_rep1
                                                             (select 
                                                             (to_array
                                                               o4) ada___system__val_lli__impl__value_integer__B_2__non_blank__assume)) 32)))
                                                    (= (only_space_ghost
                                                         o4
                                                         o3
                                                         (- ada___system__val_lli__impl__value_integer__B_2__non_blank__assume 1)) true))))
                                              (and
                                                (= ada___system__val_lli__impl__value_integer__B_2__non_blank__assume 
                                                non_blank)
                                                (and
                                                    ...
                                                    (and
                                                      ...
                                                      (ite (= o1 true)
                                                        (let ((o5 (+ 
                                                          non_blank 1)))
                                                          (and
                                                            (= ada___system__val_lli__impl__value_integer__B_2__fst_num__assume o5)
                                                            (in_range o5)))
                                                        (= ada___system__val_lli__impl__value_integer__B_2__fst_num__assume 
                                                        non_blank)))
                                                    (and
                                                      (= ada___system__val_lli__impl__value_integer__B_2__fst_num__assume 
                                                      fst_num)
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    v1) true)
                                                                    (= 
                                                                    ada___system__val_lli__impl__value_integer__result 
                                                                    v1))))))))))))))))))))))))))))))))))))))))))))))
