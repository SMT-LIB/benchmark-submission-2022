...
(define-fun uc_to_int ((x (_ BitVec 128))) Int
  (ite (= (bool_lt1 x ((_ int2bv 128) two_power_size_minus_one)) true)
    (bv2nat x)
    (- (bv2nat (bvneg x)))))
...
;; bool_eq
(define-fun bool_eq12 ((x Bool) (y Bool)) Bool
  (ite (= x y) true false))
...
(assert
  (and
    (forall ((temp___compl_839 us_t))
      (slide_if_necessary__function_guard
        (slide_if_necessary temp___compl_839)
        temp___compl_839))
    (and
      (forall ((temp___compl_839 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_839))
      (and
        (forall ((temp___compl_839 us_t) (temp___840 Int))
          (is_value_integer_ghost__function_guard
            (is_value_integer_ghost
              (slide_if_necessary temp___compl_839)
              temp___840)
                ...
                (forall ((o2 us_t) (non_blank1 Int) (uval (_ BitVec 128)))
                  (is_int_of_uns__function_guard
                    (is_int_of_uns
                      ...
                      uval
                      v1)
                    (bool_eq6 (to_rep1 (select (to_array o2) non_blank1)) 45)
                    uval
                    v1))
                (and
                  (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                  ...
                  (ite (= spark__branch true)
                    (and
                      ...
                      (let ((temp___837 (of_array
                                          ...
                                          1
                                          (length str))))
                        (let ((temp___compl_839 (of_array
                                                  (to_array temp___837)
                                                  (first temp___837)
                                                  (last temp___837))))
                          (let ((temp___840 (value_integer temp___compl_839)))
                            (and
                              (and
                                (value_integer__function_guard
                                  temp___840
                                ...
                                (and
                                  ...
                                  (= (is_value_integer_ghost
                                       (slide_if_necessary temp___compl_839)
                                       temp___840) true)))
                              (= ada___system__val_llli__impl__value_integer__result temp___840))))))
                    (and
                                      ...
                                      (and
                                        ...
                                        (and
                                          (and
                                            ...
                                            (not
                                              (= (to_rep1
                                                   (select (to_array o4) ada___system__val_llli__impl__value_integer__B_2__non_blank__assume)) 32)))
                                          (= (only_space_ghost
                                               o4
                                               o3
                                          ...
                                          (and
                                            (and
                                              ...
                                              (and
                                                (= (to_rep1
                                                     (select (to_array str) 
                                                     non_blank)) temp___844)
                                                (ite (= temp___844 43)
                                                  (= o1 true)
                                                  (= o1 (ite (= temp___844 45)
                                                          true
                                                          false)))))
                                            (ite (= o1 true)
                                              (let ((o5 (+ non_blank 1)))
                                                      ...
                                                      (and
                                                        (and
                                                          (not
                                                            (= (rec__ada___system__val_llli__impl__T5s__is_null_pointer
                                                                 usf) true))
                                                          (= false (rec__ada___system__val_llli__impl__T5s__is_null_pointer
                                                                    usf)))
                                                        (and
