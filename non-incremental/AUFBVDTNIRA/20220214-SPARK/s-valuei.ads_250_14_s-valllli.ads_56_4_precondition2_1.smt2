...
;; user_eq
(declare-fun user_eq1 (long_long_long_integer
  long_long_long_integer) Bool)

(declare-const dummy1 long_long_long_integer)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool
  (=>
    (or
      (= temp___is_init_35 true)
      (<= (- 170141183460469231731687303715884105728) 170141183460469231731687303715884105727))
    (in_range1 temp___expr_39)))
      ...
      (! (and
           ...
           (=>
             (and
               (and
                 (and
                   (dynamic_invariant3 s true true true true)
...
;; bool_eq
(define-fun bool_eq7 ((x Bool) (y Bool)) Bool
  (ite (= x y) true false))
    ...
    (forall ((from Int) (to__ Int))
      (! (=>
           (and
             (and
               (and
                 (dynamic_invariant3 str true true true true)
                 (dynamic_invariant from true true true true))
               (dynamic_invariant to__ true true true true))
             (and
               (and
               ...
               (let ((temp___564 (to_rep1 (select (to_array str) from))))
...
(define-fun uc_to_int ((x (_ BitVec 128))) Int
  (ite (= (bool_lt1 x (of_int1 two_power_size_minus_one)) true)
    (bv2nat128 x)
    (- (bv2nat128 (bvneg x)))))
...
(declare-datatypes ((us_rep 0))
  (((us_repqtmk
    (rec__ada___system__val_llli__impl__T5s__is_null_pointer Bool)(rec__ada___system__val_llli__impl__T5s__is_moved_pointer Bool)(rec__ada___system__val_llli__impl__T5s__pointer_value integer)))))

;; __rep_rec__ada___system__val_llli__impl__T5s__is_null_pointer__projection
(define-fun us_rep_rec__ada___system__val_llli__impl__T5s__is_null_pointer__projection 
  ((a us_rep)) Bool
  (rec__ada___system__val_llli__impl__T5s__is_null_pointer a))

;; __rep_rec__ada___system__val_llli__impl__T5s__is_moved_pointer__projection
(define-fun us_rep_rec__ada___system__val_llli__impl__T5s__is_moved_pointer__projection 
  ((a us_rep)) Bool
  (rec__ada___system__val_llli__impl__T5s__is_moved_pointer a))

;; __rep_rec__ada___system__val_llli__impl__T5s__pointer_value__projection
(define-fun us_rep_rec__ada___system__val_llli__impl__T5s__pointer_value__projection 
  ((a us_rep)) integer
  (rec__ada___system__val_llli__impl__T5s__pointer_value a))
...
(define-fun bool_eq9 ((a us_rep) (b us_rep)) Bool
  (ite (and
         (= (rec__ada___system__val_llli__impl__T5s__is_null_pointer a) 
         (rec__ada___system__val_llli__impl__T5s__is_null_pointer
           b))
         (=>
           (not
             (= (rec__ada___system__val_llli__impl__T5s__is_null_pointer a) true))
           (= (rec__ada___system__val_llli__impl__T5s__pointer_value a) 
           (rec__ada___system__val_llli__impl__T5s__pointer_value
             b))))
    true
    false))

;; rec__ada___system__val_llli__impl__T5s__pointer_value__pred
(define-fun rec__ada___system__val_llli__impl__T5s__pointer_value__pred 
  ((a us_rep)) Bool
  (not (= (rec__ada___system__val_llli__impl__T5s__is_null_pointer a) true)))
               ...
               (forall ((str1 us_t) (val__1 Int) (non_blank Int) (uval (_ BitVec 128)))
                 (is_int_of_uns__function_guard
                   (is_int_of_uns
                     ...
                     uval
                     val__1)
                   (bool_eq6 (to_rep1 (select (to_array str1) non_blank)) 45)
                   uval
                   val__1))
               (=
...
(declare-datatypes ((t54s__ref 0))
  (((t54s__refqtmk (t54s__content us_rep)))))

;; t54s__ref_t54s__content__projection
(define-fun t54s__ref_t54s__content__projection ((a t54s__ref)) us_rep
  (t54s__content a))
...
(declare-datatypes ((t53s__ref 0))
  (((t53s__refqtmk (t53s__content us_t)))))

;; t53s__ref_t53s__content__projection
(define-fun t53s__ref_t53s__content__projection ((a t53s__ref)) us_t
  (t53s__content a))
...
(declare-const dummy8 long_long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_217 (_ BitVec 128)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool
  true)
...
;; bool_eq
(define-fun bool_eq12 ((x (_ BitVec 128)) (y (_ BitVec 128))) Bool
  (ite (= x y) true false))

;; attr__ATTRIBUTE_IMAGE
(declare-fun attr__ATTRIBUTE_IMAGE7 ((_ BitVec 128)) us_image)

;; attr__ATTRIBUTE_VALUE__pre_check
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)

;; attr__ATTRIBUTE_VALUE
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) (_ BitVec 128))

;; user_eq
(declare-fun user_eq7 (long_long_long_unsigned1
...
;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_224 (_ BitVec 128)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool
  true)
...
(assert
  (forall ((str1 us_t))
    (! (=>
         (and
           (dynamic_invariant3 str1 true true true true)
           (and
             (not
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (and
             ...
             (let ((minus_sign (bool_eq6
                                 (to_rep1
                                   (select (to_array str1) (+ (first str1) 1)))
                                 45)))
               (let ((sign (or (bool_eq6
                                 (to_rep1
                                   (select (to_array str1) (+ (first str1) 1)))
                                 43) minus_sign)))
                 (and
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 ...
                 start
                 0))
             (= (scan_exponent_ghost str1 real__) (let ((plus_sign (bool_eq6
                                                                    (to_rep1
                                                                    (select 
                                                                    (to_array
                                                                    str1) (+ 
...
;; to_rep
(declare-fun to_rep2 (long_long_long_unsigned1) (_ BitVec 128))

;; of_rep
(declare-fun of_rep2 ((_ BitVec 128)) long_long_long_unsigned1)

;; inversion_axiom
(assert
  (forall ((x long_long_long_unsigned1))
...
;; to_int
(define-fun to_int3 ((x long_long_long_unsigned1)) Int
  (bv2nat128 (to_rep2 x)))
...
(declare-datatypes ((us_split_fields 0))
  (((us_split_fieldsqtmk
    (rec__ada___system__val_lllu__impl__uns_option__value long_long_long_unsigned1)))))
...
(define-fun us_split_fields_rec__ada___system__val_lllu__impl__uns_option__value__projection 
  ((a us_split_fields)) long_long_long_unsigned1
...
;; bool_eq
(define-fun bool_eq13 ((a us_rep1) (b us_rep1)) Bool
  (ite (and
         (= (to_int1
              (rec__ada___system__val_lllu__impl__uns_option__overflow
...
(define-fun default_initial_assumption ((temp___expr_233 us_rep1) (temp___skip_top_level_234 Bool)) Bool
  (and
    ...
    (=>
      (ada___system__val_lllu__impl__uns_option__value__pred temp___expr_233)
      (= (to_rep2
           (rec__ada___system__val_lllu__impl__uns_option__value
             (us_split_fields1 temp___expr_233))) #x00000000000000000000000000000000))))
...
(assert
  (forall ((x Int))
    (! (=>
         (and
           (dynamic_invariant5 x true true true true)
           (or
             (and (<= 48 x) (<= x 57))
  ...
  (forall ((x Int))
    (! (=>
         ...
         (= (hexa_to_unsigned_ghost x) (ite (and (<= 48 x) (<= x 57))
                                         (bvsub (of_int1 x) #x00000000000000000000000000000030)
                                         (ite (and (<= 97 x) (<= x 102))
                                           (bvadd (bvsub (of_int1 x) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                                           (ite (and (<= 65 x) (<= x 70))
                                             (bvadd (bvsub (of_int1 x) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                                             (to_rep2 dummy9)))))) :pattern (
    (hexa_to_unsigned_ghost
      x)) )))
               ...
               (and
                 (and
                   (and
                     ...
                     (dynamic_invariant from true true true true))
                   (dynamic_invariant to__ true true true true))
                 (dynamic_invariant7 base true true true true))
               (dynamic_invariant7 acc true true true true))
             (and
  ...
  (forall ((value (_ BitVec 128)) (base (_ BitVec 128)))
    (forall ((exp1 Int))
      (! (=>
           (and
             (and
               (dynamic_invariant7 value true true true true)
                                     ...
                                     (and
                                       ...
                                       (= (not (let ((temp___474 (to_rep2
                                                                   (rec__ada___system__val_lllu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                 (and (ite (bvule #x00000000000000000000000000000002 temp___474)
                                                        true
                                                        false) (ite (bvule temp___474 #x00000000000000000000000000000010)
                                                                 true
                                                                 false)))) true)))
                                   (and
                                     (= starts_as_based true)
      ...
      (forall ((val__ Int))
        (! (=
             ...
             (ite (and
               ...
               (ite (= minus true)
                 (= val__ (- (bv2nat128 uval)))
                 (= val__ (bv2nat128 uval))))) :pattern ((is_int_of_uns
                                                           minus
                                                           uval
                                                           val__)) )))))
...
;; dynamic_invariant
(define-fun dynamic_invariant8 ((temp___expr_612 us_t) (temp___is_init_608 Bool) (temp___skip_constant_609 Bool) (temp___do_toplevel_610 Bool) (temp___do_typ_inv_611 Bool)) Bool
  (=>
...
;; dynamic_invariant
(define-fun dynamic_invariant9 ((temp___expr_765 us_t) (temp___is_init_761 Bool) (temp___skip_constant_762 Bool) (temp___do_toplevel_763 Bool) (temp___do_typ_inv_764 Bool)) Bool
  (=>
...
;; Assume
(assert (dynamic_invariant3 str true false true true))
...
(declare-const ada___system__val_llli__impl__value_integer__result Int)
...
(declare-const ada___system__val_llli__impl__value_integer__B_2__fst_num__assume Int)
...
(assert
  (and
    (forall ((temp___compl_840 us_t))
      (slide_if_necessary__function_guard
        (slide_if_necessary temp___compl_840)
        temp___compl_840))
    (and
      (forall ((temp___compl_840 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_840))
      (and
        (forall ((temp___compl_840 us_t) (temp___841 Int))
          (is_value_integer_ghost__function_guard
            (is_value_integer_ghost
              (slide_if_necessary temp___compl_840)
              temp___841)
            ...
            temp___841))
        (and
          (forall ((o2 Int) (o3 us_t) (ada___system__val_llli__impl__value_integer__B_2__non_blank__assume Int))
            (only_space_ghost__function_guard
              (only_space_ghost
                o3
                o2
                (- ada___system__val_llli__impl__value_integer__B_2__non_blank__assume 1))
              o3
              o2
              (- ada___system__val_llli__impl__value_integer__B_2__non_blank__assume 1)))
          (and
              ...
              (is_raw_unsigned_format_ghost
                (let ((temp___846 (of_array
                  ...
                  (of_array
                    ...
                    (first temp___846)
                    (last temp___846))))
              (let ((temp___846 (of_array (to_array str) fst_num (last str))))
                (of_array
                  (to_array temp___846)
                  (first temp___846)
                  (last temp___846))))
              ...
              (and
                (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                  (scan_raw_unsigned_ghost__function_guard
                    ...
                    o2))
                (and
                  (forall ((o2 us_t) (non_blank1 Int) (uval (_ BitVec 128)))
                    (is_int_of_uns__function_guard
                      (is_int_of_uns
                        (bool_eq6
                          (to_rep1 (select (to_array o2) non_blank1))
                          45)
                        uval
                        v1)
                      (bool_eq6
                  ...
                  (and
                    ...
                    (and
                      (raw_unsigned_last_ghost__function_guard
                        (raw_unsigned_last_ghost str fst_num (last str))
                        str
                        fst_num
                        (last str))
                      (and
                            ...
                            (ite (= spark__branch true)
                              (and
                                ...
                                (let ((temp___838 (of_array
                                                    ...
                                                    1
                                                    (length str))))
                                  (let ((temp___compl_840 (of_array
                                                            (to_array
                                                              temp___838)
                                                            (first
                                                              temp___838)
                                                            (last temp___838))))
                                    (let ((temp___841 (value_integer
                                                        temp___compl_840)))
                                      (and
                                        (and
                                          (value_integer__function_guard
                                          ...
                                          (and
                                            ...
                                            (= (is_value_integer_ghost
                                                 (slide_if_necessary
                                                   temp___compl_840)
                                                 temp___841) true)))
                                        (= ada___system__val_llli__impl__value_integer__result temp___841))))))
                              (and
                                ...
                                (and
                                  ...
                                  (and
                                    ...
                                    (let ((o2 (last str)))
                                      (let ((o3 (first str)))
                                        (let ((o4 str))
                                          (let ((ada___system__val_llli__impl__value_integer__B_2__non_blank__assume 
                                            (first_non_space_ghost
                                              o4
                                              o3
                                              o2)))
                                            (and
                                              (and
                                                (first_non_space_ghost__function_guard
                                                  ada___system__val_llli__impl__value_integer__B_2__non_blank__assume
                                                  o4
                                                  o3
                                                  o2)
                                                (and
                                                  ...
                                                  (and
                                                    (and
                                                      (and
                                                        (<= o3 ada___system__val_llli__impl__value_integer__B_2__non_blank__assume)
                                                        (<= ada___system__val_llli__impl__value_integer__B_2__non_blank__assume o2))
                                                      (not
                                                        (= (to_rep1
                                                             (select 
                                                             (to_array
                                                               o4) ada___system__val_llli__impl__value_integer__B_2__non_blank__assume)) 32)))
                                                    (= (only_space_ghost
                                                         o4
                                                         o3
                                                         (- ada___system__val_llli__impl__value_integer__B_2__non_blank__assume 1)) true))))
                                              (and
                                                (= ada___system__val_llli__impl__value_integer__B_2__non_blank__assume 
                                                non_blank)
                                                (and
                                                    ...
                                                    (and
                                                      ...
                                                      (ite (= o1 true)
                                                        (let ((o5 (+ 
                                                          non_blank 1)))
                                                          (and
                                                            (= ada___system__val_llli__impl__value_integer__B_2__fst_num__assume o5)
                                                            (in_range o5)))
                                                        (= ada___system__val_llli__impl__value_integer__B_2__fst_num__assume 
                                                        non_blank)))
                                                    (and
                                                      (= ada___system__val_llli__impl__value_integer__B_2__fst_num__assume 
                                                      fst_num)
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    v1) true)
                                                                    (= 
                                                                    ada___system__val_llli__impl__value_integer__result 
                                                                    v1))))))))))))))))))))))))))))))))))))))))))))))

;; H
(assert (slide_if_necessary__function_guard (slide_if_necessary str) str))

;; H
(assert (dynamic_invariant3 (slide_if_necessary str) true false true true))

;; H
(assert
  (and
    (slide_to_1__function_guard (slide_to_1 str) str)
    (= (slide_if_necessary str) (ite (= (last str) 2147483647)
                                  (slide_to_1 str)
                                  str))))
  ...
  (and
    ...
    (and
      (only_space_ghost__function_guard
        (only_space_ghost
          (slide_if_necessary str)
          (first (slide_if_necessary str))
          (last (slide_if_necessary str)))
        (slide_if_necessary str)
        (first (slide_if_necessary str))
        (last (slide_if_necessary str)))
      (=
        ...
        (= (only_space_ghost
             (slide_if_necessary str)
             (first (slide_if_necessary str))
             (last (slide_if_necessary str))) true)))))

;; Goal def'vc
;; File "s-valuei.ads", line 245, characters 0-0
(assert
  (not (not (= (last (slide_if_necessary str)) 2147483647))))
