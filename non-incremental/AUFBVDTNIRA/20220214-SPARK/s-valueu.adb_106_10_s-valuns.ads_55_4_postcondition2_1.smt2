...
(declare-const old_acc (_ BitVec 32))
    ...
    (and
      (and
        (and
          ...
          (and (bvule #x00000002 base) (bvule base #x00000010)))
        (=>
          (and (bvult digit base) (bvule old_acc (bvudiv #xFFFFFFFF base)))
          (= acc (bvadd (bvmul base old_acc) digit))))
      (ite (or
             (or (bvuge digit base) (bvugt old_acc (bvudiv #xFFFFFFFF base)))
             (and
               (bvugt old_acc (bvudiv (bvadd (bvsub #xFFFFFFFF base) #x00000001) 
               base))
               (bvult acc (bvudiv #xFFFFFFFF base))))
        (= overflow true)
...
(assert
  (or
    ...
    (exists ((spark__branch1 Bool))
      (and
        (= spark__branch1 (ite (bvule old_acc (bvudiv (bvadd (bvsub #xFFFFFFFF 
                            base) #x00000001) base))
                            true
                            false))
        (ite (= spark__branch1 true)
          ...
          (exists ((spark__branch2 Bool))
            (and
              (= spark__branch2 (ite (bvugt old_acc (bvudiv #xFFFFFFFF 
                                  base))
                                  true
                                  false))
              (or
