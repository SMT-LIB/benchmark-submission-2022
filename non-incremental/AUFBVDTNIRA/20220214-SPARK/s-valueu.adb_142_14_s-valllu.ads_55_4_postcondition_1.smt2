...
(define-fun uc_to_int ((x (_ BitVec 64))) Int
  (ite (= (bool_lt x (of_int1 two_power_size_minus_one)) true)
    (bv2nat64 x)
    (- (bv2nat64 (bvneg x)))))
    ...
    (and
      (and
        ...
        (and
          (last_hexa_ghost__function_guard
            (last_hexa_ghost
              (let ((temp___1524 (of_array (to_array str) from to__)))
                (of_array
                  (to_array temp___1524)
                  (first temp___1524)
                  (last temp___1524))))
            (let ((temp___1524 (of_array (to_array str) from to__)))
              (of_array
          ...
          (and
            (last_number_ghost__function_guard
              (last_number_ghost
                (let ((temp___1529 (of_array (to_array str) from to__)))
                  (of_array
                    (to_array temp___1529)
                    (first temp___1529)
                    (last temp___1529))))
              (let ((temp___1529 (of_array (to_array str) from to__)))
                (of_array
            ...
            (ite (= ext true)
              (and
                (= (is_based_format_ghost
                     (let ((temp___1522 (of_array (to_array str) from to__)))
                       (of_array
                         (to_array temp___1522)
                         (first temp___1522)
                         (last temp___1522)))) true)
                (= lst (last_hexa_ghost
                         (let ((temp___1524 (of_array
                                              (to_array str)
                                              from
                                              to__)))
                           (of_array
              ...
              (and
                (= (is_natural_format_ghost
                     (let ((temp___1527 (of_array (to_array str) from to__)))
                       (of_array
                         (to_array temp___1527)
                         (first temp___1527)
                         (last temp___1527)))) true)
                (= lst (last_number_ghost
                         (let ((temp___1529 (of_array
                                              (to_array str)
                                              from
                                              to__)))
                           (of_array
