...
(assert
  ...
  (ite (and
    ...
    (bvsub ((_ int2bv 128) (to_rep (select (to_array str1) from))) #x00000000000000000000000000000030)
    (ite (and
           (<= 97 (to_rep (select (to_array str1) from)))
           (<= (to_rep (select (to_array str1) from)) 102))
      (bvadd (bvsub ((_ int2bv 128) (to_rep (select (to_array str1) from))) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
      (ite (and
             (<= 65 (to_rep (select (to_array str1) from)))
             (<= (to_rep (select (to_array str1) from)) 70))
        (bvadd (bvsub ((_ int2bv 128) (to_rep (select (to_array str1) from))) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
        (to_rep2 dummy4))))))
