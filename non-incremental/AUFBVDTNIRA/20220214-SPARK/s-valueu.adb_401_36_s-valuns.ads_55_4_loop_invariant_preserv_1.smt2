...
;; H
(assert
  (= uval1 (bvsub (of_int (to_rep1 (select (to_array str) p1))) #x00000030)))
...
(assert
  (=>
    ...
    (= (bool_eq9
         init_val
         (scan_based_number_ghost str p3 last_num_init #x0000000A uval2)) true)))
...
;; H
(assert
  (= digit2 (bvsub (of_int (to_rep1 (select (to_array str) p3))) #x00000030)))
...
;; H
(assert (= spark__branch1 (ite (bvugt digit2 #x00000009) true false)))

(declare-const old_uval3 (_ BitVec 32))
  ...
  (ite (= spark__branch1 true)
    ...
    (and
      ...
      (and
        ...
        (and
          (and
            (= spark__branch2 (ite (bvule uval2 #x19999998) true false))
            (ite (= spark__branch2 true)
              (and
                (= uval3 (bvadd (bvmul #x0000000A uval2) digit2))
                (= overflow2 overflow1))
              (and
                (= spark__branch3 (ite (bvugt uval2 #x19999999) true false))
                (ite (= spark__branch3 true)
                  (and (= overflow2 (of_int1 1)) (= uval3 uval2))
                  (and
                    (= uval3 (bvadd (bvmul #x0000000A uval2) digit2))
                    (and
                      (= spark__branch4 (ite (bvult uval3 #x19999999)
                                          true
                                          false))
