...
;; H
(assert
  (= digit2 (bvsub ((_ int2bv 64) (to_rep1 (select (to_array str) p3))) #x0000000000000030)))
...
;; H
(assert
  (= spark__branch2 (ite (bvugt digit2 #x0000000000000009) true false)))
    ...
    (and
      (and
        ...
        (and
          ...
          (and
            (and
              (= spark__branch3 (ite (bvule uval2 #x1999999999999998)
                                  true
                                  false))
              (ite (= spark__branch3 true)
                (and
                  ...
                  (= overflow2 overflow1))
                (and
                  (= spark__branch4 (ite (bvugt uval2 #x1999999999999999)
                                      true
                                      false))
                  (ite (= spark__branch4 true)
                    ...
                    (and
                      ...
                      digit2))
                      (and
                        (= spark__branch1 (ite (bvult uval3 #x1999999999999999)
                                            true
                                            false))
