...
;; H
(assert (= old_uval3 uval2))

(declare-const old_overflow Bool)

;; H
(assert (= old_overflow overflow1))
...
(assert
  (ite (= spark__branch2 true)
    (and
      (= uval3 (bvadd (bvmul #x0000000000000000000000000000000A uval2) 
      digit2))
      (= overflow2 overflow1))
    (and
...
(assert
  (not
  (let ((temp___723 (to_rep1 (select (to_array str) p3))))
    (or
      (and (<= 48 temp___723) (<= temp___723 57))
      (or
        (and (<= 97 temp___723) (<= temp___723 102))
        (and (<= 65 temp___723) (<= temp___723 70)))))))
