...
(assert
  (and
    ...
    (exists ((p4 Int) (uval3 (_ BitVec 128)) (overflow2 Bool) (digit1 (_ BitVec 128)) (old_uval2 (_ BitVec 128)))
      (and
        (and
        ...
        (and
          ...
          (ite (< max1 p4)
            (and (and (= p3 p4) (= uval2 uval3)) (= overflow1 overflow2))
            (and
              (and (<= (first str) p4) (<= p4 (last str)))
              (exists ((o5 Int))
                (and
                  (= (to_rep1 (select (to_array str) p4)) o5)
                  (exists ((digit2 (_ BitVec 128)))
                    (and
                      (= digit2 (bvsub (of_int o5) #x00000000000000000000000000000030))
                      (and
                        (and
                          (and
...
(assert
  ...
  (=>
    ...
    (= (to_rep2
         (rec__ada___system__val_lllu__impl__uns_option__value
           (us_split_fields1 init_val))) uval2))))
