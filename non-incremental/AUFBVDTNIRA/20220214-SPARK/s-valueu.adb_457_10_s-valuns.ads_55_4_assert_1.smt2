...
(assert
  (and
    ...
    (exists ((p4 Int) (uval3 (_ BitVec 32)) (overflow2 Bool) (digit1 (_ BitVec 32)) (old_uval2 (_ BitVec 32)))
      (and
        (and
            ...
            (and
              ...
              (exists ((o5 Int))
                (and
                  ...
                  (exists ((digit2 (_ BitVec 32)))
                    (and
                      (= digit2 (bvsub (of_int o5) #x00000030))
                      (and
                        (and
                          (and
                            (exists ((spark__branch1 Bool))
                              (and
                                (= spark__branch1 (ite (bvugt digit2 #x00000009)
                                                    true
                                                    false))
                                (and
                                  (= spark__branch1 true)
