        ...
        (and
          (and
            (and
              ...
              (exists ((temp___1190 Int))
                (and
                  (= (to_rep1 (select (to_array str) p2)) temp___1190)
                  (exists ((spark__branch2 Bool))
                    (and
                      (= spark__branch2 (and (ite (<= 48 temp___1190)
                                               true
                                               false) (ite (<= temp___1190 57)
                                                        true
                                                        false)))
                      (and
                        ...
                        (and
                          (and (<= (first str) p2) (<= p2 (last str)))
                          (exists ((temp___1189 Int))
                            (and
                              (= (to_rep1 (select (to_array str) p2)) temp___1189)
                              (exists ((spark__branch3 Bool))
                                (and
                                  (= spark__branch3 (and (ite (<= 65 temp___1189)
                                                           true
                                                           false) (ite (<= temp___1189 70)
                                                                    true
                                                                    false)))
                                  (and
                                        ...
                                        (and
                                          ...
                                          (exists ((spark__branch4 Bool))
                                            (and
                                              ...
                                              (ite (<= 97 temp___1187)
                                                true
                                                false) (ite (<= temp___1187 102)
                                                         true
                                                         false)))
                                              (not (= spark__branch4 true)))))))))))))))))))
            (= ptr__pointer_value3 ptr__pointer_value2))
          (= p3 p2))
        (= uval3 uval2))
      (= overflow3 overflow2))
    (and
      (forall ((o7 Int) (o8 Int) (o9 us_t))
        (last_hexa_ghost__function_guard
          (last_hexa_ghost
            (let ((temp___717 (of_array (to_array o9) o8 o7)))
              (of_array
                (to_array temp___717)
                (first temp___717)
                (last temp___717))))
          (let ((temp___717 (of_array (to_array o9) o8 o7)))
            (of_array
              ...
              (first temp___717)
              (last temp___717)))))
      (exists ((spark__branch2 Bool) (digit1 (_ BitVec 128)))
        (and
          (and
            (and (<= (first str) p2) (<= p2 (last str)))
            (exists ((temp___1190 Int))
              (and
                ...
                (exists ((spark__branch3 Bool))
                  (and
                    (= spark__branch3 (and (ite (<= 48 temp___1190)
                                             true
                                             false) (ite (<= temp___1190 57)
                                                      true
                                                      false)))
                        ...
                        (and
                          ...
                          (exists ((o7 Int))
                            (and
                              ...
                              (= digit1 (bvsub (of_int o7) #x00000000000000000000000000000030)))))
                      ...
                      (and
                        ...
                        (exists ((temp___1189 Int))
                          (and
                            ...
                            (exists ((spark__branch4 Bool))
                              (and
                                (= spark__branch4 (and (ite (<= 65 temp___1189)
                                                         true
                                                         false) (ite (<= temp___1189 70)
                                                                  true
                                                                  false)))
                                (ite (= spark__branch4 true)
                                      ...
                                      (exists ((o7 Int))
                                        (and
                                          (= (to_rep1
                                               (select (to_array str) 
                                               p2)) o7)
                                          (= digit1 (bvsub (of_int o7) #x00000000000000000000000000000037)))))
                                  ...
                                  (and
                                    ...
                                    (exists ((temp___1187 Int))
                                      (and
                                        (= (to_rep1
                                             (select (to_array str) p2)) temp___1187)
                                        (and
                                          (= spark__branch2 (and (ite (<= 97 temp___1187)
                                                                   true
                                                                   false) 
                                          (ite (<= temp___1187 102)
                                            true
                                              ...
                                              (exists ((o7 Int))
                                                (and
                                                  (= (to_rep1
                                                       ...
                                                       p2)) o7)
                                                  (= digit1 (bvsub (of_int
                                                                    o7) #x00000000000000000000000000000057))))))))))))))))))))))
          (let ((o7 (+ last_num_init 2)))
            (and
              (in_range1 o7)
              (and
                (not
                  (= p2 (+ (last_hexa_ghost
                             (let ((temp___717 (of_array
                               ...
                               (of_array
                                 ...
                                 (first temp___717)
                                 (last temp___717)))) 1)))
                (exists ((ptr__pointer_value4 integer) (p4 Int) (uval4 (_ BitVec 128)) (overflow4 Bool) (digit2 (_ BitVec 128)) (old_uval2 (_ BitVec 128)))
                  (and
                    (and
                      (and (<= p2 p4) (<= p4 last_num_based))
                      (and
                        (and
                          (let ((temp___1234 (to_rep1
                                               (select (to_array str) p4))))
                            (or
                          ...
                          (= digit2 (hexa_to_unsigned_ghost
                                      (to_rep1 (select (to_array str) p4)))))
                        (and
                          (=> (= overflow2 true) (= overflow4 true))
                          (and
                            (=>
                              (= overflow4 true)
                              (or
                              ...
                              (=>
                                ...
                                (= (bool_eq9
                                     ...
                                     (scan_based_number_ghost
                                       ...
                                       base2
                                       uval4)) true))
                              (= (to_rep ptr__pointer_value4) (+ last_num_init 1)))))))
                    (and
                      (and
                        (and
                          (and
                            (and
                              ...
                              (dynamic_invariant4 uval4 false true true true))
                      ...
                      (exists ((old_uval3 (_ BitVec 128)))
                        (and
                          (= old_uval3 uval4)
                          (exists ((old_overflow Bool))
                            (and
                              (= old_overflow overflow4)
                              (exists ((spark__branch3 Bool))
                                (and
                                  (exists ((spark__branch4 Bool))
                                    (and
                                      (= spark__branch4 (ite (bvuge digit2 
                                                          base2)
                                                          true
                                                          false))
                                      (ite (= spark__branch4 true)
                                        ...
                                        (exists ((spark__branch5 Bool))
                                          (and
                                            (= spark__branch5 (ite (bvule uval4 
                                                                umax1)
                                                                true
                                                                false))
                                            (ite (= spark__branch5 true)
                                              ...
                                              (exists ((spark__branch6 Bool))
                                                (and
                                                  (= spark__branch6 (ite (bvugt uval4 
                                                                    umaxb)
                                                                    true
                                                                    false))
                                      ...
                                      (let ((o9 (+ p4 1)))
                                        (and
                                          ...
                                          (exists ((p5 Int))
                                            (and
                                              (= p5 o9)
                                              (exists ((spark__branch4 Bool) (ptr__pointer_value5 integer))
                                                (and
                                                  (and
                                                    (= spark__branch4 
                                                    (ite (< max1 p5)
                                                    ...
                                                    (and
                                                      (not
                                                        (= spark__branch4 true))
                                                      (= ptr__pointer_value5 ptr__pointer_value4)))
                                                  (exists ((spark__branch5 Bool))
                                                    (and
                                                      (and
                                                        (and
                                                              ...
                                                              (and
                                                                ...
                                                                (and
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (and
                                                                    (= 
                                                                    ptr__pointer_value3 ptr__pointer_value5)
                                                                    (= 
                                                                    p3 p5)))))))))))))
                                                      (and
                                                        (and
...
(declare-const base3 (_ BitVec 128))

;; H
(assert (= base3 #x0000000000000000000000000000000A))
