        ...
        (last_hexa_ghost__function_guard
          ...
          (let ((temp___717 (of_array (to_array o9) o8 o7)))
            (of_array
              ...
              (first temp___717)
              (last temp___717)))))
      (exists ((spark__branch2 Bool) (digit1 (_ BitVec 64)))
        (and
          (and
            (and (<= (first str) p2) (<= p2 (last str)))
            (exists ((temp___1190 Int))
                        ...
                        (and
                          ...
                          (exists ((o7 Int))
                            (and
                              ...
                              (= digit1 (bvsub (of_int o7) #x0000000000000030)))))
                                      ...
                                      (exists ((o7 Int))
                                        (and
                                          (= (to_rep1
                                               (select (to_array str) 
                                               p2)) o7)
                                          (= digit1 (bvsub (of_int o7) #x0000000000000037)))))
                  ...
                  (= p2 (+ (last_hexa_ghost
                             (let ((temp___717 (of_array
                               ...
                               (of_array
                                 ...
                                 (first temp___717)
                                 (last temp___717)))) 1)))
                (exists ((ptr__pointer_value4 integer) (p4 Int) (uval4 (_ BitVec 64)) (overflow4 Bool) (digit2 (_ BitVec 64)) (old_uval2 (_ BitVec 64)))
                  (and
                    (and
...
(declare-const base3 (_ BitVec 64))

;; H
(assert (= base3 #x000000000000000A))
