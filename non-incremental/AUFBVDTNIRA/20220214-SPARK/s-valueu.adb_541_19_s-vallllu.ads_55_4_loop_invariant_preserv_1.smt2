...
;; LoopInvariant
(assert (and (<= p4 p7) (<= p7 last_num_based)))

;; LoopInvariant
(assert
  (and
    (let ((temp___1214 (to_rep1 (select (to_array str) p7))))
      (or
        (and (<= 48 temp___1214) (<= temp___1214 57))
        (or
          (and (<= 97 temp___1214) (<= temp___1214 102))
          (and (<= 65 temp___1214) (<= temp___1214 70)))))
    (= digit4 (hexa_to_unsigned_ghost (to_rep1 (select (to_array str) p7))))))
...
(assert
  ...
  (=>
    ...
    (= (bool_eq9
         based_val
         (scan_based_number_ghost str p7 last_num_based base2 uval5)) true))))
