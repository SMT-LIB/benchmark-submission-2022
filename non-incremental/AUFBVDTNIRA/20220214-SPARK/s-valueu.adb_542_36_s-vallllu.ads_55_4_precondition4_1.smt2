...
;; H
(assert (= (to_rep1 (select (to_array str) p4)) temp___1210))
...
(assert
  (ite (= (and (ite (<= 48 temp___1210) true false) (ite (<= temp___1210 57)
                                                      ...
                                                      false)) true)
    (= o10 true)
    (= o10 (ite (= (and (ite (<= 97 temp___1210) true false) (ite (<= 
                                                               temp___1210 102)
                                                               true
                                                               false)) true)
             true
...
(assert
  (or
    ...
    (and
      ...
      (exists ((o11 Int))
        (and
          (= (to_rep1 (select (to_array str) p4)) o11)
          (let ((o12 (hexa_to_unsigned_ghost o11)))
            (and
              (dynamic_invariant4 o12 true false true true)
              (= o12 (ite (and (<= 48 o11) (<= o11 57))
                       (bvsub ((_ int2bv 128) o11) #x00000000000000000000000000000030)
                       (ite (and (<= 97 o11) (<= o11 102))
                         (bvadd (bvsub ((_ int2bv 128) o11) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                         (ite (and (<= 65 o11) (<= o11 70))
                           (bvadd (bvsub ((_ int2bv 128) o11) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                           (to_rep2 dummy5))))))))))))
