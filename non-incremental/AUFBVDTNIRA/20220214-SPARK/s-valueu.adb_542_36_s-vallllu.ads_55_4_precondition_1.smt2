...
;; LoopInvariant
(assert (and (<= p4 p5) (<= p5 last_num_based)))

;; LoopInvariant
(assert
  (and
    (let ((temp___1214 (to_rep1 (select (to_array str) p5))))
      (or
        (and (<= 48 temp___1214) (<= temp___1214 57))
        (or
          (and (<= 97 temp___1214) (<= temp___1214 102))
          (and (<= 65 temp___1214) (<= temp___1214 70)))))
  ...
  (and
    (and
      (and
        (and
          (and
            (dynamic_invariant4 digit3 false true true true)
            (dynamic_invariant4 old_uval2 false true true true))
          (not (= ptr__is_null_pointer true)))
        (dynamic_invariant p5 false true true true))
...
;; H
(assert (= spark__branch8 (ite (bvuge digit3 base2) true false)))
...
(assert
  (ite (= spark__branch8 true)
    (and
      (and (= overflow4 (of_int 1)) (= spark__branch7 spark__branch8))
      (= uval5 uval4))
    (and
      (= spark__branch9 (ite (bvule uval4 umax1) true false))
      (ite (= spark__branch9 true)
        (and
          (and
            (= uval5 (bvadd (bvmul base2 uval4) digit3))
            (= spark__branch7 spark__branch9))
          (= overflow4 overflow3))
        (and
          (= spark__branch10 (ite (bvugt uval4 umaxb) true false))
          (ite (= spark__branch10 true)
            ...
            (and
              (= uval5 (bvadd (bvmul base2 uval4) digit3))
              (and
                (= spark__branch7 (ite (bvult uval5 umaxb) true false))
                (ite (= spark__branch7 true)
                  (= overflow4 (of_int 1))
                  (= overflow4 overflow3))))))))))

;; Ensures
(assert (in_range1 (+ p5 1)))
...
;; H
(assert (= spark__branch11 (ite (< max1 p6) true false)))
...
;; Assert
(assert (and (<= (first str) p6) (<= p6 (last str))))

(declare-const o11 Int)

;; H
(assert (= (to_rep1 (select (to_array str) p6)) o11))

(declare-const spark__branch13 Bool)

;; H
(assert (= spark__branch13 (ite (= o11 base_char1) true false)))
...
;; H
(assert (= (to_rep1 (select (to_array str) p6)) o12))

;; H
(assert (= spark__branch12 (ite (= o12 95) true false)))
    ...
    (and
      ...
      (and
        (and
          (and
            (= p8 (+ p6 1))
            (= (to_rep ptr__pointer_value4) (to_rep ptr__pointer_value5)))
          (and
            (dynamic_invariant5 p8 true true true true)
            (not (= ptr__is_null_pointer true))))
        (and (in_range1 p8) (= p7 p8))))
    (and (= ptr__pointer_value5 ptr__pointer_value4) (= p7 p6))))

(declare-const digit4 (_ BitVec 128))

;; Assert
(assert (and (<= (first str) p7) (<= p7 (last str))))

(declare-const temp___11781 Int)

;; H
(assert (= (to_rep1 (select (to_array str) p7)) temp___11781))

(declare-const spark__branch14 Bool)

;; H
(assert
  (= spark__branch14 (and (ite (<= 48 temp___11781) true false) (ite (<= 
                                                                  temp___11781 57)
                                                                  true
                                                                  false))))

(declare-const temp___11771 Int)

(declare-const spark__branch15 Bool)

(declare-const temp___11751 Int)
...
(assert
  (ite (= spark__branch14 true)
    (and
      (and (<= (first str) p7) (<= p7 (last str)))
      (and
        (= (to_rep1 (select (to_array str) p7)) o15)
        (= digit4 (bvsub ((_ int2bv 128) o15) #x00000000000000000000000000000030))))
    (and
      (and (<= (first str) p7) (<= p7 (last str)))
      (and
        (= (to_rep1 (select (to_array str) p7)) temp___11771)
        (and
          (= spark__branch15 (and (ite (<= 65 temp___11771) true false) 
          (ite (<= temp___11771 70)
            true
            false)))
          (ite (= spark__branch15 true)
            (and
              (and (<= (first str) p7) (<= p7 (last str)))
              (and
                (= (to_rep1 (select (to_array str) p7)) o14)
                (= digit4 (bvsub ((_ int2bv 128) o14) #x00000000000000000000000000000037))))
            (and
              (and (<= (first str) p7) (<= p7 (last str)))
              (and
                (= (to_rep1 (select (to_array str) p7)) temp___11751)
                (and
                  (= spark__branch16 (and (ite (<= 97 temp___11751)
                                            true
                                            false) (ite (<= temp___11751 102)
                                                     true
                                                     false)))
                  (and
                    ...
                    (and
                      (and (<= (first str) p7) (<= p7 (last str)))
                      (and
                        (= (to_rep1 (select (to_array str) p7)) o13)
                        (= digit4 (bvsub ((_ int2bv 128) o13) #x00000000000000000000000000000057))))))))))))))
...
;; H
(assert (= (to_rep1 (select (to_array str) p7)) temp___1210))

(declare-const o16 Bool)

;; H
(assert
  (ite (= (and (ite (<= 48 temp___1210) true false) (ite (<= temp___1210 57)
                                                      true
                                                      false)) true)
    (= o16 true)
    (= o16 (ite (= (and (ite (<= 97 temp___1210) true false) (ite (<= 
                                                               temp___1210 102)
                                                               true
                                                               false)) true)
             true
             (and (ite (<= 65 temp___1210) true false) (ite (<= temp___1210 70)
                                                         true
                                                         false))))))
...
(assert
  (or
    ...
    (and
      ...
      (exists ((o17 Int))
        (and
          (= (to_rep1 (select (to_array str) p7)) o17)
          (let ((o18 (hexa_to_unsigned_ghost o17)))
            (and
              (dynamic_invariant4 o18 true false true true)
              (= o18 (ite (and (<= 48 o17) (<= o17 57))
                       (bvsub ((_ int2bv 128) o17) #x00000000000000000000000000000030)
                       (ite (and (<= 97 o17) (<= o17 102))
                         (bvadd (bvsub ((_ int2bv 128) o17) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                         (ite (and (<= 65 o17) (<= o17 70))
                           (bvadd (bvsub ((_ int2bv 128) o17) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                           (to_rep2 dummy5))))))))))))
...
(assert
  (not (= (only_hexa_ghost str p7 last_num_based) true)))
