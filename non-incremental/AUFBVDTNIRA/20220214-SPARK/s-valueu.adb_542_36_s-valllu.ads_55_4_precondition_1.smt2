...
(declare-const base1 (_ BitVec 64))
...
;; H
(assert (= uval2 #x0000000000000000))

(declare-const spark__branch1 Bool)

(declare-const overflow2 Bool)

(declare-const base2 (_ BitVec 64))

;; H
(assert
  (= spark__branch1 (ite (= (and (ite (bvule #x0000000000000002 base1)
                                   true
                                   false) (ite (bvule base1 #x0000000000000010)
                                            true
                                            false)) true)
                      false
                      true)))
...
(assert
  (ite (= spark__branch1 true)
    (and (= overflow2 (of_int1 1)) (= base2 #x0000000000000010))
...
;; Assume
(assert
  (= (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFF base2) #x0000000000000001) 
  base2) umax1))
...
;; Assume
(assert (= (bvudiv #xFFFFFFFFFFFFFFFF base2) umaxb))
    ...
    (and
      (and
        ...
        (and
          ...
          (= digit1 (bvsub (of_int o9) #x0000000000000030))))
            ...
            (and
              (and
                ...
                (and
                  ...
                  (= digit1 (bvsub (of_int o8) #x0000000000000037))))
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (= digit1 (bvsub (of_int o7) #x0000000000000057))))))))))))))
...
(declare-const uval4 (_ BitVec 64))
...
(declare-const digit3 (_ BitVec 64))
  ...
  (ite (= spark__branch12 true)
    (and
      ...
      (and
        ...
        (= digit3 (bvsub (of_int o15) #x0000000000000030))))
    (and
      (and (<= (first str) p5) (<= p5 (last str)))
      (and
          ...
          (ite (= spark__branch13 true)
            (and
              ...
              (and
                ...
                (= digit3 (bvsub (of_int o14) #x0000000000000037))))
            (and
              (and (<= (first str) p5) (<= p5 (last str)))
              (and
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (= digit3 (bvsub (of_int o13) #x0000000000000057))))))))))))))
          ...
          (let ((o18 (hexa_to_unsigned_ghost o17)))
            (and
              ...
              (= o18 (ite (and (<= 48 o17) (<= o17 57))
                       (bvsub (of_int o17) #x0000000000000030)
                       (ite (and (<= 97 o17) (<= o17 102))
                         (bvadd (bvsub (of_int o17) #x0000000000000061) #x000000000000000A)
                         (ite (and (<= 65 o17) (<= o17 70))
                           (bvadd (bvsub (of_int o17) #x0000000000000041) #x000000000000000A)
                           (to_rep2 dummy5))))))))))))
