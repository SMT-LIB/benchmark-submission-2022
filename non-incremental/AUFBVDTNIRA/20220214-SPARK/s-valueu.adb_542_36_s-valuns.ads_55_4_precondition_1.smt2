...
;; H
(assert
  (= uval1 (bvsub ((_ int2bv 32) (to_rep1 (select (to_array str) p1))) #x00000030)))
...
(declare-const digit1 (_ BitVec 32))
...
(assert
  (and
    ...
    (exists ((spark__branch2 Bool) (ptr__pointer_value2 integer) (p4 Int) (uval3 (_ BitVec 32)) (overflow2 Bool) (digit2 (_ BitVec 32)) (old_uval2 (_ BitVec 32)))
      (and
        (and
            ...
            (and
              ...
              (exists ((o5 Int))
                (and
                  ...
                  (and
                    (= digit1 (bvsub ((_ int2bv 32) o5) #x00000030))
                    (and
                      (and
                        (and
                          (and
                            (exists ((spark__branch3 Bool))
                              (and
                                (= spark__branch3 (ite (bvugt digit1 #x00000009)
                                                    true
                                                    false))
                                (and
                                  (= spark__branch3 true)
...
;; H
(assert
  (= spark__branch3 (ite (= (and (ite (bvule #x00000002 base1) true false) 
...
(assert
  (ite (= spark__branch3 true)
    (and (= overflow2 (of_int 1)) (= base2 #x00000010))
...
(declare-const digit2 (_ BitVec 32))
    ...
    (and
      (and
        ...
        (and
          ...
          (= digit2 (bvsub ((_ int2bv 32) o9) #x00000030))))
            ...
            (and
              (and
                ...
                (and
                  ...
                  (= digit2 (bvsub ((_ int2bv 32) o8) #x00000037))))
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (= digit2 (bvsub ((_ int2bv 32) o7) #x00000057))))))))))))))

(declare-const ptr__pointer_value3 integer)

(declare-const p5 Int)

(declare-const uval4 (_ BitVec 32))

(declare-const overflow3 Bool)

(declare-const digit3 (_ BitVec 32))

(declare-const old_uval2 (_ BitVec 32))
...
(declare-const uval5 (_ BitVec 32))
...
(declare-const digit4 (_ BitVec 32))
  ...
  (ite (= spark__branch14 true)
    (and
      ...
      (and
        ...
        (= digit4 (bvsub ((_ int2bv 32) o15) #x00000030))))
    (and
      (and (<= (first str) p7) (<= p7 (last str)))
      (and
          ...
          (ite (= spark__branch15 true)
            (and
              ...
              (and
                ...
                (= digit4 (bvsub ((_ int2bv 32) o14) #x00000037))))
            (and
              (and (<= (first str) p7) (<= p7 (last str)))
              (and
                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        ...
                        (= digit4 (bvsub ((_ int2bv 32) o13) #x00000057))))))))))))))
          ...
          (let ((o18 (hexa_to_unsigned_ghost o17)))
            (and
              ...
              (= o18 (ite (and (<= 48 o17) (<= o17 57))
                       (bvsub ((_ int2bv 32) o17) #x00000030)
                       (ite (and (<= 97 o17) (<= o17 102))
                         (bvadd (bvsub ((_ int2bv 32) o17) #x00000061) #x0000000A)
                         (ite (and (<= 65 o17) (<= o17 70))
                           (bvadd (bvsub ((_ int2bv 32) o17) #x00000041) #x0000000A)
                           (to_rep2 dummy5))))))))))))
