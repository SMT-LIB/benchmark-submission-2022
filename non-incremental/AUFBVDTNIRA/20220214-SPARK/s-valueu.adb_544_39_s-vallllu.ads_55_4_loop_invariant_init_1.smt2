...
;; LoopInvariant
(assert (and (<= p4 p4) (<= p4 last_num_based)))

;; LoopInvariant
(assert
  (and
    (let ((temp___1214 (to_rep1 (select (to_array str) p4))))
      (or
        (and (<= 48 temp___1214) (<= temp___1214 57))
        (or
          (and (<= 97 temp___1214) (<= temp___1214 102))
          (and (<= 65 temp___1214) (<= temp___1214 70)))))
    (= digit2 (hexa_to_unsigned_ghost (to_rep1 (select (to_array str) p4))))))
...
(assert
  (=>
    ...
    (= (bool_eq9
         based_val
         (scan_based_number_ghost str p4 last_num_based base2 uval3)) true)))

;; Goal def'vc
;; File "s-valueu.ads", line 368, characters 0-0
(assert
  (not (= (to_rep ptr__pointer_value2) (+ last_num_init 1))))
