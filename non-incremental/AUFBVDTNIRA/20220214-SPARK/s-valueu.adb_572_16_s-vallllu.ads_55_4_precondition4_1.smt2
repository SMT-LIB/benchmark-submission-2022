...
(assert
  ...
  (=>
    (or
      (or
        (bvuge digit2 base2)
        (bvugt old_uval3 (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF base2)))
      (and
        (bvugt old_uval3 (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF 
        base2) #x00000000000000000000000000000001) base2))
        (bvult uval4 (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF base2))))
    (= overflow4 true))))
