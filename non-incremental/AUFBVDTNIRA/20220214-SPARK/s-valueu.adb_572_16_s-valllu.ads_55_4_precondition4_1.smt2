...
(assert
  ...
  (=>
    (or
      (or
        (bvuge digit2 base2)
        (bvugt old_uval3 (bvudiv #xFFFFFFFFFFFFFFFF base2)))
      (and
        (bvugt old_uval3 (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFF base2) #x0000000000000001) 
        base2))
        (bvult uval4 (bvudiv #xFFFFFFFFFFFFFFFF base2))))
    (= overflow4 true))))
