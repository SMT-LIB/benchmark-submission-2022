...
;; Ensures
(assert (in_range1 (+ p4 1)))

(declare-const ptr__pointer_value5 integer)

;; Ensures
(assert (= (to_rep ptr__pointer_value5) (+ p4 1)))

;; Assert
(assert (= (to_rep ptr__pointer_value5) (+ last_num_based 2)))
...
(assert
  (=>
    ...
    (= (bool_eq9
         based_val
         (scan_based_number_ghost str p4 last_num_based base2 uval4)) true)))

;; Ensures
(assert
  (= (bool_eq9
       (scan_based_number_ghost str p4 last_num_based base2 uval4)
       (us_repqtmk
         (us_split_discrsqtmk (of_int1 0))
         (us_split_fieldsqtmk (of_rep2 uval4)))) true))
