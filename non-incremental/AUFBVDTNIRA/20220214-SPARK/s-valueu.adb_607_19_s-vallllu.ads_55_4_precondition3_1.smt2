...
(define-fun lpeqrpqtresultqtunusedqtunused1 () Bool
  (ite (= (to_rep1 (select (to_array str) p6)) base_char1) true false))

(declare-const spark__branch12 Bool)

;; H
(assert
  (= spark__branch12 (ite (= (to_rep1 (select (to_array str) p6)) base_char1)
                       true
                       false)))
...
(define-fun lpeqrpqtresultqtunusedqtunused2 () Bool
  (ite (= (to_rep1 (select (to_array str) p6)) 95) true false))

(declare-const spark__branch13 Bool)

;; H
(assert
  (= spark__branch13 (ite (= (to_rep1 (select (to_array str) p6)) 95)
                       true
                       false)))
...
(assert
  ...
  (=>
    (= (of_int 1) true)
    (let ((temp___858 (to_rep1 (select (to_array str) (+ p6 1)))))
      (or
        (and (<= 48 temp___858) (<= temp___858 57))
        (or
          (and (<= 65 temp___858) (<= temp___858 70))
          (and (<= 97 temp___858) (<= temp___858 102))))))))
