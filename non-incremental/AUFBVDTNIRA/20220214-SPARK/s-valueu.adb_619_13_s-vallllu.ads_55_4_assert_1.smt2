          ...
          (exists ((uval4 (_ BitVec 128)))
            (and
                                              ...
                                              (and
                                                ...
                                                (exists ((o7 Int))
                                                  (and
                                                    ...
                                                    (= digit1 (bvsub 
                                                    (of_int
                                                      o7) #x00000000000000000000000000000037)))))
                                              (= spark__branch2 spark__branch4))
                                            (and
                                              (and
                                                (<= (first str) p2)
                            ...
                            (= p2 (+ (last_hexa_ghost
                                       (let ((temp___717 (of_array
                                         ...
                                         (of_array
                                           ...
                                           (first temp___717)
                                           (last temp___717)))) 1)))
                          (exists ((ptr__pointer_value4 integer) (p4 Int) (uval5 (_ BitVec 128)) (overflow4 Bool) (digit2 (_ BitVec 128)) (old_uval2 (_ BitVec 128)))
                            (and
                              (and
                                (and (<= p2 p4) (<= p4 last_num_based))
                                (and
              ...
              (and
                (= uval3 base2)
                (and
                  (= base3 #x0000000000000000000000000000000A)
                  (and
                    (= (to_rep ptr__pointer_value3) (+ last_num_init 1))
                    (=>
                      (not (= overflow3 true))
                      (= uval3 (to_rep2
                                 (rec__ada___system__val_lllu__impl__uns_option__value
  ...
  (=>
    (or
      (or
        (= (rec__ada___system__val_lllu__impl__uns_option__overflow
             (us_split_discrs1 init_val)) true)
        (= (not (let ((temp___1241 (to_rep2
                                     (rec__ada___system__val_lllu__impl__uns_option__value
                                       (us_split_fields1 init_val)))))
                  (and (ite (bvule #x00000000000000000000000000000002 temp___1241)
                         true
                         false) (ite (bvule temp___1241 #x00000000000000000000000000000010)
                                  true
                                  false)))) true))
      (and
        (= starts_as_based true)
