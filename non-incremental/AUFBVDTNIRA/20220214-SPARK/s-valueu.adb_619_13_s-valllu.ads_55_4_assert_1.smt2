                            ...
                            (= p2 (+ (last_hexa_ghost
                                       (let ((temp___717 (of_array
                                         ...
                                         (of_array
                                           ...
                                           (first temp___717)
                                           (last temp___717)))) 1)))
                          (exists ((ptr__pointer_value4 integer) (p4 Int) (uval5 (_ BitVec 64)) (overflow4 Bool) (digit2 (_ BitVec 64)) (old_uval2 (_ BitVec 64)))
                            (and
                              (and
                                (and (<= p2 p4) (<= p4 last_num_based))
                                (and
    ...
    (or
      (or
        ...
        (= (not (let ((temp___1241 (to_rep2
                                     (rec__ada___system__val_llu__impl__uns_option__value
                                       (us_split_fields1 init_val)))))
                  (and (ite (bvule #x0000000000000002 temp___1241)
                         true
                         false) (ite (bvule temp___1241 #x0000000000000010)
                                  true
                                  false)))) true))
      (and
        (= starts_as_based true)
