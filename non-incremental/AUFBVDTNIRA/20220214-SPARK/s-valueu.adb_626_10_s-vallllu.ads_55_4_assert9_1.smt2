      ...
      (and
        ...
        (ite (= o6 35)
          ...
          (and
            (and (<= (first str) p1) (<= p1 (last str)))
            (and
              (= (to_rep1 (select (to_array str) p1)) o7)
              (= o5 (ite (= o7 58) true false)))))))
    (= o5 false)))
...
(assert
  (and
    (forall ((o9 Int) (o10 Int) (o11 us_t))
      (last_hexa_ghost__function_guard
        (last_hexa_ghost
          (let ((temp___717 (of_array (to_array o11) o10 o9)))
            (of_array
              (to_array temp___717)
              (first temp___717)
              (last temp___717))))
      ...
      (and
        ...
        (ite (= spark__branch true)
          (and
            (and (<= (first str) p1) (<= p1 (last str)))
            (and
              (= (to_rep1 (select (to_array str) p1)) o8)
              (and
                (= base_char1 o8)
                (let ((o9 (+ p1 1)))
                  (and
                    ...
                    (and
                      ...
                      (and
                        (= base2 uval1)
                        (and
                          (= uval3 #x00000000000000000000000000000000)
                          (and
                            (and
                              (= spark__branch1 (ite (= (and (ite (bvule #x00000000000000000000000000000002 
                                                               ...
                                                               true
                                                               false) 
                                                  (ite (bvule base2 #x00000000000000000000000000000010)
                                                    true
                                                    false)) true)
                                                  false
                                                  true))
                              (ite (= spark__branch1 true)
                                (and
                                  (= overflow3 (of_int1 1))
                                  (= base3 #x00000000000000000000000000000010))
                                (and (= overflow3 overflow1) (= base3 base2))))
                            (and
                              (and
                                (= (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF 
                                base3) #x00000000000000000000000000000001) 
                                base3) umax1)
                                (and
                                  (dynamic_invariant4
                                    umax1
                                    ...
                                    true)
                                  (and
                                    (= (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF 
                                    base3) umaxb)
                                    (and
                                      (dynamic_invariant4
                                        umaxb
                                                              ...
                                                              (and
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    (= digit1 (bvsub 
                                                                    (of_int
                                                                    o10) #x00000000000000000000000000000030)))))
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= digit1 (bvsub 
                                                                    (of_int
                                                                    o10) #x00000000000000000000000000000037)))))
                                                                    ...
                                                                    (= digit1 (bvsub 
                                                                    (of_int
                                                                    o10) #x00000000000000000000000000000057))))))))))))))))))))))
                                                  (let ((o10 (+ last_num_init 2)))
                                                    (and
                                                      (in_range1 o10)
                                                      (and
                                                        (not
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    (= p5 o12)
                                                                    (exists 
                                                                    ((spark__branch4 Bool) (ptr__pointer_value5 integer))
                                                                    (and
                                                                    (and
                                                                    (= spark__branch4 
                                                                    (ite (< 
