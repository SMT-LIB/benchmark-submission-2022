                  ...
                  (and
                    ...
                    (and
                      ...
                      (and
                        (= base2 uval1)
                        (and
                          (= uval3 #x0000000000000000)
                          (and
                            (and
                              (= spark__branch1 (ite (= (and (ite (bvule #x0000000000000002 
                                                               base2)
                                                               true
                                                               false) 
                                                  (ite (bvule base2 #x0000000000000010)
                                                    true
                                                    false)) true)
                                                  false
                                                  true))
                            ...
                            (and
                              (and
                                (= (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFF 
                                base3) #x0000000000000001) base3) umax1)
                                (and
                                  (dynamic_invariant4
                                    umax1
                                    true
                                    ...
                                    true)
                                  (and
                                    (= (bvudiv #xFFFFFFFFFFFFFFFF base3) 
                                    umaxb)
                                    (and
                                      (dynamic_invariant4
                                        umaxb
