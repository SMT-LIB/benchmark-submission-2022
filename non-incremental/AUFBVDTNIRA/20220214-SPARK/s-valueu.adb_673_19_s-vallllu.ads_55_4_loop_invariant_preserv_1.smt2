...
(assert
  (ite (not (= expon1 0))
    (= spark__branch5 (ite (not (= uval3 #x00000000000000000000000000000000))
                        true
                        false))
    (= spark__branch5 false)))
...
;; H
(assert
  (= (exponent_unsigned_ghost uval3 expon1 base1) (ite (or
                                                         (= expon1 0)
...
;; Assume
(assert (= (exponent_unsigned_ghost uval3 expon1 base1) res_val))
...
;; Assume
(assert (dynamic_invariant r271s true false true true))
...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j r271s) true false)) true))
...
(assert
  (=>
    ...
    (= (bool_eq9
         res_val
         (exponent_unsigned_ghost uval5 (+ (- expon1 j1) 1) base1)) true)))

;; H
(assert
  (= (and (ite (and
                 (dynamic_property1 1 r271s j1)
                 (dynamic_invariant4 uval5 false true true true))
            true
            false) (ite (and (<= 1 j1) (<= j1 r271s)) true false)) true))

(declare-const spark__branch6 Bool)

;; H
(assert (= spark__branch6 (ite (bvugt uval5 umaxb1) true false)))

;; H
(assert (not (= spark__branch6 true)))

(declare-const uval6 (_ BitVec 128))

;; H
(assert (= uval6 (bvmul uval5 base1)))

;; (=)'result'unused'unused
(define-fun lpeqrpqtresultqtunusedqtunused1 () Bool
  (ite (= j1 r271s) true false))
...
(assert
  ...
  (=>
    ...
    (= (bool_eq9
         res_val
         (exponent_unsigned_ghost uval6 (+ (- expon1 j2) 1) base1)) true))))
