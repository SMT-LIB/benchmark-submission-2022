...
;; H
(assert
  (= (and (ite (<= 1 j) true false) (ite (<= j r277s) true false)) true))
...
(assert
  (=>
    ...
    (= (bool_eq9
         res_val
         (exponent_unsigned_ghost uval2 (+ (- expon1 j1) 1) base1)) true)))
...
(assert
  (=
    (bvugt uval2 umaxb1)
    (= (scan_overflows_ghost #x00000000000000000000000000000000 base1 uval2) true)))

(declare-const spark__branch1 Bool)

;; H
(assert (= spark__branch1 (ite (bvugt uval2 umaxb1) true false)))
...
;; H
(assert (= uval3 (bvmul uval2 base1)))

;; (=)'result'unused'unused
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= j1 r277s) true false))
...
(assert
  ...
  (=>
    ...
    (= (bool_eq9
         res_val
         (exponent_unsigned_ghost uval3 (+ (- expon1 j2) 1) base1)) true))))
