...
(assert
  (ite (not (= expon1 0))
    (= spark__branch (ite (not (= uval1 #x00000000)) true false))
    (= spark__branch false)))
...
;; Assume
(assert (= (bvudiv #xFFFFFFFF base1) umaxb1))
        ...
        (and
          ...
          (and
            ...
            (and
              (=
                (bvugt uval3 umaxb1)
                (= (scan_overflows_ghost #x00000000 base1 uval3) true))
              (and
        ...
        (or
          ...
          (and
            ...
            (= (not (let ((temp___1287 (to_rep2
                                         (rec__ada___system__val_uns__impl__uns_option__value
                                           (us_split_fields1 init_val)))))
                      (and (ite (bvule #x00000002 temp___1287) true false) 
                      (ite (bvule temp___1287 #x00000010)
                        true
                        false)))) true)))
        (and
          (= starts_as_based true)
