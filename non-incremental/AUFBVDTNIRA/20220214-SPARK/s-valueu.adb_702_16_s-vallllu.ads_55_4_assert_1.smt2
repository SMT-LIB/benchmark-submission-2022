...
(assert
  (ite (not (= expon1 0))
    (= spark__branch (ite (not (= uval1 #x00000000000000000000000000000000))
                       true
                       false))
    (= spark__branch false)))
...
;; Assume
(assert (= (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF base1) umaxb1))

;; Assume
(assert (dynamic_invariant4 umaxb1 true false true true))

;; Ensures
(assert (in_range2 expon1))
...
;; H
(assert
  (= (exponent_unsigned_ghost uval1 expon1 base1) (ite (or
                                                         (= expon1 0)
...
;; Assume
(assert (= (exponent_unsigned_ghost uval1 expon1 base1) res_val))
...
;; Assume
(assert (dynamic_invariant r277s true false true true))
...
(assert
  (let ((temp___1268 r277s))
    (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1268)
                                             true
                                             false)) true)
        ...
        (and
          (and
            ...
            (=>
              ...
              (= (bool_eq9
                   res_val
                   (exponent_unsigned_ghost uval3 (+ (- expon1 j1) 1) base1)) true)))
          (and
            (= (and (ite (and
                           (dynamic_property1 1 r277s j1)
                           (dynamic_invariant4 uval3 false true true true))
                      true
                      false) (ite (and (<= 1 j1) (<= j1 r277s)) true false)) true)
            (and
              (=
                (bvugt uval3 umaxb1)
                (= (scan_overflows_ghost
                     ...
                     uval3) true))
              (and
                (= spark__branch1 (ite (bvugt uval3 umaxb1) true false))
                (ite (= spark__branch1 true)
                  (and (= overflow2 (of_int1 1)) (= uval2 uval3))
                  (and
                    (and (= uval2 (bvmul uval3 base1)) (= j1 temp___1268))
                    (= overflow2 overflow1))))))))
      (and
        (and (= spark__branch1 spark__branch) (= uval2 uval1))
        (= overflow2 overflow1)))))
          ...
          (and
            (and
              ...
              (let ((temp___1286 (to_rep1
                                   (select (to_array str) (+ last_num_init 1)))))
                (or (= temp___1286 35) (= temp___1286 58))))
