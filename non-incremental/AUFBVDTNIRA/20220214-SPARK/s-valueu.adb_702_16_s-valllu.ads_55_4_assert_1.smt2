...
(assert
  (and
    (and
              ...
              (or
                ...
                (and
                  ...
                  (= (not (let ((temp___1248 (to_rep2
                                               (rec__ada___system__val_llu__impl__uns_option__value
                                                 (us_split_fields1 init_val)))))
                            (and (ite (bvule #x0000000000000002 temp___1248)
                                   true
                                   false) (ite (bvule temp___1248 #x0000000000000010)
                                            true
                                            false)))) true)))
              (and
                (= starts_as_based true)
      ...
      (and (bvule #x0000000000000002 base1) (bvule base1 #x0000000000000010)))
    (=>
      (not (= overflow1 true))
      (ite (= is_based true)
        (= base1 (to_rep2
...
(assert
  (ite (not (= expon1 0))
    (= spark__branch (ite (not (= uval1 #x0000000000000000)) true false))
    (= spark__branch false)))
...
;; Assume
(assert (= (bvudiv #xFFFFFFFFFFFFFFFF base1) umaxb1))
...
(assert
  (let ((temp___1268 r277s))
    (ite (= (and (ite (<= 1 j) true false) (ite (<= j temp___1268)
                                             true
                                             false)) true)
      (exists ((uval3 (_ BitVec 64)) (j1 Int))
        (and
          (and
            (=>
              (= overflow1 true)
          ...
          (and
            ...
            (and
              (=
                (bvugt uval3 umaxb1)
                (= (scan_overflows_ghost #x0000000000000000 base1 uval3) true))
              (and
        ...
        (or
          ...
          (and
            ...
            (= (not (let ((temp___1287 (to_rep2
                                         (rec__ada___system__val_llu__impl__uns_option__value
                                           (us_split_fields1 init_val)))))
                      (and (ite (bvule #x0000000000000002 temp___1287)
                             true
                             false) (ite (bvule temp___1287 #x0000000000000010)
                                      true
                                      false)))) true)))
        (and
          (= starts_as_based true)
