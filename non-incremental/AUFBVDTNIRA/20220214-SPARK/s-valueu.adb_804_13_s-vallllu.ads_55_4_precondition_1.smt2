...
;; H
(assert (= (to_rep1 (select (to_array str) non_blank)) o))
...
(assert
  (ite (= o 43)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_lllu__impl__value_unsigned__B_9__fst_num__assume o1)
        (in_range o1)))
...
(assert
  (not
    (= (rec__ada___system__val_lllu__impl__T86s__is_null_pointer usf) true)))

;; H
(assert
  (= false (rec__ada___system__val_lllu__impl__T86s__is_null_pointer usf)))
...
(assert
  (and
    ...
    (let ((non_blank1 (first_non_space_ghost
                        ...
                        (to_rep p_acc__pointer_value)
                        (last str))))
      (let ((fst_num1 (ite (= (to_rep1 (select (to_array str) non_blank1)) 43)
                        (+ non_blank1 1)
                        non_blank1)))
        (and
          (and
            (and
              (forall ((fst_num2 Int))
                (raw_unsigned_overflows_ghost__function_guard
                  (raw_unsigned_overflows_ghost str fst_num2 (last str))
                  str
                  fst_num2
                  (last str)))
              (not
                (= (raw_unsigned_overflows_ghost str fst_num1 (last str)) true)))
            (and
              (forall ((fst_num2 Int))
                (scan_raw_unsigned_ghost__function_guard
                  (scan_raw_unsigned_ghost str fst_num2 (last str))
                  str
                  fst_num2
                  (last str)))
              (= v1 (scan_raw_unsigned_ghost str fst_num1 (last str)))))
          (and
            (forall ((fst_num2 Int))
              (raw_unsigned_last_ghost__function_guard
                (raw_unsigned_last_ghost str fst_num2 (last str))
                str
                fst_num2
                (last str)))
            (= (to_rep p_acc__pointer_value1) (raw_unsigned_last_ghost
                                                str
                                                fst_num1
                                                (last str)))))))))
...
;; Assume
(assert
  (= p_acc__brower_at_end (us_repqtmk
...
;; H
(assert (= p1 p_acc__borrowed_at_end))
...
(assert
  ...
  (=>
    (only_space_ghost__function_guard
      (only_space_ghost str p1 (last str))
      str
      p1
      (last str))
    (= (only_space_ghost str p1 (last str)) true))))
