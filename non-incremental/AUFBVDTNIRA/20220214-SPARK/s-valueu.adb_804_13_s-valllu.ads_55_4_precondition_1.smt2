...
(assert
  (ite (= o 43)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_llu__impl__value_unsigned__B_9__fst_num__assume o1)
        (in_range o1)))
...
(assert
  (not
    (= (rec__ada___system__val_llu__impl__T86s__is_null_pointer usf) true)))

;; H
(assert
  (= false (rec__ada___system__val_llu__impl__T86s__is_null_pointer usf)))
