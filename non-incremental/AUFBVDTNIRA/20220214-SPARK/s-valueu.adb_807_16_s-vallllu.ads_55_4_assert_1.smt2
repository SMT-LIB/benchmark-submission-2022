...
;; Assume
(assert
  (= p_acc__brower_at_end (us_repqtmk1
...
(assert
  (and
    (scan_raw_unsigned_ghost__function_guard
      ...
      fst_num
      (last str))
    (= v1 (scan_raw_unsigned_ghost str fst_num (last str)))))
...
(assert
  ...
  (=>
    ...
    (=>
      ...
      (=>
        (is_value_unsigned_ghost__function_guard
          (is_value_unsigned_ghost (slide_if_necessary str) v1)
          (slide_if_necessary str)
          v1)
        (= (is_value_unsigned_ghost (slide_if_necessary str) v1) true))))))
