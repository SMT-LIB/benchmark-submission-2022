    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (and
             (and
               (< 1 (length str))
               (let ((temp___368 (to_rep (select (to_array str) (first str)))))
...
(assert
  (and
    (and
      ...
      (let ((temp___1091 (to_rep (select (to_array str) from))))
        (and (<= 48 temp___1091) (<= temp___1091 57))))
    (and
      (raw_unsigned_overflows_ghost__function_guard
        (raw_unsigned_overflows_ghost str from to__)
        str
        from
        to__)
...
(assert
  (=>
    ...
    (and
      (and (<= (first str) from) (<= from (last str)))
      (and (<= (first str) to__) (<= to__ (last str))))))
...
(assert
  (last_number_ghost__function_guard
    (last_number_ghost
      (of_array
        (to_array (of_array (to_array str) from to__))
        (first (of_array (to_array str) from to__))
        (last (of_array (to_array str) from to__))))
    (of_array
      (to_array (of_array (to_array str) from to__))
      (first (of_array (to_array str) from to__))
      (last (of_array (to_array str) from to__)))))
...
(assert
  (<= (first
        (of_array
          (to_array (of_array (to_array str) from to__))
          (first (of_array (to_array str) from to__))
          (last (of_array (to_array str) from to__)))) (last_number_ghost
                                                         (of_array
                                                           (to_array
                                                             (of_array
                                                               (to_array str)
...
(assert
  (<= (last_number_ghost
        (of_array
          (to_array (of_array (to_array str) from to__))
          (first (of_array (to_array str) from to__))
          (last (of_array (to_array str) from to__)))) (last
                                                         (of_array
                                                           (to_array
                                                             (of_array
                                                               (to_array str)
  ...
  (= (only_number_ghost
       ...
       (last_number_ghost
         (of_array
           (to_array (of_array (to_array str) from to__))
           (first (of_array (to_array str) from to__))
           (last (of_array (to_array str) from to__))))) true))
  ...
  (= (scan_based_number_ghost
       ...
       (last_number_ghost
         (of_array
           ...
           (last (of_array (to_array str) from to__))))
       #x0000000000000000000000000000000A
       #x00000000000000000000000000000000) (ite (< (last_number_ghost
                                                     (of_array
                                                       (to_array
                                                         (of_array
                                                           (to_array str)
...
;; H
(assert
  (ite (< (last_number_ghost
            (of_array
              (to_array (of_array (to_array str) from to__))
              (first (of_array (to_array str) from to__))
              (last (of_array (to_array str) from to__)))) (- to__ 1))
    (let ((o1 (+ (last_number_ghost
                   (of_array
                     (to_array (of_array (to_array str) from to__))
                     (first (of_array (to_array str) from to__))
                     (last (of_array (to_array str) from to__)))) 1)))
      (and
        (in_range1 o1)
        (and
          (and (<= (first str) o1) (<= o1 (last str)))
          (and
            (= (to_rep (select (to_array str) o1)) temp___1081)
            (ite (= temp___1081 35)
              (= o true)
              (= o (ite (= temp___1081 58) true false)))))))
    (= o false)))
  ...
  (ite (= o true)
    (let ((o1 (+ (last_number_ghost
                   (of_array
                     (to_array (of_array (to_array str) from to__))
                     (first (of_array (to_array str) from to__))
                     (last (of_array (to_array str) from to__)))) 2)))
      (and
        (in_range1 o1)
        (and
          (and (<= (first str) o1) (<= o1 (last str)))
          (and
            (= (to_rep (select (to_array str) o1)) temp___1083)
            (ite (= (and (ite (<= 48 temp___1083) true false) (ite (<= 
                                                                temp___1083 57)
                                                                true
                                                                false)) true)
              (= starts_as_based true)
              (= starts_as_based (ite (= (and (ite (<= 97 temp___1083)
                                                true
                                                false) (ite (<= temp___1083 102)
                                                         true
                                                         false)) true)
                                   true
                                   (and (ite (<= 65 temp___1083) true false) 
                                   (ite (<= temp___1083 70)
                                     true
                                     false)))))))))
    (= starts_as_based false)))
        ...
        (and
          (=>
            ...
            (and
              (and (<= (first str) o1) (<= o1 (last str)))
              (and (<= (first str) to__) (<= to__ (last str)))))
          (let ((temp___1077 (of_array (to_array str) o1 to__)))
            (let ((o2 (of_array
                        (to_array temp___1077)
                        (first temp___1077)
                        (last temp___1077))))
              (and
                (= last_num_based (last_hexa_ghost o2))
                (and
                  (last_hexa_ghost__function_guard last_num_based o2)
                  (and
                    (dynamic_invariant2 last_num_based true false true true)
                    (and
                      (and
                        (and
                          (<= (first o2) last_num_based)
                          (<= last_num_based (last o2)))
                        (=>
                          (< last_num_based (last o2))
                          (= (not (let ((temp___278 (to_rep
                                    ...
                                    (ite (<= temp___278 70)
                                      ...
                                      false)) (ite (= temp___278 95)
                                                true
                                                false)))))) true)))
                      (= (only_hexa_ghost o2 (first o2) last_num_based) true))))))))))
    (= last_num_based (last_number_ghost
                        (of_array
                          (to_array (of_array (to_array str) from to__))
                          (first (of_array (to_array str) from to__))
                          (last (of_array (to_array str) from to__)))))))
...
;; H
(assert
  (ite (and (= starts_as_based true) (< last_num_based to__))
    (let ((o3 (+ (last_number_ghost
                   (of_array
                     (to_array (of_array (to_array str) from to__))
                     (first (of_array (to_array str) from to__))
                     (last (of_array (to_array str) from to__)))) 1)))
      (and
        ...
        (and
          ...
          (and
            (= (to_rep (select (to_array str) o3)) o1)
            (let ((o4 (+ last_num_based 1)))
              (and
                ...
                (and
                  ...
                  (and
                    (= (to_rep (select (to_array str) o4)) o2)
                    (= is_based (ite (= o2 o1) true false))))))))))
    (= is_based false)))
               ...
               (scan_based_number_ghost
                 ...
                 (last_number_ghost
                   (of_array
                     ...
                     (last (of_array (to_array str) from to__))))
                 #x0000000000000000000000000000000A
                 #x00000000000000000000000000000000)))) o4)
      (let ((o5 (+ (last_number_ghost
                     (of_array
                       (to_array (of_array (to_array str) from to__))
                       (first (of_array (to_array str) from to__))
                       (last (of_array (to_array str) from to__)))) 2)))
...
(assert
  (ite (= is_based true)
    (let ((o5 (+ last_num_based 2))) (and (= first_exp o5) (in_range1 o5)))
    (let ((o5 (+ (last_number_ghost
                   (of_array
                     (to_array (of_array (to_array str) from to__))
                     (first (of_array (to_array str) from to__))
                     (last (of_array (to_array str) from to__)))) 1)))
      (and (= first_exp o5) (in_range1 o5)))))
...
(assert
  (=>
    (<= first_exp to__)
    (and
      (and (<= (first str) first_exp) (<= first_exp (last str)))
      (and (<= (first str) to__) (<= to__ (last str))))))

;; H
(assert
  (let ((o5 (of_int1 0)))
    (let ((temp___1072 (of_array (to_array str) first_exp to__)))
      (let ((o6 (of_array
                  (to_array temp___1072)
                  (first temp___1072)
                  (last temp___1072))))
        (=
          (= (starts_as_exponent_format_ghost o6 o5) true)
          (and
            (and
              (< 1 (length o6))
              (let ((temp___363 (to_rep (select (to_array o6) (first o6)))))
                (or (= temp___363 69) (= temp___363 101))))
            (let ((minus_sign (bool_eq10
                                (to_rep
                                  (select (to_array o6) (+ (first o6) 1)))
                                45)))
              (let ((sign (or (bool_eq10
                                (to_rep
                                  (select (to_array o6) (+ (first o6) 1)))
                ...
                (and
                  (and
                    (=> (= minus_sign true) (= o5 true))
                    (=> (= sign true) (< 2 (length o6))))
                  (let ((temp___364 (to_rep
                                      (select (to_array o6) (ite (= sign true)
                                                              (+ (first o6) 2)
                                                              (+ (first o6) 1))))))
                    (and (<= 48 temp___364) (<= temp___364 57))))))))))))

;; H
(assert
  (let ((temp___1072 (of_array (to_array str) first_exp to__)))
    (and
      (forall ((o5 us_t) (start Int))
        (scan_natural_ghost__function_guard
          (scan_natural_ghost
            (let ((temp___444 (of_array (to_array o5) start (last o5))))
              (of_array
                (to_array temp___444)
                (first temp___444)
                (last temp___444)))
          ...
          (and
            (=>
              ...
              (and
                (and (<= (first str) first_exp) (<= first_exp (last str)))
                (and (<= (first str) to__) (<= to__ (last str)))))
            (let ((temp___1070 (of_array (to_array str) first_exp to__)))
              (let ((o6 (of_array
                          (to_array temp___1070)
                          (first temp___1070)
                          (last temp___1070))))
                (let ((o7 (scan_exponent_ghost o6 o5)))
                  (and
                    (and
                      (scan_exponent_ghost__function_guard o7 o6 o5)
                      (and
                        (dynamic_invariant o7 true false true true)
                        (and
                          (= o7 (let ((plus_sign (bool_eq10
                                                   (to_rep
                                                     (select (to_array o6) (+ 
                                                     (first
                                                       o6) 1)))
                                  ...
                                  (let ((minus_sign (bool_eq10
                                                      (to_rep
                                                        ...
                                                        (first
                                                          o6) 1)))
                                                      45)))
                                    (let ((signqtunused (or plus_sign minus_sign)))
                                      (let ((start (ite (= (or plus_sign minus_sign) true)
                                                     (+ (first o6) 2)
                                                     (+ (first o6) 1))))
                                        (let ((value (scan_natural_ghost
                                                       (let ((temp___444 
                                                         (of_array
                                                           (to_array o6)
                                                           start
             ...
             (scan_based_number_ghost
               ...
               (last_number_ghost
                 (of_array
                   ...
                   (last (of_array (to_array str) from to__))))
               #x0000000000000000000000000000000A
               #x00000000000000000000000000000000)))) base)
    (= base #x0000000000000000000000000000000A)))
...
(assert
  (ite (= is_based true)
    (= (to_rep2
         (rec__ada___system__val_lllu__impl__uns_option__value
           (us_split_fields1 based_val))) value)
    (= (to_rep2
         (rec__ada___system__val_lllu__impl__uns_option__value
           (us_split_fields1
             (scan_based_number_ghost
               ...
               (last_number_ghost
                 (of_array
                   ...
                   (last (of_array (to_array str) from to__))))
               #x0000000000000000000000000000000A
               #x00000000000000000000000000000000)))) value)))
...
;; H
(assert
  (= (exponent_unsigned_ghost value expon base) (ite (or
                                                       (= expon 0)
                                                       (= value #x00000000000000000000000000000000))
                                                  (us_repqtmk
                                                    (us_split_discrsqtmk
...
;; Goal def'vc
;; File "s-valueu.ads", line 279, characters 0-0
(assert
  (not
  (ada___system__val_lllu__impl__uns_option__value__pred
    (exponent_unsigned_ghost value expon base))))
