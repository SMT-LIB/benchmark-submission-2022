  ...
  (= (scan_based_number_ghost
       ...
       (last_number_ghost
         (of_array
           ...
           (last (of_array (to_array str) from to__))))
       #x000000000000000A
       #x0000000000000000) (ite (< (last_number_ghost
                                     (of_array
                                       (to_array
                                         (of_array (to_array str) from to__))
                                       (first
                                         (of_array (to_array str) from to__))
                                       (last
                                         (of_array (to_array str) from to__)))) 
                             ...
                             (ite (= (to_rep (select (to_array o6) o5)) 95)
                               ...
                               (ite (= (scan_overflows_ghost
                                 ...
                                 (scan_based_number_ghost
                                   ...
                                   last_num_based
                                   o4
                                   (bvadd (bvmul o4 #x0000000000000000) 
                                   (hexa_to_unsigned_ghost
                                     (to_rep (select (to_array o6) o5))))))))))))))
    (= based_val (scan_based_number_ghost
                   str
             ...
             (scan_based_number_ghost
               ...
               (last_number_ghost
                 (of_array
                   ...
                   (last (of_array (to_array str) from to__))))
               #x000000000000000A
               #x0000000000000000)))) base)
    (= base #x000000000000000A)))
