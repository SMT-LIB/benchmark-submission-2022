...
(assert
  (and
    (and
              ...
              (or
                ...
                (and
                  ...
                  (= (not (let ((temp___1248 (to_rep2
                                               (rec__ada___system__val_uns__impl__uns_option__value
                                                 (us_split_fields1 init_val)))))
                            (and (ite (bvule #x00000002 temp___1248)
                                   true
                                   false) (ite (bvule temp___1248 #x00000010)
                                            true
                                            false)))) true)))
              (and
                (= starts_as_based true)
      ...
      (and (bvule #x00000002 base1) (bvule base1 #x00000010)))
    (=>
      (not (= overflow1 true))
      (ite (= is_based true)
        (= base1 (to_rep2
...
(assert
  (ite (not (= expon1 0))
    (= o5 (ite (not (= uval1 #x00000000)) true false))
    (= o5 false)))
  ...
  (and
    ...
    (and
      ...
      (ite (= spark__branch1 true)
        (and
          (= (bvudiv #xFFFFFFFF base1) umaxb1)
          (and
            (dynamic_invariant4 umaxb1 true false true true)
            (and
              (in_range2 expon1)
              (let ((ada___system__val_uns__impl__scan_raw_unsigned__B_6__res_val__assume 
                (exponent_unsigned_ghost
                  uval1
                  expon1
                  base1)))
                (and
                  (= ada___system__val_uns__impl__scan_raw_unsigned__B_6__res_val__assume 
                  (ite (or (= expon1 0) (= uval1 #x00000000))
                    (us_repqtmk
                      (us_split_discrsqtmk (of_int1 0))
                      (us_split_fieldsqtmk (of_rep2 uval1)))
                    (ite (= (scan_overflows_ghost #x00000000 base1 uval1) true)
                      (us_repqtmk
                        (us_split_discrsqtmk (of_int1 1))
                        (us_split_fieldsqtmk dummy5))
                      (exponent_unsigned_ghost
                            ...
                            (and
                              ...
                              (ite (= (and (ite (<= 1 j) true false) 
                                (ite (<= j temp___1268)
                                  true
                                  false)) true)
                                (exists ((uval3 (_ BitVec 32)) (j1 Int))
                                  (and
                                    (and
                                      (=>
                                        (= overflow1 true)
                                    ...
                                    (and
                                      ...
                                      (= (not (let ((temp___1287 (to_rep2
                                                                   (rec__ada___system__val_uns__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                (and (ite (bvule #x00000002 temp___1287)
                                                       true
                                                       false) (ite (bvule temp___1287 #x00000010)
                                                                true
                                                                false)))) true)))
                                  (and
                                    (= starts_as_based true)
