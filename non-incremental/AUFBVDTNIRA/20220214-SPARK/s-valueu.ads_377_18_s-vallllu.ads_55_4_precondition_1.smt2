        ...
        (and
          (=
            ...
            (or
              (or
                ...
                (and
                  (and
                    (< last_num_init (- max1 1))
                    (let ((temp___1247 (to_rep1
                                         (select (to_array str) (+ last_num_init 1)))))
                      (or (= temp___1247 35) (= temp___1247 58))))
                  (= (not (let ((temp___1248 (to_rep2
                                               (rec__ada___system__val_lllu__impl__uns_option__value
                                                 (us_split_fields1 init_val)))))
                            (and (ite (bvule #x00000000000000000000000000000002 temp___1248)
                                   true
                                   false) (ite (bvule temp___1248 #x00000000000000000000000000000010)
                                            true
                                            false)))) true)))
              (and
                (= starts_as_based true)
          ...
          (=>
            ...
            (ite (= is_based true)
              (= uval1 (to_rep2
                         (rec__ada___system__val_lllu__impl__uns_option__value
                           (us_split_fields1 based_val))))
              (= uval1 (to_rep2
                         (rec__ada___system__val_lllu__impl__uns_option__value
                           (us_split_fields1 init_val)))))))
        (= (to_rep ptr__pointer_value1) first_exp))
      (and
        (bvule #x00000000000000000000000000000002 base1)
        (bvule base1 #x00000000000000000000000000000010)))
    (=>
      (not (= overflow1 true))
      (ite (= is_based true)
        (= base1 (to_rep2
                   (rec__ada___system__val_lllu__impl__uns_option__value
                     (us_split_fields1 init_val))))
        (= base1 #x0000000000000000000000000000000A)))))
...
;; Assume
(assert (dynamic_invariant4 base1 false true true true))

(declare-const ptr__pointer_value2 integer)

(declare-const expon1 Int)
...
(assert
  (and
    (scan_exponent_ghost__function_guard
      (scan_exponent_ghost
        (let ((temp___869 (of_array
                            (to_array str)
                            (to_rep ptr__pointer_value1)
                            max1)))
          (of_array
            (to_array temp___869)
            (first temp___869)
      ...
      (let ((temp___869 (of_array
                          ...
                          (to_rep ptr__pointer_value1)
                          max1)))
        (of_array (to_array temp___869) (first temp___869) (last temp___869)))
      (of_int1 0))
    (and
      (last_number_ghost__function_guard
        (last_number_ghost
          (let ((temp___873 (of_array
                              (to_array str)
                              (+ (to_rep ptr__pointer_value1) 2)
                              max1)))
            (of_array
              (to_array temp___873)
              (first temp___873)
      ...
      (and
        ...
        (ite (= (starts_as_exponent_format_ghost
            ...
            (= expon1 (scan_exponent_ghost
                        (let ((temp___869 (of_array
                          ...
                          (of_array
                            ...
                            (last temp___869)))
                        (of_int1 0)))
            (ite (let ((temp___881 (to_rep1
                                     (select (to_array str) (+ (to_rep
                                                                 ptr__pointer_value1) 1)))))
                   (or (= temp___881 45) (= temp___881 43)))
              (= (to_rep ptr__pointer_value2) (+ (last_number_ghost
                                                   (let ((temp___873 
                                                     (of_array
                                                       (to_array str)
                                                       (+ (to_rep
                                                            ptr__pointer_value1) 2)
                                                       max1)))
                                                     (of_array
                                                       (to_array temp___873)
                                                       (first temp___873)
          ...
          (and
            (= expon1 0)
            (= (to_rep ptr__pointer_value2) (to_rep ptr__pointer_value1))))))))

;; H
(assert (not (= ptr__is_null_pointer true)))

;; H
(assert (dynamic_invariant expon1 true true true true))
...
(assert
  (and
    (scan_exponent_ghost__function_guard
      (scan_exponent_ghost
        (let ((temp___1262 (of_array (to_array str) first_exp max1)))
          (of_array
            (to_array temp___1262)
            (first temp___1262)
            (last temp___1262)))
        (of_int1 0))
      (let ((temp___1262 (of_array (to_array str) first_exp max1)))
    ...
    (=>
      (= (starts_as_exponent_format_ghost
           (let ((temp___1265 (of_array (to_array str) first_exp max1)))
             (of_array
               (to_array temp___1265)
               (first temp___1265)
               (last temp___1265)))
           (of_int1 0)) true)
      (= expon1 (scan_exponent_ghost
...
(assert
  (ite (not (= expon1 0))
    (= o5 (ite (not (= uval1 #x00000000000000000000000000000000)) true false))
    (= o5 false)))
...
(assert
  (and
    (raw_unsigned_overflows_ghost__function_guard
      (raw_unsigned_overflows_ghost str ptr_old max1)
      str
      ptr_old
      max1)
    (and
      (scan_raw_unsigned_ghost__function_guard
        (scan_raw_unsigned_ghost str ptr_old max1)
        str
        ptr_old
        max1)
      (ite (= spark__branch1 true)
        (and
          (= (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF base1) umaxb1)
          (and
            (dynamic_invariant4 umaxb1 true false true true)
            (and
              (in_range2 expon1)
              (let ((ada___system__val_lllu__impl__scan_raw_unsigned__B_6__res_val__assume 
                (exponent_unsigned_ghost
                  uval1
                  expon1
                  base1)))
                (and
                  (= ada___system__val_lllu__impl__scan_raw_unsigned__B_6__res_val__assume 
                  (ite (or
                         (= expon1 0)
                         (= uval1 #x00000000000000000000000000000000))
                    (us_repqtmk
                      (us_split_discrsqtmk (of_int1 0))
                      (us_split_fieldsqtmk (of_rep2 uval1)))
                    (ite (= (scan_overflows_ghost
                              #x00000000000000000000000000000000
                              base1
                              uval1) true)
                  ...
                  (and
                    ...
                    (and
                      (= expon1 r277s)
                      (and
                        (dynamic_invariant r277s true false true true)
                        (and
                          (let ((temp___1268 r277s))
                            (and
                              (= j 1)
                              (ite (= (and (ite (<= 1 j) true false) 
                                (ite (<= j temp___1268)
                                  true
                                  false)) true)
                                (exists ((uval3 (_ BitVec 128)) (j1 Int))
                                  (and
                                    (and
                                      (=>
                                        (= overflow1 true)
                          ...
                          (and
                                      ...
                                      (and
                                        ...
                                        (let ((temp___1286 (to_rep1
                                          ...
                                          (or
                                            (= temp___1286 35)
                                            (= temp___1286 58))))
                                      (= (not (let ((temp___1287 (to_rep2
                                                                   (rec__ada___system__val_lllu__impl__uns_option__value
                                                                    (us_split_fields1
                                                                    init_val)))))
                                                (and (ite (bvule #x00000000000000000000000000000002 temp___1287)
                                                       true
                                                       false) (ite (bvule temp___1287 #x00000000000000000000000000000010)
                                                                true
                                                                false)))) true)))
                                  (and
                                    (= starts_as_based true)
                            ...
                            (and
                              ...
                              (and
                                (= (bool_eq9
                                     (exponent_unsigned_ghost uval2 0 base1)
                                     (us_repqtmk
                                       (us_split_discrsqtmk (of_int1 0))
                                       (us_split_fieldsqtmk (of_rep2 uval2)))) true)
                                (and
                                  (=>
                                    (not (= overflow2 true))
                                    (= uval2 (to_rep2
                                               (rec__ada___system__val_lllu__impl__uns_option__value
                                                 (us_split_fields1 res_val)))))
                                  (=>
                                    (not (= overflow2 true))
                                    (= uval2 (scan_raw_unsigned_ghost
                                               str
                                               ptr_old
                                               max1))))))))))))))))
        (and
          (and (= spark__branch spark__branch1) (= uval2 uval1))
          (= overflow2 overflow1))))))

;; Assert
(assert
  (=>
    (or (= expon1 0) (= uval2 #x00000000000000000000000000000000))
    (= (bool_eq9
         (exponent_unsigned_ghost uval2 expon1 base1)
         (us_repqtmk
           (us_split_discrsqtmk (of_int1 0))
           (us_split_fieldsqtmk (of_rep2 uval2)))) true)))
...
(assert
  (and
    ...
    (=
      (= overflow2 true)
      (= (raw_unsigned_overflows_ghost str ptr_old max1) true))))
...
(assert
  (and
    ...
    (=>
      (not (= overflow2 true))
      (= uval2 (scan_raw_unsigned_ghost str ptr_old max1)))))

(declare-const res1 (_ BitVec 128))

(declare-const spark__branch2 Bool)

;; H
(assert (= spark__branch2 overflow2))
...
(assert
  (raw_unsigned_last_ghost__function_guard
    (raw_unsigned_last_ghost str (to_rep ptr__pointer_value) max1)
    str
    (to_rep ptr__pointer_value)
    max1))
  ...
  (and
    (last_number_ghost__function_guard
      ...
      (let ((temp___568 (of_array
                          ...
                          (to_rep ptr__pointer_value)
                          max1)))
        (of_array (to_array temp___568) (first temp___568) (last temp___568))))
    (and
      (forall ((last_num_init1 Int))
        (last_hexa_ghost__function_guard
          (last_hexa_ghost
          ...
          (let ((temp___559 (of_array
            ...
            (of_array
              ...
              (last temp___559)))))
      (and
        (forall ((first_exp1 Int))
          (last_number_ghost__function_guard
            (last_number_ghost
              (let ((temp___547 (of_array
                                  (to_array str)
                                  (+ first_exp1 2)
                                  max1)))
                (of_array
                  ...
                  (first temp___547)
                  (last temp___547))))
            (let ((temp___547 (of_array (to_array str) (+ first_exp1 2) max1)))
              (of_array
                (to_array temp___547)
                (first temp___547)
                (last temp___547)))))
            ...
            (last_number_ghost__function_guard
              ...
              (let ((temp___551 (of_array
                ...
                (of_array
                  ...
                  (last temp___551)))))
          (= (raw_unsigned_last_ghost str (to_rep ptr__pointer_value) max1) 
          (let ((last_num_init1 (last_number_ghost
                                  (let ((temp___568 (of_array
                                                      (to_array str)
                                                      (to_rep
                                                        ptr__pointer_value)
                                    ...
                                    (of_array
                                      ...
                                      (first temp___568)
                                      (last temp___568))))))
            (let ((starts_as_based1 (and (and (bool_lt1
                                                last_num_init1
                                                (- max1 1)) (let ((temp___563 
                                                              (to_rep1
                                                                (select 
                                                                (to_array
                                                                  str) (+ last_num_init1 1)))))
                                                              (or (ite (= temp___563 35)
                                                                    true
                                                                    false) 
                                                              (ite (= temp___563 58)
                                                                true
                                                                false)))) 
              (let ((temp___564 (to_rep1
                                  (select (to_array str) (+ last_num_init1 2)))))
                (or (and (ite (<= 48 temp___564) true false) (ite (<= temp___564 57)
                                                               true
                                                               false)) (or (and 
                (ite (<= 97 temp___564)
                  true
                  false) (ite (<= temp___564 102) true false)) (and (ite (<= 65 temp___564)
                                                                    true
                                                                    false) 
                (ite (<= temp___564 70)
                  true
                  false))))))))
              (let ((last_num_based1 (ite (= starts_as_based1 true)
                                       (last_hexa_ghost
                                         (let ((temp___559 (of_array
                                                             (to_array str)
                                                             (+ last_num_init1 2)
                                           ...
                                           (of_array
                                             ...
                                             (last temp___559))))
                                       last_num_init1)))
                (let ((is_basedqtunused (and (and starts_as_based1 (bool_lt1
                                                                    last_num_based1
                                                                    max1)) 
                  (bool_eq10
                    (to_rep1 (select (to_array str) (+ last_num_based1 1)))
                    (to_rep1 (select (to_array str) (+ last_num_init1 1)))))))
                  (let ((first_exp1 (ite (= (and (and starts_as_based1 
                                      (bool_lt1
                                        last_num_based1
                                        max1)) (bool_eq10
                                                 (to_rep1
                                                   (select (to_array str) (+ last_num_based1 1)))
                                                 (to_rep1
                                                   (select (to_array str) (+ last_num_init1 1))))) true)
                                      (+ last_num_based1 2)
                                      (+ last_num_init1 1))))
                    (ite (not
                           (= (starts_as_exponent_format_ghost
                                (let ((temp___556 (of_array
                                                    (to_array str)
                                                    first_exp1
                                                    max1)))
                                  (of_array
                                ...
                                (of_int1 0)) true))
                      first_exp1
                      (ite (let ((temp___555 (to_rep1
                                               (select (to_array str) (+ first_exp1 1)))))
                             (or (= temp___555 45) (= temp___555 43)))
                        (+ (last_number_ghost
                             (let ((temp___547 (of_array
                                                 (to_array str)
                                                 (+ first_exp1 2)
...
;; H
(assert
  (<= (to_rep ptr__pointer_value) (raw_unsigned_last_ghost
                                    str
                                    (to_rep ptr__pointer_value)
                                    max1)))
...
(define-fun lpeqrpqtresultqtunusedqtunused () Bool
  (ite (= (to_rep ptr__pointer_value2) (raw_unsigned_last_ghost
                                         str
                                         (to_rep ptr__pointer_value)
                                         max1))
    true
...
(assert
  (scan_raw_unsigned_ghost__function_guard
    (scan_raw_unsigned_ghost str (to_rep ptr__pointer_value) max1)
    str
    (to_rep ptr__pointer_value)
    max1))
  ...
  (and
    (last_number_ghost__function_guard
      ...
      (let ((temp___520 (of_array
                          ...
                          (to_rep ptr__pointer_value)
                          max1)))
        (of_array (to_array temp___520) (first temp___520) (last temp___520))))
    (and
      (forall ((last_num_init1 Int))
        (last_hexa_ghost__function_guard
          (last_hexa_ghost
            (let ((temp___511 (of_array
                                (to_array str)
                                (+ last_num_init1 2)
                                max1)))
              (of_array
      ...
      (and
        (forall ((first_exp1 Int))
          (scan_exponent_ghost__function_guard
            (scan_exponent_ghost
              (let ((temp___505 (of_array (to_array str) first_exp1 max1)))
                (of_array
                  (to_array temp___505)
                  (first temp___505)
                  (last temp___505)))
          ...
          (let ((last_num_init1 (last_number_ghost
                                  (let ((temp___520 (of_array
                                    ...
                                    (of_array
                                      ...
                                      (first temp___520)
                                      (last temp___520))))))
            (let ((init_val1 (scan_based_number_ghost
                               str
                               (to_rep ptr__pointer_value)
                               last_num_init1
                               #x0000000000000000000000000000000A
              ...
              (let ((starts_as_based1 (and (and (bool_lt1
                                                  last_num_init1
                                                  (- max1 1)) (let ((temp___515 
                                                                (to_rep1
                                                                  (select 
                                                                  (to_array
                                                                    str) (+ last_num_init1 1)))))
                                                                (or (ite (= temp___515 35)
                                                                    true
                                                                    false) 
                                                                (ite (= temp___515 58)
                                                                  true
                                                                  false)))) 
                (let ((temp___516 (to_rep1
                                    (select (to_array str) (+ last_num_init1 2)))))
                  (or (and (ite (<= 48 temp___516) true false) (ite (<= temp___516 57)
                                                                 true
                                                                 false)) (or (and 
                  (ite (<= 97 temp___516)
                    true
                    false) (ite (<= temp___516 102) true false)) (and 
                  (ite (<= 65 temp___516)
                    true
                    false) (ite (<= temp___516 70) true false))))))))
                (let ((last_num_based1 (ite (= starts_as_based1 true)
                                         (last_hexa_ghost
                                           (let ((temp___511 (of_array
                                                               (to_array str)
                                             ...
                                             (of_array
                                               ...
                                               (last temp___511))))
                                         last_num_init1)))
                  (let ((is_based1 (and (and starts_as_based1 (bool_lt1
                                                                last_num_based1
                                                                max1)) 
                    (bool_eq10
                      (to_rep1 (select (to_array str) (+ last_num_based1 1)))
                      (to_rep1 (select (to_array str) (+ last_num_init1 1)))))))
                    (let ((based_val1 (ite (and
                                             (= starts_as_based1 true)
                                             (not
                                               (= (rec__ada___system__val_lllu__impl__uns_option__overflow
                                                    (us_split_discrs1
                                                      init_val1)) true)))
                                        (scan_based_number_ghost
                                          ...
                                          (to_rep2
                                            (rec__ada___system__val_lllu__impl__uns_option__value
                                              (us_split_fields1 init_val1)))
                                          #x00000000000000000000000000000000)
                                        init_val1)))
                      (let ((first_exp1 (ite (= is_based1 true)
                                          (+ last_num_based1 2)
                                          (+ last_num_init1 1))))
                        (let ((exponqtunused (ite (= (starts_as_exponent_format_ghost
                                                       (let ((temp___508 
                                                         (of_array
                                                           (to_array str)
                                                           first_exp1
                                               ...
                                               (scan_exponent_ghost
                                                 ...
                                                 (of_int1 0))
                                               0)))
                          (let ((baseqtunused (ite (= is_based1 true)
                                                (to_rep2
                                                  (rec__ada___system__val_lllu__impl__uns_option__value
                                                    (us_split_fields1
                                                      init_val1)))
                                                #x0000000000000000000000000000000A)))
                            (let ((valueqtunused (ite (= is_based1 true)
                                                   (to_rep2
                                                     (rec__ada___system__val_lllu__impl__uns_option__value
                                                       (us_split_fields1
                                                         based_val1)))
                                  ...
                                  (us_split_fields1
                                    (exponent_unsigned_ghost
                                      (ite (= is_based1 true)
                                        (to_rep2
                                          (rec__ada___system__val_lllu__impl__uns_option__value
                                            (us_split_fields1 based_val1)))
                                        (to_rep2
                                          (rec__ada___system__val_lllu__impl__uns_option__value
                                            (us_split_fields1 init_val1))))
                                      (ite (= (starts_as_exponent_format_ghost
                                                (let ((temp___508 (of_array
                                                                    (to_array
                                                                    str)
                                                                    first_exp1
                                                                    max1)))
...
(define-fun eqqtresultqtunusedqtunused () Bool
  (ite (= res1 (scan_raw_unsigned_ghost str (to_rep ptr__pointer_value) max1))
    true
    false))
...
(assert
  (not
  (<= (to_rep1 (select (to_array str) (to_rep ptr__pointer_value))) 57)))
