...
;; H
(assert
  (= uval1 (bvsub ((_ int2bv 64) (to_rep1 (select (to_array str) p1))) #x0000000000000030)))
...
(assert
  (and
    ...
    (exists ((spark__branch2 Bool) (ptr__pointer_value2 integer) (p4 Int) (uval3 (_ BitVec 64)) (overflow2 Bool) (digit2 (_ BitVec 64)) (old_uval2 (_ BitVec 64)))
      (and
        (and
            ...
            (and
              ...
              (exists ((o5 Int))
                (and
                  ...
                  (and
                    (= digit1 (bvsub ((_ int2bv 64) o5) #x0000000000000030))
                    (and
                      (and
                        (and
                          (and
                            (exists ((spark__branch3 Bool))
                              (and
                                (= spark__branch3 (ite (bvugt digit1 #x0000000000000009)
                                                    true
                                                    false))
                                (and
                                  (= spark__branch3 true)
            ...
            (and
              ...
              (and
                ...
                (and
                  (= base2 uval2)
                  (and
                    (= uval4 #x0000000000000000)
                    (and
                      (and
                        (= spark__branch4 (ite (= (and (ite (bvule #x0000000000000002 
                                                         base2)
                                                         true
                                                         false) (ite (bvule 
                                                                  base2 #x0000000000000010)
                                                                  true
                                                                  false)) true)
                                            false
                                            true))
                        (ite (= spark__branch4 true)
                          (and
                            (= overflow3 (of_int 1))
                            (= base3 #x0000000000000010))
                          (and (= overflow3 overflow1) (= base3 base2))))
                      (and
                        (= (bvudiv (bvadd (bvsub #xFFFFFFFFFFFFFFFF base3) #x0000000000000001) 
                        base3) umax1)
                        (and
                          (dynamic_invariant4 umax1 true false true true)
                          (and
                            (= (bvudiv #xFFFFFFFFFFFFFFFF base3) umaxb)
                            (and
                              ...
                              (and
                                ...
                                (or
                                  (and
                                    (exists ((spark__branch5 Bool) (digit2 (_ BitVec 64)))
                                      (and
                                        (and
                                          (and
                                            (<= (first str) p4)
                                                          ...
                                                          (and
                                                            (= (to_rep1
                                                                 ...
                                                                 (to_array
                                                                   str) 
                                                                 p4)) o10)
                                                            (= digit2 (bvsub ((_ int2bv 64) o10) #x0000000000000030)))))
                                                              ...
                                                              (ite (= spark__branch7 true)
                                                                (and
                                                                  (and
                                                                    ...
                                                                    str) 
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 64) o10) #x0000000000000037)))))
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    str) 
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 64) o10) #x0000000000000057))))))))))))))))))))))
                                        (exists ((ptr__pointer_value4 integer) (p5 Int) (uval5 (_ BitVec 64)) (overflow4 Bool) (digit3 (_ BitVec 64)) (old_uval2 (_ BitVec 64)))
                                          (and
                                            (and
                                              (and
                                                (<= p4 p5)
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (ite (= spark__branch7 true)
                                                                    ...
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 64) o10) #x0000000000000057))))))))))))))))))))))
                                            (exists ((ptr__pointer_value4 integer) (p5 Int) (uval6 (_ BitVec 64)) (overflow4 Bool) (digit3 (_ BitVec 64)) (old_uval2 (_ BitVec 64)))
                                              (and
                                                (and
                                                  (and
                                                    (<= p4 p5)
...
(declare-const uval5 (_ BitVec 64))
...
(assert
  (ite (not (= expon1 0))
    (= o9 (ite (not (= uval3 #x0000000000000000)) true false))
    (= o9 false)))
...
(assert
  (ite (= spark__branch6 true)
    (and
      (= (bvudiv #xFFFFFFFFFFFFFFFF base1) umaxb1)
      (and
        (dynamic_invariant4 umaxb1 true false true true)
        (and
          (in_range2 expon1)
          (let ((ada___system__val_llu__impl__scan_raw_unsigned__B_6__res_val__assume 
            (exponent_unsigned_ghost
              uval3
              expon1
              base1)))
            (and
              (= ada___system__val_llu__impl__scan_raw_unsigned__B_6__res_val__assume 
              (ite (or (= expon1 0) (= uval3 #x0000000000000000))
                (us_repqtmk
                  (us_split_discrsqtmk (of_int 0))
                  (us_split_fieldsqtmk (of_rep2 uval3)))
                (ite (= (scan_overflows_ghost #x0000000000000000 base1 uval3) true)
                  (us_repqtmk
                    (us_split_discrsqtmk (of_int 1))
                    (us_split_fieldsqtmk dummy5))
                  (exponent_unsigned_ghost
                    ...
                    (let ((temp___1223 r271s))
                      (and
                        ...
                        (ite (= (and (ite (<= 1 j) true false) (ite (<= 
                                                                 ...
                                                                 true
                                                                 false)) true)
                          (exists ((uval6 (_ BitVec 64)) (j1 Int))
                            (and
                              (and
                                (=>
                                  (= overflow2 true)
