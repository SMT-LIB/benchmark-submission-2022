              ...
              (and
                ...
                (and
                  ...
                  (and
                    ...
                    (and
                      (and
                        (= spark__branch4 (ite (= (and (ite (bvule #x00000002 
                                                         base2)
                                                         true
                                                         false) (ite (bvule 
                                                                  base2 #x00000010)
                        ...
                        (ite (= spark__branch4 true)
                          (and (= overflow3 (of_int 1)) (= base3 #x00000010))
                          (and (= overflow3 overflow1) (= base3 base2))))
                      (and
                        (= (bvudiv (bvadd (bvsub #xFFFFFFFF base3) #x00000001) 
                        base3) umax1)
                        (and
                          (dynamic_invariant4 umax1 true false true true)
                          (and
                            (= (bvudiv #xFFFFFFFF base3) umaxb)
                            (and
                              ...
                              (and
                                ...
                                (or
                                  (and
                                    (exists ((spark__branch5 Bool) (digit2 (_ BitVec 32)))
                                      (and
                                        (and
                                          (and
                                            (<= (first str) p4)
                                                          ...
                                                          (and
                                                            (= (to_rep1
                                                                 ...
                                                                 (to_array
                                                                   str) 
                                                                 p4)) o10)
                                                            (= digit2 (bvsub ((_ int2bv 32) o10) #x00000030)))))
                                                              ...
                                                              (ite (= spark__branch7 true)
                                                                (and
                                                                  (and
                                                                    ...
                                                                    str) 
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 32) o10) #x00000037)))))
                                                                ...
                                                                (and
                                                                  ...
                                                                  (exists 
                                                                    ...
                                                                    str) 
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 32) o10) #x00000057))))))))))))))))))))))
                                        (exists ((ptr__pointer_value4 integer) (p5 Int) (uval5 (_ BitVec 32)) (overflow4 Bool) (digit3 (_ BitVec 32)) (old_uval2 (_ BitVec 32)))
                                          (and
                                            (and
                                              (and
                                                (<= p4 p5)
                                                              ...
                                                              (exists 
                                                                ...
                                                                (and
                                                                  ...
                                                                  (ite (= spark__branch7 true)
                                                                    ...
                                                                    p4)) o10)
                                                                    (= digit2 (bvsub ((_ int2bv 32) o10) #x00000057))))))))))))))))))))))
                                            (exists ((ptr__pointer_value4 integer) (p5 Int) (uval6 (_ BitVec 32)) (overflow4 Bool) (digit3 (_ BitVec 32)) (old_uval2 (_ BitVec 32)))
                                              (and
                                                (and
                                                  (and
                                                    (<= p4 p5)
...
(assert
  (ite (not (= expon1 0))
    (= o9 (ite (not (= uval3 #x00000000)) true false))
    (= o9 false)))
        ...
        (and
          ...
          (let ((ada___system__val_uns__impl__scan_raw_unsigned__B_6__res_val__assume 
            ...
            (and
              ...
              (ite (or (= expon1 0) (= uval3 #x00000000))
                (us_repqtmk
                  (us_split_discrsqtmk (of_int 0))
                  (us_split_fieldsqtmk (of_rep2 uval3)))
                (ite (= (scan_overflows_ghost #x00000000 base1 uval3) true)
                  (us_repqtmk
                    (us_split_discrsqtmk (of_int 1))
                    (us_split_fieldsqtmk dummy5))
                  (exponent_unsigned_ghost
                    ...
                    (let ((temp___1223 r271s))
                      (and
                        ...
                        (ite (= (and (ite (<= 1 j) true false) (ite (<= 
                                                                 ...
                                                                 true
                                                                 false)) true)
                          (exists ((uval6 (_ BitVec 32)) (j1 Int))
                            (and
                              (and
                                (=>
                                  (= overflow2 true)
