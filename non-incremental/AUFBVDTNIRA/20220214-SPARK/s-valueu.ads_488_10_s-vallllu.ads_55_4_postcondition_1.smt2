...
;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_631 us_t) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool
  (=>
    ...
    (and
      ...
      (= (last temp___expr_631) (length str)))))

;; default_initial_assumption
(define-fun default_initial_assumption ((temp___expr_633 us_t) (temp___skip_top_level_634 Bool)) Bool
  (and (= (first temp___expr_633) 1) (= (last temp___expr_633) (length str))))
...
(declare-const ada___system__val_lllu__impl__slide_to_1__result us_t)

;; H
(assert
  (= ada___system__val_lllu__impl__slide_to_1__result (of_array
                                                        (to_array
                                                          (of_array
                                                            (slide
                                                              (to_array str)
...
;; Goal def'vc
;; File "s-valueu.ads", line 485, characters 0-0
(assert
  (not
  (=>
    (forall ((j Int))
      (=>
        ...
        (= (to_rep
             (select (to_array
                       ada___system__val_lllu__impl__slide_to_1__result) (+ (- j 
             (first
               str)) 1))) 32)))
    (=>
      (only_space_ghost__function_guard
