...
(assert
  (forall ((str1 us_t))
    (! (=>
         (and
           (dynamic_invariant str1 true true true true)
           (and
             (not
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (and
             ...
             (let ((minus_sign (bool_eq7
                                 (to_rep
                                   (select (to_array str1) (+ (first str1) 1)))
                                 45)))
               (let ((sign (or (bool_eq7
                                 (to_rep
                                   (select (to_array str1) (+ (first str1) 1)))
                                 43) minus_sign)))
                 (and
           ...
           (and
             (forall ((str2 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 ...
                 start
                 0))
             (= (scan_exponent_ghost str1 real__) (let ((plus_sign (bool_eq7
                                                                    (to_rep
                                                                    (select 
                                                                    (to_array
                                                                    str1) (+ 
...
(define-fun only_hexa_ghost ((str1 us_t) (from Int) (to__ Int)) Bool
  (ite (forall ((j Int))
         (=>
           (and (<= from j) (<= j to__))
           (let ((temp___174 (to_rep (select (to_array str1) j))))
             (or
             ...
             (not
               (= (let ((temp___284 (temp___String_Literal_270 Tuple0)))
                    (bool_eq4
                      ...
                      1
                      0)) true))
             (let ((temp___285 (to_rep (select (to_array str1) (first str1)))))
               (or
               ...
               (and
                 (and
                   (and
                     ...
                     (dynamic_invariant1 from true true true true))
                   (dynamic_invariant1 to__ true true true true))
                 (dynamic_invariant2 base true true true true))
               (dynamic_invariant2 acc true true true true))
...
(assert
  (and
    (<= (first str) (first_non_space_ghost str (first str) (last str)))
    (<= (first_non_space_ghost str (first str) (last str)) (last str))))
...
(assert
  (ite (= o 43)
    (let ((o1 (+ (first_non_space_ghost str (first str) (last str)) 1)))
      (and (= fst_num o1) (in_range1 o1)))
    (= fst_num (first_non_space_ghost str (first str) (last str)))))

;; Goal def'vc
;; File "s-valueu.ads", line 523, characters 0-0
(assert
  (not (<= 48 (to_rep (select (to_array str) fst_num)))))
