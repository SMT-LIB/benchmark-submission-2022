...
;; bool_eq
(define-fun bool_eq6 ((x (_ BitVec 128)) (y (_ BitVec 128))) Bool
  (ite (= x y) true false))
...
(declare-datatypes ((t89s__ref 0))
  (((t89s__refqtmk (t89s__content us_rep)))))

;; t89s__ref_t89s__content__2__projection
(define-fun t89s__ref_t89s__content__2__projection ((a t89s__ref)) us_rep
  (t89s__content a))

(declare-datatypes ((t114s__ref 0))
  (((t114s__refqtmk (t114s__content us_t)))))

;; t114s__ref_t114s__content__projection
(define-fun t114s__ref_t114s__content__projection ((a t114s__ref)) us_t
  (t114s__content a))
...
(declare-datatypes ((t281s__ref 0))
  (((t281s__refqtmk (t281s__content us_rep)))))

;; t281s__ref_t281s__content__projection
(define-fun t281s__ref_t281s__content__projection ((a t281s__ref)) us_rep
  (t281s__content a))
...
;; bool_eq
(define-fun bool_eq9 ((x Bool) (y Bool)) Bool
  (ite (= x y) true false))
...
(declare-datatypes ((t89s__ref1 0))
  (((t89s__refqtmk1 (t89s__content1 us_t)))))

;; t89s__ref_t89s__content__projection
(define-fun t89s__ref_t89s__content__projection ((a t89s__ref1)) us_t
  (t89s__content1 a))
...
(define-fun ada___system__val_lllu__impl__uns_option__value__pred ((a us_rep1)) Bool
  (= (to_int2
...
(define-fun default_initial_assumption ((temp___expr_254 us_rep1) (temp___skip_top_level_255 Bool)) Bool
  (and
    (= (rec__ada___system__val_lllu__impl__uns_option__overflow
...
;; only_hexa_ghost
(define-fun only_hexa_ghost ((str1 us_t) (from Int) (to__ Int)) Bool
  (ite (forall ((j Int))
         (=>
           (and (<= from j) (<= j to__))
           (let ((temp___174 (to_rep1 (select (to_array str1) j))))
             (or
    ...
    (forall ((from Int) (to__ Int))
      (forall ((base (_ BitVec 128)) (acc (_ BitVec 128)))
        (! (=>
             ...
             (= (scan_based_number_ghost str1 from to__ base acc) (ite (< to__ from)
    ...
    (! (and
         ...
         (and
           (forall ((str2 us_t) (last_num_init Int))
             (last_hexa_ghost__function_guard
               (last_hexa_ghost
                 (let ((temp___412 (let ((temp___411 (last str2)))
                 ...
                 (let ((starts_as_based (and (and (bool_lt1
                   ...
                   (let ((last_num_based (ite (= starts_as_based true)
                     ...
                     (and
                       ...
                       (= (is_opt_exponent_format_ghost
                            (let ((temp___408 (let ((temp___407 (last str1)))
                                                (of_array
                                                  (to_array str1)
    ...
    (forall ((from Int) (to__ Int))
      (! (and
           (forall ((str2 us_t) (from1 Int) (to__1 Int))
             (last_number_ghost__function_guard
               (last_number_ghost
                 (let ((temp___500 (of_array (to_array str2) from1 to__1)))
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___524 (to_rep1 (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___542 (of_array (to_array str2) from1 to__1)))
             ...
             (and
               (and
                 (and
                   ...
                   (and (<= (first str1) from) (<= from (last str1))))
                 (and (<= from to__) (<= to__ (last str1))))
               (let ((temp___572 (to_rep1 (select (to_array str1) from))))
...
;; fst_num__def_axiom
(assert
  (= fst_num (ite (= (to_rep1 (select (to_array str) non_blank)) 43)
               (+ non_blank 1)
               non_blank)))

;; dynamic_invariant
(define-fun dynamic_invariant7 ((temp___expr_914 us_t) (temp___is_init_910 Bool) (temp___skip_constant_911 Bool) (temp___do_toplevel_912 Bool) (temp___do_typ_inv_913 Bool)) Bool
  (=>
    (not (= temp___skip_constant_911 true))
    (and
      (and
        (dynamic_property
          1
          (length str)
          (first temp___expr_914)
          (last temp___expr_914))
        (= (first temp___expr_914) 1))
      (= (last temp___expr_914) (length str)))))

;; default_initial_assumption
(define-fun default_initial_assumption2 ((temp___expr_916 us_t) (temp___skip_top_level_917 Bool)) Bool
  (and (= (first temp___expr_916) 1) (= (last temp___expr_916) (length str))))
...
(declare-const ada___system__val_lllu__impl__value_unsigned__result (_ BitVec 128))
...
(declare-const ada___system__val_lllu__impl__value_unsigned__B_9__fst_num__assume Int)
...
(declare-const p_acc__pointer_value1 integer)
...
(assert
  (and
    (forall ((temp___compl_1299 us_t))
      (slide_if_necessary__function_guard
        (slide_if_necessary temp___compl_1299)
        temp___compl_1299))
    (and
      (forall ((temp___compl_1299 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_1299))
      (and
        (forall ((temp___compl_1299 us_t) (temp___1300 (_ BitVec 128)))
          (is_value_unsigned_ghost__function_guard
            (is_value_unsigned_ghost
              (slide_if_necessary temp___compl_1299)
              temp___1300)
            ...
            temp___1300))
        (and
          (forall ((o2 Int) (o3 us_t) (ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume Int))
            (only_space_ghost__function_guard
              (only_space_ghost
                o3
                o2
                (- ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume 1))
              o3
              o2
              (- ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume 1)))
          (and
            (forall ((o2 Int) (o3 us_t))
              (first_non_space_ghost__function_guard
                (first_non_space_ghost o3 (to_rep p_acc__pointer_value) o2)
                o3
                (to_rep p_acc__pointer_value)
                o2))
            (and
              (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                (raw_unsigned_overflows_ghost__function_guard
                  (raw_unsigned_overflows_ghost o3 fst_num1 o2)
                  o3
                  fst_num1
                  o2))
              (and
                (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                  (scan_raw_unsigned_ghost__function_guard
                    (scan_raw_unsigned_ghost o3 fst_num1 o2)
                    o3
                    fst_num1
                    o2))
                (and
                  (forall ((o2 Int) (o3 us_t) (fst_num1 Int))
                    (raw_unsigned_last_ghost__function_guard
                      (raw_unsigned_last_ghost o3 fst_num1 o2)
                      o3
                      fst_num1
                      o2))
                  (ite (= spark__branch true)
                    (and
                      ...
                      (let ((temp___1297 (of_array
                                           ...
                                           1
                                           (length str))))
                        (let ((temp___compl_1299 (of_array
                                                   (to_array temp___1297)
                                                   (first temp___1297)
                                                   (last temp___1297))))
                          (let ((temp___1300 (value_unsigned
                                               temp___compl_1299)))
                            (and
                              (and
                                (value_unsigned__function_guard
                                ...
                                (and
                                  ...
                                  (= (is_value_unsigned_ghost
                                       (slide_if_necessary temp___compl_1299)
                                       temp___1300) true)))
                              (= ada___system__val_lllu__impl__value_unsigned__result temp___1300))))))
                    (and
                      ...
                      (and
                        ...
                        (and
                          ...
                          (let ((o2 (last str)))
                            (let ((o3 (first str)))
                              (let ((o4 str))
                                (let ((ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume 
                                  (first_non_space_ghost
                                    o4
                                    o3
                                    o2)))
                                  (and
                                    (and
                                      (first_non_space_ghost__function_guard
                                        ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume
                                        o4
                                        o3
                                        o2)
                                      (and
                                        ...
                                        (and
                                          (and
                                            (and
                                              (<= o3 ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume)
                                              (<= ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume o2))
                                            (not
                                              (= (to_rep1
                                                   (select (to_array o4) ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume)) 32)))
                                          (= (only_space_ghost
                                               o4
                                               o3
                                               (- ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume 1)) true))))
                                    (and
                                      (= ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume 
                                      non_blank)
                                      (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              (ite (= o1 43)
                                                (let ((o5 (+ non_blank 1)))
                                                  (and
                                                    (= ada___system__val_lllu__impl__value_unsigned__B_9__fst_num__assume o5)
                                                    (in_range o5)))
                                                (= ada___system__val_lllu__impl__value_unsigned__B_9__fst_num__assume 
                                                non_blank))))
                                          (and
                                            (= ada___system__val_lllu__impl__value_unsigned__B_9__fst_num__assume 
                                            fst_num)
                                            (and
                                              ...
                                              (and
                                                (= (to_rep o) p)
                                                (and
                                                  (= p_acc__pointer_value 
                                                  o)
                                                  (and
                                                    (= p_acc__is_null_pointer false)
                                                    (and
                                                      (= p_acc__is_moved_pointer false)
                                                      (and
                                                        (and
                                                          (not
                                                            (= (rec__ada___system__val_lllu__impl__T86s__is_null_pointer
                                                                 usf) true))
                                                          (= false (rec__ada___system__val_lllu__impl__T86s__is_null_pointer
                                                                    usf)))
                                                        (and
                                                              ...
                                                              (let ((o5 
                                                                ...
                                                                (let ((o6 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    p_acc__brower_at_end 
                                                                    (us_repqtmk
                                                                    p_acc__is_null_pointer
                                                                    p_acc__is_moved_pointer
                                                                    p_acc__pointer_value1))
                                                                    (and
                                                                    (= 
                                                                    p1 
                                                                    ...
                                                                    p1)
                                                                    (= 
                                                                    ada___system__val_lllu__impl__value_unsigned__result 
                                                                    v1))))))))))))))))))))))))))))))))))))))

;; Goal def'vc
;; File "s-valueu.ads", line 539, characters 0-0
(assert
  (not
  (=>
    (slide_if_necessary__function_guard (slide_if_necessary str) str)
    (=>
      ...
      (=>
        ...
        (= (is_value_unsigned_ghost
             (slide_if_necessary str)
             ada___system__val_lllu__impl__value_unsigned__result) true))))))
