...
;; bool_eq
(define-fun bool_eq10 ((a us_rep1) (b us_rep1)) Bool
  (ite (and
         (= (rec__ada___system__val_lllu__impl__T86s__is_null_pointer a) 
...
(declare-datatypes ((t89s__ref 0))
  (((t89s__refqtmk (t89s__content us_rep1)))))

;; t89s__ref_t89s__content__2__projection
(define-fun t89s__ref_t89s__content__2__projection ((a t89s__ref)) us_rep1
  (t89s__content a))
...
(declare-datatypes ((t291s__ref 0))
  (((t291s__refqtmk (t291s__content us_rep1)))))

;; t291s__ref_t291s__content__projection
(define-fun t291s__ref_t291s__content__projection ((a t291s__ref)) us_rep1
  (t291s__content a))
...
(declare-datatypes ((t290s__ref 0))
  (((t290s__refqtmk (t290s__content us_t)))))

;; t290s__ref_t290s__content__projection
(define-fun t290s__ref_t290s__content__projection ((a t290s__ref)) us_t
  (t290s__content a))
...
(declare-const p_acc__brower_at_end us_rep1)
...
(assert
  (and
    (forall ((temp___compl_1367 us_t))
      (slide_if_necessary__function_guard
        (slide_if_necessary temp___compl_1367)
        temp___compl_1367))
    (and
      (forall ((temp___compl_1367 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_1367))
      (and
        (forall ((temp___compl_1367 us_t) (temp___1368 (_ BitVec 128)))
          (is_value_unsigned_ghost__function_guard
            (is_value_unsigned_ghost
              (slide_if_necessary temp___compl_1367)
              temp___1368)
        ...
        (and
          ...
          (and
            (is_raw_unsigned_format_ghost__function_guard
              (is_raw_unsigned_format_ghost
                (let ((temp___1373 (of_array
                                     (to_array str)
                                     fst_num
                                     (last str))))
                  (of_array
                    (to_array temp___1373)
                    (first temp___1373)
                    (last temp___1373))))
              (let ((temp___1373 (of_array (to_array str) fst_num (last str))))
                (of_array
                  (to_array temp___1373)
                  (first temp___1373)
                  (last temp___1373))))
                              ...
                              (ite (= spark__branch true)
                                (and
                                  ...
                                  (let ((temp___1365 (of_array
                                                       ...
                                                       1
                                                       (length str))))
                                    (let ((temp___compl_1367 (of_array
                                                               (to_array
                                                                 temp___1365)
                                                               (first
                                                                 temp___1365)
                                                               (last
                                                                 temp___1365))))
                                      (let ((temp___1368 (value_unsigned
                                                           temp___compl_1367)))
                                        (and
                                          (and
                                            (value_unsigned__function_guard
                                            ...
                                            (and
                                              ...
                                              (= (is_value_unsigned_ghost
                                                   (slide_if_necessary
                                                     temp___compl_1367)
                                                   temp___1368) true)))
                                          (= ada___system__val_lllu__impl__value_unsigned__result temp___1368))))))
                                (and
                                  (dynamic_invariant3
                                    v
                                    false
                                                      ...
                                                      (and
                                                        ...
                                                        (not
                                                          (= (to_rep1
                                                               (select 
                                                               (to_array
                                                                 o4) ada___system__val_lllu__impl__value_unsigned__B_9__non_blank__assume)) 32)))
                                                      (= (only_space_ghost
                                                           o4
                                                           o3
