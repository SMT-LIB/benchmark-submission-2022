...
;; user_eq
(declare-fun user_eq4 (long_long_unsigned
  long_long_unsigned) Bool)

(declare-const dummy4 long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_245 (_ BitVec 64)) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool
  true)
...
(define-fun ada___system__val_llu__impl__uns_option__value__pred ((a us_rep1)) Bool
  (= (to_int2
...
(declare-const ada___system__val_llu__impl__value_unsigned__result (_ BitVec 64))
...
(declare-const ada___system__val_llu__impl__value_unsigned__B_9__fst_num__assume Int)
    ...
    (and
      (forall ((temp___compl_1299 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_1299))
      (and
        (forall ((temp___compl_1299 us_t) (temp___1300 (_ BitVec 64)))
          (is_value_unsigned_ghost__function_guard
            (is_value_unsigned_ghost
              (slide_if_necessary temp___compl_1299)
              temp___1300)
            ...
            temp___1300))
        (and
          (forall ((o2 Int) (o3 us_t) (ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume Int))
            (only_space_ghost__function_guard
              (only_space_ghost
                o3
                o2
                (- ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume 1))
              o3
              o2
              (- ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume 1)))
          (and
                              ...
                              (and
                                ...
                                (and
                                  ...
                                  (= (is_value_unsigned_ghost
                                       (slide_if_necessary temp___compl_1299)
                                       temp___1300) true)))
                              (= ada___system__val_llu__impl__value_unsigned__result temp___1300))))))
                    (and
                      ...
                      (and
                        ...
                        (and
                          ...
                          (let ((o2 (last str)))
                            (let ((o3 (first str)))
                              (let ((o4 str))
                                (let ((ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume 
                                  (first_non_space_ghost
                                    o4
                                    o3
                                    o2)))
                                  (and
                                    (and
                                      (first_non_space_ghost__function_guard
                                        ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume
                                        o4
                                        o3
                                        o2)
                                      (and
                                        ...
                                        (and
                                          (and
                                            (and
                                              (<= o3 ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume)
                                              (<= ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume o2))
                                            (not
                                              (= (to_rep1
                                                   (select (to_array o4) ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume)) 32)))
                                          (= (only_space_ghost
                                               o4
                                               o3
                                               (- ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume 1)) true))))
                                    (and
                                      (= ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume 
                                      non_blank)
                                      (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              ...
                                              (ite (= o1 43)
                                                (let ((o5 (+ non_blank 1)))
                                                  (and
                                                    (= ada___system__val_llu__impl__value_unsigned__B_9__fst_num__assume o5)
                                                    (in_range o5)))
                                                (= ada___system__val_llu__impl__value_unsigned__B_9__fst_num__assume 
                                                non_blank))))
                                          (and
                                            (= ada___system__val_llu__impl__value_unsigned__B_9__fst_num__assume 
                                            fst_num)
                                                      ...
                                                      (and
                                                        (and
                                                          (not
                                                            (= (rec__ada___system__val_llu__impl__T86s__is_null_pointer
                                                                 usf) true))
                                                          (= false (rec__ada___system__val_llu__impl__T86s__is_null_pointer
                                                                    usf)))
                                                        (and
                                                              ...
                                                              (let ((o5 
                                                                ...
                                                                (let ((o6 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    p1)
                                                                    (= 
                                                                    ada___system__val_llu__impl__value_unsigned__result 
                                                                    v1))))))))))))))))))))))))))))))))))))))
  ...
  (=>
    ...
    (=>
      ...
      (=>
        ...
        (= (is_value_unsigned_ghost
             (slide_if_necessary str)
             ada___system__val_llu__impl__value_unsigned__result) true))))))
