    ...
    (and
      (forall ((temp___compl_1367 us_t))
        (slide_if_necessary__function_guard
          ...
          temp___compl_1367))
      (and
        (forall ((temp___compl_1367 us_t) (temp___1368 (_ BitVec 64)))
          (is_value_unsigned_ghost__function_guard
            (is_value_unsigned_ghost
              (slide_if_necessary temp___compl_1367)
              temp___1368)
                                            ...
                                            (and
                                              ...
                                              (= (is_value_unsigned_ghost
                                                   (slide_if_necessary
                                                     temp___compl_1367)
                                                   temp___1368) true)))
                                          (= ada___system__val_llu__impl__value_unsigned__result temp___1368))))))
                                (and
                                  (dynamic_invariant3
                                    v
                                    false
                                                      ...
                                                      (and
                                                        ...
                                                        (not
                                                          (= (to_rep1
                                                               (select 
                                                               (to_array
                                                                 o4) ada___system__val_llu__impl__value_unsigned__B_9__non_blank__assume)) 32)))
                                                      (= (only_space_ghost
                                                           o4
                                                           o3
