...
;; Assume
(assert (dynamic_invariant1 str1 true false true true))

;; Assume
(assert (dynamic_invariant1 str2 true false true true))
      ...
      (and
        (and
          (and
            ...
            (not (= (last str2) 2147483647)))
          (or
            (< to__ from)
            (and (<= (first str1) from) (<= to__ (last str1)))))
        (or (< to__ from) (and (<= (first str2) from) (<= to__ (last str2)))))
      (= (only_hexa_ghost str1 from to__) true))
    (forall ((j Int))
      (=>
        (and (<= from j) (<= j to__))
        (= (to_rep (select (to_array str1) j)) (to_rep
                                                 (select (to_array str2) j)))))))

(declare-const spark__branch Bool)

;; H
(assert (= spark__branch (ite (< to__ from) true false)))
...
(assert
  (or
    ...
    (and
      ...
      (exists ((o Int))
        (and
          (= (to_rep (select (to_array str1) from)) o)
          (exists ((spark__branch1 Bool))
            (and
              (= spark__branch1 (ite (= o 95) true false))
              (ite (= spark__branch1 true)
                (let ((o1 (+ from 1)))
                  (and
                    (in_range1 o1)
                    (let ((temp___compl_1397 to__))
                      (let ((temp___compl_1398 base))
                        (let ((temp___compl_1399 acc))
                          (= (bool_eq8
                               (scan_based_number_ghost
                                 str1
                                 o1
                ...
                (let ((o1 acc))
                  (let ((o2 base))
                    (and
                      ...
                      (exists ((o3 Int))
                        (and
                          (= (to_rep (select (to_array str1) from)) o3)
                          (let ((o4 (hexa_to_unsigned_ghost o3)))
                            (and
                              (and
                                (dynamic_invariant2 o4 true false true true)
                                (= o4 (ite (and (<= 48 o3) (<= o3 57))
                                        (bvsub (of_int o3) #x00000000000000000000000000000030)
                                        (ite (and (<= 97 o3) (<= o3 102))
                                          (bvadd (bvsub (of_int o3) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                                          (ite (and (<= 65 o3) (<= o3 70))
                                            (bvadd (bvsub (of_int o3) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                                            (to_rep2 dummy4))))))
                              (let ((o5 (scan_overflows_ghost o4 o2 o1)))
                                (and
                                  (=
                                    (= o5 true)
                                    (or
                                      (or
                                        (bvuge o4 o2)
                                        (bvugt o1 (bvudiv #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF o2)))
                                      (bvult (bvsub #xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF o4) (bvmul o2 o1))))
                                    ...
                                    (and
                                      ...
                                      (or
                                        ...
                                        (let ((o6 (+ from 1)))
                                          (and
                                            (in_range1 o6)
                                            (let ((temp___compl_1391 
                                              to__))
                                              (let ((temp___compl_1392 
                                                base))
                                                (and
                                                  (and
                                                    (<= (first str1) 
                                                        ...
                                                        (and
                                                          (and
                                                            ...
                                                            (= o8 (ite 
                                                                    ...
                                                                    (bvsub 
                                                                    (of_int
                                                                    o7) #x00000000000000000000000000000030)
                                                                    (ite 
                                                                    (and
                                                                    (<= 97 o7)
                                                                    (<= o7 102))
                                                                    (bvadd (bvsub 
                                                                    (of_int
                                                                    o7) #x00000000000000000000000000000061) #x0000000000000000000000000000000A)
                                                                    (ite 
                                                                    (and
                                                                    (<= 65 o7)
                                                                    (<= o7 70))
                                                                    (bvadd (bvsub 
                                                                    (of_int
                                                                    o7) #x00000000000000000000000000000041) #x0000000000000000000000000000000A)
                                                                    (to_rep2
                                                                    dummy4))))))
                                                          (let ((temp___compl_1393 (bvadd (bvmul 
                                                            base acc) o8)))
                                                            (= (bool_eq8
                                                                 (scan_based_number_ghost
                                                                   str1
                                                                 ...
                                                                 (scan_based_number_ghost
                                                                   ...
                                                                   temp___compl_1391
                                                                   temp___compl_1392
                                                                   temp___compl_1393)) true)))))))))))))))))))))))))))))))

;; Goal def'vc
;; File "s-valueu.ads", line 553, characters 0-0
(assert
  (not
  (= (bool_eq8
       (scan_based_number_ghost str1 from to__ base acc)
       (scan_based_number_ghost str2 from to__ base acc)) true)))
