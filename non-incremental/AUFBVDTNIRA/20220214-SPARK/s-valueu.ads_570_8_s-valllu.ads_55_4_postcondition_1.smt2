            ...
            (and
              ...
              (ite (= spark__branch1 true)
                (let ((o1 (+ from 1)))
                  (and
                    (in_range1 o1)
                    (let ((temp___compl_1318 to__))
                      (let ((temp___compl_1319 base))
                        (let ((temp___compl_1320 acc))
                          (= (bool_eq8
                               (scan_based_number_ghost
                                 str1
                                 o1
                            ...
                            (and
                              (and
                                ...
                                (= o4 (ite (and (<= 48 o3) (<= o3 57))
                                        (bvsub ((_ int2bv 64) o3) #x0000000000000030)
                                        (ite (and (<= 97 o3) (<= o3 102))
                                          (bvadd (bvsub ((_ int2bv 64) o3) #x0000000000000061) #x000000000000000A)
                                          (ite (and (<= 65 o3) (<= o3 70))
                                            (bvadd (bvsub ((_ int2bv 64) o3) #x0000000000000041) #x000000000000000A)
                                            (to_rep2 dummy4))))))
                                ...
                                (and
                                  (=
                                    ...
                                    (or
                                      (or
                                        (bvuge o4 o2)
                                        (bvugt o1 (bvudiv #xFFFFFFFFFFFFFFFF o2)))
                                      (bvult (bvsub #xFFFFFFFFFFFFFFFF o4) (bvmul o2 o1))))
                                    ...
                                    (and
                                      ...
                                      (or
                                        ...
                                        (let ((o6 (+ from 1)))
                                          (and
                                            (in_range1 o6)
                                            (let ((temp___compl_1312 
                                              to__))
                                              (let ((temp___compl_1313 
                                                base))
                                                (and
                                                  (and
                                                    (<= (first str1) 
                                                        ...
                                                        (and
                                                          (and
                                                            ...
                                                            (= o8 (ite 
                                                                    ...
                                                                    (<= 48 o7)
                                                                    (<= o7 57))
                                                                    (bvsub ((_ int2bv 64) o7) #x0000000000000030)
                                                                    (ite 
                                                                    (and
                                                                    (<= 97 o7)
                                                                    (<= o7 102))
                                                                    (bvadd (bvsub ((_ int2bv 64) o7) #x0000000000000061) #x000000000000000A)
                                                                    (ite 
                                                                    (and
                                                                    (<= 65 o7)
                                                                    (<= o7 70))
                                                                    (bvadd (bvsub ((_ int2bv 64) o7) #x0000000000000041) #x000000000000000A)
                                                                    (to_rep2
                                                                    dummy4))))))
                                                          (let ((temp___compl_1314 (bvadd (bvmul 
                                                            base acc) o8)))
                                                            (= (bool_eq8
                                                                 (scan_based_number_ghost
                                                                   str1
