                            ...
                            (and
                              (and
                                ...
                                (= o4 (ite (and (<= 48 o3) (<= o3 57))
                                        (bvsub (of_int o3) #x0000000000000030)
                                        (ite (and (<= 97 o3) (<= o3 102))
                                          (bvadd (bvsub (of_int o3) #x0000000000000061) #x000000000000000A)
                                          (ite (and (<= 65 o3) (<= o3 70))
                                            (bvadd (bvsub (of_int o3) #x0000000000000041) #x000000000000000A)
                                            (to_rep2 dummy4))))))
                                                        ...
                                                        (and
                                                          (and
                                                            ...
                                                            (= o8 (ite 
                                                                    ...
                                                                    (bvadd (bvsub 
                                                                    (of_int
                                                                    o7) #x0000000000000061) #x000000000000000A)
                                                                    (ite 
                                                                    (and
                                                                    (<= 65 o7)
                                                                    (<= o7 70))
                                                                    (bvadd (bvsub 
                                                                    (of_int
                                                                    o7) #x0000000000000041) #x000000000000000A)
                                                                    (to_rep2
                                                                    dummy4))))))
