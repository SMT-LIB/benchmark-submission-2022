                            ...
                            (and
                              (and
                                ...
                                (= o4 (ite (and (<= 48 o3) (<= o3 57))
                                        (bvsub (of_int o3) #x00000030)
                                        (ite (and (<= 97 o3) (<= o3 102))
                                          (bvadd (bvsub (of_int o3) #x00000061) #x0000000A)
                                          (ite (and (<= 65 o3) (<= o3 70))
                                            (bvadd (bvsub (of_int o3) #x00000041) #x0000000A)
                                            (to_rep2 dummy4))))))
                                ...
                                (and
                                  (=
                                    ...
                                    (or
                                      (or
                                        (bvuge o4 o2)
                                        (bvugt o1 (bvudiv #xFFFFFFFF o2)))
                                      (bvult (bvsub #xFFFFFFFF o4) (bvmul o2 o1))))
