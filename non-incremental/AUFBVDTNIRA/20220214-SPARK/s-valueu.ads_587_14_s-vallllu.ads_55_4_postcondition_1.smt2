...
(define-fun wrap_option ((value (_ BitVec 128))) us_rep
  (let ((temp___overflow_169 (of_int 0)))
    (us_repqtmk
    ...
    (let ((o2 (+ last_num_init 1)))
      (and
        ...
        (and
          ...
          (and
            (= (to_rep (select (to_array str) o2)) temp___1333)
            (ite (= temp___1333 35)
              (= o1 true)
              (= o1 (ite (= temp___1333 58) true false)))))))
    (= o1 false)))
    ...
    (let ((o2 (+ last_num_init 2)))
      (and
        ...
        (and
          (and (<= (first str) o2) (<= o2 (last str)))
          (and
            (= (to_rep (select (to_array str) o2)) temp___1335)
            (ite (= (and (ite (<= 48 temp___1335) true false) (ite (<= 
                                                                temp___1335 57)
                                                                true
                                                                false)) true)
              ...
              (ite (= (and (ite (<= 97 temp___1335) true false) (ite (<= 
                                                                  temp___1335 102)
                                                                  true
                                                                  false)) true)
                true
                (and (ite (<= 65 temp___1335) true false) (ite (<= temp___1335 70)
                                                            true
                                                            false)))))))))
          ...
          (and
            (=>
              ...
              (and
                (and (<= (first str) o2) (<= o2 (last str)))
                (and
                  (<= (first str) temp___1340)
                  (<= temp___1340 (last str)))))
            (let ((temp___1341 (of_array (to_array str) o2 temp___1340)))
              (let ((o3 (of_array
                          (to_array temp___1341)
                          (first temp___1341)
                          (last temp___1341))))
                (and
...
(assert
  (= (is_opt_exponent_format_ghost
       (let ((temp___1349 (of_array
                            (to_array str)
                            (+ (last str) 1)
                            (last str))))
         (of_array
           (to_array temp___1349)
           (first temp___1349)
           (last temp___1349)))
       (of_int 0)) true))
...
(assert
  (= (is_natural_format_ghost
       (let ((temp___1357 (of_array
                            (to_array str)
                            (+ (first str) 1)
                            (last str))))
         (of_array
           (to_array temp___1357)
           (first temp___1357)
           (last temp___1357)))) true))
...
(assert
  (and
    (is_raw_unsigned_format_ghost__function_guard
      (is_raw_unsigned_format_ghost
        (let ((temp___1365 (of_array
                             (to_array str)
                             (+ (first str) 1)
                             (last str))))
          (of_array
            (to_array temp___1365)
            (first temp___1365)
            (last temp___1365))))
      (let ((temp___1365 (of_array
                           (to_array str)
