...
;; wrap_option
(define-fun wrap_option ((value (_ BitVec 128))) us_rep
  (let ((temp___overflow_169 (of_int1 0)))
    (us_repqtmk
      (us_split_discrsqtmk temp___overflow_169)
      (us_split_fieldsqtmk (of_rep2 value)))))
...
;; only_decimal_ghost
(define-fun only_decimal_ghost ((str us_t) (from Int) (to__ Int)) Bool
  (ite (forall ((j Int))
         (=>
           (and (<= from j) (<= j to__))
           (let ((temp___171 (to_rep (select (to_array str) j))))
             (and (<= 48 temp___171) (<= temp___171 57)))))
    true
    false))
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_245 (_ BitVec 128)) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool
  true)
      ...
      (! (=>
           (and
             (and
               ...
               (dynamic_invariant4 exp1 true true true true))
             (dynamic_invariant3 base true true true true))
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___378 (let ((temp___377 (last str)))
                                      (of_array
                                        (to_array str)
                                        (ite (let ((temp___381 (to_rep
                                                                 (select 
                                                                 (to_array
                                                                   str) (+ 
                                                                 (first
             ...
             (and
               ...
               (and
                 (and
                   ...
                   (let ((temp___524 (to_rep (select (to_array str) from))))
    ...
    (! (and
         ...
         (and
           (forall ((str1 us_t) (fst_num Int))
             (is_raw_unsigned_format_ghost__function_guard
               (is_raw_unsigned_format_ghost
                 (let ((temp___670 (let ((temp___669 (last str1)))
                                     (of_array
                                       (to_array str1)
                                       fst_num
                                       temp___669))))
                   (let ((temp___671 (to_array temp___670)))
                     (of_array
                       temp___671
                       (first temp___670)
                       (last temp___670)))))
               (let ((temp___670 (let ((temp___669 (last str1)))
                                   (of_array
                                     ...
                                     temp___669))))
                 (let ((temp___671 (to_array temp___670)))
                   (of_array temp___671 (first temp___670) (last temp___670))))))
           (and
             (forall ((str1 us_t) (fst_num Int))
               (raw_unsigned_overflows_ghost__function_guard
...
(declare-const val__ (_ BitVec 128))
...
(declare-datatypes ((t257s__ref 0))
  (((t257s__refqtmk (t257s__content us_t)))))

;; t257s__ref_t257s__content__projection
(define-fun t257s__ref_t257s__content__projection ((a t257s__ref)) us_t
  (t257s__content a))

(declare-datatypes ((t259s__ref 0))
  (((t259s__refqtmk (t259s__content us_t)))))

;; t259s__ref_t259s__content__projection
(define-fun t259s__ref_t259s__content__projection ((a t259s__ref)) us_t
  (t259s__content a))

(declare-datatypes ((t261s__ref 0))
  (((t261s__refqtmk (t261s__content us_t)))))

;; t261s__ref_t261s__content__projection
(define-fun t261s__ref_t261s__content__projection ((a t261s__ref)) us_t
  (t261s__content a))

(declare-datatypes ((t263s__ref 0))
  (((t263s__refqtmk (t263s__content us_t)))))

;; t263s__ref_t263s__content__projection
(define-fun t263s__ref_t263s__content__projection ((a t263s__ref)) us_t
  (t263s__content a))
           ...
           (and
             (and
               (and
                 ...
                 (dynamic_invariant4 p true true true true))
      ...
      (! (=>
           (and
             ...
             (and
               ...
               (let ((temp___572 (to_rep (select (to_array str1) from))))
      ...
      (! (=>
           ...
           (and
             (forall ((str2 us_t) (from1 Int) (to__1 Int))
               (last_number_ghost__function_guard
                 (last_number_ghost
                   (let ((temp___596 (of_array (to_array str2) from1 to__1)))
                 ...
                 (let ((temp___596 (of_array (to_array str2) from1 to__1)))
                   (let ((temp___597 (to_array temp___596)))
                     (of_array
                       ...
                       (last temp___596))))))
             (and
               (forall ((str2 us_t) (to__1 Int) (last_num_init1 Int))
                 (last_hexa_ghost__function_guard
                   (last_hexa_ghost
                     (let ((temp___587 (let ((temp___586 (+ last_num_init1 2)))
                                         (of_array
                                           (to_array str2)
                                           temp___586
                                           to__1))))
                       ...
                       (let ((temp___579 (let ((temp___578 (+ first_exp 1)))
                         ...
                         (let ((temp___580 (to_array temp___579)))
                           (of_array
                             ...
                             (first temp___579)
                             (last temp___579))))))
                   (= (raw_unsigned_last_ghost str1 from to__) (let ((last_num_init1 
                                                                 (last_number_ghost
                                                                   (let ((temp___596 
                                                                    (of_array
                                                                    (to_array
                                                                 ...
                                                                 (let ((starts_as_based1 (and (and 
                                                                   ...
                                                                   (let ((temp___592 
                                                                    ...
                                                                    false)))))))))
                                                                   (let ((last_num_based1 
                                                                    (ite (= starts_as_based1 true)
                                                                    (last_hexa_ghost
                                                                    (let ((temp___587 
                                                                    (let ((temp___586 (+ last_num_init1 2)))
                                                                    (of_array
                                                                    (to_array
                                                                    str1)
                                                                    temp___586
                                                                    ...
                                                                    temp___587)))))
                                                                    last_num_init1)))
                                                                    (let ((is_based (and (and starts_as_based1 
                                                                    (bool_lt1
                                                                    last_num_based1
                                                                    to__)) 
                                                                    (bool_eq10
...
(assert
  (forall ((str1 us_t))
    (! (=>
         (dynamic_invariant2 str1 true true true true)
         (= (slide_to_1 str1) (let ((res (let ((temp___646 (slide
                                                             (to_array str1)
                                                             (first str1)
                                                             1)))
                                           (of_array
...
;; dynamic_invariant
(define-fun dynamic_invariant6 ((temp___expr_631 us_t) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool
  (=>
    (not (= temp___skip_constant_628 true))
    (and
      (and
        (dynamic_property
          1
          (length str1)
          (first temp___expr_631)
          (last temp___expr_631))
        (= (first temp___expr_631) 1))
      (= (last temp___expr_631) (length str1)))))

;; default_initial_assumption
(define-fun default_initial_assumption1 ((temp___expr_633 us_t) (temp___skip_top_level_634 Bool)) Bool
  (and
    (= (first temp___expr_633) 1)
    (= (last temp___expr_633) (length str1))))
...
;; fst_num__def_axiom
(assert
  (= fst_num (ite (= (to_rep (select (to_array str) non_blank)) 43)
               (+ non_blank 1)
               non_blank)))

;; last_num_init__def_axiom
(assert
  (and
    (last_number_ghost__function_guard
      (last_number_ghost
        (let ((temp___205 (let ((temp___204 (last str)))
                            (let ((temp___203 (+ (first str) 1)))
                              (of_array (to_array str) temp___203 temp___204)))))
          (let ((temp___206 (to_array temp___205)))
            (of_array temp___206 (first temp___205) (last temp___205)))))
      (let ((temp___205 (let ((temp___204 (last str)))
                          (let ((temp___203 (+ (first str) 1)))
                            (of_array (to_array str) temp___203 temp___204)))))
        (let ((temp___206 (to_array temp___205)))
          (of_array temp___206 (first temp___205) (last temp___205)))))
    (= last_num_init (last_number_ghost
                       (let ((temp___205 (let ((temp___204 (last str)))
                                           (let ((temp___203 (+ (first str) 1)))
                                             (of_array
                                               (to_array str)
...
(assert
  (= starts_as_based (and (and (bool_lt1 last_num_init (- (last str) 1)) 
  (let ((temp___209 (to_rep (select (to_array str) (+ last_num_init 1)))))
    (or (ite (= temp___209 35) true false) (ite (= temp___209 58) true false)))) 
  (let ((temp___210 (to_rep (select (to_array str) (+ last_num_init 2)))))
    (or (let ((temp___213 temp___210))
          (and (ite (<= 48 temp___213) true false) (ite (<= temp___213 57)
                                                     true
                                                     false))) (or (let ((temp___212 temp___210))
                                                                    (and 
                                                                    (ite (<= 97 temp___212)
                                                                    true
                                                                    false) 
                                                                    ...
                                                                    true
                                                                    false))) 
    (let ((temp___211 temp___210))
      (and (ite (<= 65 temp___211) true false) (ite (<= temp___211 70)
                                                 true
                                                 false)))))))))
...
(assert
  (and
    (last_hexa_ghost__function_guard
      (last_hexa_ghost
        (let ((temp___216 (let ((temp___215 (last str)))
                            (let ((temp___214 (+ last_num_init 2)))
                              (of_array (to_array str) temp___214 temp___215)))))
          (let ((temp___217 (to_array temp___216)))
            (of_array temp___217 (first temp___216) (last temp___216)))))
      (let ((temp___216 (let ((temp___215 (last str)))
                          (let ((temp___214 (+ last_num_init 2)))
                            (of_array (to_array str) temp___214 temp___215)))))
        (let ((temp___217 (to_array temp___216)))
...
;; Assume
(assert (dynamic_invariant3 val__ true false true true))
  ...
  (and
    (and
      (and
        ...
        (= (to_rep (select (to_array str) (first str))) 32))
...
;; Assert
(assert (= non_blank (+ (first str) 1)))

(declare-const ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__fst_num__assume Int)
...
;; H
(assert (= (to_rep (select (to_array str) non_blank)) o))
...
(assert
  (ite (= o 43)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__fst_num__assume o1)
        (in_range1 o1)))
    (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__fst_num__assume 
    non_blank)))
...
;; Ensures
(assert (in_range1 (+ (first str) 1)))

;; Assert
(assert
  (=>
    (<= (+ (first str) 1) (last str))
    (and
      (and
        (<= (first str) (+ (first str) 1))
        (<= (+ (first str) 1) (last str)))
      (and (<= (first str) (last str)) (<= (last str) (last str))))))
...
(assert
  (last_number_ghost__function_guard
    (last_number_ghost
      (of_array
        (to_array (of_array (to_array str) (+ (first str) 1) (last str)))
        (first (of_array (to_array str) (+ (first str) 1) (last str)))
        (last (of_array (to_array str) (+ (first str) 1) (last str)))))
    (of_array
      (to_array (of_array (to_array str) (+ (first str) 1) (last str)))
      (first (of_array (to_array str) (+ (first str) 1) (last str)))
      (last (of_array (to_array str) (+ (first str) 1) (last str))))))
  ...
  (= (only_number_ghost
       ...
       (last_number_ghost
         (of_array
           (to_array (of_array (to_array str) (+ (first str) 1) (last str)))
           (first (of_array (to_array str) (+ (first str) 1) (last str)))
           (last (of_array (to_array str) (+ (first str) 1) (last str)))))) true))
...
;; Assert
(assert (= last_num_init (last str)))

(declare-const ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__starts_as_based__assume Bool)

;; H
(assert (in_range1 (- (last str) 1)))

(declare-const o1 Bool)

(declare-const temp___1412 Int)

;; H
(assert
  (ite (< last_num_init (- (last str) 1))
    (let ((o2 (+ last_num_init 1)))
      (and
        (in_range1 o2)
        (and
          (and (<= (first str) o2) (<= o2 (last str)))
          (and
            (= (to_rep (select (to_array str) o2)) temp___1412)
            (ite (= temp___1412 35)
              (= o1 true)
              (= o1 (ite (= temp___1412 58) true false)))))))
    (= o1 false)))

(declare-const temp___1414 Int)

;; H
(assert
  (ite (= o1 true)
    (let ((o2 (+ last_num_init 2)))
      (and
        (in_range1 o2)
        (and
          (and (<= (first str) o2) (<= o2 (last str)))
          (and
            (= (to_rep (select (to_array str) o2)) temp___1414)
            (ite (= (and (ite (<= 48 temp___1414) true false) (ite (<= 
                                                                temp___1414 57)
                                                                true
                                                                false)) true)
              (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__starts_as_based__assume true)
              (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__starts_as_based__assume 
              (ite (= (and (ite (<= 97 temp___1414) true false) (ite (<= 
                                                                  temp___1414 102)
                                                                  true
                                                                  false)) true)
                true
                (and (ite (<= 65 temp___1414) true false) (ite (<= temp___1414 70)
                                                            true
                                                            false)))))))))
    (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__starts_as_based__assume false)))
...
;; Assert
(assert (not (= starts_as_based true)))

(declare-const ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume Int)

;; H
(assert
  (ite (= starts_as_based true)
    (let ((temp___1419 (last str)))
      (let ((o2 (+ last_num_init 2)))
        (and
          (in_range1 o2)
          (and
            (=>
              ...
              (and
                (and (<= (first str) o2) (<= o2 (last str)))
                (and
                  (<= (first str) temp___1419)
                  (<= temp___1419 (last str)))))
            (let ((temp___1420 (of_array (to_array str) o2 temp___1419)))
              (let ((o3 (of_array
                          (to_array temp___1420)
                          (first temp___1420)
                          (last temp___1420))))
                (and
                  (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
                  (last_hexa_ghost
                    o3))
                  (and
                    (last_hexa_ghost__function_guard
                    ...
                    (and
                      ...
                      (and
                        (and
                          (and
                            (<= (first o3) ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume)
                            (<= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
                            (last
                              o3)))
                          (=>
                            ...
                            (last
                              o3))
                            (= (not (let ((temp___278 (to_rep
                                                        (select (to_array o3) (+ 
                                                        ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume 1)))))
                        ...
                        (= (only_hexa_ghost
                             o3
                             (first o3)
                             ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume) true)))))))))))
    (= ada___system__val_lllu__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
    last_num_init)))
...
;; Assert
(assert (= last_num_based (last str)))

;; Assert
(assert
  (= (is_opt_exponent_format_ghost
       (let ((temp___1428 (of_array
                            (to_array str)
                            (+ (last str) 1)
                            (last str))))
         (of_array
           (to_array temp___1428)
           (first temp___1428)
           (last temp___1428)))
       (of_int1 0)) true))
...
(assert
  (= (is_natural_format_ghost
       (let ((temp___1436 (of_array
                            (to_array str)
                            (+ (first str) 1)
                            (last str))))
         (of_array
           (to_array temp___1436)
           (first temp___1436)
           (last temp___1436)))) true))
...
(assert
  (and
    (is_raw_unsigned_format_ghost__function_guard
      (is_raw_unsigned_format_ghost
        (let ((temp___1444 (of_array
                             (to_array str)
                             (+ (first str) 1)
                             (last str))))
          (of_array
            (to_array temp___1444)
            (first temp___1444)
            (last temp___1444))))
      (let ((temp___1444 (of_array
                           (to_array str)
    ...
    (= (is_raw_unsigned_format_ghost
         (let ((temp___1444 (of_array
           ...
           (of_array
             (to_array temp___1444)
             (first temp___1444)
             (last temp___1444)))) true)))

;; Assert
(assert
  (and
    (raw_unsigned_overflows_ghost__function_guard
      (raw_unsigned_overflows_ghost str (+ (first str) 1) (last str))
      str
      (+ (first str) 1)
      (last str))
    (not
      (= (raw_unsigned_overflows_ghost str (+ (first str) 1) (last str)) true))))
...
(assert
  (and
    (scan_raw_unsigned_ghost__function_guard
      (scan_raw_unsigned_ghost str (+ (first str) 1) (last str))
      str
      (+ (first str) 1)
      (last str))
    (= val__ (scan_raw_unsigned_ghost str (+ (first str) 1) (last str)))))
...
(assert
  (and
    (is_value_unsigned_ghost__function_guard
      (is_value_unsigned_ghost str val__)
      str
      val__)
    (= (is_value_unsigned_ghost str val__) true)))

;; Goal def'vc
;; File "s-valueu.ads", line 576, characters 0-0
(assert
  (not
  (=>
    (value_unsigned__function_guard (value_unsigned str) str)
    (= (value_unsigned str) val__))))
