...
;; wrap_option
(define-fun wrap_option ((value (_ BitVec 32))) us_rep
                     ...
                     (and
                       (forall ((str2 us_t))
                         (slide_if_necessary__function_guard
                           ...
                           str2))
                       (and
                         (forall ((str2 us_t) (result1 (_ BitVec 32)))
                           (is_value_unsigned_ghost__function_guard
                             (is_value_unsigned_ghost
                               (slide_if_necessary str2)
                               result1)
...
(declare-const ada___system__val_uns__impl__prove_scan_only_decimal_ghost__fst_num__assume Int)
...
(assert
  (ite (= o 43)
    (let ((o1 (+ non_blank 1)))
      (and
        (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__fst_num__assume o1)
        (in_range1 o1)))
    (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__fst_num__assume 
    non_blank)))
...
(declare-const ada___system__val_uns__impl__prove_scan_only_decimal_ghost__starts_as_based__assume Bool)
        ...
        (and
          ...
          (and
            ...
            (ite (= (and (ite (<= 48 temp___1414) true false) (ite (<= 
                                                                ...
                                                                true
                                                                false)) true)
              (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__starts_as_based__assume true)
              (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__starts_as_based__assume 
              (ite (= (and (ite (<= 97 temp___1414) true false) (ite (<= 
                ...
                (and (ite (<= 65 temp___1414) true false) (ite (<= temp___1414 70)
                                                            true
                                                            false)))))))))
    (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__starts_as_based__assume false)))
...
(declare-const ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume Int)
          ...
          (and
            ...
            (let ((temp___1420 (of_array (to_array str) o2 temp___1419)))
              (let ((o3 (of_array
                          ...
                          (last temp___1420))))
                (and
                  (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
                  (last_hexa_ghost
                    o3))
                  (and
                    (last_hexa_ghost__function_guard
                    ...
                    (and
                      ...
                      (and
                        (and
                          (and
                            (<= (first o3) ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume)
                            (<= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
                            (last
                              o3)))
                          (=>
                            ...
                            (= (not (let ((temp___278 (to_rep
                                                        (select (to_array o3) (+ 
                                                        ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume 1)))))
                        ...
                        (= (only_hexa_ghost
                             o3
                             (first o3)
                             ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume) true)))))))))))
    (= ada___system__val_uns__impl__prove_scan_only_decimal_ghost__last_num_based__assume 
    last_num_init)))
...
(assert
  (= val__ (to_rep2
             (rec__ada___system__val_uns__impl__uns_option__value
               (us_split_fields1
                 (exponent_unsigned_ghost val__ 0 #x0000000A))))))
