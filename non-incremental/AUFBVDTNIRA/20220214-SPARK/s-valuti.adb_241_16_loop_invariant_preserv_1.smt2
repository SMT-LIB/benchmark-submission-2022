  ...
  (forall ((str us_t))
    (! (=>
         (and
           ...
           (and
             (not
               (= (let ((temp___244 (temp___String_Literal_235 Tuple0)))
                    (bool_eq4
                      (to_array str)
                      (first str)
                      (last str)
                      ...
                      1
                      0)) true))
             (let ((temp___245 (to_rep1 (select (to_array str) (first str)))))
               (and (<= 48 temp___245) (<= temp___245 57)))))
             ...
             (and
               (and
                 (and
                   ...
                   (=>
                     (< result (last str))
                     (= (not (let ((temp___247 (to_rep1
                                                 (select (to_array str) (+ result 1)))))
                               (or (let ((temp___248 temp___247))
                                     (and (ite (<= 48 temp___248) true false) 
                                     (ite (<= temp___248 57)
                                       true
                                       false))) (ite (= temp___247 95)
                                                  true
                                                  false)))) true)))
    ...
    (! (and
         ...
         (=
           ...
           (and
             (and
               (not
                 (= (let ((temp___259 (temp___String_Literal_250 Tuple0)))
                      (bool_eq4
                        (to_array str)
                        (first str)
                        (last str)
               ...
               (let ((temp___260 (to_rep1
                 ...
                 (and (<= 48 temp___260) (<= temp___260 57))))
             (let ((l (last_number_ghost str)))
               (and
                 (let ((temp___261 (to_rep1 (select (to_array str) l))))
                   (and (<= 48 temp___261) (<= temp___261 57)))
                 (forall ((j Int))
                   (=>
                     (and (<= (first str) j) (<= j l))
                     (=>
    ...
    (forall ((real__ Bool))
      (! (=
           ...
           (or
             ...
             (= (is_natural_format_ghost
                  (let ((temp___276 (let ((temp___275 (last str)))
                                      (of_array
                                        (to_array str)
                                        (ite (let ((temp___279 (to_rep1
                                                                 (select 
                                                                 (to_array
                                                                   str) (+ 
                                                                 (first
                                          ...
                                          (+ (first str) 1))
                                        temp___275))))
                    (let ((temp___277 (to_array temp___276)))
                      (of_array
                        temp___277
                        (first temp___276)
                        (last temp___276))))) true))) :pattern ((is_opt_exponent_format_ghost
                                                                  str
                                                                  real__)) ))))
      ...
      (! (=>
           ...
           (and
             (forall ((str1 us_t) (start Int))
               (scan_natural_ghost__function_guard
                 (scan_natural_ghost
                   (let ((temp___308 (let ((temp___307 (last str1)))
                                       (of_array
                                         (to_array str1)
                                         start
                                         temp___307))))
                     (let ((temp___309 (to_array temp___308)))
                       (of_array
                         temp___309
                         (first temp___308)
                         (last temp___308))))
             ...
             (and
               ...
               (and
                 (and
                   (and
                     (not
                       (= (let ((temp___292 (temp___String_Literal_280
                                              Tuple0)))
                            (bool_eq4
                              (to_array str1)
                              (first str1)
                              ...
                              1
                              0)) true))
                     (let ((temp___293 (to_rep1
                                         (select (to_array str1) (first str1)))))
                       (and (<= 48 temp___293) (<= temp___293 57))))
...
(assert
  (=>
    ...
    (= (not (let ((temp___240 (to_rep1
                                (select (to_array rest) (+ (last_number_ghost
                                                             rest) 1)))))
              (or (and (ite (<= 48 temp___240) true false) (ite (<= temp___240 57)
                                                             true
                                                             false)) 
              (ite (= temp___240 95)
                true
...
;; Assert
(assert (= (is_natural_format_ghost rest) true))

;; Assert
(assert
  (let ((temp___718 (to_rep1 (select (to_array str) p2))))
    (and (<= 48 temp___718) (<= temp___718 57))))
...
;; LoopInvariant
(assert
  (let ((temp___730 (to_rep1 (select (to_array str) p3))))
    (and (<= 48 temp___730) (<= temp___730 57))))
    ...
    (and
      (and
        (and
          ...
          (and
            (= (to_rep1 (select (to_array str) p4)) temp___723)
            (= (and (ite (<= 48 temp___723) true false) (ite (<= temp___723 57)
                                                          true
                                                          false)) true)))
...
;; Assert
(assert
  (let ((temp___718 (to_rep1 (select (to_array str) p5))))
    (and (<= 48 temp___718) (<= temp___718 57))))
...
;; LoopInvariant
(assert
  (let ((temp___730 (to_rep1 (select (to_array str) p5))))
    (and (<= 48 temp___730) (<= temp___730 57))))
