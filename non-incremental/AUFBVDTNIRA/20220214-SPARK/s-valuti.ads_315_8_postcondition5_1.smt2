...
;; H
(assert (= (to_rep ptr__pointer_value) o))
...
(assert
  (ite (<= max p)
    ...
    (and
      ...
      (and
        (= (to_rep1 (select (to_array str) p)) o2)
        (ite (not (= o2 69))
          (and
            (and (<= (first str) p) (<= p (last str)))
            (and
              (= (to_rep1 (select (to_array str) p)) o3)
              (= o1 (ite (= o3 101) false true))))
          (= o1 false))))))
...
(assert
  (and
    (scan_natural_ghost__function_guard
      ...
      0)
    (and
      (forall ((p2 Int) (x1 Int))
        (scan_natural_ghost__function_guard
          (scan_natural_ghost rest (+ p2 1) x1)
          rest
          (+ p2 1)
          x1))
      (and
        ...
        (and
          ...
          (ite (= spark__branch true)
            (and (= exp2 0) (= ptr__pointer_value1 ptr__pointer_value))
            (let ((o4 (+ p 1)))
              (and
                (in_range1 o4)
                (and
                        ...
                        (exists ((o5 Int))
                          (and
                            ...
                            (exists ((spark__branch1 Bool))
                              (and
                                (= spark__branch1 (ite (= o5 43) true false))
                                (ite (= spark__branch1 true)
                                  ...
                                  (and
                                    ...
                                    (exists ((o6 Int))
                                      (and
                                        (= (to_rep1
                                             (select (to_array str) p1)) o6)
                                        (exists ((spark__branch2 Bool))
                                          (and
                                            (= spark__branch2 (ite (= o6 45)
                                                                true
                                                                false))
                                            (and
                                              (= spark__branch2 true)
                                                          ...
                                                          (exists ((spark__branch3 Bool))
                                                            (and
                                                              ...
                                                              (and
                                                                (= spark__branch3 true)
                                                                (= exp2 0))))))))))))))))))))))
                      (= ptr__pointer_value1 ptr__pointer_value))
                    (exists ((spark__branch1 Bool) (p2 Int) (m Bool))
                      (and
                        (and
                          (and (<= (first str) p1) (<= p1 (last str)))
                          (exists ((o5 Int))
                        ...
                        (and
                          ...
                          (exists ((temp___666 Int))
                            (and
                              (= (to_rep1 (select (to_array str) p2)) temp___666)
                              (exists ((spark__branch2 Bool))
                                (and
                                  (= spark__branch2 (ite (= (and (ite (<= 48 temp___666)
                                                                   true
                                                                   false) 
                                                      (ite (<= temp___666 57)
                                                        true
                                  ...
                                  (ite (= spark__branch2 true)
                                    ...
                                    (exists ((x1 Int))
                                      (and
                                        (= x1 0)
                                        (exists ((spark__branch3 Bool) (ptr__pointer_value2 integer) (p3 Int) (x2 Int))
                                          (and
                                            (and
                                              (=>
                                                (<= p2 max)
                                                              ...
                                                              (and
                                                                ...
                                                                (exists 
                                                                  ...
                                                                  (and
                                                                    ...
                                                                    (= x3 x1)))
                                                                    (exists 
                                                                    ((spark__branch5 Bool) (ptr__pointer_value3 integer) (p4 Int))
                                                                    (and
                                                                    (and
                                                                    (<= 0 x2)
                                                                    (and
                                                                    ...
                                                                    (= ptr__pointer_value2 ptr__pointer_value3))
                                                                    (= p3 p5))
                                                                    (and
                                                                    (and
                                                                    (and
