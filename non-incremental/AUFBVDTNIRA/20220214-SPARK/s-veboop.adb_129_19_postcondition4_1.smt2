...
;; of_int
(declare-fun of_int (Int) (_ BitVec 8))

;; to_int
(define-fun to_int1 ((x (_ BitVec 8))) Int
  (ite (bvsge x (_ bv0 8)) (bv2nat8 x) (- (- 256 (bv2nat8 x)))))
...
(assert
  (forall ((x (_ BitVec 8)) (n (_ BitVec 8)))
    (= (bvlshr x n) (lsr x (bv2nat8 n)))))

;; asr_bv_is_asr
(assert
  (forall ((x (_ BitVec 8)) (n (_ BitVec 8)))
    (= (bvashr x n) (asr x (bv2nat8 n)))))

;; lsl_bv_is_lsl
(assert
  (forall ((x (_ BitVec 8)) (n (_ BitVec 8)))
    (= (bvshl x n) (lsl x (bv2nat8 n)))))
...
(assert
  (forall ((x (_ BitVec 8)) (i (_ BitVec 8)))
    (= (nth x (bv2nat8 i)) (nth_bv x i))))

;; Nth_bv_is_nth2
(assert
  (forall ((x (_ BitVec 8)) (i Int))
    (=> (and (<= 0 i) (< i 256)) (= (nth_bv x (of_int i)) (nth x i)))))
...
(assert
  (forall ((a (_ BitVec 8)) (b (_ BitVec 8)) (i (_ BitVec 8)) (n (_ BitVec 8)))
    (= (eq_sub a b (bv2nat8 i) (bv2nat8 n)) (eq_sub_bv a b i n))))
...
(assert
  (forall ((x (_ BitVec 8)) (y (_ BitVec 8)))
    (= (bv2nat8 (bv_min x y)) (min (bv2nat8 x) (bv2nat8 y)))))

;; bv_max_to_uint
(assert
  (forall ((x (_ BitVec 8)) (y (_ BitVec 8)))
    (= (bv2nat8 (bv_max x y)) (max (bv2nat8 x) (bv2nat8 y)))))
    ...
    (forall ((n Int))
      (! (=>
           (and
             (dynamic_invariant2 v true true true true)
             (dynamic_invariant n true true true true))
           (= (element v n) ((_ extract 7 0) (bvand (bvlshr v (of_int1
                                                                (* (- n 1) 8))) #x00000000000000FF)))) :pattern (
      (element
        v
        n)) ))))
...
(assert
  (and
    (and (= (valid left) true) (= (valid right) true))
    (= result__ (bvand left right))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j) left j)
      (and
        (element__function_guard (element right j) right j)
        (= (element result__ j) (ite (and
                                       (= (element left j) #x01)
                                       (= (element right j) #x01))
                                  #x01
                                  #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j1) left j1)
      (and
        (element__function_guard (element right j1) right j1)
        (= (element result__ j1) (ite (and
                                        (= (element left j1) #x01)
                                        (= (element right j1) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j2) left j2)
      (and
        (element__function_guard (element right j2) right j2)
        (= (element result__ j2) (ite (and
                                        (= (element left j2) #x01)
                                        (= (element right j2) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j3) left j3)
      (and
        (element__function_guard (element right j3) right j3)
        (= (element result__ j3) (ite (and
                                        (= (element left j3) #x01)
                                        (= (element right j3) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j4) left j4)
      (and
        (element__function_guard (element right j4) right j4)
        (= (element result__ j4) (ite (and
                                        (= (element left j4) #x01)
                                        (= (element right j4) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j5) left j5)
      (and
        (element__function_guard (element right j5) right j5)
        (= (element result__ j5) (ite (and
                                        (= (element left j5) #x01)
                                        (= (element right j5) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j6) left j6)
      (and
        (element__function_guard (element right j6) right j6)
        (= (element result__ j6) (ite (and
                                        (= (element left j6) #x01)
                                        (= (element right j6) #x01))
                                   #x01
                                   #x00))))))
...
(assert
  (and
    ...
    (and
      (element__function_guard (element left j7) left j7)
      (and
        (element__function_guard (element right j7) right j7)
        (= (element result__ j7) (ite (and
                                        (= (element left j7) #x01)
                                        (= (element right j7) #x01))
                                   #x01
                                   #x00))))))

;; Goal def'vc
;; File "s-veboop.adb", line 123, characters 0-0
(assert
  (not
  (forall ((j8 Int))
    (=>
