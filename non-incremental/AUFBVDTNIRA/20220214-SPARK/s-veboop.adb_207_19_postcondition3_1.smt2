    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j) right j)
            (= (element result__ j) (ite (= (and (or (bool_eq
                                                       (element left j)
                                                       #x01) (bool_eq
                                                               (element
                                                                 right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j1) right j1)
            (= (element result__ j1) (ite (= (and (or (bool_eq
                                                        (element left j1)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j2) right j2)
            (= (element result__ j2) (ite (= (and (or (bool_eq
                                                        (element left j2)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j3) right j3)
            (= (element result__ j3) (ite (= (and (or (bool_eq
                                                        (element left j3)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j4) right j4)
            (= (element result__ j4) (ite (= (and (or (bool_eq
                                                        (element left j4)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j5) right j5)
            (= (element result__ j5) (ite (= (and (or (bool_eq
                                                        (element left j5)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j6) right j6)
            (= (element result__ j6) (ite (= (and (or (bool_eq
                                                        (element left j6)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
    ...
    (and
      ...
      (and
        ...
        (and
          ...
          (and
            (element__function_guard (element right j7) right j7)
            (= (element result__ j7) (ite (= (and (or (bool_eq
                                                        (element left j7)
                                                        #x01) (bool_eq
                                                                (element
                                                                  right
...
;; Goal def'vc
;; File "s-veboop.adb", line 201, characters 0-0
(assert
  (not
  (forall ((j8 Int))
    (=>
