...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool
  (=>
    (= temp___do_toplevel_192 true)
    (=> (= temp___is_init_190 true) (<= 0 temp___expr_194))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool
  (=>
...
;; Goal def'vc
;; File "s-widthi.adb", line 81, characters 0-0
(assert
