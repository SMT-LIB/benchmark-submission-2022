    ...
    (ite (= temp___170 8)
      ...
      (ite (= temp___170 16)
        ...
        (ite (= temp___170 32)
          ...
          (ite (= temp___170 64)
            19
            (ite (= temp___170 128) 38 (to_rep dummy2))))))))
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_185 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool
  (=>
    (= temp___do_toplevel_200 true)
    (=> (= temp___is_init_198 true) (< 0 temp___expr_202))))

;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool
  (=>
    (= temp___do_toplevel_192 true)
    (=> (= temp___is_init_190 true) (<= 0 temp___expr_194))))
...
(assert
  (= t_init (max
              (abs1 (max lo (- 170141183460469231731687303715884105727)))
              (abs1 (max hi (- 170141183460469231731687303715884105727))))))
...
;; Ensures
(assert
  (in_range2 (abs1 (max hi (- 170141183460469231731687303715884105727)))))

;; Ensures
(assert
  (in_range2 (abs1 (max lo (- 170141183460469231731687303715884105727)))))

;; Assume
(assert
  (= (max
       (abs1 (max lo (- 170141183460469231731687303715884105727)))
       (abs1 (max hi (- 170141183460469231731687303715884105727)))) t_init))
...
;; Goal def'vc
;; File "s-widllli.ads", line 51, characters 0-0
(assert
  (not (<= w4 (+ max_w 3))))
