...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_206 Int) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool
  (=>
    (= temp___do_toplevel_204 true)
    (=> (= temp___is_init_202 true) (<= 0 temp___expr_206))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool
  (=>
    (= temp___do_toplevel_212 true)
    (=> (= temp___is_init_210 true) (< 0 temp___expr_214))))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool
  true)
...
;; Goal def'vc
;; File "s-widthu.adb", line 71, characters 0-0
(assert
