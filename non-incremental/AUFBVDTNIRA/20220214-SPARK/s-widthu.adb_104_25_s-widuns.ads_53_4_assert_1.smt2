...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool
  (=>
    (= temp___do_toplevel_206 true)
    (=> (= temp___is_init_204 true) (<= 0 temp___expr_208))))

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_216 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool
  (=>
    (= temp___do_toplevel_214 true)
    (=> (= temp___is_init_212 true) (< 0 temp___expr_216))))

;; dynamic_invariant
(define-fun dynamic_invariant2 ((temp___expr_199 Int) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool) (temp___do_typ_inv_198 Bool)) Bool
  true)
