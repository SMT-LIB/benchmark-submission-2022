    ...
    (ite (= temp___169 8)
      ...
      (ite (= temp___169 16)
        ...
        (ite (= temp___169 32)
          ...
          (ite (= temp___169 64)
            19
            (ite (= temp___169 128) 38 (to_rep dummy1))))))))
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_185 (_ BitVec 128)) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool
  true)
...
;; dynamic_invariant
(define-fun dynamic_invariant3 ((temp___expr_199 Int) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool) (temp___do_typ_inv_198 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant4 ((temp___expr_216 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool
  (=>
    (= temp___do_toplevel_214 true)
    (=> (= temp___is_init_212 true) (< 0 temp___expr_216))))

;; dynamic_invariant
(define-fun dynamic_invariant5 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool
  (=>
    (= temp___do_toplevel_206 true)
    (=> (= temp___is_init_204 true) (<= 0 temp___expr_208))))
...
;; q__def_axiom
(assert (= q (div1 (bv2nat128 t_init) f)))

;; r__def_axiom
(assert (= r (mod1 (bv2nat128 t_init) f)))
...
;; bv_max'result'unused'unused
(define-fun bv_maxqtresultqtunusedqtunused () (_ BitVec 128)
  (ite (bvule lo hi) hi lo))

;; ada___system__wid_lllu__width_uns__width__t_init__assume'unused'unused
(define-fun ada___system__wid_lllu__width_uns__width__t_init__assumeqtunusedqtunused 
  () (_ BitVec 128)
  (ite (bvule lo hi) hi lo))
...
;; range_check_'result'unused'unused
(define-fun range_check_qtresultqtunusedqtunused () (_ BitVec 128)
  (ite (bvule lo hi) hi lo))

;; Assume
(assert (= (ite (bvule lo hi) hi lo) t_init))
...
;; bv_max'result'unused'unused
(define-fun bv_maxqtresultqtunusedqtunused1 () (_ BitVec 128)
  (ite (bvule lo hi) hi lo))

(declare-const t1 (_ BitVec 128))

;; H
(assert (= t1 (ite (bvule lo hi) hi lo)))

;; H
(assert (bvuge t1 #x0000000000000000000000000000000A))

;; Ensures
(assert
  (= (div1 (bv2nat128 t1) (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
  t1 #x0000000000000000000000000000000A))))

;; Assert
(assert (< 0 big_10))

;; Ensures
(assert (in_range2 (- w1 2)))
...
;; Assert
(assert (<= 0 (bv2nat128 t_init)))

;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 t_init) (power big_10 (- w1 2))) big_10) 
  (div1
    (bv2nat128 t_init)
    (* (power big_10 (- w1 2)) big_10))))

(declare-const t2 (_ BitVec 128))

;; H
(assert (= t2 (bvudiv t1 #x0000000000000000000000000000000A)))
...
;; LoopInvariant
(assert (and (<= 3 w3) (<= w3 (+ max_w 2))))

;; LoopInvariant
(assert (= pow3 (power big_10 (- w3 2))))

;; LoopInvariant
(assert (= (bv2nat128 t3) (div1 (bv2nat128 t_init) pow3)))

;; Assume
(assert
  (and
    (dynamic_invariant w3 false true true true)
    (dynamic_invariant1 t3 false true true true)))

;; H
(assert (bvuge t3 #x0000000000000000000000000000000A))

;; Ensures
(assert
  (= (div1 (bv2nat128 t3) (bv2nat128 #x0000000000000000000000000000000A)) (bv2nat128 (bvudiv 
  t3 #x0000000000000000000000000000000A))))

;; Assert
(assert (< 0 big_10))

;; Ensures
(assert (in_range2 (- w3 2)))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat128 t_init) (power big_10 (- w3 2))) big_10) 
  (div1
    (bv2nat128 t_init)
    (* (power big_10 (- w3 2)) big_10))))

(declare-const t4 (_ BitVec 128))

;; H
(assert (= t4 (bvudiv t3 #x0000000000000000000000000000000A)))
...
;; LoopInvariant
(assert (and (<= 3 w4) (<= w4 (+ max_w 2))))

;; LoopInvariant
(assert (= pow4 (power big_10 (- w4 2))))

;; Goal def'vc
;; File "s-widthu.ads", line 75, characters 0-0
(assert
  (not (= (bv2nat128 t4) (div1 (bv2nat128 t_init) pow4))))
