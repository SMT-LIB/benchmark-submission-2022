...
(declare-const t_init (_ BitVec 64))
...
;; user_eq
(declare-fun user_eq3 (long_long_unsigned
  long_long_unsigned) Bool)

(declare-const dummy3 long_long_unsigned)
...
;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_185 (_ BitVec 64)) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool
  true)
...
;; q__def_axiom
(assert (= q (div1 (bv2nat64 t_init) f)))

;; r__def_axiom
(assert (= r (mod1 (bv2nat64 t_init) f)))
...
(define-fun bv_maxqtresultqtunusedqtunused () (_ BitVec 64)
  (ite (bvule lo hi) hi lo))

;; ada___system__wid_llu__width_uns__width__t_init__assume'unused'unused
(define-fun ada___system__wid_llu__width_uns__width__t_init__assumeqtunusedqtunused 
  () (_ BitVec 64)
  (ite (bvule lo hi) hi lo))
...
(define-fun range_check_qtresultqtunusedqtunused () (_ BitVec 64)
  (ite (bvule lo hi) hi lo))
...
;; bv_max'result'unused'unused
(define-fun bv_maxqtresultqtunusedqtunused1 () (_ BitVec 64)
  (ite (bvule lo hi) hi lo))
...
;; H
(assert (bvuge t1 #x000000000000000A))

;; Ensures
(assert
  (= (div1 (bv2nat64 t1) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  t1 #x000000000000000A))))
...
;; Assert
(assert (<= 0 (bv2nat64 t_init)))

;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 t_init) (power big_10 (- w1 2))) big_10) (div1
                                                                    (bv2nat64 
                                                                    t_init)
                                                                    (* 
                                                                    (power
...
;; H
(assert (= t2 (bvudiv t1 #x000000000000000A)))
...
;; LoopInvariant
(assert (= (bv2nat64 t3) (div1 (bv2nat64 t_init) pow3)))
...
;; H
(assert (bvuge t3 #x000000000000000A))

;; Ensures
(assert
  (= (div1 (bv2nat64 t3) (bv2nat64 #x000000000000000A)) (bv2nat64 (bvudiv 
  t3 #x000000000000000A))))
...
;; Ensures
(assert
  (= (div1 (div1 (bv2nat64 t_init) (power big_10 (- w3 2))) big_10) (div1
                                                                    (bv2nat64 
                                                                    t_init)
                                                                    (* 
                                                                    (power
...
;; H
(assert (= t4 (bvudiv t3 #x000000000000000A)))
...
(assert
  (not (= (bv2nat64 t4) (div1 (bv2nat64 t_init) pow4))))
