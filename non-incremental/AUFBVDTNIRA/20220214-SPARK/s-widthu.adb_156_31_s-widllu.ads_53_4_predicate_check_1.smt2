...
;; H
(assert
  (ite (bvuge t1 #x000000000000000A)
    (and
                    ...
                    (and
                      ...
                      (and
                        (= (div1 (div1 o2 o1) temp___232) (div1
                                                            o2
                                                            (* o1 temp___232)))
                        (exists ((t2 (_ BitVec 64)))
                          (and
                            (= t2 (bvudiv t1 #x000000000000000A))
                            (let ((o3 (+ w1 1)))
                              (and
                                (in_range1 o3)
                                (exists ((w3 Int))
                                  (and
                                    ...
                                    (exists ((pow1 Int))
                                      (and
                                        ...
                                        (and
                                          (in_range1 (+ max_w 2))
                                          (exists ((t3 (_ BitVec 64)) (pow3 Int))
                                            (and
                                              (and
                                                (and
                                                  (<= 3 w2)
...
;; Assume
(assert (= (div1 (bv2nat64 t_init) f) q))
...
;; Assume
(assert (= (mod1 (bv2nat64 t_init) f) r))
