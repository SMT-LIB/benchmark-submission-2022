...
(assert
  (ite (bvuge t1 #x0000000000000000000000000000000A)
    (and
      ...
      (let ((temp___232 big_10))
        (and
          (< 0 temp___232)
          (let ((o (- w1 2)))
            (and
              (in_range2 o)
              (let ((o1 (power big_10 o)))
                (and
                  (< 0 o1)
                  (let ((o2 (bv2nat128 t_init)))
                    (and
                      (<= 0 o2)
                      (and
                        (= (div1 (div1 o2 o1) temp___232) (div1
                                                            o2
                                                            (* o1 temp___232)))
...
;; Ensures
(assert (in_range2 (- w2 2)))

;; Assert
(assert true)

;; Assume
(assert (= (power big_10 (- w2 2)) f))
...
;; Assume
(assert (= (div1 (bv2nat128 t_init) f) q))
...
;; Assume
(assert (= (mod1 (bv2nat128 t_init) f) r))
...
(assert
  (not
  (<= (bv2nat128 t_init) (- (+ (* (bv2nat128 #x00000000000000000000000000000009) 
  f) f) 1))))
