...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_185 (_ BitVec 128)) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool
  true)

;; dynamic_invariant
(define-fun dynamic_invariant1 ((temp___expr_199 Int) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool) (temp___do_typ_inv_198 Bool)) Bool
  true)
...
;; Goal def'vc
;; File "s-widthu.adb", line 65, characters 0-0
(assert
