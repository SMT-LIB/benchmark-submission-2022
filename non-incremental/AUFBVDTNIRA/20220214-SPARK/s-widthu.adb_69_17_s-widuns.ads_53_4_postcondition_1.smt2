...
;; dynamic_invariant
(define-fun dynamic_invariant ((temp___expr_185 (_ BitVec 32)) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool
  true)
...
(assert
  (not (= (div1 (bv2nat32 x) (bv2nat32 y)) (bv2nat32 (bvudiv x y)))))
