                  ...
                  (let ((temp___232 big_10))
                    (and
                      ...
                      (let ((o2 (- w1 2)))
                        (and
                          (in_range2 o2)
                          (let ((o3 (power big_10 o2)))
                            (and
                              (< 0 o3)
                              (let ((o4 (bv2nat128 t_init)))
                                (and
                                  (<= 0 o4)
                                  (and
                                    (= (div1 (div1 o4 o3) temp___232) 
                                    (div1
                                      o4
                                      (* o3 temp___232)))
              ...
              (let ((o2 (- w2 2)))
                (and
                  ...
                  (and
                    (= (power big_10 o2) f)
                    (and
                      (= (div1 (bv2nat128 t_init) f) q)
                      (and
                        (= (mod1 (bv2nat128 t_init) f) r)
                        (and
                          (< q big_10)
                          (and
                            (= (bv2nat128 t_init) (+ (* q f) r))
                            (let ((temp___268 f))
                              (and
                                (<= 0 temp___268)
                                (and
                                  ...
                                  (let ((temp___264 q))
                                    (and
                                      (<= 0 temp___264)
                                      (and
                                        (<= (* temp___264 temp___268) (* 9 temp___268))
                                        (and
                                          ...
                                          (and
                                            ...
                                            (and
                                              (= (* big_10 f) (power
                                                                big_10
                                                                (- w2 1)))
                                              (= ada___system__wid_lllu__width_uns__width__result 
                                              w2))))))))))))))))))))))))
