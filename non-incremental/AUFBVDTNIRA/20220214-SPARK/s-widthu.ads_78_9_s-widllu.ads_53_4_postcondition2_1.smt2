...
(declare-const ada___system__wid_llu__width_uns__width__result Int)
...
(assert
  (ite (= spark__branch true)
    (= ada___system__wid_llu__width_uns__width__result 0)
    (and
      (= w1 2)
      (let ((o hi))
        (let ((o1 lo))
              ...
              (let ((o2 (- w2 2)))
                (and
                  ...
                  (and
                    (= (power big_10 o2) f)
                    (and
                      (= (div1 (bv2nat64 t_init) f) q)
                      (and
                        (= (mod1 (bv2nat64 t_init) f) r)
                        (and
                          (< q big_10)
                          (and
                            (= (bv2nat64 t_init) (+ (* q f) r))
                            (let ((temp___268 f))
                              (and
                                (<= 0 temp___268)
                                (and
                                  ...
                                  (let ((temp___264 q))
                                    (and
                                      ...
                                      (and
                                        ...
                                        (and
                                          (<= (bv2nat64 t_init) (- (+ (* (bv2nat64 #x0000000000000009) 
                                          f) f) 1))
                                          (and
                                            (< (bv2nat64 t_init) (* big_10 
                                            f))
                                            (and
                                              (= (* big_10 f) (power
                                                                big_10
                                                                (- w2 1)))
                                              (= ada___system__wid_llu__width_uns__width__result 
                                              w2))))))))))))))))))))))))
...
(assert
  ...
  (=>
    ...
    (< (bv2nat64 lo) (power
                       big_10
                       (- ada___system__wid_llu__width_uns__width__result 1))))))
