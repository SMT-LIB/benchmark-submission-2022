...
RegHendecagon-Diagonal_Side:
 Comparison of Diagonal and Side (regular hendecagon):Let A, B be arbitrary points. Let poly1 be the regular 11-gon with vertices A, B, C, D, E, F, G, H, I, J, K. Let f be the segment A, B. Let r be the segment K, C. Compare segment K, C and segment A, B.
