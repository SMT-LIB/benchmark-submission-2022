...
Application: CAD calls of SUMCracker-ProveInequality to prove (1) in
...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (< 0 V4) (< 0 (+ (* V1 V1) V4)) (< 0 V5) (< 0 (+ (* V2 V2) V5)) (<= (* V3 V3) (* V4 V5)) (< (* (+ (* V1 V1) V4) (+ (* V2 V2) V5)) (* (+ (* V1 V2) V3) (+ (* V1 V2) V3)))))
(check-sat)
(exit)
