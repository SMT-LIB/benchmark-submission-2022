...
(declare-fun t1 () Real)
(declare-fun y () Real)
(assert (and (= (* y y) 5) (= (+ (* sst1 sst1) (* (* t1 t1) 25) (* st1 t1 (+ (/ (- 140) 11) (* y (/ (- 130) 11)))) (* sst1 st1 (+ (/ (- 28) 11) (* y (/ (- 26) 11)))) (* (* st1 st1) (+ 6 (* y 4))) (* sst1 t1 (+ (/ (- 20) 11) (* y (/ 60 11))))) 0) (< 0 y) (<= 0 t1) (<= 0 (+ (* sst1 (* y y)) (* (* st1 (* y y)) (- 4)) (* (* t1 (* y y)) 5) (* (* sst1 y) 4) (* (* st1 y) (- 16)) (* (* t1 y) 20) (* sst1 11) (* st1 (- 20)))) (< sst1 0) (< st1 0) (< (+ (* sst1 y) (* (* st1 y) (- 4)) (* (* t1 y) 5) (* sst1 4) (* st1 (- 5))) 0)))
(check-sat)
(exit)
