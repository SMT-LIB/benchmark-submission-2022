...
Application: Automated proof of (4.41) in 
...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< 1 V1) (< 1 (+ (* (* V1 (* V2 V2)) 4) (* (* V1 V2) 6) (* V1 2))) (< 1 V3) (< 1 (+ (* (* V2 V3) 2) V3)) (<= 2 V2) (<= 0 (+ (- 1) V2)) (<= (* V3 V3) (* V1 V4)) (< (* (+ 1 (* V2 2)) (+ (* (* V1 V2 V4) 2) (* (* V1 V4) 2) (- 1))) (* (+ (* (* V2 V3) 2) V3) (+ (* (* V2 V3) 2) V3)))))
(check-sat)
(exit)
