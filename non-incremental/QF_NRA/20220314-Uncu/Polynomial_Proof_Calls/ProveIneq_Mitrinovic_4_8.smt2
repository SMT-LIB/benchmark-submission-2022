...
Application: Automated proof of (4.8) in 
...
(declare-fun V2 () Real)
(declare-fun V3 () Real)
(assert (and (<= 1 a) (<= 1 V1) (<= 0 V1) (<= 0 (* V2 V2)) (<= 0 (* (* a a) (* V2 V2))) (<= 0 V3) (<= 0 (+ (* (* a a) (* V2 V2)) V3)) (<= V3 (+ (* a V1 (* V2 V2)) V1)) (< (+ (* (* a a a) V1 (* V2 V2)) (* (* a a a) (* V2 V2)) V1 1) (+ (* (* a a) (* V2 V2)) V3))))
(check-sat)
(exit)
