...
(declare-fun V1 () Real)
(declare-fun V2 () Real)
(assert (and (<= 1 V1) (<= 0 V1) (<= 0 (+ 1 V1)) (<= (+ (- 12) (* V1 16)) (* (* V2 V2) 16)) (<= (* (* (+ 1 (* V1 4)) (* V2 V2 V2 V2)) 4) (* (* (* V2 V2) (* (+ V1 V2) (+ V1 V2))) 16)) (< (* (* (* (+ V1 V2) (+ V1 V2)) (* (+ (* V1 V2) V1 (* V2 2)) (+ (* V1 V2) V1 (* V2 2)))) 16) (* (* (+ 5 (* V1 4)) (* (+ V1 V2) (+ V1 V2) (+ V1 V2) (+ V1 V2))) 4)) (not (= (* V2 V2) 0)) (not (= (* (+ V1 V2) (+ V1 V2)) 0))))
(check-sat)
(exit)
