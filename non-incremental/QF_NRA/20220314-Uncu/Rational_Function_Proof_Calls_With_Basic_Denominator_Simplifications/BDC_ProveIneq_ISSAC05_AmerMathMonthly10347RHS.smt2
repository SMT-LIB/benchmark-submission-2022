...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (= (* (* V1 V1) 4) (+ (- 1) (* V4 4))) (= (* (* V2 V2) 4) (+ 3 (* V4 4))) (= (* (* V3 V3) 4) (+ 7 (* V4 4))) (< 0 V1) (< 0 V2) (< 0 V3) (< 0 V5) (< 0 (* V5 (+ V4 V5))) (< 0 (* (+ V4 V5) (+ (* V5 2) (* V4 (+ 1 V5))))) (<= 1 V4) (<= 0 V4) (<= 0 (+ 1 V4)) (<= (* (* V5 (+ (* V4 2) V5)) 2) (* (* V2 (* V5 V5)) 4)) (<= (+ (- 2) (* V5 4)) (* V1 4)) (< (* (* V3 (* (+ V4 V5) (+ V4 V5))) 4) (* (* (+ V4 V5) (+ (* V5 3) (* V4 (+ 1 (* V5 2))))) 2)) (not (= V5 0)) (not (= (+ V4 V5) 0)) (not (= (* V5 2) 0)) (not (= (+ (* V4 2) (* V5 2)) 0))))
(check-sat)
(exit)
