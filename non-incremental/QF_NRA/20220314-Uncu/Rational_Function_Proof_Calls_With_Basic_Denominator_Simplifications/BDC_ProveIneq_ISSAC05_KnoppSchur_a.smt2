...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< P 4) (< 3 P) (< 0 V1) (< 0 V3) (< 0 (* (* (+ 2 V2) (+ 3 (* V2 2)) V3) 2)) (< 0 V4) (<= 1 V2) (<= 0 V2) (< (* (* (+ (* P P) (* V1 (- 6)) (- 6)) V2 V3) 6) 72) (<= (* (* (+ 3 (* V2 2)) (+ 3 (* V2 2))) 288) (* (* (+ 3 (* V2 2)) (+ (* V2 V2) (* V2 3) 2) V3 (+ (* P P) (* V4 (- 6)) (- 6))) 12)) (not (= (+ 6 (* V2 4)) 0)) (not (= (+ 36 (* V2 24)) 0))))
(check-sat)
(exit)
