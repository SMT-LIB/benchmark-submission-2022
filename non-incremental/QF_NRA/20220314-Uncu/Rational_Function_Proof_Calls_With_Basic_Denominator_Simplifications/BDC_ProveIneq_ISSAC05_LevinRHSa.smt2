...
(declare-fun V2 () Real)
(declare-fun x () Real)
(assert (and (<= 0 V1) (<= 0 (+ 1 V1)) (< 0 x) (<= x 1) (<= (* (* (+ 1 V1) (* V2 V2 V2) (+ (* x V1 V2) 1)) 4) (* (* (* (+ 1 V1) (+ 1 V1)) (* V2 V2 V2) (+ (* (* x x) V1) (* (* x V1) (- 2)) V1 (* V2 2))) 2)) (< (* (* (* x x x) (* (+ 2 V1) (+ 2 V1)) (* V2 V2 V2) (+ (* (* x x) V1) (* (* x V1) (- 2)) (* (* x V2) 2) (* x x) V1 (* x (- 2)) 1)) 2) (* (* (* x x x) (+ 2 V1) (* V2 V2 V2) (+ (* (* x x) V1 V2) (* (* x x) V2) 1)) 4)) (not (= (* (+ 1 V1) V2) 0)) (not (= (* V2 2) 0)) (not (= (* x (+ 2 V1) V2) 0)) (not (= (* (* x V2) 2) 0))))
(check-sat)
(exit)
