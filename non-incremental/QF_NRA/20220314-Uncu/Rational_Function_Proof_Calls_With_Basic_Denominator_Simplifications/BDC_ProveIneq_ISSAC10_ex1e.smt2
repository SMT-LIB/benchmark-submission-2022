...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (<= 0 V1) (<= 0 V2) (<= 0 V3) (<= 1 V4) (<= 0 V4) (<= 0 (+ 1 V4)) (<= 0 (+ 2 V4)) (<= 0 (+ 3 V4)) (<= 0 (+ 4 V4)) (<= 0 (* (+ 13 (* V4 2)) (+ (* V1 (+ 7 (* V4 2))) (* (* V2 (+ 20 (* V4 3))) (- 1)) (* V3 (+ 22 (* V4 5)))))) (<= 0 (* (+ 13 (* V4 2)) (+ 15 (* V4 2)) (+ (* V1 (+ (* (* V4 V4) 10) (* V4 89) 189)) (* (* V2 (+ (* (* V4 V4) 11) (* V4 137) 423)) (- 1)) (* V3 (+ (* (* V4 V4) 19) (* V4 160) 295))))) (< (* (+ 13 (* V4 2)) (+ 15 (* V4 2)) (+ 17 (* V4 2)) (+ (* (* V2 (+ (* (* V4 V4 V4) 37) (* (* V4 V4) 626) (* V4 3389) 5736)) (- 1)) (* V1 (+ (* (* V4 V4 V4) 38) (* (* V4 V4) 529) (* V4 2334) 3318)) (* V3 (+ (* (* V4 V4 V4) 73) (* (* V4 V4) 947) (* V4 3517) 3005)))) 0) (not (= (+ 13 (* V4 2)) 0)) (not (= (* (+ 13 (* V4 2)) (+ 15 (* V4 2))) 0)) (not (= (* (+ 13 (* V4 2)) (+ 15 (* V4 2)) (+ 17 (* V4 2))) 0))))
(check-sat)
(exit)
