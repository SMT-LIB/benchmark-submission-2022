...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (<= 0 V1) (<= 0 V2) (<= 0 V3) (<= 1 V4) (<= 0 V4) (<= 0 (+ 1 V4)) (<= 0 (+ 2 V4)) (<= 0 (+ 3 V4)) (<= 0 (* (+ 3 V4) (+ (* (* V2 V4) (- 1)) (* V1 (+ 2 V4)) (* V3 (+ 13 (* V4 5)))))) (< (* (+ 3 V4) (+ 4 V4) (+ (* V2 (+ (* (* V4 V4) (- 4)) (* V4 (- 12)) 9)) (* V1 (+ (* (* V4 V4) 5) (* V4 28) 36)) (* V3 (+ (* (* V4 V4) 24) (* V4 151) 231)))) 0) (not (= (+ 3 V4) 0)) (not (= (* (+ 3 V4) (+ 4 V4)) 0))))
(check-sat)
(exit)
