...
(declare-fun V2 () Real)
(declare-fun V3 () Real)
(assert (and (<= 0 V1) (<= 0 V2) (<= 1 V3) (<= 0 V3) (<= 0 (+ 1 V3)) (<= 0 (+ 2 V3)) (<= 0 (+ 3 V3)) (<= 0 (+ 4 V3)) (<= 0 (+ 5 V3)) (<= 0 (+ 6 V3)) (<= 0 (+ 7 V3)) (<= 0 (+ 8 V3)) (<= 0 (+ 9 V3)) (<= 0 (* (* (* (+ 3 V3) (+ 3 V3)) (- (* V1 (+ (* V3 V3) (* V3 5) 4)) (* V2 (+ (* (* V3 V3) 3) (* V3 17) 22)))) (- 2))) (<= 0 (* (* (+ 3 V3) (+ 4 V3) (+ (* (* V1 (+ (* (* V3 V3) 3) (* V3 17) 14)) (- 1)) (* V2 (+ (* (* V3 V3) 7) (* V3 45) 62)))) 4)) (<= 0 (* (* (+ 3 V3) (+ 5 V3) (+ (* (* V1 (+ (* (* V3 V3) 7) (* V3 45) 38)) (- 1)) (* V2 (+ (* (* V3 V3) 15) (* V3 109) 158)))) 8)) (<= 0 (* (* (+ 3 V3) (+ 6 V3) (+ (* (* V1 (+ (* (* V3 V3) 15) (* V3 109) 94)) (- 1)) (* V2 (+ (* (* V3 V3) 31) (* V3 253) 382)))) 16)) (<= 0 (* (* (+ 3 V3) (+ 7 V3) (- (* (* V2 (+ (* (* V3 V3) 21) (* V3 191) 298)) 3) (* V1 (+ (* (* V3 V3) 31) (* V3 253) 222)))) 32)) (<= 0 (* (* (+ 3 V3) (+ 8 V3) (+ (* (* V1 (+ (* (* V3 V3) 21) (* V3 191) 170)) (- 3)) (* V2 (+ (* (* V3 V3) 127) (* V3 1277) 2046)))) 64)) (<= 0 (* (* (+ 3 V3) (+ 9 V3) (+ (* (* V1 (+ (* (* V3 V3) 127) (* V3 1277) 1150)) (- 1)) (* V2 (+ (* (* V3 V3) 255) (* V3 2813) 4606)))) 128)) (<= 0 (* (* (+ 3 V3) (+ 10 V3) (+ (* (* V1 (+ (* (* V3 V3) 255) (* V3 2813) 2558)) (- 1)) (* V2 (+ (* (* V3 V3) 511) (* V3 6141) 10238)))) 256)) (< (* (* (+ 3 V3) (+ 11 V3) (+ (* (* V1 (+ (* (* V3 V3) 511) (* V3 6141) 5630)) (- 1)) (* V2 (+ (* (* V3 V3) 1023) (* V3 13309) 22526)))) 512) 0) (not (= (* (* (+ 3 V3) (+ 3 V3)) 2) 0)) (not (= (* (* (+ 3 V3) (+ 4 V3)) 4) 0)) (not (= (* (* (+ 3 V3) (+ 5 V3)) 8) 0)) (not (= (* (* (+ 3 V3) (+ 6 V3)) 16) 0)) (not (= (* (* (+ 3 V3) (+ 7 V3)) 32) 0)) (not (= (* (* (+ 3 V3) (+ 8 V3)) 64) 0)) (not (= (* (* (+ 3 V3) (+ 9 V3)) 128) 0)) (not (= (* (* (+ 3 V3) (+ 10 V3)) 256) 0)) (not (= (* (* (+ 3 V3) (+ 11 V3)) 512) 0))))
(check-sat)
(exit)
