...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (<= (* (+ (- 1) V1 V2) (+ (* V3 V3) (* (* V3 V4) 2) (* V4 V4) (* V3 (- 6)) (* V4 (- 6)) 9)) (* (* (+ (- 1) V1 V2) (+ (- 1) V1 V2)) V5)) (< (* V2 (* (+ (- 1) V1 (* V2 2)) (+ (- 1) V1 (* V2 2))) (+ (* V2 V5) (* V4 V4))) (* (* V2 V2) (+ (- 1) V1 (* V2 2)) (+ (* V3 V3) (* (* V3 V4) 4) (* (* V4 V4) 4) (* V3 (- 6)) (* V4 (- 12)) 9))) (not (= (+ (- 1) V1 V2) 0)) (not (= V2 0)) (not (= (+ (- 1) V1 (* V2 2)) 0))))
(check-sat)
(exit)
