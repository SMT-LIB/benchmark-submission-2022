...
(declare-fun V2 () Real)
(declare-fun V3 () Real)
(assert (and (< (* (* (+ 1 V2) (+ (* (* V1 V2) 2) (* V1 2) (* V2 3) 5)) 3) (* (* (* (+ 1 V2) (+ 1 V2)) V3) 9)) (<= 0 V1) (<= 1 V2) (<= 0 V2) (<= 0 (* (+ 1 V2) (+ (* V1 V2) V1 1))) (<= (* (* (* (+ 1 V2) (+ 1 V2)) (* (+ 2 V2) (+ 2 V2)) (+ 5 (* V2 3)) (+ (* (* V2 V3) 3) (* V3 7))) 9) (* (* (+ 1 V2) (+ 2 V2) (* (+ 5 (* V2 3)) (+ 5 (* V2 3))) (+ (* (* V1 (* V2 V2)) 2) (* (* V1 V2) 6) (* (* V2 V2) 3) (* V1 4) (* V2 13) 12)) 3)) (not (= (+ 3 (* V2 3)) 0)) (not (= (+ 1 V2) 0)) (not (= (+ 5 (* V2 3)) 0)) (not (= (* (* (+ 1 V2) (+ 2 V2)) 3) 0))))
(check-sat)
(exit)
