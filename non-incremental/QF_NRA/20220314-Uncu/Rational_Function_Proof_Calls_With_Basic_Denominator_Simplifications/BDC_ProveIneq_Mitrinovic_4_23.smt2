...
(declare-fun V5 () Real)
(declare-fun V6 () Real)
(assert (and (< 1 V4) (< 1 (+ V2 V4)) (< (* V6 V6) (* V5 V6)) (< (* (* V6 V6) 4) (* (* (+ (* V2 V5) V5) V6) 2)) (<= 1 V1) (<= 1 V2) (<= 1 V3) (<= 0 V3) (<= (* (+ 1 V4) (* V6 V6)) (* (+ (* V3 V5) V5) V6)) (< (* (* (+ (* V2 V3 V5) (* (* V2 V5) 2) (* V3 V5) (* V5 2)) V6) 2) (* (* (+ 1 V2 V4) (* V6 V6)) 4)) (not (= V6 0)) (not (= (* V6 2) 0)) (not (= V6 0)) (not (= (* V6 2) 0))))
(check-sat)
(exit)
