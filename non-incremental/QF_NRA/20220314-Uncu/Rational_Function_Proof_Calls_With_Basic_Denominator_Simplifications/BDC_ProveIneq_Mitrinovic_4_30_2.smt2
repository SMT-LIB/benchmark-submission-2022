...
(declare-fun V1 () Real)
(declare-fun V2 () Real)
(assert (and (<= 1 V1) (<= 0 V1) (< (* (+ 1 a) V1 (+ 1 a V1)) (* (* (+ 1 a) (+ 1 a)) (* (+ 1 a V1) (+ 1 a V1)) V2)) (<= (* a (+ 1 V1) (* (+ 1 a V1) (+ 1 a V1) (+ 1 a V1) (+ 1 a V1) (+ 1 a V1))) (* (* a a) (* (+ 1 a V1) (+ 1 a V1) (+ 1 a V1) (+ 1 a V1)) (+ 1 (* (* (+ 1 a V1) (+ 1 a V1)) V2)))) (< (* (* a a) (* (+ a V1) (+ a V1)) V2) (* a V1 (+ a V1))) (< 0 a) (not (= (* (+ 1 a) (+ 1 a V1)) 0)) (not (= (* (+ 1 a V1) (+ 1 a V1)) 0)) (not (= (* a (+ 1 a V1)) 0)) (not (= (* a (+ a V1)) 0))))
(check-sat)
(exit)
