...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< P 4) (< 3 P) (< 0 V1) (< 0 V3) (or (and (< 0 (+ 6 (* V2 4))) (< 0 (* (+ 2 V2) V3))) (and (< (* V2 4) (- 6)) (< (* (+ 2 V2) V3) 0))) (< 0 V4) (<= 1 V2) (<= 0 V2) (< (* (+ (* P P) (* V1 (- 6)) (- 6)) V2 V3) 12) (or (and (< 0 (+ 36 (* V2 24))) (<= (+ 72 (* V2 48)) (* (+ (* V2 V2) (* V2 3) 2) V3 (+ (* P P) (* V4 (- 6)) (- 6))))) (and (< (* V2 24) (- 36)) (<= (* (+ (* V2 V2) (* V2 3) 2) V3 (+ (* P P) (* V4 (- 6)) (- 6))) (+ 72 (* V2 48)))))))
(check-sat)
(exit)
