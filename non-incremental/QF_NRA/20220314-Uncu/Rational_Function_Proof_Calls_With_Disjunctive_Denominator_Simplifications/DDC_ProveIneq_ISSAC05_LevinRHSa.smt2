...
(declare-fun V2 () Real)
(declare-fun x () Real)
(assert (and (<= 0 V1) (<= 0 (+ 1 V1)) (< 0 x) (<= x 1) (or (and (or (and (< 0 (* (+ 1 V1) V2)) (< 0 (* V2 2))) (and (< (* (+ 1 V1) V2) 0) (< (* V2 2) 0))) (<= (* (* V2 (+ (* x V1 V2) 1)) 2) (* (+ 1 V1) V2 (+ (* (* (+ (- 1) x) (+ (- 1) x)) V1) (* V2 2))))) (and (or (and (< 0 (* (+ 1 V1) V2)) (< (* V2 2) 0)) (and (< (* (+ 1 V1) V2) 0) (< 0 (* V2 2)))) (<= (* (+ 1 V1) V2 (+ (* (* (+ (- 1) x) (+ (- 1) x)) V1) (* V2 2))) (* (* V2 (+ (* x V1 V2) 1)) 2)))) (or (and (or (and (< 0 (* x (+ 2 V1) V2)) (< 0 (* (* x V2) 2))) (and (< (* x (+ 2 V1) V2) 0) (< (* (* x V2) 2) 0))) (< (* x (+ 2 V1) (+ 1 V1 (* (* x x) (+ 1 V1)) (* (* x (+ 1 V1 (* V2 (- 1)))) (- 2))) V2) (* (* x V2 (+ 1 (* (* x x) (+ 1 V1) V2))) 2))) (and (or (and (< 0 (* x (+ 2 V1) V2)) (< (* (* x V2) 2) 0)) (and (< (* x (+ 2 V1) V2) 0) (< 0 (* (* x V2) 2)))) (< (* (* x V2 (+ 1 (* (* x x) (+ 1 V1) V2))) 2) (* x (+ 2 V1) (+ 1 V1 (* (* x x) (+ 1 V1)) (* (* x (+ 1 V1 (* V2 (- 1)))) (- 2))) V2))))))
(check-sat)
(exit)
