...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (< 0 V1) (< 0 V2) (or (and (< 0 (+ (- 1) V3)) (< V3 (* (+ (- 1) V3) (+ (* V3 (- 1)) V5)))) (and (< V3 1) (< (* (+ (- 1) V3) (+ (* V3 (- 1)) V5)) V3))) (<= 2 V3) (<= 0 (+ (- 1) V3)) (<= 0 V4) (<= 0 (+ V2 V4)) (or (and (or (and (< 0 V4) (< 0 V3)) (and (< V4 0) (< V3 0))) (<= (* V3 (+ V2 (* V4 (+ (* V3 (- 1)) V5)))) (* (+ 1 V3) V4))) (and (or (and (< 0 V4) (< V3 0)) (and (< V4 0) (< 0 V3))) (<= (* (+ 1 V3) V4) (* V3 (+ V2 (* V4 (+ (* V3 (- 1)) V5)))))))))
(check-sat)
(exit)
