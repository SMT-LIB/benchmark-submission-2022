...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (<= 0 V1) (<= 0 V2) (<= 0 V3) (<= 1 V4) (<= 0 V4) (<= 0 (+ 1 V4)) (<= 0 (+ 2 V4)) (or (and (< 0 (+ 13 (* V4 2))) (< (+ (* V1 (+ 7 (* V4 2))) (* (* V2 (+ 20 (* V4 3))) (- 1)) (* V3 (+ 22 (* V4 5)))) 0)) (and (< (* V4 2) (- 13)) (< 0 (+ (* V1 (+ 7 (* V4 2))) (* (* V2 (+ 20 (* V4 3))) (- 1)) (* V3 (+ 22 (* V4 5)))))))))
(check-sat)
(exit)
