...
(declare-fun V1 () Real)
(declare-fun V2 () Real)
(assert (and (<= 0 V1) (<= 1 V2) (<= 0 V2) (<= 0 (+ 1 V2)) (or (and (< 0 (+ (- 17) (* V2 3))) (<= 0 (* V1 (+ (- 16) (* V2 3))))) (and (< (* V2 3) 17) (<= (* V1 (+ (- 16) (* V2 3))) 0))) (or (and (< 0 (* (+ (- 17) (* V2 3)) (+ (- 14) (* V2 3)))) (< (* V1 (+ (* (* V2 V2) 9) (* V2 (- 87)) 208)) 0)) (and (< (* (+ (- 17) (* V2 3)) (+ (- 14) (* V2 3))) 0) (< 0 (* V1 (+ (* (* V2 V2) 9) (* V2 (- 87)) 208)))))))
(check-sat)
(exit)
