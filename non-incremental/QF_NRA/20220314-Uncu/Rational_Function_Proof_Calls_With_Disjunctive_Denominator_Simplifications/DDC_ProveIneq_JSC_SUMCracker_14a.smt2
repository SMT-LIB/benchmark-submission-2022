...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (or (and (< 0 (+ (- 1) V1 V2)) (<= (* (+ (- 3) V3 V4) (+ (- 3) V3 V4)) (* (+ (- 1) V1 V2) V5))) (and (< (+ V1 V2) 1) (<= (* (+ (- 1) V1 V2) V5) (* (+ (- 3) V3 V4) (+ (- 3) V3 V4))))) (or (and (or (and (< 0 V2) (< 0 (+ (- 1) V1 (* V2 2)))) (and (< V2 0) (< (+ V1 (* V2 2)) 1))) (< (* (+ (- 1) V1 (* V2 2)) (+ (* V2 V5) (* V4 V4))) (* V2 (* (+ (- 3) V3 (* V4 2)) (+ (- 3) V3 (* V4 2)))))) (and (or (and (< 0 V2) (< (+ V1 (* V2 2)) 1)) (and (< V2 0) (< 0 (+ (- 1) V1 (* V2 2))))) (< (* V2 (* (+ (- 3) V3 (* V4 2)) (+ (- 3) V3 (* V4 2)))) (* (+ (- 1) V1 (* V2 2)) (+ (* V2 V5) (* V4 V4))))))))
(check-sat)
(exit)
