...
(declare-fun V6 () Real)
(declare-fun V7 () Real)
(assert (and (= (* V1 V1) V5) (= (* V2 V2) (+ 1 V5)) (= (* V3 V3) (+ 1 (* V5 3))) (= (* V4 V4) (+ 4 (* V5 3))) (< 0 V1) (< 0 V2) (< 0 V3) (< 0 V4) (<= 2 V5) (<= 0 (+ (- 1) V5)) (or (and (or (and (< 0 (* V1 2)) (< 0 V7)) (and (< (* V1 2) 0) (< V7 0))) (< V7 (* (* V1 V6) 2))) (and (or (and (< 0 (* V1 2)) (< V7 0)) (and (< (* V1 2) 0) (< 0 V7))) (< (* (* V1 V6) 2) V7))) (or (and (or (and (< 0 (* V2 2)) (< 0 (* (* (+ 1 V5) V7) 2))) (and (< (* V2 2) 0) (< (* (* (+ 1 V5) V7) 2) 0))) (<= (* (* V2 (+ 1 (* V5 2)) V6) 2) (* (* (+ 1 V5) V7) 2))) (and (or (and (< 0 (* V2 2)) (< (* (* (+ 1 V5) V7) 2) 0)) (and (< (* V2 2) 0) (< 0 (* (* (+ 1 V5) V7) 2)))) (<= (* (* (+ 1 V5) V7) 2) (* (* V2 (+ 1 (* V5 2)) V6) 2))))))
(check-sat)
(exit)
