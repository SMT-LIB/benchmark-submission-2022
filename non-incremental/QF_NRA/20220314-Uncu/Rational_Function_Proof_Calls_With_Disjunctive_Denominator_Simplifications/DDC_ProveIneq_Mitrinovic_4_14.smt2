...
Application: Automated proof of (4.14) in 
...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (= (* V1 V1) V3) (= (* V2 V2) (+ 1 V3)) (< 0 V1) (< 0 V2) (< V1 V4) (<= 2 V3) (<= 0 (+ (- 1) V3)) (<= 0 V4) (or (and (< 0 V2) (<= 0 (+ (* V2 V4) 1))) (and (< V2 0) (<= (* V2 V4) (- 1)))) (or (and (< 0 V2) (<= (+ (* V2 V4) 1) (* V2 V2))) (and (< V2 0) (<= (* V2 V2) (+ (* V2 V4) 1))))))
(check-sat)
(exit)
