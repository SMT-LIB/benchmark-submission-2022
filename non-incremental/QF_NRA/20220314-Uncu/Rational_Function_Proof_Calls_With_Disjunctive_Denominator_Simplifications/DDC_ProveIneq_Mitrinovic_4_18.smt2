...
Application: Automated proof of (4.18) in 
...
(declare-fun V3 () Real)
(declare-fun V4 () Real)
(assert (and (< 0 V1) (< V1 1) (< 0 V2) (< V2 1) (< 0 V4) (< V4 1) (< 0 (+ V2 V4)) (< (+ V2 V4) 1) (or (and (< 0 (- 1 V4)) (< (* V3 (- 1 V4)) 1)) (and (< (* V4 (- 1)) (- 1)) (< 1 (* V3 (- 1 V4))))) (or (and (< 0 (- 1 V2 V4)) (<= 1 (* (+ (* V2 V3) V3) (- 1 V2 V4)))) (and (< (- (* V2 (- 1)) V4) (- 1)) (<= (* (+ (* V2 V3) V3) (- 1 V2 V4)) 1)))))
(check-sat)
(exit)
