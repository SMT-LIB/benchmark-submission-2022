...
(declare-fun V2 () Real)
(declare-fun V3 () Real)
(assert (and (< V3 V1) (<= 1 V2) (<= 0 V2) (or (and (or (and (< 0 (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3))) 3)) (< 0 (+ 1 V2))) (and (< (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3))) 3) 0) (< V2 (- 1)))) (<= (* (+ 1 V2) (+ 26 (* V2 54) (* (* V2 V2) 27) (* (* V1 (+ (* (* V2 V2 V2) 9) (* (* V2 V2) 27) (* V2 26) 8)) 3))) (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3)) (+ 1 (* (+ 1 V2) V3))) 3))) (and (or (and (< 0 (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3))) 3)) (< V2 (- 1))) (and (< (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3))) 3) 0) (< 0 (+ 1 V2)))) (<= (* (* (+ 1 V2) (+ 2 (* V2 3)) (+ 4 (* V2 3)) (+ 1 (* (+ 1 V2) V3))) 3) (* (+ 1 V2) (+ 26 (* V2 54) (* (* V2 V2) 27) (* (* V1 (+ (* (* V2 V2 V2) 9) (* (* V2 V2) 27) (* V2 26) 8)) 3))))))))
(check-sat)
(exit)
