...
Application: Automated proof of (7.35) in 
...
(declare-fun V2 () Real)
(declare-fun x () Real)
(assert (and (<= 0 x) (<= 0 V1) (<= 0 (* x V1)) (<= 0 V2) (<= 0 (+ 1 V2)) (or (and (< 0 (+ (- 1) x)) (<= (* (+ (- 1) x) (+ (* (* V1 V2) 2) V1)) (+ (* x (* V1 V1)) (- 1)))) (and (< x 1) (<= (+ (* x (* V1 V1)) (- 1)) (* (+ (- 1) x) (+ (* (* V1 V2) 2) V1))))) (or (and (< 0 (+ (- 1) x)) (< (+ (* (* x x x) (* V1 V1)) (- 1)) (* (+ (- 1) x) (+ (* (* x V1 V2) 2) (* (* x V1) 3))))) (and (< x 1) (< (* (+ (- 1) x) (+ (* (* x V1 V2) 2) (* (* x V1) 3))) (+ (* (* x x x) (* V1 V1)) (- 1)))))))
(check-sat)
(exit)
