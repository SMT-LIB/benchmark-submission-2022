...
Application: Automated proof of (8.3) in 
...
(declare-fun V4 () Real)
(declare-fun V5 () Real)
(assert (and (< 0 V1) (< 0 V2) (<= 1 V3) (<= 0 V3) (<= 0 V4) (<= 0 (+ V2 V4)) (<= (* V3 V3) (* V4 V5)) (or (and (< 0 V2) (< (* (+ V2 V4) (+ (* V2 V5) 1)) (* V2 (* (+ 1 V3) (+ 1 V3))))) (and (< V2 0) (< (* V2 (* (+ 1 V3) (+ 1 V3))) (* (+ V2 V4) (+ (* V2 V5) 1)))))))
(check-sat)
(exit)
