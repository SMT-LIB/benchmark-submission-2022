...
Application: CAD calls of SUMCracker-ProveInequality to prove LHS of Levin's Inequality in
...
(declare-fun V2 () Real)
(declare-fun x () Real)
(assert (and (<= 0 V1) (<= 0 (+ 1 V1)) (or (and (< 0 (* (+ 1 V1) V2)) (<= (* (+ 1 V1) V2) (+ (* x V1 V2) 1))) (and (< (* (+ 1 V1) V2) 0) (<= (+ (* x V1 V2) 1) (* (+ 1 V1) V2)))) (< 0 x) (<= x 1) (or (and (< 0 (* x (+ 2 V1) V2)) (< (+ 1 (* (* x x) (+ 1 V1) V2)) (* x (+ 2 V1) V2))) (and (< (* x (+ 2 V1) V2) 0) (< (* x (+ 2 V1) V2) (+ 1 (* (* x x) (+ 1 V1) V2)))))))
(check-sat)
(exit)
