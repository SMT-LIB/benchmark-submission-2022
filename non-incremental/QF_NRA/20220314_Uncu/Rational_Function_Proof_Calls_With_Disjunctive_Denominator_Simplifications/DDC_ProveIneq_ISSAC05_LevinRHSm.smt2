...
(declare-fun V2 () Real)
(declare-fun x () Real)
(assert (and (<= 0 V1) (<= 0 (+ 1 V1)) (< 0 x) (<= x 1) (or (and (< 0 (+ 1 V1)) (<= (+ (* (* x V1 V2) 2) 2) (* (+ 1 V1) (+ (* (* (+ (- 1) x) (+ (- 1) x)) V1) (* V2 2))))) (and (< V1 (- 1)) (<= (* (+ 1 V1) (+ (* (* (+ (- 1) x) (+ (- 1) x)) V1) (* V2 2))) (+ (* (* x V1 V2) 2) 2)))) (or (and (< 0 (+ 2 V1)) (< (* (+ 2 V1) (+ 1 V1 (* (* x x) (+ 1 V1)) (* (* x (+ 1 V1 (* V2 (- 1)))) (- 2)))) (+ 2 (* (* (* x x) (+ 1 V1) V2) 2)))) (and (< V1 (- 2)) (< (+ 2 (* (* (* x x) (+ 1 V1) V2) 2)) (* (+ 2 V1) (+ 1 V1 (* (* x x) (+ 1 V1)) (* (* x (+ 1 V1 (* V2 (- 1)))) (- 2)))))))))
(check-sat)
(exit)
