...
(declare-fun V2 () Real)
(declare-fun V3 () Real)
(assert (and (< 0 a) (< (* a 2) 1) (<= V1 a) (< 0 V1) (<= (* a V1) a) (< 0 (* a V1)) (<= (* (* a a) V1) a) (< 0 (* (* a a) V1)) (or (and (< 0 (+ (- 1) (* a 2) (* V1 (- 1)))) (< (* (+ (- 1) (* a 2) (* V1 (- 1))) V2) a)) (and (< (- (* a 2) V1) 1) (< a (* (+ (- 1) (* a 2) (* V1 (- 1))) V2)))) (or (and (< 0 (+ (* a V1) (* a (- 2)) 1)) (< (* (+ (* a V1) (* a (- 2)) 1) V3) (- 1 a))) (and (< (+ (* a V1) (* a (- 2))) (- 1)) (< (- 1 a) (* (+ (* a V1) (* a (- 2)) 1) V3)))) (or (and (< 0 (+ (* (* a a) V1) (* a (- 2)) 1)) (<= (- 1 a) (* (+ (* (* a a) V1) (* a (- 2)) 1) (+ (* a V1 V3) V3)))) (and (< (+ (* (* a a) V1) (* a (- 2))) (- 1)) (<= (* (+ (* (* a a) V1) (* a (- 2)) 1) (+ (* a V1 V3) V3)) (- 1 a))))))
(check-sat)
(exit)
