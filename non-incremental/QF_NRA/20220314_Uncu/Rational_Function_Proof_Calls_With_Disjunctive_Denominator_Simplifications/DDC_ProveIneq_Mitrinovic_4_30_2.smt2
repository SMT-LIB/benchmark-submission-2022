...
(declare-fun V1 () Real)
(declare-fun V2 () Real)
(assert (and (<= 1 V1) (<= 0 V1) (or (and (< 0 (* (+ 1 a) (+ 1 a V1))) (< V1 (* (+ 1 a) (+ 1 a V1) V2))) (and (< (* (+ 1 a) (+ 1 a V1)) 0) (< (* (+ 1 a) (+ 1 a V1) V2) V1))) (or (and (or (and (< 0 (* (+ 1 a V1) (+ 1 a V1))) (< 0 (* a (+ 1 a V1)))) (and (< (* (+ 1 a V1) (+ 1 a V1)) 0) (< (* a (+ 1 a V1)) 0))) (<= (* (+ 1 V1) (* (+ 1 a V1) (+ 1 a V1))) (* a (+ 1 a V1) (+ 1 (* (* (+ 1 a V1) (+ 1 a V1)) V2))))) (and (or (and (< 0 (* (+ 1 a V1) (+ 1 a V1))) (< (* a (+ 1 a V1)) 0)) (and (< (* (+ 1 a V1) (+ 1 a V1)) 0) (< 0 (* a (+ 1 a V1))))) (<= (* a (+ 1 a V1) (+ 1 (* (* (+ 1 a V1) (+ 1 a V1)) V2))) (* (+ 1 V1) (* (+ 1 a V1) (+ 1 a V1)))))) (or (and (< 0 (* a (+ a V1))) (< (* a (+ a V1) V2) V1)) (and (< (* a (+ a V1)) 0) (< V1 (* a (+ a V1) V2)))) (< 0 a)))
(check-sat)
(exit)
